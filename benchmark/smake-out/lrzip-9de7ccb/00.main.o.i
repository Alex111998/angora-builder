# 1 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
# 22 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c"
# 1 "./config.h" 1
# 23 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 26 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 28 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 31 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 34 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 37 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 40 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 43 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 50 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 53 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 54 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 55 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 57 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
# 1 "./lrzip_core.h" 1
# 24 "./lrzip_core.h"
...
extern void zpaq_decompress(unsigned char *s_buf, i64 *d_len, unsigned char *c_buf, i64 c_len,
       FILE *msgout, _Bool progress, long thread);
# 58 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
# 1 "./util.h" 1
# 23 "./util.h"
...
# 59 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
# 1 "./stream.h" 1
# 26 "./stream.h"
...
# 60 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
# 63 "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c" 2
...
{
 do { do { print_stuff(control, 1, 70, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "lrz%s version %s\n", compat ? "" : "ip", "0.631"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 71, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Copyright (C) Con Kolivas 2006-2016\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 72, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Based on rzip "); } while (0); } while (0);
 do { do { print_stuff(control, 1, 73, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Copyright (C) Andrew Tridgell 1998-2003\n\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 74, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Usage: lrz%s [options] <file...>\n", compat ? "" : "ip"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 75, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "General options:\n"); } while (0); } while (0);
 if (compat) {
  do { do { print_stuff(control, 1, 77, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-c, --stdout		output to STDOUT\n"); } while (0); } while (0);
  do { do { print_stuff(control, 1, 78, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-C, --check		check integrity of file written on decompression\n"); } while (0); } while (0);
 } else
  do { do { print_stuff(control, 1, 80, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-c, -C, --check		check integrity of file written on decompression\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 81, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-d, --decompress	decompress\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 82, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-e, --encrypt		password protected sha512/aes128 encryption on compression\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 83, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-h, -?, --help		show help\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 84, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-H, --hash		display md5 hash integrity information\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 85, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-i, --info		show compressed file information\n"); } while (0); } while (0);
 if (compat) {
  do { do { print_stuff(control, 1, 87, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-L, --license		display software version and license\n"); } while (0); } while (0);
  do { do { print_stuff(control, 1, 88, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-P, --progress		show compression progress\n"); } while (0); } while (0);
 } else
  do { do { print_stuff(control, 1, 90, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-q, --quiet		don't show compression progress\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 91, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-r, --recursive		operate recursively on directories\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 92, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-t, --test		test compressed file integrity\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 93, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-v[v%s], --verbose	Increase verbosity\n", compat ? "v" : ""); } while (0); } while (0);
 do { do { print_stuff(control, 1, 94, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-V, --version		show version\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 95, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Options affecting output:\n"); } while (0); } while (0);
 if (!compat)
  do { do { print_stuff(control, 1, 97, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-D, --delete		delete existing files\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 98, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-f, --force		force overwrite of any existing files\n"); } while (0); } while (0);
 if (compat)
  do { do { print_stuff(control, 1, 100, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-k, --keep		don't delete source files on de/compression\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 101, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-K, --keep-broken	keep broken or damaged output files\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 102, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-o, --outfile filename	specify the output file name and/or path\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 103, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-O, --outdir directory	specify the output directory when -o is not used\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 104, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-S, --suffix suffix	specify compressed suffix (default '.lrz')\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 105, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Options affecting compression:\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 106, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	--lzma			lzma compression (default)\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 107, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-b, --bzip2		bzip2 compression\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 108, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-g, --gzip		gzip compression using zlib\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 109, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-l, --lzo		lzo compression (ultra fast)\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 110, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-n, --no-compress	no backend compression - prepare for other compressor\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 111, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-z, --zpaq		zpaq compression (best, extreme compression, extremely slow)\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 112, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Low level options:\n"); } while (0); } while (0);
 if (compat) {
  do { do { print_stuff(control, 1, 114, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-1 .. -9		set lzma/bzip2/gzip compression level (1-9, default 7)\n"); } while (0); } while (0);
  do { do { print_stuff(control, 1, 115, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	--fast			alias for -1\n"); } while (0); } while (0);
  do { do { print_stuff(control, 1, 116, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	--best			alias for -9\n"); } while (0); } while (0);
 }
 if (!compat)
  do { do { print_stuff(control, 1, 119, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-L, --level level	set lzma/bzip2/gzip compression level (1-9, default 7)\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 120, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-N, --nice-level value	Set nice value to value (default %d)\n", compat ? 0 : 19); } while (0); } while (0);
 do { do { print_stuff(control, 1, 121, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-p, --threads value	Set processor count to override number of threads\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 122, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-m, --maxram size	Set maximim available ram in hundreds of MB\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 123, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "				overrides detected ammount of available ram\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 124, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-T, --threshold		Disable LZO compressibility testing\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 125, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-U, --unlimited		Use unlimited window size beyond ramsize (potentially much slower)\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 126, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "	-w, --window size	maximum compression window in hundreds of MB\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 127, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "				default chosen by heuristic dependent on ram and chosen compression\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 128, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "\nLRZIP=NOCONFIG environment variable setting can be used to bypass lrzip.conf.\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 129, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "TMP environment variable will be used for storage of temporary files when needed.\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 130, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "TMPDIR may also be stored in lrzip.conf file.\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 131, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "\nIf no filenames or \"-\" is specified, stdin/out will be used.\n"); } while (0); } while (0);

}

static void license(void)
{
 do { do { print_stuff(control, 1, 137, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "lrz version %s\n", "0.631"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 138, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Copyright (C) Con Kolivas 2006-2016\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 139, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Based on rzip "); } while (0); } while (0);
 do { do { print_stuff(control, 1, 140, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Copyright (C) Andrew Tridgell 1998-2003\n\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 141, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "This is free software.  You may redistribute copies of it under the terms of\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 142, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "the GNU General Public License <http://www.gnu.org/licenses/gpl.html>.\n"); } while (0); } while (0);
 do { do { print_stuff(control, 1, 143, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "There is NO WARRANTY, to the extent permitted by law.\n"); } while (0); } while (0);
}
...
static void show_summary(void)
{
 ...
 if (!(control->flags & (1 << 14))) {
  if (!(control->flags & (1 << 2)))
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 165, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "The following options are in effect for this %s.\n", (control->flags & (1 << 4)) ? "DECOMPRESSION" : "COMPRESSION"); } while (0); } while (0);

  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 167, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Threading is %s. Number of CPUs detected: %d\n", control->threads > 1? "ENABLED" : "DISABLED", control->threads); } while (0); } while (0);

  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 168, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Detected %lld bytes ram\n", control->ramsize); } while (0); } while (0);
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 169, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Compression level %d\n", control->compression_level); } while (0); } while (0);
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 170, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Nice Value: %d\n", control->nice_val); } while (0); } while (0);
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 171, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Show Progress\n"); } while (0); } while (0);
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 172, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Max "); } while (0); } while (0);
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 173, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Verbose\n"); } while (0); } while (0);
  if ((control->flags & (1 << 3)))
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 175, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Overwrite Files\n"); } while (0); } while (0);
  if (!(control->flags & (1 << 1)))
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 177, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Remove input files on completion\n"); } while (0); } while (0);
  if (control->outdir)
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 179, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Output Directory Specified: %s\n", control->outdir); } while (0); } while (0);
  else if (control->outname)
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 181, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Output Filename Specified: %s\n", control->outname); } while (0); } while (0);
  if ((control->flags & (1 << 2)))
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 183, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Test file integrity\n"); } while (0); } while (0);
  if (control->tmpdir)
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 185, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Temporary Directory set as: %s\n", control->tmpdir); } while (0); } while (0);


  if (!(control->flags & (1 << 4)) && !(control->flags & (1 << 2))) {
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 189, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Compression mode is: "); } while (0); } while (0);
   if ((!(control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 191, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "LZMA. LZO Compressibility testing %s\n", ((control->flags & (1 << 20))? "enabled" : "disabled")); } while (0); } while (0);
   else if ((control->flags & (1 << 6)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 193, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "LZO\n"); } while (0); } while (0);
   else if ((control->flags & (1 << 7)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 195, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "BZIP2. LZO Compressibility testing %s\n", ((control->flags & (1 << 20))? "enabled" : "disabled")); } while (0); } while (0);
   else if ((control->flags & (1 << 8)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 197, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "GZIP\n"); } while (0); } while (0);
   else if ((control->flags & (1 << 9)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 199, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "ZPAQ. LZO Compressibility testing %s\n", ((control->flags & (1 << 20))? "enabled" : "disabled")); } while (0); } while (0);
   else if ((control->flags & (1 << 5)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 201, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "RZIP pre-processing only\n"); } while (0); } while (0);
   if (control->window)
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 203, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Compression Window: %lld = %lldMB\n", control->window, control->window * 100ull); } while (0); } while (0);
   ...
   if (!control->window && !(control->flags & (1 << 15))) {
    ...
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 213, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Heuristically Computed Compression Window: %lld = %lldMB\n", temp_window, temp_window * 100ull); } while (0); } while (0);
   }
   if ((control->flags & (1 << 15)))
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 216, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Using Unlimited Window size\n"); } while (0); } while (0);
  }
  if (!(control->flags & (1 << 4)) && !(control->flags & (1 << 2)))
   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 219, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Storage time in seconds %lld\n", control->secs); } while (0); } while (0);
  if ((control->flags & (1 << 23)))
   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 221, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Encryption hash loops %lld\n", control->encloops); } while (0); } while (0);
 }
}
...
static void recurse_dirlist(char *indir, char **dirlist, int *entries)
{
 ...
 if (__builtin_expect(!!(!dirp), 0))
  failure(control, 283, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Unable to open directory %s\n", indir);
 while ((dp = readdir(dirp)) != ((void*)0)) {
  if (!strcmp(dp->d_name, ".") || !strcmp(dp->d_name, ".."))
   continue;
  sprintf(fname, "%s/%s", indir, dp->d_name);
  if (__builtin_expect(!!(stat(fname, &istat)), 0))
   failure(control, 289, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Unable to stat file %s\n", fname);
  if (((((istat.st_mode)) & 0170000) == (0040000))) {
   recurse_dirlist(fname, dirlist, entries);
   continue;
  }
  if (!((((istat.st_mode)) & 0170000) == (0100000))) {
   do { print_err(control, 295, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Not regular file %s\n", fname); } while (0);
   continue;
  }
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 298, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Added file %s\n", fname); } while (0); } while (0);
...
int main(int argc, char *argv[])
{
 ...
 while ((c = getopt_long(argc, argv, compat ? coptions : loptions, long_options, &i)) != -1) {
  ...
  case 'b':
   if (control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))
    failure(control, 356, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only use one of -l, -b, -g, -z or -n\n");
   control->flags |= (1 << 7);
   break;
  case 'c':
   if (compat) {
  ...
  case 'g':
   if (control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))
    failure(control, 383, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only use one of -l, -b, -g, -z or -n\n");
   control->flags |= (1 << 8);
   break;
  case 'h':
  case '?':
  ...
  case 'l':
   if (control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))
    failure(control, 406, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only use one of -l, -b, -g, -z or -n\n");
   control->flags |= (1 << 6);
   break;
  case 'L':
   if (compat) {
   ...
   if (control->compression_level < 1 || control->compression_level > 9)
    failure(control, 416, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Invalid compression level (must be 1-9)\n");
   break;
  case 'm':
  ...
  case 'n':
   if (control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))
    failure(control, 423, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only use one of -l, -b, -g, -z or -n\n");
   control->flags |= (1 << 5);
   break;
  case 'N':
   control->nice_val = atoi(optarg);
   if (control->nice_val < -20 || control->nice_val > 19)
    failure(control, 429, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Invalid nice value (must be -20..19)\n");
   break;
  case 'o':
   if (control->outdir)
    failure(control, 433, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot have -o and -O together\n");
   if (__builtin_expect(!!((control->flags & (1 << 13))), 0))
    failure(control, 435, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify an output filename when outputting to stdout\n");
   control->outname = optarg;
   control->suffix = "";
   break;
  case 'O':
   if (control->outname)
    failure(control, 441, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot have options -o and -O together\n");
   if (__builtin_expect(!!((control->flags & (1 << 13))), 0))
    failure(control, 443, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify an output directory when outputting to stdout\n");
   control->outdir = malloc(strlen(optarg) + 2);
   if (control->outdir == ((void*)0))
    fatal(control, 446, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Failed to allocate for outdir\n");
  ...
  case 'p':
   ...
   if (control->threads < 1)
    failure(control, 454, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Must have at least one thread\n");
   break;
  case 'P':
   control->flags |= (1 << 0);
   break;
  ...
  case 'S':
   if (control->outname)
    failure(control, 467, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Specified output filename already, can't specify an extension.\n");
   if (__builtin_expect(!!((control->flags & (1 << 13))), 0))
    failure(control, 469, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify a filename suffix when outputting to stdout\n");
   control->suffix = optarg;
   break;
  case 't':
   if (control->outname)
    failure(control, 474, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify an output file name when just testing.\n");
   if (compat)
    control->flags |= (1 << 1);
   if (!(control->flags & (1 << 1)))
    failure(control, 478, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Doubt that you want to delete a file when just testing.\n");
   control->flags |= (1 << 2);
   break;
  case 'T':
   control->flags &= ~(1 << 20);
  ...
  case 'v':
   ...
   break;
  case 'V':
   do { do { print_stuff(control, 1, 499, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "lrzip version %s\n", "0.631"); } while (0); } while (0);
   exit(0);
   break;
  case 'w':
  ...
  case 'z':
   if (control->flags & ((1 << 5) | (1 << 6) | (1 << 7) | (1 << 8) | (1 << 9)))
    failure(control, 507, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only use one of -l, -b, -g, -z or -n\n");
   control->flags |= (1 << 9);
   break;
  case '1':
  case '2':
 ...
 if (control->outname) {
  if (argc > 1)
   failure(control, 529, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify output filename with more than 1 file\n");
  if (recurse)
   failure(control, 531, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot specify output filename with recursive\n");
 }

 if ((control->flags & ((1 << 10) | (1 << 11))) && !(control->flags & (1 << 0))) {
  do { print_err(control, 535, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot have -v and -q options. -v wins.\n"); } while (0);
  control->flags |= (1 << 0);
 }

 if ((control->flags & (1 << 15)) && control->window) {
  do { print_err(control, 540, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "If -U used, cannot specify a window size with -w.\n"); } while (0);
  control->window = 0;
 }
 ...
 if ((control->flags & (1 << 15)) && (control->flags & (1 << 12))) {
  do { print_err(control, 548, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot have -U and stdin, unlimited mode disabled.\n"); } while (0);
  control->flags &= ~(1 << 15);
 }
 ...
 if (control->nice_val > 0 && !(control->flags & (1 << 5))) {
  if (__builtin_expect(!!(setpriority(PRIO_PROCESS, 0, control->nice_val / 2) == -1), 0))
   do { print_err(control, 558, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Warning, unable to set nice value\n"); } while (0);
 } else {
  if (__builtin_expect(!!(setpriority(PRIO_PROCESS, 0, control->nice_val) == -1), 0))
   do { print_err(control, 561, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Warning, unable to set nice value\n"); } while (0);
 }
  ...
  if (infile) {
   if ((strcmp(infile, "-") == 0))
    ...
    if (__builtin_expect(!!(stat(infile, &istat)), 0))
     failure(control, 581, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Failed to stat %s\n", infile);
    isdir = ((((istat.st_mode)) & 0170000) == (0040000));
    if (!recurse && (isdir || !((((istat.st_mode)) & 0170000) == (0100000)))) {
     failure(control, 585, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "lrzip only works directly on regular FILES.\n" "Use -r recursive, lrztar or pipe through tar for compressing directories.\n");

    }
    if (recurse && !isdir)
     failure(control, 588, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "%s not a directory, -r recursive needs a directory\n", infile);
   }
  }

  if (recurse) {
   if (__builtin_expect(!!((control->flags & (1 << 12)) || (control->flags & (1 << 13))), 0))
    failure(control, 594, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Cannot use -r recursive with STDIO\n");
   recurse_dirlist(infile, &dirlist, &direntries);
  }

  if ((control->flags & (1 << 14)) && (control->flags & (1 << 12)))
   failure(control, 599, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Will not get file info from STDIN\n");
recursion:
  if (recurse) {
  ...
  if (!(control->flags & (1 << 3))) {
   if ((control->flags & (1 << 12)) && isatty(fileno((FILE *)stdin))) {
    do { print_err(control, 638, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Will not read stdin from a terminal. Use -f to override.\n"); } while (0);
    usage(compat);
    exit (1);
   }
   if (!(control->flags & (1 << 2)) && (control->flags & (1 << 13)) && isatty(fileno((FILE *)stdout)) && !compat) {
    do { print_err(control, 643, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Will not write stdout to a terminal. Use -f to override.\n"); } while (0);
    usage(compat);
    exit (1);
   }
  }
  ...
  if ((control->flags & (1 << 18))) {
   if (!(control->flags & (1 << 4))) {
    do { print_err(control, 651, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can only check file written on decompression.\n"); } while (0);
    control->flags &= ~(1 << 18);
   } else if ((control->flags & (1 << 13))) {
    do { print_err(control, 654, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Can't check file written when writing to stdout. Checking disabled.\n"); } while (0);
    control->flags &= ~(1 << 18);
   }
  }
  ...
  if (__builtin_expect(!!((control->flags & (1 << 12)) && (control->flags & (1 << 23))), 0))
   failure(control, 665, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Unable to work from STDIN while reading password\n");
  ...
  if (!(control->flags & (1 << 14)))
   do { if ((control->flags & (1 << 0))) do { print_stuff(control, 2, 683, "/benchmark/RUNDIR-lrzip-9de7ccb/BUILD/main.c", __func__, "Total time: %02d:%02d:%05.2f\n", hours, minutes, seconds); } while (0); } while (0);
  if (recurse)
   goto recursion;
 }
