# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 20 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c"
...
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
...
# 22 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
...
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 1 "./shape_util.h" 1
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 1 "./blocks/shape.h" 1
# 46 "./blocks/shape.h"
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 1 "./blocks/matrix.h" 1
# 35 "./blocks/matrix.h"
struct SWFMatrix_s
{
...
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 1 "./movie.h" 1
# 34 "./movie.h"
...
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
# 1 "./fill.h" 1
# 30 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c" 2
...
# 65 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c"
void SWFShape_setLine(SWFShape shape, unsigned short width,
     byte r, byte g, byte b, byte a)
{
 SWFShape_setLineStyle_internal(shape, width * Ming_scale, r, g, b, a);
}
# 111 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c"
void SWFShape_setLine2(SWFShape shape, unsigned short width,
                       byte r, byte g, byte b, byte a,
                       int flags, float miterLimit)
{
...
# 161 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/shape_util.c"
void SWFShape_setLine2Filled(SWFShape shape, unsigned short width,
                             SWFFillStyle fill,
                             int flags, float miterLimit)
{
...
void SWFShape_setLeftFill(SWFShape shape, SWFFill fill)
{
 SWFShape_setLeftFillStyle(shape, fill==((void*)0) ? ((void*)0) : SWFFill_getFillStyle(fill));
}


void SWFShape_setRightFill(SWFShape shape, SWFFill fill)
{
 SWFShape_setRightFillStyle(shape, fill==((void*)0) ? ((void*)0) : SWFFill_getFillStyle(fill));
}
...
void SWFShape_drawArc(SWFShape shape, double r, double startAngle, double endAngle)
{
 ...
 nSegs = 1 + (int)(floor((7 * (delta / 360))+0.5));


 subangle = 3.14159265358979323846 * delta / nSegs / 360;

 angle = 3.14159265358979323846 * startAngle / 180;
...
void SWFShape_movePenTo(SWFShape shape, double x, double y)
{
 SWFShape_moveScaledPenTo(shape, (int)(floor((x*Ming_scale)+0.5)),
     (int)(floor((y*Ming_scale)+0.5)));
}


void SWFShape_movePen(SWFShape shape, double dx, double dy)
{
 SWFShape_moveScaledPen(shape, (int)(floor((dx*Ming_scale)+0.5)),
    (int)(floor((dy*Ming_scale)+0.5)));
}
...
void SWFShape_drawLineTo(SWFShape shape, double x, double y)
{
 SWFShape_drawScaledLineTo(shape, (int)(floor((x*Ming_scale)+0.5)),
     (int)(floor((y*Ming_scale)+0.5)));
}
...
void SWFShape_drawLine(SWFShape shape, double dx, double dy)
{
 SWFShape_drawScaledLine(shape, (int)(floor((dx*Ming_scale)+0.5)),
    (int)(floor((dy*Ming_scale)+0.5)));
}
    ...
    double anchorx, double anchory)
{
 SWFShape_drawScaledCurveTo(shape,
      (int)(floor((controlx*Ming_scale)+0.5)),
      (int)(floor((controly*Ming_scale)+0.5)),
      (int)(floor((anchorx*Ming_scale)+0.5)),
      (int)(floor((anchory*Ming_scale)+0.5)));
}
   ...
   double anchordx, double anchordy)
{
 SWFShape_drawScaledCurve(shape,
     (int)(floor((controldx*Ming_scale)+0.5)),
     (int)(floor((controldy*Ming_scale)+0.5)),
     (int)(floor((anchordx*Ming_scale)+0.5)),
     (int)(floor((anchordy*Ming_scale)+0.5)));
}
