# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c"
...
# 22 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
...
# 23 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
...
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "../src/blocks/blocktypes.h" 1
# 32 "../src/blocks/blocktypes.h"
# 1 "../src/ming.h" 1
# 56 "../src/ming.h"
...
# 33 "../src/blocks/blocktypes.h" 2
# 1 "../src/blocks/error.h" 1
# 15 "../src/blocks/error.h"
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "../src/abctypes.h" 1
# 23 "../src/abctypes.h"
typedef enum {
 __add = 0xa0,
...
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "./action.h" 1
# 24 "./action.h"
# 1 "./swftypes.h" 1
# 23 "./swftypes.h"
...
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "./decompile.h" 1
# 31 "./decompile.h"
struct _stack;
...
# 30 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "./parser.h" 1
# 24 "./parser.h"
struct Rect
{
...
# 76 "./parser.h" 2
# 31 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
# 1 "./read.h" 1
...
void dumpBuffer(unsigned char *buf, int length);
# 32 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c" 2
...
void silentSkipBytes(FILE *f, int length);
# 56 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c"
void
...
parseSWF_BUTTONCONDACTION (FILE * f, struct SWF_BUTTONCONDACTION *bcarec, int end)
{
 ...
 actionEnd = end;
  ...
  {
 do { if(_SWF_warn) _SWF_warn(("parseSWF_BUTTONCONDACTION: expected actionEnd flag\n")); } while(0);
...
parseSWF_GLYPHENTRY (FILE * f, SWF_GLYPHENTRY *gerec, int glyphbits, int advancebits)
{
  ...
  for( i=0; glyphbits; i++ ) {
   ...
   glyphbits = 0;
      ...
      do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
    }
  }
  ...
  for (i = 0; i < count; i++)
    {
      if(version == 1)
        ...
        do { if(_SWF_error) _SWF_error(("parseSWF_MORPHLINESTYLES: unknow MORPH version\n")); } while(0);
    }
}
...
# 902 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/parser.c"
int
parseSWF_ACTIONRECORD(FILE * f, int *thisactionp, SWF_ACTION *actions)
{
 ...
 case SWFACTION_GOTOFRAME:
  {
  struct SWF_ACTIONGOTOFRAME *act; act=(struct SWF_ACTIONGOTOFRAME *)action; act->Length = readUInt16(f);
  act->Frame = readUInt16(f);
  break;
  }
 case SWFACTION_GETURL:
  {
  struct SWF_ACTIONGETURL *act; act=(struct SWF_ACTIONGETURL *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_WAITFORFRAME:
  {
  struct SWF_ACTIONWAITFORFRAME *act; act=(struct SWF_ACTIONWAITFORFRAME *)action; act->Length = readUInt16(f);
  act->Frame = readUInt16(f);
 ...
 case SWFACTION_SETTARGET:
  {
  struct SWF_ACTIONSETTARGET *act; act=(struct SWF_ACTIONSETTARGET *)action; act->Length = readUInt16(f);
  act->TargetName = readString(f);
  break;
  }
 case SWFACTION_GOTOLABEL:
  {
  struct SWF_ACTIONGOTOLABEL *act; act=(struct SWF_ACTIONGOTOLABEL *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_PUSH:
  ...
  struct SWF_ACTIONPUSH *act; act=(struct SWF_ACTIONPUSH *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_LOGICALNOT:
  {
  struct SWF_ACTIONNOT *act; act=(struct SWF_ACTIONNOT *)action;
 ...
 case SWFACTION_CALLFRAME:
  {
  struct SWF_ACTIONCALL *act; act=(struct SWF_ACTIONCALL *)action; act->Length = readUInt16(f);

  break;
  }
 case SWFACTION_JUMP:
  {
  struct SWF_ACTIONJUMP *act; act=(struct SWF_ACTIONJUMP *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_IF:
  ...
  struct SWF_ACTIONIF *act; act=(struct SWF_ACTIONIF *)action; act->Length = readUInt16(f);
  ...
  curroffset=(action->SWF_ACTIONRECORD.Offset-actions[0].SWF_ACTIONRECORD.Offset)+
       action->SWF_ACTIONRECORD.Length+3;
  if( act->BranchOffset < 0 ) {
   ...
   if( (actions[i].SWF_ACTIONRECORD.Offset-actions[0].SWF_ACTIONRECORD.Offset) == curroffset+act->BranchOffset ) break;
      ...
      if( i>=thisaction ) {
                            do { if(_SWF_warn) _SWF_warn(("Failed to find branch target!!!\n")); } while(0);
                            do { if(_SWF_warn) _SWF_warn(("Looking for: %d\n\n"), curroffset + act->BranchOffset); } while(0);
                            act->BranchOffset=0;
                            i=thisaction;
      }
 ...
 case SWFACTION_GETURL2:
  {
  struct SWF_ACTIONGETURL2 *act; act=(struct SWF_ACTIONGETURL2 *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_GOTOFRAME2:
  {
  struct SWF_ACTIONGOTOFRAME2 *act; act=(struct SWF_ACTIONGOTOFRAME2 *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_WAITFORFRAME2:
  {
  struct SWF_ACTIONWAITFORFRAME2 *act; act=(struct SWF_ACTIONWAITFORFRAME2 *)action; act->Length = readUInt16(f);
  act->SkipCount = readUInt8(f);
  break;
  }
 ...
 case SWFACTION_CONSTANTPOOL:
  {
  int i, count;
  struct SWF_ACTIONCONSTANTPOOL *act; act=(struct SWF_ACTIONCONSTANTPOOL *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_DEFINEFUNCTION:
  ...
  struct SWF_ACTIONDEFINEFUNCTION *act; act=(struct SWF_ACTIONDEFINEFUNCTION *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_WITH:
  {
  int end;
  struct SWF_ACTIONWITH *act; act=(struct SWF_ACTIONWITH *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_STOREREGISTER:
  {
  struct SWF_ACTIONSTOREREGISTER *act; act=(struct SWF_ACTIONSTOREREGISTER *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_DEFINEFUNCTION2:
  {
  int i, end2, num_params;
  struct SWF_ACTIONDEFINEFUNCTION2 *act; act=(struct SWF_ACTIONDEFINEFUNCTION2 *)action; act->Length = readUInt16(f);
 ...
 case SWFACTION_TRY:
  {
  int end2;
  struct SWF_ACTIONTRY *act; act=(struct SWF_ACTIONTRY *)action; act->Length = readUInt16(f);
...
{
  struct SWF_CHARACTERSET *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_CHARACTERSET *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
...
parseSWF_DEFINEBITS (FILE * f, int length)
{
  ...
  struct SWF_DEFINEBITS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBITS *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_DEFINEBITSJPEG2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBITSJPEG2 *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_DEFINEBITSJPEG3 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBITSJPEG3 *)pstruct;;
...
{
  struct SWF_DEFINEBITSPTR *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBITSPTR *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_DEFINEBUTTON *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBUTTON *)pstruct;;
...
parseSWF_DEFINEBUTTON2 (FILE * f, int length)
{
  int stop;
  int end = fileOffset + length;
  struct SWF_DEFINEBUTTON2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBUTTON2 *)pstruct;;
  ...
  {
    do { if(_SWF_warn) _SWF_warn((" CharacterEndFlag in DefineButton2 != 0")); } while(0);
  }
...
{
  struct SWF_DEFINEBUTTONCXFORM *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBUTTONCXFORM *)pstruct;;
  parserrec->ButtonId = readUInt16(f);
...
{
  struct SWF_DEFINEBUTTONSOUND *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBUTTONSOUND *)pstruct;;
  parserrec->CharacterID = readUInt16 (f);
...
{
  struct SWF_DEFINECOMMANDOBJ *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINECOMMANDOBJ *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_DEFINEEDITTEXT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEEDITTEXT *)pstruct;;
...
parseSWF_DEFINEFONT (FILE * f, int length)
{
  int i;
  int firstOffset;
  struct SWF_DEFINEFONT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONT *)pstruct;;
  ...
  parserrec->OffsetTable = (UI16 *)malloc((((1)>((firstOffset/2)))?(1):((firstOffset/2))) * sizeof( UI16 ) );
...
{
  int i, num_glyphs;
  struct SWF_DEFINEFONT2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONT2 *)pstruct;;
...
{
  int i, num_glyphs;
  struct SWF_DEFINEFONT3 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONT3 *)pstruct;;
...
parseSWF_DEFINEFONTINFO (FILE * f, int length)
{
  ...
  struct SWF_DEFINEFONTINFO *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONTINFO *)pstruct;;
  ...
  if (parserrec->nGlyph < 0 || parserrec->nGlyph > (2147483647 / sizeof(UI16))) {
    do { if(_SWF_error) _SWF_error(("invalid Glyph count")); } while(0);
  }
...
{
  int i, end = fileOffset + length;
  struct SWF_DEFINEFONTINFO2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONTINFO2 *)pstruct;;
...
{
  struct SWF_CSMTEXTSETTINGS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_CSMTEXTSETTINGS *)pstruct;;
...
{
  data->AlignmentCoordinate = readUInt16(f);
  data->Range = readUInt16(f);
}
...
parseSWF_ZONERECORD(FILE *f, struct SWF_ZONERECORD *table)
{
  ...
  if (num_zone_data == (-1)) {
    do { if(_SWF_error) _SWF_error(("unexpeced end of file")); } while(0);
  }
...
{
  int i;
  struct SWF_DEFINEFONTALIGNZONES *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONTALIGNZONES *)pstruct;;
  parserrec->FontID = readUInt16(f);
 ...
 do { if(_SWF_error) _SWF_error(("SWF_DEFINEFONTALIGNZONES: FontID %i not present\n"), parserrec->FontID); } while(0);
...
{
  struct SWF_DEFINEFONTNAME *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEFONTNAME *)pstruct;;
  parserrec->FontId = readUInt16(f);
...
{
  int end = fileOffset + length;
  struct SWF_DEFINELOSSLESS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINELOSSLESS *)pstruct;;

  parserrec->CharacterID = readUInt16 (f);
  parserrec->BitmapFormat = readUInt8 (f);
  parserrec->BitmapWidth = readUInt16 (f);
  parserrec->BitmapHeight = readUInt16 (f);
  if( parserrec->BitmapFormat == 3 ) {
...
{
  int end = fileOffset + length;
  struct SWF_DEFINELOSSLESS2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINELOSSLESS2 *)pstruct;;
...
{
  int end, endEdges;
  struct SWF_DEFINEMORPHSHAPE *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEMORPHSHAPE *)pstruct;;
  end = fileOffset + length;
  parserrec->CharacterID = readUInt16 (f);
  ...
  if(parserrec->Offset == 0)
    do { if(_SWF_error) _SWF_error(("parseSWF_DEFINEMORPHSHAPE: offset == 0!\n")); } while(0);
...
{
  int end, endEdges;
  struct SWF_DEFINEMORPHSHAPE2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEMORPHSHAPE2 *)pstruct;;
  end = fileOffset + length;
  ...
  if(parserrec->Offset == 0)
    do { if(_SWF_error) _SWF_error(("parseSWF_DEFINEMORPHSHAPE2: offset == 0!\n")); } while(0);
...
{
  struct SWF_DEFINESHAPE *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESHAPE *)pstruct;;
...
{
  struct SWF_DEFINESHAPE2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESHAPE2 *)pstruct;;
...
{
  struct SWF_DEFINESHAPE3 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESHAPE3 *)pstruct;;
...
{
  struct SWF_DEFINESHAPE4 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESHAPE4 *)pstruct;;
...
parseSWF_DEFINESPRITE (FILE * f, int length)
{
  ...
  int numblocks, start;
  struct SWF_DEFINESPRITE *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESPRITE *)pstruct;;

  numblocks=0;
  start = fileOffset;
  parserrec->SpriteId = readUInt16 (f);
  parserrec->FrameCount = readUInt16 (f);
  parserrec->tagTypes = ((void*)0);
  parserrec->Tags = ((void*)0);
  while( fileOffset < start+length ) {
   ...
   if( ftell(f) != nextFrame ) {
     do { if(_SWF_warn) _SWF_warn((" Sprite Stream out of sync...\n")); } while(0);
     do { if(_SWF_warn) _SWF_warn((" %ld but expecting %d\n"), ftell(f),nextFrame); } while(0);
     fseek(f,blockstart,0);
  ...
  {
    do { if(_SWF_warn) _SWF_warn(("PARSER: parseSWF_DEFINESPRITE (ID %i): skiping excessive bytes after SWF_END.\n"), parserrec->SpriteId); } while(0);
...
{
  struct SWF_DEFINETEXT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINETEXT *)pstruct;;
...
{
  struct SWF_DEFINETEXT2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINETEXT2 *)pstruct;;
...
{
  struct SWF_DEFINETEXTFORMAT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINETEXTFORMAT *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_DEFINEVIDEO *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEVIDEO *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_DEFINEVIDEOSTREAM *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEVIDEOSTREAM *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_DOACTION *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DOACTION *)pstruct;;
...
{
  struct SWF_ENABLEDEBUGGER *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_ENABLEDEBUGGER *)pstruct;;
...
{
  struct SWF_ENABLEDEBUGGER2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_ENABLEDEBUGGER2 *)pstruct;;
...
{
  struct SWF_END *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_END *)pstruct;;
...
{
  int i;
  struct SWF_EXPORTASSETS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_EXPORTASSETS *)pstruct;;
...
{
  struct SWF_FONTREF *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FONTREF *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_FRAMELABEL *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FRAMELABEL *)pstruct;;
...
{
  struct SWF_FRAMETAG *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FRAMETAG *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_FREEALL *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FREEALL *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_FREECHARACTER *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FREECHARACTER *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_GENCOMMAND *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_GENCOMMAND *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  int i;
  struct SWF_IMPORTASSETS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_IMPORTASSETS *)pstruct;;
...
{
  int i;
  struct SWF_IMPORTASSETS2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_IMPORTASSETS2 *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_JPEGTABLES *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_JPEGTABLES *)pstruct;;
...
{
  struct SWF_NAMECHARACTER *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_NAMECHARACTER *)pstruct;;
...
{
  struct SWF_PATHSAREPOSTSCRIPT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PATHSAREPOSTSCRIPT *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  int end = fileOffset + length;
  struct SWF_PLACEOBJECT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PLACEOBJECT *)pstruct;;
...
{
  struct SWF_PLACEOBJECT2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PLACEOBJECT2 *)pstruct;;
...
{
  struct SWF_PLACEOBJECT3 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PLACEOBJECT3 *)pstruct;;
...
{
  struct SWF_PREBUILT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PREBUILT *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_PREBUILTCLIP *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PREBUILTCLIP *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  struct SWF_PROTECT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_PROTECT *)pstruct;;

  if( length != 0 ) {
   parserrec->Password = readString (f);
  } else {
   parserrec->Password = ((void*)0);
  }
...
{
  struct SWF_REMOVEOBJECT *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_REMOVEOBJECT *)pstruct;;
...
{
  struct SWF_REMOVEOBJECT2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_REMOVEOBJECT2 *)pstruct;;
...
{
  struct SWF_SERIALNUMBER *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SERIALNUMBER *)pstruct;;
...
{
  struct SWF_SETBACKGROUNDCOLOR *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SETBACKGROUNDCOLOR *)pstruct;;
...
{
  struct SWF_SHOWFRAME *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SHOWFRAME *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_SOUNDSTREAMBLOCK *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SOUNDSTREAMBLOCK *)pstruct;;
...
{
  struct SWF_SOUNDSTREAMHEAD *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SOUNDSTREAMHEAD *)pstruct;;
  ...
  if( parserrec->StreamSoundCompression == 2 )
...
{
  struct SWF_SOUNDSTREAMHEAD2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SOUNDSTREAMHEAD2 *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_DEFINESOUND *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESOUND *)pstruct;;
...
{
  struct SWF_STARTSOUND *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_STARTSOUND *)pstruct;;
...
{
  struct SWF_STARTSOUND2 *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_STARTSOUND2 *)pstruct;;
...
{
  struct SWF_SYNCFRAME *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SYNCFRAME *)pstruct;;
  printf("skipping %i bytes\n", length); readBytes(f, length);;
  return (SWF_Parserstruct *)parserrec;;
}
...
{
  int end = fileOffset + length;
  struct SWF_INITACTION *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_INITACTION *)pstruct;;
...
{
  int end = fileOffset + length;
  struct SWF_VIDEOFRAME *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_VIDEOFRAME *)pstruct;;
...
{
  struct SWF_REFLEX *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_REFLEX *)pstruct;;
...
{
  struct SWF_FILEATTRIBUTES *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_FILEATTRIBUTES *)pstruct;;
  byteAlign();
  parserrec->Reserved = readBits(f, 3);
...
{
  struct SWF_METADATA *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_METADATA *)pstruct;;
...
{
  struct SWF_SCRIPTLIMITS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SCRIPTLIMITS *)pstruct;;
...
{
  struct SWF_DEFINESCALINGGRID *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESCALINGGRID *)pstruct;;
  parserrec->CharacterId = readUInt16(f);
...
{
  struct SWF_SETTABINDEX *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SETTABINDEX *)pstruct;;
  parserrec->Depth = readUInt16(f);
...
void parseABC_NS_SET_INFO(struct ABC_NS_SET_INFO *nsset, FILE *f)
{
  ...
  if (nsset->NS == ((void*)0)) {
    do { if(_SWF_error) _SWF_error(("parseABC_NS_SET_INFO: Failed to allocate %lu bytes"), sizeof(U30) * nsset->Count); } while(0);
    return;
  }
...
void parseABC_MULTINAME_INFO(struct ABC_MULTINAME_INFO *minfo, FILE *f)
{
  ...
  switch(minfo->Kind)
  {
    ...
    case 0x1C:
      ...
      break;
    default:
      do { if(_SWF_error) _SWF_error(("Unknow multiname kind %x\n"), minfo->Kind); } while(0);
  }
}
...
void parseABC_CONSTANT_POOL(struct ABC_CONSTANT_POOL *cpool, FILE *f)
{
  ...
  if (cpool->IntCount > 2147483647 / sizeof(S32))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->UIntCount > 2147483647 / sizeof(U32))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->DoubleCount > 2147483647 / sizeof(DOUBLE))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->StringCount > 2147483647 / sizeof(struct ABC_STRING_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->NamespaceCount > 2147483647 / sizeof(struct ABC_NS_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->NamespaceSetCount > 2147483647 / sizeof(struct ABC_NS_SET_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->MultinameCount > 2147483647 / sizeof(struct ABC_MULTINAME_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
...
void parseABC_OPTION_INFO(struct ABC_OPTION_INFO *oinfo, FILE *f)
{
  ...
  if (oinfo->OptionCount > 2147483647 / sizeof(struct ABC_OPTION_INFO))
    do { if(_SWF_error) _SWF_error(("%s: line %d: OptionCount is too big"), __FUNCTION__, 3211); } while(0);
...
void parseABC_METHOD_INFO(struct ABC_METHOD_INFO *method, FILE *f)
{
  ...
  if (method->ParamCount > 2147483647 / sizeof(U30))
    do { if(_SWF_error) _SWF_error(("parseABC_METHOD_INFO: ParamCount is too big")); } while(0);
...
void parseABC_METADATA_INFO(struct ABC_METADATA_INFO *meta, FILE *f)
{
  ...
  if (meta->ItemCount > 2147483647 / sizeof(struct ABC_ITEM_INFO))
    do { if(_SWF_error) _SWF_error(("parseABC_METADATA_INFO: ItemCount is too big")); } while(0);
...
void parseABC_TRAITS_INFO(struct ABC_TRAITS_INFO *trait, FILE *f)
{
  ...
  switch(trait->Kind & 0x0f)
  {
    ...
    case 0x03:
      ...
      break;
    default:
      do { if(_SWF_error) _SWF_error(("Unknow trait %x\n"), trait->Kind); } while(0);
  }

  if(trait->Attr & 0x04)
  {
    trait->MetadataCount = readEncUInt30(f);
    if (trait->MetadataCount > 2147483647 / sizeof(U30)) {
      do { if(_SWF_error) _SWF_error(("parseABC_TRAITS_INFO: MetadataCount is too big")); } while(0);
      return;
    }
...
void parseABC_CLASS_INFO(struct ABC_CLASS_INFO *cinfo, FILE *f)
{
  ...
  if (cinfo->TraitCount > 2147483647 / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_SCRIPT_INFO(struct ABC_SCRIPT_INFO *sinfo, FILE *f)
{
  ...
  if (sinfo->TraitCount > 2147483647 / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_INSTANCE_INFO(struct ABC_INSTANCE_INFO *inst, FILE *f)
{
  ...
  if (inst->InterfaceCount > 2147483647 / sizeof(U30))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (inst->TraitCount > 2147483647 / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_METHOD_BODY_INFO(struct ABC_METHOD_BODY_INFO *minfo, FILE *f)
{
  ...
  if (minfo->ExceptionCount > 2147483647 / sizeof(struct ABC_EXCEPTION_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (minfo->TraitCount > 2147483647 / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_FILE(struct ABC_FILE *abcFile, FILE *f)
{
  ...
  if (abcFile->MethodCount > 2147483647 / sizeof(struct ABC_METHOD_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->MetadataCount > 2147483647 / sizeof(struct ABC_METADATA_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->ClassCount > 2147483647 / sizeof(struct ABC_INSTANCE_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  size = abcFile->ClassCount * sizeof(struct ABC_INSTANCE_INFO);
  abcFile->Instances = malloc(size);
  if (abcFile->ClassCount > 2147483647 / sizeof(struct ABC_CLASS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->ScriptCount > 2147483647 / sizeof(struct ABC_SCRIPT_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->MethodBodyCount > 2147483647 / sizeof(struct ABC_METHOD_BODY_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
{
  struct SWF_DOABC *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DOABC *)pstruct;;
...
{
  int i, count;
  struct SWF_SYMBOLCLASS *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_SYMBOLCLASS *)pstruct;;
  count = readUInt16(f);
  parserrec->SymbolCount = count;
  if (parserrec->SymbolCount > 2147483647 / sizeof(struct SWF_SYMBOLCLASS))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
{
  struct SWF_DEFINEBINARYDATA *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINEBINARYDATA *)pstruct;;
...
{
  int i;
  struct SWF_DEFINESCENEANDFRAMEDATA *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEFINESCENEANDFRAMEDATA *)pstruct;;
  parserrec->SceneCount = readEncUInt32(f);
  if (parserrec->SceneCount > 2147483647 / sizeof(struct SCENE_DATA))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (parserrec->FrameLabelCount > 2147483647 / sizeof(struct FRAME_DATA))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
{
  struct SWF_DEBUGID *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_DEBUGID *)pstruct;;
...
{
  struct SWF_UNKNOWNBLOCK *parserrec; SWF_Parserstruct *pstruct; pstruct = calloc(1, sizeof(SWF_Parserstruct)); pstruct->length = length; pstruct->offset = fileOffset - ( (length >= 63 ) ? 6 : 2) ; parserrec= (struct SWF_UNKNOWNBLOCK *)pstruct;;
