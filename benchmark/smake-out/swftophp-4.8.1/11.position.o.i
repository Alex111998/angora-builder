# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 20 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c"
...
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
...
# 22 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
...
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 1 "./libming.h" 1
# 36 "./libming.h"
# 1 "./ming_config.h" 1
# 37 "./libming.h" 2
...
# 76 "./libming.h" 2
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 1 "./position.h" 1
# 34 "./position.h"
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 1 "./blocks/matrix.h" 1
# 33 "./blocks/matrix.h"
# 1 "./blocks/output.h" 1
# 34 "./blocks/output.h"
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 1 "./movie.h" 1
# 34 "./movie.h"
...
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
# 1 "./blocks/error.h" 1
# 15 "./blocks/error.h"
...
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/position.c" 2
...
{
 double cRot = cos(p->rot*3.14159265358979323846/180);
 double sRot = sin(p->rot*3.14159265358979323846/180);
 double xS = p->xSkew, yS = p->ySkew;
 SWFMatrix m = p->matrix;
 if ( ! m )
 {
  do { if(_SWF_warn) _SWF_warn(("Warning! tried to change the matrix of an object with no matrix")); } while(0);
  return;
 }
 ...
 SWFMatrix_set(m, p->xScale * (cRot - xS*sRot),
  ...
  (int)(floor((Ming_scale*p->x)+0.5)),
  (int)(floor((Ming_scale*p->y)+0.5)));
}
...
SWFPosition_setMatrix(SWFPosition p, double a, double b, double c, double d, double x, double y)
{
 ...
 SWFMatrix_set(p->matrix, a, b, c, d,
  (int)(floor((Ming_scale*x)+0.5)), (int)(floor((Ming_scale*y)+0.5)));
}
