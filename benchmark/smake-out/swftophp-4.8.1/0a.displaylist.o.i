# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 20 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
...
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
...
# 23 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2

# 1 "./blocks/placeobject.h" 1
# 13 "./blocks/placeobject.h"
# 1 "./ming.h" 1
# 45 "./ming.h"
...
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 1 "./blocks/character.h" 1
# 33 "./blocks/character.h"
# 1 "./blocks/block.h" 1
# 33 "./blocks/block.h"
...
# 1 "./blocks/../displaylist.h" 1
# 33 "./blocks/../displaylist.h"
# 1 "./blocklist.h" 1
# 35 "./blocklist.h"
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 1 "./blocks/matrix.h" 1
# 35 "./blocks/matrix.h"
struct SWFMatrix_s
{
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
...
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
...
# 30 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
...
# 31 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 1 "./blocks/button.h" 1
# 33 "./blocks/button.h"
...
# 32 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 1 "./blocks/videostream.h" 1
# 30 "./blocks/videostream.h"
...
void SWFVideoStream_setDimension(SWFVideoStream stream, int width, int height);
# 33 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
...
# 35 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 1 "./blocks/sprite.h" 1
# 35 "./blocks/sprite.h"
# 1 "./blocks/action.h" 1
# 36 "./blocks/action.h"
...
# 36 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c" 2
# 47 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
...
newSWFDisplayList()
{
 ...
 list->isSprite = ((BOOL)0);
 list->head = ((void*)0);
 list->tail = ((void*)0);
 list->soundStream = ((void*)0);
 list->depth = 0;
...
SWFDisplayItem_removeFromList(SWFDisplayItem item, SWFBlockList blocklist)
{
  ...
  if(item == ((void*)0) || item->list == ((void*)0) || blocklist == ((void*)0))
   return;
...
SWFDisplayItem_setRatio(SWFDisplayItem item, float ratio)
{
 ...
 if(ratio < 0)
 {
  do { if(_SWF_warn) _SWF_warn(("SWFDisplayItem_setRatio: ratio must be inside [0...1]\n")); } while(0);
   ratio = 0;
 }
 else if (ratio > 1.0)
 {
...
# 545 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
                              ...
                              SWFFilter filter )
{
 ...
 {
  do { if(_SWF_warn) _SWF_warn(("Filter can only be applied to buttons, sprite/movieclips and text\n")); } while(0);
  return;
 }
 checkBlock(item);
...
# 581 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
...
# 595 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
...
# 681 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/displaylist.c"
void
SWFDisplayItem_flush(SWFDisplayItem item )
{
 ...
 if (character != ((void*)0) && !SWFBlock_isDefined((SWFBlock)character))
 {
