# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
...
# 22 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
...
# 23 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
# 1 "./decompile.h" 1
# 28 "./decompile.h"
# 1 "./action.h" 1
# 24 "./action.h"
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
# 1 "./parser.h" 1
# 22 "./parser.h"
...
# 76 "./parser.h" 2
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2
# 1 "./swfoutput.h" 1
# 25 "./swfoutput.h"
...
extern void outputSWF_LINESTYLE2(SWF_LINESTYLE2 *linestyle, char *parentname, int i);
...
extern void outputSWF_DEFINEFONT3(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINEFONTINFO(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINEFONTINFO2(SWF_Parserstruct *pblock);
extern void outputSWF_CSMTEXTSETTINGS(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINEFONTALIGNZONES(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINEFONTNAME(SWF_Parserstruct *pblock);
...
extern void outputSWF_DEFINEMORPHSHAPE2(SWF_Parserstruct *pblock);
...
extern void outputSWF_DEFINESHAPE4(SWF_Parserstruct *pblock);
...
extern void outputSWF_ENABLEDEBUGGER2(SWF_Parserstruct *pblock);
...
extern void outputSWF_IMPORTASSETS2(SWF_Parserstruct *pblock);
...
extern void outputSWF_PLACEOBJECT3(SWF_Parserstruct *pblock);
...
extern void outputSWF_STARTSOUND2(SWF_Parserstruct *pblock);
...
extern void outputSWF_REFLEX(SWF_Parserstruct *pblock);
extern void outputSWF_FILEATTRIBUTES(SWF_Parserstruct *pblock);
extern void outputSWF_METADATA(SWF_Parserstruct *pblock);
extern void outputSWF_SCRIPTLIMITS(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINESCALINGGRID(SWF_Parserstruct *pblock);
extern void outputSWF_SETTABINDEX(SWF_Parserstruct *pblock);
extern void outputSWF_DOABC(SWF_Parserstruct *pblock);
extern void outputSWF_SYMBOLCLASS(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINEBINARYDATA(SWF_Parserstruct *pblock);
extern void outputSWF_DEFINESCENEANDFRAMEDATA(SWF_Parserstruct *pblock);
extern void outputSWF_DEBUGID(SWF_Parserstruct *pblock);
extern void outputSWF_UNKNOWNBLOCK(SWF_Parserstruct *pblock);
...
# 33 "./swfoutput.h" 2
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c" 2

extern char *swftargetfile;
# 115 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
...
# 235 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
static void
init_script()
{
...
methodcall (char *varname, char *method)
{
  ...
  sprintf (buf, "$" "%s" "->" "%s", varname, method);
...
__builtin_va_start(ap, nparam);
printf("%s", "(");
for(i=0;i<nparam;i++) {
 fmt = __builtin_va_arg(ap, char *);
 p = __builtin_va_arg(ap, unsigned long);
 printf(fmt,p);
 if( i<nparam-1 )
  printf("," " ");
}
...
newobj (char *varname, char *obj)
{
  ...
  if (varname)
  {
# 303 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
    sprintf (buf, "$" "%s = " "new" " " "SWF" "%s", varname, obj);

  }
  else
    sprintf (buf, "new" " " "SWF" "%s", obj);
...
{
# 334 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
...
outputSWF_MATRIX (SWF_MATRIX * matrix, char *fname)
{
 ...
 angle = 90;
    ...
    {
      angle = atan (c / a) * 180 / 3.14159265358979323846;
      ...
      if (a < 0)
 {
  ...
  if (matrix->HasScale)
  {
  if (xScale > 1.0 - 0.02 && xScale < 1.0 + 0.02)
    xScale = 1.0;

  if (yScale > 1.0 - 0.02 && yScale < 1.0 + 0.02)
    yScale = 1.0;
...
outputSWF_CLIPACTIONS (SWF_CLIPACTIONS * clipactions, char *sname)
{
  ...
  {
    printf ("%s(%s(\"%s\"),%s);\n\n", methodcall (sname, "addAction"), newobj (((void*)0), "Action"),
...
outputSWF_FILLSTYLE_new (SWF_FILLSTYLE * fillstyle, char *parentname, int i, SWF_RECT *shapeBounds)
{
  char fname[64];
  char gname[64];
  const char* fillTypeName = ((void*)0);
  int do_declare;
  ...
  switch (fillstyle->FillStyleType)
    ...
    case 0x10:
      ...
      if (do_declare)
        printf ("" "$" " ");
      printf ("%s = %s(" "$" "%s,SWFFILL_LINEAR_GRADIENT);\n",
    ...
    case 0x12:
      ...
      if (do_declare)
        printf ("" "$" " ");
      printf ("%s = %s(" "$" "%s,SWFFILL_RADIAL_GRADIENT);\n",
       fname, methodcall (parentname, "addGradientFill"), gname);
      if (shapeBounds)
        prepareSWF_MATRIX(&fillstyle->GradientMatrix, shapeBounds);
      outputSWF_MATRIX (&fillstyle->GradientMatrix, fname);
...
outputSWF_LINESTYLE2 (SWF_LINESTYLE2 * linestyle, char *parentname, int i)
{
  ...
  printf ("/*" "Style information not output" "*/" "\n");
     ...
     char *parentname)
{
  ...
  printf ("" "/*" "%d linestyles(s)" "*/" "\n", count);
  for (i = 0; i < count; i++)
  {
    if(linestylearray->LineStyles != ((void*)0))
      outputSWF_LINESTYLE (&(linestylearray->LineStyles[i]), parentname, i);
    else if(linestylearray->LineStyles2 != ((void*)0))
      outputSWF_LINESTYLE2 (&(linestylearray->LineStyles2[i]), parentname, i);
    else
      printf ("" "/*" "Unknown linestyle %d (parser error?)" "*/" "\n", i);
  }
}
...
outputSWF_SHAPERECORD (SWF_SHAPERECORD * shaperec, char *parentname)
{
      ...
      if (shaperec->EndShape.EndOfShape == 0)
 {
  ...
  printf ("/*" "Some styles are CHANGED now:" "*/" "\n");
  outputSWF_LINESTYLEARRAY (&(shaperec->StyleChange.LineStyles), parentname);
  outputSWF_FILLSTYLEARRAY_new (&(shaperec->StyleChange.FillStyles), parentname,((void*)0));
      }
      if (shaperec->StyleChange.StateLineStyle)
 {
   ...
   if (shaperec->StyleChange.LineStyle == 0)
   ...
   else
     {
       ...
       printf ("%s(" "$" "%s_l%ld_width, " "$" "%s_l%ld_red, "
        "$" "%s_l%ld_green, " "$" "%s_l%ld_blue, "
        "$" "%s_l%ld_alpha);\n",
        methodcall (parentname, "setLine"),
      ...
      if (shaperec->StyleChange.StateFillStyle1 && shaperec->StyleChange.FillStyle1)
 {
   ...
   if (shaperec->StyleChange.FillStyle1)
     {
       printf ("$" "%s_f%ld", parentname,shaperec->StyleChange.FillStyle1 - 1);
     }
   printf (");\n");
 }
      if (shaperec->StyleChange.StateFillStyle0 && shaperec->StyleChange.FillStyle0)
 {
   ...
   if (shaperec->StyleChange.FillStyle0)
     {
       printf ("$" "%s_f%ld", parentname,shaperec->StyleChange.FillStyle0 - 1);
     }
   printf (");\n");
 }
...
outputSWF_DEFINEBITS (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINEBITS *sblock = (struct SWF_DEFINEBITS *)pblock; printf( "\n" "/*" " " "SWF_DEFINEBITS" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);
  printf ("\n" "/*" " Bitmap %d (bits). To extract: " "*/" "\n",
    sblock->CharacterID);
  printf ("/*" " swfextract -j %d -o %s.jpg $swf " "*/" "\n",
...
outputSWF_DEFINEBITSJPEG2 (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINEBITSJPEG2 *sblock = (struct SWF_DEFINEBITSJPEG2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEBITSJPEG2" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);
  printf ("\n" "/*" " Bitmap %d (jpeg2). To extract: " "*/" "\n",
    sblock->CharacterID);
  printf ("/*" " swfextract -j %d -o %s.jpg $swf " "*/" "\n",
    sblock->CharacterID, name);
  printf ("%s('%s.jpg');\n", newobj (name, "Bitmap"), name);
...
outputSWF_DEFINEBITSJPEG3 (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINEBITSJPEG3 *sblock = (struct SWF_DEFINEBITSJPEG3 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEBITSJPEG3" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);
  printf ("\n" "/*" " Bitmap %d (jpeg3). To extract: " "*/" "\n",
    sblock->CharacterID);
  printf ("/*" " swfextract -j %d -o %s.jpg $swf " "*/" "\n",
    sblock->CharacterID, name);
  printf ("%s('%s.jpg');\n", newobj (name, "Bitmap"), name);
...
outputSWF_DEFINEBUTTON2 (SWF_Parserstruct * pblock)
{
  int i;
  char bname[64];
  struct SWF_DEFINEBUTTON2 *sblock = (struct SWF_DEFINEBUTTON2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEBUTTON2" " " "*/" "\n");;
  ...
  {
    printf ("%s(%s(\"%s\"),%s);\n\n", methodcall (bname, "addAction"), newobj (((void*)0), "Action"),
...
outputSWF_DEFINEEDITTEXT (SWF_Parserstruct * pblock)
{
  ...
  int notFirst = 0;
  char tname[64];
  struct SWF_DEFINEEDITTEXT *sblock = (struct SWF_DEFINEEDITTEXT *)pblock; printf( "\n" "/*" " " "SWF_DEFINEEDITTEXT" " " "*/" "\n");;
...
# 1030 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
  if (sblock->AutoSize)
    {
      if (notFirst)
 printf (" | ");
  ...
  if (sblock->HasFont)
    {
      ...
      while (fi)
      {
       ...
       {
        printf ("%s(" "'" , methodcall (tname, "addChars"));
...
{
  char fname[64];
  struct SWF_DEFINEFONT *sblock = (struct SWF_DEFINEFONT *)pblock; printf( "\n" "/*" " " "SWF_DEFINEFONT" " " "*/" "\n");;
...
static void saveFontInfo(int id,int numglyph,int *codetable,UI16 *ct16)
{
  ...
  if (fi)
  {
   if (((void*)0) != (fi->fontcodeptr=malloc(numglyph * sizeof(int))))
   {
    int i;
...
{
  char fname[64];
  struct SWF_DEFINEFONT2 *sblock = (struct SWF_DEFINEFONT2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEFONT2" " " "*/" "\n");;
  ...
  if (sblock->FontFlagsHasLayout || sblock->NumGlyphs)
  {
   printf ("/*" " font name: %s" "*/" "\n", sblock->FontName);
   printf ("%s(\"font%d.fdb\" );\n", newobj (fname, "Font"), sblock->FontID);
   saveFontInfo(sblock->FontID,sblock->NumGlyphs,sblock->CodeTable,((void*)0));
  }
  else
  {
...
{
  char fname[64];
  struct SWF_DEFINEFONT3 *sblock = (struct SWF_DEFINEFONT3 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEFONT3" " " "*/" "\n");;
  ...
  if (sblock->FontFlagsHasLayout || sblock->NumGlyphs)
  {
   printf ("/*" " font name: %s" "*/" "\n", sblock->FontName);
   printf ("%s(\"font%d.fdb\" );\n", newobj (fname, "Font"), sblock->FontID);
   saveFontInfo(sblock->FontID,sblock->NumGlyphs,((void*)0),sblock->CodeTable);
  }
  else
  {
   printf ("%s(\"%s\" );\n", newobj (fname, "BrowserFont"), sblock->FontName);
...
{
  char fname[64];
  struct SWF_DEFINEFONTINFO *sblock = (struct SWF_DEFINEFONTINFO *)pblock; printf( "\n" "/*" " " "SWF_DEFINEFONTINFO" " " "*/" "\n");;

  sprintf (fname, "f%d", sblock->FontID);
  printf ("%s(\"%s.fdb\" );\n", newobj (fname, "Font"), sblock->FontName);
  saveFontInfo(sblock->FontID,sblock->nGlyph,((void*)0),sblock->CodeTable);
}
...
{
  char fname[64];
  struct SWF_DEFINEFONTINFO2 *sblock = (struct SWF_DEFINEFONTINFO2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINEFONTINFO2" " " "*/" "\n");;
...
outputSWF_DEFINELOSSLESS (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINELOSSLESS *sblock = (struct SWF_DEFINELOSSLESS *)pblock; printf( "\n" "/*" " " "SWF_DEFINELOSSLESS" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);
  printf ("\n" "/*" " Bitmap %d (lossless). To extract: " "*/" "\n",
    sblock->CharacterID);
  printf ("/*" " swfextract -p %d -o %s.png $swf " "*/" "\n",
    sblock->CharacterID, name);
  printf ("%s('%s.png');\n", newobj (name, "Bitmap"), name);
...
outputSWF_DEFINELOSSLESS2 (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINELOSSLESS2 *sblock = (struct SWF_DEFINELOSSLESS2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINELOSSLESS2" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);
  printf ("\n" "/*" " Bitmap %d (lossless2). To extract:" "*/" "\n",
    sblock->CharacterID);
  printf ("/*" " swfextract -p %d -o %s.png $swf " "*/" "\n",
    sblock->CharacterID, name);
  printf ("%s('%s.png');\n", newobj (name, "Bitmap"), name);
...
{
  char name[32];
  struct SWF_DEFINESHAPE *sblock = (struct SWF_DEFINESHAPE *)pblock; printf( "\n" "/*" " " "SWF_DEFINESHAPE" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->ShapeID);

  printf ("\n" "/*" " Shape %d (TYPE=1, RECT=%d,%d %d,%d)" "*/" "\n", sblock->ShapeID,
...
{
  char name[32];
  struct SWF_DEFINESHAPE2 *sblock = (struct SWF_DEFINESHAPE2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINESHAPE2" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->ShapeID);

  printf ("\n" "/*" " Shape %d (TYPE=2, RECT=%d,%d %d,%d)" "*/" "\n", sblock->ShapeID,
   (int)sblock->ShapeBounds.Xmin,(int)sblock->ShapeBounds.Xmax,(int)sblock->ShapeBounds.Ymin,(int)sblock->ShapeBounds.Ymax);
  printf ("%s();\n", newobj (name, "Shape"));
...
{
  char name[32];
  struct SWF_DEFINESHAPE3 *sblock = (struct SWF_DEFINESHAPE3 *)pblock; printf( "\n" "/*" " " "SWF_DEFINESHAPE3" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->ShapeID);

  printf ("\n" "/*" " Shape %d (TYPE=3, RECT=%d,%d %d,%d)" "*/" "\n", sblock->ShapeID,
   (int)sblock->ShapeBounds.Xmin,(int)sblock->ShapeBounds.Xmax,(int)sblock->ShapeBounds.Ymin,(int)sblock->ShapeBounds.Ymax);
  printf ("%s();\n", newobj (name, "Shape"));
...
{
  char name[32];
  struct SWF_DEFINESHAPE4 *sblock = (struct SWF_DEFINESHAPE4 *)pblock; printf( "\n" "/*" " " "SWF_DEFINESHAPE4" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->ShapeID);

  printf ("\n" "/*" " Shape %d (TYPE=4, RECT=%d,%d %d,%d)" "*/" "\n", sblock->ShapeID,
   (int)sblock->ShapeBounds.Xmin,(int)sblock->ShapeBounds.Xmax,(int)sblock->ShapeBounds.Ymin,(int)sblock->ShapeBounds.Ymax);
  printf ("%s();\n", newobj (name, "Shape"));
...
{
  char sname[64];
  struct SWF_DEFINESOUND *sblock = (struct SWF_DEFINESOUND *)pblock; printf( "\n" "/*" " " "SWF_DEFINESOUND" " " "*/" "\n");;
  sprintf (sname, "character%d", sblock->SoundId);
  printf ("%s(\"FIX_MY_PARAMS\")"";""\n", newobj (sname, "Sound"));
}
...
{
  int i;
  struct SWF_DEFINESPRITE *sblock = (struct SWF_DEFINESPRITE *)pblock; printf( "\n" "/*" " " "SWF_DEFINESPRITE" " " "*/" "\n");;
  ...
  for(i=0;i<sblock->BlockCount;i++) {
   outputBlock( sblock->tagTypes[i], sblock->Tags[i], ((void*)0));
  }
  spritenum = 0;
...
outputSWF_TEXT_RECORD (SWF_TEXTRECORD *trec, int level,char *tname,char *buffer,int bsize,int id)
{
  ...
  if (!trec->StyleFlagHasFont)
  {
   ...
   if (!fi)
      do { if(_SWF_warn) _SWF_warn(("outputSWF_TEXT_RECORD: can't process text record: fonts information list is NULL\n")); } while(0);
   else
      id = fi->fontcodeID;
  }
  while (fi)
...
outputSWF_DEFINETEXT (SWF_Parserstruct * pblock)
{
  ...
  char name[32];
  char buffer[64];
  struct SWF_DEFINETEXT *sblock = (struct SWF_DEFINETEXT *)pblock; printf( "\n" "/*" " " "SWF_DEFINETEXT" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->CharacterID);
  printf ("%s(1);\n", newobj (name, "Text"));
...
outputSWF_DEFINETEXT2 (SWF_Parserstruct * pblock)
{
  ...
  char name[32];
  char buffer[64];
  struct SWF_DEFINETEXT2 *sblock = (struct SWF_DEFINETEXT2 *)pblock; printf( "\n" "/*" " " "SWF_DEFINETEXT2" " " "*/" "\n");;
  sprintf (name, "character%d", sblock->CharacterID);
  printf ("%s(2);\n", newobj (name, "Text"));
  for(i=0;i<sblock->numTextRecords;i++)
  {
...
outputSWF_DEFINEVIDEOSTREAM (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINEVIDEOSTREAM *sblock = (struct SWF_DEFINEVIDEOSTREAM *)pblock; printf( "\n" "/*" " " "SWF_DEFINEVIDEOSTREAM" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->CharacterID);


  if ( sblock->NumFrames && sblock->NumFrames != 65535 ) {
    printf ("/*" " You'll need to extract video%d.flv " "*/" "\n",
            sblock->CharacterID);
...
{
  struct SWF_DOACTION *sblock = (struct SWF_DOACTION *)pblock; printf( "\n" "/*" " " "SWF_DOACTION" " " "*/" "\n");;

  printf ("%s(%s(\"%s\") );\n", methodcall (spritenum?spritename:"m", "add"),
   newobj (((void*)0), "Action"), decompile5Action(sblock->numActions,sblock->Actions,0));
}
...
outputSWF_EXPORTASSETS (SWF_Parserstruct * pblock)
{
  int i;
  char name[32];
  struct SWF_EXPORTASSETS *sblock = (struct SWF_EXPORTASSETS *)pblock; printf( "\n" "/*" " " "SWF_EXPORTASSETS" " " "*/" "\n");;

  for (i = 0; i < sblock->Count; i++)
  {
   sprintf (name, "$" "character%d", sblock->Tags[i]);
   printf ("%s" "(" "%s" "," "'" "%s" "'" ")" ";" "\n",
...
{
  struct SWF_FRAMELABEL *sblock = (struct SWF_FRAMELABEL *)pblock; printf( "\n" "/*" " " "SWF_FRAMELABEL" " " "*/" "\n");;
...
{
  char cname[64];
  struct SWF_PLACEOBJECT2 *sblock = (struct SWF_PLACEOBJECT2 *)pblock; printf( "\n" "/*" " " "SWF_PLACEOBJECT2" " " "*/" "\n");;
  ...
  if( sblock->PlaceFlagHasCharacter ) {
    ...
    if(sblock->Depth)
    {
      ...
      printf("/*" " PlaceFlagHasCharacter and Depth == 0! " "*/" "\n");
  }
  if( sblock->PlaceFlagHasMatrix ) {
    printf("/*" " PlaceFlagHasMatrix " "*/" "\n");
    sprintf(cname, "i%d", sblock->Depth );
    if (!spritenum)
    {
...
{
  struct SWF_PROTECT *sblock = (struct SWF_PROTECT *)pblock; printf( "\n" "/*" " " "SWF_PROTECT" " " "*/" "\n");;

  if( sblock->Password == ((void*)0) ) {
   printf ("%s();\n",
...
{
  struct SWF_REMOVEOBJECT *sblock = (struct SWF_REMOVEOBJECT *)pblock; printf( "\n" "/*" " " "SWF_REMOVEOBJECT" " " "*/" "\n");;
  printf ("%s(" "$" "c%d);\n",
...
{
  struct SWF_REMOVEOBJECT2 *sblock = (struct SWF_REMOVEOBJECT2 *)pblock; printf( "\n" "/*" " " "SWF_REMOVEOBJECT2" " " "*/" "\n");;
  printf ("%s(" "$" "i%d);\n",
...
{
  struct SWF_SETBACKGROUNDCOLOR *sblock = (struct SWF_SETBACKGROUNDCOLOR *)pblock; printf( "\n" "/*" " " "SWF_SETBACKGROUNDCOLOR" " " "*/" "\n");;
...
{
  struct SWF_INITACTION *sblock = (struct SWF_INITACTION *)pblock; printf( "\n" "/*" " " "SWF_INITACTION" " " "*/" "\n");;
  ...
  printf ("%s(%s(",
          methodcall (spritenum?spritename:"m", "add"),
          newobj (((void*)0), "InitAction"));



  printf ("%s(\"%s\")));\n",
          newobj (((void*)0), "Action"),
...
outputSWF_VIDEOFRAME (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_VIDEOFRAME *sblock = (struct SWF_VIDEOFRAME *)pblock; printf( "\n" "/*" " " "SWF_VIDEOFRAME" " " "*/" "\n");;

  sprintf (name, "character%d", sblock->StreamID);

  printf ("/*" " Frame %d of stream %d " "*/" "\n",
...
{
  struct SWF_METADATA *sblock = (struct SWF_METADATA *)pblock; printf( "\n" "/*" " " "SWF_METADATA" " " "*/" "\n");;
...
{
  struct SWF_SETTABINDEX *sblock = (struct SWF_SETTABINDEX *)pblock; printf( "\n" "/*" " " "SWF_SETTABINDEX" " " "*/" "\n");;
...
{
  struct SWF_SCRIPTLIMITS *sblock = (struct SWF_SCRIPTLIMITS *)pblock; printf( "\n" "/*" " " "SWF_SCRIPTLIMITS" " " "*/" "\n");;
...
outputSWF_SYMBOLCLASS (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_SYMBOLCLASS *sblock = (struct SWF_SYMBOLCLASS *)pblock; printf( "\n" "/*" " " "SWF_SYMBOLCLASS" " " "*/" "\n");;
...
outputSWF_DEFINESCENEANDFRAMEDATA (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_DEFINESCENEANDFRAMEDATA *sblock = (struct SWF_DEFINESCENEANDFRAMEDATA *)pblock; printf( "\n" "/*" " " "SWF_DEFINESCENEANDFRAMEDATA" " " "*/" "\n");;
...
# 2023 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/outputscript.c"
  if( npending )
