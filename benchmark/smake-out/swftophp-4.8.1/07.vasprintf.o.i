# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/vasprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/vasprintf.c" 2
...
# 2 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/vasprintf.c" 2
...
# 3 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/vasprintf.c" 2
...
vasprintf(char **ret, const char *format, va_list ap)
{
 ...
 while (1)
 {
  ...
  if ((*ret = (char *) realloc(*ret, len)) == ((void*)0))
  {
   free(*ret);
   return -1;
  }
