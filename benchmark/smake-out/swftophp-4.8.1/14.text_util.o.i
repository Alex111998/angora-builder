# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
# 20 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c"
...
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
...
# 23 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
# 1 "./text_util.h" 1
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
# 1 "./movie.h" 1
# 34 "./movie.h"
...
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
# 1 "./blocks/text.h" 1
# 33 "./blocks/text.h"
# 1 "./blocks/output.h" 1
# 34 "./blocks/output.h"
...
void SWFTextRecord_setFontCharacter(SWFTextRecord record, SWFFontCharacter font);
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
# 1 "./blocks/font.h" 1
# 33 "./blocks/font.h"
# 1 "./blocks/rect.h" 1
# 33 "./blocks/rect.h"
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
...
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/text_util.c" 2
...
{
 SWFText_setScaledHeight(text, (int)(floor((Ming_scale*height)+0.5)));
}
...
{
 SWFText_setScaledSpacing(text, (int)(floor((Ming_scale*spacing)+0.5)));
}
...
{
 SWFText_scaledMoveTo(text, (int)(floor((Ming_scale*x)+0.5)), (int)(floor((Ming_scale*y)+0.5)));
}
...
{
 SWFTextField_setScaledBounds(field, (int)(floor((Ming_scale*width)+0.5)),
       (int)(floor((Ming_scale*height)+0.5)));
}
...
{
 SWFTextField_setScaledFontHeight(field, (int)(floor((Ming_scale*height)+0.5)));
}
...
{
 SWFTextField_setScaledFieldHeight(field, (int)(floor((Ming_scale*height)+0.5)));
}
...
{
 SWFTextField_setScaledLeftMargin(field, (int)(floor((Ming_scale*leftMargin)+0.5)));
}
...
{
 SWFTextField_setScaledRightMargin(field, (int)(floor((Ming_scale*rightMargin)+0.5)));
}
...
{
 SWFTextField_setScaledIndentation(field, (int)(floor((Ming_scale*indentation)+0.5)));
}
...
{
 SWFTextField_setScaledLineSpacing(field, (int)(floor((Ming_scale*lineSpacing)+0.5)));
}
...
{
 SWFTextField_setScaledPadding(field, (int)(floor((Ming_scale*padding)+0.5)));
}
