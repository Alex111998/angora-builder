# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
# 33 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 34 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 36 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 37 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 38 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 39 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 40 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
void dumpBuffer(unsigned char *buf, int length);
# 42 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
# 1 "./action.h" 1
# 24 "./action.h"
# 1 "./swftypes.h" 1
# 23 "./swftypes.h"
...
# 43 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 45 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
# 1 "./vasprintf.h" 1

# 1 "../src/ming_config.h" 1
# 3 "./vasprintf.h" 2
# 46 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c" 2
...
# 73 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
static int strsize=0;
static int strmaxsize=0;
static char *dcstr=((void*)0);
static char *dcptr=((void*)0);
...
# 198 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
...
# 235 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
...
# 281 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
struct _stack {
 char type;
...
getString(struct SWF_ACTIONPUSHPARAM *act)
{
 ...
 case PUSH_STRING:
  if (!act->p.String)
  {
          do { if(_SWF_warn) _SWF_warn(("WARNING: Call to getString with NULL string.\n")); } while(0);
          break;
  }
 ...
 case PUSH_DOUBLE:
 {
  ...
  if (needed_length <= 0)
  {
          do { if(_SWF_warn) _SWF_warn(("WARNING: could not evaluate size of buffer (memory issue ?).\n")); } while(0);
          break;
  }
 ...
 case PUSH_CONSTANT:
  ...
  {
          do { if(_SWF_warn) _SWF_warn(("WARNING: retrieving constants not present in the pool.\n")); } while(0);
          break;
  }
...
getName(struct SWF_ACTIONPUSHPARAM *act)
{
 ...
 case PUSH_STRING:
  if (!act->p.String)
  {
          do { if(_SWF_warn) _SWF_warn(("WARNING: Call to getName with NULL string.\n")); } while(0);
          break;
  }
...
pushdup()
{
  ...
  *t->val = *Stack->val;
  ...
  int len = strlen(Stack->val->p.String) + 1;
...
struct SWF_ACTIONPUSHPARAM * pop()
{
 ...
 if( Stack == ((void*)0) ) do { if(_SWF_error) _SWF_error(("Stack blown!! - pop")); } while(0);
...
struct SWF_ACTIONPUSHPARAM * peek()
{
 ...
 if( Stack == ((void*)0) ) do { if(_SWF_error) _SWF_error(("Stack blown!! - peek")); } while(0);
...
# 798 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
static void
...
decompilePUSHPARAM (struct SWF_ACTIONPUSHPARAM *act, int wantstring)
{
 ...
 case PUSH_CONSTANT16:
  if( wantstring ) t=getString(act);
    ...
    free(t);
    break;
# 883 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
 case 12:
 case 11:
 case PUSH_VARIABLE:
...
{
# 1399 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
...
# 2336 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
       ...
       OpCode(actions, n-j+1, maxn) == SWFACTION_STOREREGISTER )
 {
  ...
  if(n+1 >= maxn)
  {
   do { if(_SWF_warn) _SWF_warn(("Warning: %s:%i: something is wrong here\n"), "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c", 2407); } while(0);
  }
  else
  {
   offSave=offseoloop;
        ...
        sact->Actions[sact->numActions-1].SWF_ACTIONJUMP.BranchOffset < 0) )
 {
                ...
                sact->Actions[sact->numActions-1].SWF_ACTIONJUMP.Offset+sact->Actions[sact->numActions-1].SWF_ACTIONJUMP.BranchOffset)
  {
     ...
     do { if(_SWF_warn) _SWF_warn(("WARNING: this might be wrong (%s:%i)\n"), "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c", 2441); } while(0);
     dcputs("if ( ");
     dcputs(getName(pop()));
     println(" ) {");
     decompileActions(sact->numActions, sact->Actions,gIndent+1);
 ...
 }
 {
  ...
  if (sbi==1 && sbe==1)
   ...
   {
    if (OpCode(actions, n+j, maxn) == SWFACTION_JUMP)
    {
...
decompileTRY(int n, SWF_ACTION *actions, int maxn)
{
 ...
 {
  struct SWF_ACTIONPUSHPARAM *rsave=((void*)0);
  { int ii=gIndent; while(--ii>=0) { dcputchar(' '); dcputchar(' '); } }
...
# 2776 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
...
decompileCALLFUNCTION(int n, SWF_ACTION *actions, int maxn)
{
 ...
 if(!(OpCode(actions, n-1, maxn) == SWFACTION_PUSH) ) do { if(_SWF_error) _SWF_error(("SanityCheck failed in %s\n %s\n"), "SWF_CALLMETHOD", "CALLMETHOD not preceeded by PUSH"); } while(0);
...
decompileEXTENDS(int n, SWF_ACTION *actions, int maxn)
{
 ...
 baseclass=pop();
# 3114 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
 println("asm {");
...
# 3533 "/benchmark/RUNDIR-libming-4.8.1/BUILD/util/decompile.c"
 if( Stack != ((void*)0) )
  fprintf(stderr,
