# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 20 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
...
# 21 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
...
# 23 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocklist.h" 1
# 35 "./blocklist.h"
...
void SWFBlockList_resolveCharacterDependencies(SWFBlockList list,
            SWFCharacter character);
# 24 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./displaylist.h" 1
# 34 "./displaylist.h"
...
# 25 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
...
# 27 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/outputblock.h" 1
# 33 "./blocks/outputblock.h"
# 1 "./blocks/output.h" 1
# 34 "./blocks/output.h"
...
# 28 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/sprite.h" 1
# 33 "./blocks/sprite.h"
...
# 29 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/shape.h" 1
# 46 "./blocks/shape.h"
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 30 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/morph.h" 1
# 31 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/button.h" 1
# 34 "./blocks/button.h"
...
# 32 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
# 1 "./blocks/text.h" 1
# 36 "./blocks/text.h"
...
void SWFTextRecord_setFontCharacter(SWFTextRecord record, SWFFontCharacter font);
# 33 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c" 2
...
# 73 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
SWFMovieClip
newSWFMovieClip()
{
...
# 133 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
void
...
# 146 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
SWFSoundInstance
...
SWFMovieClip_add(SWFMovieClip clip, SWFBlock block)
{
 ...
 if ( SWFBlock_isCharacter(block) )
 {
  SWFCharacter_getDependencies((SWFCharacter)block,
                 &((SWFCharacter)(clip))->dependencies,
                 &((SWFCharacter)(clip))->nDependencies);
...
# 258 "/benchmark/RUNDIR-libming-4.8.1/BUILD/src/movieclip.c"
void
