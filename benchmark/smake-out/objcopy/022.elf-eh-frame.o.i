# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c" 2
...
read_value (bfd *abfd, bfd_byte *buf, int width, int is_signed)
{
 ...
 value = ((*((abfd)->xvec->bfd_getx64)) (buf));
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",193); } while (0);
      return 0;
    }
...
write_value (bfd *abfd, bfd_byte *buf, bfd_vma value, int width)
{
  switch (width)
    ...
    default: do { bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",210); } while (0);
    }
}
   ...
   hdr_info->u.compact.entries =
    ...
    hdr_info->u.compact.allocated_entries
      * sizeof (hdr_info->u.compact.entries[0]));
      ...
      do { if (!(hdr_info->u.compact.entries)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",502); } while (0);
    }
...
# 686 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
  buf = ehbuf;
  cie_count = 0;
...
# 969 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) cookie->rel++;
 }
       ...
       || this_inf->make_relative))
 {
  ...
  do { if (!(sec_info->count == num_entries)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1017); } while (0);
  do { if (!(cie_count == num_cies)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1018); } while (0);
...
# 1185 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
    ...
    struct elf_reloc_cookie *cookie)
{
 ...
 if ((sec->flags & 0x100000) != 0 && cookie->rels == ((void*)0))
 ...
 else
   {
     ...
     do { if (!(cookie->rel < cookie->relend && cookie->rel->r_offset == ent->offset + 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1364); } while (0);
      ...
      bfd_vma offset)
{
 ...
 break;
  ...
  do { if (!(lo < hi)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1591); } while (0);
           ...
           asection *sec, bfd_byte *contents)
{
  ...
  do { if (!(sec->sec_info_type == 6)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1659); } while (0);
      ...
      if (addr <= last_addr)
 {
  ...
  do { if (!(sec->size == sec->rawsize + 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1712); } while (0);
  do { if (!((addr & 1) == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1713); } while (0);
  do { if (!(bed->cant_unwind_opcode)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1714); } while (0);
     ...
     bfd_byte *contents)
{
  ...
  ptr_size = (((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)
       ->elf_backend_eh_frame_address_size (abfd, sec));
  do { if (!(ptr_size != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1745); } while (0);
      ...
      if (ent->size == 4)
 {
   ...
   do { if (!(ent == sec_info->entry + sec_info->count - 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1785); } while (0);
   continue;
 }
      ...
      if (ent->cie)
 {
  ...
  {
    do { if (!(action & 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1847); } while (0);
    *aug++ = 'R';
  ...
  switch (*aug++)
    ...
    case 'L':
      if (action & 2)
        {
   do { if (!(*buf == ent->lsda_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1859); } while (0);
   *buf = make_pc_relative (*buf, ptr_size);
   action &= ~2;
    ...
    case 'P':
      ...
      do { if (!(per_width != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1870); } while (0);
      do { if (!(((per_encoding & 0x70) == 0x10) == ent->u.cie.per_encoding_relative)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1872); } while (0);
   ...
   action &= ~4;
    ...
    case 'R':
      if (action & 1)
        {
   do { if (!(*buf == ent->fde_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1900); } while (0);
   *buf = make_pc_relative (*buf, ptr_size);
   action &= ~1;
        }
      buf++;
    ...
    case 'S':
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1909); } while (0);
    }
     }
 }
      else
 {
  ...
  {
  case 0x20:
    do { if (!(hdr_info == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1939); } while (0);
    break;
  case 0x30:
    {
      switch (abfd->arch_info->arch)
        {
        case bfd_arch_ia64:
   do { if (!((((abfd) -> tdata.elf_obj_data) -> gp) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1946); } while (0);
   ...
   (*info->callbacks->einfo)
     (dgettext ("bfd", "%P: DW_EH_PE_datarel unspecified" " for this architecture.\n"));
        ...
        case bfd_arch_frv:
        case bfd_arch_i386:
   do { if (!(htab->hgot != ((void*)0) && ((htab->hgot->root.type == bfd_link_hash_defined) || (htab->hgot->root.type == bfd_link_hash_defweak)))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",1960); } while (0);
  ...
  if ((sec_size % ptr_size) != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c", 2072, __PRETTY_FUNCTION__);
...
# 2107 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
bfd_boolean
_bfd_elf_fixup_eh_frame_hdr (struct bfd_link_info *info)
{
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c", 2146, __PRETTY_FUNCTION__);
...
write_compact_eh_frame_hdr (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (sec->size != 8)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c", 2185, __PRETTY_FUNCTION__);
  ...
  do { if (!(bed->compact_eh_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c",2193); } while (0);
...
# 2222 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-eh-frame.c"
static bfd_boolean
