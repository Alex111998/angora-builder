# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 44 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 45 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 46 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
...
# 47 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
# 1 "./bfd_stdint.h" 1
...
# 8 "./bfd_stdint.h" 2
# 48 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
...
# 51 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c" 2
# 61 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
enum cache_flag {
  CACHE_NORMAL = 0,
  CACHE_NO_OPEN = 1,
  CACHE_NO_SEEK = 2,
...
bfd_cache_max_open (void)
{
  if (max_open_files == 0)
    {
      int max;
# 97 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
      struct rlimit rlim;
...
# 237 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
static FILE *
bfd_cache_lookup_worker (bfd *abfd, enum cache_flag flag)
{
  bfd *orig_bfd = abfd;
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c", 242, __PRETTY_FUNCTION__);
      ...
      if (abfd != bfd_last_cache)
 {
  ...
  if (bfd_open_file (abfd) == ((void*)0))
    ...
    && real_fseek ((FILE *) abfd->iostream, abfd->where, 0) != 0
  ...
  _bfd_error_handler (dgettext ("bfd", "reopening %B: %s\n"),
...
# 302 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
static file_ptr
cache_bread_1 (struct bfd *abfd, void *buf, file_ptr nbytes)
{
  FILE *f;
  file_ptr nread;
# 316 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
  if (nbytes == 0)
    return 0;
  ...
  if (f == ((void*)0))
    return 0;
# 336 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
...
# 380 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
             ...
             bfd_size_type *map_len __attribute__ ((__unused__)))
{
  ...
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c", 454, __PRETTY_FUNCTION__);
...
# 511 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
bfd_boolean
bfd_cache_init (bfd *abfd)
{
  do { if (!(abfd->iostream != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c",514); } while (0);
...
# 542 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
bfd_boolean
...
# 571 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
bfd_boolean
...
# 597 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
FILE *
bfd_open_file (bfd *abfd)
{
 ...
 return ((void*)0);
  ...
  switch (abfd->direction)
    ...
    case read_direction:
    case no_direction:
      abfd->iostream = real_fopen (abfd->filename, "r");
      break;
    case both_direction:
      ...
      if (abfd->opened_once)
 {
   abfd->iostream = real_fopen (abfd->filename, "r+");
   if (abfd->iostream == ((void*)0))
     abfd->iostream = real_fopen (abfd->filename, "w+");
 }
      else
 {
# 645 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cache.c"
   struct stat s;
