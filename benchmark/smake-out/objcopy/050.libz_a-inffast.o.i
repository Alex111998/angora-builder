# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c" 2
...
# 7 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c" 2
# 1 "./inftrees.h" 1
# 24 "./inftrees.h"
typedef struct {
    unsigned char op;
...
# 8 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c" 2
# 1 "./inflate.h" 1
# 20 "./inflate.h"
typedef enum {
    HEAD,
...
# 9 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c" 2
# 1 "./inffast.h" 1
# 11 "./inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 10 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c" 2
# 67 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c"
...
# 215 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/inffast.c"
                    }
                    from = window - 1;
                    if (wnext == 0) {
                        from += wsize - op;
