# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
# 122 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 123 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 124 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 125 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
...
# 126 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
...
# 127 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c" 2
# 142 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c"
...
ihex_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == ':')) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c",573); } while (0);
...
ihex_write_object_contents (bfd *abfd)
{
      ...
      while (count > 0)
 {
       ...
       if (where <= 0xfffff)
  {
    ...
    do { if (!(extbase == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c",800); } while (0);
       ...
       else
  {
   ...
   (dgettext ("bfd", "%s: address 0x%s out of range for Intel Hex file"),
    ((char *) (abfd)->filename), buf);
        bfd_set_error (bfd_error_bad_value);
        return 0;
      }
...
# 958 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/ihex.c"
const bfd_target ihex_vec =
{
  ...
  _bfd_norelocs_get_reloc_upper_bound, _bfd_norelocs_canonicalize_reloc, ((reloc_howto_type *(*) (bfd *, bfd_reloc_code_real_type)) bfd_nullvoidptr), ((reloc_howto_type *(*) (bfd *, const char *)) bfd_nullvoidptr),
  ihex_set_arch_mach, ihex_set_section_contents,
  ihex_sizeof_headers, bfd_generic_get_relocated_section_contents, bfd_generic_relax_section, _bfd_generic_link_hash_table_create, _bfd_generic_link_add_symbols, _bfd_generic_link_just_syms, _bfd_generic_copy_link_hash_symbol_type, _bfd_generic_final_link, _bfd_generic_link_split_section, _bfd_generic_link_check_relocs, bfd_generic_gc_sections, bfd_generic_lookup_section_flags, bfd_generic_merge_sections, bfd_generic_is_group_section, bfd_generic_discard_group, _bfd_generic_section_already_linked, bfd_generic_define_common_symbol,
