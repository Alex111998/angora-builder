# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c" 2
# 45 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c"
# 1 "./coff-i386.c" 1
# 24 "./coff-i386.c"
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
# 1081 "./coffcode.h"
  ...
  if (((struct coff_section_tdata *) (section)->used_by_bfd)->comdat == ((void*)0))
    _bfd_abort ("./coffcode.h", 1130, __PRETTY_FUNCTION__);
  ...
  if (newname == ((void*)0))
    _bfd_abort ("./coffcode.h", 1138, __PRETTY_FUNCTION__);
    ...
    void * scnhdr)
{
 ...
 _bfd_abort ("./coffcode.h", 1908, __PRETTY_FUNCTION__);
    }
 ...
 _bfd_abort ("./coffcode.h", 1917, __PRETTY_FUNCTION__);
    }
 ...
 return;
    ...
    _bfd_error_handler
      (dgettext ("bfd", "%s: warning: claims to have 0xffff relocs, without overflow"),
       ((char *) (abfd)->filename));
}
# 2110 "./coffcode.h"
static bfd_boolean
...
{
  do { if (!(symbol->is_sym)) bfd_assert("./coffcode.h",2587); } while (0);
  do { if (!(! aux->is_sym)) bfd_assert("./coffcode.h",2588); } while (0);
# 2633 "./coffcode.h"
  return 0;
}
# 2669 "./coffcode.h"
   ...
   if (i < count)
     {
       ...
       aux = csym->native + 1;
       do { if (!(! aux->is_sym)) bfd_assert("./coffcode.h",3941); } while (0);
...
# 4474 "./coffcode.h"
 ...
 do { if (!(rec == recend)) bfd_assert("./coffcode.h",4486); } while (0);
      }
...
coff_slurp_line_table (bfd *abfd, asection *asect)
{
  ...
  do { if (!(asect->lineno == ((void*)0))) bfd_assert("./coffcode.h",4573); } while (0);
      ...
      if (func_table != ((void*)0))
 {
   ...
   do { if (!((unsigned int) (p - func_table) == nbr_func)) bfd_assert("./coffcode.h",4700); } while (0);
       ...
       for (i = 0; i < nbr_func; i++)
  {
    ...
    while (old_ptr->line_number != 0);
       ...
       do { if (!((bfd_size_type) (n_cache_ptr - n_lineno_cache) == (amt / sizeof (alent)))) bfd_assert("./coffcode.h",4727); } while (0);
...
coff_slurp_symbol_table (bfd * abfd)
{
      ...
      while (this_index < last_native_index)
 {
   ...
   do { if (!(src->is_sym)) bfd_assert("./coffcode.h",4788); } while (0);
...
{
  _bfd_abort ("./coffcode.h", 5465, __PRETTY_FUNCTION__);
}
# 5518 "./coffcode.h"
static bfd_boolean
...

{
  ...
  bfd_getl64, bfd_getl_signed_64, bfd_putl64,
    ...
    {bfd_false, coff_write_object_contents,
     ...
     pe_bfd_copy_private_bfd_data, ((bfd_boolean (*) (bfd *, struct bfd_link_info *)) bfd_true), _bfd_generic_init_private_section_data, _bfd_pe_bfd_copy_private_section_data, ((bfd_boolean (*) (bfd *, asymbol *, bfd *, asymbol *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), pe_print_private_bfd_data,
...
# 46 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/pei-i386.c" 2
