# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c" 2
# 307 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c"
   ...
   struct bfd_hash_entry *ent)
{
  ...
  for (pph = &table->table[_index]; *pph != ((void*)0); pph = &(*pph)->next)
    if (*pph == ent)
      break;
  if (*pph == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c", 579, __PRETTY_FUNCTION__);
    ...
    struct bfd_hash_entry *nw)
{
      ...
      if (*pph == old)
 {
  ...
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c", 611, __PRETTY_FUNCTION__);
}
...
# 696 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c"
...
# 760 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/hash.c"
struct bfd_strtab_hash *
