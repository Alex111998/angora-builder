# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "./../include/progress.h" 1
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "./../include/fnmatch.h" 1
# 63 "./../include/fnmatch.h"
extern int fnmatch (const char *__pattern, const char *__string, int __flags);
# 30 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "../bfd/elf-bfd.h" 1
# 25 "../bfd/elf-bfd.h"
...
# 31 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
# 1 "../bfd/libcoff.h" 1
# 27 "../bfd/libcoff.h"
# 1 "../bfd/coff-bfd.h" 1
# 27 "../bfd/coff-bfd.h"
...
# 33 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c" 2
...
static asymbol **isympp = ((void*)0);
static asymbol **osympp = ((void*)0);
...
# 143 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
  bfd_vma vma_val;
  bfd_vma lma_val;
  flagword flags;
};
...
static bfd_boolean set_start_set = 0;
...
static bfd_boolean gap_fill_set = 0;
static bfd_byte gap_fill = 0;


static bfd_boolean pad_to_set = 0;
...
static const char * gnu_debuglink_filename = ((void*)0);


static bfd_boolean convert_debugging = 0;
...
static bfd_boolean change_leading_char = 0;


static bfd_boolean remove_leading_char = 0;


static bfd_boolean wildcard = 0;


static bfd_boolean localize_hidden = 0;



static htab_t strip_specific_htab = ((void*)0);
static htab_t strip_unneeded_htab = ((void*)0);
static htab_t keep_specific_htab = ((void*)0);
static htab_t localize_specific_htab = ((void*)0);
static htab_t globalize_specific_htab = ((void*)0);
static htab_t keepglobal_specific_htab = ((void*)0);
static htab_t weaken_specific_htab = ((void*)0);
static struct redefine_node *redefine_sym_list = ((void*)0);
static struct addsym_node *add_sym_list = ((void*)0), **add_sym_tail = &add_sym_list;
static int add_symbols = 0;


static bfd_boolean weaken = 0;


static bfd_boolean keep_file_symbols = 0;
...
static bfd_boolean extract_symbol = 0;
...
{
  {"disable-deterministic-archives", 0, 0, 'U'},
  {"discard-all", 0, 0, 'x'},
  {"discard-locals", 0, 0, 'X'},
  {"enable-deterministic-archives", 0, 0, 'D'},
  {"format", 1, 0, 'F'},
  {"help", 0, 0, 'h'},
  {"info", 0, 0, OPTION_FORMATS_INFO},
  {"input-format", 1, 0, 'I'},
  {"input-target", 1, 0, 'I'},
  {"keep-file-symbols", 0, 0, OPTION_KEEP_FILE_SYMBOLS},
  {"keep-symbol", 1, 0, 'K'},
  {"only-keep-debug", 0, 0, OPTION_ONLY_KEEP_DEBUG},
  {"output-file", 1, 0, 'o'},
  {"output-format", 1, 0, 'O'},
  {"output-target", 1, 0, 'O'},
  {"preserve-dates", 0, 0, 'p'},
  {"remove-section", 1, 0, 'R'},
  {"remove-relocations", 1, 0, OPTION_REMOVE_RELOCS},
  {"strip-all", 0, 0, 's'},
  {"strip-debug", 0, 0, 'S'},
  {"strip-dwo", 0, 0, OPTION_STRIP_DWO},
  {"strip-symbol", 1, 0, 'N'},
  {"strip-unneeded", 0, 0, OPTION_STRIP_UNNEEDED},
  {"target", 1, 0, 'F'},
  {"verbose", 0, 0, 'v'},
  {"version", 0, 0, 'V'},
  {"wildcard", 0, 0, 'w'},
...
{
  {"add-gnu-debuglink", 1, 0, OPTION_ADD_GNU_DEBUGLINK},
  {"add-section", 1, 0, OPTION_ADD_SECTION},
  {"add-symbol", 1, 0, OPTION_ADD_SYMBOL},
  {"adjust-section-vma", 1, 0, OPTION_CHANGE_SECTION_ADDRESS},
  {"adjust-start", 1, 0, OPTION_CHANGE_START},
  {"adjust-vma", 1, 0, OPTION_CHANGE_ADDRESSES},
  {"adjust-warnings", 0, 0, OPTION_CHANGE_WARNINGS},
  {"alt-machine-code", 1, 0, OPTION_ALT_MACH_CODE},
  {"binary-architecture", 1, 0, 'B'},
  {"byte", 1, 0, 'b'},
  {"change-addresses", 1, 0, OPTION_CHANGE_ADDRESSES},
  {"change-leading-char", 0, 0, OPTION_CHANGE_LEADING_CHAR},
  {"change-section-address", 1, 0, OPTION_CHANGE_SECTION_ADDRESS},
  {"change-section-lma", 1, 0, OPTION_CHANGE_SECTION_LMA},
  {"change-section-vma", 1, 0, OPTION_CHANGE_SECTION_VMA},
  {"change-start", 1, 0, OPTION_CHANGE_START},
  {"change-warnings", 0, 0, OPTION_CHANGE_WARNINGS},
  {"compress-debug-sections", 2, 0, OPTION_COMPRESS_DEBUG_SECTIONS},
  {"debugging", 0, 0, OPTION_DEBUGGING},
  {"decompress-debug-sections", 0, 0, OPTION_DECOMPRESS_DEBUG_SECTIONS},
  {"disable-deterministic-archives", 0, 0, 'U'},
  {"discard-all", 0, 0, 'x'},
  {"discard-locals", 0, 0, 'X'},
  {"dump-section", 1, 0, OPTION_DUMP_SECTION},
  {"elf-stt-common", 1, 0, OPTION_ELF_STT_COMMON},
  {"enable-deterministic-archives", 0, 0, 'D'},
  {"extract-dwo", 0, 0, OPTION_EXTRACT_DWO},
  {"extract-symbol", 0, 0, OPTION_EXTRACT_SYMBOL},
  {"file-alignment", 1, 0, OPTION_FILE_ALIGNMENT},
  {"format", 1, 0, 'F'},
  {"gap-fill", 1, 0, OPTION_GAP_FILL},
  {"globalize-symbol", 1, 0, OPTION_GLOBALIZE_SYMBOL},
  {"globalize-symbols", 1, 0, OPTION_GLOBALIZE_SYMBOLS},
  {"heap", 1, 0, OPTION_HEAP},
  {"help", 0, 0, 'h'},
  {"image-base", 1, 0 , OPTION_IMAGE_BASE},
  {"impure", 0, 0, OPTION_IMPURE},
  {"info", 0, 0, OPTION_FORMATS_INFO},
  {"input-format", 1, 0, 'I'},
  {"input-target", 1, 0, 'I'},
  {"interleave", 2, 0, 'i'},
  {"interleave-width", 1, 0, OPTION_INTERLEAVE_WIDTH},
  {"keep-file-symbols", 0, 0, OPTION_KEEP_FILE_SYMBOLS},
  {"keep-global-symbol", 1, 0, 'G'},
  {"keep-global-symbols", 1, 0, OPTION_KEEPGLOBAL_SYMBOLS},
  {"keep-symbol", 1, 0, 'K'},
  {"keep-symbols", 1, 0, OPTION_KEEP_SYMBOLS},
  {"localize-hidden", 0, 0, OPTION_LOCALIZE_HIDDEN},
  {"localize-symbol", 1, 0, 'L'},
  {"localize-symbols", 1, 0, OPTION_LOCALIZE_SYMBOLS},
  {"long-section-names", 1, 0, OPTION_LONG_SECTION_NAMES},
  {"no-adjust-warnings", 0, 0, OPTION_NO_CHANGE_WARNINGS},
  {"no-change-warnings", 0, 0, OPTION_NO_CHANGE_WARNINGS},
  {"only-keep-debug", 0, 0, OPTION_ONLY_KEEP_DEBUG},
  {"only-section", 1, 0, 'j'},
  {"output-format", 1, 0, 'O'},
  {"output-target", 1, 0, 'O'},
  {"pad-to", 1, 0, OPTION_PAD_TO},
  {"prefix-alloc-sections", 1, 0, OPTION_PREFIX_ALLOC_SECTIONS},
  {"prefix-sections", 1, 0, OPTION_PREFIX_SECTIONS},
  {"prefix-symbols", 1, 0, OPTION_PREFIX_SYMBOLS},
  {"preserve-dates", 0, 0, 'p'},
  {"pure", 0, 0, OPTION_PURE},
  {"readonly-text", 0, 0, OPTION_READONLY_TEXT},
  {"redefine-sym", 1, 0, OPTION_REDEFINE_SYM},
  {"redefine-syms", 1, 0, OPTION_REDEFINE_SYMS},
  {"remove-leading-char", 0, 0, OPTION_REMOVE_LEADING_CHAR},
  {"remove-section", 1, 0, 'R'},
  {"remove-relocations", 1, 0, OPTION_REMOVE_RELOCS},
  {"rename-section", 1, 0, OPTION_RENAME_SECTION},
  {"reverse-bytes", 1, 0, OPTION_REVERSE_BYTES},
  {"section-alignment", 1, 0, OPTION_SECTION_ALIGNMENT},
  {"set-section-flags", 1, 0, OPTION_SET_SECTION_FLAGS},
  {"set-start", 1, 0, OPTION_SET_START},
  {"srec-forceS3", 0, 0, OPTION_SREC_FORCES3},
  {"srec-len", 1, 0, OPTION_SREC_LEN},
  {"stack", 1, 0, OPTION_STACK},
  {"strip-all", 0, 0, 'S'},
  {"strip-debug", 0, 0, 'g'},
  {"strip-dwo", 0, 0, OPTION_STRIP_DWO},
  {"strip-symbol", 1, 0, 'N'},
  {"strip-symbols", 1, 0, OPTION_STRIP_SYMBOLS},
  {"strip-unneeded", 0, 0, OPTION_STRIP_UNNEEDED},
  {"strip-unneeded-symbol", 1, 0, OPTION_STRIP_UNNEEDED_SYMBOL},
  {"strip-unneeded-symbols", 1, 0, OPTION_STRIP_UNNEEDED_SYMBOLS},
  {"subsystem", 1, 0, OPTION_SUBSYSTEM},
  {"target", 1, 0, 'F'},
  {"update-section", 1, 0, OPTION_UPDATE_SECTION},
  {"verbose", 0, 0, 'v'},
  {"version", 0, 0, 'V'},
  {"weaken", 0, 0, OPTION_WEAKEN},
  {"weaken-symbol", 1, 0, 'W'},
  {"weaken-symbols", 1, 0, OPTION_WEAKEN_SYMBOLS},
  {"wildcard", 0, 0, 'w'},
  {"writable-text", 0, 0, OPTION_WRITABLE_TEXT},
  {0, 0, 0, 0}
};
...
{
  fprintf (stream, gettext ("Usage: %s [option(s)] in-file [out-file]\n"), program_name);
  fprintf (stream, gettext (" Copies a binary file, possibly transforming it in the process\n"));
  fprintf (stream, gettext (" The options are:\n"));
  fprintf (stream, gettext ("  -I --input-target <bfdname>      Assume input file is in format <bfdname>\n  -O --output-target <bfdname>     Create an output file in format <bfdname>\n  -B --binary-architecture <arch>  Set output arch, when input is arch-less\n  -F --target <bfdname>            Set both input and output format to <bfdname>\n     --debugging                   Convert debugging information, if possible\n  -p --preserve-dates              Copy modified/access timestamps to the output\n"));
  ...
  if (0)
    fprintf (stream, gettext ("  -D --enable-deterministic-archives\n                                   Produce deterministic output when stripping archives (default)\n  -U --disable-deterministic-archives\n                                   Disable -D behavior\n"));
...
{
  fprintf (stream, gettext ("Usage: %s <option(s)> in-file(s)\n"), program_name);
  fprintf (stream, gettext (" Removes symbols and sections from files\n"));
  fprintf (stream, gettext (" The options are:\n"));
  fprintf (stream, gettext ("  -I --input-target=<bfdname>      Assume input file is in format <bfdname>\n  -O --output-target=<bfdname>     Create an output file in format <bfdname>\n  -F --target=<bfdname>            Set both input and output format to <bfdname>\n  -p --preserve-dates              Copy modified/access timestamps to the output\n"));
  ...
  fprintf (stream, gettext ("  -R --remove-section=<name>       Also remove section <name> from the output\n     --remove-relocations <name>   Remove relocations from section <name>\n  -s --strip-all                   Remove all symbol and relocation information\n  -g -S -d --strip-debug           Remove all debugging symbols & sections\n     --strip-dwo                   Remove all DWO sections\n     --strip-unneeded              Remove all symbols not needed by relocations\n     --only-keep-debug             Strip everything but the debug information\n  -N --strip-symbol=<name>         Do not copy symbol <name>\n  -K --keep-symbol=<name>          Do not strip symbol <name>\n     --keep-file-symbols           Do not strip file symbol(s)\n  -w --wildcard                    Permit wildcard in symbol comparison\n  -x --discard-all                 Remove all non-global symbols\n  -X --discard-locals              Remove any compiler-generated symbols\n  -v --verbose                     List all object files modified\n  -V --version                     Display this program's version number\n  -h --help                        Display this output\n     --info                        List object formats & architectures supported\n  -o <file>                        Place stripped output into <file>\n"));
# 694 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
  list_supported_targets (program_name, stream);
  if ("<http://www.sourceware.org/bugzilla/>"[0] && exit_status == 0)
    fprintf (stream, gettext ("Report bugs to %s\n"), "<http://www.sourceware.org/bugzilla/>");
  exit (exit_status);
...
parse_flags (const char *s)
{
      ...
      else
 {
   ...
   ++snext;
      ...
      else if (strncasecmp ("alloc", s, len) == 0) ret |= 0x001;
      else if (strncasecmp ("load", s, len) == 0) ret |= 0x002;
      else if (strncasecmp ("noload", s, len) == 0) ret |= 0x200;
      else if (strncasecmp ("readonly", s, len) == 0) ret |= 0x008;
      else if (strncasecmp ("debug", s, len) == 0) ret |= 0x2000;
      else if (strncasecmp ("code", s, len) == 0) ret |= 0x010;
      else if (strncasecmp ("data", s, len) == 0) ret |= 0x020;
      else if (strncasecmp ("rom", s, len) == 0) ret |= 0x040;
      else if (strncasecmp ("share", s, len) == 0) ret |= 0x8000000;
      else if (strncasecmp ("contents", s, len) == 0) ret |= 0x100;
      else if (strncasecmp ("merge", s, len) == 0) ret |= 0x800000;
      else if (strncasecmp ("strings", s, len) == 0) ret |= 0x1000000;
      ...
      else
 {
   ...
   strncpy (copy, s, len);
   copy[len] = '\0';
   non_fatal (gettext ("unrecognized section flag `%s'"), copy);
   fatal (gettext ("supported flags: %s"),
...
# 791 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
      if (0) ;
      else if (len == sizeof "local" - 1 && strncasecmp ("local", s, len) == 0) ret |= (1 << 0);
      else if (len == sizeof "global" - 1 && strncasecmp ("global", s, len) == 0) ret |= (1 << 1);
      else if (len == sizeof "export" - 1 && strncasecmp ("export", s, len) == 0) ret |= (1 << 1);
      else if (len == sizeof "debug" - 1 && strncasecmp ("debug", s, len) == 0) ret |= (1 << 2);
      else if (len == sizeof "function" - 1 && strncasecmp ("function", s, len) == 0) ret |= (1 << 3);
      else if (len == sizeof "weak" - 1 && strncasecmp ("weak", s, len) == 0) ret |= (1 << 7);
      else if (len == sizeof "section" - 1 && strncasecmp ("section", s, len) == 0) ret |= (1 << 8);
      else if (len == sizeof "constructor" - 1 && strncasecmp ("constructor", s, len) == 0) ret |= (1 << 11);
      else if (len == sizeof "warning" - 1 && strncasecmp ("warning", s, len) == 0) ret |= (1 << 12);
      else if (len == sizeof "indirect" - 1 && strncasecmp ("indirect", s, len) == 0) ret |= (1 << 13);
      else if (len == sizeof "file" - 1 && strncasecmp ("file", s, len) == 0) ret |= (1 << 14);
      else if (len == sizeof "object" - 1 && strncasecmp ("object", s, len) == 0) ret |= (1 << 16);
      else if (len == sizeof "synthetic" - 1 && strncasecmp ("synthetic", s, len) == 0) ret |= (1 << 21);
      else if (len == sizeof "indirect-function" - 1 && strncasecmp ("indirect-function", s, len) == 0) ret |= (1 << 22) | (1 << 3);
      else if (len == sizeof "unique-object" - 1 && strncasecmp ("unique-object", s, len) == 0) ret |= (1 << 23) | (1 << 16);
      else if (len >= sizeof "before=" && strncasecmp ("before=", s, sizeof "before=" - 1) == 0) *other = xstrndup (s + sizeof "before=" - 1, len - sizeof "before=" + 1);
      ...
      else
 {
   ...
   strncpy (copy, s, len);
   copy[len] = '\0';
   non_fatal (gettext ("unrecognized symbol flag `%s'"), copy);
   fatal (gettext ("supported flags: %s"),
...
# 859 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
static struct section_list *
find_section_list (const char *name, bfd_boolean add, unsigned int context)
{
  struct section_list *p, *match = ((void*)0);
      ...
      if (add)
 {
   if (strcmp (p->pattern, name) == 0)
    ...
    || ((context & (1 << 0))
        && (p->context & (1 << 1))))
  fatal (gettext ("error: %s both copied and removed"), name);

       if (((p->context & (1 << 2))
    && (context & (1 << 3)))
    || ((context & (1 << 2))
        && (context & (1 << 3))))
  fatal (gettext ("error: %s both sets and alters VMA"), name);

       if (((p->context & (1 << 4))
    && (context & (1 << 5)))
    || ((context & (1 << 4))
        && (context & (1 << 5))))
  fatal (gettext ("error: %s both sets and alters LMA"), name);
...
{
  return htab_create_alloc (16, htab_hash_string, eq_string, ((void*)0), xcalloc, free);
}
...
add_specific_symbols (const char *filename, htab_t htab)
{
  ...
  f = fopen (filename, "r");
  if (f == ((void*)0))
    fatal (gettext ("cannot open '%s': %s"), filename, strerror ((*__errno_location ())));

  if (fread (buffer, 1, size, f) == 0 || ferror (f))
    fatal (gettext ("%s: fread failed"), filename);
      ...
      if (! ((* name_end) == '\n' || (* name_end) == '\r' || (* name_end) == '\0'))
 {
   ...
   for (extra = name_end + 1; ((* extra) == ' ' || (* extra) == '\t'); extra ++)
     ;

   if (! ((* extra) == '\n' || (* extra) == '\r' || (* extra) == '\0'))
     non_fatal (gettext ("%s:%d: Ignoring rubbish found on this line"),
         filename, line_count);
 }
...
is_specified_symbol (const char *name, htab_t htab)
{
  ...
  return htab_find (htab, name) != ((void*)0);
}
...
group_signature (asection *group)
{
  ...
  ghdr = &((struct bfd_elf_section_data*)(group)->used_by_bfd)->this_hdr;
  if (ghdr->sh_link < (((abfd) -> tdata.elf_obj_data) -> num_elf_sections))
    {
      ...
      Elf_Internal_Shdr *symhdr = (((abfd) -> tdata.elf_obj_data) -> elf_sect_ptr) [ghdr->sh_link];
...
static bfd_boolean
is_dwo_section (bfd *abfd __attribute__ ((__unused__)), asection *sec)
{
  const char *name = ((void) abfd, (sec)->name);
  int len = strlen (name);
...
static bfd_boolean
is_update_section (bfd *abfd __attribute__ ((__unused__)), asection *sec)
{
  if (update_sections != ((void*)0))
    {
...
static bfd_boolean
is_strip_section_1 (bfd *abfd __attribute__ ((__unused__)), asection *sec)
{
  if (sections_removed || sections_copied)
    {
      ...
      p = find_section_list (((void) abfd, (sec)->name), 0,
        (1 << 0));
      q = find_section_list (((void) abfd, (sec)->name), 0,
        (1 << 1));

      if (p && q)
 fatal (gettext ("error: section %s matches both remove and copy options"),
        ((void) abfd, (sec)->name));
      if (p && is_update_section (abfd, sec))
 fatal (gettext ("error: section %s matches both update and remove options"),
        ((void) abfd, (sec)->name));

      if (p != ((void*)0))
 return 1;
      if (sections_copied && q == ((void*)0))
 return 1;
    }

  if ((((void) abfd, (sec)->flags) & 0x2000) != 0)
    {
   ...
   || convert_debugging)
 {
   ...
   if (strcmp (((void) abfd, (sec)->name), ".reloc") != 0)
     return 1;
 }
...
static bfd_boolean
is_strip_section (bfd *abfd __attribute__ ((__unused__)), asection *sec)
{
  if (is_strip_section_1 (abfd, sec))
    return 1;

  if ((((void) abfd, (sec)->flags) & 0x2000000) != 0)
    {
      asymbol *gsym;
      const char *gname;
      asection *elt, *first;
...
is_nondebug_keep_contents_section (bfd *ibfd, asection *isection)
{
  ...
  if (ibfd->xvec->flavour == bfd_target_elf_flavour)
    return ((((struct bfd_elf_section_data*)(isection)->used_by_bfd)->this_hdr.sh_type) == 7);
  ...
  if (ibfd->xvec->flavour == bfd_target_coff_flavour)
    return (strcmp (((void) ibfd, (isection)->name), ".buildid") == 0);
...
is_hidden_symbol (asymbol *sym)
{
  ...
  elf_sym = (((sym)->the_bfd->xvec->flavour == bfd_target_elf_flavour && (sym)->the_bfd->tdata.elf_obj_data != 0) ? (elf_symbol_type *) (sym) : 0);
  if (elf_sym != ((void*)0))
    switch (((elf_sym->internal_elf_sym.st_other) & 0x3))
      {
      case 2:
      case 1:
 return 1;
...
{
  asymbol *sym = ((*((obfd)->xvec->_bfd_make_empty_symbol)) (obfd));
  ...
  if (ptr->section)
    {
      ...
      if (!sec)
 fatal (gettext ("Section %s not found"), ptr->section);
      sym->section = sec;
    }
  else
  ...
  asymbol **isyms, long symcount)
{
  ...
  int relocatable = (abfd->flags & (0x02 | 0x40)) == 0;
  ...
  for (; src_count < symcount; src_count++)
    {
      ...
      bfd_boolean keep;
      bfd_boolean used_in_reloc = 0;
      bfd_boolean undefined;
      bfd_boolean rem_leading_char;
      bfd_boolean add_leading_char;

      undefined = ((((sym)->section)) == (&_bfd_std_section[1]));
      ...
      if (redefine_sym_list || section_rename_list)
 {
   ...
   if (new_name == name
       && (flags & (1 << 8)) != 0)
     new_name = (char *) find_section_rename (name, ((void*)0));
   ((sym)->name) = new_name;
   name = new_name;
 }
      ...
      rem_leading_char =
 (name[0] == ((abfd)->xvec->symbol_leading_char))
 && (change_leading_char
     || (remove_leading_char
  && ((flags & ((1 << 1) | (1 << 7))) != 0
      || undefined
      ...
      add_leading_char =
 change_leading_char
 && (((obfd)->xvec->symbol_leading_char) != '\0')
 && (((abfd)->xvec->symbol_leading_char) == '\0'
     || (name[0] == ((abfd)->xvec->symbol_leading_char)));


      if (rem_leading_char && add_leading_char && !prefix_symbols_string)
 {
   name[0] = ((obfd)->xvec->symbol_leading_char);
   ((sym)->name) = name;
   rem_leading_char = 0;
   add_leading_char = 0;
 }
      ...
      if (add_leading_char || prefix_symbols_string)
 {
   ...
   ptr = n = (char *) xmalloc (1 + strlen (prefix_symbols_string)
          + strlen (name) + 1);
   if (add_leading_char)
     *ptr++ = ((obfd)->xvec->symbol_leading_char);
 ...
 keep = (strip_symbols != STRIP_DEBUG
  && strip_symbols != STRIP_UNNEEDED
  && ! convert_debugging);
      else if (((((abfd)->xvec->flavour) == bfd_target_coff_flavour && ((struct coff_section_tdata *) (((sym)->section))->used_by_bfd) != ((void*)0)) ? ((struct coff_section_tdata *) (((sym)->section))->used_by_bfd)->comdat : ((void*)0)))
      ...
      if (keep && is_specified_symbol (name, strip_specific_htab))
 {
   ...
   if (used_in_reloc)
     {
       non_fatal (gettext ("not stripping symbol `%s' because it is named in a relocation"), name);
       status = 1;
     }
   else
     keep = 0;
 ...
 keep = 0;
      ...
      if (!keep
   && ((keep_file_symbols && (flags & (1 << 14)))
       || is_specified_symbol (name, keep_specific_htab)))
 keep = 1;

      if (keep && is_strip_section (abfd, ((sym)->section)))
 keep = 0;
      ...
      for (src_count = 0; src_count < add_symbols; src_count++)
 {
  ...
  fatal (gettext ("'before=%s' not found"), ptr->othersym);
     }
   else
     to[dst_count++] = create_new_symbol (ptr, obfd);
...
redefine_list_append (const char *cause, const char *source, const char *target)
{
  ...
  for (p = &redefine_sym_list; (list = *p) != ((void*)0); p = &list->next)
    {
      if (strcmp (source, list->source) == 0)
 fatal (gettext ("%s: Multiple redefinition of symbol \"%s\""),
        cause, source);

      if (strcmp (target, list->target) == 0)
 fatal (gettext ("%s: Symbol \"%s\" is target of more than one redefinition"),
        cause, target);
    }
...
add_redefine_syms_file (const char *filename)
{
  ...
  if (file == ((void*)0))
    fatal (gettext ("couldn't open symbol redefinition file %s (error: %s)"),
 ...
 fatal (gettext ("%s:%d: garbage found at end of line"), filename, lineno);
    comment:
      if (len != 0 && (outsym_off == 0 || outsym_off == len))
 fatal (gettext ("%s:%d: missing new symbol name"), filename, lineno);
      buf[len++] = '\0';
 ...
 c = getc (file);
  ...
  if (len != 0)
    fatal (gettext ("%s:%d: premature end of file"), filename, lineno);
...
copy_unknown_object (bfd *ibfd, bfd *obfd)
{
  ...
  if (((*((ibfd)->xvec->_bfd_stat_arch_elt)) (ibfd, &buf)) != 0)
    {
      bfd_nonfatal_message (((void*)0), ibfd, ((void*)0), ((void*)0));
      return 0;
    }
  ...
  if (size < 0)
    {
      non_fatal (gettext ("stat returns negative size for `%s'"),
   bfd_get_archive_filename (ibfd));
      return 0;
    }

  if (bfd_seek (ibfd, (file_ptr) 0, 0) != 0)
    {
  ...
  if (verbose)
    printf (gettext ("copy from `%s' [unknown] to `%s' [unknown]\n"),
     bfd_get_archive_filename (ibfd), ((char *) (obfd)->filename));

  cbuf = (char *) xmalloc (8192);
  ncopied = 0;
  while (ncopied < size)
    {
      tocopy = size - ncopied;
   ...
   != (bfd_size_type) tocopy)
 {
   ...
   != (bfd_size_type) tocopy)
 {
   bfd_nonfatal_message (((void*)0), obfd, ((void*)0), ((void*)0));
   free (cbuf);
   return 0;
 }
  ...
  chmod (((char *) (obfd)->filename), buf.st_mode | 0400);
  free (cbuf);
  return 1;
}
...
copy_object (bfd *ibfd, bfd *obfd, const bfd_arch_info_type *input_arch)
{
  bfd_vma start;
  long symcount;
  asection **osections = ((void*)0);
  asection *gnu_debuglink_section = ((void*)0);
  bfd_size_type *gaps = ((void*)0);
  ...
  if (ibfd->xvec->byteorder != obfd->xvec->byteorder
      ...
      && obfd->xvec->byteorder != BFD_ENDIAN_UNKNOWN)
    {
      ...
      non_fatal (gettext ("Unable to change endianness of input file(s)"));
      return 0;
    }

  if (!bfd_set_format (obfd, ((ibfd)->format)))
    {
      bfd_nonfatal_message (((void*)0), obfd, ((void*)0), ((void*)0));
      return 0;
    }

  if (ibfd->sections == ((void*)0))
    {
      non_fatal (gettext ("error: the input file '%s' has no sections"),
   bfd_get_archive_filename (ibfd));
      return 0;
    }
 ...
 {
   non_fatal (gettext ("--compress-debug-sections=[zlib|zlib-gnu|zlib-gabi] is unsupported on `%s'"),
       bfd_get_archive_filename (ibfd));
   return 0;
 }
 ...
 {
   non_fatal (gettext ("--elf-stt-common=[yes|no] is unsupported on `%s'"),
       bfd_get_archive_filename (ibfd));
   return 0;
 }
    }
  ...
  if (verbose)
    printf (gettext ("copy from `%s' [%s] to `%s' [%s]\n"),
     bfd_get_archive_filename (ibfd), ((ibfd)->xvec->name),
     ((char *) (obfd)->filename), ((obfd)->xvec->name));
 ...
 start = ((ibfd)->start_address);
      start += change_start;
    }



  if (((obfd)->format) != bfd_core)
    {
      flagword flags;
   ...
   || !bfd_set_file_flags (obfd, flags))
 {
  ...
  if (input_arch)
    {
      if (bfd_get_arch_info (ibfd) == ((void*)0)
 ...
 non_fatal (gettext ("Input file `%s' ignores binary architecture parameter."),
     bfd_get_archive_filename (ibfd));
    }
  if (!((*((obfd)->xvec->_bfd_set_arch_mach)) (obfd, iarch, imach))
      && (ibfd->target_defaulted
   || bfd_get_arch (ibfd) != bfd_get_arch (obfd)))
    {
      if (bfd_get_arch (ibfd) == bfd_arch_unknown)
 non_fatal (gettext ("Unable to recognise the format of the input file `%s'"),
     bfd_get_archive_filename (ibfd));
      else
 non_fatal (gettext ("Output file cannot represent architecture `%s'"),
  ...
  if (((obfd)->xvec->flavour) == bfd_target_coff_flavour
      && ((strncmp (((obfd)->xvec->name), ("pei-"), sizeof ("pei-") - 1) == 0)))
    {

      pe_data_type *pe = ((obfd)->tdata.pe_obj_data);


      if (ibfd->xvec->flavour == bfd_target_coff_flavour
   && ((strncmp (((ibfd)->xvec->name), ("pei-"), sizeof ("pei-") - 1) == 0)))
      ...
      if (pe_file_alignment > pe_section_alignment)
 {
   ...
   sprintf (file_alignment, "%016" "l" "x", pe_file_alignment);
   sprintf (section_alignment, "%016" "l" "x", pe_section_alignment);
   non_fatal (gettext ("warning: file alignment (0x%s) > section alignment (0x%s)"),
  ...
  symsize = ((*((ibfd)->xvec->_bfd_get_symtab_upper_bound)) (ibfd));
  if (symsize < 0)
    {
      bfd_nonfatal_message (((void*)0), ibfd, ((void*)0), ((void*)0));
      return 0;
  ...
  symcount = ((*((ibfd)->xvec->_bfd_canonicalize_symtab)) (ibfd, isympp));
  if (symcount < 0)
    {
      bfd_nonfatal_message (((void*)0), ibfd, ((void*)0), ((void*)0));
      return 0;
  ...
  if (add_sections != ((void*)0))
    {
      struct section_add *padd;
      struct section_list *pset;

      for (padd = add_sections; padd != ((void*)0); padd = padd->next)
 {
   flagword flags;

   pset = find_section_list (padd->name, 0,
        (1 << 6));
   if (pset != ((void*)0))
     flags = pset->flags | 0x100;
   else
     flags = 0x100 | 0x008 | 0x020;



   if (bfd_get_section_by_name (obfd, padd->name))
     {
       bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
        gettext ("can't add section '%s'"), padd->name);
       return 0;
     }
   else
     {
  ...
  (obfd, padd->name, flags | 0x100000);
       if (padd->section == ((void*)0))
  {
    bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
     gettext ("can't create section `%s'"),
     padd->name);
    return 0;
  }
     }
   ...
   if (! bfd_set_section_size (obfd, padd->section, padd->size))
     {
       bfd_nonfatal_message (((void*)0), obfd, padd->section, ((void*)0));
       return 0;
     }
    ...
    pupdate = pupdate->next)
 {
   ...
   if (pupdate->section == ((void*)0))
     {
       non_fatal (gettext ("error: %s not found, can't be updated"), pupdate->name);
       return 0;
     }
   ...
   if (! bfd_set_section_size (obfd, osec, pupdate->size))
     {
       bfd_nonfatal_message (((void*)0), obfd, osec, ((void*)0));
       return 0;
     }
 }
    }

  if (dump_sections != ((void*)0))
    {
      struct section_add * pdump;

      for (pdump = dump_sections; pdump != ((void*)0); pdump = pdump->next)
 {
   asection * sec;
   ...
   if (sec == ((void*)0))
     {
       bfd_nonfatal_message (((void*)0), ibfd, ((void*)0),
        gettext ("can't dump section '%s' - it does not exist"),
        pdump->name);
       continue;
     }

   if ((((void) ibfd, (sec)->flags) & 0x100) == 0)
     {
       bfd_nonfatal_message (((void*)0), ibfd, sec,
        gettext ("can't dump section - it has no contents"));
       continue;
     }
   ...
   if (size == 0)
     {
       bfd_nonfatal_message (((void*)0), ibfd, sec,
        gettext ("can't dump section - it is empty"));
       continue;
     }

   FILE * f;
   f = fopen (pdump->filename, "w");
   if (f == ((void*)0))
     {
       bfd_nonfatal_message (pdump->filename, ((void*)0), ((void*)0),
        gettext ("could not open section dump file"));
       continue;
     }
  ...
  {
    non_fatal (gettext ("error writing section contents to %s (error: %s)"),
        pdump->filename,
    ...
    return 0;
     ...
     bfd_nonfatal_message (((void*)0), ibfd, sec,
      gettext ("could not retrieve section contents"));
  ...
  if (gnu_debuglink_filename != ((void*)0))
    {
 ...
 {
   non_fatal (gettext ("%s: debuglink section already exists"),
       ((char *) (obfd)->filename));
   gnu_debuglink_filename = ((void*)0);
 }
      else
 {
   ...
   if (gnu_debuglink_section == ((void*)0))
     {
       bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
        gettext ("cannot create debug link section `%s'"),
   ...
   if (((obfd)->xvec->flavour) == bfd_target_coff_flavour)
     {
       ...
       asection * sec;
# 2251 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
       for (sec = obfd->sections, highest_section = ((void*)0);
     sec != ((void*)0);
     sec = sec->next)
  if (sec->vma > 0
      && (highest_section == ((void*)0)
   || sec->vma > highest_section->vma))
    highest_section = sec;

       if (highest_section)
  debuglink_vma = ((((bfd_vma) (highest_section->vma + highest_section->size) + (0x1000) - 1) >= (bfd_vma) (highest_section->vma + highest_section->size)) ? (((bfd_vma) (highest_section->vma + highest_section->size) + ((0x1000) - 1)) & ~ (bfd_vma) ((0x1000)-1)) : ~ (bfd_vma) 0);
# 2269 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
       else
   ...
   for (i = 0; i < c - 1; i++)
     {
       ...
       flags = ((void) obfd, (osections[i])->flags);
       if ((flags & 0x100) == 0
    || (flags & 0x002) == 0)
  continue;

       size = ((osections[i])->size);
       gap_start = ((osections[i])->lma) + size;
       gap_stop = ((osections[i + 1])->lma);
       if (gap_start < gap_stop)
  {
    if (! bfd_set_section_size (obfd, osections[i],
           size + (gap_stop - gap_start)))
      {
        bfd_nonfatal_message (((void*)0), obfd, osections[i],
         gettext ("Can't fill gap after section"));
        status = 1;
        break;
      }
      ...
      if (pad_to_set)
 {
   ...
   lma = ((osections[c - 1])->lma);
   size = ((osections[c - 1])->size);
   if (lma + size < pad_to)
     {
       if (! bfd_set_section_size (obfd, osections[c - 1],
       pad_to - lma))
  {
    bfd_nonfatal_message (((void*)0), obfd, osections[c - 1],
     gettext ("can't add padding"));
    status = 1;
  }
       else
  {
  ...
  if (convert_debugging)
    dhandle = read_debugging_info (ibfd, isympp, symcount, 0);
  ...
  if (strip_symbols == STRIP_DEBUG
      ...
      || add_symbols)
    {
# 2397 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
      if (strip_symbols != STRIP_ALL)
 bfd_map_over_sections (ibfd,
  ...
  if (convert_debugging && dhandle != ((void*)0))
    {
 ...
 {
   bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
    gettext ("cannot fill debug link section `%s'"),
    gnu_debuglink_filename);
   return 0;
 }
    }
      ...
      for (i = 0; i < c; i++)
 {
       ...
       while (left > 0)
  {
    ...
    if (! bfd_set_section_contents (obfd, osections[i], buf,
        off, now))
      {
        bfd_nonfatal_message (((void*)0), obfd, osections[i], ((void*)0));
        return 0;
      }
  ...
  if (! ((*((obfd)->xvec->_bfd_copy_private_bfd_data)) (ibfd, obfd)))
    {
      bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
       gettext ("error copying private BFD data"));
      return 0;
    }
 ...
 {
   non_fatal (gettext ("this target does not support %lu alternative machine codes"),
       use_alt_mach_code);
   if (((obfd)->xvec->flavour) == bfd_target_elf_flavour)
     {
       non_fatal (gettext ("treating that number as an absolute e_machine value instead"));
       (((obfd) -> tdata.elf_obj_data) -> elf_header)->e_machine = use_alt_mach_code;
     }
   else
     non_fatal (gettext ("ignoring the alternative value"));
 }
    }
       ...
       const bfd_arch_info_type *input_arch)
{
  ...
  dir = make_tempdir (((char *) (obfd)->filename));
  if (dir == ((void*)0))
    fatal (gettext ("cannot create tempdir for archive copying (error: %s)"),
    strerror ((*__errno_location ())));
  ...
  this_element = bfd_openr_next_archived_file (ibfd, ((void*)0));
  ...
  while (!status && this_element != ((void*)0))
    {
      char *output_name;
      bfd *output_bfd;
      bfd *last_element;
      ...
      if (! is_valid_archive_path (((char *) (this_element)->filename)))
 {
   non_fatal (gettext ("illegal pathname found in archive member: %s"),
       ((char *) (this_element)->filename));
   status = 1;
   goto cleanup_and_exit;
 }
      ...
      output_name = concat (dir, "/",
       ((char *) (this_element)->filename), (char *) 0);
      ...
      if (stat (output_name, &buf) >= 0)
 {
   ...
   if (output_name == ((void*)0))
     {
       non_fatal (gettext ("cannot create tempdir for archive copying (error: %s)"),
    strerror ((*__errno_location ())));
       status = 1;
       goto cleanup_and_exit;
     }
   ...
   output_name = concat (output_name, "/",
    ((char *) (this_element)->filename), (char *) 0);
      ...
      if (preserve_dates)
 {
   stat_status = ((*((this_element)->xvec->_bfd_stat_arch_elt)) (this_element, &buf));

   if (stat_status != 0)
     non_fatal (gettext ("internal stat error on %s"),
         ((char *) (this_element)->filename));
 }
      ...
      if (!ok_object)
 bfd_nonfatal_message (((void*)0), this_element, ((void*)0),
         gettext ("Unable to recognise the format of file"));
 ...
 output_bfd = bfd_openw (output_name, ((this_element)->xvec->name));

      if (output_bfd == ((void*)0))
 {
   bfd_nonfatal_message (output_name, ((void*)0), ((void*)0), ((void*)0));
   status = 1;
   goto cleanup_and_exit;
 }
  ...
  *ptr = ((void*)0);
  ...
  filename = ((char *) (obfd)->filename);
  if (!bfd_close (obfd))
    {
      status = 1;
      bfd_nonfatal_message (filename, ((void*)0), ((void*)0), ((void*)0));
    }

  filename = ((char *) (ibfd)->filename);
  if (!bfd_close (ibfd))
    {
      status = 1;
      bfd_nonfatal_message (filename, ((void*)0), ((void*)0), ((void*)0));
...
set_long_section_mode (bfd *output_bfd, bfd *input_bfd, enum long_section_name_handling style)
{
  ...
  if (((output_bfd)->xvec->flavour) == bfd_target_coff_flavour)
    {
      if (style == KEEP
   && ((input_bfd)->xvec->flavour) == bfd_target_coff_flavour)
 style = (((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_long_section_names) ? ENABLE : DISABLE;
      ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_set_long_section_names) (output_bfd, style != DISABLE));
    }
}
    ...
    const bfd_arch_info_type *input_arch)
{
  ...
  if (size < 1)
    {
      if (size == 0)
 non_fatal (gettext ("error: the input file '%s' is empty"),
     input_filename);
      status = 1;
      return;
    }
  ...
  if (ibfd == ((void*)0))
    {
      bfd_nonfatal_message (input_filename, ((void*)0), ((void*)0), ((void*)0));
      status = 1;
      return;
    }
      ...
      if (output_target == ((void*)0))
 {
   ...
   force_output_target = 0;
 }
      else
 force_output_target = 1;

      obfd = bfd_openw (output_filename, output_target);
      if (obfd == ((void*)0))
 {
   bfd_nonfatal_message (output_filename, ((void*)0), ((void*)0), ((void*)0));
   status = 1;
   return;
 }
      ...
      flagword flags)
{
  ...
  for (srename = section_rename_list; srename != ((void*)0); srename = srename->next)
 ...
 fatal (gettext ("Multiple renames of section %s"), old_name);
      }
...
find_section_rename (const char *old_name, flagword *returned_flags)
{
  ...
  for (srename = section_rename_list; srename != ((void*)0); srename = srename->next)
    if (strcmp (srename->old_name, old_name) == 0)
      {
 if (returned_flags != ((void*)0) && srename->flags != (flagword) -1)
...
setup_bfd_headers (bfd *ibfd, bfd *obfd)
{
  ...
  if (! ((*((obfd)->xvec->_bfd_copy_private_header_data)) (ibfd, obfd)))
    {
      status = 1;
      bfd_nonfatal_message (((void*)0), ibfd, ((void*)0),
       gettext ("error in private header data"));
      return;
    }
...
setup_section (bfd *ibfd, sec_ptr isection, void *obfdarg)
{
  ...
  name = ((isection)->name);
  flags = ((void) ibfd, (isection)->flags);
  name = find_section_rename (name, &flags);


  if ((prefix_alloc_sections_string)
      && (((void) ibfd, (isection)->flags) & 0x001))
  ...
  p = find_section_list (((isection)->name), 0,
    (1 << 6));
  if (p != ((void*)0))
    flags = p->flags | (flags & (0x100 | 0x004));
  else if (strip_symbols == STRIP_NONDEBUG
    && (flags & (0x001 | 0x2000000)) != 0
    && !is_nondebug_keep_contents_section (ibfd, isection))
    {
      flags &= ~(0x100 | 0x002 | 0x2000000);
      if (obfd->xvec->flavour == bfd_target_elf_flavour)
 {
   make_nobits = 1;
   ...
   isection->flags &= ~(0x100 | 0x002 | 0x2000000);
 }
    }
  ...
  if (osection == ((void*)0))
    {
      err = gettext ("failed to create output section");
      goto loser;
    }

  if (make_nobits)
    (((struct bfd_elf_section_data*)(osection)->used_by_bfd)->this_hdr.sh_type) = 8;
  ...
  if (! bfd_set_section_size (obfd, osection, size))
    {
      err = gettext ("failed to set size");
      goto loser;
    }
 ...
 lma = p->lma_val;
  ...
  if (!bfd_set_section_alignment (obfd,
      osection,
      ((isection)->alignment_power)))
    {
      err = gettext ("failed to set alignment");
      goto loser;
    }
      ...
      if (gsym != ((void*)0))
 {
   gsym->flags |= (1 << 5);
   if (ibfd->xvec->flavour == bfd_target_elf_flavour)
     (((struct bfd_elf_section_data*)(isection)->used_by_bfd)->group.id) = gsym;
 }
    }



  if (!((*((obfd)->xvec->_bfd_copy_private_section_data)) (ibfd, isection, obfd, osection)))
    {
      err = gettext ("failed to copy private data");
      goto loser;
    }
 ...
 loser:
  status = 1;
  bfd_nonfatal_message (((void*)0), obfd, osection, err);
}
...
{
  find_section_list (section_pattern, 1, (1 << 7));
}
...
static bfd_boolean
discard_relocations (bfd *ibfd __attribute__ ((__unused__)), asection *isection)
{
  return (find_section_list (((isection)->name), 0,
        (1 << 7)) != ((void*)0));
}
...
handle_remove_section_option (const char *section_pattern)
{
  if (strncmp (section_pattern, ".rela.", 6) == 0)
    ...
    {
      find_section_list (section_pattern, 1, (1 << 0));
      sections_removed = 1;
    }
}
...
copy_relocations_in_section (bfd *ibfd, sec_ptr isection, void *obfdarg)
{
      ...
      if (relsize < 0)
 {
   ...
   if (relsize == -1 && bfd_get_error () == bfd_error_invalid_operation)
     ...
     {
       status = 1;
       bfd_nonfatal_message (((void*)0), ibfd, isection, ((void*)0));
       return;
     }
 }
    }
 ...
 {
   status = 1;
   bfd_nonfatal_message (((void*)0), ibfd, isection,
    gettext ("relocation count is negative"));
   return;
 }
      ...
      if (strip_symbols == STRIP_ALL)
 {
   ...
   for (i = 0; i < relcount; i++)
    ...
    && * relpp[i]->sym_ptr_ptr)
  if (is_specified_symbol (((*relpp[i]->sym_ptr_ptr)->name),
      keep_specific_htab))
...
copy_section (bfd *ibfd, sec_ptr isection, void *obfdarg)
{
  ...
  if (((void) ibfd, (isection)->flags) & 0x100
      && ((void) obfd, (osection)->flags) & 0x100)
    {
      bfd_byte *memhunk = ((void*)0);
  ...
  for (j = 0; j < (unsigned long)(reverse_bytes / 2); j++)
    {
     ...
     fatal (gettext ("cannot reverse bytes: length of section %s must be evenly divisible by %d"),
     ((isection)->name), reverse_bytes);
 }
 ...
 {
   status = 1;
   bfd_nonfatal_message (((void*)0), obfd, osection, ((void*)0));
   free (memhunk);
   return;
 }
      free (memhunk);
    }
  else if ((p = find_section_list (((void) ibfd, (isection)->name),
       0, (1 << 6))) != ((void*)0)
    && (p->flags & 0x100) != 0)
    {
...
static void
get_sections (bfd *obfd __attribute__ ((__unused__)), asection *osection, void *secppparg)
{
  ...
  for (i = 0; i < relcount; i++)
    {
      ...
      if (relpp[i]->sym_ptr_ptr != ((void*)0)
   && * relpp[i]->sym_ptr_ptr != ((void*)0)
   && *relpp[i]->sym_ptr_ptr != (&_bfd_std_section[0])->symbol
   && *relpp[i]->sym_ptr_ptr != (&_bfd_std_section[2])->symbol
   && *relpp[i]->sym_ptr_ptr != (&_bfd_std_section[1])->symbol)
 (*relpp[i]->sym_ptr_ptr)->flags |= (1 << 5);
    }
...
write_debugging_info (bfd *obfd, void *dhandle,
        long *symcountp __attribute__ ((__unused__)),
        asymbol ***symppp __attribute__ ((__unused__)))
{
  if (((obfd)->xvec->flavour) == bfd_target_ieee_flavour)
 ...
 {
   bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
    gettext ("can't create debugging section"));
   return 0;
 }
 ...
 {
   bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
    gettext ("can't set debugging section contents"));
   return 0;
 }
  ...
  bfd_nonfatal_message (((void*)0), obfd, ((void*)0),
   gettext ("don't know how to write debugging information for %s"),
   ((obfd)->xvec->name));
  return 0;
}
...
strip_main (int argc, char *argv[])
{
 ...
 tmpname = output_file;
      ...
      if (tmpname == ((void*)0))
 {
   bfd_nonfatal_message (argv[i], ((void*)0), ((void*)0),
    gettext ("could not create temporary file to hold stripped copy"));
   status = 1;
   continue;
 }

      status = 0;
      copy_file (argv[i], tmpname, input_target, output_target, ((void*)0));
      if (status == 0)
 {
   if (preserve_dates)
...
set_pe_subsystem (const char *s)
{
 ...
 pe_minor_subsystem_version = strtoul (copy + 1, &copy, 0);
      if (*copy != '\0')
 non_fatal (gettext ("%s: bad version in PE subsystem"), s);
    }
 ...
 if (strcmp (subsystem, v[i].name) == 0)
  ...
  switch (set_def)
    {
    case -1:
      fatal (gettext ("unknown PE subsystem: %s"), s);
      break;
    case 0:
      break;
    default:
    ...
    const char *option)
{
  ...
  s = strchr (arg, '=');
  if (s == ((void*)0))
    fatal (gettext ("bad format for %s"), option);
...
section_add_load_file (struct section_add *pa)
{
  ...
  f = fopen (pa->filename, "r");
  if (f == ((void*)0))
    fatal (gettext ("cannot open: %s: %s"),
    pa->filename, strerror ((*__errno_location ())));
      ...
      if (off == alloc)
 {
   ...
   pa->contents = (bfd_byte *) xrealloc (pa->contents, alloc);
      ...
      if (ferror (f))
 fatal (gettext ("%s: fread failed"), pa->filename);
...
copy_main (int argc, char *argv[])
{
 ...
 case 'b':
   ...
   if (copy_byte < 0)
     fatal (gettext ("byte number must be non-negative"));
   break;

 case 'B':
   input_arch = bfd_scan_arch (optarg);
   if (input_arch == ((void*)0))
     fatal (gettext ("architecture %s unknown"), optarg);
   break;
   ...
   if (optarg)
     {
       ...
       if (interleave < 1)
  fatal (gettext ("interleave must be positive"));
     }
   else
     interleave = 4;
   break;
 ...
 case OPTION_INTERLEAVE_WIDTH:
   ...
   if (copy_width < 1)
     fatal(gettext ("interleave width must be positive"));
   break;
 ...
 case 'j':
   find_section_list (optarg, 1, (1 << 1));
   sections_copied = 1;
   break;
 ...
 case OPTION_ADD_SYMBOL:
   {
     ...
     s = strchr (optarg, '=');
     if (s == ((void*)0))
       fatal (gettext ("bad format for %s"), "--add-symbol");
     t = strchr (s + 1, ':');
  ...
  newsym->symval = strtol (t + 1, ((void*)0), 0);
       }
     else
       {
  newsym->section = ((void*)0);
  newsym->symval = strtol (s + 1, ((void*)0), 0);
  t = s;
       }

     t = strchr (t + 1, ',');
     newsym->othersym = ((void*)0);
     if (t)
 ...
 case OPTION_CHANGE_SECTION_VMA:
  ...
  switch (c)
    ...
    case OPTION_CHANGE_SECTION_VMA:
     ...
     p = find_section_list (name, 1, context);
 ...
 case OPTION_COMPRESS_DEBUG_SECTIONS:
  ...
  fatal (gettext ("unrecognized --compress-debug-sections type `%s'"),
         optarg);
     }
   else
     do_debug_sections = compress;
 ...
 case OPTION_ELF_STT_COMMON:
   if (strcasecmp (optarg, "yes") == 0)
     ...
     fatal (gettext ("unrecognized --elf-stt-common= option `%s'"),
     optarg);
   break;
 ...
 case OPTION_GAP_FILL:
  ...
  sprintf (buff, "%016" "l" "x", gap_fill_vma);

  non_fatal (gettext ("Warning: truncating gap-fill from 0x%s to 0x%x"),
      buff, gap_fill);
       }
     gap_fill_set = 1;
   }
 ...
 case OPTION_REDEFINE_SYM:
   {
     ...
     s = strchr (optarg, '=');
     if (s == ((void*)0))
       fatal (gettext ("bad format for %s"), "--redefine-sym");
 ...
 case OPTION_SET_SECTION_FLAGS:
   {
     ...
     s = strchr (optarg, '=');
     if (s == ((void*)0))
       fatal (gettext ("bad format for %s"), "--set-section-flags");
     ...
     p = find_section_list (name, 1, (1 << 6));
 ...
 case OPTION_RENAME_SECTION:
   {
     ...
     eq = strchr (optarg, '=');
     if (eq == ((void*)0))
       fatal (gettext ("bad format for %s"), "--rename-section");
 ...
 case OPTION_LONG_SECTION_NAMES:
   if (!strcmp ("enable", optarg))
     ...
     fatal (gettext ("unknown long section names option '%s'"), optarg);
   break;
 ...
 case OPTION_ALT_MACH_CODE:
   use_alt_mach_code = strtoul (optarg, ((void*)0), 0);
   if (use_alt_mach_code == 0)
     fatal (gettext ("unable to parse alternative machine code"));
   break;
 ...
 case OPTION_READONLY_TEXT:
   bfd_flags_to_set |= 0x80;
   bfd_flags_to_clear &= ~0x80;
   break;
 ...
 case OPTION_PURE:
   bfd_flags_to_set |= 0x100;
   bfd_flags_to_clear &= ~0x100;
   break;
 ...
 case OPTION_REVERSE_BYTES:
   {
     ...
     if ((reverse_bytes <= 0) || ((reverse_bytes % 2) != 0))
       fatal (gettext ("number of bytes to reverse must be positive and even"));

     if (prev && prev != reverse_bytes)
       non_fatal (gettext ("Warning: ignoring previous --reverse-bytes value of %d"),
    prev);
     break;
   }
 ...
 case OPTION_HEAP:
   {
     ...
     if (end == optarg
  || (*end != '.' && *end != '\0'))
       non_fatal (gettext ("%s: invalid reserve value for --heap"),
    optarg);
     else if (*end != '\0')
       {
  pe_heap_commit = strtoul (end + 1, &end, 0);
  if (*end != '\0')
    non_fatal (gettext ("%s: invalid commit value for --heap"),
        optarg);
       }
   }
   break;
 ...
 case OPTION_STACK:
   {
     ...
     if (end == optarg
  || (*end != '.' && *end != '\0'))
       non_fatal (gettext ("%s: invalid reserve value for --stack"),
    optarg);
     else if (*end != '\0')
       {
  pe_stack_commit = strtoul (end + 1, &end, 0);
  if (*end != '\0')
    non_fatal (gettext ("%s: invalid commit value for --stack"),
        optarg);
       }
   }
   break;
 ...
 default:
  ...
  if (interleave && copy_byte == -1)
    fatal (gettext ("interleave start byte must be set with --byte"));

  if (copy_byte >= interleave)
    fatal (gettext ("byte number must be less than interleave"));

  if (copy_width > interleave - copy_byte)
    fatal (gettext ("interleave width must be less than or equal to interleave - byte`"));
 ...
 fatal (gettext ("unknown input EFI target: %s"), input_target);
 ...
 fatal (gettext ("unknown output EFI target: %s"), output_target);
 ...
 pe_section_alignment = 0x1000;
  ...
  if (preserve_dates)
    if (stat (input_filename, & statbuf) < 0)
      fatal (gettext ("warning: could not locate '%s'.  System error message: %s"),
      input_filename, strerror ((*__errno_location ())));
  ...
  if (tmpname == ((void*)0))
    fatal (gettext ("warning: could not create temporary file whilst copying '%s', (error: %s)"),
    input_filename, strerror ((*__errno_location ())));
      ...
      for (p = change_sections; p != ((void*)0); p = p->next)
 {
   if (! p->used)
     {
       if (p->context & ((1 << 2) | (1 << 3)))
  {
    char buff [20];

    sprintf (buff, "%016" "l" "x", p->vma_val);


    non_fatal (gettext ("%s %s%c0x%s never used"),
        "--change-section-vma",
        p->pattern,
        p->context & (1 << 2) ? '=' : '+',
        buff);
       ...
       if (p->context & ((1 << 4) | (1 << 5)))
  {
    char buff [20];

    sprintf (buff, "%016" "l" "x", p->lma_val);
...
# 4882 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/objcopy.c"
