# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2
# 104 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 105 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 106 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 107 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2
...
# 108 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2
...
# 109 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c" 2




static const char digs[] = "0123456789ABCDEF";
# 132 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c"
unsigned int Chunk = 16;




bfd_boolean S3Forced = 0;
...
srec_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == 'S')) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c",743); } while (0);

      if (bfd_bread (hdr, (bfd_size_type) 3, abfd) != 3)
 goto error_return;

      do { if (!((((unsigned int) _hex_value[(unsigned char) (hdr[1])]) != 99) && (((unsigned int) _hex_value[(unsigned char) (hdr[2])]) != 99))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c",748); } while (0);
 ...
 {
 default:
   do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c",770); } while (0);
   if (buf != ((void*)0))
     free (buf);
   return 1;
 ...
 case '1':
   ...
   if (address != section->vma + sofar)
     {
       ...
       do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c",795); } while (0);
       if (buf != ((void*)0))
  free (buf);
       return 1;
     }
  ...
  do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c",818); } while (0);
      ...
      srec_data_list_type *list)
{
  ...
  if (Chunk == 0)
    Chunk = 1;
  else if (Chunk > 0xff - tdata->type - 2)
    Chunk = 0xff - tdata->type - 2;
...
# 1289 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/srec.c"
