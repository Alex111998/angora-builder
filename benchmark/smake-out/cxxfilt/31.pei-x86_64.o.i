# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
# 67 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c"
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 68 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
...
# 69 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
...
# 70 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
...
# 71 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
# 1 "./libcoff.h" 1
# 26 "./libcoff.h"
...
# 72 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
# 1 "./libpei.h" 1
# 341 "./libpei.h"
...
# 73 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
...
# 74 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
        ...
        struct pex64_runtime_function *rf)
{
  ...
  if (ui->CountOfCodes == 0 || ui->rawUnwindCodes == ((void*)0))
    return;
...
pex64_bfd_print_pdata_section (bfd *abfd, void *vfile, asection *pdata_section)
{
  ...
  bfd_byte *pdata = ((void*)0);
  bfd_byte *xdata = ((void*)0);
  asection *xdata_section = ((void*)0);
  bfd_vma xdata_base;
  bfd_size_type i;
  ...
  int onaline = (3 * 4);
  int seen_error = 0;
  bfd_vma *xdata_arr = ((void*)0);
  int xdata_arr_cnt;
  bfd_boolean virt_size_is_zero = 0;


  if (pdata_section == ((void*)0)
      || ((struct coff_section_tdata *) (pdata_section)->used_by_bfd) == ((void*)0)
      || ((struct pei_section_tdata *) ((struct coff_section_tdata *) ((pdata_section))->used_by_bfd)->tdata) == ((void*)0))
    return 1;
  ...
  if (strcmp (pdata_section->name, ".pdata") != 0)
    {
      ...
      char *xdata_name = __builtin_alloca(len + 1);
...
# 118 "./coff-x86_64.c"
 ...
 switch (howto->size)
   ...
   case 4:
     {
       long long x = ((*((abfd)->xvec->bfd_getx64)) (addr));
       x = ((x & ~howto->dst_mask) | (((x & howto->src_mask) + diff) & howto->dst_mask));
       ((*((abfd)->xvec->bfd_putx64)) (((bfd_vma) x), (addr)));
     }
     break;
...
# 338 "./coff-x86_64.c"
  { (unsigned) (10), 0, 0, 0, 0, 0, complain_overflow_dont, ((void*)0), ((void*)0), 0, 0, 0, 0 },


  { (unsigned) 11, 0, 2, 32, 0, 0, complain_overflow_bitfield, coff_amd64_reloc, "secrel32", 1, 0xffffffff, 0xffffffff, 1 },
# 357 "./coff-x86_64.c"
  { (unsigned) (12), 0, 0, 0, 0, 0, complain_overflow_dont, ((void*)0), ((void*)0), 0, 0, 0, 0 },
  { (unsigned) (13), 0, 0, 0, 0, 0, complain_overflow_dont, ((void*)0), ((void*)0), 0, 0, 0, 0 },
  ...
  if (sym != ((void*)0) && sym->n_scnum == 0 && sym->n_value != 0)
    {
      ...
      do { if (!(h != ((void*)0))) bfd_assert("./coff-x86_64.c",590); } while (0);
# 602 "./coff-x86_64.c"
    }
# 613 "./coff-x86_64.c"
  if (howto->pc_relative)
...
coff_amd64_reloc_type_lookup (bfd *abfd __attribute__ ((__unused__)), bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    default:
      do { bfd_assert("./coff-x86_64.c",695); } while (0);
      return 0;
    }
}
...
# 5320 "./coffcode.h"
      { coff_symbol_type *coffsym = ((void*)0); if (ptr && ((ptr)->the_bfd) != abfd) coffsym = ((((abfd)->tdata.coff_obj_data)->symbols) + (cache_ptr->sym_ptr_ptr - symbols)); else if (ptr) coffsym = (((((((ptr)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((ptr)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((ptr)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (ptr) : ((void*)0)); if (coffsym != ((void*)0) && coffsym->native->u.syment.n_scnum == 0) cache_ptr->addend = - coffsym->native->u.syment.n_value; else if (ptr && ((ptr)->the_bfd) == abfd && ptr->section != ((void*)0)) cache_ptr->addend = - (ptr->section->vma + ptr->value); else cache_ptr->addend = 0; if (ptr && dst.r_type < (sizeof (howto_table) / sizeof ((howto_table)[0])) && howto_table[dst.r_type].pc_relative) cache_ptr->addend += asect->vma; };
      (void) ptr;
...
static bfd_coff_backend_data bfd_coff_pei_swap_table __attribute__ ((__unused__)) =
{
  ...
  ((void*)0), coff_pe_amd64_relocate_section, coff_amd64_rtype_to_howto,
...

{
  ...
  pe_bfd_copy_private_bfd_data, ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), _bfd_generic_init_private_section_data, _bfd_pex64_bfd_copy_private_section_data, ((bfd_boolean (*) (bfd *, asymbol *, bfd *, asymbol *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), pe_print_private_bfd_data,
  ...
  coff_get_reloc_upper_bound, coff_canonicalize_reloc, coff_amd64_reloc_type_lookup, coff_amd64_reloc_name_lookup,
...
# 764 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-x86_64.c" 2
