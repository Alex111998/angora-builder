# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 30 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c" 2
   ...
   void **psecinfo)
{
  ...
  if ((abfd->flags & 0x40) != 0
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c", 370, __PRETTY_FUNCTION__);
...
_bfd_write_merged_section (bfd *output_bfd, asection *sec, void *psecinfo)
{
  ...
  if (hdr->sh_offset == (file_ptr) -1)
   ...
   || contents == ((void*)0))
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c", 824, __PRETTY_FUNCTION__);
    }
  else
    {
      contents = ((void*)0);
       ...
       void *psecinfo, bfd_vma offset)
{
      ...
      else
 {
  ...
  if (!entry)
    {
      if (! secinfo->htab->strings)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c", 905, __PRETTY_FUNCTION__);


      if (*p)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c", 909, __PRETTY_FUNCTION__);
      if (! secinfo->htab->first)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/merge.c", 911, __PRETTY_FUNCTION__);
