# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c" 2
...
# 7 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c" 2
...
# 51 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c"
...
# 85 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c"
    ...
    gz_statep state;
{
    ...
    if (state->size == 0) {
        ...
        if (inflateInit2_((&(state->strm)), (15 + 16), "1.2.7", (int)sizeof(z_stream)) != 0) {
            free(state->out);
            free(state->in);
            state->size = 0;
            gz_error(state, (-4), "out of memory");
...
# 135 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzread.c"
    if (strm->avail_in > 1 &&
