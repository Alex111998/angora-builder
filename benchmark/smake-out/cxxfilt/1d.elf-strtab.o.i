# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c" 2
       ...
       bfd_boolean copy)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",153); } while (0);
  ...
  if (entry->len == 0)
    {
      ...
      do { if (!(entry->len > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",165); } while (0);
...
_bfd_elf_strtab_addref (struct elf_strtab_hash *tab, bfd_size_type idx)
{
  if (idx == 0 || idx == (bfd_size_type) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",187); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",188); } while (0);
...
_bfd_elf_strtab_delref (struct elf_strtab_hash *tab, bfd_size_type idx)
{
  if (idx == 0 || idx == (bfd_size_type) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",197); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",198); } while (0);
  do { if (!(tab->array[idx]->refcount > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",199); } while (0);
  --tab->array[idx]->refcount;
}
...
_bfd_elf_strtab_restore_size (struct elf_strtab_hash *tab, bfd_size_type idx)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",225); } while (0);
  do { if (!(idx <= curr_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",226); } while (0);
  tab->size = idx;
...
_bfd_elf_strtab_offset (struct elf_strtab_hash *tab, bfd_size_type idx)
{
  ...
  if (idx == 0)
    return 0;
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",251); } while (0);
  do { if (!(tab->sec_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",252); } while (0);
  entry = tab->array[idx];
  do { if (!(entry->refcount > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",254); } while (0);
  entry->refcount--;
...
_bfd_elf_strtab_emit (register bfd *abfd, struct elf_strtab_hash *tab)
{
  ...
  for (i = 1; i < tab->size; ++i)
    {
      ...
      do { if (!(tab->array[i]->refcount == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",272); } while (0);
      len = tab->array[i]->len;
      if ((int) len < 0)
 continue;
 ...
 return 0;
  ...
  do { if (!(off == tab->sec_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c",284); } while (0);
  return 1;
}
...
# 378 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf-strtab.c"
      e = *--a;
      e->len += 1;
      while (--a >= array)
 {
