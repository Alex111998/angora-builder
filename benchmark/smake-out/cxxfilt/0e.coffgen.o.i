# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
# 39 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 40 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 41 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 42 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
...
# 43 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
# 1 "./libcoff.h" 1
# 26 "./libcoff.h"
...
# 44 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c" 2
...
coff_object_p (bfd *abfd)
{
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  bfd_release (abfd, filehdr);
# 351 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
...
coff_section_from_bfd_index (bfd *abfd, int section_index)
{
  ...
  if (section_index == ((short)-1))
    return (&_bfd_std_section[2]);
  if (section_index == ((short)0))
    return (&_bfd_std_section[1]);
  if (section_index == ((short)-2))
    return (&_bfd_std_section[2]);
    ...
    char *buf)
{
  ...
  if (sym->_n._n_n._n_zeroes != 0
  ...
  else
    {
      ...
      do { if (!(sym->_n._n_n._n_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",466); } while (0);
...
# 492 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
struct internal_reloc *
...
coff_count_linenumbers (bfd *abfd)
{
 ...
 total += s->lineno_count;
  ...
  for (s = abfd->sections; s != ((void*)0); s = s->next)
    do { if (!(s->lineno_count == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",603); } while (0);
      ...
      struct internal_syment *syment)
{
 ...
 {
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",684); } while (0);

   syment->n_scnum = ((short)-1);
   syment->n_value = coff_symbol_ptr->symbol.value;
 }
    }
}
# 699 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
bfd_boolean
...
# 718 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
  {
    asymbol **newsyms;
    unsigned int i;
    bfd_size_type amt;
 ...
 *newsyms++ = symbol_ptr_ptr[i];
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",767); } while (0);
...
coff_mangle_symbols (bfd *bfd_ptr)
{
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",812); } while (0);
   if (s->fix_value)
     {
  ...
  coff_section_from_bfd_index (bfd_ptr, ((short)-2));
       do { if (!(coff_symbol_ptr->symbol.flags & (1 << 2))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",831); } while (0);
     }
   for (i = 0; i < s->u.syment.n_numaux; i++)
     {
       combined_entry_type *a = s + i + 1;

       do { if (!(! a->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",837); } while (0);
       if (a->fix_tag)
  {
        ...
        bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",881); } while (0);
      ...
      if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings))
 {
   ...
   *string_size_p += 6;
   ...
   strncpy (native->u.syment._n._n_name, ".file", 8);
      ...
      do { if (!(! (native + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",897); } while (0);
      ...
      else
 {
   ...
   if (!bfd_set_section_contents (abfd,
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c", 963, __PRETTY_FUNCTION__);
   if (bfd_seek (abfd, filepos, 0) != 0)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c", 965, __PRETTY_FUNCTION__);
   native->u.syment._n._n_n._n_offset =
...
# 982 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
static bfd_boolean
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1000); } while (0);
  ...
  if (symbol->flags & (1 << 2)
    ...
    native->u.syment.n_scnum = ((short)-2);

  else if (((symbol->section) == (&_bfd_std_section[2])))
    native->u.syment.n_scnum = ((short)-1);

  else if (((symbol->section) == (&_bfd_std_section[1])))
    native->u.syment.n_scnum = ((short)0);
 ...
 {
   do { if (!(! (native + j + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1042); } while (0);
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1179); } while (0);
...
coff_write_symbols (bfd *abfd)
{
 ...
 {
   if (!coff_write_alien_symbol (abfd, symbol, ((void*)0), &written,
   ...
   if (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_classify_symbol != ((void*)0))
     {
       ...
       do { if (!(c_symbol->native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1289); } while (0);
...
# 1303 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
       if (symbol->flags & (1 << 7))
    ...
    i++, p++)
 {
   ...
   size_t maxlen;
# 1376 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
   if (c_symbol == ((void*)0)
 ...
 return 0;
  ...
  do { if (!(debug_string_size == 0 || (debug_string_section != (asection *) ((void*)0) && (((((bfd_vma) (debug_string_size) + (1 << debug_string_section->alignment_power) - 1) >= (bfd_vma) (debug_string_size)) ? (((bfd_vma) (debug_string_size) + ((1 << debug_string_section->alignment_power) - 1)) & ~ (bfd_vma) ((1 << debug_string_section->alignment_power)-1)) : ~ (bfd_vma) 0) == debug_string_section->size)))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1439); } while (0);
       ...
       combined_entry_type *auxent)
{
  ...
  do { if (!(symbol->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1523); } while (0);
 ...
 return;
  ...
  do { if (!(! auxent->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1537); } while (0);
...
coff_get_normalized_symtab (bfd *abfd)
{
    ...
    i++)
 {
  ...
  for (internal_ptr = internal; internal_ptr < internal_end;
       internal_ptr++)
    {
      do { if (!(internal_ptr->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1850); } while (0);
   ...
   && internal_ptr->u.syment.n_numaux > 0)
 {
   ...
   do { if (!(! aux->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1859); } while (0);
      ...
      else
 {
  ...
  debug_sec_data = build_debug_section (abfd, & debug_sec);
       if (debug_sec_data != ((void*)0))
  {
    do { if (!(debug_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1947); } while (0);
  ...
  do { if (!((((abfd)->tdata.coff_obj_data)->raw_syment_count) == (unsigned int) (internal_ptr - internal))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",1965); } while (0);
     ...
     bfd_print_symbol_type how)
{
      ...
      if (((coff_symbol_type *)(&((symbol)->the_bfd)))->native)
 {
   ...
   do { if (!(combined->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",2079); } while (0);
   ...
   for (aux = 0; aux < combined->u.syment.n_numaux; aux++)
     {
       ...
       do { if (!(! auxp->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",2099); } while (0);
       if (auxp->fix_tag)
                                   ...
                                   const struct dwarf_debug_section *debug_sections)
{
  ...
  *line_ptr = 0;
  ...
  while (p < pend)
    {
      do { if (!(p->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",2289); } while (0);
      ...
      while (1)
 {
   ...
   for (p2 = p + 1 + p->u.syment.n_numaux;
     ...
     {
       do { if (!(p2->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",2313); } while (0);
      ...
      for (; i < section->lineno_count; i++)
 {
       ...
       if (coff->native)
  {
    ...
    do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c",2392); } while (0);
    s = s + 1 + s->u.syment.n_numaux;



    if (s->u.syment.n_scnum == ((short)-2))
      s = s + 1 + s->u.syment.n_numaux;
...
# 2614 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
...
fini_reloc_cookie_rels (struct coff_reloc_cookie *cookie,
   asection *sec)
{
  if (cookie->rels && ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs != cookie->rels)
    free (cookie->rels);
}
...
# 2974 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
 }
    }
...
{
  bfd *sub;
# 3027 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/coffgen.c"
