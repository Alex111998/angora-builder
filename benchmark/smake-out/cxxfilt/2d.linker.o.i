# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
# 1 "./genlink.h" 1
# 42 "./genlink.h"
...
struct bfd_hash_entry *_bfd_generic_link_hash_newfunc
  (struct bfd_hash_entry *, struct bfd_hash_table *, const char *);
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c" 2
# 405 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
   ...
   unsigned int entsize)
{
  ...
  do { if (!(!abfd->is_linker_output && !abfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",478); } while (0);
  table->undefs = ((void*)0);
...
# 647 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
void
...
bfd_link_add_undef (struct bfd_link_hash_table *table,
      struct bfd_link_hash_entry *h)
{
  do { if (!(h->u.undef.next == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",675); } while (0);
...
# 690 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
void
...
_bfd_generic_link_hash_table_free (bfd *obfd)
{
  ...
  do { if (!(obfd->is_linker_output && obfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",780); } while (0);
...
# 795 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
...
# 836 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
...
# 926 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
        ...
        bfd_boolean collect)
{
      ...
      if (h->type == bfd_link_hash_undefined)
 {
   ...
   bfd_vma size;
   unsigned int power;
# 1155 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
...
# 1273 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
...
# 1309 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
enum link_row
{
  UNDEF_ROW,
  UNDEFW_ROW,
...
# 1392 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
static bfd *
...
# 1431 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry **hashp)
{
  ...
  do { if (!(section != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",1448); } while (0);
 ...
 {
 case FAIL:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 1523, __PRETTY_FUNCTION__);
 ...
 case CDEF:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",1545); } while (0);
 ...
 case DEFW:
   {
     ...
     if (collect && name[0] == '_')
       {
  const char *s;
# 1584 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
  s = name + 1;
  while (*s == '_')
    ++s;
  if (s[0] == 'G' && (strncmp ((s), ("GLOBAL_"), sizeof ("GLOBAL_") - 1) == 0))
   ...
   if (oldtype == bfd_link_hash_defweak)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 1603, __PRETTY_FUNCTION__);
...
# 1650 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
 ...
 case BIG:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",1676); } while (0);
   if (! ((*info->callbacks->multiple_common)
 ...
 case CIND:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",1737); } while (0);
   if (! ((*info->callbacks->multiple_common)
...
_bfd_generic_final_link (bfd *abfd, struct bfd_link_info *info)
{
      ...
      for (o = abfd->sections; o != ((void*)0); o = o->next)
 {
       ...
       else if (p->type == bfd_indirect_link_order)
  {
    ...
    if (reloc_count < 0)
      return 0;
    do { if (!((unsigned long) reloc_count == input_section->reloc_count)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",1947); } while (0);
      ...
      size_t *psymalloc)
{
   ...
   || ((((sym)->section)) == (&_bfd_std_section[3])))
 {
   if (sym->udata.p != ((void*)0))
     ...
     {
# 2099 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
       h = ((void*)0);
     }
  ...
  case bfd_link_hash_new:
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2128, __PRETTY_FUNCTION__);
  case bfd_link_hash_undefined:
    break;
  case bfd_link_hash_undefweak:
    sym->flags |= (1 << 7);
  ...
  case bfd_link_hash_common:
    ...
    if (! (((sym->section)->flags & 0x1000) != 0))
      {
        do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2154); } while (0);
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2243, __PRETTY_FUNCTION__);
...
set_symbol_from_hash (asymbol *sym, struct bfd_link_hash_entry *h)
{
  switch (h->type)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2274, __PRETTY_FUNCTION__);
      break;
    case bfd_link_hash_new:
 ...
 {
   do { if (!((sym->flags & (1 << 11)) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2281); } while (0);
 }
      else
 {
   sym->flags |= (1 << 11);
 ...
 {
   do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2314); } while (0);
   sym->section = (&_bfd_std_section[0]);
 }
 ...
 return 0;
  ...
  if (! generic_add_output_symbol (wginfo->output_bfd, wginfo->psymalloc,
       sym))
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2367, __PRETTY_FUNCTION__);
    }
          ...
          struct bfd_link_order *link_order)
{
  ...
  if (! ((info)->type == type_relocatable))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2384, __PRETTY_FUNCTION__);
  if (sec->orelocation == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2386, __PRETTY_FUNCTION__);
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2448, __PRETTY_FUNCTION__);
    ...
    struct bfd_link_order *link_order)
{
  switch (link_order->type)
    ...
    case bfd_symbol_reloc_link_order:
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2517, __PRETTY_FUNCTION__);
    case bfd_indirect_link_order:
    ...
    struct bfd_link_order *link_order)
{
  ...
  do { if (!((sec->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2540); } while (0);
        ...
        bfd_boolean generic_linker)
{
  ...
  do { if (!((output_section->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2603); } while (0);
  ...
  do { if (!(input_section->output_section == output_section)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2610); } while (0);
  do { if (!(input_section->output_offset == link_order->offset)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2611); } while (0);
  do { if (!(input_section->size == link_order->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2612); } while (0);
      ...
      if (!output_bfd->output_has_begun)
 {
   ...
   if (!bfd_set_section_contents (output_bfd, output_section, "", 0, 1))
     goto error_return;
      ...
      do { if (!(new_contents != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2694); } while (0);
      do { if (!(input_section->output_offset == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",2695); } while (0);
    }
  else
    {
...
# 2767 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
...
# 2803 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
       ...
       struct bfd_link_info *info)
{
  switch (sec->flags & 0xc0000)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c", 2890, __PRETTY_FUNCTION__);
         ...
         struct bfd_link_info *info)
{
  ...
  if ((sec->flags & 0x2000000) != 0)
    return 0;
# 2996 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
...
# 3136 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry *h)
{
  ...
  do { if (!(h != ((void*)0) && h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",3145); } while (0);
  ...
  do { if (!(alignment != 0 && (alignment & -alignment) == alignment)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c",3154); } while (0);
...
# 3194 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
struct bfd_elf_version_tree *
...
# 3298 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/linker.c"
bfd_boolean
