# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c" 2
...
# 7 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c" 2
# 19 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
static void gz_reset (gz_statep);
static gzFile gz_open (const void *, int, const char *);
# 75 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
...
# 197 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
        len = strlen(path);
...
# 211 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
    ...
    const char *mode;
{
    ...
    if (fd == -1 || (path = malloc(7 + 3 * sizeof(int))) == ((void*)0))
        return ((void*)0);
...
# 304 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzlib.c"
    ...
    int *errnum;
{
    ...
    if (errnum != ((void*)0))
        *errnum = state->err;
    return state->msg == ((void*)0) ? "" : state->msg;
}
    ...
    const char *msg;
{
    ...
    if ((state->msg = malloc(strlen(state->path) + strlen(msg) + 3)) == ((void*)0)) {
        state->err = (-4);
