# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c" 2
# 41 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
...
# 193 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
...
# 284 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
bfd_openr (const char *filename, const char *target)
{
  return bfd_fopen (filename, target, "r", -1);
}
# 328 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
bfd_fdopenr (const char *filename, const char *target, int fd)
{
  ...
  switch (fdflags & (0003))
    ...
    default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c", 356, __PRETTY_FUNCTION__);
    }


  return bfd_fopen (filename, target, mode, fd);
}
# 379 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
...
# 469 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
struct opncls
{
  void *stream;
...
# 640 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
...
# 726 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd_boolean
bfd_close (bfd *abfd)
{
  bfd_boolean ret;
...
# 772 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd_boolean
...
# 803 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd *
...
# 839 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd_boolean
...
# 884 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd_boolean
...
# 938 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
void *
...
# 976 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
void *
...
# 1002 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
void *
...
# 1025 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
void *
...
# 1089 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
unsigned long
...
# 1173 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
char *
bfd_get_debug_link_info (bfd *abfd, unsigned long *crc32_out)
{
  ...
  do { if (!(abfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1182); } while (0);
  do { if (!(crc32_out)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1183); } while (0);
...
# 1229 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
char *
        ...
        bfd_byte **buildid_out)
{
  ...
  do { if (!(abfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1238); } while (0);
  do { if (!(buildid_len)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1239); } while (0);
  do { if (!(buildid_out)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1240); } while (0);
...
# 1280 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
static bfd_boolean
separate_debug_file_exists (const char *name, const unsigned long crc)
{
  ...
  do { if (!(name)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1288); } while (0);
...
# 1315 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
static bfd_boolean
    ...
    const unsigned long buildid __attribute__ ((__unused__)))
{
  ...
  do { if (!(name)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1321); } while (0);
...
# 1352 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
     ...
     check_func_type check_func)
{
  ...
  do { if (!(abfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c",1369); } while (0);
...
# 1488 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
char *
...
# 1540 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
char *
...
# 1566 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
asection *
...
# 1628 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/opncls.c"
bfd_boolean
