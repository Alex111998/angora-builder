# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzwrite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzwrite.c" 2
...
# 7 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzwrite.c" 2
    ...
    gz_statep state;
{
    ...
    if (!state->direct) {
        ...
        strm->zfree = 0;
        strm->opaque = 0;
        ret = deflateInit2_((strm),(state->level),(8),(15 + 16),(8), (state->strategy), "1.2.7", (int)sizeof(z_stream));
...
# 355 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzwrite.c"
...
# 453 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/gzwrite.c"
