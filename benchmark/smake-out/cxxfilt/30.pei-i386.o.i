# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c" 2
# 45 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c"
# 1 "./coff-i386.c" 1
# 24 "./coff-i386.c"
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
# 119 "./coff-i386.c"
 ...
 switch (howto->size)
   ...
   default:
     _bfd_abort ("./coff-i386.c", 174, __PRETTY_FUNCTION__);
   }
      }
  ...
  if (sym != ((void*)0) && sym->n_scnum == 0 && sym->n_value != 0)
    {
      ...
      do { if (!(h != ((void*)0))) bfd_assert("./coff-i386.c",468); } while (0);
# 480 "./coff-i386.c"
    }
# 491 "./coff-i386.c"
  if (howto->pc_relative)
 ...
 *addendp -= sym->n_value;
  ...
  if (rel->r_type == 20 && sym == ((void*)0))
    *addendp -= rel->r_vaddr;
    ...
    do { if (!(sym != ((void*)0))) bfd_assert("./coff-i386.c",516); } while (0);
        ...
        bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    default:
      do { bfd_assert("./coff-i386.c",574); } while (0);
      return 0;
    }
}
...
# 883 "./peicode.h"
 ...
 _bfd_abort ("./peicode.h", 893, __PRETTY_FUNCTION__);
      ...
      for (i = (sizeof (jtab) / sizeof (jtab)[0]); i--;)
 {
   ...
   if (jtab[i].magic == magic)
     break;
      ...
      if (i < 0)
 _bfd_abort ("./peicode.h", 979, __PRETTY_FUNCTION__);
...
# 1017 "./peicode.h"
 pe_ILF_make_a_symbol_reloc (&vars, (bfd_vma) jtab[i].offset,
    ...
    default:
      ...
      _bfd_abort ("./peicode.h", 1029, __PRETTY_FUNCTION__);
    }
 ...
 * ptr = '.';
    ...
    default:
      ...
      _bfd_abort ("./peicode.h", 1087, __PRETTY_FUNCTION__);
    }
  ...
  while (esym < esymend)
    {
      ...
      do { if (!(sizeof (internal_s->s_name) <= 8)) bfd_assert("./coffcode.h",934); } while (0);
...
# 963 "./coffcode.h"
   ...
   if (symname == ((void*)0))
     {
       _bfd_error_handler (dgettext ("bfd", "%B: unable to load COMDAT section name"), abfd);
       break;
     }
...
# 995 "./coffcode.h"
  if (! ((isym.n_sclass == 3
   || isym.n_sclass == 2)
         && ((isym.n_type) & 0xf) == 0
         && isym.n_value == 0))
    _bfd_abort ("./coffcode.h", 999, __PRETTY_FUNCTION__);
...
# 1079 "./coffcode.h"
  ...
  if (((struct coff_section_tdata *) (section)->used_by_bfd)->comdat == ((void*)0))
    _bfd_abort ("./coffcode.h", 1128, __PRETTY_FUNCTION__);
  ...
  if (newname == ((void*)0))
    _bfd_abort ("./coffcode.h", 1136, __PRETTY_FUNCTION__);
    ...
    void * scnhdr)
{
 ...
 _bfd_abort ("./coffcode.h", 1904, __PRETTY_FUNCTION__);
    }
 ...
 _bfd_abort ("./coffcode.h", 1913, __PRETTY_FUNCTION__);
    }
...
{
  do { if (!(symbol->is_sym)) bfd_assert("./coffcode.h",2583); } while (0);
  do { if (!(! aux->is_sym)) bfd_assert("./coffcode.h",2584); } while (0);
# 2629 "./coffcode.h"
  return 0;
}
# 2665 "./coffcode.h"
  ...
  if ((*q->sym_ptr_ptr)->section == (&_bfd_std_section[2])
  ...
  else
    {
      ...
      if (n.r_symndx > (((abfd)->tdata.coff_obj_data)->conv_table_size))
        {
   bfd_set_error (bfd_error_bad_value);
   _bfd_error_handler (dgettext ("bfd", "%B: reloc against a non-existant symbol index: %ld"),
         abfd, n.r_symndx);
   return 0;
        }
    }
...
# 3711 "./coffcode.h"
      ...
      if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_long_section_names))
 {
       ...
       if (string_size >= 10000000)
  {
    bfd_set_error (bfd_error_file_too_big);
    (*_bfd_error_handler)
      (dgettext ("bfd", "%B: section %s: string table overflow at offset %ld"),
    ...
    return 0;
       ...
       snprintf (s_name_buf, (8) + 1, "/%lu", (unsigned long) string_size);
   ...
   if (i < count)
     {
       ...
       aux = csym->native + 1;
       do { if (!(! aux->is_sym)) bfd_assert("./coffcode.h",3933); } while (0);
...
# 4464 "./coffcode.h"
 ...
 do { if (!(rec == recend)) bfd_assert("./coffcode.h",4476); } while (0);
      }
...
coff_slurp_line_table (bfd *abfd, asection *asect)
{
  ...
  do { if (!(asect->lineno == ((void*)0))) bfd_assert("./coffcode.h",4563); } while (0);
      ...
      if (func_table != ((void*)0))
 {
   ...
   do { if (!((unsigned int) (p - func_table) == nbr_func)) bfd_assert("./coffcode.h",4686); } while (0);
       ...
       for (i = 0; i < nbr_func; i++)
  {
    ...
    while (old_ptr->line_number != 0);
       ...
       do { if (!((bfd_size_type) (n_cache_ptr - n_lineno_cache) == (amt / sizeof (alent)))) bfd_assert("./coffcode.h",4713); } while (0);
...
coff_slurp_symbol_table (bfd * abfd)
{
      ...
      while (this_index < last_native_index)
 {
   ...
   do { if (!(src->is_sym)) bfd_assert("./coffcode.h",4774); } while (0);
...
# 4890 "./coffcode.h"
     case 6:
       if (src->u.syment.n_scnum == ((short)-2))
...
{
  _bfd_abort ("./coffcode.h", 5423, __PRETTY_FUNCTION__);
  return 0;
}
# 5435 "./coffcode.h"
static void
...
{
  _bfd_abort ("./coffcode.h", 5444, __PRETTY_FUNCTION__);
}
# 5495 "./coffcode.h"
static bfd_boolean
...

{
  ...
  bfd_getl64, bfd_getl_signed_64, bfd_putl64,
    ...
    {_bfd_dummy_target, pe_bfd_object_p, bfd_generic_archive_p, pe_bfd_object_p},
    ...
    {bfd_false, coff_write_object_contents,
     ...
     pe_bfd_copy_private_bfd_data, ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), _bfd_generic_init_private_section_data, _bfd_pe_bfd_copy_private_section_data, ((bfd_boolean (*) (bfd *, asymbol *, bfd *, asymbol *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), pe_print_private_bfd_data,
     ...
     coff_get_symtab_upper_bound, coff_canonicalize_symtab, coff_make_empty_symbol, coff_print_symbol, _bfd_pe_get_symbol_info, ((const char *(*) (bfd *, asymbol *, bfd_boolean *)) bfd_nullvoidptr), coff_i386_is_local_label_name, ((bfd_boolean (*) (bfd *, asymbol *)) bfd_false), coff_get_lineno, coff_find_nearest_line, ((bfd_boolean (*) (bfd *, asymbol **, asymbol *, const char **, unsigned int *)) bfd_false), coff_find_inliner_info, coff_bfd_make_debug_symbol, _bfd_generic_read_minisymbols, _bfd_generic_minisymbol_to_symbol,
     coff_get_reloc_upper_bound, coff_canonicalize_reloc, coff_i386_reloc_type_lookup, coff_i386_reloc_name_lookup,
     coff_set_arch_mach, coff_set_section_contents,
     coff_sizeof_headers, bfd_generic_get_relocated_section_contents, bfd_generic_relax_section, _bfd_coff_link_hash_table_create, _bfd_coff_link_add_symbols, _bfd_generic_link_just_syms, _bfd_generic_copy_link_hash_symbol_type, _bfd_coff_final_link, _bfd_generic_link_split_section, bfd_coff_gc_sections, bfd_generic_lookup_section_flags, bfd_generic_merge_sections, bfd_generic_is_group_section, bfd_generic_discard_group, _bfd_coff_section_already_linked, bfd_generic_define_common_symbol,
...
# 46 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/pei-i386.c" 2
