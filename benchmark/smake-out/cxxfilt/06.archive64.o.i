# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/archive64.c" 2
...
bfd_elf64_archive_slurp_armap (bfd *abfd)
{
  ...
  char *stringbase;
  char *stringend;
  bfd_byte *raw_armap = ((void*)0);
  carsym *carsyms;
  bfd_size_type amt;

  ardata->symdefs = ((void*)0);
  ...
  if (! (strncmp ((nextname), ("/SYM64/         "), sizeof ("/SYM64/         ") - 1) == 0))
    {
      ((abfd)->has_armap) = 0;
      return 1;
    }
          ...
          int stridx)
{
  ...
  padding = ((((bfd_vma) (mapsize) + (8) - 1) >= (bfd_vma) (mapsize)) ? (((bfd_vma) (mapsize) + ((8) - 1)) & ~ (bfd_vma) ((8)-1)) : ~ (bfd_vma) 0) - mapsize;
  mapsize += padding;
  ...
  for (current = arch->archive_head;
       current != ((void*)0) && count < symbol_count;
