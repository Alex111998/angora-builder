# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf32.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf32.c"
# 1 "./elfcode.h" 1
# 68 "./elfcode.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
        ...
        bfd_boolean dynamic)
{
  ...
  do { if (!(entsize == sizeof (Elf32_External_Rel) || entsize == sizeof (Elf32_External_Rela))) bfd_assert("./elfcode.h",1410); } while (0);
         ...
         bfd_boolean dynamic)
{
 ...
 return 0;
      do { if (!((rel_hdr && asect->rel_filepos == rel_hdr->sh_offset) || (rel_hdr2 && asect->rel_filepos == rel_hdr2->sh_offset))) bfd_assert("./elfcode.h",1510); } while (0);
...
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elf32.c" 2
