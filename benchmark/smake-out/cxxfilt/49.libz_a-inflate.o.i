# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
# 83 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
# 1 "./zutil.h" 1
# 22 "./zutil.h"
# 1 "./zlib.h" 1
# 34 "./zlib.h"
...
# 84 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
# 1 "./inftrees.h" 1
# 24 "./inftrees.h"
typedef struct {
    unsigned char op;
...
# 85 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
# 1 "./inflate.h" 1
# 20 "./inflate.h"
typedef enum {
    HEAD,
...
# 86 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
# 1 "./inffast.h" 1
# 11 "./inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 87 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
...
int stream_size;
{
    ...
    if (version == 0 || version[0] != "1.2.7"[0] ||
...
# 260 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
static void fixedtables(state)
struct inflate_state *state;
{
# 295 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
# 1 "./inffixed.h" 1
# 10 "./inffixed.h"
...
# 296 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c" 2
...
# 378 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
...
# 604 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
...
# 1146 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
                }
                if (copy > state->wnext) {
                    copy -= state->wnext;
...
# 1338 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
...
# 1412 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/zlib/inflate.c"
...
z_streamp strm;
{
    ...
    if (strm == 0 || strm->state == 0) return -1L << 16;
    state = (struct inflate_state *)strm->state;
