# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
# 1 "./bfd_stdint.h" 1
...
# 8 "./bfd_stdint.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c" 2
...
# 225 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
bfd_boolean
  ...
  if (bed->want_dynbss)
    {
      ...
      if (s == ((void*)0))
 return 0;
# 422 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 445 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
bfd_boolean
    ...
    bfd_boolean hidden)
{
 ...
 hv = (struct elf_link_hash_entry *) hv->root.u.i.link;
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 593, __PRETTY_FUNCTION__);
      break;
    }
...
# 931 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static bfd_boolean
...
# 1105 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (newdyn)
    {
      if (((sec) == (&_bfd_std_section[1])))
 {
...
# 1319 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 1358 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  ...
  if (*type_change_ok
      || h->root.type == bfd_link_hash_undefined)
    *size_change_ok = 1;
# 1407 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (newdyn
      && newdef
      && !newweak
      && (sec->flags & 0x001) != 0
...
# 1477 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (newdyn
      && newdef
      && (olddef
   || (h->root.type == bfd_link_hash_common
...
# 1553 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  flip = ((void*)0);
  if (!newdyn
      && (newdef
   || ((((sec)->flags & 0x1000) != 0)
 ...
 *pvalue = h->size;
      ...
      do { if (!(pold_alignment)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",1623); } while (0);
        ...
        bfd_boolean *dynsym)
{
      ...
      if (! ((info)->type == type_relocatable))
 {
   ...
   hi = (struct elf_link_hash_entry *) bh;
    ...
    {
# 1787 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 2207 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static bfd_boolean
...
# 2297 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
Elf_Internal_Rela *
      ...
      struct elf_info_failed *eif)
{
      ...
      else
 {
   ...
   do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",2634); } while (0);

   do { if (!(weakdef->def_dynamic)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",2635); } while (0);
   do { if (!(weakdef->root.type == bfd_link_hash_defined || weakdef->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",2637); } while (0);
...
_bfd_elf_adjust_dynamic_symbol (struct elf_link_hash_entry *h, void *data)
{
  ...
  if (! _bfd_elf_fix_symbol_flags (h, eif))
    return 0;
# 2674 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (!h->needs_plt
      && h->type != 10
      && (h->def_regular
   || !h->def_dynamic
...
# 2724 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (h->u.weakdef != ((void*)0))
    {
...
# 2918 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
bfd_boolean
       ...
       bfd_vma val)
{
  ...
  do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",3153); } while (0);
...
on_needed_list (const char *soname, struct bfd_link_needed_list *needed)
{
  for (; needed != ((void*)0); needed = needed->next)
    if (((((needed->by) -> tdata.elf_obj_data) -> dyn_lib_class) & DYN_AS_NEEDED) == 0
...
elf_finalize_dynstr (bfd *output_bfd, struct bfd_link_info *info)
{
  ...
  do { if (!(sdyn != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",3298); } while (0);
...
# 3551 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   if (dynamic)
     {
       struct elf_link_hash_entry *h;
   ...
   && !htab->dynamic_sections_created)
 {
   if (! _bfd_elf_link_create_dynamic_sections (abfd, info))
  ...
  else
    {
      ...
      if (just_syms)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 3626, __PRETTY_FUNCTION__);
# 3635 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 3777 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
 ...
 h = (struct elf_link_hash_entry *) h->root.u.i.link;
   ...
   && h->u.weakdef == ((void*)0))
 {
# 4295 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   h->u.weakdef = weaks;
   weaks = h;
   new_weakdef = 1;
 }
      ...
      if ((((struct bfd_link_hash_table *) (htab))->type == bfd_link_elf_hash_table))
 {
  ...
  dynsym = 1;
   ...
   if ((old_alignment || common)
       && h->root.type != bfd_link_hash_common)
     {
       ...
       do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",4405); } while (0);
  ...
  break;
   ...
   if (!add_needed
    ...
    || (h->ref_dynamic_nonweak
        ...
        && !on_needed_list ((((abfd) -> tdata.elf_obj_data) -> dt_name), htab->needed))))
     {
       int ret;
  ...
  goto error_free_vers;
       ...
       do { if (!(ret == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",4605); } while (0);
     }
 }
    }
...
# 4772 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (weaks != ((void*)0))
    {
      ...
      while (weaks != ((void*)0))
 {
   ...
   do { if (!(hlook->root.type == bfd_link_hash_defined || hlook->root.type == bfd_link_hash_defweak || hlook->root.type == bfd_link_hash_common || hlook->root.type == bfd_link_hash_indirect)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",4822); } while (0);
  ...
  if (bed->check_directives
    ...
    return 0;
# 4933 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (! dynamic
      && (((struct bfd_link_hash_table *) (htab))->type == bfd_link_elf_hash_table)
...
# 5094 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static bfd_boolean
elf_link_add_archive_symbols (bfd *abfd, struct bfd_link_info *info)
{
      ...
      for (i = 0; symdef < symdefend; symdef++, i++)
 {
   ...
   if (h->root.type == bfd_link_hash_common)
     {
# 5179 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  ...
  ->add_archive_element) (info, element, symdef->name, &element))
   ...
   if (!((*((element)->xvec->_bfd_link_add_symbols)) (element, info)))
     goto error_return;
# 5213 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 5465 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static size_t
...
# 5543 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   ...
   max *= fact * fact;
# 5569 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   if (max < best_chlen)
     {
       best_chlen = max;
       best_size = i;
          ...
          asection **sinterpptr)
{
  ...
  if (dynobj != ((void*)0) && ((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      *sinterpptr = bfd_get_linker_section (dynobj, ".interp");
      do { if (!(*sinterpptr != ((void*)0) || !(((info)->type == type_pde) || ((info)->type == type_pie)) || info->nointerp)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",5773); } while (0);
  ...
  if (dynobj != ((void*)0) && ((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version_d");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6078); } while (0);
      ...
      else
 {
  ...
  do { if (!(t->next->next == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6263); } while (0);
      ...
      if (info->flags_1)
 {
   ...
   if (!_bfd_elf_add_dynamic_entry (info, 0x6ffffffb, info->flags_1))
     return 0;
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version_r");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6341); } while (0);
      {
...
bfd_elf_size_dynsym_hash_dynstr (bfd *output_bfd, struct bfd_link_info *info)
{
  ...
  if (((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6537); } while (0);
      if (dynsymcount != 0
   && (s->flags & 0x8000) == 0)
 {
   ...
   if (!_bfd_elf_add_dynamic_entry (info, 0x6ffffff0, 0))
     return 0;
      ...
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6557); } while (0);
      ...
      if (info->emit_hash)
 {
   ...
   do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6615); } while (0);
      ...
      if (info->emit_gnu_hash)
 {
   ...
   do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6669); } while (0);

   if (cinfo.nsyms == 0)
     {

       do { if (!(cinfo.min_dynindx == -1)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6674); } while (0);
       free (cinfo.hashcodes);
  ...
  return 0;
       ...
       ((bed->s->arch_size) == 8 ? ((void) (*((unsigned char *) (contents + 16)) = (0) & 0xff)) : (bed->s->arch_size) == 16 ? ((*((output_bfd)->xvec->bfd_putx16)) ((0),(contents + 16))) : (bed->s->arch_size) == 32 ? ((*((output_bfd)->xvec->bfd_putx32)) ((0),(contents + 16))) : (bed->s->arch_size) == 64 ? ((*((output_bfd)->xvec->bfd_putx64)) ((0), (contents + 16))) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 6690, __PRETTY_FUNCTION__), (void) 0));
   ...
   else
     {
       ...
       do { if (!(cinfo.min_dynindx != -1)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6698); } while (0);
  ...
  if (cinfo.counts[i] != 0)
    {
      ...
      cnt += cinfo.counts[i];
       ...
       do { if (!(cnt == dynsymcount)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6747); } while (0);
       ...
       for (i = 0; i < maskwords; ++i)
  {
    ...
    contents += bed->s->arch_size / 8;
      ...
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6797); } while (0);
...
merge_sections_remove_hook (bfd *abfd __attribute__ ((__unused__)),
       asection *sec)
{
  do { if (!(sec->sec_info_type == 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",6817); } while (0);
  sec->sec_info_type = 0;
}
...
elf_create_symbuf (bfd_size_type symcount, Elf_Internal_Sym *isymbuf)
{
      ...
      if (ind == indbuf || ssymhead->st_shndx != (*ind)->st_shndx)
 {
  ...
  do { if (!((bfd_size_type) (ssymhead - ssymbuf) == shndx_count && (((bfd_hostptr_t) ssym - (bfd_hostptr_t) ssymbuf) == total_size))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",7296); } while (0);
...
# 7625 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static void
    ...
    bfd_vma val)
{
      ...
      if ((((unsigned int)(sym->st_info)) >> 4) == 0)
 {
   ...
   return;
      ...
      do { if (!((((bfd_with_globals) -> tdata.elf_obj_data) -> bad_symtab))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",7649); } while (0);
      extsymoff = 0;
    }
      ...
      else
 {
   if (!resolve_symbol (symbuf, input_bfd, flinfo, result,
       ...
       result))
     {
      ...
      return 1;
# 7902 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
    default:
    ...
    bfd_byte *location)
{
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 7968, __PRETTY_FUNCTION__);
   break;
 }
    }
}
    ...
    bfd_byte *location)
{
  ...
  do { if (!(chunksz <= sizeof (x) && size >= chunksz && chunksz != 0 && (size % chunksz) == 0 && input_bfd != ((void*)0) && location != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",7989); } while (0);
  ...
  if (chunksz == sizeof (x))
    {
      do { if (!(size == chunksz)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",7993); } while (0);
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8022, __PRETTY_FUNCTION__);
 }
    }
  return x;
}
...
# 8090 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  r = bfd_reloc_ok;
  if (! trunc_p)
...
# 8111 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   ...
   bfd_boolean sort)
{
  ...
  if (reldata->hdr->sh_entsize == bed->s->sizeof_rel)
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8232, __PRETTY_FUNCTION__);

  if (bed->s->int_rels_per_ext_rel > 3)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8235, __PRETTY_FUNCTION__);
 ...
 continue;
      ...
      do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",8257); } while (0);
      ...
      if (bed->s->arch_size == 32)
 {
   if (abfd->xvec->header_byteorder == BFD_ENDIAN_LITTLE)
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8281, __PRETTY_FUNCTION__);
 }
      else
 {
   ...
   if (abfd->xvec->header_byteorder == BFD_ENDIAN_LITTLE)
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8292, __PRETTY_FUNCTION__);
 }
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 8301, __PRETTY_FUNCTION__);
...
elf_link_sort_relocs (bfd *abfd, struct bfd_link_info *info, asection **psec)
{
 ...
 if (lo->type == bfd_indirect_link_order)
  ...
  if ((o->size % bed->s->sizeof_rel) == 0)
  ...
  else
    {
      ...
      if (use_rela_initialised && (use_rela == 0))
        {
   _bfd_error_handler
     (dgettext ("bfd", "%B: Unable to sort relocs - they are in more than one size"), abfd);
   bfd_set_error (bfd_error_invalid_operation);
   return 0;
        }
      else
  ...
  _bfd_error_handler
    (dgettext ("bfd", "%B: Unable to sort relocs - they are of an unknown size"), abfd);
  bfd_set_error (bfd_error_invalid_operation);
  return 0;
       }
   }
      ...
      struct elf_link_hash_entry *h)
{
  ...
  do { if (!((((flinfo->output_bfd) -> tdata.elf_obj_data) -> symtab_section))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",8723); } while (0);
...
elf_link_swap_symbols_out (struct elf_final_link_info *flinfo)
{
  ...
  do { if (!((((flinfo->output_bfd) -> tdata.elf_obj_data) -> symtab_section))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",8791); } while (0);
     ...
     struct elf_link_hash_entry *h)
{
 ...
 return 0;
  ...
  do { if (!(abfd != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",8912); } while (0);
      ...
      for (isym = isymbuf; isym < isymend; isym++, ever++)
 {
   ...
   if ((iver.vs_vers & 0x8000) == 0
     ...
     && h->forced_local))
     {
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 9004, __PRETTY_FUNCTION__);
     }
...
# 9031 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
static bfd_boolean
elf_link_output_extsym (struct bfd_hash_entry *bh, void *data)
{
 ...
 def_bfd = hi->root.u.def.section->owner;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_new:
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 9211, __PRETTY_FUNCTION__);
      return 0;
 ...
 if (input_sec->output_section != ((void*)0))
  ...
  if (h->type == 6)
   ...
   {
     do { if (!(input_sec->owner == ((void*)0) || (input_sec->owner->flags & 0x40) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",9257); } while (0);
      ...
      (flinfo->output_bfd, flinfo->info, h, &sym)))
 {
  ...
  if (sym.st_shndx == 0
   ...
   || (((unsigned int)(sym.st_info)) >> 4) == 2))
    {
      int bindtype;
      unsigned int type = ((sym.st_info) & 0xF);
      ...
      if (flinfo->symver_sec != ((void*)0) && flinfo->symver_sec->contents != ((void*)0))
 {
  ...
  if (strip || (input_sec->flags & 0x8000) != 0)
    return 1;
# 9472 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
  if (eoinfo->localsyms
 ...
 return 0;
  ...
  if (ret == 0)
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 9499, __PRETTY_FUNCTION__);
...
# 9539 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
unsigned int
...
elf_link_input_bfd (struct elf_final_link_info *flinfo, bfd *input_bfd)
{
 ...
 return 0;
# 9807 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   ...
   if (((osym.st_info) & 0xF) == 6)
     {
       ...
       do { if (!(((struct elf_link_hash_table *) ((flinfo->info)->hash))->tls_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",9814); } while (0);
   ...
   && (o->flags & (0x100000 | 0x2000000)) == 0x2000000)
 {
       ...
       if (flinfo->indices[symndx] == -1)
  {
    ...
    if (ret == 0)
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 9910, __PRETTY_FUNCTION__);
  }
...
# 10091 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
       ...
       if (action_discarded != -1 && ps != ((void*)0))
  {
    ...
    if ((sec = *ps) != ((void*)0) && (!((sec) == (&_bfd_std_section[2])) && (((sec)->output_section) == (&_bfd_std_section[2])) && (sec)->sec_info_type != 2 && (sec)->sec_info_type != 4))
      {
        do { if (!(r_symndx != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",10107); } while (0);
...
# 10156 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
     ...
     && flinfo->sections[r_symndx] == ((void*)0)))
      {
        ...
        unsigned long indx;
# 10259 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   ...
   rh = (struct elf_link_hash_entry *) rh->root.u.i.link;
        ...
        do { if (!(rh->indx < 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",10268); } while (0);
        rh->indx = -2;
        ...
        if (flinfo->indices[r_symndx] == -1)
   {
         ...
         if (((sym.st_info) & 0xF) == 6)
    {
      ...
      do { if (!(((struct elf_link_hash_table *) ((flinfo->info)->hash)) ->tls_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",10372); } while (0);
     ...
     if (ret == 0)
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 10387, __PRETTY_FUNCTION__);
   }
        ...
        struct bfd_link_order *link_order)
{
  ...
  if (esdo->rel.hdr)
    ...
    {
      reldata = ((void*)0);
      do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",10538); } while (0);
    }
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      do { if (!(indx != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",10546); } while (0);
      *rel_hash_ptr = ((void*)0);
    }
  else
    {
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 10612, __PRETTY_FUNCTION__);
...
bfd_elf_final_link (bfd *abfd, struct bfd_link_info *info)
{
 ...
 o->vma = 0;
  ...
  do { if (!(! abfd->output_has_begun)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",11103); } while (0);
      ...
      if (esdo->this_hdr.sh_offset == (file_ptr) -1)
 {
   ...
   if ((o->flags & 0x8000000) == 0 || contents != ((void*)0))
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c", 11134, __PRETTY_FUNCTION__);
   contents
 ...
 return 0;
  ...
  if (!_bfd_elf_fixup_eh_frame_hdr (info))
    return 0;
# 11336 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
   ...
   || ((struct elf_link_hash_table *) ((info)->hash))->is_relocatable_executable)
 {
  ...
  continue;
       ...
       do { if (!(indx > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",11475); } while (0);
       sym.st_shndx = indx;
  ...
  if (dynamic)
    {
      ...
      do { if (!(o != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",11635); } while (0);
      ...
      for (; dyncon < dynconend; dyncon += bed->s->sizeof_dyn)
 {
  ...
  {
    (*_bfd_error_handler)
      (dgettext ("bfd", "%B: could not find output section %s"), abfd, name);
    goto error_return;
  }
       if (o->size == 0)
  (*_bfd_error_handler)
...
elf_gc_smash_unused_vtentry_relocs (struct elf_link_hash_entry *h, void *okp)
{
  ...
  do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",12581); } while (0);
     ...
     struct bfd_link_info *info)
{
  ...
  do { if (!(abfd == info->output_bfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",13050); } while (0);
...
# 13417 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
...
# 13522 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c"
asection *
...
elf_append_rela (bfd *abfd, asection *s, Elf_Internal_Rela *rel)
{
  ...
  do { if (!(loc + bed->s->sizeof_rela <= s->contents + s->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",13593); } while (0);
...
elf_append_rel (bfd *abfd, asection *s, Elf_Internal_Rela *rel)
{
  ...
  do { if (!(loc + bed->s->sizeof_rel <= s->contents + s->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/elflink.c",13604); } while (0);
