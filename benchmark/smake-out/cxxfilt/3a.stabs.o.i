# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c" 2
# 60 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c"
...
# 107 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c"
    ...
    bfd_size_type *pstring_offset)
{
 ...
 {
   (*_bfd_error_handler)
     (dgettext ("bfd", "%B(%A+0x%lx): Stabs entry has invalid string index."),
      ...
      if (type == (int) N_BINCL)
 {
       ...
       else if (nest == 0)
  {
   ...
   do { if (!(num_chars == (bfd_vma) (symb_rover - symb))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",359); } while (0);
  ...
  free (stabstrbuf);
  stabstrbuf = ((void*)0);
# 460 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c"
   ...
   *pskips = offset;
   if (*pstridx == (bfd_size_type) -1)
     offset += 12;
      ...
      do { if (!(offset != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",490); } while (0);
    }
   ...
   *pskips = offset;
   if (*pstridx == (bfd_size_type) -1)
     offset += 12;
      ...
      do { if (!(offset != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",644); } while (0);
    }
     ...
     bfd_byte *contents)
{
  ...
  for (e = secinfo->excls; e != ((void*)0); e = e->next)
    {
      ...
      do { if (!(e->offset < stabsec->rawsize)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",682); } while (0);
      ...
      if (*pstridx != (bfd_size_type) -1)
 {
   ...
   if (sym[4] == 0)
     {
       ...
       do { if (!(sym == contents)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",708); } while (0);
  ...
  do { if (!((bfd_size_type) (tosym - contents) == stabsec->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",720); } while (0);
...
_bfd_write_stab_strings (bfd *output_bfd, struct stab_info *sinfo)
{
  ...
  do { if (!((sinfo->stabstr->output_offset + _bfd_stringtab_size (sinfo->strings)) <= sinfo->stabstr->output_section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/stabs.c",738); } while (0);
