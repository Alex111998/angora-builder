# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c" 2
...
# 180 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/dwarf1.c"
static bfd_boolean
parse_die (bfd * abfd,
    ...
    bfd_byte * aDiePtrEnd)
{
  ...
  aDieInfo->length = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
  xptr += 4;
  ...
  aDieInfo->tag = ((*((abfd)->xvec->bfd_getx16)) ((bfd_byte *) xptr));
  xptr += 2;
  ...
  while (xptr < (this_die + aDieInfo->length))
    {
      ...
      attr = ((*((abfd)->xvec->bfd_getx16)) ((bfd_byte *) xptr));
      xptr += 2;
 ...
 case FORM_REF:
   if (attr == AT_sibling)
     aDieInfo->sibling = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
   else if (attr == AT_stmt_list)
     {
       aDieInfo->stmt_list_offset = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
 ...
 case FORM_ADDR:
   if (attr == AT_low_pc)
     aDieInfo->low_pc = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
   else if (attr == AT_high_pc)
     aDieInfo->high_pc = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
   xptr += 4;
   break;
 case FORM_BLOCK2:
   xptr += 2 + ((*((abfd)->xvec->bfd_getx16)) ((bfd_byte *) xptr));
   break;
 case FORM_BLOCK4:
   xptr += 4 + ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
   break;
 case FORM_STRING:
   if (attr == AT_name)
