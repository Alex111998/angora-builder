# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 28 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
# 1 "./libcoff.h" 1
# 27 "./libcoff.h"
# 1 "./coff-bfd.h" 1
# 27 "./coff-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
struct bfd_hash_entry *
         ...
         struct bfd_link_info *info)
{
  ...
  do { if (!(symesz == (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_auxesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",264); } while (0);
      ...
      if (classification != COFF_SYMBOL_LOCAL)
 {
   ...
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 303, __PRETTY_FUNCTION__);
...
# 376 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
   if ((((abfd)->tdata.coff_obj_data)->pe)
  ...
  goto error_return;
   ...
   if (classification == COFF_SYMBOL_PE_SECTION
       && (*sym_hash)->numaux != 0)
     {
       ...
       do { if (!((*sym_hash)->numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",494); } while (0);
       if (section->size == 0)
        ...
        struct bfd_link_info *info)
{
      ...
      else
 {
   ...
   line_filepos += o->lineno_count * linesz;
      ...
      if (o->reloc_count != 0)
 {
# 750 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
   do { if (!(((info)->type == type_relocatable))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",750); } while (0);
   amt = o->reloc_count;
      ...
      for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
 {
  ...
  goto error_return;
       ...
       if (string_size)
  {
    bfd_boolean hash = ! (abfd->flags & 0x400);
    bfd_size_type indx;
   ...
   for (; irel < irelend; irel++, rel_hash++, erel += relsz)
     {
       if (*rel_hash != ((void*)0))
  {
    do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",1062); } while (0);
...
_bfd_coff_link_input_bfd (struct coff_final_link_info *flaginfo, bfd *input_bfd)
{
  ...
  do { if (!(linesz == (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_linesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",1410); } while (0);

  copy = 0;
  if (! flaginfo->info->keep_memory)
    copy = 1;
  hash = 1;
  if ((output_bfd->flags & 0x400) != 0)
    hash = 0;
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 1468, __PRETTY_FUNCTION__);
 case COFF_SYMBOL_GLOBAL:
 case COFF_SYMBOL_PE_SECTION:
      ...
      if (! skip)
 {
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 1506, __PRETTY_FUNCTION__);
     case COFF_SYMBOL_GLOBAL:
     case COFF_SYMBOL_COMMON:
     case COFF_SYMBOL_PE_SECTION:
 ...
 skip = 1;
   ...
   && ! dont_skip_symbol
   && (isym.n_scnum == ((short)-2)
       || (isym.n_scnum == ((short)-1)
    && (isym.n_sclass == 1
        || isym.n_sclass == 4
        || isym.n_sclass == 8
        || isym.n_sclass == 16
       ...
       || flaginfo->info->discard == discard_l))
 {
   ...
   if (! dont_skip_symbol
     ...
     skip = 1;
      ...
      if (! skip
   && (flaginfo->output_bfd->flags & 0x400) == 0
   && (isym.n_sclass == 15
       || isym.n_sclass == 10
       || isym.n_sclass == 12)
   && isym.n_numaux == 1)
      ...
      if (! skip)
 {
  ...
  if (! (((flaginfo->output_bfd)->tdata.coff_obj_data)->pe))
    isym.n_value += (*secpp)->output_section->vma;
     ...
     case 103:
# 1847 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
       if (flaginfo->last_file_index != -1
   ...
   if (*indexp < 0)
     {
       ...
       do { if (!(isymp->n_numaux == 0 || h->numaux == 0 || h->numaux == isymp->n_numaux)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",1964); } while (0);
       ...
       if (isymp->n_sclass == 103)
  {
    ...
    if (auxp->x_file.x_n.x_zeroes == 0
        && auxp->x_file.x_n.x_offset != 0)
      {
        ...
        do { if (!(auxp->x_file.x_n.x_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",1999); } while (0);
      ...
      for (o = input_bfd->sections; o != ((void*)0); o = o->next)
 {
   ...
   file_ptr pos;
   bfd_size_type amt;
# 2178 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
   if (o->lineno_count == 0
...
# 2231 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
 ...
 return 0;
      ...
      do { if (!(((((output_bfd)->tdata.coff_obj_data)->raw_syment_count) + (outsym - flaginfo->outsyms) / osymesz) == output_index)) bfd_assert("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c",2308); } while (0);
 ...
 return 1;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 2561, __PRETTY_FUNCTION__);
      return 0;

    case bfd_link_hash_undefined:
    case bfd_link_hash_undefweak:
      isym.n_scnum = ((short)0);
      isym.n_value = 0;
      break;
       ...
       struct bfd_link_order *link_order)
{
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 2804, __PRETTY_FUNCTION__);
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 2846, __PRETTY_FUNCTION__);
      *rel_hash_ptr = ((void*)0);
      irel->r_symndx = 0;
    }
  else
 ...
 {
   if (! ((*flaginfo->info->callbacks->unattached_reloc)
   (flaginfo->info, link_order->u.reloc.p->u.name, (bfd *) ((void*)0),
        ...
        asection **sections)
{
      ...
      else
 {
  ...
  {
# 3013 "/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c"
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.26/binutils-2.26/bfd/cofflink.c", 3086, __PRETTY_FUNCTION__);
 case bfd_reloc_ok:
   break;
 case bfd_reloc_outofrange:
   (*_bfd_error_handler)
