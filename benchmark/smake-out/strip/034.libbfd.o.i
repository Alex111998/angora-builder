# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c" 2
# 46 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
bfd_boolean
bfd_false (bfd *ignore __attribute__ ((__unused__)))
{
...
bfd_boolean
bfd_true (bfd *ignore __attribute__ ((__unused__)))
{
  return 1;
}
...
void *
bfd_nullvoidptr (bfd *ignore __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return ((void*)0);
}
...
int
bfd_0 (bfd *ignore __attribute__ ((__unused__)))
{
  return 0;
}

unsigned int
bfd_0u (bfd *ignore __attribute__ ((__unused__)))
{
   return 0;
}

long
bfd_0l (bfd *ignore __attribute__ ((__unused__)))
{
  return 0;
}
...
long
_bfd_n1 (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return -1;
}
...
void
bfd_void (bfd *ignore __attribute__ ((__unused__)))
{
}
...
# 309 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
bfd_boolean
...
# 485 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
bfd_vma
...
bfd_put_bits (bfd_uint64_t data, void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c", 738, __PRETTY_FUNCTION__);
...
bfd_get_bits (const void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c", 759, __PRETTY_FUNCTION__);
       ...
       bfd_size_type count)
{
  ...
  if (section->compress_status != 0)
    {
      (*_bfd_error_handler)
 (dgettext ("bfd", "%B: unable to get decompressed section %A"),
  abfd, section);
      bfd_set_error (bfd_error_invalid_operation);
      return 0;
    }
...
{
# 866 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c", 866, __PRETTY_FUNCTION__);
...
# 903 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/libbfd.c"
unsigned int
bfd_log2 (bfd_vma x)
{
...
_bfd_generic_verify_endian_match (bfd *ibfd, bfd *obfd)
{
 ...
 msg = dgettext ("bfd", "%B: compiled for a big endian system and target is little endian");
      else
 msg = dgettext ("bfd", "%B: compiled for a little endian system and target is big endian");
...
bfd_vma
read_unsigned_leb128 (bfd *abfd __attribute__ ((__unused__)),
        bfd_byte *buf,
...
bfd_vma
safe_read_leb128 (bfd *abfd __attribute__ ((__unused__)),
    bfd_byte *data,
...
bfd_signed_vma
read_signed_leb128 (bfd *abfd __attribute__ ((__unused__)),
      bfd_byte *buf,
      unsigned int *bytes_read_ptr)
{
  bfd_vma result;
