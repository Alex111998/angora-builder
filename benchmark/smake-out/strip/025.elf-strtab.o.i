# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c" 2
       ...
       bfd_boolean copy)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",153); } while (0);
  ...
  if (entry->len == 0)
    {
      ...
      do { if (!(entry->len > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",165); } while (0);
...
_bfd_elf_strtab_addref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",187); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",188); } while (0);
...
_bfd_elf_strtab_delref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",197); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",198); } while (0);
  do { if (!(tab->array[idx]->refcount > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",199); } while (0);
  --tab->array[idx]->refcount;
}
...
_bfd_elf_strtab_restore (struct elf_strtab_hash *tab, void *buf)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",251); } while (0);
  do { if (!(save->size <= curr_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",252); } while (0);
  tab->size = save->size;
...
_bfd_elf_strtab_offset (struct elf_strtab_hash *tab, size_t idx)
{
  ...
  if (idx == 0)
    return 0;
  do { if (!(idx < tab->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",280); } while (0);
  do { if (!(tab->sec_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",281); } while (0);
  entry = tab->array[idx];
  do { if (!(entry->refcount > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",283); } while (0);
  entry->refcount--;
...
_bfd_elf_strtab_emit (register bfd *abfd, struct elf_strtab_hash *tab)
{
  ...
  for (i = 1; i < tab->size; ++i)
    {
      ...
      do { if (!(tab->array[i]->refcount == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",302); } while (0);
      len = tab->array[i]->len;
      if ((int) len < 0)
 continue;
 ...
 return 0;
  ...
  do { if (!(off == tab->sec_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c",314); } while (0);
  return 1;
}
...
# 404 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-strtab.c"
      e = *--a;
      e->len += 1;
      while (--a >= array)
 {
