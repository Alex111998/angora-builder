# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c" 2
...
extern int utime (const char *__file,
    const struct utimbuf *__file_times)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c" 2
...
simple_copy (const char *from, const char *to)
{
  ...
  fromfd = open (from, 00 | 0);
  if (fromfd < 0)
    return -1;

  tofd = open (to, 0100 | 01 | 01000 | 0, 0777);
...
set_times (const char *destination, const struct stat *statbuf)
{
...

  {
    ...
    tb.actime = statbuf->st_atim.tv_sec;
    tb.modtime = statbuf->st_mtim.tv_sec;
    result = utime (destination, &tb);
# 119 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
  }

  if (result != 0)
    non_fatal (gettext ("%s: cannot set time: %s"), destination, strerror ((*__errno_location ())));
}
# 137 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
int
smart_rename (const char *from, const char *to, int preserve_dates __attribute__ ((__unused__)))
{
  bfd_boolean exists;
  struct stat s;
  int ret = 0;
  ...
  exists = lstat (to, &s) == 0;
# 163 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
  if (! exists
      || (!((((s.st_mode)) & 0170000) == (0120000))
   && ((((s.st_mode)) & 0170000) == (0100000))
   && (s.st_mode & 0200)
   && s.st_nlink == 1)
      )
    {
      ...
      if (ret == 0)
 {
   if (exists)
     {
# 187 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/rename.c"
      ...
      else
 {
   ...
   non_fatal (gettext ("unable to rename '%s'; reason: %s"), to, strerror ((*__errno_location ())));
   unlink (from);
 }
    }
  else
    {
      ...
      if (ret != 0)
 non_fatal (gettext ("unable to copy file '%s'; reason: %s"), to, strerror ((*__errno_location ())));
