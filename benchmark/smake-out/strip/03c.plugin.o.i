# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
# 1 "./plugin.h" 1
# 26 "./plugin.h"
...
plugin_data_struct;
# 37 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 38 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
...
# 39 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c" 2
# 111 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c"
...
try_claim (bfd *abfd)
{
  ...
  if (abfd->my_archive && !((abfd->my_archive)->is_thin_archive))
    {
      iobfd = abfd->my_archive;
      file.offset = abfd->origin;
      file.filesize = (((struct areltdata *)((abfd)->arelt_data))->parsed_size);
    }
  else
    {
      iobfd = abfd;
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",391); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",404); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",417); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",424); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",431); } while (0);
  return ((void*)0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",438); } while (0);
  return 0;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",445); } while (0);
  return 0;
}
...
bfd_plugin_get_symtab_upper_bound (bfd *abfd)
{
  ...
  do { if (!(nsyms >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",455); } while (0);
...
convert_flags (const struct ld_plugin_symbol *sym)
{
 switch (sym->def)
   ...
   default:
     do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",475); } while (0);
     return 0;
   }
}
    ...
    asymbol **alocation)
{
  ...
  for (i = 0; i < nsyms; i++)
    {
      ...
      do { if (!(s)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",498); } while (0);
      alocation[i] = s;
 ...
 case LDPK_WEAKDEF:
   ...
   break;
 default:
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",519); } while (0);
 }
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",534); } while (0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/plugin.c",561); } while (0);
  return 0;
}
...
const bfd_target plugin_vec =
{
  ...
  bfd_plugin_bfd_copy_private_bfd_data, ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), _bfd_generic_init_private_section_data, bfd_plugin_bfd_copy_private_section_data, bfd_plugin_bfd_copy_private_symbol_data, ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), bfd_plugin_bfd_print_private_bfd_data,
