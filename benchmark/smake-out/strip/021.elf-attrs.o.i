# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c" 2
...
bfd_elf_set_obj_attr_contents (bfd *abfd, bfd_byte *contents, bfd_vma size)
{
 ...
 vendor_set_obj_attr_contents (abfd, p, vendor_size, vendor);
  ...
  if (size != my_size)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c", 225, __PRETTY_FUNCTION__);
}
    ...
    list = list->next)
 {
   ...
   switch (in_attr->type & ((1 << 0) | (1 << 1)))
     ...
     case (1 << 0) | (1 << 1):
       ...
       break;
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c", 389, __PRETTY_FUNCTION__);
     }
 }
    }
}
...
_bfd_elf_obj_attrs_arg_type (bfd *abfd, int vendor, unsigned int tag)
{
  switch (vendor)
    ...
    case 1:
      ...
      break;
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c", 424, __PRETTY_FUNCTION__);
    }
}
      ...
      while (len > 0 && p < p_end - 4)
 {
   ...
   while (section_len > 0 && p < p_end)
     {
       ...
       tag = safe_read_leb128 (abfd, p, &n, 0, p_end);
       p += n;
       if (p < p_end - 4)
  ...
  case Tag_File:
    while (p < end)
      {
        ...
        tag = safe_read_leb128 (abfd, p, &n, 0, end);
        p += n;
        type = _bfd_elf_obj_attrs_arg_type (abfd, vendor, tag);
        switch (type & ((1 << 0) | (1 << 1)))
   {
   case (1 << 0) | (1 << 1):
     val = safe_read_leb128 (abfd, p, &n, 0, end);
     p += n;
   ...
   case (1 << 0):
     ...
     break;
   default:
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c", 543, __PRETTY_FUNCTION__);
   }
      }
    break;
  case Tag_Section:
...
# 573 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-attrs.c"
bfd_boolean
_bfd_elf_merge_object_attributes (bfd *ibfd, bfd *obfd)
{
 ...
 {
   _bfd_error_handler
  (dgettext ("bfd", "error: %B: Object has vendor-specific contents that " "must be processed by the '%s' toolchain"),
 ...
 {
   _bfd_error_handler (dgettext ("bfd", "error: %B: Object tag '%d, %s' is " "incompatible with tag '%d, %s'"),
