# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
# 1 "./bfd_stdint.h" 1
...
# 8 "./bfd_stdint.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
plugin_data_struct;
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c" 2
...
# 245 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
bfd_boolean
  ...
  if (bed->want_dynbss)
    {
      ...
      if (s == ((void*)0))
 return 0;
# 442 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 465 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
bfd_boolean
    ...
    bfd_boolean hidden)
{
 ...
 hv = (struct elf_link_hash_entry *) hv->root.u.i.link;
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 628, __PRETTY_FUNCTION__);
      break;
    }
...
# 965 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static bfd_boolean
...
# 1139 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (newdyn)
    {
      if (((sec) == (&_bfd_std_section[1])))
 {
...
# 1352 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 1391 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  ...
  if (*type_change_ok
      || h->root.type == bfd_link_hash_undefined)
    *size_change_ok = 1;
# 1440 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (newdyn
      && newdef
      && !newweak
      && (sec->flags & 0x001) != 0
...
# 1509 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (newdyn
      && newdef
      && (olddef
   || (h->root.type == bfd_link_hash_common
...
# 1587 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  flip = ((void*)0);
  if (!newdyn
      && (newdef
   || ((((sec)->flags & 0x1000) != 0)
 ...
 *pvalue = h->size;
      ...
      do { if (!(pold_alignment)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",1656); } while (0);
        ...
        bfd_boolean *dynsym)
{
      ...
      if (! ((info)->type == type_relocatable))
 {
   ...
   hi = (struct elf_link_hash_entry *) bh;
    ...
    {
# 1845 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 2264 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static bfd_boolean
...
# 2354 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
Elf_Internal_Rela *
      ...
      struct elf_info_failed *eif)
{
      ...
      else
 {
   ...
   do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",2691); } while (0);

   do { if (!(weakdef->def_dynamic)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",2692); } while (0);
   do { if (!(weakdef->root.type == bfd_link_hash_defined || weakdef->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",2694); } while (0);
...
_bfd_elf_adjust_dynamic_symbol (struct elf_link_hash_entry *h, void *data)
{
  ...
  if (! _bfd_elf_fix_symbol_flags (h, eif))
    return 0;
# 2731 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (!h->needs_plt
      && h->type != 10
      && (h->def_regular
   || !h->def_dynamic
...
# 2781 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (h->u.weakdef != ((void*)0))
    {
...
# 2975 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
bfd_boolean
       ...
       bfd_vma val)
{
  ...
  do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",3220); } while (0);
...
elf_finalize_dynstr (bfd *output_bfd, struct bfd_link_info *info)
{
  ...
  do { if (!(sdyn != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",3379); } while (0);
...
_bfd_elf_link_check_relocs (bfd *abfd, struct bfd_link_info *info)
{
  const struct elf_backend_data *bed = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data);
  struct elf_link_hash_table *htab = ((struct elf_link_hash_table *) ((info)->hash));
# 3558 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 3696 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   if (dynamic)
     {
       struct elf_link_hash_entry *h;
   ...
   && !htab->dynamic_sections_created)
 {
   if (! _bfd_elf_link_create_dynamic_sections (abfd, info))
  ...
  else
    {
      ...
      if (just_syms)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 3774, __PRETTY_FUNCTION__);
# 3783 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 3925 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
 ...
 h->indx = -3;
   ...
   && h->u.weakdef == ((void*)0))
 {
# 4458 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   h->u.weakdef = weaks;
   weaks = h;
   new_weakdef = 1;
 }
      ...
      if ((((struct bfd_link_hash_table *) (htab))->type == bfd_link_elf_hash_table))
 {
  ...
  dynsym = 1;
   ...
   if ((old_alignment || common)
       && h->root.type != bfd_link_hash_common)
     {
       ...
       do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",4568); } while (0);
  ...
  goto error_free_vers;
       ...
       do { if (!(ret == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",4772); } while (0);
     }
 }
    }
...
# 4938 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (weaks != ((void*)0))
    {
      ...
      while (weaks != ((void*)0))
 {
   ...
   do { if (!(hlook->root.type == bfd_link_hash_defined || hlook->root.type == bfd_link_hash_defweak || hlook->root.type == bfd_link_hash_common || hlook->root.type == bfd_link_hash_indirect)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",4989); } while (0);
...
# 5215 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static bfd_boolean
elf_link_add_archive_symbols (bfd *abfd, struct bfd_link_info *info)
{
      ...
      for (i = 0; symdef < symdefend; symdef++, i++)
 {
   ...
   if (h->root.type == bfd_link_hash_common)
     {
# 5300 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  ...
  ->add_archive_element) (info, element, symdef->name, &element))
   ...
   if (!((*((element)->xvec->_bfd_link_add_symbols)) (element, info)))
     goto error_return;
# 5334 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 5586 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static size_t
...
# 5664 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   ...
   max *= fact * fact;
# 5690 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   if (max < best_chlen)
     {
       best_chlen = max;
       best_size = i;
          ...
          asection **sinterpptr)
{
  ...
  if (dynobj != ((void*)0) && ((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      *sinterpptr = bfd_get_linker_section (dynobj, ".interp");
      do { if (!(*sinterpptr != ((void*)0) || !(((info)->type == type_pde) || ((info)->type == type_pie)) || info->nointerp)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",5894); } while (0);
   ...
   if (! (((info)->type == type_pde) || ((info)->type == type_pie)))
     {
       ...
       for (sub = info->input_bfds; sub != ((void*)0);
     sub = sub->link.next)
  ...
  if (dynobj != ((void*)0) && ((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version_d");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6199); } while (0);
      ...
      else
 {
  ...
  do { if (!(t->next->next == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6384); } while (0);
      ...
      if (info->flags_1)
 {
   ...
   if (!_bfd_elf_add_dynamic_entry (info, 0x6ffffffb, info->flags_1))
     return 0;
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version_r");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6462); } while (0);
      {
...
bfd_elf_size_dynsym_hash_dynstr (bfd *output_bfd, struct bfd_link_info *info)
{
  ...
  if (((struct elf_link_hash_table *) ((info)->hash))->dynamic_sections_created)
    {
      ...
      s = bfd_get_linker_section (dynobj, ".gnu.version");
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6658); } while (0);
      if ((s->flags & 0x8000) == 0)
 {
   ...
   if (!_bfd_elf_add_dynamic_entry (info, 0x6ffffff0, 0))
     return 0;
      ...
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6677); } while (0);
      ...
      if (info->emit_hash)
 {
   ...
   do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6732); } while (0);
      ...
      if (info->emit_gnu_hash)
 {
   ...
   do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6786); } while (0);

   if (cinfo.nsyms == 0)
     {

       do { if (!(cinfo.min_dynindx == -1)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6791); } while (0);
       free (cinfo.hashcodes);
  ...
  return 0;
       ...
       ((bed->s->arch_size) == 8 ? ((void) (*((unsigned char *) (contents + 16)) = (0) & 0xff)) : (bed->s->arch_size) == 16 ? ((*((output_bfd)->xvec->bfd_putx16)) ((0),(contents + 16))) : (bed->s->arch_size) == 32 ? ((*((output_bfd)->xvec->bfd_putx32)) ((0),(contents + 16))) : (bed->s->arch_size) == 64 ? ((*((output_bfd)->xvec->bfd_putx64)) ((0), (contents + 16))) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 6807, __PRETTY_FUNCTION__), (void) 0));
   ...
   else
     {
       ...
       do { if (!(cinfo.min_dynindx != -1)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6815); } while (0);
  ...
  if (cinfo.counts[i] != 0)
    {
      ...
      cnt += cinfo.counts[i];
       ...
       do { if (!(cnt == dynsymcount)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6864); } while (0);
       ...
       for (i = 0; i < maskwords; ++i)
  {
    ...
    contents += bed->s->arch_size / 8;
      ...
      do { if (!(s != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6914); } while (0);
...
merge_sections_remove_hook (bfd *abfd __attribute__ ((__unused__)),
       asection *sec)
{
  do { if (!(sec->sec_info_type == 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",6934); } while (0);
  sec->sec_info_type = 0;
}
...
elf_create_symbuf (size_t symcount, Elf_Internal_Sym *isymbuf)
{
      ...
      if (ind == indbuf || ssymhead->st_shndx != (*ind)->st_shndx)
 {
  ...
  do { if (!((size_t) (ssymhead - ssymbuf) == shndx_count && (((bfd_hostptr_t) ssym - (bfd_hostptr_t) ssymbuf) == total_size))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",7413); } while (0);
...
# 7742 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static void
    ...
    bfd_vma val)
{
      ...
      if ((((unsigned int)(sym->st_info)) >> 4) == 0)
 {
   ...
   return;
      ...
      do { if (!((((bfd_with_globals) -> tdata.elf_obj_data) -> bad_symtab))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",7766); } while (0);
      extsymoff = 0;
    }
      ...
      else
 {
   if (!resolve_symbol (symbuf, input_bfd, flinfo, result,
       ...
       result, input_bfd))
     {
      ...
      return 1;
# 8025 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
    default:
    ...
    bfd_byte *location)
{
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8091, __PRETTY_FUNCTION__);
   break;
 }
    }
}
    ...
    bfd_byte *location)
{
  ...
  do { if (!(chunksz <= sizeof (x) && size >= chunksz && chunksz != 0 && (size % chunksz) == 0 && input_bfd != ((void*)0) && location != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",8112); } while (0);
  ...
  if (chunksz == sizeof (x))
    {
      do { if (!(size == chunksz)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",8116); } while (0);
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8145, __PRETTY_FUNCTION__);
 }
    }
  return x;
}
...
# 8213 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  r = bfd_reloc_ok;
  if (! trunc_p)
...
# 8233 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   ...
   bfd_boolean sort)
{
  ...
  if (reldata->hdr->sh_entsize == bed->s->sizeof_rel)
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8355, __PRETTY_FUNCTION__);

  if (bed->s->int_rels_per_ext_rel > 3)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8358, __PRETTY_FUNCTION__);
 ...
 continue;
      ...
      do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",8380); } while (0);
      ...
      if (bed->s->arch_size == 32)
 {
   if (abfd->xvec->header_byteorder == BFD_ENDIAN_LITTLE)
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8404, __PRETTY_FUNCTION__);
 }
      else
 {
   ...
   if (abfd->xvec->header_byteorder == BFD_ENDIAN_LITTLE)
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8415, __PRETTY_FUNCTION__);
 }
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 8424, __PRETTY_FUNCTION__);
      ...
      struct elf_link_hash_entry *h)
{
  ...
  do { if (!((((flinfo->output_bfd) -> tdata.elf_obj_data) -> symtab_section))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",8880); } while (0);
...
elf_link_swap_symbols_out (struct elf_final_link_info *flinfo)
{
  ...
  do { if (!((((flinfo->output_bfd) -> tdata.elf_obj_data) -> symtab_section))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",8949); } while (0);
     ...
     struct elf_link_hash_entry *h)
{
 ...
 return 0;
  ...
  do { if (!(abfd != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",9071); } while (0);
      ...
      for (isym = isymbuf; isym < isymend; isym++, ever++)
 {
   ...
   if ((iver.vs_vers & 0x8000) == 0
     ...
     && h->forced_local))
     {
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 9163, __PRETTY_FUNCTION__);
     }
...
elf_link_convert_common_type (struct bfd_link_info *info, int type)
{
  ...
  if (!((info)->type == type_relocatable))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 9190, __PRETTY_FUNCTION__);
...
# 9212 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
static bfd_boolean
elf_link_output_extsym (struct bfd_hash_entry *bh, void *data)
{
 ...
 def_bfd = hi->root.u.def.section->owner;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_new:
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 9375, __PRETTY_FUNCTION__);
      return 0;
 ...
 if (input_sec->output_section != ((void*)0))
  ...
  if (h->type == 6)
   ...
   {
     do { if (!(input_sec->owner == ((void*)0) || (input_sec->owner->flags & 0x40) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",9421); } while (0);
 ...
 break;
      default:
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 9461, __PRETTY_FUNCTION__);
      }
      ...
      if (flinfo->symver_sec != ((void*)0) && flinfo->symver_sec->contents != ((void*)0))
 {
  ...
  if ((input_sec->flags & 0x8000) != 0)
    return 1;
# 9681 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
  if (eoinfo->localsyms
 ...
 return 0;
  ...
  if (ret == 0)
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 9708, __PRETTY_FUNCTION__);
...
# 9748 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
unsigned int
...
elf_link_input_bfd (struct elf_final_link_info *flinfo, bfd *input_bfd)
{
 ...
 return 0;
# 10017 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   ...
   if (((osym.st_info) & 0xF) == 6)
     {
       ...
       do { if (!(((struct elf_link_hash_table *) ((flinfo->info)->hash))->tls_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10024); } while (0);
   ...
   && (o->flags & (0x100000 | 0x2000000)) == 0x2000000)
 {
       ...
       if (flinfo->indices[symndx] == -1)
  {
    ...
    if (ret == 0)
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 10120, __PRETTY_FUNCTION__);
  }
...
# 10301 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
       ...
       if (action_discarded != -1 && ps != ((void*)0))
  {
    ...
    if ((sec = *ps) != ((void*)0) && (!((sec) == (&_bfd_std_section[2])) && (((sec)->output_section) == (&_bfd_std_section[2])) && (sec)->sec_info_type != 2 && (sec)->sec_info_type != 4))
      {
        do { if (!(r_symndx != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10317); } while (0);
...
# 10366 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
     ...
     && flinfo->sections[r_symndx] == ((void*)0)))
      {
        ...
        unsigned long indx;
# 10469 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
   ...
   rh = (struct elf_link_hash_entry *) rh->root.u.i.link;
        ...
        do { if (!(rh->indx < 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10478); } while (0);
        rh->indx = -2;
        ...
        if (flinfo->indices[r_symndx] == -1)
   {
         ...
         if (((sym.st_info) & 0xF) == 6)
    {
      ...
      do { if (!(((struct elf_link_hash_table *) ((flinfo->info)->hash)) ->tls_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10582); } while (0);
     ...
     if (ret == 0)
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 10597, __PRETTY_FUNCTION__);
   }
        ...
        struct bfd_link_order *link_order)
{
  ...
  if (esdo->rel.hdr)
    ...
    {
      reldata = ((void*)0);
      do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10750); } while (0);
    }
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      do { if (!(indx != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",10758); } while (0);
      *rel_hash_ptr = ((void*)0);
    }
  else
    {
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 10823, __PRETTY_FUNCTION__);
...
elf_fixup_link_order (bfd *abfd, asection *o)
{
      ...
      if (seen_other && seen_linkorder)
 {
   if (other_sec && linkorder_sec)
     (*_bfd_error_handler) (dgettext ("bfd", "%A has both ordered [`%A' in %B] and unordered [`%A' in %B] sections"),
       o, linkorder_sec,
       linkorder_sec->owner, other_sec,
       other_sec->owner);
   else
     (*_bfd_error_handler) (dgettext ("bfd", "%A has both ordered and unordered sections"),
       o);
   bfd_set_error (bfd_error_bad_value);
   return 0;
 }
...
bfd_elf_final_link (bfd *abfd, struct bfd_link_info *info)
{
 ...
 o->vma = 0;
  ...
  if (! ((info)->type == type_relocatable) && merged)
    (bfd_link_hash_traverse (&(((struct elf_link_hash_table *) ((info)->hash)))->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (_bfd_elf_link_sec_merge_syms), (abfd)));
  ...
  do { if (!(! abfd->output_has_begun)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",11328); } while (0);
      ...
      if (esdo->this_hdr.sh_offset == (file_ptr) -1)
 {
   ...
   if ((o->flags & 0x8000000) == 0 || contents != ((void*)0))
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 11359, __PRETTY_FUNCTION__);
   contents
  ...
  if (max_sym_count < 20)
    max_sym_count = 20;
  ((struct elf_link_hash_table *) ((info)->hash))->strtabsize = max_sym_count;
  amt = max_sym_count * sizeof (struct elf_sym_strtab);
  ((struct elf_link_hash_table *) ((info)->hash))->strtab
    = (struct elf_sym_strtab *) bfd_malloc (amt);
  if (((struct elf_link_hash_table *) ((info)->hash))->strtab == ((void*)0))
    goto error_return;
  ...
  if (((struct elf_link_hash_table *) ((info)->hash))->tls_sec)
    {
      ...
      for (sec = ((struct elf_link_hash_table *) ((info)->hash))->tls_sec;
    sec && (sec->flags & 0x400);
    sec = sec->next)
 {
  ...
  size = ord->offset + ord->size;
      ...
      base = ((struct elf_link_hash_table *) ((info)->hash))->tls_sec->vma;


      if (bed->static_tls_alignment == 1)
 end = (((end) + ((bfd_vma) 1 << (((struct elf_link_hash_table *) ((info)->hash))->tls_sec->alignment_power)) - 1) & (-((bfd_vma) 1 << (((struct elf_link_hash_table *) ((info)->hash))->tls_sec->alignment_power))));

      ((struct elf_link_hash_table *) ((info)->hash))->tls_size = end - base;
    }
 ...
 return 0;
  ...
  if (!_bfd_elf_fixup_eh_frame_hdr (info))
    return 0;
# 11561 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
      ...
      for (p = o->map_head.link_order; p != ((void*)0); p = p->next)
 {
       ...
       if (! _bfd_default_link_order (abfd, info, o, p))
  {
   ...
   default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 11602, __PRETTY_FUNCTION__);
   }
   ...
   default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c", 11610, __PRETTY_FUNCTION__);
   }
 ...
 return 0;
  ...
  if (dynamic
      && ((struct elf_link_hash_table *) ((info)->hash))->dynsym != ((void*)0)
      && (((struct elf_link_hash_table *) ((info)->hash))->dynsym->output_section
   != (&_bfd_std_section[2])))
    {
      Elf_Internal_Sym sym;
      bfd_byte *dynsym = ((struct elf_link_hash_table *) ((info)->hash))->dynsym->contents;
      long last_local = 0;
   ...
   || ((struct elf_link_hash_table *) ((info)->hash))->is_relocatable_executable)
 {
  ...
  continue;
       ...
       do { if (!(indx > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",11705); } while (0);
       sym.st_shndx = indx;
      ...
      if (((struct elf_link_hash_table *) ((info)->hash))->dynlocal)
 {
  ...
  last_local = e->dynindx;
      ...
      ((struct bfd_elf_section_data*)(((struct elf_link_hash_table *) ((info)->hash))->dynsym->output_section)->used_by_bfd)->this_hdr.sh_info =
 last_local + 1;
    }
  ...
  if (dynamic)
    {
      ...
      do { if (!(o != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",11865); } while (0);
      ...
      for (o = dynobj->sections; o != ((void*)0); o = o->next)
 {
   ...
   if (((struct elf_link_hash_table *) ((info)->hash))->stab_info.stabstr == o)
     continue;
   if (((struct elf_link_hash_table *) ((info)->hash))->eh_info.hdr_sec == o)
     continue;
 ...
 goto error_return;
  ...
  if (((struct elf_link_hash_table *) ((info)->hash))->stab_info.stabstr != ((void*)0))
    {
   ...
   struct elf_link_hash_entry *h)
{
 ...
 return ((void*)0);
  ...
  if (sec_name != ((void*)0) && *sec_name != '\0')
    {
      bfd *i;

      for (i = info->input_bfds; i != ((void*)0); i = i->link.next)
 {
...
elf_gc_sweep (bfd *abfd, struct bfd_link_info *info)
{
      ...
      for (o = sub->sections; o != ((void*)0); o = o->next)
 {
   ...
   if (info->print_gc_sections && o->size != 0)
     _bfd_error_handler (dgettext ("bfd", "Removing unused section '%s' in file '%B'"), sub, o->name);
...
elf_gc_smash_unused_vtentry_relocs (struct elf_link_hash_entry *h, void *okp)
{
  ...
  do { if (!(h->root.type == bfd_link_hash_defined || h->root.type == bfd_link_hash_defweak)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",12848); } while (0);
     ...
     struct bfd_link_info *info)
{
  ...
  do { if (!(abfd == info->output_bfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",13317); } while (0);
...
# 13684 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
...
# 13789 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c"
asection *
...
elf_append_rela (bfd *abfd, asection *s, Elf_Internal_Rela *rel)
{
  ...
  do { if (!(loc + bed->s->sizeof_rela <= s->contents + s->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",13860); } while (0);
...
elf_append_rel (bfd *abfd, asection *s, Elf_Internal_Rela *rel)
{
  ...
  do { if (!(loc + bed->s->sizeof_rel <= s->contents + s->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elflink.c",13871); } while (0);
