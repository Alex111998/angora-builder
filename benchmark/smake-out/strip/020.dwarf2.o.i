# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 36 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 37 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c" 2
...
# 375 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
...
# 657 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static char *
...
read_address (struct comp_unit *unit, bfd_byte *buf, bfd_byte * buf_end)
{
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c", 824, __PRETTY_FUNCTION__);
 }
    }
  else
    {
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c", 838, __PRETTY_FUNCTION__);
 }
    }
}
...
# 970 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
...
# 1367 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
  if (seq
...
sort_line_sequences (struct line_info_table* table)
{
  ...
  for (n = 0; n < num_sequences; n++)
    {
      ...
      do { if (!(seq)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",1608); } while (0);
  ...
  do { if (!(seq == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",1615); } while (0);
...
# 2152 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static bfd_boolean
  ...
  if (attr_ptr->form == DW_FORM_ref_addr)
    {
      ...
      if (!die_ref)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c", 2297, __PRETTY_FUNCTION__);
...
scan_unit_for_symbols (struct comp_unit *unit)
{
   ...
   || abbrev->tag == DW_TAG_inlined_subroutine)
 {
   ...
   do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",2516); } while (0);
      ...
      else
 {
  ...
  goto fail;
       ...
       do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",2540); } while (0);
     }
  ...
  case DW_AT_location:
        ...
        if (*attr.u.blk->data == DW_OP_addr)
   {
     ...
     if (attr.u.blk->size == unit->addr_size + 1U)
       var->addr = ((unit->addr_size * 8) == 8 ? (bfd_vma) (*(const unsigned char *) (attr.u.blk->data + 1) & 0xff) : (unit->addr_size * 8) == 16 ? ((*((unit->abfd)->xvec->bfd_getx16)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 32 ? ((*((unit->abfd)->xvec->bfd_getx32)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 64 ? ((*((unit->abfd)->xvec->bfd_getx64)) (attr.u.blk->data + 1)) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c", 2664, __PRETTY_FUNCTION__), (bfd_vma) - 1));
...
# 2725 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
   ...
   unsigned int offset_size)
{
  ...
  info_ptr += 2;
  do { if (!(offset_size == 4 || offset_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",2749); } while (0);
  if (offset_size == 4)
...
# 2950 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static bfd_vma
...
# 3045 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static bfd_boolean
       ...
       struct info_hash_table *varinfo_hash_table)
{
  ...
  do { if (!(stash->info_hash_status != 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3110); } while (0);

  if (!comp_unit_maybe_decode_line_info (unit, stash))
    return 0;

  do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3115); } while (0);
...
# 3173 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static asection *
...
# 3267 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static bfd_boolean
place_sections (bfd *orig_bfd, struct dwarf2_debug *stash)
{
      ...
      while (1)
 {
  ...
  continue;
       ...
       if (is_debug_info)
  {
    do { if (!(sect->alignment_power == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3356); } while (0);
    sect->vma = last_dwarf;
    last_dwarf += sz;
  }
       else
...
stash_verify_info_hash_table (struct dwarf2_debug *stash)
{
    ...
    each_func = each_func->prev_func)
 {
   ...
   node = lookup_info_hash_table (stash->funcinfo_hash_table,
      each_func->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3532); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3539); } while (0);
 }
    ...
    each_var = each_var->prev_var)
 {
   ...
   node = lookup_info_hash_table (stash->varinfo_hash_table,
      each_var->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3550); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3557); } while (0);
 }
    }
}
...
{
  do { if (!(stash->info_hash_status == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3570); } while (0);
...
stash_find_line_fast (struct dwarf2_debug *stash,
        ...
        unsigned int *linenumber_ptr)
{
  do { if (!(stash->info_hash_status == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3606); } while (0);
...
# 3645 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
static bfd_boolean
         ...
         bfd_boolean do_place)
{
   ...
   || !bfd_generic_link_read_symbols (debug_bfd))
 {
  ...
  if (do_place
    ...
    return 0;
# 3753 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
...
# 3864 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
bfd_boolean
_bfd_dwarf2_find_nearest_line (bfd *abfd,
          ...
          void **pinfo)
{
# 3886 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
  struct dwarf2_debug *stash;
  ...
  *linenumber_ptr = 0;
  ...
  if (do_line)
    {
      do { if (!(section == ((void*)0) && offset == 0 && functionname_ptr == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3911); } while (0);
      section = ((symbol)->section);
      addr = symbol->value;
    }
  else
    {
      do { if (!(section != ((void*)0) && functionname_ptr != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",3917); } while (0);
      addr = offset;
    }
      ...
      for (each = stash->all_comp_units; each; each = each->next_unit)
 {
   ...
   if (found)
     {
# 4002 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
       if (range <= min_range)
  {
      ...
      if (* linenumber_ptr)
 {
  ...
  if (addr_size == 0)
    addr_size = 4;
  do { if (!(addr_size == 4 || addr_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c",4029); } while (0);
...
# 4065 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
      else if (addr_size == 8)
 {
   offset_size = 4;
   stash->info_ptr += 4;
 ...
 return ((void*)0);
  ...
  if (cache->last_section != section
      ...
      || offset >= cache->func->value + cache->func_size)
    {
      ...
      bfd_vma low_func;
      asymbol **p;
# 4329 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/./dwarf2.c"
