# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
# 1 "./../include/ieee.h" 1
# 25 "./../include/ieee.h"
...
ieee_section_type;
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c" 2
...
# 252 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
...
{
  if (p != ((void*)0))
    fprintf (stderr, "%s: 0x%lx: %s (0x%x)\n", ((char *) (info->abfd)->filename),
      (unsigned long) (p - info->bytes), s, *p);
  else
    fprintf (stderr, "%s: %s\n", ((char *) (info->abfd)->filename), s);
}
...
ieee_eof (struct ieee_info *info)
{
  ieee_error (info, (const bfd_byte *) ((void*)0),
       gettext ("unexpected end of debugging information"));
}
 ...
 *ppresent = 1;
  ...
  ieee_error (info, *pp - 1, gettext ("invalid number"));
  return 0;
}
      ...
      if (ppresent != ((void*)0))
 {
   ...
   *ppresent = 0;
   return 1;
      ...
      ieee_error (info, *pp - 1, gettext ("invalid string length"));
      return 0;
    }
        ...
        bfd_vma *pv)
{
 ...
 return 0;
      ...
      if (present)
 {
   if (esp - expr_stack >= (10))
     {
       ieee_error (info, start, gettext ("expression stack overflow"));
       return 0;
     }
   *esp++ = val;
   continue;
 ...
 {
 default:
   ieee_error (info, start, gettext ("unsupported IEEE expression operator"));
   break;
 ...
 case ieee_variable_R_enum:
  ...
  break;
     if (s == ((void*)0))
       {
  ieee_error (info, start, gettext ("unknown section"));
  return 0;
       }
 ...
 case ieee_function_minus_enum:
   {
     ...
     if (esp - expr_stack < 2)
       {
  ieee_error (info, start, gettext ("expression stack underflow"));
  return 0;
       }
  ...
  if (esp - 1 != expr_stack)
    {
      ieee_error (info, expr_start, gettext ("expression stack mismatch"));
      return 0;
    }
     ...
     unsigned int indx)
{
  ...
  if (indx < (60)
      && info->types.builtins[indx] != ((debug_type) ((void*)0)))
  ...
  if (indx >= 32 && indx < 64)
    {
      ...
      ((void) sizeof ((indx < (60)) ? 1 : 0), __extension__ ({ if (indx < (60)) ; else __assert_fail ("indx < BUILTIN_TYPE_COUNT", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 604, __extension__ __PRETTY_FUNCTION__); }));
  ...
  switch ((enum builtin_types) indx)
    {
    default:
      ieee_error (info, p, gettext ("unknown builtin type"));
      return ((void*)0);
    ...
    case builtin_signed_char:
      type = debug_make_int_type (dhandle, 1, 0);
      name = "signed char";
      break;

    case builtin_unsigned_char:
      type = debug_make_int_type (dhandle, 1, 1);
      name = "unsigned char";
      break;

    case builtin_signed_short_int:
      type = debug_make_int_type (dhandle, 2, 0);
      name = "signed short int";
      break;

    case builtin_unsigned_short_int:
      type = debug_make_int_type (dhandle, 2, 1);
      name = "unsigned short int";
      break;

    case builtin_signed_long:
      type = debug_make_int_type (dhandle, 4, 0);
      name = "signed long";
      break;

    case builtin_unsigned_long:
      type = debug_make_int_type (dhandle, 4, 1);
      name = "unsigned long";
      break;

    case builtin_signed_long_long:
      type = debug_make_int_type (dhandle, 8, 0);
      name = "signed long long";
      break;

    case builtin_unsigned_long_long:
      type = debug_make_int_type (dhandle, 8, 1);
    ...
    case builtin_bcd_float:
      ieee_error (info, p, gettext ("BCD float type not supported"));
      return ((debug_type) ((void*)0));
    }

  if (name != ((void*)0))
    type = debug_name_type (dhandle, name, type);

  ((void) sizeof ((indx < (60)) ? 1 : 0), __extension__ ({ if (indx < (60)) ; else __assert_fail ("indx < BUILTIN_TYPE_COUNT", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 764, __extension__ __PRETTY_FUNCTION__); }));
        ...
        debug_type *ptype)
{
 ...
 return 0;
  ...
  indx -= 256;
  if (! ieee_alloc_type (info, indx, 1))
    return 0;
...
parse_ieee (void *dhandle, bfd *abfd, const bfd_byte *bytes, bfd_size_type len)
{
  ...
  info.tags = ((void*)0);
  for (i = 0; i < (60); i++)
    info.types.builtins[i] = ((debug_type) ((void*)0));
 ...
 {
   ieee_error (&info, record_start, gettext ("unexpected number"));
   return 0;
 }
 ...
 {
 default:
   ieee_error (&info, record_start, gettext ("unexpected record type"));
   return 0;
 ...
 case ieee_atn_record_enum:
  ...
  if (info.blockstack.bsp != info.blockstack.stack)
    {
      ieee_error (&info, (const bfd_byte *) ((void*)0),
    gettext ("blocks left on stack at end"));
      return 0;
    }
...
parse_ieee_bb (struct ieee_info *info, const bfd_byte **pp)
{
 ...
 return 0;
      ...
      if (info->vars.vars != ((void*)0))
 free (info->vars.vars);
      info->vars.vars = ((void*)0);
      info->vars.alloc = 0;
      if (info->types.types != ((void*)0))
 free (info->types.types);
      info->types.types = ((void*)0);
      info->types.alloc = 0;


      if (info->global_types != ((void*)0))
 {
 ...
 if (typindx < 256)
   {
     ...
     if (return_type == ((debug_type) ((void*)0)))
       return 0;
   }
 else
   {
     typindx -= 256;
     if (! ieee_alloc_type (info, typindx, 1))
       return 0;
     fnindx = typindx;
 ...
 if (! ieee_read_number (info, pp, &sectype)
   ...
   return 0;
    ...
    default:
      ieee_error (info, block_start, gettext ("unknown BB type"));
      return 0;
    }
  ...
  if (info->blockstack.bsp >= info->blockstack.stack + (16))
    {
      ieee_error (info, (const bfd_byte *) ((void*)0), gettext ("stack overflow"));
      return 0;
    }
...
parse_ieee_be (struct ieee_info *info, const bfd_byte **pp)
{
  ...
  if (info->blockstack.bsp <= info->blockstack.stack)
    {
      ieee_error (info, *pp, gettext ("stack underflow"));
      return 0;
    }
  --info->blockstack.bsp;
...
parse_ieee_nn (struct ieee_info *info, const bfd_byte **pp)
{
  ...
  if (varindx < 32)
    {
      ieee_error (info, nn_start, gettext ("illegal variable index"));
      return 0;
    }
  varindx -= 32;
...
parse_ieee_ty (struct ieee_info *info, const bfd_byte **pp)
{
  ...
  if (typeindx < 256)
    {
      ieee_error (info, ty_start, gettext ("illegal type index"));
      return 0;
    }

  typeindx -= 256;
  if (! ieee_alloc_type (info, typeindx, 0))
    return 0;

  if (**pp != 0xce)
    {
      ieee_error (info, *pp, gettext ("unknown TY code"));
      return 0;
    }
  ++*pp;
  ...
  if (varindx < 32)
    {
      ieee_error (info, ty_var_start, gettext ("illegal variable index"));
      return 0;
    }
  varindx -= 32;

  if (varindx >= info->vars.alloc || info->vars.vars[varindx].name == ((void*)0))
    {
      ieee_error (info, ty_var_start, gettext ("undefined variable in TY"));
      return 0;
    }
  ...
  switch (tc)
    {
    default:
      ieee_error (info, ty_code_start, gettext ("unknown TY code"));
      return 0;
 ...
 if (! ieee_read_number (info, pp, &size))
   return 0;
 type = debug_make_int_type (dhandle, size, 0);
      }
      break;
 ...
 type = debug_make_struct_type (dhandle, 1, size, fields);
 tag = 1;
      }
      break;
 ...
 while (1)
  ...
  tindx -= 256;
  if (! ieee_alloc_type (info, tindx, 1))
    return 0;
 ...
 type = debug_make_function_type (dhandle, rtype, (debug_type *) ((void*)0),
      0);
      }
      break;
 ...
 type = debug_make_complex_type (dhandle, tc == 'c' ? 4 : 8);
    ...
    case 'f':
      ...
      ieee_error (info, ty_code_start, gettext ("Pascal file name not supported"));
      return 0;
 ...
 switch (kind)
   {
   default:
     ieee_error (info, ty_start, gettext ("unsupported qualifier"));
     return 0;
 ...
 type = debug_make_set_type (dhandle, etype, 0);
      }
      break;
 ...
 if (nargs == (bfd_vma) -1)
  ...
  if (debug_get_type_kind (dhandle, arg_types[i])
   ...
   memset (arg_slots, 0, nargs * sizeof *arg_slots);
     ...
     arg_types[nargs] = ((debug_type) ((void*)0));
   }
 ...
 return 0;
  ...
  if (info->types.types[typeindx].pslot != ((void*)0))
...
parse_ieee_atn (struct ieee_info *info, const bfd_byte **pp)
{
 ...
 return ieee_read_number (info, pp, &v);
      ...
      ieee_error (info, atn_start, gettext ("illegal variable index"));
      return 0;
    }
  else
    {
   ...
   || info->vars.vars[varindx].name == ((void*)0))
 {
       ...
       if (varindx >= info->vars.alloc)
  {
    ...
    info->vars.alloc = alloc;
     ...
     {
       ieee_error (info, atn_start, gettext ("undefined variable in ATN"));
       return 0;
     }
 }
 ...
 case 10:
  ...
  switch (atn_code)
    {
    default:
      ieee_error (info, atn_code_start, gettext ("unknown ATN type"));
      return 0;
 ...
 pvar->kind = IEEE_LOCAL;
    ...
    case 11:
      ...
      ieee_error (info, atn_code_start, gettext ("unsupported ATN11"));
      ...
      if (present)
 {
  ...
  return 0;
      ...
      ieee_error (info, atn_code_start, gettext ("unsupported ATN12"));
      ...
      if (atn_code == 62 && v == 80)
 {
   if (present)
     ...
     gettext ("unexpected string in C++ misc"));
       return 0;
     }
      ...
      for (; v2 > 0; --v2)
 {
   switch ((ieee_record_enum_type) **pp)
     {
     default:
       ieee_error (info, *pp, gettext ("bad misc record"));
       return 0;
      ...
      unsigned long count)
{
  ...
  switch (category)
    {
    default:
      ieee_error (info, start, gettext ("unrecognized C++ misc record"));
      return 0;
       ...
       unsigned long count)
{
 ...
 && strlen (it->name) == taglen)
  ...
  if (it == ((void*)0))
    {
      ieee_error (info, start, gettext ("undefined C++ object"));
      return 0;
    }
 ...
 {
 default:
   ieee_error (info, spec_start, gettext ("unrecognized C++ object spec"));
   return 0;
 ...
 case 'b':
  ...
  || ! ieee_require_atn65 (info, pp, &fieldname, &fieldlen))
     ...
     if ((fieldlen == 0) == (cinline == 0))
       {
  ieee_error (info, start, gettext ("unsupported C++ object type"));
  return 0;
       }
     ...
     basetype = debug_find_tagged_type (dhandle, basecopy,
            DEBUG_KIND_ILLEGAL);
     free (basecopy);
     if (basetype == ((debug_type) ((void*)0)))
       {
  ieee_error (info, start, gettext ("C++ base class not defined"));
  return 0;
       }
  ...
  if (structfields == ((void*)0))
    {
      ieee_error (info, start, gettext ("C++ object has no fields"));
      return 0;
    }

  for (pf = structfields; *pf != ((debug_field) ((void*)0)); pf++)
    {
      const char *fname;
  ...
  if (*pf == ((debug_field) ((void*)0)))
    {
      ieee_error (info, start,
    gettext ("C++ base class not found in container"));
      return 0;
    }
  ...
  bitpos = debug_get_field_bitpos (dhandle, *pf);
     ...
     baseclass = debug_make_baseclass (dhandle, basetype, bitpos,
           virtualp, visibility);
     if (baseclass == ((debug_baseclass) ((void*)0)))
       return 0;
  ...
  baseclasses = ((debug_baseclass *)
     ...
     ++baseclasses_count;
     baseclasses[baseclasses_count] = ((debug_baseclass) ((void*)0));
   }
   break;
 ...
 case 'd':
  ...
  if (*pf == ((debug_field) ((void*)0)))
    {
      ieee_error (info, start,
    gettext ("C++ data member not found in container"));
      return 0;
    }
   ...
   memset (it->fslots, 0,
    fcnt * sizeof *it->fslots);
     ...
     switch (flags & (0x3))
       {
       default:
  ieee_error (info, start, gettext ("unknown C++ visibility"));
  return 0;
  ...
  if (bitpos == (bfd_vma) -1 || bitsize == (bfd_vma) -1)
    {
      ieee_error (info, start, gettext ("bad C++ field bit pos or size"));
      return 0;
    }
  ...
  fields = ((debug_field *)
     ...
     ++field_count;
     fields[field_count] = ((debug_field) ((void*)0));
   }
   break;
 ...
 case 'v':
  ...
  bfd_boolean varargs = 0;

  if (debug_get_type_kind (dhandle, pv->type)
      != DEBUG_KIND_FUNCTION)
    {
      ieee_error (info, start,
    gettext ("bad type for C++ method function"));
      return 0;
    }
  ...
  arg_types = debug_get_parameter_types (dhandle, pv->type,
             &varargs);
  if (return_type == ((debug_type) ((void*)0)) || arg_types == ((void*)0))
    {
      ieee_error (info, start,
    gettext ("no type information for C++ method function"));
      return 0;
    }
  ...
  break;
     ...
     constp = (flags & (0x20)) != 0 ? 1 : 0;
     volatilep = (flags & (0x40)) != 0 ? 1 : 0;
  ...
  if (id == 'v')
    {
      ieee_error (info, start, gettext ("C++ static virtual method"));
      return 0;
    }
  ...
  mv = debug_make_method_variant (dhandle, mangledcopy, type,
     ...
     if (mv == ((debug_method_variant) ((void*)0)))
       return 0;
  ...
  methods[methods_count].variants = ((void*)0);
  ...
  meth->variants = ((debug_method_variant *)
     ...
     ++meth->count;
     meth->variants[meth->count] = ((debug_method_variant) ((void*)0));
   }
   break;
 ...
 case 'o':
  ...
  --count;
       ...
       {
  ieee_error (info, start,
       gettext ("unrecognized C++ object overhead spec"));
  return 0;
       }
   }
   break;
 ...
 case 'z':
  ...
  vptrbase = debug_find_tagged_type (dhandle, basecopy,
         DEBUG_KIND_ILLEGAL);
  free (basecopy);
  if (vptrbase == ((debug_type) ((void*)0)))
    {
      ieee_error (info, start, gettext ("undefined C++ vtable"));
      return 0;
    }
       }
   }
      ...
      for (i = 0; i < methods_count; i++)
 {
   ...
   dmethods[i] = debug_make_method (dhandle, namcopy,
        methods[i].variants);
   if (dmethods[i] == ((debug_method) ((void*)0)))
     return 0;
 }
      dmethods[i] = ((debug_method) ((void*)0));
      free (methods);
    }
   ...
   unsigned long count)
{
  ...
  if (info->blockstack.bsp <= info->blockstack.stack
    ...
    {
      ieee_error (info, start, gettext ("C++ default values not in a function"));
      return 0;
    }
 ...
 default:
   ieee_error (info, start, gettext ("unrecognized C++ default type"));
   return 0;
 }
...
ieee_read_reference (struct ieee_info *info, const bfd_byte **pp)
{
      ...
      for (pass = 0; pass < 2; pass++)
 {
  ...
  default:
    ieee_error (info, start,
         gettext ("unrecognized C++ reference type"));
    return 0;
      ...
      for (it = info->tags; it != ((void*)0); it = it->next)
 {
       ...
       if (it->fslots != ((void*)0))
  {
    ...
    for (findx = 0; *pf != ((debug_field) ((void*)0)); pf++, findx++)
      {
        const char *fname;
  ...
  if (pslot == ((void*)0))
    {
      ieee_error (info, start, gettext ("C++ reference not found"));
      return 0;
    }
...
ieee_require_asn (struct ieee_info *info, const bfd_byte **pp, bfd_vma *pv)
{
  ...
  if (c != ieee_e2_first_byte_enum)
    {
      ieee_error (info, start, gettext ("missing required ASN"));
      return 0;
    }
  ++*pp;
      ...
      const char **pname, unsigned long *pnamlen)
{
  ...
  if (c != ieee_at_record_enum)
    {
      ieee_error (info, start, gettext ("missing required ATN65"));
      return 0;
    }
  ++*pp;
  ...
  if (type_indx != 0 || atn_code != 65)
    {
      ieee_error (info, start, gettext ("bad ATN65 record"));
      return 0;
    }
...
# 3613 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
struct ieee_buf
{
...
static bfd_boolean
ieee_init_buffer (struct ieee_handle *info __attribute__ ((__unused__)),
...
static bfd_boolean
ieee_append_buffer (struct ieee_handle *info __attribute__ ((__unused__)),
      struct ieee_buflist *mainbuf,
      struct ieee_buflist *newbuf)
{
  if (newbuf->head != ((void*)0))
    {
      if (mainbuf->head == ((void*)0))
...
# 4112 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
static bfd_boolean
ieee_real_write_byte (struct ieee_handle *info, int b)
{
  if (info->curbuf->c >= (490))
    {
      struct ieee_buf *n;
...
{
  return (((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (i >> 8), 1) : ieee_real_write_byte ((info), (i >> 8)))
   && ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (i & 0xff), 1) : ieee_real_write_byte ((info), (i & 0xff))));
}
...
ieee_write_number (struct ieee_handle *info, bfd_vma v)
{
  ...
  if (v <= (bfd_vma) ieee_number_end_enum)
    return ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) v), 1) : ieee_real_write_byte ((info), ((int) v)));
  ...
  if (c > (unsigned int) (ieee_number_repeat_end_enum
    ...
    {
      fprintf (stderr, gettext ("IEEE numeric overflow: 0x"));
      fprintf (stderr, "%016" "l" "x", v);
      fprintf (stderr, "\n");
      return 0;
    }

  if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_number_repeat_start_enum + c), 1) : ieee_real_write_byte ((info), ((int) ieee_number_repeat_start_enum + c))))
    return 0;
  for (; c > 0; --c, ++p)
    {
      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (*p), 1) : ieee_real_write_byte ((info), (*p))))
 return 0;
    }
...
ieee_write_id (struct ieee_handle *info, const char *s)
{
  ...
  if (len <= 0x7f)
    {
      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (len), 1) : ieee_real_write_byte ((info), (len))))
 return 0;
    }
  else if (len <= 0xff)
    {
      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_extension_length_1_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_extension_length_1_enum)))
   || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (len), 1) : ieee_real_write_byte ((info), (len))))
 return 0;
    }
  else if (len <= 0xffff)
    {
      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_extension_length_2_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_extension_length_2_enum)))
   || ! ieee_write_2bytes (info, len))
 return 0;
    }
  else
    {
      fprintf (stderr, gettext ("IEEE string length overflow: %u\n"), len);
      return 0;
    }

  for (; *s != '\0'; s++)
    if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (*s), 1) : ieee_real_write_byte ((info), (*s))))
      return 0;
...
{
  return ieee_pop_type_used (info, 1);
}
...
{
  (void) ieee_pop_type_used (info, 0);
}
...
ieee_pop_type_used (struct ieee_handle *info, bfd_boolean used)
{
  ...
  ts = info->type_stack;
  ((void) sizeof ((ts != ((void*)0)) ? 1 : 0), __extension__ ({ if (ts != ((void*)0)) ; else __assert_fail ("ts != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 4294, __extension__ __PRETTY_FUNCTION__); }));



  if (used && ! ((&ts->type.fndef)->head == ((void*)0)))
    {
      struct ieee_buflist *buflist;
      ...
      if (ts->type.localp)
 {
   ...
   if (((&info->types)->head == ((void*)0)))
     {
       if (! ieee_change_buffer (info, &info->types)
    || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
    || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (1), 1) : ieee_real_write_byte ((info), (1)))
    || ! ieee_write_number (info, 0)
      ...
      else
 {
   ...
   if (((&info->global_types)->head == ((void*)0)))
     {
       if (! ieee_change_buffer (info, &info->global_types)
    || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
    || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (2), 1) : ieee_real_write_byte ((info), (2)))
    || ! ieee_write_number (info, 0)
    || ! ieee_write_id (info, ""))
  return 0;
     }
...
ieee_end_range (struct ieee_handle *info, bfd_vma high)
{
  ...
  ((void) sizeof ((info->pending_ranges != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->pending_ranges != ((void*)0)) ; else __assert_fail ("info->pending_ranges != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 4420, __extension__ __PRETTY_FUNCTION__); }));
  r = info->pending_ranges;
  low = r->low;
  info->pending_ranges = r->next;
  free (r);
  return ieee_add_range (info, 0, low, high);
}
   ...
   struct ieee_buflist *buflist)
{
      ...
      else
 {
  ...
  return (((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_nn_record), 1) : ieee_real_write_byte ((info), ((int) ieee_nn_record)))
   && ieee_write_number (info, name_indx)
   && ieee_write_id (info, name)
   && ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_ty_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_ty_record_enum)))
   && ieee_write_number (info, type_indx)
   && ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (0xce), 1) : ieee_real_write_byte ((info), (0xce)))
   && ieee_write_number (info, name_indx));
}
...
# 4594 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c"
bfd_boolean
write_ieee_debugging_info (bfd *abfd, void *dhandle)
{
 ...
 return 0;
  ...
  info.error = 0;
  (bfd_hash_traverse (&(&info.tags)->root, (bfd_boolean (*) (struct bfd_hash_entry *, void *)) (ieee_write_undefined_tag), ((void *) &info)));
  ...
  if (! ((&info.global_types)->head == ((void*)0)))
    {
      ...
      if (! ieee_change_buffer (&info, &info.global_types)
   || ! ((&info)->curbuf->c < (490) ? ((&info)->curbuf->buf[(&info)->curbuf->c++] = ((int) ieee_nn_record), 1) : ieee_real_write_byte ((&info), ((int) ieee_nn_record)))
   ...
   || ! ((&info)->curbuf->c < (490) ? ((&info)->curbuf->buf[(&info)->curbuf->c++] = ((int) ieee_be_record_enum), 1) : ieee_real_write_byte ((&info), ((int) ieee_be_record_enum))))
 return 0;
   ...
   if (! ieee_change_buffer (info, &info->global_types))
     {
      ...
      name_indx = info->name_indx;
      ++info->name_indx;
      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_nn_record), 1) : ieee_real_write_byte ((info), ((int) ieee_nn_record)))
   || ! ieee_write_number (info, name_indx)
...
ieee_start_compilation_unit (void *p, const char *filename)
{
 ...
 return 0;
  ...
  if (! ieee_change_buffer (info, &info->vars)
      || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
      || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (3), 1) : ieee_real_write_byte ((info), (3)))
      || ! ieee_write_number (info, 0)
      || ! ieee_write_id (info, info->modname))
    return 0;
...
ieee_finish_compilation_unit (struct ieee_handle *info)
{
 ...
 return 0;
  ...
  if (! ((&info->cxx)->head == ((void*)0)))
    {


      ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 4902, __extension__ __PRETTY_FUNCTION__); }));
      if (! ieee_change_buffer (info, &info->vars))
 return 0;



      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
   || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (6), 1) : ieee_real_write_byte ((info), (6)))
   || ! ieee_write_number (info, 0)
      ...
      if (filename_cmp (info->filename, info->lineno_filename) != 0)
 {
   ...
   if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_be_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_be_record_enum))))
     return 0;
 }
    }
  ...
  if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
      || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (10), 1) : ieee_real_write_byte ((info), (10)))
      || ! ieee_write_number (info, 0)
      || ! ieee_write_id (info, info->modname)
      || ! ieee_write_id (info, "")
      || ! ieee_write_number (info, 0)
  ...
  for (r = info->ranges; r != ((void*)0); r = r->next)
    {
      ...
      for (s = info->abfd->sections; s != ((void*)0); s = s->next)
 {
   if (((void) info->abfd, (s)->vma) <= low
       && high <= (((void) info->abfd, (s)->vma)
     + ((s)->size)))
     break;
 }
       ...
       + ((s)->size))))
 {
   ...
   high = r->high;
      ...
      if ((s->flags & 0x010) != 0)
 kind = 1;
      else if ((s->flags & 0x008) != 0)
 kind = 3;
      else
 kind = 2;

      if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
   || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (11), 1) : ieee_real_write_byte ((info), (11)))
   || ! ieee_write_number (info, 0)
   || ! ieee_write_id (info, "")
   || ! ieee_write_number (info, kind)
   || ! ieee_write_number (info, s->index + 1)
 ...
 return 0;
      ...
      if (! ieee_add_range (info, 1, low, high))
 return 0;
    }
...
static void
ieee_add_bb11_blocks (bfd *abfd __attribute__ ((__unused__)), asection *sec, void *data)
{
  struct ieee_handle *info = (struct ieee_handle *) data;
  bfd_vma low, high;
  struct ieee_range *r;

  low = ((void) abfd, (sec)->vma);
  high = low + ((sec)->size);



  for (r = info->global_ranges; r != ((void*)0); r = r->next)
    if (r->high > low)
      break;

  while (low < high)
    {
      if (r == ((void*)0) || r->low >= high)
 {
        ...
        bfd_vma high)
{
 ...
 return 0;
  ...
  else
    {
      ...
      filename = ((char *) (info->abfd)->filename);
      modname = strrchr (filename, '/');
 ...
 *s = '\0';
   ...
   || ! ieee_write_id (info, "GNU objcopy"))
 {
  ...
  if (! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
      ...
      || ! ieee_write_id (info, "")
      || ! ieee_write_number (info, kind)
      || ! ieee_write_number (info, sec->index + 1)
      || ! ieee_write_number (info, low)
      || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_be_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_be_record_enum)))
      || ! ieee_write_number (info, high - low))
    return 0;
...
static bfd_boolean
ieee_start_source (void *p __attribute__ ((__unused__)),
...
ieee_empty_type (void *p)
{
  ...
  return ieee_push_type (info, (int) builtin_unknown, 0, 0, 0);
}
...
ieee_void_type (void *p)
{
  ...
  return ieee_push_type (info, (int) builtin_void, 0, 0, 0);
}
...
ieee_int_type (void *p, unsigned int size, bfd_boolean unsignedp)
{
  ...
  switch (size)
    ...
    case 8:
      ...
      break;
    default:
      fprintf (stderr, gettext ("IEEE unsupported integer type size %u\n"), size);
      return 0;
    }
  ...
  return ieee_push_type (info, indx, size, unsignedp, 0);
}
...
ieee_float_type (void *p, unsigned int size)
{
  ...
  switch (size)
    ...
    case 16:
      ...
      break;
    default:
      fprintf (stderr, gettext ("IEEE unsupported float type size %u\n"), size);
      return 0;
    }

  return ieee_push_type (info, indx, size, 0, 0);
}
...
ieee_complex_type (void *p, unsigned int size)
{
 ...
 return ieee_push_type (info, info->complex_double_index, size * 2,
      ...
      break;
    default:
      fprintf (stderr, gettext ("IEEE unsupported complex type size %u\n"), size);
      return 0;
    }


  if (! ieee_define_type (info, size * 2, 0, 0)
  ...
  bfd_signed_vma *vals)
{
       ...
       && e->names[i] == ((void*)0)))
 {
   ...
   return ieee_push_type (info, e->indx, 0, 1, 0);
 }
      ...
      for (i = 0; names[i] != ((void*)0); i++)
 {
  ...
  if (! ieee_define_named_type (info, tag, indx, 0, 1, localp,
...
ieee_pointer_type (void *p)
{
  ...
  if (indx < 32)
    return ieee_push_type (info, indx + 32, 0, 1, 0);
 ...
 return 0;
      ...
      if (m->pointer > 0)
 return ieee_push_type (info, m->pointer, 4, 1, 0);
    }

  if (! ieee_define_type (info, 4, 1, localp)
      || ! ieee_write_number (info, 'P')
      || ! ieee_write_number (info, indx))
    return 0;
...
ieee_function_type (void *p, int argcount, bfd_boolean varargs)
{
 ...
 return 0;
      ...
      if (m->function > 0)
 return ieee_push_type (info, m->function, 0, 1, 0);
    }
...
ieee_reference_type (void *p)
{
  ...
  if (! ieee_pointer_type (p))
    return 0;
  info->type_stack->type.referencep = 1;
  return 1;
}
...
ieee_array_type (void *p, bfd_signed_vma low, bfd_signed_vma high,
   bfd_boolean stringp __attribute__ ((__unused__)))
{
  struct ieee_handle *info = (struct ieee_handle *) p;
 ...
 return 0;
      ...
      for (a = m->arrays; a != ((void*)0); a = a->next)
 {
   if (a->low == low && a->high == high)
     return ieee_push_type (info, a->indx, size, 0, 0);
 }
    }

  if (! ieee_define_type (info, size, 0, localp)
...
static bfd_boolean
ieee_set_type (void *p, bfd_boolean bitstringp __attribute__ ((__unused__)))
{
  struct ieee_handle *info = (struct ieee_handle *) p;
  bfd_boolean localp;
  unsigned int eleindx;
  ...
  return (ieee_define_type (info, 0, 1, localp)
   ...
   bfd_boolean structp, unsigned int size)
{
  ...
  h = ((struct ieee_name_type_hash_entry *) bfd_hash_lookup (&(&info->tags)->root, (look), (1), (copy)));
  if (h == ((void*)0))
    return 0;
      ...
      else if (! ntlook->type.localp)
 {
  ...
  if (nt != ((void*)0))
    {
      ((void) sizeof ((localp == nt->type.localp) ? 1 : 0), __extension__ ({ if (localp == nt->type.localp) ; else __assert_fail ("localp == nt->type.localp", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 5876, __extension__ __PRETTY_FUNCTION__); }));
      if (nt->kind == DEBUG_KIND_ILLEGAL && ! localp)
 {
  ...
  if (! ieee_init_buffer (info, &strdef)
      || ! ieee_define_named_type (info, tag, nt->type.indx, size, 1,
       localp, &strdef)
     ...
     enum debug_visibility visibility)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->next != ((void*)0) && ! ((&info->type_stack->next->type.strdef)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->next != ((void*)0) && ! ((&info->type_stack->next->type.strdef)->head == ((void*)0))) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->next != NULL && ! ieee_buffer_emptyp (&info->type_stack->next->type.strdef)", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 5940, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_end_struct_type (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && ! ((&info->type_stack->type.strdef)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && ! ((&info->type_stack->type.strdef)->head == ((void*)0))) ; else __assert_fail ("info->type_stack != NULL && ! ieee_buffer_emptyp (&info->type_stack->type.strdef)", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6041, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (vptr && ! ownvptr)
    {
      ...
      ((void) sizeof ((vclass != ((void*)0)) ? 1 : 0), __extension__ ({ if (vclass != ((void*)0)) ; else __assert_fail ("vclass != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6126, __extension__ __PRETTY_FUNCTION__); }));
     ...
     enum debug_visibility visibility)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6178, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_class_start_method (void *p, const char *name)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method == ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method == ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL && info->type_stack->type.classdef->method == NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6281, __extension__ __PRETTY_FUNCTION__); }));
         ...
         bfd_boolean context)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL && info->type_stack->type.classdef->method != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6313, __extension__ __PRETTY_FUNCTION__); }));
      ...
      bfd_vma voffset, bfd_boolean context)
{
  ...
  return ieee_class_method_var (info, physname, visibility, 0, constp,
      ...
      bfd_boolean constp, bfd_boolean volatilep)
{
  ...
  return ieee_class_method_var (info, physname, visibility, 1, constp,
    volatilep, 0, 0);
}
...
ieee_class_end_method (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL && info->type_stack->type.classdef->method != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6393, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_end_class_type (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6409, __extension__ __PRETTY_FUNCTION__); }));
 ...
 return 0;
  ...
  if (! ieee_append_buffer (info, &info->cxx,
       &info->type_stack->type.classdef->pmiscbuf))
    return 0;
  if (! ((&info->type_stack->type.classdef->refs)->head == ((void*)0)))
    {
      if (! ieee_append_buffer (info, &info->cxx,
    &info->type_stack->type.classdef->refs))
 return 0;
...
ieee_typedef_type (void *p, const char *name)
{
  ...
  h = ((struct ieee_name_type_hash_entry *) bfd_hash_lookup (&(&info->typedefs)->root, (name), (0), (0)));




  ((void) sizeof ((h != ((void*)0)) ? 1 : 0), __extension__ ({ if (h != ((void*)0)) ; else __assert_fail ("h != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6490, __extension__ __PRETTY_FUNCTION__); }));
        ...
        enum debug_type_kind kind)
{
 ...
 if (e->tag != ((void*)0) && strcmp (e->tag, name) == 0)
  ...
  h = ((struct ieee_name_type_hash_entry *) bfd_hash_lookup (&(&info->tags)->root, (name), (1), (copy)));
  if (h == ((void*)0))
    return 0;
      ...
      if (! nt->type.localp)
 {
  ...
  if (! ieee_push_type (info, nt->type.indx, 0, 0, localp))
    return 0;
...
ieee_typdef (void *p, const char *name)
{
 ...
 type.indx = indx;
  ...
  h = ((struct ieee_name_type_hash_entry *) bfd_hash_lookup (&(&info->typedefs)->root, (name), (1), (0)));
  if (h == ((void*)0))
    return 0;
...
static bfd_boolean
ieee_tag (void *p, const char *name __attribute__ ((__unused__)))
{
  struct ieee_handle *info = (struct ieee_handle *) p;
...
static bfd_boolean
ieee_int_constant (void *p __attribute__ ((__unused__)), const char *name __attribute__ ((__unused__)),
     bfd_vma val __attribute__ ((__unused__)))
{
...
static bfd_boolean
ieee_float_constant (void *p __attribute__ ((__unused__)),
       const char *name __attribute__ ((__unused__)),
       double val __attribute__ ((__unused__)))
{
...
static bfd_boolean
ieee_typed_constant (void *p, const char *name __attribute__ ((__unused__)),
       bfd_vma val __attribute__ ((__unused__)))
{
  struct ieee_handle *info = (struct ieee_handle *) p;
        ...
        bfd_vma val)
{
  ...
  ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 6899, __extension__ __PRETTY_FUNCTION__); }));
  if (! ieee_change_buffer (info, &info->vars))
    return 0;
  ...
  switch (kind)
   ...
   || ! ieee_add_range (info, 0, val, val + size))
 return 0;
      refflag = 0;
      asn = 1;
      break;
...
ieee_start_function (void *p, const char *name, bfd_boolean global)
{
  ...
  if (! ieee_define_named_type (info, name, (unsigned int) -1, 0, 0, 1,
    &info->fntype)
      || ! ieee_write_number (info, 'x')
 ...
 return 0;
  ...
  ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 7066, __extension__ __PRETTY_FUNCTION__); }));
  if (! ieee_change_buffer (info, &info->vars))
    return 0;
  ...
  return (((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
   && ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (global ? 4 : 6), 1) : ieee_real_write_byte ((info), (global ? 4 : 6)))
   && ieee_write_number (info, 0)
   && ieee_write_id (info, name)
   && ieee_write_number (info, 0)
    ...
    bfd_vma val)
{
  ...
  ((void) sizeof ((info->block_depth == 1) ? 1 : 0), __extension__ ({ if (info->block_depth == 1) ; else __assert_fail ("info->block_depth == 1", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 7092, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_output_pending_parms (struct ieee_handle *info)
{
 ...
 case DEBUG_PARM_REF_REG:
   ...
   break;
      ...
      if (! ieee_push_type (info, m->type, 0, 0, 0))
 return 0;
...
ieee_end_function (void *p)
{
  ...
  ((void) sizeof ((info->block_depth == 1) ? 1 : 0), __extension__ ({ if (info->block_depth == 1) ; else __assert_fail ("info->block_depth == 1", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 7275, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_lineno (void *p, const char *filename, unsigned long lineno, bfd_vma addr)
{
  ...
  ((void) sizeof ((info->filename != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->filename != ((void*)0)) ; else __assert_fail ("info->filename != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/ieee.c", 7322, __extension__ __PRETTY_FUNCTION__); }));
      ...
      else
 {
   ...
   if (! ieee_change_buffer (info, &info->linenos)
       || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = ((int) ieee_bb_record_enum), 1) : ieee_real_write_byte ((info), ((int) ieee_bb_record_enum)))
       || ! ((info)->curbuf->c < (490) ? ((info)->curbuf->buf[(info)->curbuf->c++] = (5), 1) : ieee_real_write_byte ((info), (5)))
       || ! ieee_write_number (info, 0)
