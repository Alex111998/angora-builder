# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c" 2
...
# 337 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c"
static bfd_boolean
     ...
     bfd_vma value, const char *string)
{
  ...
  if (string == ((void*)0))
  ...
  else
    {
      ...
      h = ((struct string_hash_entry *) bfd_hash_lookup (&(&info->strhash)->table, (string), (1), (1)));
      if (h == ((void*)0))
 {
   non_fatal (gettext ("string_hash_lookup failed: %s"),
      ...
      else
 {
  ...
  ((*((info->abfd)->xvec->bfd_putx32)) ((strx),(sym)));
  ((void) (*((unsigned char *) (sym + 4)) = (type) & 0xff));
  ((void) (*((unsigned char *) (sym + 5)) = (0) & 0xff));
  ((*((info->abfd)->xvec->bfd_putx16)) ((desc),(sym + 6)));
  ((*((info->abfd)->xvec->bfd_putx32)) ((value),(sym + 8)));

  if (info->symbols_size + (12) > info->symbols_alloc)
    {
  ...
  memcpy (info->symbols + info->symbols_size, sym, (12));

  info->symbols_size += (12);
   ...
   unsigned int size)
{
  ...
  return stab_push_string (info, buf, tindex, 0, size);
}
...
stab_pop_type (struct stab_write_handle *info)
{
  ...
  s = info->type_stack;
  ((void) sizeof ((s != ((void*)0)) ? 1 : 0), __extension__ ({ if (s != ((void*)0)) ; else __assert_fail ("s != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 440, __extension__ __PRETTY_FUNCTION__); }));
...
# 460 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c"
bfd_boolean
     ...
     bfd_size_type *pstringsize)
{
  ...
  if (! stab_write_symbol (&info, N_SO, 0, 0, ((char *) (abfd)->filename)))
    return 0;

  if (! debug_write (dhandle, &stab_fns, (void *) &info))
    return 0;

  ((void) sizeof ((info.pending_lbrac == (bfd_vma) -1) ? 1 : 0), __extension__ ({ if (info.pending_lbrac == (bfd_vma) -1) ; else __assert_fail ("info.pending_lbrac == (bfd_vma) -1", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 514, __extension__ __PRETTY_FUNCTION__); }));
  ...
  ((*((abfd)->xvec->bfd_putx32)) ((info.strings_size),(info.symbols + 8)));
...
stab_empty_type (void *p)
{
  ...
  if (info->type_cache.void_type != 0)
  ...
  else
    {
      ...
      return stab_push_string (info, buf, tindex, 0, 0);
    }
}
...
stab_void_type (void *p)
{
  ...
  if (info->type_cache.void_type != 0)
  ...
  else
    {
      ...
      return stab_push_string (info, buf, tindex, 1, 0);
    }
}
...
stab_int_type (void *p, unsigned int size, bfd_boolean unsignedp)
{
  ...
  if (size <= 0 || (size > sizeof (long) && size != 8))
    {
      non_fatal (gettext ("stab_int_type: bad size %u"), size);
      return 0;
    }
      ...
      else
 {
   if (size <= sizeof (long))
     ...
     abort ();
      ...
      return stab_push_string (info, buf, tindex, 1, size);
    }
}
...
stab_complex_type (void *p, unsigned int size)
{
  ...
  return stab_push_string (info, buf, tindex, 1, size * 2);
}
  ...
  bfd_signed_vma *vals)
{
  ...
  if (names == ((void*)0))
    {
      ((void) sizeof ((tag != ((void*)0)) ? 1 : 0), __extension__ ({ if (tag != ((void*)0)) ; else __assert_fail ("tag != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 791, __extension__ __PRETTY_FUNCTION__); }));

      buf = (char *) xmalloc (10 + strlen (tag));
      sprintf (buf, "xe%s:", tag);

      if (! stab_push_string (info, buf, 0, 0, 4))
 return 0;
      free (buf);
      return 1;
    }
    ...
    unsigned int size, long **cache, size_t *cache_alloc)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 853, __extension__ __PRETTY_FUNCTION__); }));
      ...
      else
 {
   ...
   if (! stab_push_string (info, buf, tindex, 1, size))
     return 0;
...
stab_function_type (void *p, int argcount,
      bfd_boolean varargs __attribute__ ((__unused__)))
{
  struct stab_write_handle *info = (struct stab_write_handle *) p;
  int i;
     ...
     bfd_vma bitsize, enum debug_visibility visibility)
{
  ...
  ((void) sizeof ((info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1364, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (bitsize == 0)
    {
      bitsize = size * 8;
      if (bitsize == 0)
 non_fatal (gettext ("%s: warning: unknown size for field `%s' in struct"),
     ((char *) (info->abfd)->filename), name);
    }
...
stab_end_struct_type (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1419, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (vptr)
    {
      ...
      if (ownvptr)
 {
   ((void) sizeof ((info->type_stack->index > 0) ? 1 : 0), __extension__ ({ if (info->type_stack->index > 0) ; else __assert_fail ("info->type_stack->index > 0", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1469, __extension__ __PRETTY_FUNCTION__); }));
     ...
     enum debug_visibility visibility)
{
  ...
  ((void) sizeof ((info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1506, __extension__ __PRETTY_FUNCTION__); }));
  n = (char *) xmalloc (strlen (info->type_stack->fields)
   + strlen (name)
   + strlen (s)
   + strlen (physname)
        ...
        enum debug_visibility visibility)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1586, __extension__ __PRETTY_FUNCTION__); }));
...
stab_class_start_method (void *p, const char *name)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1618, __extension__ __PRETTY_FUNCTION__); }));
         ...
         bfd_boolean contextp)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->methods != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->methods != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->methods != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1663, __extension__ __PRETTY_FUNCTION__); }));
      ...
      bfd_vma voffset, bfd_boolean contextp)
{
  ...
  return stab_class_method_var (info, physname, visibility, 0, constp,
      ...
      bfd_boolean constp, bfd_boolean volatilep)
{
  ...
  return stab_class_method_var (info, physname, visibility, 1, constp,
    volatilep, 0, 0);
}
...
stab_class_end_method (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->methods != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->methods != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->methods != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1764, __extension__ __PRETTY_FUNCTION__); }));
...
stab_end_class_type (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->fields != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->fields != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1783, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (info->type_stack->baseclasses != ((void*)0))
    {
      len += 20;
      for (i = 0; info->type_stack->baseclasses[i] != ((void*)0); i++)
 len += strlen (info->type_stack->baseclasses[i]);
    }
  if (info->type_stack->methods != ((void*)0))
    len += strlen (info->type_stack->methods);
  if (info->type_stack->vtable != ((void*)0))
...
stab_typedef_type (void *p, const char *name)
{
  ...
  h = ((struct string_hash_entry *) bfd_hash_lookup (&(&info->typedef_hash)->table, (name), (0), (0)));
  ((void) sizeof ((h != ((void*)0) && h->index > 0) ? 1 : 0), __extension__ ({ if (h != ((void*)0) && h->index > 0) ; else __assert_fail ("h != NULL && h->index > 0", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 1856, __extension__ __PRETTY_FUNCTION__); }));
...
stab_typdef (void *p, const char *name)
{
  ...
  h = ((struct string_hash_entry *) bfd_hash_lookup (&(&info->typedef_hash)->table, (name), (1), (0)));
  if (h == ((void*)0))
    {
      non_fatal (gettext ("string_hash_lookup failed: %s"),
   bfd_errmsg (bfd_get_error ()));
        ...
        bfd_vma val)
{
  ...
  switch (kind)
    ...
    case DEBUG_LOCAL:
      ...
      if (! (_sch_istable[(*s) & 0xff] & (unsigned short)(_sch_isdigit)))
 {
   char *n;
   long tindex;
...
stab_start_function (void *p, const char *name, bfd_boolean globalp)
{
  ...
  ((void) sizeof ((info->nesting == 0 && info->fun_offset == -1) ? 1 : 0), __extension__ ({ if (info->nesting == 0 && info->fun_offset == -1) ; else __assert_fail ("info->nesting == 0 && info->fun_offset == -1", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 2088, __extension__ __PRETTY_FUNCTION__); }));
...
stab_start_block (void *p, bfd_vma addr)
{
  ...
  if (info->so_offset != -1)
    {
      ((*((info->abfd)->xvec->bfd_putx32)) ((addr),(info->symbols + info->so_offset + 8)));
      info->so_offset = -1;
    }

  if (info->fun_offset != -1)
    {
      ((*((info->abfd)->xvec->bfd_putx32)) ((addr),(info->symbols + info->fun_offset + 8)));
      info->fun_offset = -1;
    }
...
stab_end_block (void *p, bfd_vma addr)
{
 ...
 return 0;
  ...
  ((void) sizeof ((info->nesting > 0) ? 1 : 0), __extension__ ({ if (info->nesting > 0) ; else __assert_fail ("info->nesting > 0", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 2230, __extension__ __PRETTY_FUNCTION__); }));
...
static bfd_boolean
stab_end_function (void *p __attribute__ ((__unused__)))
{
  return 1;
}
...
stab_lineno (void *p, const char *file, unsigned long lineno, bfd_vma addr)
{
  ...
  ((void) sizeof ((info->lineno_filename != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->lineno_filename != ((void*)0)) ; else __assert_fail ("info->lineno_filename != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/wrstabs.c", 2257, __extension__ __PRETTY_FUNCTION__); }));
