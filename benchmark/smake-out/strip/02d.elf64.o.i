# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf64.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf64.c"
# 1 "./elfcode.h" 1
# 68 "./elfcode.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
...
# 173 "./elfcode.h"
bfd_boolean
bfd_elf64_swap_symbol_in (bfd *abfd,
      const void *psrc,
      const void *pshn,
      Elf_Internal_Sym *dst)
{
  const Elf64_External_Sym *src = (const Elf64_External_Sym *) psrc;
  ...
  if (signed_vma)
    dst->st_value = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->st_value));
  else
    dst->st_value = ((*((abfd)->xvec->bfd_h_getx64)) (src->st_value));
  dst->st_size = ((*((abfd)->xvec->bfd_h_getx64)) (src->st_size));
...
void
bfd_elf64_swap_symbol_out (bfd *abfd,
       ...
       void *shndx)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx64)) (src->st_value, dst->st_value));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->st_size, dst->st_size));
    ...
    Elf_Internal_Ehdr *dst)
{
  ...
  if (signed_vma)
    dst->e_entry = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->e_entry));
  else
    dst->e_entry = ((*((abfd)->xvec->bfd_h_getx64)) (src->e_entry));
  dst->e_phoff = ((*((abfd)->xvec->bfd_h_getx64)) (src->e_phoff));
  dst->e_shoff = ((*((abfd)->xvec->bfd_h_getx64)) (src->e_shoff));
     ...
     Elf64_External_Ehdr *dst)
{
  ...
  if (signed_vma)
    ((*((abfd)->xvec->bfd_h_putx64)) (src->e_entry, dst->e_entry));
  else
    ((*((abfd)->xvec->bfd_h_putx64)) (src->e_entry, dst->e_entry));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->e_phoff, dst->e_phoff));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->e_shoff, dst->e_shoff));
    ...
    Elf_Internal_Shdr *dst)
{
  ...
  dst->sh_flags = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_flags));
  if (signed_vma)
    dst->sh_addr = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->sh_addr));
  else
    dst->sh_addr = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_addr));
  dst->sh_offset = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_offset));
  dst->sh_size = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_size));
  dst->sh_link = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_link));
  dst->sh_info = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_info));
  dst->sh_addralign = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_addralign));
  dst->sh_entsize = ((*((abfd)->xvec->bfd_h_getx64)) (src->sh_entsize));
     ...
     Elf64_External_Shdr *dst)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_flags, dst->sh_flags));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_addr, dst->sh_addr));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_offset, dst->sh_offset));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_size, dst->sh_size));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_link, dst->sh_link));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_info, dst->sh_info));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_addralign, dst->sh_addralign));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->sh_entsize, dst->sh_entsize));
}
...
void
bfd_elf64_swap_phdr_in (bfd *abfd,
    ...
    Elf_Internal_Phdr *dst)
{
  ...
  dst->p_offset = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_offset));
  if (signed_vma)
    {
      dst->p_vaddr = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->p_vaddr));
      dst->p_paddr = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->p_paddr));
    }
  else
    {
      dst->p_vaddr = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_vaddr));
      dst->p_paddr = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_paddr));
    }
  dst->p_filesz = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_filesz));
  dst->p_memsz = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_memsz));
  dst->p_align = ((*((abfd)->xvec->bfd_h_getx64)) (src->p_align));
}

void
bfd_elf64_swap_phdr_out (bfd *abfd,
     ...
     Elf64_External_Phdr *dst)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx64)) (src->p_offset, dst->p_offset));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->p_vaddr, dst->p_vaddr));
  ((*((abfd)->xvec->bfd_h_putx64)) (p_paddr, dst->p_paddr));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->p_filesz, dst->p_filesz));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->p_memsz, dst->p_memsz));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_flags, dst->p_flags));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->p_align, dst->p_align));
}


void
bfd_elf64_swap_reloc_in (bfd *abfd,
     const bfd_byte *s,
     Elf_Internal_Rela *dst)
{
  const Elf64_External_Rel *src = (const Elf64_External_Rel *) s;
  dst->r_offset = ((*((abfd)->xvec->bfd_h_getx64)) (src->r_offset));
  dst->r_info = ((*((abfd)->xvec->bfd_h_getx64)) (src->r_info));
  dst->r_addend = 0;
}

void
bfd_elf64_swap_reloca_in (bfd *abfd,
      const bfd_byte *s,
      Elf_Internal_Rela *dst)
{
  const Elf64_External_Rela *src = (const Elf64_External_Rela *) s;
  dst->r_offset = ((*((abfd)->xvec->bfd_h_getx64)) (src->r_offset));
  dst->r_info = ((*((abfd)->xvec->bfd_h_getx64)) (src->r_info));
  dst->r_addend = ((*((abfd)->xvec->bfd_h_getx_signed_64)) (src->r_addend));
}


void
bfd_elf64_swap_reloc_out (bfd *abfd,
      const Elf_Internal_Rela *src,
      bfd_byte *d)
{
  Elf64_External_Rel *dst = (Elf64_External_Rel *) d;
  ((*((abfd)->xvec->bfd_h_putx64)) (src->r_offset, dst->r_offset));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->r_info, dst->r_info));
}

void
bfd_elf64_swap_reloca_out (bfd *abfd,
       const Elf_Internal_Rela *src,
       bfd_byte *d)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx64)) (src->r_offset, dst->r_offset));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->r_info, dst->r_info));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->r_addend, dst->r_addend));
}

void
bfd_elf64_swap_dyn_in (bfd *abfd,
   const void *p,
   Elf_Internal_Dyn *dst)
{
  const Elf64_External_Dyn *src = (const Elf64_External_Dyn *) p;

  dst->d_tag = ((*((abfd)->xvec->bfd_h_getx64)) (src->d_tag));
  dst->d_un.d_val = ((*((abfd)->xvec->bfd_h_getx64)) (src->d_un.d_val));
}

void
bfd_elf64_swap_dyn_out (bfd *abfd,
    const Elf_Internal_Dyn *src,
    void *p)
{
  Elf64_External_Dyn *dst = (Elf64_External_Dyn *) p;

  ((*((abfd)->xvec->bfd_h_putx64)) (src->d_tag, dst->d_tag));
  ((*((abfd)->xvec->bfd_h_putx64)) (src->d_un.d_val, dst->d_un.d_val));
}
# 470 "./elfcode.h"
static inline bfd_boolean
elf_file_p (Elf64_External_Ehdr *x_ehdrp)
{
...
void
bfd_elf64_write_relocs (bfd *abfd, asection *sec, void *data)
{
  ...
  if (rela_hdr->sh_type == 4)
    ...
    {
      swap_out = bfd_elf64_swap_reloc_out;
      extsize = sizeof (Elf64_External_Rel);
    }
  else
   ...
   && ! _bfd_elf_validate_reloc (abfd, ptr))
 {
   *failedp = 1;
   return;
      ...
      src_rela.r_info = (((bfd_vma) (n) << 31 << 1) + (bfd_vma) (ptr->howto->type));
...
int
bfd_elf64_write_out_phdrs (bfd *abfd,
...
bfd_boolean
bfd_elf64_write_shdrs_and_ehdr (bfd *abfd)
{
  Elf64_External_Ehdr x_ehdr;
  Elf_Internal_Ehdr *i_ehdrp;
...
bfd_boolean
bfd_elf64_checksum_contents (bfd *abfd,
         ...
         void *arg)
{
  ...
  for (count = 0; count < num; count++)
    {
      Elf64_External_Phdr x_phdr;
      bfd_elf64_swap_phdr_out (abfd, &i_phdrp[count], &x_phdr);
...
long
bfd_elf64_slurp_symbol_table (bfd *abfd, asymbol **symptrs, bfd_boolean dynamic)
{
  Elf_Internal_Shdr *hdr;
        ...
        bfd_boolean dynamic)
{
  ...
  do { if (!(entsize == sizeof (Elf64_External_Rel) || entsize == sizeof (Elf64_External_Rela))) bfd_assert("./elfcode.h",1411); } while (0);
 ...
 bfd_elf64_swap_reloc_in (abfd, native_relocs, &rela);
 ...
 relent->sym_ptr_ptr = (&_bfd_std_section[2])->symbol_ptr_ptr;
      else if (((rela.r_info) >> 32) > symcount)
 {
   (*_bfd_error_handler)
     (dgettext ("bfd", "%s(%s): relocation %d has invalid symbol index %ld"),
      abfd->filename, asect->name, i, ((rela.r_info) >> 32));
   relent->sym_ptr_ptr = (&_bfd_std_section[2])->symbol_ptr_ptr;
 }
      else
 {
...
bfd_boolean
bfd_elf64_slurp_reloc_table (bfd *abfd,
         asection *asect,
         asymbol **symbols,
         bfd_boolean dynamic)
{
   ...
   int (*target_read_memory) (bfd_vma, bfd_byte *, bfd_size_type))
{
      ...
      if (! ((templ)->xvec->header_byteorder == BFD_ENDIAN_LITTLE))
 {
  ...
  if (i_ehdr.e_phentsize != sizeof (Elf64_External_Phdr) || i_ehdr.e_phnum == 0)
    {
      bfd_set_error (bfd_error_wrong_format);
      return ((void*)0);
    }

  x_phdrs = (Elf64_External_Phdr *)
  ...
  for (i = 0; i < i_ehdr.e_phnum; ++i)
    {
      bfd_elf64_swap_phdr_in (templ, &x_phdrs[i], &i_phdrs[i]);
...
{
  return (((bfd_vma) (sym) << 31 << 1) + (bfd_vma) (type));
}
...
# 21 "./elfcore.h"
char*
bfd_elf64_core_file_failing_command (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->command;
}

int
bfd_elf64_core_file_failing_signal (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->signal;
}

int
bfd_elf64_core_file_pid (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->pid;
}

bfd_boolean
bfd_elf64_core_file_matches_executable_p (bfd *core_bfd, bfd *exec_bfd)
{
  char* corename;
...
# 78 "./elfcore.h"
const bfd_target *
bfd_elf64_core_file_p (bfd *abfd)
{
  Elf64_External_Ehdr x_ehdr;
  Elf_Internal_Ehdr *i_ehdrp;
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf64.c" 2
