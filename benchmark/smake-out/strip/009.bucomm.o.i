# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
# 1 "../bfd/libbfd.h" 1
# 56 "../bfd/libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c" 2
...
# 74 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
void
...
display_target_list (void)
{
  ...
  dummy_name = make_temp_file (((void*)0));
 ...
 if (((*((abfd)->xvec->_bfd_set_arch_mach)) (abfd, (enum bfd_architecture) a, 0)))
   printf ("  %s\n",
...
display_info_table (int first, int last)
{
  ...
  for (a = bfd_arch_obscure + 1; a < bfd_arch_last; a++)
    if (strcmp (bfd_printable_arch_mach ((enum bfd_architecture) a, 0),
                "UNKNOWN!") != 0)
      {
 printf ("%*s ", (int) sizeof ("powerpc:common") - 1,
  bfd_printable_arch_mach ((enum bfd_architecture) a, 0));
 for (t = first; t < last && bfd_target_vector[t]; t++)
   {
     const bfd_target *p = bfd_target_vector[t];
...
display_target_tables (void)
{
  ...
  t = 0;
  while (bfd_target_vector[t] != ((void*)0))
    {
      int oldt = t, wid;

      wid = sizeof ("powerpc:common") + strlen (bfd_target_vector[t]->name) + 1;
      ++t;
      while (wid < columns && bfd_target_vector[t] != ((void*)0))
 {
   int newwid;
...
template_in_dir (const char *path)
{
  ...
  char *tmpname;
  size_t len;
# 475 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
  if (slash != (char *) ((void*)0))
    {
      len = slash - path;
      tmpname = (char *) xmalloc (len + sizeof ("stXXXXXX") + 2);
      memcpy (tmpname, path, len);
# 488 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
      tmpname[len++] = '/';
    }
  else
    {
...
# 550 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c"
}
...
bfd_get_archive_filename (const bfd *abfd)
{
  ...
  ((void) sizeof ((abfd != ((void*)0)) ? 1 : 0), __extension__ ({ if (abfd != ((void*)0)) ; else __assert_fail ("abfd != NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/bucomm.c", 606, __extension__ __PRETTY_FUNCTION__); }));
