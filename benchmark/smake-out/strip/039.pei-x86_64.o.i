# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
# 67 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c"
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 68 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
...
# 69 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
...
# 70 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
...
# 71 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
# 1 "./libcoff.h" 1
# 26 "./libcoff.h"
...
# 72 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
# 1 "./libpei.h" 1
# 341 "./libpei.h"
...
# 73 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
...
# 74 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
  ...
  if (sym != ((void*)0) && sym->n_scnum == 0 && sym->n_value != 0)
    {
      ...
      do { if (!(h != ((void*)0))) bfd_assert("./coff-x86_64.c",592); } while (0);
# 604 "./coff-x86_64.c"
    }
# 615 "./coff-x86_64.c"
  if (howto->pc_relative)
...
coff_amd64_reloc_type_lookup (bfd *abfd __attribute__ ((__unused__)), bfd_reloc_code_real_type code)
{
  switch (code)
    ...
    default:
      do { bfd_assert("./coff-x86_64.c",697); } while (0);
      return 0;
    }
}
...
# 765 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-x86_64.c" 2
