# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c" 2
...
# 9 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c" 2
...
# 11 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c" 2
...
# 115 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c"
    return flags;
}
# 136 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c"
const char * zError(err)
    int err;
{
    return z_errmsg[2 -(err)];
}
# 304 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/zutil.c"
