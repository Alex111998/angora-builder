# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c" 2
        ...
        bfd_boolean avoid_plt)
{
 ...
 (dgettext ("bfd", "%F%P: dynamic STT_GNU_IFUNC symbol `%s' with pointer " "equality in `%B' can not be used when making an " "executable; recompile with -fPIE and relink with -pie\n"),
  ...
  if (!h->ref_regular)
    {
      if (h->plt.refcount > 0
   || h->got.refcount > 0)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c", 192, __PRETTY_FUNCTION__);
      h->got = htab->init_got_offset;
      h->plt = htab->init_plt_offset;
      *head = ((void*)0);
      return 1;
...
# 306 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/elf-ifunc.c"
  if (use_plt
      && (h->got.refcount <= 0
...
_bfd_elf_ifunc_get_synthetic_symtab
  (bfd *abfd, long symcount __attribute__ ((__unused__)),
   asymbol **syms __attribute__ ((__unused__)), long dynsymcount, asymbol **dynsyms,
