# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c" 2
# 49 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 50 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 51 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c" 2
...
# 52 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 53 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c" 2
# 429 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
unsigned int
bfd_get_reloc_size (reloc_howto_type *howto)
{
  switch (howto->size)
    ...
    case -1: return 2;
    case -2: return 4;
    default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 442, __PRETTY_FUNCTION__);
    }
}
# 487 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_reloc_status_type
      ...
      bfd_vma relocation)
{
 ...
 flag = bfd_reloc_overflow;
    ...
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 535, __PRETTY_FUNCTION__);
    }

  return flag;
}
# 572 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (octets + bfd_get_reloc_size (howto)
      > ((abfd)->direction != write_direction && (input_section)->rawsize != 0 ? (input_section)->rawsize : (input_section)->size))
  ...
  if (howto->pc_relative)
    {
# 685 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
      relocation -=
      ...
      else
 {
   ...
   if (abfd->xvec->flavour == bfd_target_coff_flavour
     ...
     {
# 787 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
       relocation -= reloc_entry->addend;
...
# 804 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont
    ...
    flag = bfd_check_overflow (howto->complain_on_overflow,
          ...
          relocation);
# 839 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 880 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  switch (howto->size)
    {
    case 0:
      {
 ...
 ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) x),((bfd_byte *) data + octets)));
    ...
    case 4:
      ...
      {
 bfd_vma x = ((*((abfd)->xvec->bfd_getx64)) ((bfd_byte *) data + octets));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx64)) ((x), ((bfd_byte *) data + octets)));
      }
...
# 966 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (howto->pc_relative)
    {
# 1069 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
      relocation -=
 input_section->output_section->vma + input_section->output_offset;
 ...
 relocation -= reloc_entry->address;
  ...
  if (! howto->partial_inplace)
   ...
   && strcmp (abfd->xvec->name, "coff-Intel-big") != 0)
 {
# 1168 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
   relocation -= reloc_entry->addend;
...
# 1186 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont)
    flag = bfd_check_overflow (howto->complain_on_overflow,
          howto->bitsize,
          howto->rightshift,
          bfd_arch_bits_per_address (abfd),
          relocation);
# 1220 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 1261 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
...
# 1336 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_reloc_status_type
     ...
     bfd_vma addend)
{
  ...
  if (octets + bfd_get_reloc_size (howto)
      > ((input_bfd)->direction != write_direction && (input_section)->rawsize != 0 ? (input_section)->rawsize : (input_section)->size))
    return bfd_reloc_outofrange;
...
# 1369 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
  if (howto->pc_relative)
    {
   ...
   bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 1406, __PRETTY_FUNCTION__);
    case 0:
      return bfd_reloc_ok;
    case 1:
    ...
    case 8:
      ...
      x = ((*((input_bfd)->xvec->bfd_getx64)) (location));
 ...
 case complain_overflow_bitfield:
   ...
   sum = a + b;
# 1496 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
   if (((~(a ^ b)) & (a ^ sum)) & signmask & addrmask)
     flag = bfd_reloc_overflow;
   break;

 case complain_overflow_unsigned:
# 1512 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
   sum = (a + b) & addrmask;
   if ((a | b | sum) & signmask)
     flag = bfd_reloc_overflow;
   break;
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 1518, __PRETTY_FUNCTION__);
 }
    }
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 1534, __PRETTY_FUNCTION__);
    case 1:
       ...
       bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 1575, __PRETTY_FUNCTION__);
    case 0:
      return;
    case 1:
      x = (*(const unsigned char *) (location) & 0xff);
  ...
  switch (size)
    ...
    default:
    case 0:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c", 1611, __PRETTY_FUNCTION__);
    case 1:
      ((void) (*((unsigned char *) (location)) = (x) & 0xff));
      break;
    case 2:
...
# 7726 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
reloc_howto_type *
...
# 7754 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
reloc_howto_type *
bfd_default_reloc_type_lookup (bfd *abfd, bfd_reloc_code_real_type code)
{
 ...
 {
 case 64:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c",7765); } while (0);
 case 32:
   return &bfd_howto_32;
 case 16:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c",7769); } while (0);
 default:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c",7771); } while (0);
 }
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c",7774); } while (0);
    }
  return ((void*)0);
}
# 7791 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
const char *
...
# 7815 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_boolean
...
# 7842 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_boolean
...
# 7863 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_boolean
...
# 7889 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_boolean
...
# 7915 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c"
bfd_byte *
         ...
         asymbol **symbols)
{
      ...
      for (parent = reloc_vector; *parent != ((void*)0); parent++)
 {
   ...
   if (symbol == ((void*)0))
     {
       link_info->callbacks->einfo
  (dgettext ("bfd", "%X%P: %B(%A): error: relocation for offset %V has no value\n"),
  ...
  case bfd_reloc_dangerous:
    do { if (!(error_message != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/reloc.c",8014); } while (0);
  ...
  case bfd_reloc_outofrange:
    ...
    link_info->callbacks->einfo
      (dgettext ("bfd", "%X%P: %B(%A): relocation \"%R\" goes out of range\n"),
  ...
  case bfd_reloc_notsupported:
    ...
    link_info->callbacks->einfo
      (dgettext ("bfd", "%X%P: %B(%A): relocation \"%R\" is not supported\n"),
       abfd, input_section, * parent);
    goto error_return;
  ...
  default:
    ...
    link_info->callbacks->einfo
      (dgettext ("bfd", "%X%P: %B(%A): relocation \"%R\" returns an unrecognized value %x\n"),
