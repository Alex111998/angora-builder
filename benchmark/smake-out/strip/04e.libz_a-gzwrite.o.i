# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/gzwrite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/gzwrite.c" 2
...
# 7 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/gzwrite.c" 2
...
int gzvprintf(gzFile file, const char *format, va_list va)
{
    ...
    size = (int)(state->size);
    state->in[size - 1] = 0;
# 357 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/gzwrite.c"
...
# 465 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/zlib/gzwrite.c"
