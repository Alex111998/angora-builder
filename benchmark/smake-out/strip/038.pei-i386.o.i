# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c" 2
# 45 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c"
# 1 "./coff-i386.c" 1
# 24 "./coff-i386.c"
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
      ...
      for (i = (sizeof (jtab) / sizeof (jtab)[0]); i--;)
 {
   ...
   if (jtab[i].magic == magic)
     break;
      ...
      if (i < 0)
 _bfd_abort ("./peicode.h", 985, __PRETTY_FUNCTION__);
...
# 1018 "./peicode.h"
 pe_ILF_make_a_symbol_reloc (&vars, (bfd_vma) jtab[i].offset,
    ...
    default:
      ...
      _bfd_abort ("./peicode.h", 1030, __PRETTY_FUNCTION__);
    }
  ...
  switch (import_type)
    ...
    default:
      ...
      _bfd_abort ("./peicode.h", 1080, __PRETTY_FUNCTION__);
    }
...
# 4466 "./coffcode.h"
 ...
 do { if (!(rec == recend)) bfd_assert("./coffcode.h",4478); } while (0);
      }
...
coff_slurp_line_table (bfd *abfd, asection *asect)
{
  ...
  do { if (!(asect->lineno == ((void*)0))) bfd_assert("./coffcode.h",4565); } while (0);
      ...
      if (func_table != ((void*)0))
 {
   ...
   do { if (!((unsigned int) (p - func_table) == nbr_func)) bfd_assert("./coffcode.h",4688); } while (0);
       ...
       for (i = 0; i < nbr_func; i++)
  {
    ...
    while (old_ptr->line_number != 0);
       ...
       do { if (!((bfd_size_type) (n_cache_ptr - n_lineno_cache) == (amt / sizeof (alent)))) bfd_assert("./coffcode.h",4715); } while (0);
...
coff_slurp_symbol_table (bfd * abfd)
{
      ...
      while (this_index < last_native_index)
 {
   ...
   do { if (!(src->is_sym)) bfd_assert("./coffcode.h",4776); } while (0);
...
{
  _bfd_abort ("./coffcode.h", 5425, __PRETTY_FUNCTION__);
  return 0;
}
# 5437 "./coffcode.h"
static void
...
{
  _bfd_abort ("./coffcode.h", 5446, __PRETTY_FUNCTION__);
}
# 5499 "./coffcode.h"
static bfd_boolean
...
# 46 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/pei-i386.c" 2
