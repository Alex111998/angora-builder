# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
# 134 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 135 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 136 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
...
# 137 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 138 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
...
# 139 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
...
# 140 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
...
# 141 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
...
# 144 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c" 2
# 155 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
struct ar_cache
{
  file_ptr ptr;
  bfd *arbfd;
};
# 172 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
void
...
_bfd_generic_mkarchive (bfd *abfd)
{
  ...
  if (((abfd)->tdata.aout_ar_data) == ((void*)0))
    return 0;
# 229 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
  return 1;
}
# 254 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
symindex
...
# 294 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd_boolean
...
# 474 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
void *
...
# 773 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd *
...
# 858 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  if (abfd->target_defaulted && ((abfd)->has_armap))
    {
      bfd *first;
# 883 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
...
# 917 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
static bfd_boolean
...
# 1188 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd_boolean
bfd_slurp_bsd_armap_f2 (bfd *abfd)
{
  ...
  if (! (strncmp ((nextname), ("/               "), sizeof ("/               ") - 1) == 0))
    {
      ((abfd)->has_armap) = 0;
      return 1;
    }
 ...
 bfd_set_error (bfd_error_malformed_archive);
  ...
  ardata->symdef_count = ((*((abfd)->xvec->bfd_h_getx16)) (raw_armap));

  ardata->cache = 0;

  stringsize = ((*((abfd)->xvec->bfd_h_getx32)) (raw_armap + 2));
  if (stringsize > left)
    goto wrong_format;
  left -= stringsize;
...
# 1302 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd_boolean
...
# 1423 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
static const char *
normalize (bfd *abfd __attribute__ ((__unused__)), const char *file)
{
  return lbasename (file);
}
# 1452 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
static const char *
      ...
      while (dir_down && down > pwd)
 {
   if ((((*down) == '/') || (((*down) == '\\') && (0))))
     --dir_down;
      ...
      do { if (!(dir_down == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c",1523); } while (0);
      len += strlen (down) + 1;
    }
  else
    down = ((void*)0);
...
# 1591 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd_boolean
  ...
  if ((hdr->ar_name[0] == '#' && hdr->ar_name[1] == '1' && hdr->ar_name[2] == '/' && (_sch_istable[(hdr->ar_name[3]) & 0xff] & (unsigned short)(_sch_isdigit))))
    {
      ...
      do { if (!(padded_len == ((struct areltdata *) ((abfd)->arelt_data))->extra_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c",1853); } while (0);
...
# 1913 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
...
bfd_generic_stat_arch_elt (bfd *abfd, struct stat *buf)
{
  ...
  if (hdr == ((void*)0))
    return -1;
# 2039 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
  ...
  if (filename == ((void*)0))
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c", 2072, __PRETTY_FUNCTION__);
    }
...
# 2118 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
void
...
# 2681 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c"
bfd_boolean
...
_bfd_archive_close_and_cleanup (bfd *abfd)
{
      ...
      if (htab)
 {
   ...
   if (slot != ((void*)0))
     {
       do { if (!(((struct ar_cache *) *slot)->arbfd == abfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/archive.c",2868); } while (0);
