# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
# 122 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 123 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 124 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 125 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
...
# 126 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
...
# 127 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c" 2
# 142 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c"
...
ihex_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == ':')) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c",566); } while (0);
...
ihex_write_object_contents (bfd *abfd)
{
      ...
      while (count > 0)
 {
       ...
       if (where <= 0xfffff)
  {
    ...
    do { if (!(extbase == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c",793); } while (0);
...
# 950 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/ihex.c"
const bfd_target ihex_vec =
{
  ...
  ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), _bfd_generic_init_private_section_data, ((bfd_boolean (*) (bfd *, asection *, bfd *, asection *)) bfd_true), ((bfd_boolean (*) (bfd *, asymbol *, bfd *, asymbol *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), ((bfd_boolean (*) (bfd *, void *)) bfd_true),
