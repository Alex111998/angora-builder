# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "./../include/progress.h" 1
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "./../include/fnmatch.h" 1
# 63 "./../include/fnmatch.h"
extern int fnmatch (const char *__pattern, const char *__string, int __flags);
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "../bfd/elf-bfd.h" 1
# 25 "../bfd/elf-bfd.h"
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "../bfd/libbfd.h" 1
# 56 "../bfd/libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
# 1 "../bfd/libcoff.h" 1
# 27 "../bfd/libcoff.h"
# 1 "../bfd/coff-bfd.h" 1
# 27 "../bfd/coff-bfd.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 39 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c" 2
...
# 143 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
  bfd_vma vma_val;
  bfd_vma lma_val;
  flagword flags;
};
...
# 639 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
...
# 689 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
  list_supported_targets (program_name, stream);
  if ("<http://www.sourceware.org/bugzilla/>"[0] && exit_status == 0)
    fprintf (stream, gettext ("Report bugs to %s\n"), "<http://www.sourceware.org/bugzilla/>");
  exit (exit_status);
...
# 786 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
      if (0) ;
...
# 854 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
   ...
   if (((obfd)->xvec->flavour) == bfd_target_coff_flavour)
     {
       ...
       asection * sec;
# 2229 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
...
# 2247 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
       else
      ...
      if (pad_to_set)
 {
  ...
  if (strip_symbols == STRIP_DEBUG
      ...
      || add_symbols)
    {
# 2375 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
      if (strip_symbols != STRIP_ALL)
...
copy_relocations_in_section (bfd *ibfd, sec_ptr isection, void *obfdarg)
{
  ...
  if (((obfd)->format) == bfd_core || strip_symbols == STRIP_NONDWO)
    relsize = 0;
  else
    {
...
mark_symbols_used_in_relocations (bfd *ibfd, sec_ptr isection, void *symbolsarg)
{
 ...
 return;
  ...
  for (i = 0; i < relcount; i++)
    {
      if (*relpp[i]->sym_ptr_ptr != (&_bfd_std_section[0])->symbol
...
strip_main (int argc, char *argv[])
{
 ...
 case 'F':
   ...
   break;
 case 'R':
   find_section_list (optarg, 1, (1 << 0));
   sections_removed = 1;
   break;
 case 's':
   strip_symbols = STRIP_ALL;
...
# 4807 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/objcopy.c"
