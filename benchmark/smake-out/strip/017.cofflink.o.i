# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
# 1 "./libbfd.h" 1
# 56 "./libbfd.h"
...
void *bfd_arch_default_fill (bfd_size_type count,
    bfd_boolean is_bigendian,
    bfd_boolean code);
# 28 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
# 1 "./libcoff.h" 1
# 27 "./libcoff.h"
# 1 "./coff-bfd.h" 1
# 27 "./coff-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
struct bfd_hash_entry *
         ...
         struct bfd_link_info *info)
{
  ...
  do { if (!(symesz == (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_auxesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",265); } while (0);
      ...
      if (classification != COFF_SYMBOL_LOCAL)
 {
   ...
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 304, __PRETTY_FUNCTION__);
...
# 377 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
   if ((((abfd)->tdata.coff_obj_data)->pe)
  ...
  goto error_return;
   ...
   if (classification == COFF_SYMBOL_PE_SECTION
       && (*sym_hash)->numaux != 0)
     {
       ...
       do { if (!((*sym_hash)->numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",495); } while (0);
       if (section->size == 0)
        ...
        struct bfd_link_info *info)
{
      ...
      else
 {
   ...
   line_filepos += o->lineno_count * linesz;
      ...
      if (o->reloc_count != 0)
 {
# 751 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
   do { if (!(((info)->type == type_relocatable))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",751); } while (0);
   amt = o->reloc_count;
      ...
      for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
 {
       ...
       if (string_size)
  {
    ...
    if (isym.n_sclass != 103)
      ...
      {
        do { if (!(isym.n_numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",942); } while (0);
   ...
   for (; irel < irelend; irel++, rel_hash++, erel += relsz)
     {
       if (*rel_hash != ((void*)0))
  {
    do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",1093); } while (0);
...
_bfd_coff_link_input_bfd (struct coff_final_link_info *flaginfo, bfd *input_bfd)
{
  ...
  do { if (!(linesz == (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_linesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",1441); } while (0);
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 1499, __PRETTY_FUNCTION__);
 case COFF_SYMBOL_GLOBAL:
 case COFF_SYMBOL_PE_SECTION:
      ...
      if (! skip)
 {
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 1537, __PRETTY_FUNCTION__);
     case COFF_SYMBOL_GLOBAL:
     case COFF_SYMBOL_COMMON:
     case COFF_SYMBOL_PE_SECTION:
      ...
      if (! skip)
 {
  ...
  if (! (((flaginfo->output_bfd)->tdata.coff_obj_data)->pe))
    isym.n_value += (*secpp)->output_section->vma;
     ...
     case 103:
# 1878 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
       if (flaginfo->last_file_index != -1
   ...
   if (*indexp < 0)
     {
       ...
       do { if (!(isymp->n_numaux == 0 || h->numaux == 0 || h->numaux == isymp->n_numaux)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",1995); } while (0);
       ...
       if (isymp->n_sclass == 103)
  {
    ...
    if (auxp->x_file.x_n.x_zeroes == 0
        && auxp->x_file.x_n.x_offset != 0)
      {
        ...
        do { if (!(auxp->x_file.x_n.x_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",2030); } while (0);
      ...
      for (o = input_bfd->sections; o != ((void*)0); o = o->next)
 {
   ...
   file_ptr pos;
   bfd_size_type amt;
# 2209 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
   if (o->lineno_count == 0
...
# 2262 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
 ...
 return 0;
      ...
      do { if (!(((((output_bfd)->tdata.coff_obj_data)->raw_syment_count) + (outsym - flaginfo->outsyms) / osymesz) == output_index)) bfd_assert("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c",2339); } while (0);
 ...
 return 1;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 2590, __PRETTY_FUNCTION__);
      return 0;
       ...
       struct bfd_link_order *link_order)
{
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 2833, __PRETTY_FUNCTION__);
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 2871, __PRETTY_FUNCTION__);
      *rel_hash_ptr = ((void*)0);
      irel->r_symndx = 0;
    }
  else
        ...
        asection **sections)
{
      ...
      else
 {
  ...
  {
# 3043 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c"
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.27/binutils-2.27/bfd/cofflink.c", 3113, __PRETTY_FUNCTION__);
 case bfd_reloc_ok:
   break;
 case bfd_reloc_outofrange:
   (*_bfd_error_handler)
