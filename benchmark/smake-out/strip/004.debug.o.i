# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
# 29 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 30 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 31 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 32 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
...
# 34 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 35 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c" 2
...
debug_set_filename (void *handle, const char *name)
{
  ...
  if (info->current_unit != ((void*)0))
    ...
    {
      ((void) sizeof ((info->units == ((void*)0)) ? 1 : 0), __extension__ ({ if (info->units == ((void*)0)) ; else __assert_fail ("info->units == NULL", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c", 699, __extension__ __PRETTY_FUNCTION__); }));
      info->units = nunit;
    }
...
# 763 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
bfd_boolean
...
# 990 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
...
# 1308 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
debug_type
...
# 1775 "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c"
    ...
    struct debug_type_s *type, struct debug_name *name)
{
      ...
      else
 {
  ...
  if (name != ((void*)0)
      ...
      && type->kind != DEBUG_KIND_TAGGED)
    {
      ((void) sizeof ((name->kind == DEBUG_OBJECT_TAG) ? 1 : 0), __extension__ ({ if (name->kind == DEBUG_OBJECT_TAG) ; else __assert_fail ("name->kind == DEBUG_OBJECT_TAG", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c", 2474, __extension__ __PRETTY_FUNCTION__); }));
      tag = name->name;
    }
   ...
   if (info->mark == type->u.kclass->mark)
     {
       ...
       ((void) sizeof ((type->u.kclass->id > info->base_id) ? 1 : 0), __extension__ ({ if (type->u.kclass->id > info->base_id) ; else __assert_fail ("type->u.kclass->id > info->base_id", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c", 2513, __extension__ __PRETTY_FUNCTION__); }));
   ...
   struct debug_type_s *type, const char *tag)
{
      ...
      if (info->mark == type->u.kclass->mark)
 {
   ...
   ((void) sizeof ((type->u.kclass->id > info->base_id) ? 1 : 0), __extension__ ({ if (type->u.kclass->id > info->base_id) ; else __assert_fail ("type->u.kclass->id > info->base_id", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c", 2685, __extension__ __PRETTY_FUNCTION__); }));
   return (*fns->tag_type) (fhandle, tag, type->u.kclass->id,
       type->kind);
 }
      type->u.kclass->mark = info->mark;
      ...
      struct debug_type_s *type)
{
  ...
  ((void) sizeof ((type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS) ? 1 : 0), __extension__ ({ if (type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS) ; else __assert_fail ("type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS", "/benchmark/RUNDIR-binutils-2.27/binutils-2.27/binutils/debug.c", 2944, __extension__ __PRETTY_FUNCTION__); }));
