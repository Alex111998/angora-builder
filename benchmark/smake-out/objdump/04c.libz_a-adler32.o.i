# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/adler32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/adler32.c" 2
...
# 9 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/adler32.c" 2



static uLong adler32_combine_ (uLong adler1, uLong adler2, off_t len2);
# 65 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/zlib/adler32.c"
