# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 60 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 61 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 62 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 63 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
# 64 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 1 "./bfdver.h" 1
# 65 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
# 66 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
extern size_t wcsftime_l (wchar_t *__restrict __s, size_t __maxsize,
     ...
     const struct tm *__restrict __tp,
     locale_t __loc) __attribute__ ((__nothrow__ ));
# 68 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
# 71 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 84 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
...
# 85 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
# 88 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 1 "./libcoff.h" 1
# 26 "./libcoff.h"
...
# 89 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 1 "./libpei.h" 1
# 341 "./libpei.h"
...
# 90 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
...
# 91 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c" 2
# 108 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
void
...
# 142 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
  if (in->n_sclass == 104)
    {
      char namebuf[8 + 1];
      ...
      if (in->n_scnum == 0)
 {
   ...
   if (name == ((void*)0))
     {
       _bfd_error_handler (dgettext ("bfd", "%B: unable to find name for empty section"),
      abfd);
   ...
   if (name == namebuf)
     {
       ...
       if (name == ((void*)0))
  {
    _bfd_error_handler (dgettext ("bfd", "%B: out of memory creating name for empty section"),
          abfd);
    return;
  }
   ...
   flags = 0x100 | 0x001 | 0x020 | 0x002;
   sec = bfd_make_section_anyway_with_flags (abfd, name, flags);
   if (sec == ((void*)0))
     {
       _bfd_error_handler (dgettext ("bfd", "%B: unable to create fake empty section"),
      abfd);
       return;
     }
     ...
     void * aouthdr_int1)
{
 ...
 _bfd_error_handler
   (dgettext ("bfd", "%B: aout header specifies an invalid number of data-directory entries: %d"),
...
# 597 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
}
...
# 691 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
 ...
 if (sec->flags & 0x010)
   tsize += rounded;
# 737 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
 if (((struct coff_section_tdata *) (sec)->used_by_bfd) != ((void*)0)
  ...
  ((*((abfd)->xvec->bfd_h_putx16)) ((((short) (228000000 / 1000000)) / 100 + (((short) (228000000 / 1000000)) % 100) * 256), aouthdr_out->standard.vstamp));
...
# 968 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
 ...
 ps = 0;
  ...
  {
# 1019 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
    typedef struct
    {
...
# 1053 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
      ...
      if (strcmp (scnhdr_int->s_name, p->section_name) == 0)
 {
  ...
  if (((abfd)->tdata.coff_obj_data)->link_info
    ...
    {
# 1079 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
      ...
      else
 {
   ...
   _bfd_error_handler (dgettext ("bfd", "%s: line number overflow: 0x%lx > 0xffff"),
         ((char *) (abfd)->filename),
         scnhdr_int->s_nlnno);
...
# 1260 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
static bfd_boolean
...
# 1380 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
  fprintf (file,
...
# 1537 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
...
pe_print_edata (bfd * abfd, void * vfile)
{
      ...
      if (datasize > section->size - dataoff)
 {
  ...
  fprintf (file, "\n");
# 1770 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
  fprintf (file,
...
# 1876 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
static bfd_boolean
...
# 2006 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
      fprintf (file, "\n");
    }
...
# 2781 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
  switch (i->Magic)
    {
    case 0x10b:
      name = "PE32";
...
_bfd_pe_bfd_copy_private_bfd_data_common (bfd * ibfd, bfd * obfd)
{
 ...
 + ope->pe_opthdr.ImageBase;
   ...
   if (ope->pe_opthdr.DataDirectory[6].Size + (addr - section->vma)
       > ((section)->size))
     {
       ...
       _bfd_error_handler (dgettext ("bfd", "%B: Data Directory size (%lx) exceeds space left in section (%lx)"),
 ...
 {
   _bfd_error_handler (dgettext ("bfd", "%B: Failed to read debug data section"), obfd);
   return 0;
 }
    }
...
# 3091 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
        ...
        rsrc_directory * dir)
{
  ...
  for (i = dir->names.num_entries, entry = dir->names.first_entry;
    ...
    {
      do { if (!(entry->is_name)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3544); } while (0);
      rsrc_write_entry (data, next_entry, entry);
      next_entry += 8;
    }
  do { if (!(i == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3548); } while (0);
  do { if (!(entry == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3549); } while (0);

  for (i = dir->ids.num_entries, entry = dir->ids.first_entry;
       i > 0 && entry != ((void*)0);
       i--, entry = entry->next_entry)
    {
      do { if (!(! entry->is_name)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3555); } while (0);
      rsrc_write_entry (data, next_entry, entry);
      next_entry += 8;
    }
  do { if (!(i == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3559); } while (0);
  do { if (!(entry == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3560); } while (0);
  do { if (!(nt == next_entry)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3561); } while (0);
}
...
# 3643 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
  {
    unsigned int i;
...
# 3789 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
static bfd_boolean
      ...
      rsrc_entry * b __attribute__ ((__unused__)))
{
  ...
  do { if (!(! a->is_dir)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3801); } while (0);
  astring = a->value.leaf->data;

  do { if (!(! b->is_dir)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3804); } while (0);
      ...
      else
 {
  ...
  do { if (!(nstring - new_data == (signed) (a->value.leaf->size + copy_needed))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",3881); } while (0);
     ...
     rsrc_directory * dir)
{
      ...
      do
 {
  ...
  {
# 3943 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
    if (entry->is_name == 0
        && entry->name_id.id == 1
        && dir != ((void*)0)
        && dir->entry != ((void*)0)
     ...
     && next->value.directory->ids.first_entry->is_name == 0
     && next->value.directory->ids.first_entry->name_id.id == 0)

   ;
        else if (entry->value.directory->names.num_entries == 0
          && entry->value.directory->ids.num_entries == 1
          && entry->value.directory->ids.first_entry->is_name == 0
       ...
       else
  {
    ...
    if (entry->is_name == 0
        ...
        && dir->entry->parent->entry != ((void*)0)
        && dir->entry->parent->entry->is_name == 0
...
rsrc_merge (struct rsrc_entry * a, struct rsrc_entry * b)
{
  ...
  do { if (!(a->is_dir)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",4091); } while (0);
  do { if (!(b->is_dir)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",4092); } while (0);
        ...
        struct coff_final_link_info * pfinfo)
{
  ...
  if (! bfd_get_section_contents (abfd, sec, data, 0, size))
    goto end;
# 4179 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
      ...
      if (rsrc_sec != ((void*)0) && !(!((rsrc_sec) == (&_bfd_std_section[2])) && (((rsrc_sec)->output_section) == (&_bfd_std_section[2])) && (rsrc_sec)->sec_info_type != 2 && (rsrc_sec)->sec_info_type != 4))
 {
  ...
  goto end;
   ...
   do { if (!(rsrc_sec->size > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",4201); } while (0);
      ...
      if (data > dataend)
 {
   ...
   _bfd_error_handler (dgettext ("bfd", "%s: .rsrc merge failure: corrupt .rsrc section"),
         ((char *) (abfd)->filename));
   bfd_set_error (bfd_error_file_truncated);
   goto end;
 }
 ...
 {
   _bfd_error_handler (dgettext ("bfd", "%s: .rsrc merge failure: unexpected .rsrc size"),
         ((char *) (abfd)->filename));
   bfd_set_error (bfd_error_file_truncated);
   goto end;
 }
  ...
  do { if (!(num_resource_sets == num_input_rsrc)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",4243); } while (0);
  ...
  do { if (!(indx == num_resource_sets)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c",4264); } while (0);
# 4274 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
...
# 4352 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: unable to fill in DataDictionary[1] because .idata$2 is missing"),
      abfd);
   result = 0;
 }
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: unable to fill in DataDictionary[1] because .idata$4 is missing"),
      abfd);
   result = 0;
 }
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: unable to fill in DataDictionary[12] because .idata$5 is missing"),
      abfd);
   result = 0;
 }
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: unable to fill in DataDictionary[PE_IMPORT_ADDRESS_TABLE (12)] because .idata$6 is missing"),
      abfd);
   result = 0;
 }
    }
   ...
   && h1->root.u.def.section->output_section != ((void*)0))
 {
  ...
  ((abfd)->tdata.pe_obj_data)->pe_opthdr.DataDirectory[12].VirtualAddress =
    iat_va - ((abfd)->tdata.pe_obj_data)->pe_opthdr.ImageBase;
     ...
     {
       _bfd_error_handler
  (dgettext ("bfd", "%B: unable to fill in DataDictionary[PE_IMPORT_ADDRESS_TABLE(12)]" " because .idata$6 is missing"), abfd);
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: unable to fill in DataDictionary[9] because __tls_used is missing"),
      abfd);
   result = 0;
 }
...
# 4545 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/peigen.c"
