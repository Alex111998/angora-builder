# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 51 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 52 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 53 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "../bfd/elf-bfd.h" 1
# 25 "../bfd/elf-bfd.h"
...
# 54 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "../bfd/coff-bfd.h" 1
# 27 "../bfd/coff-bfd.h"
...
# 55 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./../include/progress.h" 1
# 56 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 57 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./elfcomm.h" 1
# 27 "./elfcomm.h"
...
extern char *make_qualified_name (struct archive_info *,
      struct archive_info *,
      const char *);
# 58 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./dwarf.h" 1
# 21 "./dwarf.h"
...
# 59 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 60 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
# 61 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
extern void init_disassemble_info (struct disassemble_info *dinfo, void *stream,
       fprintf_ftype fprintf_func);
# 62 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
# 63 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
cplus_demangle_print_callback (int options,
                               const struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 64 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
# 65 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 66 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 67 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
# 1 "./objdump.h" 1
# 21 "./objdump.h"
...
# 68 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
# 76 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c" 2
...
# 231 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
  if (status != 2)
    {
...
# 262 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
...
# 408 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
static void
free_only_list (void)
{
...
dump_section_header (bfd *abfd, asection *section,
       void *ignored __attribute__ ((__unused__)))
{
  char *comma = "";
  ...
  if (section->flags & 0x001) { printf ("%s%s", comma, "ALLOC"); comma = ", "; };
  if (section->flags & 0x080) { printf ("%s%s", comma, "CONSTRUCTOR"); comma = ", "; };
  if (section->flags & 0x002) { printf ("%s%s", comma, "LOAD"); comma = ", "; };
  if (section->flags & 0x004) { printf ("%s%s", comma, "RELOC"); comma = ", "; };
  if (section->flags & 0x008) { printf ("%s%s", comma, "READONLY"); comma = ", "; };
  if (section->flags & 0x010) { printf ("%s%s", comma, "CODE"); comma = ", "; };
  if (section->flags & 0x020) { printf ("%s%s", comma, "DATA"); comma = ", "; };
  if (section->flags & 0x040) { printf ("%s%s", comma, "ROM"); comma = ", "; };
...
dump_headers (bfd *abfd)
{
  ...
  if (bfd_get_arch_size (abfd) == 32)
    printf (gettext ("Idx Name          Size      VMA       LMA       File off  Algn"));
  else
    printf (gettext ("Idx Name          Size      VMA               LMA               File off  Algn"));
...
compare_symbols (const void *ap, const void *bp)
{
 ...
 || strstr (bn, "gcc2_compiled") != ((void*)0));
  ...
  if (! af && bf)
    return -1;
# 711 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
...
# 970 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
...
# 1227 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
static const char *
slurp_file (const char *fn, size_t *size)
{
  ...
  *size = st.st_size;
# 1255 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
...
# 1615 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
static void
...
# 1784 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
        || (distance_to_rel > 0
...
disassemble_section (bfd *abfd, asection *section, void *inf)
{
 ...
 {
# 2203 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
...
dump_dwarf (bfd *abfd)
{
  is_relocatable = (abfd->flags & (0x02 | 0x40)) == 0;
...
# 2679 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
static void
...
dump_bfd_header (bfd *abfd)
{
  ...
  if (abfd->flags & 0x01) {printf("%s%s", comma, "HAS_RELOC"); comma=", ";};
  if (abfd->flags & 0x02) {printf("%s%s", comma, "EXEC_P"); comma=", ";};
  if (abfd->flags & 0x04) {printf("%s%s", comma, "HAS_LINENO"); comma=", ";};
...
# 3227 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/./objdump.c"
   if (abfd->xvec->flavour == bfd_target_elf_flavour
...
dump_bfd (bfd *abfd)
{
  ...
  if (adjust_section_vma != 0)
    {
      bfd_boolean has_reloc = (abfd->flags & 0x01);
  ...
  if (! dump_debugging_tags && ! suppress_bfd_header)
    printf (gettext ("\n%s:     file format %s\n"), ((char *) (abfd)->filename),
     abfd->xvec->name);
  if (dump_ar_hdrs)
    print_arelt_descr (stdout, abfd, 1);
  if (dump_file_header)
