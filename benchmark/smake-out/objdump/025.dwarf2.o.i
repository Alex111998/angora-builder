# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
# 32 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 33 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 36 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 37 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c" 2
...
# 381 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
       ...
       bfd_size_type * section_size)
{
 ...
 {
   *section_buffer
     = bfd_simple_get_relocated_section_contents (abfd, msec, ((void*)0), syms);
   if (! *section_buffer)
     return 0;
 }
      else
  ...
  if (offset != 0 && offset >= *section_size)
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "Dwarf Error: Offset (%lu)" " greater than or equal to %s size (%lu)."),
...
static bfd_byte *
read_n_bytes (bfd *abfd __attribute__ ((__unused__)),
       bfd_byte *buf,
       bfd_byte *end,
...
# 664 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static char *
...
read_address (struct comp_unit *unit, bfd_byte *buf, bfd_byte * buf_end)
{
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c", 831, __PRETTY_FUNCTION__);
 }
    }
  else
    {
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c", 845, __PRETTY_FUNCTION__);
 }
    }
}
...
read_abbrevs (bfd *abfd, bfd_uint64_t offset, struct dwarf2_debug *stash)
{
  ...
  abbrev_number = safe_read_leb128 (abfd, abbrev_ptr, &bytes_read, 0, abbrev_end);
 ...
 safe_read_leb128 (abfd, abbrev_ptr, &bytes_read, 0, abbrev_end);
      abbrev_ptr += bytes_read;
      cur_abbrev->has_children = read_1_byte (abfd, abbrev_ptr, abbrev_end);
      abbrev_ptr += 1;


      abbrev_name = safe_read_leb128 (abfd, abbrev_ptr, &bytes_read, 0, abbrev_end);
      abbrev_ptr += bytes_read;
      abbrev_form = safe_read_leb128 (abfd, abbrev_ptr, &bytes_read, 0, abbrev_end);
      abbrev_ptr += bytes_read;
...
# 977 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
        ...
        bfd_byte * info_ptr_end)
{
 ...
 return ((void*)0);
    ...
    case DW_FORM_block:
      ...
      if (blk == ((void*)0))
 return ((void*)0);
      blk->size = safe_read_leb128 (abfd, info_ptr, &bytes_read, 0, info_ptr_end);
      info_ptr += bytes_read;
      blk->data = read_n_bytes (abfd, info_ptr, info_ptr_end, blk->size);
      info_ptr += blk->size;
      attr->u.blk = blk;
 ...
 return ((void*)0);
    ...
    case DW_FORM_flag_present:
      ...
      break;
    case DW_FORM_sdata:
      attr->u.sval = safe_read_leb128 (abfd, info_ptr, &bytes_read, 1, info_ptr_end);
      info_ptr += bytes_read;
      break;
    case DW_FORM_udata:
      attr->u.val = safe_read_leb128 (abfd, info_ptr, &bytes_read, 0, info_ptr_end);
      info_ptr += bytes_read;
      break;
    case DW_FORM_ref1:
      attr->u.val = read_1_byte (abfd, info_ptr, info_ptr_end);
    ...
    case DW_FORM_indirect:
      form = safe_read_leb128 (abfd, info_ptr, &bytes_read, 0, info_ptr_end);
      info_ptr += bytes_read;
...
# 1390 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
  if (seq
         ...
         struct line_sequence * seq)
{
  ...
  do { if (!(line_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",1641); } while (0);
...
sort_line_sequences (struct line_info_table* table)
{
  ...
  for (n = 0; n < num_sequences; n++)
    {
      ...
      do { if (!(seq)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",1676); } while (0);
  ...
  do { if (!(seq == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",1685); } while (0);
...
decode_line_info (struct comp_unit *unit, struct dwarf2_debug *stash)
{
  ...
  if (stash->dwarf_line_size < 16)
    {
      _bfd_error_handler
 (dgettext ("bfd", "Dwarf Error: Line info section is too small (%ld)"),
 ...
 (dgettext ("bfd", "Dwarf Error: Line info data is bigger (0x%lx) than the section (0x%lx)"),
 ...
 safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
      line_ptr += bytes_read;
      table->files[table->num_files].time = safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
      line_ptr += bytes_read;
      table->files[table->num_files].size = safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
      line_ptr += bytes_read;
      table->num_files++;
    }
      ...
      while (! end_sequence)
 {
  ...
  high_pc = address;
     ...
     case DW_LNS_extended_op:
       exop_len = safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
       line_ptr += bytes_read;
       ...
       else
  {
    ...
    op_index = (op_index + adjust) % lh.maximum_ops_per_insn;
     ...
     case DW_LNS_advance_line:
       line += safe_read_leb128 (abfd, line_ptr, &bytes_read, 1, line_end);
       line_ptr += bytes_read;
       break;
  ...
  file = safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
  line_ptr += bytes_read;
  if (filename)
    free (filename);
  ...
  break;
     ...
     case DW_LNS_set_column:
       column = safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
       line_ptr += bytes_read;
       break;
  ...
  {
    (void) safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
    line_ptr += bytes_read;
  }
       break;
     }
...
build_lookup_funcinfo_table (struct comp_unit * unit)
{
      ...
      for (range = entry->funcinfo->arange.next; range; range = range->next)
 {
  ...
  do { if (!(func_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",2298); } while (0);
        ...
        bfd_boolean *is_linkage)
{
  ...
  if (attr_ptr->form == DW_FORM_ref_addr)
    {
      ...
      if (!die_ref)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c", 2505, __PRETTY_FUNCTION__);
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "Dwarf Error: Unable to read alt ref %u."), die_ref);
   bfd_set_error (bfd_error_bad_value);
   return ((void*)0);
 }
  ...
  abbrev_number = safe_read_leb128 (abfd, info_ptr, &bytes_read, 0, info_ptr_end);
  info_ptr += bytes_read;
...
scan_unit_for_symbols (struct comp_unit *unit)
{
   ...
   || abbrev->tag == DW_TAG_inlined_subroutine)
 {
   ...
   do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",2725); } while (0);
      ...
      else
 {
  ...
  goto fail;
       ...
       do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",2749); } while (0);
     }
  ...
  case DW_AT_location:
        ...
        if (*attr.u.blk->data == DW_OP_addr)
   {
     ...
     if (attr.u.blk->size == unit->addr_size + 1U)
       var->addr = ((unit->addr_size * 8) == 8 ? (bfd_vma) (*(const unsigned char *) (attr.u.blk->data + 1) & 0xff) : (unit->addr_size * 8) == 16 ? ((*((unit->abfd)->xvec->bfd_getx16)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 32 ? ((*((unit->abfd)->xvec->bfd_getx32)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 64 ? ((*((unit->abfd)->xvec->bfd_getx64)) (attr.u.blk->data + 1)) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c", 2873, __PRETTY_FUNCTION__), (bfd_vma) - 1));
...
# 2934 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
   ...
   unsigned int offset_size)
{
  ...
  info_ptr += 2;
  do { if (!(offset_size == 4 || offset_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",2958); } while (0);
  if (offset_size == 4)
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "Dwarf Error: found dwarf version '%u', this reader" " only handles version 2, 3 and 4 information."), version);
 ...
 ("Dwarf Error: found address size '%u', this reader"
  ...
  abbrev_number = safe_read_leb128 (abfd, info_ptr, &bytes_read, 0, end_ptr);
  info_ptr += bytes_read;
  if (! abbrev_number)
    {
...
# 3160 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static bfd_vma
...
# 3255 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static bfd_boolean
       ...
       struct info_hash_table *varinfo_hash_table)
{
  ...
  do { if (!(stash->info_hash_status != 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3320); } while (0);

  if (!comp_unit_maybe_decode_line_info (unit, stash))
    return 0;

  do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3325); } while (0);
...
# 3383 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static asection *
...
# 3477 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static bfd_boolean
place_sections (bfd *orig_bfd, struct dwarf2_debug *stash)
{
      ...
      for (sect = abfd->sections; sect != ((void*)0); sect = sect->next)
 {
   ...
   if (!((sect->flags & 0x001) != 0 && abfd == orig_bfd)
       && !is_debug_info)
     continue;
      ...
      while (1)
 {
  ...
  continue;
       ...
       if (is_debug_info)
  {
    do { if (!(sect->alignment_power == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3566); } while (0);
    sect->vma = last_dwarf;
    last_dwarf += sz;
  }
       else
...
stash_verify_info_hash_table (struct dwarf2_debug *stash)
{
    ...
    each_func = each_func->prev_func)
 {
   ...
   node = lookup_info_hash_table (stash->funcinfo_hash_table,
      each_func->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3742); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3749); } while (0);
 }
    ...
    each_var = each_var->prev_var)
 {
   ...
   node = lookup_info_hash_table (stash->varinfo_hash_table,
      each_var->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3760); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3767); } while (0);
 }
    }
}
...
{
  do { if (!(stash->info_hash_status == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3780); } while (0);
...
stash_find_line_fast (struct dwarf2_debug *stash,
        ...
        unsigned int *linenumber_ptr)
{
  do { if (!(stash->info_hash_status == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",3816); } while (0);
...
# 3855 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
static bfd_boolean
         ...
         bfd_boolean do_place)
{
   ...
   || !bfd_generic_link_read_symbols (debug_bfd))
 {
  ...
  if (do_place
    ...
    return 0;
# 3967 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
...
# 4078 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
bfd_boolean
_bfd_dwarf2_find_nearest_line (bfd *abfd,
          ...
          void **pinfo)
{
# 4100 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
  struct dwarf2_debug *stash;
  ...
  *linenumber_ptr = 0;
  ...
  if (do_line)
    {
      do { if (!(section == ((void*)0) && offset == 0 && functionname_ptr == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",4125); } while (0);
      section = ((symbol)->section);
      addr = symbol->value;
    }
  else
    {
      do { if (!(section != ((void*)0) && functionname_ptr != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",4131); } while (0);
      addr = offset;
    }
      ...
      for (each = stash->all_comp_units; each; each = each->next_unit)
 {
   ...
   if (found)
     {
# 4216 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
       if (range <= min_range)
  {
      ...
      if (* linenumber_ptr)
 {
  ...
  if (addr_size == 0)
    addr_size = 4;
  do { if (!(addr_size == 4 || addr_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c",4243); } while (0);
...
# 4279 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
      else if (addr_size == 8)
 {
   offset_size = 4;
   stash->info_ptr += 4;
 ...
 return ((void*)0);
  ...
  if (cache->last_section != section
      ...
      || offset >= cache->func->value + cache->func_size)
    {
      ...
      bfd_vma low_func;
      asymbol **p;
# 4549 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/./dwarf2.c"
