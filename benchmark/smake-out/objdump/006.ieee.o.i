# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
# 1 "./../include/ieee.h" 1
# 25 "./../include/ieee.h"
...
ieee_section_type;
# 28 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 31 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c" 2
...
# 252 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
     ...
     unsigned int indx)
{
  ...
  if (indx >= 32 && indx < 64)
    {
      ...
      ((void) sizeof ((indx < (60)) ? 1 : 0), __extension__ ({ if (indx < (60)) ; else __assert_fail ("indx < BUILTIN_TYPE_COUNT", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 604, __extension__ __PRETTY_FUNCTION__); }));
  ...
  ((void) sizeof ((indx < (60)) ? 1 : 0), __extension__ ({ if (indx < (60)) ; else __assert_fail ("indx < BUILTIN_TYPE_COUNT", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 764, __extension__ __PRETTY_FUNCTION__); }));
...
# 3613 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
struct ieee_buf
{
...
# 4112 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
static bfd_boolean
...
ieee_pop_type_used (struct ieee_handle *info, bfd_boolean used)
{
  ...
  ts = info->type_stack;
  ((void) sizeof ((ts != ((void*)0)) ? 1 : 0), __extension__ ({ if (ts != ((void*)0)) ; else __assert_fail ("ts != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 4294, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_end_range (struct ieee_handle *info, bfd_vma high)
{
  ...
  ((void) sizeof ((info->pending_ranges != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->pending_ranges != ((void*)0)) ; else __assert_fail ("info->pending_ranges != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 4420, __extension__ __PRETTY_FUNCTION__); }));
...
# 4594 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c"
bfd_boolean
  ...
  if (! ((&info->cxx)->head == ((void*)0)))
    {
      ...
      ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 4902, __extension__ __PRETTY_FUNCTION__); }));
      if (! ieee_change_buffer (info, &info->vars))
 return 0;
   ...
   bfd_boolean structp, unsigned int size)
{
      ...
      else if (! ntlook->type.localp)
 {
  ...
  if (nt != ((void*)0))
    {
      ((void) sizeof ((localp == nt->type.localp) ? 1 : 0), __extension__ ({ if (localp == nt->type.localp) ; else __assert_fail ("localp == nt->type.localp", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 5876, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (vptr && ! ownvptr)
    {
      ...
      ((void) sizeof ((vclass != ((void*)0)) ? 1 : 0), __extension__ ({ if (vclass != ((void*)0)) ; else __assert_fail ("vclass != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6126, __extension__ __PRETTY_FUNCTION__); }));
         ...
         bfd_boolean context)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL && info->type_stack->type.classdef->method != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6313, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_class_end_method (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0) && info->type_stack->type.classdef->method != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL && info->type_stack->type.classdef->method != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6393, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_end_class_type (void *p)
{
  ...
  ((void) sizeof ((info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->type_stack != ((void*)0) && info->type_stack->type.classdef != ((void*)0)) ; else __assert_fail ("info->type_stack != NULL && info->type_stack->type.classdef != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6409, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_typedef_type (void *p, const char *name)
{
  ...
  ((void) sizeof ((h != ((void*)0)) ? 1 : 0), __extension__ ({ if (h != ((void*)0)) ; else __assert_fail ("h != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6490, __extension__ __PRETTY_FUNCTION__); }));
        ...
        bfd_vma val)
{
  ...
  ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 6899, __extension__ __PRETTY_FUNCTION__); }));
  if (! ieee_change_buffer (info, &info->vars))
    return 0;
...
ieee_start_function (void *p, const char *name, bfd_boolean global)
{
 ...
 return 0;
  ...
  ((void) sizeof ((! ((&info->vars)->head == ((void*)0))) ? 1 : 0), __extension__ ({ if (! ((&info->vars)->head == ((void*)0))) ; else __assert_fail ("! ieee_buffer_emptyp (&info->vars)", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 7066, __extension__ __PRETTY_FUNCTION__); }));
  if (! ieee_change_buffer (info, &info->vars))
    return 0;
    ...
    bfd_vma val)
{
  ...
  ((void) sizeof ((info->block_depth == 1) ? 1 : 0), __extension__ ({ if (info->block_depth == 1) ; else __assert_fail ("info->block_depth == 1", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 7092, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_end_function (void *p)
{
  ...
  ((void) sizeof ((info->block_depth == 1) ? 1 : 0), __extension__ ({ if (info->block_depth == 1) ; else __assert_fail ("info->block_depth == 1", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 7275, __extension__ __PRETTY_FUNCTION__); }));
...
ieee_lineno (void *p, const char *filename, unsigned long lineno, bfd_vma addr)
{
  ...
  ((void) sizeof ((info->filename != ((void*)0)) ? 1 : 0), __extension__ ({ if (info->filename != ((void*)0)) ; else __assert_fail ("info->filename != NULL", "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/binutils/ieee.c", 7322, __extension__ __PRETTY_FUNCTION__); }));
