# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
# 1 "./plugin.h" 1
# 24 "./plugin.h"
...
plugin_data_struct;
# 37 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 38 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
...
# 39 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c" 2
# 111 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c"
...
bfd_plugin_open_input (bfd *ibfd, struct ld_plugin_input_file *file)
{
  ...
  iobfd = ibfd;
  if (ibfd->my_archive && !((ibfd->my_archive)->is_thin_archive))
...
try_claim (bfd *abfd)
{
  ...
  if (!bfd_plugin_open_input (abfd, &file))
    return 0;
  file.handle = abfd;
  off_t cur_offset = lseek (file.fd, 0, 1);
  claim_file (&file, &claimed);
  lseek (file.fd, cur_offset, 0);
  return claimed;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",392); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",405); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",418); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",425); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",432); } while (0);
  return ((void*)0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",439); } while (0);
  return 0;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",446); } while (0);
  return 0;
}
...
bfd_plugin_get_symtab_upper_bound (bfd *abfd)
{
  ...
  do { if (!(nsyms >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",456); } while (0);
...
convert_flags (const struct ld_plugin_symbol *sym)
{
 switch (sym->def)
   ...
   default:
     do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",476); } while (0);
     return 0;
   }
}
    ...
    asymbol **alocation)
{
  ...
  for (i = 0; i < nsyms; i++)
    {
      ...
      do { if (!(s)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",499); } while (0);
      alocation[i] = s;
 ...
 case LDPK_WEAKDEF:
   ...
   break;
 default:
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",520); } while (0);
 }
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",535); } while (0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/plugin.c",562); } while (0);
  return 0;
}
...
const bfd_target plugin_vec =
{
  ...
  _bfd_archive_close_and_cleanup, bfd_true, _bfd_generic_new_section_hook, _bfd_generic_get_section_contents, _bfd_generic_get_section_contents_in_window,
  bfd_plugin_bfd_copy_private_bfd_data, ((bfd_boolean (*) (bfd *, struct bfd_link_info *)) bfd_true), _bfd_generic_init_private_section_data, bfd_plugin_bfd_copy_private_section_data, bfd_plugin_bfd_copy_private_symbol_data, ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), bfd_plugin_bfd_print_private_bfd_data,
  ...
  bfd_plugin_get_symtab_upper_bound, bfd_plugin_canonicalize_symtab, bfd_plugin_make_empty_symbol, bfd_plugin_print_symbol, bfd_plugin_get_symbol_info, ((const char *(*) (bfd *, asymbol *, bfd_boolean *)) bfd_nullvoidptr), ((bfd_boolean (*) (bfd *, const char *)) bfd_false), ((bfd_boolean (*) (bfd *, asymbol *)) bfd_false), ((alent *(*) (bfd *, asymbol *)) bfd_nullvoidptr), ((bfd_boolean (*) (bfd *, asymbol **, asection *, bfd_vma, const char **, const char **, unsigned int *, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, asymbol **, asymbol *, const char **, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, const char **, const char **, unsigned int *)) bfd_false), ((asymbol *(*) (bfd *, void *, unsigned long)) bfd_nullvoidptr), _bfd_generic_read_minisymbols, _bfd_generic_minisymbol_to_symbol,
