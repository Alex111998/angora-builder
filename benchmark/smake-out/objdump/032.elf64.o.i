# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf64.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf64.c"
# 1 "./elfcode.h" 1
# 68 "./elfcode.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
        ...
        bfd_boolean dynamic)
{
  ...
  do { if (!(entsize == sizeof (Elf64_External_Rel) || entsize == sizeof (Elf64_External_Rela))) bfd_assert("./elfcode.h",1414); } while (0);
...
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf64.c" 2
