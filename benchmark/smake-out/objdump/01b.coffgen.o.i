# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
# 39 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 40 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 41 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 42 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
...
# 43 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
# 1 "./libcoff.h" 1
# 26 "./libcoff.h"
...
# 44 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c" 2
...
coff_object_p (bfd *abfd)
{
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  bfd_release (abfd, filehdr);
# 353 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
    ...
    char *buf)
{
  ...
  if (sym->_n._n_n._n_zeroes != 0
  ...
  else
    {
      ...
      do { if (!(sym->_n._n_n._n_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",468); } while (0);
...
# 494 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
struct internal_reloc *
...
coff_count_linenumbers (bfd *abfd)
{
 ...
 total += s->lineno_count;
  ...
  for (s = abfd->sections; s != ((void*)0); s = s->next)
    do { if (!(s->lineno_count == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",605); } while (0);
      ...
      struct internal_syment *syment)
{
 ...
 {
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",686); } while (0);
...
# 701 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
bfd_boolean
...
# 720 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
  {
    asymbol **newsyms;
    unsigned int i;
    bfd_size_type amt;
 ...
 *newsyms++ = symbol_ptr_ptr[i];
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",769); } while (0);
...
coff_mangle_symbols (bfd *bfd_ptr)
{
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",814); } while (0);
   if (s->fix_value)
     {
  ...
  coff_section_from_bfd_index (bfd_ptr, ((int)-2));
       do { if (!(coff_symbol_ptr->symbol.flags & (1 << 2))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",833); } while (0);
     }
   for (i = 0; i < s->u.syment.n_numaux; i++)
     {
       combined_entry_type *a = s + i + 1;

       do { if (!(! a->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",839); } while (0);
       if (a->fix_tag)
  {
        ...
        bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",883); } while (0);
      ...
      if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings))
 {
   ...
   *string_size_p += 6;
   ...
   strncpy (native->u.syment._n._n_name, ".file", 8);
      ...
      do { if (!(! (native + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",899); } while (0);
      ...
      else
 {
   ...
   if (!bfd_set_section_contents (abfd,
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c", 965, __PRETTY_FUNCTION__);
   if (bfd_seek (abfd, filepos, 0) != 0)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c", 967, __PRETTY_FUNCTION__);
   native->u.syment._n._n_n._n_offset =
...
# 984 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
static bfd_boolean
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1002); } while (0);
 ...
 {
   do { if (!(! (native + j + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1044); } while (0);
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1184); } while (0);
   ...
   if (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_classify_symbol != ((void*)0))
     {
       ...
       do { if (!(c_symbol->native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1295); } while (0);
...
# 1309 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
       if (symbol->flags & (1 << 7))
    ...
    i++, p++)
 {
   ...
   size_t maxlen;
# 1382 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
   if (c_symbol == ((void*)0)
 ...
 return 0;
  ...
  do { if (!(debug_string_size == 0 || (debug_string_section != (asection *) ((void*)0) && (((((bfd_vma) (debug_string_size) + (1 << debug_string_section->alignment_power) - 1) >= (bfd_vma) (debug_string_size)) ? (((bfd_vma) (debug_string_size) + ((1 << debug_string_section->alignment_power) - 1)) & ~ (bfd_vma) ((1 << debug_string_section->alignment_power)-1)) : ~ (bfd_vma) 0) == debug_string_section->size)))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1445); } while (0);
       ...
       combined_entry_type *auxent)
{
  ...
  do { if (!(symbol->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1529); } while (0);
 ...
 return;
  ...
  do { if (!(! auxent->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1543); } while (0);
...
coff_get_normalized_symtab (bfd *abfd)
{
    ...
    i++)
 {
  ...
  for (internal_ptr = internal; internal_ptr < internal_end;
       internal_ptr++)
    {
      do { if (!(internal_ptr->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1857); } while (0);
   ...
   && internal_ptr->u.syment.n_numaux > 0)
 {
   ...
   do { if (!(! aux->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1866); } while (0);
      ...
      else
 {
  ...
  debug_sec_data = build_debug_section (abfd, & debug_sec);
       if (debug_sec_data != ((void*)0))
  {
    do { if (!(debug_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1954); } while (0);
  ...
  do { if (!((((abfd)->tdata.coff_obj_data)->raw_syment_count) == (unsigned int) (internal_ptr - internal))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",1972); } while (0);
     ...
     bfd_print_symbol_type how)
{
      ...
      if (((coff_symbol_type *)(&((symbol)->the_bfd)))->native)
 {
   ...
   do { if (!(combined->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",2086); } while (0);
   ...
   for (aux = 0; aux < combined->u.syment.n_numaux; aux++)
     {
       ...
       do { if (!(! auxp->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",2106); } while (0);
       if (auxp->fix_tag)
                                   ...
                                   const struct dwarf_debug_section *debug_sections)
{
  ...
  *line_ptr = 0;
  ...
  while (p < pend)
    {
      do { if (!(p->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",2296); } while (0);
      ...
      while (1)
 {
   ...
   for (p2 = p + 1 + p->u.syment.n_numaux;
     ...
     {
       do { if (!(p2->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",2320); } while (0);
      ...
      for (; i < section->lineno_count; i++)
 {
       ...
       if (coff->native)
  {
    ...
    do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c",2399); } while (0);
...
# 2621 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
...
# 2988 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
 }
    }
...
{
  bfd *sub;
# 3041 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/coffgen.c"
