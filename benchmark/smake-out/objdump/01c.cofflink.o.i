# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 28 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
# 1 "./libcoff.h" 1
# 27 "./libcoff.h"
# 1 "./coff-bfd.h" 1
# 27 "./coff-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
struct bfd_hash_entry *
         ...
         struct bfd_link_info *info)
{
  ...
  do { if (!(symesz == (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_auxesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",265); } while (0);
      ...
      if (classification != COFF_SYMBOL_LOCAL)
 {
   ...
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 304, __PRETTY_FUNCTION__);
...
# 377 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
   if ((((abfd)->tdata.coff_obj_data)->pe)
  ...
  goto error_return;
   ...
   if (classification == COFF_SYMBOL_PE_SECTION
       && (*sym_hash)->numaux != 0)
     {
       ...
       do { if (!((*sym_hash)->numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",496); } while (0);
       if (section->size == 0)
        ...
        struct bfd_link_info *info)
{
      ...
      else
 {
   ...
   line_filepos += o->lineno_count * linesz;
      ...
      if (o->reloc_count != 0)
 {
# 752 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
   do { if (!(((info)->type == type_relocatable))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",752); } while (0);
   amt = o->reloc_count;
      ...
      for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
 {
       ...
       if (string_size)
  {
    ...
    if (isym.n_sclass != 103)
      ...
      {
        do { if (!(isym.n_numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",943); } while (0);
   ...
   for (; irel < irelend; irel++, rel_hash++, erel += relsz)
     {
       if (*rel_hash != ((void*)0))
  {
    do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",1094); } while (0);
  ...
  for (a = input_bfd->sections; a != (asection *) ((void*)0); a = a->next)
    {
      ...
      if ((a->flags & 0x004) == 0 || a->reloc_count < 1
   || a->linker_mark == 0)
 continue;
...
_bfd_coff_link_input_bfd (struct coff_final_link_info *flaginfo, bfd *input_bfd)
{
  ...
  do { if (!(linesz == (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_linesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",1443); } while (0);
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 1501, __PRETTY_FUNCTION__);
 case COFF_SYMBOL_GLOBAL:
 case COFF_SYMBOL_PE_SECTION:
      ...
      if (! skip)
 {
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 1539, __PRETTY_FUNCTION__);
     case COFF_SYMBOL_GLOBAL:
     case COFF_SYMBOL_COMMON:
     case COFF_SYMBOL_PE_SECTION:
      ...
      if (! skip)
 {
  ...
  if (! (((flaginfo->output_bfd)->tdata.coff_obj_data)->pe))
    isym.n_value += (*secpp)->output_section->vma;
     ...
     case 103:
# 1880 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
       if (flaginfo->last_file_index != -1
   ...
   if (*indexp < 0)
     {
       ...
       do { if (!(isymp->n_numaux == 0 || h->numaux == 0 || h->numaux == isymp->n_numaux)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",1997); } while (0);
       ...
       if (isymp->n_sclass == 103)
  {
    ...
    if (auxp->x_file.x_n.x_zeroes == 0
        && auxp->x_file.x_n.x_offset != 0)
      {
        ...
        do { if (!(auxp->x_file.x_n.x_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",2032); } while (0);
      ...
      for (o = input_bfd->sections; o != ((void*)0); o = o->next)
 {
   ...
   file_ptr pos;
   bfd_size_type amt;
# 2211 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
   if (o->lineno_count == 0
...
# 2264 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
 ...
 return 0;
      ...
      do { if (!(((((output_bfd)->tdata.coff_obj_data)->raw_syment_count) + (outsym - flaginfo->outsyms) / osymesz) == output_index)) bfd_assert("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c",2341); } while (0);
   ...
   || (o->size == 0 && (o->flags & 0x004) == 0))
 {
  ...
  (dgettext ("bfd", "%B: relocs in section `%A', but it has no contents"),
   input_bfd, o);
...
_bfd_coff_write_global_sym (struct bfd_hash_entry *bh, void *data)
{
 ...
 return 1;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 2594, __PRETTY_FUNCTION__);
      return 0;
       ...
       || h->root.type == bfd_link_hash_defweak))
 {
  ...
  _bfd_error_handler
    ...
    (dgettext ("bfd", "%s: %s: reloc overflow: 0x%lx > 0xffff"),
     ((char *) (output_bfd)->filename),
     ((void) output_bfd, (sec)->name),
     sec->reloc_count);
  ...
  _bfd_error_handler
    ...
    (dgettext ("bfd", "%s: warning: %s: line number overflow: 0x%lx > 0xffff"),
     ((char *) (output_bfd)->filename),
     ((void) output_bfd, (sec)->name),
     sec->lineno_count);
       ...
       struct bfd_link_order *link_order)
{
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 2839, __PRETTY_FUNCTION__);
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 2877, __PRETTY_FUNCTION__);
      *rel_hash_ptr = ((void*)0);
      irel->r_symndx = 0;
    }
  else
        ...
        asection **sections)
{
        ...
        || (unsigned long) symndx >= (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
 {
   _bfd_error_handler
     ...
     (dgettext ("bfd", "%B: illegal symbol index %ld in relocs"), input_bfd, symndx);
   return 0;
 }
      else
 {
      ...
      else
 {
  ...
  {
# 3050 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c"
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/cofflink.c", 3120, __PRETTY_FUNCTION__);
 case bfd_reloc_ok:
   break;
 case bfd_reloc_outofrange:
   _bfd_error_handler

     (dgettext ("bfd", "%B: bad reloc address 0x%lx in section `%A'"),
