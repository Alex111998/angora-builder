# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c" 2
...
bfd_elf_set_obj_attr_contents (bfd *abfd, bfd_byte *contents, bfd_vma size)
{
 ...
 vendor_set_obj_attr_contents (abfd, p, vendor_size, vendor);
  ...
  if (size != my_size)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c", 225, __PRETTY_FUNCTION__);
}
    ...
    list = list->next)
 {
   ...
   switch (in_attr->type & ((1 << 0) | (1 << 1)))
     ...
     case (1 << 0) | (1 << 1):
       ...
       break;
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c", 389, __PRETTY_FUNCTION__);
     }
 }
    }
}
...
_bfd_elf_obj_attrs_arg_type (bfd *abfd, int vendor, unsigned int tag)
{
  switch (vendor)
    ...
    case 1:
      ...
      break;
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c", 424, __PRETTY_FUNCTION__);
    }
}
      ...
      while (len > 0 && p < p_end - 4)
 {
  ...
  case Tag_File:
   ...
   case (1 << 0):
     ...
     break;
   default:
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c", 543, __PRETTY_FUNCTION__);
   }
      }
    break;
  case Tag_Section:
...
# 573 "/benchmark/RUNDIR-binutils-2.28/binutils-2.28/bfd/elf-attrs.c"
bfd_boolean
