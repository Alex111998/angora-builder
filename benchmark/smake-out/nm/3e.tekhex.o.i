# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c" 2
# 69 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 70 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 71 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 72 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c" 2
...
# 73 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c" 2
...
# 203 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c"
static void
tekhex_init (void)
{
  unsigned int i;
...
# 238 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c"
...
first_phase (bfd *abfd, int type, char *src, char * src_end)
{
      ...
      while (src < src_end && *src)
 {
  ...
  return 0;
       section->flags = 0x100 | 0x002 | 0x001;
       break;
     case '0':
     case '2':
     case '3':
         ...
         bfd_boolean get)
{
  ...
  do { if (!(offset == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c",638); } while (0);
...
out (bfd *abfd, int type, char *start, char *end)
{
  ...
  if (bfd_bwrite (front, (bfd_size_type) 6, abfd) != 6)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c", 792, __PRETTY_FUNCTION__);
  end[0] = '\n';
  wrlen = end - start + 1;
  if (bfd_bwrite (start, wrlen, abfd) != wrlen)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c", 796, __PRETTY_FUNCTION__);
}
...
tekhex_write_object_contents (bfd *abfd)
{
      ...
      for (p = abfd->outsymbols; *p; p++)
 {
  ...
  if (bfd_bwrite ("%0781010\n", (bfd_size_type) 9, abfd) != 9)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c", 901, __PRETTY_FUNCTION__);
  return 1;
}
...
# 994 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/tekhex.c"
const bfd_target tekhex_vec =
{
  ...
  _bfd_archive_close_and_cleanup, bfd_true, _bfd_generic_new_section_hook, tekhex_get_section_contents, _bfd_generic_get_section_contents_in_window,
