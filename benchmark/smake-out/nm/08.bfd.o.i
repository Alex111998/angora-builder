# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 367 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 368 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 370 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 1 "./bfdver.h" 1
# 371 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 372 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
cplus_demangle_print_callback (int options,
                               struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 373 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 374 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 375 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 376 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 377 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 378 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 1 "./libcoff.h" 1
# 27 "./libcoff.h"
# 1 "./coff-bfd.h" 1
# 27 "./coff-bfd.h"
...
# 379 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 1 "./libecoff.h" 1
# 25 "./libecoff.h"
...
# 380 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
...
# 382 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c" 2
# 448 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
...
# 489 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_error_type
bfd_get_error (void)
{
  return bfd_error;
}
# 509 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
  ...
  if (error_tag == bfd_error_on_input)
    {
      ...
      __builtin_va_start(ap, error_tag);
      input_bfd = __builtin_va_arg(ap, bfd *);
      input_error = (bfd_error_type) __builtin_va_arg(ap, int);
      if (input_error >= bfd_error_on_input)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 523, __PRETTY_FUNCTION__);
      __builtin_va_end(ap);
    }
}
# 540 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
const char *
...
# 583 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
...
# 612 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
static const char *_bfd_error_program_name;
# 626 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
static int
_doprnt (FILE *stream, const char *format, va_list ap)
{
      ...
      else
 {
   ...
   *sptr++ = *ptr++;
   ...
   if (*ptr == '*')
     {
       int value = abs (__builtin_va_arg(ap, int));
  ...
  case 'L':
    ...
    break;
  default:
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 700, __PRETTY_FUNCTION__);
  }
       *sptr++ = *ptr++;
     }
  ...
  if (short_width)
    do { int value = __builtin_va_arg(ap, int); result = fprintf (stream, specifier, value); } while (0);
  else
    {
   ...
   break;
        case 1:
   do { long value = __builtin_va_arg(ap, long); result = fprintf (stream, specifier, value); } while (0);
   break;
        case 2:
        default:
# 759 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
   do { long long value = __builtin_va_arg(ap, long long); result = fprintf (stream, specifier, value); } while (0);
   ...
   break;
     ...
     case 'G':
       {
  if (wide_width == 0)
    do { double value = __builtin_va_arg(ap, double); result = fprintf (stream, specifier, value); } while (0);
  else
    {

      do { long double value = __builtin_va_arg(ap, long double); result = fprintf (stream, specifier, value); } while (0);
       ...
       break;
     case 's':
       do { char * value = __builtin_va_arg(ap, char *); result = fprintf (stream, specifier, value); } while (0);
       break;
     case 'p':
       do { void * value = __builtin_va_arg(ap, void *); result = fprintf (stream, specifier, value); } while (0);
       break;
     case '%':
       fputc ('%', stream);
       result = 1;
     ...
     case 'A':
       {
  asection *sec = __builtin_va_arg(ap, asection *);
  bfd *abfd;
  ...
  if (sec == ((void*)0))
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 808, __PRETTY_FUNCTION__);
  abfd = sec->owner;
  if (abfd != ((void*)0)
  ...
  if (group != ((void*)0))
    ...
    result = fprintf (stream, "%s", sec->name);
     ...
     case 'B':
       {
  bfd *abfd = __builtin_va_arg(ap, bfd *);

  if (abfd == ((void*)0))


    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 833, __PRETTY_FUNCTION__);
    ...
    result = fprintf (stream, "%s", abfd->filename);
       ...
       break;
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 843, __PRETTY_FUNCTION__);
     }
 }
      if (result == -1)
 return -1;
...
# 909 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
...
# 933 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
bfd_set_error_program_name (const char *name)
{
  _bfd_error_program_name = name;
}
# 966 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
static void
...
# 994 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
...
# 1029 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
long
...
# 1062 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
long
...
# 1115 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_boolean
  ...
  if (fn != ((void*)0))
    _bfd_error_handler
      ...
      (dgettext ("bfd", "BFD %s internal error, aborting at %s:%d in %s\n"),
       "(GNU Binutils) " "2.29", file, line, fn);
  else
    _bfd_error_handler
...
# 1186 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
int
...
# 1216 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
int
...
# 1262 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_boolean
...
# 1282 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
unsigned int
...
# 1308 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
...
{
  if (! abfd)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 1347, __PRETTY_FUNCTION__);
  if (abfd->format != bfd_object)
    return;
...
# 1378 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_vma
...
# 1617 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_byte *
...
bfd_fprintf_vma (bfd *abfd __attribute__ ((__unused__)), void *stream, bfd_vma value)
{
  ...
  fprintf ((FILE *) stream, "%016" "l" "x", value);
}
# 1749 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_boolean
...
# 1801 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_vma
...
# 1845 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
...
# 1872 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_vma
bfd_emul_get_commonpagesize (const char *emul)
{
  ...
  if (target != ((void*)0)
      && target->flavour == bfd_target_elf_flavour)
    return ((const struct elf_backend_data *) (target)->backend_data)->commonpagesize;

  return 0;
}
# 1898 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
...
# 1925 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
char *
...
# 2018 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
void
          ...
          asection *sec)
{
      ...
      if (((abfd)->xvec->flavour) == bfd_target_elf_flavour)
 {
       ...
       else
  {
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c", 2068, __PRETTY_FUNCTION__);
}
# 2089 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_boolean
...
# 2138 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
int
...
# 2173 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_size_type
...
# 2224 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfd.c"
bfd_boolean
