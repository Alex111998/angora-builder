# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf64.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf64.c"
# 1 "./elfcode.h" 1
# 68 "./elfcode.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
        ...
        bfd_boolean dynamic)
{
  ...
  do { if (!(entsize == sizeof (Elf64_External_Rel) || entsize == sizeof (Elf64_External_Rela))) bfd_assert("./elfcode.h",1415); } while (0);
      ...
      else if (((rela.r_info) >> 32) > symcount)
 {
   _bfd_error_handler
     ...
     (dgettext ("bfd", "%B(%A): relocation %d has invalid symbol index %ld"),
      abfd, asect, i, (long) ((rela.r_info) >> 32));
   relent->sym_ptr_ptr = (&_bfd_std_section[2])->symbol_ptr_ptr;
 }
      else
 {
...
# 24 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf64.c" 2
