# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c" 2
# 45 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c"
# 1 "./coff-i386.c" 1
# 24 "./coff-i386.c"
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
# 996 "./coffcode.h"
  if (! ((isym.n_sclass == 3
   || isym.n_sclass == 2)
         && ((isym.n_type) & 0xf) == 0
         && isym.n_value == 0))
    _bfd_abort ("./coffcode.h", 1000, __PRETTY_FUNCTION__);
...
# 1084 "./coffcode.h"
  ...
  if (newname == ((void*)0))
    _bfd_abort ("./coffcode.h", 1141, __PRETTY_FUNCTION__);
    ...
    void * scnhdr)
{
 ...
 _bfd_abort ("./coffcode.h", 1912, __PRETTY_FUNCTION__);
    }
 ...
 _bfd_abort ("./coffcode.h", 1921, __PRETTY_FUNCTION__);
    }
...
{
  do { if (!(symbol->is_sym)) bfd_assert("./coffcode.h",2591); } while (0);
  do { if (!(! aux->is_sym)) bfd_assert("./coffcode.h",2592); } while (0);
# 2629 "./coffcode.h"
  return 0;
}
# 2665 "./coffcode.h"
...
{
  _bfd_abort ("./coffcode.h", 5455, __PRETTY_FUNCTION__);
  return 0;
}
# 5467 "./coffcode.h"
static void
...
{
  _bfd_abort ("./coffcode.h", 5476, __PRETTY_FUNCTION__);
}
# 5529 "./coffcode.h"
static bfd_boolean
...
# 46 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/pei-i386.c" 2
