# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 28 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
file_ptr
...
{
# 120 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
...
# 176 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
bfd_size_type
bfd_bread (void *ptr, bfd_size_type size, bfd *abfd)
{
  ...
  if (abfd->arelt_data != ((void*)0))
    {
      bfd_size_type maxbytes = (((struct areltdata *)((abfd)->arelt_data))->parsed_size);
  ...
  if (abfd->iovec)
    {
      ...
      while (parent_bfd->my_archive != ((void*)0)
      && !((parent_bfd->my_archive)->is_thin_archive))
 {
...
bfd_seek (bfd *abfd, file_ptr position, int direction)
{
  ...
  do { if (!(direction == 0 || direction == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c",288); } while (0);

  if (direction == 1 && position == 0)
    return 0;

  if (abfd->my_archive == ((void*)0) || ((abfd->my_archive)->is_thin_archive))
    {
      if (direction == 0 && (bfd_vma) position == abfd->where)
 return 0;
    }
  else
    {
# 311 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
    }
  ...
  if (result != 0)
    {
      int hold_errno = (*__errno_location ());
...
# 372 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
long
...
# 423 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
ufile_ptr
...
# 451 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
ufile_ptr
...
# 477 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/bfdio.c"
void *
