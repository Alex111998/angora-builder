# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 29 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c" 2
...
_bfd_elf_get_property (bfd *abfd, unsigned int type, unsigned int datasz)
{
  ...
  if (((abfd)->xvec->flavour) != bfd_target_elf_flavour)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c", 41, __PRETTY_FUNCTION__);
    }
 ...
 break;
  ...
  if (p == ((void*)0))
    {
      _bfd_error_handler (dgettext ("bfd", "%B: out of memory in _bfd_elf_get_property"),
     abfd);
      _exit (1);
    }
  memset (p, 0, sizeof (*p));
...
bad_size:
      _bfd_error_handler
 (dgettext ("bfd", "warning: %B: corrupt GNU_PROPERTY_TYPE (%ld) size: %#lx"),
  ...
  while (1)
    {
      unsigned int type = ((*((abfd)->xvec->bfd_h_getx32)) (ptr));
      unsigned int datasz = ((*((abfd)->xvec->bfd_h_getx32)) (ptr + 4));
      elf_property *prop;
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "warning: %B: corrupt GNU_PROPERTY_TYPE (%ld) type (0x%x) datasz: 0x%x"),
      ...
      else
 {
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "warning: %B: corrupt stack size: 0x%x"),
       abfd, datasz);
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "warning: %B: corrupt no copy on protected size: 0x%x"),
       abfd, datasz);
    ...
    return 0;
     ...
     default:
      ...
      _bfd_error_handler
 (dgettext ("bfd", "warning: %B: unsupported GNU_PROPERTY_TYPE (%ld) type: 0x%x"),
  abfd, note->type, type);
      ...
      if (aprop != ((void*)0) && bprop != ((void*)0))
 {
   ...
   break;
    ...
    default:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c", 232, __PRETTY_FUNCTION__);
    }
        ...
        elf_property_list **listp)
{
 ...
 if (pr->pr_kind != property_unknown)
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c", 297, __PRETTY_FUNCTION__);
...
_bfd_elf_link_setup_gnu_properties (struct bfd_link_info *info)
{
    ...
    list = list->next)
 {
  ...
  default:
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c", 463, __PRETTY_FUNCTION__);
  ...
  case 8:
    ...
    break;
     ...
     default:
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-properties.c", 482, __PRETTY_FUNCTION__);
     }
