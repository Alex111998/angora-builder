# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 29 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 30 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c" 2
   ...
   void **psecinfo)
{
  ...
  if ((abfd->flags & 0x40) != 0
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c", 370, __PRETTY_FUNCTION__);
...
_bfd_write_merged_section (bfd *output_bfd, asection *sec, void *psecinfo)
{
  ...
  if (hdr->sh_offset == (file_ptr) -1)
   ...
   || contents == ((void*)0))
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c", 824, __PRETTY_FUNCTION__);
    }
  else
    {
      contents = ((void*)0);
       ...
       void *psecinfo, bfd_vma offset)
{
 ...
 _bfd_error_handler
   ...
   (dgettext ("bfd", "%B: access beyond end of merged section (%ld)"),
      ...
      else
 {
  ...
  if (!entry)
    {
      if (! secinfo->htab->strings)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c", 904, __PRETTY_FUNCTION__);


      if (*p)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c", 908, __PRETTY_FUNCTION__);
      if (! secinfo->htab->first)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/merge.c", 910, __PRETTY_FUNCTION__);
