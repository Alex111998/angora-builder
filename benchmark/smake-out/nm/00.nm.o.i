# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 174 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 1 "./../include/progress.h" 1
# 24 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 25 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
cplus_demangle_print_callback (int options,
                               struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 28 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 1 "../bfd/libcoff.h" 1
# 27 "../bfd/libcoff.h"
# 1 "../bfd/coff-bfd.h" 1
# 27 "../bfd/coff-bfd.h"
...
# 38 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 39 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
# 1 "../bfd/plugin.h" 1
# 24 "../bfd/plugin.h"
...
plugin_data_struct;
# 41 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c" 2
...
# 80 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
...
# 143 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
static struct output_fns *format = &formats[0];



static int do_demangle = 0;
static int external_only = 0;
static int defined_only = 0;
static int no_sort = 0;
static int print_debug_syms = 0;
static int print_armap = 0;
static int print_size = 0;
static int reverse_sort = 0;
static int sort_numerically = 0;
static int sort_by_size = 0;
static int undefined_only = 0;
static int dynamic = 0;
static int show_version = 0;
static int show_stats = 0;
static int show_synthetic = 0;
static int line_numbers = 0;
static int allow_special_symbols = 0;
static int with_symbol_versions = 0;


static int filename_per_file = 0;
static int filename_per_symbol = 0;
...
static struct option long_options[] =
{
  ...
  {"help", 0, 0, 'h'},
  {"line-numbers", 0, 0, 'l'},
  {"no-cplus", 0, &do_demangle, 0},
  {"no-demangle", 0, &do_demangle, 0},
  {"no-sort", 0, 0, 'p'},
  {"numeric-sort", 0, 0, 'n'},
  {"plugin", 1, 0, (200 + 1)},
  {"portability", 0, 0, 'P'},
  {"print-armap", 0, &print_armap, 1},
  {"print-file-name", 0, 0, 'o'},
  {"print-size", 0, 0, 'S'},
  {"radix", 1, 0, 't'},
  {"reverse-sort", 0, &reverse_sort, 1},
  {"size-sort", 0, 0, ((200 + 1) + 1)},
  {"special-syms", 0, &allow_special_symbols, 1},
  {"stats", 0, &show_stats, 1},
  {"synthetic", 0, &show_synthetic, 1},
  {"target", 1, 0, 200},
  {"defined-only", 0, &defined_only, 1},
  {"undefined-only", 0, &undefined_only, 1},
  {"version", 0, &show_version, 1},
  {"with-symbol-versions", 0, &with_symbol_versions, 1},
  {0, 0, 0, 0}
};
...
usage (FILE *stream, int status)
{
  ...
  fprintf (stream, gettext (" List symbols in [file(s)] (a.out by default).\n"));
...
# 264 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
  fprintf (stream, gettext ("      --plugin NAME      Load the specified plugin\n"));


  fprintf (stream, gettext ("  -S, --print-size       Print size of defined symbols\n  -s, --print-armap      Include index for symbols from archive members\n      --size-sort        Sort symbols by size\n      --special-syms     Include special symbols in the output\n      --synthetic        Display synthetic symbols as well\n  -t, --radix=RADIX      Use RADIX for printing symbol values\n      --target=BFDNAME   Specify the target object format as BFDNAME\n  -u, --undefined-only   Display only undefined symbols\n      --with-symbol-versions  Display version strings after symbol names\n  -X 32_64               (ignored)\n  @FILE                  Read options from FILE\n  -h, --help             Display this information\n  -V, --version          Display this program's version number\n\n"));
# 282 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
...
set_print_radix (char *radix)
{
 ...
 print_radix = 8;
      ...
      break;
    default:
      fatal (gettext ("%s: invalid radix"), radix);
    }
}
...
set_output_format (char *f)
{
  ...
  switch (*f)
    ...
    case 'S':
      ...
      break;
    default:
      fatal (gettext ("%s: invalid output format"), f);
    }
  format = &formats[i];
}
...
get_elf_symbol_type (unsigned int type)
{
  ...
  free (bufp);
  if (type >= 13 && type <= 15)
    n = asprintf (&bufp, gettext ("<processor specific>: %d"), type);
  else if (type >= 10 && type <= 12)
    n = asprintf (&bufp, gettext ("<OS specific>: %d"), type);
  else
    n = asprintf (&bufp, gettext ("<unknown>: %d"), type);
  if (n < 0)
    fatal ("%s", xstrerror ((*__errno_location ())));
  return bufp;
}
...
get_coff_symbol_type (const struct internal_syment *sym)
{
  ...
  free (bufp);
  n = asprintf (&bufp, gettext ("<unknown>: %d/%d"), sym->n_sclass, sym->n_type);
  if (n < 0)
    fatal ("%s", xstrerror ((*__errno_location ())));
  return bufp;
}
...
print_symname (const char *form, const char *name, bfd *abfd)
{
  if (do_demangle && *name)
    {
      char *res = bfd_demangle (abfd, name, (1 << 1) | (1 << 0));
...
{
  symindex idx = ((symindex) ~0);
  carsym *thesym;
  bfd_boolean everprinted = 0;
      ...
      if (!everprinted)
 {
   ...
   everprinted = 1;
      ...
      elt = ((*((abfd)->xvec->_bfd_get_elt_at_index)) (abfd,idx));
      if (elt == ((void*)0))
  ...
  long symcount, unsigned int size)
{
  ...
  store = ((*((abfd)->xvec->_bfd_make_empty_symbol)) (abfd));
  if (store == ((void*)0))
  ...
  for (; from < fromend; from += size)
    {
      ...
      sym = ((*((abfd)->xvec->_minisymbol_to_symbol)) (abfd, is_dynamic, (const void *) from, store));
      if (sym == ((void*)0))
 bfd_fatal (((char *) (abfd)->filename));

      if (strcmp (sym->name, "__gnu_lto_slim") == 0)
 non_fatal (gettext ("%s: plugin needed to handle lto object"),
     ((char *) (abfd)->filename));

      if (undefined_only)
 keep = ((sym->section) == (&_bfd_std_section[1]));
   ...
   && defined_only)
 {
   if (((sym->section) == (&_bfd_std_section[1])))
     keep = 0;
      ...
      if (keep
   && ((*((abfd)->xvec->_bfd_is_target_special_symbol)) (abfd, sym))
...
# 547 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
static int
non_numeric_forward (const void *P_x, const void *P_y)
{
  ...
  x = ((*((sort_bfd)->xvec->_minisymbol_to_symbol)) (sort_bfd, sort_dynamic, P_x, sort_x));
  y = ((*((sort_bfd)->xvec->_minisymbol_to_symbol)) (sort_bfd, sort_dynamic, P_y, sort_y));
  if (x == ((void*)0) || y == ((void*)0))
    bfd_fatal (((char *) (sort_bfd)->filename));
...
numeric_forward (const void *P_x, const void *P_y)
{
  ...
  if (((xs) == (&_bfd_std_section[1])))
    {
      if (! ((ys) == (&_bfd_std_section[1])))
 return -1;
    }
  else if (((ys) == (&_bfd_std_section[1])))
    return 1;
  else if (((x)->section->vma + (x)->value) != ((y)->section->vma + (y)->value))
    return ((x)->section->vma + (x)->value) < ((y)->section->vma + (y)->value) ? -1 : 1;
...
# 636 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
static int
size_forward1 (const void *P_x, const void *P_y)
{
  ...
  if (((x)->section->vma + (x)->value) != ((y)->section->vma + (y)->value))
    return ((x)->section->vma + (x)->value) < ((y)->section->vma + (y)->value) ? -1 : 1;
  ...
  xf = (strstr (xn, "gnu_compiled") != ((void*)0)
 || strstr (xn, "gcc2_compiled") != ((void*)0));
  yf = (strstr (yn, "gnu_compiled") != ((void*)0)
 || strstr (yn, "gcc2_compiled") != ((void*)0));

  if (xf && ! yf)
    return -1;
  if (! xf && yf)
    return 1;
# 693 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
  xf = (((x)->flags & (1 << 14)) != 0 || ((xnl) > 2 && (xn)[(xnl) - 2] == '.' && ((xn)[(xnl) - 1] == 'o' || (xn)[(xnl) - 1] == 'a')));
  yf = (((y)->flags & (1 << 14)) != 0 || ((ynl) > 2 && (yn)[(ynl) - 2] == '.' && ((yn)[(ynl) - 1] == 'o' || (yn)[(ynl) - 1] == 'a')));
        ...
        struct size_sym **symsizesp)
{
  ...
  *symsizesp = symsizes;
  ...
  if (from < fromend)
    {
      sym = ((*((abfd)->xvec->_minisymbol_to_symbol)) (abfd, is_dynamic, (const void *) from, store_sym));
  ...
  for (; from < fromend; from += size)
    {
      ...
      bfd_vma sz;
      asymbol *temp;
      int synthetic = (sym->flags & (1 << 21));

      if (from + size < fromend)
 {
   next = ((*((abfd)->xvec->_minisymbol_to_symbol)) (abfd, is_dynamic, (const void *) (from + size), store_next));
 ...
 next = ((void*)0);
      ...
      if (!synthetic && ((abfd)->xvec->flavour) == bfd_target_elf_flavour)
 sz = ((elf_symbol_type *) sym)->internal_elf_sym.st_size;
      else if (!synthetic && (((sec)->flags & 0x1000) != 0))
 sz = sym->value;
      else
 {
   if (from + size < fromend
       && sec == ((next)->section))
     sz = ((next)->section->vma + (next)->value) - ((sym)->section->vma + (sym)->value);
   else
     sz = (((void) abfd, (sec)->vma)
    + ((sec)->size)
    - ((sym)->section->vma + (sym)->value));
 }
       ...
       bfd * archive_bfd)
{
  ...
  ((*((abfd)->xvec->_bfd_get_symbol_info)) (abfd,sym,&syminfo));
  ...
  if ((sym->flags & (1 << 21)) != 0)
    {
      info.elfinfo = ((void*)0);
      info.coffinfo = ((void*)0);
    }
  else
    {
      info.elfinfo = (((sym)->the_bfd->xvec->flavour == bfd_target_elf_flavour && (sym)->the_bfd->tdata.elf_obj_data != 0) ? (elf_symbol_type *) (sym) : 0);
      info.coffinfo = (((((((sym)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((sym)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((sym)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (sym) : ((void*)0));
    }
  ...
  if (line_numbers)
    {
      ...
      if (abfd != lineno_cache_bfd && syms != ((void*)0))
 {
   free (syms);
   syms = ((void*)0);
 }
      if (syms == ((void*)0))
 {
   ...
   symcount = ((*((abfd)->xvec->_bfd_canonicalize_symtab)) (abfd, syms));
   if (symcount < 0)
     bfd_fatal (((char *) (abfd)->filename));
      ...
      if (((((sym)->section)) == (&_bfd_std_section[1])))
 {
   ...
   if (abfd != lineno_cache_rel_bfd && relocs != ((void*)0))
     {
       ...
       for (j = 0; j < relcount[i]; j++)
  {
    ...
    r = relocs[i][j];
    if (r->sym_ptr_ptr != ((void*)0)
        && (*r->sym_ptr_ptr)->section == sym->section
        && (*r->sym_ptr_ptr)->value == sym->value
        && strcmp (symname,
     ((*r->sym_ptr_ptr)->name)) == 0
        && ((*((abfd)->xvec->_bfd_find_nearest_line)) (abfd, syms, secs[i], r->address, &filename, &functionname, &lineno, ((void*)0)))
      ...
      else if (((sym)->section)->owner == abfd)
 {
   if ((((*((abfd)->xvec->_bfd_find_line)) (abfd, syms, sym, &filename, &lineno))
        || ((*((abfd)->xvec->_bfd_find_nearest_line)) (abfd, syms, ((sym)->section), sym->value, &filename, &functionname, &lineno, ((void*)0))))
  ...
  for (; from < fromend; from++)
    {
      ...
      sym = ((*((abfd)->xvec->_minisymbol_to_symbol)) (abfd, is_dynamic, from->minisym, store));
      if (sym == ((void*)0))
 bfd_fatal (((char *) (abfd)->filename));
...
# 1059 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
static void
  ...
  for (; from < fromend; from += size)
    {
      ...
      sym = ((*((abfd)->xvec->_minisymbol_to_symbol)) (abfd, is_dynamic, from, store));
      if (sym == ((void*)0))
 bfd_fatal (((char *) (abfd)->filename));
...
display_rel_file (bfd *abfd, bfd *archive_bfd)
{
  ...
  if (! dynamic)
    {
      if (!(((abfd)->flags) & 0x10))
 {
   non_fatal (gettext ("%s: no symbols"), ((char *) (abfd)->filename));
   return;
 }
    }
 ...
 {
   long storage = ((*((abfd)->xvec->_bfd_get_dynamic_symtab_upper_bound)) (abfd));
   ...
   if (storage > 0)
     {
       ...
       dyn_count = ((*((abfd)->xvec->_bfd_canonicalize_dynamic_symtab)) (abfd, dyn_syms));
       if (dyn_count < 0)
  bfd_fatal (((char *) (abfd)->filename));
     }
 }

      synth_count = ((*((abfd)->xvec->_bfd_get_synthetic_symtab)) (abfd, static_count, static_syms, dyn_count, dyn_syms, &synthsyms));
  ...
  if (! no_sort)
    {
      ...
      sort_x = ((*((abfd)->xvec->_bfd_make_empty_symbol)) (abfd));
      sort_y = ((*((abfd)->xvec->_bfd_make_empty_symbol)) (abfd));
  ...
  if (print_width == -1)
    {
      ...
      if (strstr (((file)->xvec->name), "64") != ((void*)0)
   || strcmp (((file)->xvec->name), "mmo") == 0)
 print_width = 64;
      else
 print_width = 32;
    }
...
display_archive (bfd *file)
{
  ...
  format->print_archive_filename (((char *) (file)->filename));
      ...
      if (bfd_check_format_matches (arfile, bfd_object, &matching))
 {
   ...
   format->print_archive_member (((char *) (file)->filename),
     ((char *) (arfile)->filename));
   display_rel_file (arfile, file);
 }
      else
 {
   bfd_nonfatal (((char *) (arfile)->filename));
...
# 1350 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
static void
...
print_object_filename_sysv (char *filename)
{
  if (undefined_only)
    ...
    printf (gettext ("\n\nSymbols from %s:\n\n"), filename);
  if (print_width == 32)
    printf (gettext ("Name                  Value   Class        Type         Size     Line  Section\n\n"));
...
static void
print_archive_filename_sysv (char *filename __attribute__ ((__unused__)))
{
}

static void
print_archive_filename_posix (char *filename __attribute__ ((__unused__)))
{
}
...
static void
print_archive_member_bsd (char *archive __attribute__ ((__unused__)),
     const char *filename)
{
...
print_symbol_filename_bsd (bfd *archive_bfd, bfd *abfd)
{
  if (filename_per_symbol)
    {
      if (archive_bfd)
 printf ("%s:", ((char *) (archive_bfd)->filename));
      printf ("%s:", ((char *) (abfd)->filename));
    }
}
...
print_symbol_filename_posix (bfd *archive_bfd, bfd *abfd)
{
  if (filename_per_symbol)
    {
      if (archive_bfd)
 printf ("%s[%s]: ", ((char *) (archive_bfd)->filename),
  ((char *) (abfd)->filename));
      else
 printf ("%s: ", ((char *) (abfd)->filename));
    }
...
static void
print_value (bfd *abfd __attribute__ ((__unused__)), bfd_vma val)
{
  switch (print_width)
    {
    case 32:
...
# 1503 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/binutils/nm.c"
      break;

    default:
      fatal (gettext ("Print width has not been initialized (%d)"), print_width);
      break;
    }
}
...
print_symbol_info_bsd (struct extended_symbol_info *info, bfd *abfd)
{
 ...
 print_value (abfd, (info->elfinfo ? info->elfinfo->internal_elf_sym.st_size: info->ssize));
      else
 print_value (abfd, (info->sinfo->value));
      if (print_size && (info->elfinfo ? info->elfinfo->internal_elf_sym.st_size: info->ssize))
 {
   printf (" ");
   print_value (abfd, (info->elfinfo ? info->elfinfo->internal_elf_sym.st_size: info->ssize));
 }
...
print_symbol_info_sysv (struct extended_symbol_info *info, bfd *abfd)
{
 ...
 printf ("                ");
  ...
  if ((info->sinfo->type) == '-')
  ...
  else
    {
      ...
      if (info->elfinfo)
 printf ("%18s|",
  get_elf_symbol_type (((info->elfinfo->internal_elf_sym.st_info) & 0xF)));
 ...
 printf ("                  |");
      ...
      if ((info->elfinfo ? info->elfinfo->internal_elf_sym.st_size: info->ssize))
 print_value (abfd, (info->elfinfo ? info->elfinfo->internal_elf_sym.st_size: info->ssize));
      else
 {
   if (print_width == 32)
...
main (int argc, char **argv)
{
 ...
 case 'X':
   ...
   if (strcmp (optarg, "32_64") != 0)
     fatal (gettext ("Only -X 32_64 is supported"));
   break;
 ...
 default:
  ...
  if (sort_by_size && undefined_only)
    {
      non_fatal (gettext ("Using the --size-sort and --undefined-only options together"));
      non_fatal (gettext ("will produce no output, since undefined symbols have no size."));
      return 0;
    }
  ...
  if (show_stats)
    {
      ...
      non_fatal (gettext ("data size %ld"), (long) (lim - (char *) &environ));
    }
