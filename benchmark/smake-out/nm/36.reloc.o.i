# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c" 2
# 49 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 50 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 51 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c" 2
...
# 52 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 53 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c" 2
# 429 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
unsigned int
bfd_get_reloc_size (reloc_howto_type *howto)
{
  switch (howto->size)
    ...
    case -1: return 2;
    case -2: return 4;
    default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 442, __PRETTY_FUNCTION__);
    }
}
# 487 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_reloc_status_type
      ...
      bfd_vma relocation)
{
 ...
 flag = bfd_reloc_overflow;
    ...
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 535, __PRETTY_FUNCTION__);
    }
...
# 588 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (howto->pc_relative)
    {
# 699 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
      relocation -=
      ...
      else
 {
   ...
   if (abfd->xvec->flavour == bfd_target_coff_flavour
     ...
     {
# 801 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
       relocation -= reloc_entry->addend;
...
# 818 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont
    ...
    flag = bfd_check_overflow (howto->complain_on_overflow,
          ...
          relocation);
# 853 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 894 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  switch (howto->size)
    {
    case 0:
      {
...
# 980 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (howto->pc_relative)
    {
# 1086 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
      relocation -=
 input_section->output_section->vma + input_section->output_offset;
 ...
 relocation -= reloc_entry->address;
  ...
  if (! howto->partial_inplace)
   ...
   && strcmp (abfd->xvec->name, "coff-Intel-big") != 0)
 {
# 1185 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
   relocation -= reloc_entry->addend;
...
# 1203 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont)
    flag = bfd_check_overflow (howto->complain_on_overflow,
          howto->bitsize,
          howto->rightshift,
          bfd_arch_bits_per_address (abfd),
          relocation);
# 1237 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 1278 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
...
# 1353 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_reloc_status_type
...
# 1385 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
  if (howto->pc_relative)
    {
   ...
   bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 1422, __PRETTY_FUNCTION__);
    case 0:
      return bfd_reloc_ok;
    case 1:
 ...
 case complain_overflow_bitfield:
   ...
   sum = a + b;
# 1512 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
   if (((~(a ^ b)) & (a ^ sum)) & signmask & addrmask)
     flag = bfd_reloc_overflow;
   break;

 case complain_overflow_unsigned:
# 1528 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
   sum = (a + b) & addrmask;
   if ((a | b | sum) & signmask)
     flag = bfd_reloc_overflow;
   break;
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 1534, __PRETTY_FUNCTION__);
 }
    }
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 1550, __PRETTY_FUNCTION__);
    case 1:
       ...
       bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 1591, __PRETTY_FUNCTION__);
    case 0:
      return;
    case 1:
      x = (*(const unsigned char *) (location) & 0xff);
  ...
  switch (size)
    ...
    default:
    case 0:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c", 1627, __PRETTY_FUNCTION__);
    case 1:
      ((void) (*((unsigned char *) (location)) = (x) & 0xff));
      break;
    case 2:
...
# 7917 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
reloc_howto_type *
...
# 7945 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
reloc_howto_type *
bfd_default_reloc_type_lookup (bfd *abfd, bfd_reloc_code_real_type code)
{
 ...
 {
 case 64:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c",7956); } while (0);
   break;
 case 32:
   return &bfd_howto_32;
 case 16:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c",7961); } while (0);
   break;
 default:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c",7964); } while (0);
 }
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c",7968); } while (0);
    }
  return ((void*)0);
}
# 7985 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
const char *
...
# 8009 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_boolean
...
# 8036 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_boolean
...
# 8057 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_boolean
...
# 8083 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_boolean
...
# 8109 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
bfd_byte *
         ...
         asymbol **symbols)
{
      ...
      for (parent = reloc_vector; *parent != ((void*)0); parent++)
 {
  ...
  case bfd_reloc_dangerous:
    do { if (!(error_message != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c",8212); } while (0);
...
# 8283 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/reloc.c"
void _bfd_generic_set_reloc
