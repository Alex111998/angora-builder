# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
# 19 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 20 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 21 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 22 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
# 1 "./elf-nacl.h" 1
# 21 "./elf-nacl.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c" 2
...
nacl_modify_segment_map (bfd *abfd, struct bfd_link_info *info)
{
      ...
      if (seg->p_type == 1)
 {
  ...
  {
# 132 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c"
    struct elf_segment_map *newseg;
    asection *sec;
    struct bfd_elf_section_data *secdata;

    do { if (!(!seg->p_size_valid)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c",136); } while (0);
...
nacl_final_write_processing (bfd *abfd, bfd_boolean linker __attribute__ ((__unused__)))
{
 ...
 do { if (!(sec->flags & 0x100000)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c",335); } while (0);
 do { if (!(sec->flags & 0x010)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c",336); } while (0);
 do { if (!(sec->size > 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/elf-nacl.c",337); } while (0);
