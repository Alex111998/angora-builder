# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
# 1 "./plugin.h" 1
# 24 "./plugin.h"
...
plugin_data_struct;
# 37 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 38 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
...
# 39 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c" 2
# 112 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c"
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",393); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",406); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",419); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",426); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",433); } while (0);
  return ((void*)0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",440); } while (0);
  return 0;
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",447); } while (0);
  return 0;
}
...
bfd_plugin_get_symtab_upper_bound (bfd *abfd)
{
  ...
  do { if (!(nsyms >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",457); } while (0);
...
convert_flags (const struct ld_plugin_symbol *sym)
{
 switch (sym->def)
   ...
   default:
     do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",477); } while (0);
     return 0;
   }
}
    ...
    asymbol **alocation)
{
  ...
  for (i = 0; i < nsyms; i++)
    {
      ...
      do { if (!(s)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",500); } while (0);
      alocation[i] = s;
 ...
 case LDPK_WEAKDEF:
   ...
   break;
 default:
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",521); } while (0);
 }
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",536); } while (0);
}
...
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/plugin.c",563); } while (0);
  return 0;
}
