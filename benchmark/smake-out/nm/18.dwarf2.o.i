# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
# 32 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 33 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 36 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 37 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c" 2
...
extern int dwarf_debug_section_assert[(sizeof (dwarf_debug_sections) / sizeof ((dwarf_debug_sections)[0]))
          == debug_max + 1 ? 1 : -1];
# 401 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
...
# 684 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static char *
...
read_address (struct comp_unit *unit, bfd_byte *buf, bfd_byte * buf_end)
{
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c", 890, __PRETTY_FUNCTION__);
 }
    }
  else
    {
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c", 904, __PRETTY_FUNCTION__);
 }
    }
}
...
# 1052 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
...
# 1489 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
  if (seq
         ...
         struct line_sequence * seq)
{
  ...
  do { if (!(line_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",1740); } while (0);
...
sort_line_sequences (struct line_info_table* table)
{
  ...
  for (n = 0; n < num_sequences; n++)
    {
      ...
      do { if (!(seq)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",1775); } while (0);
  ...
  do { if (!(seq == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",1784); } while (0);
       ...
       unsigned int size))
{
      ...
      for (formati = 0; formati < format_count; formati++)
 {
   ...
   switch (content_type)
     ...
     default:
       _bfd_error_handler
  (dgettext ("bfd", "Dwarf Error: Unknown format content type %lu."),
   ...
   switch (form)
     ...
     case DW_FORM_udata:
       *uintp = _bfd_safe_read_leb128 (abfd, buf, &bytes_read, 0,
           buf_end);
       buf += bytes_read;
       break;
...
build_lookup_funcinfo_table (struct comp_unit * unit)
{
      ...
      for (range = entry->funcinfo->arange.next; range; range = range->next)
 {
  ...
  do { if (!(func_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",2611); } while (0);
  ...
  if (attr_ptr->form == DW_FORM_ref_addr)
    {
      ...
      if (!die_ref)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c", 2824, __PRETTY_FUNCTION__);
...
scan_unit_for_symbols (struct comp_unit *unit)
{
   ...
   || abbrev->tag == DW_TAG_inlined_subroutine)
 {
   ...
   do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",3053); } while (0);
  ...
  case DW_AT_location:
        ...
        if (*attr.u.blk->data == DW_OP_addr)
   {
     ...
     if (attr.u.blk->size == unit->addr_size + 1U)
       var->addr = ((unit->addr_size * 8) == 8 ? (bfd_vma) (*(const unsigned char *) (attr.u.blk->data + 1) & 0xff) : (unit->addr_size * 8) == 16 ? ((*((unit->abfd)->xvec->bfd_getx16)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 32 ? ((*((unit->abfd)->xvec->bfd_getx32)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 64 ? ((*((unit->abfd)->xvec->bfd_getx64)) (attr.u.blk->data + 1)) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c", 3202, __PRETTY_FUNCTION__), (bfd_vma) - 1));
...
# 3263 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
   ...
   unsigned int offset_size)
{
      ...
      if (version)
 {
  ...
  do { if (!(offset_size == 4 || offset_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",3316); } while (0);
  if (offset_size == 4)
...
# 3516 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static bfd_vma
...
# 3611 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static bfd_boolean
       ...
       struct info_hash_table *varinfo_hash_table)
{
  ...
  do { if (!(stash->info_hash_status != 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",3676); } while (0);

  if (!comp_unit_maybe_decode_line_info (unit, stash))
    return 0;

  do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",3681); } while (0);
...
# 3739 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static asection *
...
# 3833 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static bfd_boolean
place_sections (bfd *orig_bfd, struct dwarf2_debug *stash)
{
      ...
      while (1)
 {
  ...
  continue;
       ...
       if (is_debug_info)
  {
    do { if (!(sect->alignment_power == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",3922); } while (0);
    sect->vma = last_dwarf;
    last_dwarf += sz;
  }
       else
...
stash_verify_info_hash_table (struct dwarf2_debug *stash)
{
    ...
    each_func = each_func->prev_func)
 {
   ...
   node = lookup_info_hash_table (stash->funcinfo_hash_table,
      each_func->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4098); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4105); } while (0);
 }
    ...
    each_var = each_var->prev_var)
 {
   ...
   node = lookup_info_hash_table (stash->varinfo_hash_table,
      each_var->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4116); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4123); } while (0);
 }
    }
}
...
{
  do { if (!(stash->info_hash_status == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4136); } while (0);
...
stash_find_line_fast (struct dwarf2_debug *stash,
        ...
        unsigned int *linenumber_ptr)
{
  do { if (!(stash->info_hash_status == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4172); } while (0);
...
# 4211 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
static bfd_boolean
         ...
         bfd_boolean do_place)
{
   ...
   || !bfd_generic_link_read_symbols (debug_bfd))
 {
  ...
  if (do_place
    ...
    return 0;
# 4336 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
...
# 4447 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
bfd_boolean
_bfd_dwarf2_find_nearest_line (bfd *abfd,
          ...
          void **pinfo)
{
# 4469 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
  struct dwarf2_debug *stash;
  ...
  *linenumber_ptr = 0;
  ...
  if (do_line)
    {
      do { if (!(section == ((void*)0) && offset == 0 && functionname_ptr == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4494); } while (0);
      section = ((symbol)->section);
      addr = symbol->value;
    }
  else
    {
      do { if (!(section != ((void*)0) && functionname_ptr != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4500); } while (0);
      addr = offset;
# 4516 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
      if (symbols != ((void*)0) && (section->flags & 0x010) == 0)
 {
   asymbol **tmp;
      ...
      for (each = stash->all_comp_units; each; each = each->next_unit)
 {
   ...
   if (found)
     {
# 4617 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
       if (range <= min_range)
  {
      ...
      if (* linenumber_ptr)
 {
  ...
  if (addr_size == 0)
    addr_size = 4;
  do { if (!(addr_size == 4 || addr_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c",4644); } while (0);
...
# 4680 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
      else if (addr_size == 8)
 {
   offset_size = 4;
   stash->info_ptr += 4;
 ...
 return ((void*)0);
  ...
  if (cache->last_section != section
      ...
      || offset >= cache->func->value + cache->func_size)
    {
      ...
      bfd_vma low_func;
      asymbol **p;
# 4956 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/./dwarf2.c"
