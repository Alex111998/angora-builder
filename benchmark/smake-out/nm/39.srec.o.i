# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2
# 104 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 105 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 106 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 107 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2
...
# 108 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2
...
# 109 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c" 2




static const char digs[] = "0123456789ABCDEF";
# 132 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c"
        ...
        bfd_boolean error)
{
 ...
 (dgettext ("bfd", "%B:%d: Unexpected character `%s' in S-record file\n"),
  abfd, lineno, buf);
...
srec_scan (bfd *abfd)
{
 ...
 case 'S':
  ...
  _bfd_error_handler (dgettext ("bfd", "%B:%d: byte count %d too small\n"),
        abfd, lineno, bytes);
  bfd_set_error (bfd_error_bad_value);
  goto error_return;
       }
  ...
  if (check_sum != ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])])))
    {
      _bfd_error_handler
        ...
        (dgettext ("bfd", "%B:%d: Bad checksum in S-record file\n"),
         abfd, lineno);
      bfd_set_error (bfd_error_bad_value);
      goto error_return;
    }
...
srec_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == 'S')) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c",743); } while (0);

      if (bfd_bread (hdr, (bfd_size_type) 3, abfd) != 3)
 goto error_return;

      do { if (!((((unsigned int) _hex_value[(unsigned char) (hdr[1])]) != 99) && (((unsigned int) _hex_value[(unsigned char) (hdr[2])]) != 99))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c",748); } while (0);
 ...
 {
 default:
   do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c",770); } while (0);
   if (buf != ((void*)0))
     free (buf);
   return 1;
 ...
 case '1':
   ...
   if (address != section->vma + sofar)
     {
       ...
       do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c",795); } while (0);
       if (buf != ((void*)0))
  free (buf);
       return 1;
     }
  ...
  do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c",818); } while (0);
...
srec_write_symbols (bfd *abfd)
{
      ...
      for (i = 0; i < count; i++)
 {
  ...
  return 0;
       ...
       sprintf (buf + 2, "%016" "l" "x", (s->value + s->section->output_section->lma + s->section->output_offset));
...
# 1290 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/srec.c"
const bfd_target srec_vec =
{
  ...
  _bfd_archive_close_and_cleanup, bfd_true, _bfd_generic_new_section_hook, srec_get_section_contents, _bfd_generic_get_section_contents_in_window,
  ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, struct bfd_link_info *)) bfd_true), _bfd_generic_init_private_section_data, ((bfd_boolean (*) (bfd *, asection *, bfd *, asection *)) bfd_true), ((bfd_boolean (*) (bfd *, asymbol *, bfd *, asymbol *)) bfd_true), ((bfd_boolean (*) (bfd *, bfd *)) bfd_true), ((bfd_boolean (*) (bfd *, flagword)) bfd_true), ((bfd_boolean (*) (bfd *, void *)) bfd_true),
  ...
  bfd_false, bfd_false, ((bfd_boolean (*) (bfd *, char **, bfd_size_type *, const char **)) bfd_false), ((void (*) (bfd *, const char *, char *)) bfd_void), ((bfd_boolean (*) (bfd *, unsigned int, struct orl *, unsigned int, int)) bfd_false), bfd_nullvoidptr, ((bfd_boolean (*) (bfd *, bfd *)) bfd_false), ((bfd *(*) (bfd *, bfd *)) bfd_nullvoidptr), ((bfd *(*) (bfd *, symindex)) bfd_nullvoidptr), bfd_generic_stat_arch_elt, bfd_false,
  srec_get_symtab_upper_bound, srec_canonicalize_symtab, _bfd_generic_make_empty_symbol, srec_print_symbol, srec_get_symbol_info, ((const char *(*) (bfd *, asymbol *, bfd_boolean *)) bfd_nullvoidptr), bfd_generic_is_local_label_name, ((bfd_boolean (*) (bfd *, asymbol *)) bfd_false), ((alent *(*) (bfd *, asymbol *)) bfd_nullvoidptr), ((bfd_boolean (*) (bfd *, asymbol **, asection *, bfd_vma, const char **, const char **, unsigned int *, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, asymbol **, asymbol *, const char **, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, const char **, const char **, unsigned int *)) bfd_false), ((asymbol *(*) (bfd *, void *, unsigned long)) bfd_nullvoidptr), _bfd_generic_read_minisymbols, _bfd_generic_minisymbol_to_symbol,
  _bfd_norelocs_get_reloc_upper_bound, _bfd_norelocs_canonicalize_reloc, _bfd_norelocs_set_reloc, ((reloc_howto_type *(*) (bfd *, bfd_reloc_code_real_type)) bfd_nullvoidptr), ((reloc_howto_type *(*) (bfd *, const char *)) bfd_nullvoidptr),
  srec_set_arch_mach, srec_set_section_contents,
  srec_sizeof_headers, bfd_generic_get_relocated_section_contents, bfd_generic_relax_section, _bfd_generic_link_hash_table_create, _bfd_generic_link_add_symbols, _bfd_generic_link_just_syms, _bfd_generic_copy_link_hash_symbol_type, _bfd_generic_final_link, _bfd_generic_link_split_section, _bfd_generic_link_check_relocs, bfd_generic_gc_sections, bfd_generic_lookup_section_flags, bfd_generic_merge_sections, bfd_generic_is_group_section, bfd_generic_discard_group, _bfd_generic_section_already_linked, bfd_generic_define_common_symbol, bfd_generic_define_start_stop,
