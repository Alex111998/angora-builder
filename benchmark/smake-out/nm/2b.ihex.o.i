# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
# 122 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 123 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 124 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 125 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
...
# 126 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
...
# 127 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c" 2
# 142 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c"
...
ihex_bad_byte (bfd *abfd, unsigned int lineno, int c, bfd_boolean error)
{
 ...
 (dgettext ("bfd", "%B:%d: unexpected character `%s' in Intel Hex file"),
  abfd, lineno, buf);
...
ihex_scan (bfd *abfd)
{
      ...
      else
 {
  ...
  (dgettext ("bfd", "%B:%u: bad checksum in Intel Hex file (expected %u, found %u)"),
   abfd, lineno,
       ...
       if (len != 2)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%B:%u: bad extended address record length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }
       ...
       if (len != 4)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%B:%u: bad extended start address length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }
       ...
       if (len != 2)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%B:%u: bad extended linear address record length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }
       ...
       if (len != 2 && len != 4)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%B:%u: bad extended linear start address length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }
  ...
  (dgettext ("bfd", "%B:%u: unrecognized ihex type %u in Intel Hex file"),
   abfd, lineno, type);
       bfd_set_error (bfd_error_bad_value);
       goto error_return;
     }
...
ihex_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == ':')) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c",573); } while (0);
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%B: internal error in ihex_read_section"), abfd);
   bfd_set_error (bfd_error_bad_value);
   goto error_return;
 }
 ...
 *p++ = (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])])));
 ...
 goto error_return;
  ...
  if ((bfd_size_type) (p - contents) < section->size)
    {
      _bfd_error_handler
 (dgettext ("bfd", "%B: bad section length in ihex_read_section"), abfd);
      bfd_set_error (bfd_error_bad_value);
      goto error_return;
    }
      ...
      bfd_size_type count)
{
  ...
  if (count == 0
      || (section->flags & 0x001) == 0
      || (section->flags & 0x002) == 0)
    return 1;
...
ihex_write_object_contents (bfd *abfd)
{
      ...
      while (count > 0)
 {
       ...
       if (where <= 0xfffff)
  {
    ...
    do { if (!(extbase == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c",800); } while (0);
    ...
    if (where > extbase + 0xffff)
      {
        ...
        sprintf (buf, "%016" "l" "x", where);
        _bfd_error_handler

   (dgettext ("bfd", "%B: address 0x%s out of range for Intel Hex file"),
    abfd, buf);
        bfd_set_error (bfd_error_bad_value);
        return 0;
      }
...
# 959 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/ihex.c"
const bfd_target ihex_vec =
{
  ...
  _bfd_archive_close_and_cleanup, bfd_true, _bfd_generic_new_section_hook, ihex_get_section_contents, _bfd_generic_get_section_contents_in_window,
  ...
  bfd_0l, ((long (*) (bfd *, asymbol **)) bfd_0l), _bfd_generic_make_empty_symbol, ((void (*) (bfd *, void *, asymbol *, bfd_print_symbol_type)) bfd_void), ((void (*) (bfd *, asymbol *, symbol_info *)) bfd_void), ((const char *(*) (bfd *, asymbol *, bfd_boolean *)) bfd_nullvoidptr), ((bfd_boolean (*) (bfd *, const char *)) bfd_false), ((bfd_boolean (*) (bfd *, asymbol *)) bfd_false), ((alent *(*) (bfd *, asymbol *)) bfd_nullvoidptr), ((bfd_boolean (*) (bfd *, asymbol **, asection *, bfd_vma, const char **, const char **, unsigned int *, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, asymbol **, asymbol *, const char **, unsigned int *)) bfd_false), ((bfd_boolean (*) (bfd *, const char **, const char **, unsigned int *)) bfd_false), ((asymbol *(*) (bfd *, void *, unsigned long)) bfd_nullvoidptr), ((long (*) (bfd *, bfd_boolean, void **, unsigned int *)) _bfd_n1), ((asymbol *(*) (bfd *, bfd_boolean, const void *, asymbol *)) bfd_nullvoidptr),
