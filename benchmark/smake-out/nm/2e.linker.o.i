# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 185 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
# 1 "./libbfd.h" 1
# 47 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
# 1 "./genlink.h" 1
# 42 "./genlink.h"
...
struct bfd_hash_entry *_bfd_generic_link_hash_newfunc
  (struct bfd_hash_entry *, struct bfd_hash_table *, const char *);
# 27 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c" 2
# 405 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
   ...
   unsigned int entsize)
{
  ...
  do { if (!(!abfd->is_linker_output && !abfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",469); } while (0);
  table->undefs = ((void*)0);
...
# 638 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
void
...
bfd_link_add_undef (struct bfd_link_hash_table *table,
      struct bfd_link_hash_entry *h)
{
  do { if (!(h->u.undef.next == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",666); } while (0);
...
# 681 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
void
...
_bfd_generic_link_hash_table_free (bfd *obfd)
{
  ...
  do { if (!(obfd->is_linker_output && obfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",771); } while (0);
...
# 786 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
...
# 889 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
        ...
        bfd_boolean *pneeded)
{
      ...
      if (h->type == bfd_link_hash_undefined)
 {
   ...
   bfd_vma size;
   unsigned int power;
# 1085 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
...
# 1200 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
...
# 1236 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
enum link_row
{
  UNDEF_ROW,
  UNDEFW_ROW,
...
# 1319 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
static bfd *
...
# 1358 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry **hashp)
{
  ...
  do { if (!(section != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",1375); } while (0);
 ...
 _bfd_error_handler
   (dgettext ("bfd", "%B: plugin needed to handle lto object"), abfd);
    }
  else
    row = DEF_ROW;
 ...
 {
 case FAIL:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 1450, __PRETTY_FUNCTION__);
 ...
 case CDEF:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",1472); } while (0);
 ...
 case DEFW:
   {
     ...
     if (collect && name[0] == '_')
       {
  const char *s;
# 1510 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
  s = name + 1;
  while (*s == '_')
    ++s;
  if (s[0] == 'G' && (strncmp ((s), ("GLOBAL_"), sizeof ("GLOBAL_") - 1) == 0))
   ...
   if (oldtype == bfd_link_hash_defweak)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 1529, __PRETTY_FUNCTION__);
...
# 1575 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
 ...
 case BIG:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",1601); } while (0);
   (*info->callbacks->multiple_common) (info, h, abfd,
 ...
 case CIND:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",1659); } while (0);
   (*info->callbacks->multiple_common) (info, h, abfd,
 ...
 case IND:
  ...
  (dgettext ("bfd", "%B: indirect symbol `%s' to `%s' is a loop"),
   abfd, name, string);
...
_bfd_generic_final_link (bfd *abfd, struct bfd_link_info *info)
{
      ...
      for (o = abfd->sections; o != ((void*)0); o = o->next)
 {
       ...
       else if (p->type == bfd_indirect_link_order)
  {
    ...
    if (reloc_count < 0)
      return 0;
    do { if (!((unsigned long) reloc_count == input_section->reloc_count)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",1866); } while (0);
      ...
      size_t *psymalloc)
{
   ...
   || ((((sym)->section)) == (&_bfd_std_section[3])))
 {
   if (sym->udata.p != ((void*)0))
     ...
     {
# 2018 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
       h = ((void*)0);
     }
  ...
  case bfd_link_hash_new:
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2047, __PRETTY_FUNCTION__);
  case bfd_link_hash_undefined:
    break;
  case bfd_link_hash_undefweak:
    sym->flags |= (1 << 7);
  ...
  case bfd_link_hash_common:
    ...
    if (! (((sym->section)->flags & 0x1000) != 0))
      {
        do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2073); } while (0);
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2162, __PRETTY_FUNCTION__);
...
set_symbol_from_hash (asymbol *sym, struct bfd_link_hash_entry *h)
{
  switch (h->type)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2193, __PRETTY_FUNCTION__);
      break;
    case bfd_link_hash_new:
 ...
 {
   do { if (!((sym->flags & (1 << 11)) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2200); } while (0);
 }
      else
 {
   sym->flags |= (1 << 11);
 ...
 {
   do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2233); } while (0);
   sym->section = (&_bfd_std_section[0]);
 }
 ...
 return 0;
  ...
  if (! generic_add_output_symbol (wginfo->output_bfd, wginfo->psymalloc,
       sym))
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2286, __PRETTY_FUNCTION__);
    }
          ...
          struct bfd_link_order *link_order)
{
  ...
  if (! ((info)->type == type_relocatable))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2303, __PRETTY_FUNCTION__);
  if (sec->orelocation == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2305, __PRETTY_FUNCTION__);
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2366, __PRETTY_FUNCTION__);
    ...
    struct bfd_link_order *link_order)
{
  switch (link_order->type)
    ...
    case bfd_symbol_reloc_link_order:
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2431, __PRETTY_FUNCTION__);
    case bfd_indirect_link_order:
    ...
    struct bfd_link_order *link_order)
{
  ...
  do { if (!((sec->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2454); } while (0);
        ...
        bfd_boolean generic_linker)
{
  ...
  do { if (!((output_section->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2517); } while (0);
  ...
  do { if (!(input_section->output_section == output_section)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2524); } while (0);
  do { if (!(input_section->output_offset == link_order->offset)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2525); } while (0);
  do { if (!(input_section->size == link_order->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2526); } while (0);
      ...
      if (!output_bfd->output_has_begun)
 {
   ...
   if (!bfd_set_section_contents (output_bfd, output_section, "", 0, 1))
     goto error_return;
      ...
      do { if (!(new_contents != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2609); } while (0);
      do { if (!(input_section->output_offset == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",2610); } while (0);
    }
  else
    {
...
# 2682 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
...
# 2718 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
       ...
       struct bfd_link_info *info)
{
  switch (sec->flags & 0xc0000)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c", 2805, __PRETTY_FUNCTION__);
 ...
 (dgettext ("bfd", "%B: ignoring duplicate section `%A'\n"),
  sec->owner, sec);
      break;
 ...
 info->callbacks->einfo
   ...
   (dgettext ("bfd", "%B: duplicate section `%A' has different size\n"),
    sec->owner, sec);
      break;
      ...
      else if (sec->size != 0)
 {
   ...
   if (!bfd_malloc_and_get_section (sec->owner, sec, &sec_contents))
     info->callbacks->einfo
       ...
       (dgettext ("bfd", "%B: could not read contents of section `%A'\n"),
        sec->owner, sec);
     ...
     info->callbacks->einfo
       ...
       (dgettext ("bfd", "%B: duplicate section `%A' has different contents\n"),
        sec->owner, sec);
         ...
         struct bfd_link_info *info)
{
  ...
  if ((sec->flags & 0x2000000) != 0)
    return 0;
# 2917 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
...
_bfd_nearby_section (bfd *obfd, asection *s, bfd_vma addr)
{
 ...
 best = prev;
  ...
  else if (((prev->flags ^ next->flags) & 0x008) != 0)
    {
      if (((next->flags ^ s->flags) & 0x008) != 0)
 best = prev;
    }
  else if (((prev->flags ^ next->flags) & 0x010) != 0)
    {
      if (((next->flags ^ s->flags) & 0x010) != 0)
 best = prev;
    }
  else
    {
...
# 3057 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry *h)
{
  ...
  do { if (!(h != ((void*)0) && h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",3066); } while (0);
  ...
  do { if (!(alignment != 0 && (alignment & -alignment) == alignment)) bfd_assert("/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c",3075); } while (0);
...
# 3116 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
struct bfd_link_hash_entry *
...
# 3152 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
struct bfd_elf_version_tree *
...
# 3256 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
...
# 3280 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
bfd_link_check_relocs (bfd *abfd, struct bfd_link_info *info)
{
  return ((*((abfd)->xvec->_bfd_link_check_relocs)) (abfd, info));
}
# 3301 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
...
# 3343 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/bfd/linker.c"
bfd_boolean
_bfd_generic_verify_endian_match (bfd *ibfd, struct bfd_link_info *info)
{
 ...
 _bfd_error_handler (dgettext ("bfd", "%B: compiled for a big endian system " "and target is little endian"), ibfd);

      else
 _bfd_error_handler (dgettext ("bfd", "%B: compiled for a little endian system " "and target is big endian"), ibfd);
