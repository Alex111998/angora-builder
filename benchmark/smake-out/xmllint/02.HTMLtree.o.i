# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
# 11 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 12 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 15 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 18 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 21 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 24 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 26 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2


# 1 "./include/libxml/xmlerror.h" 1
# 29 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
typedef void (*xmlEntityReferenceFunc) (xmlEntityPtr ent,
 ...
 xmlErrMemory (xmlParserCtxtPtr ctxt,
     const char *extra);
# 30 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 32 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
...
# 34 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
# 49 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
const xmlChar *
htmlGetMetaEncoding(htmlDocPtr doc) {
    htmlNodePtr cur;
    const xmlChar *content;
 ...
 return(((void*)0));
    ...
    while (cur != ((void*)0)) {
 if ((cur->type == XML_ELEMENT_NODE) && (cur->name != ((void*)0))) {
     if (xmlStrEqual(cur->name, (xmlChar *)"html"))
  break;
     if (xmlStrEqual(cur->name, (xmlChar *)"head"))
  goto found_head;
     if (xmlStrEqual(cur->name, (xmlChar *)"meta"))
  goto found_meta;
 }
 cur = cur->next;
    }
...
found_meta:
 ...
 if ((cur->type == XML_ELEMENT_NODE) && (cur->name != ((void*)0))) {
  ...
  while (attr != ((void*)0)) {
   ...
   if ((!xmlStrcasecmp(attr->name, (xmlChar *)"http-equiv"))
    && (!xmlStrcasecmp(value, (xmlChar *)"Content-Type")))
       http = 1;
   else if ((value != ((void*)0))
    && (!xmlStrcasecmp(attr->name, (xmlChar *)"content")))
       content = value;
   if ((http != 0) && (content != ((void*)0)))
       goto found_content;
      }
      attr = attr->next;
  }
...
found_content:
    encoding = xmlStrstr(content, (xmlChar *)"charset=");
    if (encoding == ((void*)0))
 encoding = xmlStrstr(content, (xmlChar *)"Charset=");
    if (encoding == ((void*)0))
 encoding = xmlStrstr(content, (xmlChar *)"CHARSET=");
...
# 163 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
htmlSetMetaEncoding(htmlDocPtr doc, const xmlChar *encoding) {
    htmlNodePtr cur, meta = ((void*)0), head = ((void*)0);
 ...
 return(-1);
    ...
    if (!xmlStrcasecmp(encoding, (xmlChar *) "html"))
        return(-1);
 ...
 newcontent[sizeof(newcontent) - 1] = 0;
    ...
    while (cur != ((void*)0)) {
 if ((cur->type == XML_ELEMENT_NODE) && (cur->name != ((void*)0))) {
     if (xmlStrcasecmp(cur->name, (xmlChar *)"html") == 0)
  break;
     if (xmlStrcasecmp(cur->name, (xmlChar *)"head") == 0)
  goto found_head;
     if (xmlStrcasecmp(cur->name, (xmlChar *)"meta") == 0)
  goto found_meta;
 }
 cur = cur->next;
    }
...
create:
    if (meta == ((void*)0)) {
        if ((encoding != ((void*)0)) && (head != ((void*)0))) {




            meta = xmlNewDocNode(doc, ((void*)0), (xmlChar *)"meta", ((void*)0));
            if (head->children == ((void*)0))
                xmlAddChild(head, meta);
            else
                xmlAddPrevSibling(head->children, meta);
            xmlNewProp(meta, (xmlChar *)"http-equiv", (xmlChar *)"Content-Type");
            xmlNewProp(meta, (xmlChar *)"content", (xmlChar *) newcontent);
        }
    } else {
        ...
        else if (xmlStrcasestr(content, encoding) == ((void*)0)) {
            xmlSetProp(meta, (xmlChar *)"content", (xmlChar *) newcontent);
        }
    }
...
# 307 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static const char* htmlBooleanAttrs[] = {
  "checked", "compact", "declare", "defer", "disabled", "ismap",
  "multiple", "nohref", "noresize", "noshade", "nowrap", "readonly",
  "selected", ((void*)0)
};
# 322 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
htmlIsBooleanAttr(const xmlChar *name)
{
    int i = 0;

    while (htmlBooleanAttrs[i] != ((void*)0)) {
...
# 352 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
htmlSaveErrMemory(const char *extra)
{
    __xmlSimpleError(XML_FROM_OUTPUT, XML_ERR_NO_MEMORY, ((void*)0), ((void*)0), extra);
}
# 366 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
...
# 407 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static size_t
htmlBufNodeDumpFormat(xmlBufPtr buf, xmlDocPtr doc, xmlNodePtr cur,
 ...
 return (-1);
    ...
    use = xmlBufUse(buf);
    htmlNodeDumpFormatOutput(outbuf, doc, cur, ((void*)0), format);
    xmlFree(outbuf);
    ret = xmlBufUse(buf) - use;
    return (ret);
}
# 451 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
...
# 487 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
htmlNodeDumpFileFormat(FILE *out, xmlDocPtr doc,
 ...
 if (enc != XML_CHAR_ENCODING_UTF8) {
     ...
     if (handler == ((void*)0))
  htmlSaveErr(XML_SAVE_UNKNOWN_ENCODING, ((void*)0), encoding);
 }
    }
...
# 536 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlNodeDumpFile(FILE *out, xmlDocPtr doc, xmlNodePtr cur) {
    htmlNodeDumpFileFormat(out, doc, cur, ((void*)0), 1);
}
# 551 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
 ...
 *size = 0;
 return;
    ...
    htmlDocContentDumpFormatOutput(buf, cur, ((void*)0), format);
...
# 629 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlDocDumpMemory(xmlDocPtr cur, xmlChar**mem, int *size) {
 htmlDocDumpMemoryFormat(cur, mem, size, 1);
}
# 641 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void xmlNsListDumpOutput(xmlOutputBufferPtr buf, xmlNsPtr cur);
# 653 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
htmlDtdDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc,
           const char *encoding __attribute__((unused))) {
    xmlDtdPtr cur = doc->intSubset;

    if (cur == ((void*)0)) {
 htmlSaveErr(XML_SAVE_NO_DOCTYPE, (xmlNodePtr) doc, ((void*)0));
 return;
    }
 ...
 if (cur->SystemID != ((void*)0)) {
    ...
    } else if (cur->SystemID != ((void*)0) &&
        xmlStrcmp(cur->SystemID, (xmlChar *) "about:legacy-compat")) {
 xmlOutputBufferWriteString(buf, " SYSTEM ");
 xmlBufWriteQuotedString(buf->buffer, cur->SystemID);
    }
    xmlOutputBufferWriteString(buf, ">\n");
}
# 688 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
htmlAttrDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc, xmlAttrPtr cur,
            const char *encoding __attribute__((unused))) {
    xmlChar *value;
# 700 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
    if (cur == ((void*)0)) {
 return;
    }
    xmlOutputBufferWriteString(buf, " ");
 ...
 xmlOutputBufferWriteString(buf, ":");
    ...
    xmlOutputBufferWriteString(buf, (const char *)cur->name);
    if ((cur->children != ((void*)0)) && (!htmlIsBooleanAttr(cur->name))) {
 value = xmlNodeListGetString(doc, cur->children, 0);
 if (value) {
     xmlOutputBufferWriteString(buf, "=");
     if ((cur->ns == ((void*)0)) && (cur->parent != ((void*)0)) &&
  (cur->parent->ns == ((void*)0)) &&
  ((!xmlStrcasecmp(cur->name, (xmlChar *) "href")) ||
          (!xmlStrcasecmp(cur->name, (xmlChar *) "action")) ||
   (!xmlStrcasecmp(cur->name, (xmlChar *) "src")) ||
   ((!xmlStrcasecmp(cur->name, (xmlChar *) "name")) &&
    (!xmlStrcasecmp(cur->parent->name, (xmlChar *) "a"))))) {
  xmlChar *tmp = value;
  ...
  for ( ; ; ) {
      ...
      xmlChar endChar;
      xmlChar *end = ((void*)0);
      xmlChar *start = (xmlChar *)xmlStrstr(tmp, (xmlChar *) "<!--");
      if (start != ((void*)0)) {
   end = (xmlChar *)xmlStrstr(tmp, (xmlChar *) "-->");
   if (end != ((void*)0)) {
       *start = '\0';
   }
      }
      ...
      escaped = xmlURIEscapeStr(tmp, (xmlChar *)"@/:=?;#%&,+");
      if (escaped != ((void*)0)) {
...
# 782 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
...
# 805 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
static void
...
# 827 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlNodeDumpFormatOutput(xmlOutputBufferPtr buf, xmlDocPtr doc,
 ...
 if (cur->content != ((void*)0)) {
  ...
  ((cur->parent == ((void*)0)) ||
   ((xmlStrcasecmp(cur->parent->name, (xmlChar *) "script")) &&
    (xmlStrcasecmp(cur->parent->name, (xmlChar *) "style"))))) {
  xmlChar *buffer;
 ...
 xmlNsListDumpOutput(buf, cur->nsDef);
    ...
    if ((info != ((void*)0)) && (info->empty)) {
        xmlOutputBufferWriteString(buf, ">");
 if ((format) && (!info->isinline) && (cur->next != ((void*)0))) {
 ...
 (cur->children == ((void*)0))) {
        if ((info != ((void*)0)) && (info->saveEndTag != 0) &&
     (xmlStrcmp((xmlChar *) info->name, (xmlChar *) "html")) &&
     (xmlStrcmp((xmlChar *) info->name, (xmlChar *) "body"))) {
     xmlOutputBufferWriteString(buf, ">");
 } else {
     xmlOutputBufferWriteString(buf, "></");
            if ((cur->ns != ((void*)0)) && (cur->ns->prefix != ((void*)0))) {
 ...
 if ((format) && (cur->next != ((void*)0)) &&
            (info != ((void*)0)) && (!info->isinline)) {
     if ((cur->next->type != XML_TEXT_NODE) &&
  (cur->next->type != XML_ENTITY_REF_NODE) &&
  (cur->parent != ((void*)0)) &&
  (cur->parent->name != ((void*)0)) &&
 ...
 (cur->content != ((void*)0))) {
    ...
    if (cur->children != ((void*)0)) {
        if ((format) && (info != ((void*)0)) && (!info->isinline) &&
 ...
 htmlNodeListDumpOutput(buf, doc, cur->children, encoding, format);
        if ((format) && (info != ((void*)0)) && (!info->isinline) &&
     (cur->last->type != XML_TEXT_NODE) &&
     (cur->last->type != XML_ENTITY_REF_NODE) &&
     (cur->children != cur->last) &&
     (cur->name != ((void*)0)) &&
     (cur->name[0] != 'p'))
     xmlOutputBufferWriteString(buf, "\n");
...
# 1016 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlNodeDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc,
            xmlNodePtr cur, const char *encoding) {
    htmlNodeDumpFormatOutput(buf, doc, cur, encoding, 1);
}
# 1031 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlDocContentDumpFormatOutput(xmlOutputBufferPtr buf, xmlDocPtr cur,
    ...
    if (cur->intSubset != ((void*)0)) {
        htmlDtdDumpOutput(buf, cur, ((void*)0));
    }
    if (cur->children != ((void*)0)) {
...
# 1064 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
void
htmlDocContentDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr cur,
                  const char *encoding) {
    htmlDocContentDumpFormatOutput(buf, cur, encoding, 1);
}
# 1085 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
...
# 1145 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
...
# 1208 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
...
# 1272 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c"
int
...
# 1 "./elfgcchack.h" 1
# 1281 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/HTMLtree.c" 2
