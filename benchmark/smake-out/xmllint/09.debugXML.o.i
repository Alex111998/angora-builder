# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
# 11 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 12 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 15 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
# 17 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
# 22 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
typedef void (*xmlEntityReferenceFunc) (xmlEntityPtr ent,
 ...
 xmlErrMemory (xmlParserCtxtPtr ctxt,
     const char *extra);
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
typedef int (* xmlShellCmd) (xmlShellCtxtPtr ctxt,
 ...
 xmlShell (xmlDocPtr doc,
     ...
     xmlShellReadlineFunc input,
     FILE *output);
# 27 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
# 28 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2

# 1 "./include/libxml/xmlerror.h" 1
# 30 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
# 32 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
# 33 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
typedef enum {
   ...
   xmlRelaxNGSetValidStructuredErrors(xmlRelaxNGValidCtxtPtr ctxt,
      ...
      xmlDocPtr doc,
      xmlNodePtr elem);
# 35 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
...
static void
xmlCtxtDumpCleanCtxt(xmlDebugCtxtPtr ctxt __attribute__((unused)))
{

}
# 92 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlNsCheckScope(xmlNodePtr node, xmlNsPtr ns)
{
    xmlNsPtr cur;

    if ((node == ((void*)0)) || (ns == ((void*)0)))
        return(-1);
...
xmlCtxtDumpSpaces(xmlDebugCtxtPtr ctxt)
{
    if (ctxt->check)
        return;
    if ((ctxt->output != ((void*)0)) && (ctxt->depth > 0)) {
        if (ctxt->depth < 50)
...
# 196 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 229 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 249 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
xmlCtxtGenericNodeCheck(xmlDebugCtxtPtr ctxt, xmlNodePtr node) {
 ...
 if (ctxt->dict == ((void*)0)) {
    ...
    if ((node->parent != ((void*)0)) && (node->doc != node->parent->doc) &&
        (!xmlStrEqual(node->name, (xmlChar *) "pseudoroot")))
  ...
  xmlDebugErr(ctxt, XML_CHECK_NO_PREV,
        ...
        } else if ((node->parent != ((void*)0)) && (node->parent->children != node))
     xmlDebugErr(ctxt, XML_CHECK_NO_PREV,
    ...
    if (node->next == ((void*)0)) {
 if ((node->parent != ((void*)0)) && (node->type != XML_ATTRIBUTE_NODE) &&
 ...
 if (node->content != ((void*)0))
  ...
  break;
     ...
     if ((ctxt->dict != ((void*)0)) &&
         (node->name == xmlDictLookup(ctxt->dict, (xmlChar *) "nbktext",
                               7)))
  break;
...
xmlCtxtDumpString(xmlDebugCtxtPtr ctxt, const xmlChar * str)
{
    ...
    for (i = 0; i < 40; i++)
        if (str[i] == 0)
            return;
        else if ((((str[i]) == 0x20) || ((0x9 <= (str[i])) && ((str[i]) <= 0xa)) || ((str[i]) == 0xd)))
            fputc(' ', ctxt->output);
        else if (str[i] >= 0x80)
...
xmlCtxtDumpElemDecl(xmlDebugCtxtPtr ctxt, xmlElementPtr elem)
{
 ...
 xmlDebugErr(ctxt, XML_CHECK_NO_NAME,
    ...
    if (!ctxt->check) {
        ...
        if ((elem->type != XML_ELEMENT_NODE) && (elem->content != ((void*)0))) {
            char buf[5001];
...
# 823 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 861 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 878 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
xmlCtxtDumpOneNode(xmlDebugCtxtPtr ctxt, xmlNodePtr node)
{
  ...
  if (ctxt->options & 1) {
   ...
   fprintf(ctxt->output, "\n");
    ...
    ctxt->depth++;
    if ((node->type == XML_ELEMENT_NODE) && (node->nsDef != ((void*)0)))
        xmlCtxtDumpNamespaceList(ctxt, node->nsDef);
    if ((node->type == XML_ELEMENT_NODE) && (node->properties != ((void*)0)))
        xmlCtxtDumpAttrList(ctxt, node->properties);
    if (node->type != XML_ENTITY_REF_NODE) {
        if ((node->type != XML_ELEMENT_NODE) && (node->content != ((void*)0))) {
            if (!ctxt->check) {
                xmlCtxtDumpSpaces(ctxt);
                fprintf(ctxt->output, "content=");
...
# 1061 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
xmlCtxtDumpNode(xmlDebugCtxtPtr ctxt, xmlNodePtr node)
{
    ...
    if ((node->type != XML_NAMESPACE_DECL) &&
        (node->children != ((void*)0)) && (node->type != XML_ENTITY_REF_NODE)) {
        ctxt->depth++;
        xmlCtxtDumpNodeList(ctxt, node->children);
        ctxt->depth--;
    }
}
# 1088 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 1173 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 1213 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 1281 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
xmlCtxtDumpEntities(xmlDebugCtxtPtr ctxt, xmlDocPtr doc)
{
    if (doc == ((void*)0)) return;
    xmlCtxtDumpDocHead(ctxt, doc);
    if ((doc->intSubset != ((void*)0)) && (doc->intSubset->entities != ((void*)0))) {
    ...
    if ((doc->extSubset != ((void*)0)) && (doc->extSubset->entities != ((void*)0))) {
        xmlEntitiesTablePtr table = (xmlEntitiesTablePtr)
...
# 1315 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
# 1346 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1377 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1397 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1417 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1438 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1459 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1481 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1502 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1523 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1544 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1574 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
...
# 1603 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlLsCountNode(xmlNodePtr node) {
    int ret = 0;
...
# 1660 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
xmlLsOneNode(FILE *output, xmlNodePtr node) {
    if (output == ((void*)0)) return;
    if (node == ((void*)0)) {
...
# 1794 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
const char *
xmlBoolToText(int boolval)
{
    if (boolval)
...
# 1826 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
...
# 1889 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
...
xmlShellPrintNode(xmlNodePtr node)
{
    xmlShellPrintNodeCtxt(((void*)0), node);
}
# 1931 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static void
xmlShellPrintXPathResultCtxt(xmlShellCtxtPtr ctxt,xmlXPathObjectPtr list)
{
    ...
    if (list != ((void*)0)) {
        ...
        list->nodesetval->nodeTab[indx]);
            ...
            default:
                xmlShellPrintXPathError(list->type, ((void*)0));
        }
    }
}
...
xmlShellPrintXPathResult(xmlXPathObjectPtr list)
{
    xmlShellPrintXPathResultCtxt(((void*)0), list);
}
# 2003 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellList(xmlShellCtxtPtr ctxt,
             char *arg __attribute__((unused)), xmlNodePtr node,
             xmlNodePtr node2 __attribute__((unused)))
{
    xmlNodePtr cur;
    if (!ctxt)
        return (0);
...
# 2046 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellBase(xmlShellCtxtPtr ctxt,
             char *arg __attribute__((unused)), xmlNodePtr node,
             xmlNodePtr node2 __attribute__((unused)))
...
# 2083 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlShellSetBase(xmlShellCtxtPtr ctxt __attribute__((unused)),
             char *arg __attribute__((unused)), xmlNodePtr node,
             xmlNodePtr node2 __attribute__((unused)))
{
...
# 2107 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlShellRegisterNamespace(xmlShellCtxtPtr ctxt, char *arg,
      xmlNodePtr node __attribute__((unused)), xmlNodePtr node2 __attribute__((unused)))
{
    xmlChar* nsListDup;
    xmlChar* prefix;
    xmlChar* href;
...
# 2163 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlShellRegisterRootNamespaces(xmlShellCtxtPtr ctxt, char *arg __attribute__((unused)),
      xmlNodePtr root, xmlNodePtr node2 __attribute__((unused)))
{
    xmlNsPtr ns;

    if ((root == ((void*)0)) || (root->type != XML_ELEMENT_NODE) ||
        (root->nsDef == ((void*)0)) || (ctxt == ((void*)0)) || (ctxt->pctxt == ((void*)0)))
 return(-1);
    ns = root->nsDef;
    while (ns != ((void*)0)) {
        if (ns->prefix == ((void*)0))
     xmlXPathRegisterNs(ctxt->pctxt, (xmlChar *) "defaultns", ns->href);
 else
...
# 2196 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlShellGrep(xmlShellCtxtPtr ctxt __attribute__((unused)),
            char *arg, xmlNodePtr node, xmlNodePtr node2 __attribute__((unused)))
{
    if (!ctxt)
        return (0);
    if (node == ((void*)0))
 ...
 (xmlStrchr((xmlChar *) arg, '['))) {
  ...
  fprintf(ctxt->output, "%s : ", xmlGetNodePath(node));
                xmlShellList(ctxt, ((void*)0), node, ((void*)0));
     }
        } else if (node->type == XML_TEXT_NODE) {
     if (xmlStrstr(node->content, (xmlChar *) arg)) {

  fprintf(ctxt->output, "%s : ", xmlGetNodePath(node->parent));
                xmlShellList(ctxt, ((void*)0), node->parent, ((void*)0));
     }
        }
...
# 2274 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellDir(xmlShellCtxtPtr ctxt __attribute__((unused)),
            char *arg __attribute__((unused)), xmlNodePtr node,
            xmlNodePtr node2 __attribute__((unused)))
{
    if (!ctxt)
...
# 2308 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
xmlShellSetContent(xmlShellCtxtPtr ctxt __attribute__((unused)),
...
# 2354 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
static int
...
# 2410 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellCat(xmlShellCtxtPtr ctxt, char *arg __attribute__((unused)),
            xmlNodePtr node, xmlNodePtr node2 __attribute__((unused)))
{
    if (!ctxt)
        return (0);
    if (node == ((void*)0)) {
...
# 2455 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
             ...
             xmlNodePtr node2 __attribute__((unused)))
{
    ...
    if (html) {
        ...
        doc = htmlParseFile(filename, ((void*)0));




    } else {
        doc = xmlReadFile(filename,((void*)0),0);
    }
    if (doc != ((void*)0)) {
        if (ctxt->loaded == 1) {
            xmlFreeDoc(ctxt->doc);
...
# 2511 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
...
# 2578 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellSave(xmlShellCtxtPtr ctxt, char *filename,
             xmlNodePtr node __attribute__((unused)),
             xmlNodePtr node2 __attribute__((unused)))
{
    if ((ctxt == ((void*)0)) || (ctxt->doc == ((void*)0)))
        return (-1);
    if ((filename == ((void*)0)) || (filename[0] == 0))
...
# 2640 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
                 ...
                 xmlNodePtr node2 __attribute__((unused)))
{
    ...
    if ((ctxt == ((void*)0)) || (ctxt->doc == ((void*)0))) return(-1);
    vctxt.userData = stderr;
    vctxt.error = (xmlValidityErrorFunc) fprintf;
    vctxt.warning = (xmlValidityWarningFunc) fprintf;

    if ((dtd == ((void*)0)) || (dtd[0] == 0)) {
        res = xmlValidateDocument(&vctxt, ctxt->doc);
    } else {
        xmlDtdPtr subset;

        subset = xmlParseDTD(((void*)0), (xmlChar *) dtd);
        if (subset != ((void*)0)) {
...
# 2682 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellDu(xmlShellCtxtPtr ctxt,
           char *arg __attribute__((unused)), xmlNodePtr tree,
           xmlNodePtr node2 __attribute__((unused)))
{
    xmlNodePtr node;
    int indent = 0, i;
...
# 2767 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
int
xmlShellPwd(xmlShellCtxtPtr ctxt __attribute__((unused)), char *buffer,
            xmlNodePtr node, xmlNodePtr node2 __attribute__((unused)))
{
    xmlChar *path;

    if ((node == ((void*)0)) || (buffer == ((void*)0)))
        return (-1);

    path = xmlGetNodePath(node);
    if (path == ((void*)0))
 return (-1);
# 2788 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
...
# 2806 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c"
void
xmlShell(xmlDocPtr doc, char *filename, xmlShellReadlineFunc input,
         FILE * output)
{
    char prompt[500] = "/ > ";
    char *cmdline = ((void*)0), *cur;
    char command[100];
    char arg[400];
    int i;
    ...
    while (1) {
        ...
        else if ((ctxt->node != ((void*)0)) && (ctxt->node->name) &&
  ...
  if (!strcmp(command, "help")) {
    ...
    fprintf(ctxt->output, "\tgrep string  search for a string in the subtree\n");
            ...
            xmlShellValidate(ctxt, arg, ((void*)0), ((void*)0));

        } else if (!strcmp(command, "load")) {
            xmlShellLoad(ctxt, arg, ((void*)0), ((void*)0));

        } else if (!strcmp(command, "relaxng")) {
            xmlShellRNGValidate(ctxt, arg, ((void*)0), ((void*)0));


        } else if (!strcmp(command, "save")) {
            xmlShellSave(ctxt, arg, ((void*)0), ((void*)0));
        } else if (!strcmp(command, "write")) {
     if (arg[0] == 0)
  (*(__xmlGenericError()))((*(__xmlGenericErrorContext())),
                        "Write command requires a filename argument\n");
     else
  xmlShellWrite(ctxt, arg, ctxt->node, ((void*)0));

        } else if (!strcmp(command, "grep")) {
            xmlShellGrep(ctxt, arg, ctxt->node, ((void*)0));
            ...
            if (!xmlShellPwd(ctxt, dir, ctxt->node, ((void*)0)))
                fprintf(ctxt->output, "%s\n", dir);
        } else if (!strcmp(command, "du")) {
            if (arg[0] == 0) {
                xmlShellDu(ctxt, ((void*)0), ctxt->node, ((void*)0));
            } else {
                ...
                if (list != ((void*)0)) {
                    switch (list->type) {
                        ...
                        case XPATH_NODESET:{
                            ...
                            if (list->nodesetval == ((void*)0))
                                break;

                            for (indx = 0;
                                 indx < list->nodesetval->nodeNr;
                                 indx++)
                                xmlShellDu(ctxt, ((void*)0),
                                           list->nodesetval->
                                           nodeTab[indx], ((void*)0));
                            break;
                        }
                ...
                ctxt->pctxt->node = ((void*)0);
            }
        } else if (!strcmp(command, "base")) {
            xmlShellBase(ctxt, ((void*)0), ctxt->node, ((void*)0));
        } else if (!strcmp(command, "set")) {
     xmlShellSetContent(ctxt, arg, ctxt->node, ((void*)0));
  ...
  (*(__xmlGenericError()))((*(__xmlGenericErrorContext())),
    "setns: prefix=[nsuri] required\n");
                ...
                xmlShellRegisterNamespace(ctxt, arg, ((void*)0), ((void*)0));
            }
        } else if (!strcmp(command, "setrootns")) {
     xmlNodePtr root;

     root = xmlDocGetRootElement(ctxt->doc);
     xmlShellRegisterRootNamespaces(ctxt, ((void*)0), root, ((void*)0));
  ...
  xmlXPathFreeObject(list);
            ...
            xmlShellSetBase(ctxt, arg, ctxt->node, ((void*)0));
            ...
            if (arg[0] == 0) {
                if (dir)
                    xmlShellDir(ctxt, ((void*)0), ctxt->node, ((void*)0));
                else
                    xmlShellList(ctxt, ((void*)0), ctxt->node, ((void*)0));
            } else {
                ctxt->pctxt->node = ctxt->node;
    ...
    if (list->nodesetval == ((void*)0))
        break;
                                ...
                                for (indx = 0;
                                     ...
                                     indx++) {
                                    if (dir)
                                        xmlShellDir(ctxt, ((void*)0),
                                                    list->nodesetval->
                                                    nodeTab[indx], ((void*)0));
                                    else
                                        xmlShellList(ctxt, ((void*)0),
                                                     list->nodesetval->
                                                     nodeTab[indx], ((void*)0));
                                }
                                break;
     ...
     ctxt->node = ((void*)0);
        ...
        (*(__xmlGenericError()))((*(__xmlGenericErrorContext())),
          ...
          list->nodesetval->nodeNr);
            ...
            if (arg[0] == 0) {
                xmlShellCat(ctxt, ((void*)0), ctxt->node, ((void*)0));
            } else {
                ctxt->pctxt->node = ctxt->node;
...
# 1 "./elfgcchack.h" 1
# 3428 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/debugXML.c" 2
