# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
int xmlNop(void);
# 9 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 11 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
# 14 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
# 18 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
# 22 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
# 30 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
# 46 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
...
# 47 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2

# 1 "./include/libxml/xmlerror.h" 1
# 49 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
...
static xmlMutexPtr xmlMemMutex = ((void*)0);

void xmlMallocBreakpoint(void);
# 89 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
...
# 118 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
static unsigned int block=0;
static unsigned int xmlMemStopAtBlock = 0;
static void *xmlMemTraceBlockAt = ((void*)0);




static void debugmem_tag_error(void *addr);
# 144 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void
xmlMallocBreakpoint(void) {
    (*(__xmlGenericError()))((*(__xmlGenericErrorContext())),
     "xmlMallocBreakpoint reached on block %d\n", xmlMemStopAtBlock);
}
# 161 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void *
xmlMallocLoc(size_t size, const char * file, int line)
{
    MEMHDR *p;
 ...
 return(((void*)0));
    ...
    ret = ((void *) (((char *) (p)) + (((sizeof(MEMHDR) + (sizeof(double)-1)) / sizeof(double) ) * sizeof(double))));
...
# 230 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void *
xmlMallocAtomicLoc(size_t size, const char * file, int line)
{
    MEMHDR *p;
...
# 303 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void *
xmlMemMalloc(size_t size)
{
    return(xmlMallocLoc(size, "none", 0));
}
# 321 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void *
xmlReallocLoc(void *ptr,size_t size, const char * file, int line)
{
    MEMHDR *p, *tmp;
    ...
    p = ((MEMHDR *) (((char *) (ptr)) - (((sizeof(MEMHDR) + (sizeof(double)-1)) / sizeof(double) ) * sizeof(double))));
    number = p->mh_number;
...
# 405 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void *
xmlMemRealloc(void *ptr,size_t size) {
...
xmlMemFree(void *ptr)
{
 ...
 xmlMallocBreakpoint();
    ...
    free(p);
# 472 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
    return;
...
# 492 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
char *
xmlMemStrdupLoc(const char *str, const char *file, int line)
{
    char *s;
...
# 550 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
char *
xmlMemoryStrdup(const char *str) {
    return(xmlMemStrdupLoc(str, "none", 0));
}
# 563 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
xmlMemUsed(void) {
    int res;
...
# 581 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
xmlMemBlocks(void) {
    int res;
...
# 663 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void
xmlMemDisplayLast(FILE *fp, long nbBytes)
{
...
# 720 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
    fprintf(fp,"Memory list not compiled (MEM_LIST not defined !)\n");

    if (old_fp == ((void*)0))
 fclose(fp);
}
# 734 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void
xmlMemDisplay(FILE *fp)
{
# 747 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
    FILE *old_fp = fp;
...
# 800 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
    fprintf(fp,"Memory list not compiled (MEM_LIST not defined !)\n");

    if (old_fp == ((void*)0))
 fclose(fp);
}
# 841 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
...
# 864 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
void
xmlMemShow(FILE *fp, int nr __attribute__((unused)))
{
...
# 901 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
}
...
xmlMemoryDump(void)
{
# 926 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
}
# 942 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
xmlInitMemory(void)
{

     char *breakpoint;
# 956 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
...
# 1019 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
...
# 1057 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
...
# 1085 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
...
# 1129 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c"
int
...
# 1 "./elfgcchack.h" 1
# 1143 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xmlmemory.c" 2
