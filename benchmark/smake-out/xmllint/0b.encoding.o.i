# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
# 24 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 27 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 28 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 31 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 34 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 38 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 159 "./include/libxml/encoding.h" 2
 ...
 isolat1ToUTF8 (unsigned char *out,
      ...
      const unsigned char *in,
      int *inlen);
# 41 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 44 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2


# 1 "./include/libxml/xmlerror.h" 1
# 47 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
...
# 49 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
# 1 "./enc.h" 1
# 21 "./enc.h"
...
# 50 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2

static xmlCharEncodingHandlerPtr xmlUTF16LEHandler = ((void*)0);
static xmlCharEncodingHandlerPtr xmlUTF16BEHandler = ((void*)0);
...
static xmlCharEncodingAliasPtr xmlCharEncodingAliases = ((void*)0);
static int xmlCharEncodingAliasesNb = 0;
static int xmlCharEncodingAliasesMax = 0;
# 75 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
...
# 96 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static void __attribute__((__format__(__printf__,2,0)))
xmlEncodingErr(xmlParserErrors error, const char *msg, const char *val)
{
    __xmlRaiseError(((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0),
                    XML_FROM_I18N, error, XML_ERR_FATAL,
                    ((void*)0), 0, val, ((void*)0), ((void*)0), 0, 0, msg, val);
}
# 172 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 219 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 303 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
isolat1ToUTF8(unsigned char* out, int *outlen,
    ...
    if ((out == ((void*)0)) || (in == ((void*)0)) || (outlen == ((void*)0)) || (inlen == ((void*)0)))
 return(-1);
...
# 351 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
           ...
           const unsigned char* inb, int *inlenb)
{
    ...
    if ((out == ((void*)0)) || (inb == ((void*)0)) || (outlen == ((void*)0)) || (inlenb == ((void*)0)))
 return(-1);
    if (*outlen > *inlenb) {
 len = *inlenb;
    } else {
...
# 392 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
# 484 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 569 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 678 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 722 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 811 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
            ...
            const unsigned char* in, int *inlen)
{
    ...
    if ((outb == ((void*)0)) || (outlen == ((void*)0)) || (inlen == ((void*)0))) return(-1);
    if (in == ((void*)0)) {
 *outlen = 0;
 *inlen = 0;
 return(0);
...
# 922 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
xmlCharEncoding
...
xmlCleanupEncodingAliases(void) {
 ...
 if (xmlCharEncodingAliases[i].name != ((void*)0))
     xmlFree((char *) xmlCharEncodingAliases[i].name);
 if (xmlCharEncodingAliases[i].alias != ((void*)0))
     xmlFree((char *) xmlCharEncodingAliases[i].alias);
    }
    xmlCharEncodingAliasesNb = 0;
    xmlCharEncodingAliasesMax = 0;
    xmlFree(xmlCharEncodingAliases);
    xmlCharEncodingAliases = ((void*)0);
}
# 1009 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
const char *
xmlGetEncodingAlias(const char *alias) {
    int i;
    char upper[100];
...
# 1047 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
# 1104 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
xmlDelEncodingAlias(const char *alias) {
    int i;
...
# 1140 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
xmlCharEncoding
xmlParseCharEncoding(const char* name)
{
    const char *alias;
...
# 1224 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
const char*
xmlGetCharEncodingName(xmlCharEncoding enc) {
    switch (enc) {
...
# 1288 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static xmlCharEncodingHandlerPtr *handlers = ((void*)0);
...
static xmlCharEncodingHandlerPtr xmlDefaultCharEncodingHandler = ((void*)0);
# 1308 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
xmlCharEncodingHandlerPtr
xmlNewCharEncodingHandler(const char *name,
                          xmlCharEncodingInputFunc input,
                          xmlCharEncodingOutputFunc output) {
 ...
 return(((void*)0));
    ...
    handler->iconv_in = ((void*)0);
    handler->iconv_out = ((void*)0);
# 1371 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
...
# 1387 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
void
xmlInitCharEncodingHandlers(void) {
    ...
    handlers = (xmlCharEncodingHandlerPtr *)
        xmlMalloc(50 * sizeof(xmlCharEncodingHandlerPtr));
 ...
 return;
    ...
    xmlNewCharEncodingHandler("HTML", ((void*)0), UTF8ToHtml);
# 1437 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
}
...
xmlCleanupCharEncodingHandlers(void) {
 ...
 if (handlers[nbCharEncodingHandler] != ((void*)0)) {
     if (handlers[nbCharEncodingHandler]->name != ((void*)0))
  xmlFree(handlers[nbCharEncodingHandler]->name);
    ...
    xmlDefaultCharEncodingHandler = ((void*)0);
}
...
# 1497 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
xmlCharEncodingHandlerPtr
xmlGetCharEncodingHandler(xmlCharEncoding enc) {
    xmlCharEncodingHandlerPtr handler;
...
# 1631 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
xmlCharEncodingHandlerPtr
xmlFindCharEncodingHandler(const char *name) {
    const char *nalias;
    const char *norig;
...
# 1753 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
...
# 1791 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
static int
...
# 1922 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
xmlCharEncFirstLineInt(xmlCharEncodingHandler *handler, xmlBufferPtr out,
    ...
    toconv = in->use;
# 1944 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    if (len >= 0) {
        if (toconv > len)
            toconv = len;
    } else {
 ...
 out->content[out->use] = 0;
    ...
    else if (handler->iconv_in != ((void*)0)) {
...
# 2009 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    if (ret == -3) ret = 0;
    if (ret == -1) ret = 0;
    return(ret);
}
# 2028 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
xmlCharEncFirstLine(xmlCharEncodingHandler *handler, xmlBufferPtr out,
                 xmlBufferPtr in) {
    return(xmlCharEncFirstLineInt(handler, out, in, -1));
}
# 2049 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
# 2078 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    if (len >= 0) {
    ...
    else if (input->encoder->iconv_in != ((void*)0)) {
...
# 2120 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    switch (ret) {
        case 0:
...
# 2175 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
# 2237 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    switch (ret) {
        case 0:
...
# 2293 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
# 2345 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    switch (ret) {
        case 0:
...
# 2405 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
xmlCharEncOutput(xmlOutputBufferPtr output, int init)
{
    ...
    if ((output == ((void*)0)) || (output->encoder == ((void*)0)) ||
        (output->buffer == ((void*)0)) || (output->conv == ((void*)0)))
        return (-1);
    out = output->conv;
    in = output->buffer;
...
retry:
    ...
    if (init) {
        c_in = 0;
        c_out = written;
        if (output->encoder->output != ((void*)0)) {
        ...
        else if (output->encoder->iconv_out != ((void*)0)) {
            ret = xmlIconvWrapper(output->encoder->iconv_out, xmlBufEnd(out),
                                  &c_out, ((void*)0), &c_in);
            xmlBufAddLen(out, c_out);
        }
# 2460 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
        return(0);
    }
...
# 2527 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    else {
  ...
  xmlChar charref[20];
# 2592 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
...
# 2636 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
...
retry:
 ...
 else if (handler->iconv_out != ((void*)0)) {
     ret = xmlIconvWrapper(handler->iconv_out, &out->content[out->use],
      &written, ((void*)0), &toconv);
     out->use += written;
     out->content[out->use] = 0;
 }
# 2690 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
        return(0);
    }
...
# 2754 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    else {
 xmlEncodingErr(XML_I18N_NO_OUTPUT,
         "xmlCharEncOutFunc: no output function !\n", ((void*)0));
 return(-1);
  ...
  xmlChar charref[20];
# 2819 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
  charref_len = snprintf((char *) &charref[0], sizeof(charref),
     "&#%d;", cur);
...
# 2852 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
int
xmlCharEncCloseFunc(xmlCharEncodingHandler *handler) {
    int ret = 0;
    int tofree = 0;
  ...
  break;
    ...
    if ((handler_in_list == 0) &&
        ((handler->iconv_out != ((void*)0)) || (handler->iconv_in != ((void*)0)))) {
        tofree = 1;
 if (handler->iconv_out != ((void*)0)) {
     if (iconv_close(handler->iconv_out))
  ret = -1;
     handler->iconv_out = ((void*)0);
 }
 if (handler->iconv_in != ((void*)0)) {
     if (iconv_close(handler->iconv_in))
  ret = -1;
     handler->iconv_in = ((void*)0);
 }
    }
# 2902 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    if (tofree) {
...
# 2918 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
    return(ret);
}
# 2935 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
long
xmlByteConsumed(xmlParserCtxtPtr ctxt) {
...
# 3001 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
            } else {
...
# 4085 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c"
# 1 "./elfgcchack.h" 1
# 4086 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/encoding.c" 2
