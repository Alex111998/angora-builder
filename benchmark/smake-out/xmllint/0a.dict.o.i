# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
# 20 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 21 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
...
# 23 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
...
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 28 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
# 45 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 46 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
...
# 48 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
...
# 56 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2


# 1 "./include/libxml/xmlerror.h" 1
# 59 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
# 92 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
...
static xmlRMutexPtr xmlDictMutex = ((void*)0);
...
# 159 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
int xmlInitializeDict(void) {
    return(0);
}
# 175 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
int __xmlInitializeDict(void) {
...
# 220 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
void
xmlDictCleanup(void) {
    if (!xmlDictInitialized)
        return;
...
# 240 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
...
# 304 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
static const xmlChar *
...
# 374 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
static uint32_t
...
# 406 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
...
# 443 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
static unsigned long
...
# 477 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
static unsigned long
...
# 538 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
xmlDictPtr
xmlDictCreate(void) {
    xmlDictPtr dict;
    ...
    if (dict) {
        ...
        dict->size = 128;
 dict->nbElems = 0;
        dict->dict = xmlMalloc(128 * sizeof(xmlDictEntry));
 dict->strings = ((void*)0);
 dict->subdict = ((void*)0);
        if (dict->dict) {
     memset(dict->dict, 0, 128 * sizeof(xmlDictEntry));
...
# 585 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
xmlDictPtr
xmlDictCreateSub(xmlDictPtr sub) {
...
# 608 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
int
xmlDictReference(xmlDictPtr dict) {
    if (!xmlDictInitialized)
        if (!__xmlInitializeDict())
...
# 630 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
static int
xmlDictGrow(xmlDictPtr dict, size_t size) {
 ...
 if (keep_keys)
     ...
     okey = (((dict)->size == 128) ? xmlDictComputeFastKey(olddict[i].name, olddict[i].len, (dict)->seed) : xmlDictComputeBigKey(olddict[i].name, olddict[i].len, (dict)->seed));
 key = okey % dict->size;
 ...
 while (iter) {
  ...
  okey = (((dict)->size == 128) ? xmlDictComputeFastKey(iter->name, iter->len, (dict)->seed) : xmlDictComputeBigKey(iter->name, iter->len, (dict)->seed));
     key = okey % dict->size;
     if (dict->dict[key].valid == 0) {
...
# 763 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
void
xmlDictFree(xmlDictPtr dict) {
    size_t i;
...
# 828 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
const xmlChar *
xmlDictLookup(xmlDictPtr dict, const xmlChar *name, int len) {
 ...
 return(((void*)0));
    ...
    okey = (((dict)->size == 128) ? xmlDictComputeFastKey(name, l, (dict)->seed) : xmlDictComputeBigKey(name, l, (dict)->seed));
    key = okey % dict->size;
    if (dict->dict[key].valid == 0) {
 insert = ((void*)0);
    } else {
 ...
 if ((insert->okey == okey) && (insert->len == l)) {
  ...
  return(insert->name);
    ...
    if (dict->subdict) {
        ...
        if (((dict->size == 128) &&
      (dict->subdict->size != 128)) ||
            ((dict->size != 128) &&
      (dict->subdict->size == 128)))
     skey = (((dict->subdict)->size == 128) ? xmlDictComputeFastKey(name, l, (dict->subdict)->seed) : xmlDictComputeBigKey(name, l, (dict->subdict)->seed));
 else
     skey = okey;
 ...
 insert->next = entry;
    ...
    if ((nbi > 3) &&
        (dict->size <= ((8 * 2048 / 2) / 3))) {
 if (xmlDictGrow(dict, 3 * 2 * dict->size) != 0)
     return(((void*)0));
    }
...
# 968 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
const xmlChar *
...
# 1076 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
const xmlChar *
xmlDictQLookup(xmlDictPtr dict, const xmlChar *prefix, const xmlChar *name) {
 ...
 return(((void*)0));
    ...
    okey = (((prefix) == ((void*)0)) ? ((((dict)->size == 128) ? xmlDictComputeFastKey(name, l, (dict)->seed) : xmlDictComputeBigKey(name, l, (dict)->seed))) : (((dict)->size == 128) ? xmlDictComputeFastQKey(prefix, plen, name, l, (dict)->seed) : xmlDictComputeBigQKey(prefix, plen, name, l, (dict)->seed)));
    key = okey % dict->size;
    if (dict->dict[key].valid == 0) {
 insert = ((void*)0);
    } else {
 ...
 if ((insert->okey == okey) && (insert->len == len) &&
    ...
    if (dict->subdict) {
      ...
      (dict->subdict->size != 128)) ||
            ((dict->size != 128) &&
      (dict->subdict->size == 128)))
     skey = (((prefix) == ((void*)0)) ? ((((dict->subdict)->size == 128) ? xmlDictComputeFastKey(name, l, (dict->subdict)->seed) : xmlDictComputeBigKey(name, l, (dict->subdict)->seed))) : (((dict->subdict)->size == 128) ? xmlDictComputeFastQKey(prefix, plen, name, l, (dict->subdict)->seed) : xmlDictComputeBigQKey(prefix, plen, name, l, (dict->subdict)->seed)));
 else
     skey = okey;
 ...
 insert->next = entry;
    ...
    if ((nbi > 3) &&
        (dict->size <= ((8 * 2048 / 2) / 3)))
 xmlDictGrow(dict, 3 * 2 * dict->size);


    return(ret);
}
# 1181 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
int
...
# 1207 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
int
xmlDictSize(xmlDictPtr dict) {
    if (dict == ((void*)0))
 return(-1);
...
# 1226 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
size_t
...
# 1246 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c"
size_t
xmlDictGetUsage(xmlDictPtr dict) {
    xmlDictStringsPtr pool;
    size_t limit = 0;
...
# 1 "./elfgcchack.h" 1
# 1263 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/dict.c" 2
