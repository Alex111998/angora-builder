# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
# 12 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 13 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 16 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 18 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 21 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 24 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 27 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 30 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 33 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
...
# 36 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
# 51 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
static xlinkHandlerPtr xlinkDefaultHandler = ((void*)0);
static xlinkNodeDetectFunc xlinkDefaultDetect = ((void*)0);
# 61 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
xlinkHandlerPtr
xlinkGetDefaultHandler(void) {
    return(xlinkDefaultHandler);
}
# 73 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
void
xlinkSetDefaultHandler(xlinkHandlerPtr handler) {
    xlinkDefaultHandler = handler;
}
# 85 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
xlinkNodeDetectFunc
xlinkGetDefaultDetect (void) {
...
# 122 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
xlinkType
xlinkIsLink (xmlDocPtr doc, xmlNodePtr node) {
    xmlChar *type = ((void*)0), *role = ((void*)0);
    xlinkType ret = XLINK_TYPE_NONE;

    if (node == ((void*)0)) return(XLINK_TYPE_NONE);
    if (doc == ((void*)0)) doc = node->doc;
    if ((doc != ((void*)0)) && (doc->type == XML_HTML_DOCUMENT_NODE)) {



    } else if ((node->ns != ((void*)0)) &&
               (xmlStrEqual(node->ns->href, ((xmlChar *) "http://www.w3.org/1999/xhtml/")))) {
# 143 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c"
    }
    ...
    type = xmlGetNsProp(node, (xmlChar *)"type", ((xmlChar *) "http://www.w3.org/1999/xlink/namespace/"));
    if (type != ((void*)0)) {
 if (xmlStrEqual(type, (xmlChar *) "simple")) {
            ret = XLINK_TYPE_SIMPLE;
 } else if (xmlStrEqual(type, (xmlChar *) "extended")) {
     role = xmlGetNsProp(node, (xmlChar *) "role", ((xmlChar *) "http://www.w3.org/1999/xlink/namespace/"));
     if (role != ((void*)0)) {
  xmlNsPtr xlink;
  xlink = xmlSearchNs(doc, node, ((xmlChar *) "http://www.w3.org/1999/xlink/namespace/"));
  if (xlink == ((void*)0)) {

      if (xmlStrEqual(role, (xmlChar *)"xlink:external-linkset"))
   ...
   ret = XLINK_TYPE_EXTENDED_SET;
    ...
    if (type != ((void*)0)) xmlFree(type);
    if (role != ((void*)0)) xmlFree(role);
    return(ret);
}
...
# 1 "./elfgcchack.h" 1
# 184 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/xlink.c" 2
