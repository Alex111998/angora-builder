# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
# 21 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 22 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 24 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
...
# 26 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 29 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
# 40 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
...
# 41 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2


# 1 "./include/libxml/xmlerror.h" 1
# 44 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
# 53 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
...
# 173 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
xmlHashTablePtr
xmlHashCreate(int size) {
...
# 207 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
xmlHashTablePtr
...
# 228 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
static int
...
# 319 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void
...
# 374 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashAddEntry(xmlHashTablePtr table, const xmlChar *name, void *userdata) {
    return(xmlHashAddEntry3(table, name, ((void*)0), ((void*)0), userdata));
}
# 391 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashAddEntry2(xmlHashTablePtr table, const xmlChar *name,
         const xmlChar *name2, void *userdata) {
    return(xmlHashAddEntry3(table, name, name2, ((void*)0), userdata));
}
# 410 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashUpdateEntry(xmlHashTablePtr table, const xmlChar *name,
            void *userdata, xmlHashDeallocator f) {
    return(xmlHashUpdateEntry3(table, name, ((void*)0), ((void*)0), userdata, f));
}
# 430 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashUpdateEntry2(xmlHashTablePtr table, const xmlChar *name,
            const xmlChar *name2, void *userdata,
     xmlHashDeallocator f) {
    return(xmlHashUpdateEntry3(table, name, name2, ((void*)0), userdata, f));
}
# 446 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
xmlHashLookup(xmlHashTablePtr table, const xmlChar *name) {
    return(xmlHashLookup3(table, name, ((void*)0), ((void*)0)));
}
# 461 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
xmlHashLookup2(xmlHashTablePtr table, const xmlChar *name,
       const xmlChar *name2) {
    return(xmlHashLookup3(table, name, name2, ((void*)0)));
}
# 477 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
xmlHashQLookup(xmlHashTablePtr table, const xmlChar *prefix,
               const xmlChar *name) {
    return(xmlHashQLookup3(table, prefix, name, ((void*)0), ((void*)0), ((void*)0), ((void*)0)));
}
# 495 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
...
# 516 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashAddEntry3(xmlHashTablePtr table, const xmlChar *name,
 ...
 insert->next = entry;
    ...
    if (len > 8)
 xmlHashGrow(table, 8 * table->size);

    return(0);
}
# 632 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
...
# 754 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
...
# 798 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void *
xmlHashQLookup3(xmlHashTablePtr table,
                const xmlChar *prefix, const xmlChar *name,
  const xmlChar *prefix2, const xmlChar *name2,
...
stubHashScannerFull (void *payload, void *data, const xmlChar *name,
                     const xmlChar *name2 __attribute__((unused)),
       const xmlChar *name3 __attribute__((unused))) {
    stubData *stubdata = (stubData *) data;
    stubdata->hashscanner (payload, stubdata->data, (xmlChar *) name);
}
# 844 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void
...
# 860 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void
...
# 911 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void
...
# 932 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
void
...
# 974 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
xmlHashTablePtr
...
# 1016 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashSize(xmlHashTablePtr table) {
    if (table == ((void*)0))
 return(-1);
...
# 1035 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int xmlHashRemoveEntry(xmlHashTablePtr table, const xmlChar *name,
         xmlHashDeallocator f) {
    return(xmlHashRemoveEntry3(table, name, ((void*)0), ((void*)0), f));
}
# 1053 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashRemoveEntry2(xmlHashTablePtr table, const xmlChar *name,
   const xmlChar *name2, xmlHashDeallocator f) {
    return(xmlHashRemoveEntry3(table, name, name2, ((void*)0), f));
}
# 1073 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c"
int
xmlHashRemoveEntry3(xmlHashTablePtr table, const xmlChar *name,
...
# 1 "./elfgcchack.h" 1
# 1125 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/hash.c" 2
