# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
# 11 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 12 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 14 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
...
# 16 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
...
# 23 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
...
# 29 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
# 49 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
...
extern int pthread_cond_signal ()
    __attribute((weak));
# 104 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
struct _xmlMutex {

    pthread_mutex_t lock;
# 115 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
};
...
struct _xmlRMutex {
    ...
    pthread_t tid;
    pthread_cond_t cv;
# 137 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
};
# 146 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
static pthread_key_t globalkey;
static pthread_t mainthread;
static pthread_once_t once_control = 0;
static pthread_once_t once_control_init = 0;
static pthread_mutex_t global_init_lock = { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } };
# 174 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
static xmlRMutexPtr xmlLibraryLock = ((void*)0);


static void xmlOnceInit(void);
# 188 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
xmlMutexPtr
xmlNewMutex(void)
{
    xmlMutexPtr tok;
...
# 207 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
    return (tok);
}
# 217 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
void
xmlFreeMutex(xmlMutexPtr tok)
{
    if (tok == ((void*)0))
...
# 260 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
...
# 284 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
# 296 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
xmlRMutexPtr
xmlNewRMutex(void)
{
    xmlRMutexPtr tok;
...
# 320 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
    return (tok);
}
# 330 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
void
xmlFreeRMutex(xmlRMutexPtr tok __attribute__((unused)))
{
    if (tok == ((void*)0))
        return;
...
xmlRMutexLock(xmlRMutexPtr tok)
{
    ...
    tok->held = 1;
    pthread_mutex_unlock(&tok->lock);
# 391 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
...
void
xmlRMutexUnlock(xmlRMutexPtr tok __attribute__((unused)))
{
    if (tok == ((void*)0))
        return;
    ...
    pthread_mutex_unlock(&tok->lock);
# 430 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
...
__xmlGlobalInitMutexLock(void)
{
    ...
    if (pthread_mutex_lock != ((void*)0))
        pthread_mutex_lock(&global_init_lock);
# 507 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
...
__xmlGlobalInitMutexUnlock(void)
{
    ...
    if (pthread_mutex_unlock != ((void*)0))
...
{
# 541 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
# 561 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
static void
...
# 580 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
...
# 658 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
xmlGlobalStatePtr
xmlGetGlobalState(void)
{
    ...
    if ((globalval = (xmlGlobalState *)
         pthread_getspecific(globalkey)) == ((void*)0)) {
 ...
 if (tsd == ((void*)0))
    ...
    return (globalval);
# 751 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
# 768 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
int
xmlGetThreadId(void)
{
...
# 797 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
int
xmlIsMainThread(void)
{
    ...
    if (libxml_is_threaded == 0)
        return (1);
    pthread_once(&once_control, xmlOnceInit);
# 816 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
...
xmlInitThreads(void)
{
    ...
    if (libxml_is_threaded == -1) {
        if ((pthread_once != ((void*)0)) &&
            (pthread_getspecific != ((void*)0)) &&
            (pthread_setspecific != ((void*)0)) &&
            (pthread_key_create != ((void*)0)) &&
            (pthread_key_delete != ((void*)0)) &&
            (pthread_mutex_init != ((void*)0)) &&
            (pthread_mutex_destroy != ((void*)0)) &&
            (pthread_mutex_lock != ((void*)0)) &&
            (pthread_mutex_unlock != ((void*)0)) &&
            (pthread_cond_init != ((void*)0)) &&
            (pthread_cond_destroy != ((void*)0)) &&
            (pthread_cond_wait != ((void*)0)) &&
            (pthread_equal != ((void*)0)) &&
            (pthread_self != ((void*)0)) &&
            (pthread_cond_signal != ((void*)0))) {
...
# 910 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
void
xmlCleanupThreads(void)
{
...
# 940 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
# 953 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
static void
xmlOnceInit(void)
{
    ...
    __xmlInitializeDict();
# 985 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
}
# 1039 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c"
# 1 "./elfgcchack.h" 1
# 1040 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/threads.c" 2
