# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
# 24 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 29 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 30 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 32 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 33 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 34 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 35 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
# 128 "./include/libxml/schematron.h"
     ...
     xmlSchematronValidateDoc (xmlSchematronValidCtxtPtr ctxt,
      xmlDocPtr instance);
# 36 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
...
static const xmlChar *xmlSchematronNs = (xmlChar *) "http://purl.oclc.org/dsdl/schematron";
static const xmlChar *xmlOldSchematronNs = (xmlChar *) "http://www.ascc.net/xml/schematron";
# 73 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
typedef enum {
...
# 227 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
...
# 248 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
...
# 275 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
...
# 306 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
                     ...
                     xmlNodePtr node, xmlChar *test, xmlChar *report)
{
    ...
    if ((ctxt == ((void*)0)) || (rule == ((void*)0)) || (node == ((void*)0)) ||
        (test == ((void*)0)))
        return(((void*)0));
...
xmlSchematronFreeTests(xmlSchematronTestPtr tests) {
    ...
    while (tests != ((void*)0)) {
        next = tests->next;
 if (tests->test != ((void*)0))
     xmlFree(tests->test);
 if (tests->comp != ((void*)0))
     xmlXPathFreeCompExpr(tests->comp);
 if (tests->report != ((void*)0))
     xmlFree(tests->report);
 xmlFree(tests);
 tests = next;
    }
}
# 390 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
...
xmlSchematronFreeRules(xmlSchematronRulePtr rules) {
 ...
 if (rules->context != ((void*)0))
     xmlFree(rules->context);
 if (rules->pattern)
     xmlFreePattern(rules->pattern);
 if (rules->report != ((void*)0))
     xmlFree(rules->report);
 xmlFree(rules);
 rules = next;
    }
}
# 483 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
                     ...
                     xmlSchematronPtr schema, xmlNodePtr node, xmlChar *name)
{
    ...
    if ((ctxt == ((void*)0)) || (schema == ((void*)0)) || (node == ((void*)0)) || (name == ((void*)0)))
        return(((void*)0));
...
xmlSchematronFreePatterns(xmlSchematronPatternPtr patterns) {
    ...
    while (patterns != ((void*)0)) {
        next = patterns->next;
 if (patterns->name != ((void*)0))
     xmlFree(patterns->name);
 xmlFree(patterns);
 patterns = next;
    }
}
# 539 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
...
xmlSchematronNewSchematron(xmlSchematronParserCtxtPtr ctxt)
{
    ...
    if (ret == ((void*)0)) {
        xmlSchematronPErrMemory(ctxt, "allocating schema", ((void*)0));
        return (((void*)0));
    }
...
xmlSchematronFree(xmlSchematronPtr schema)
{
    ...
    if ((schema->doc != ((void*)0)) && (!(schema->preserve)))
        xmlFreeDoc(schema->doc);

    if (schema->namespaces != ((void*)0))
...
# 589 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
xmlSchematronParserCtxtPtr
xmlSchematronNewParserCtxt(const char *URL)
{
    ...
    if (ret == ((void*)0)) {
        xmlSchematronPErrMemory(((void*)0), "allocating schema parser context",
                                ((void*)0));
        return (((void*)0));
    }
    ...
    if (ret->xctxt == ((void*)0)) {
        xmlSchematronPErrMemory(((void*)0), "allocating schema parser XPath context",
                                ((void*)0));
...
# 631 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
xmlSchematronParserCtxtPtr
...
# 670 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
xmlSchematronParserCtxtPtr
xmlSchematronNewDocParserCtxt(xmlDocPtr doc)
{
    xmlSchematronParserCtxtPtr ret;
...
# 803 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
                          ...
                          const xmlChar *prefix, const xmlChar *ns)
{
 ...
 if (ctxt->namespaces == ((void*)0)) {
     xmlSchematronPErrMemory(((void*)0), "allocating parser namespaces",
        ((void*)0));
     return;
 }
        ctxt->nbNamespaces = 0;
 ...
 ctxt->maxNamespaces *= 2;
    ...
    ctxt->nbNamespaces++;
    ctxt->namespaces[2 * ctxt->nbNamespaces] = ((void*)0);
    ctxt->namespaces[2 * ctxt->nbNamespaces + 1] = ((void*)0);

}
# 848 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
         ...
         xmlNodePtr rule)
{
    ...
    if ((ctxt == ((void*)0)) || (rule == ((void*)0))) return;

    context = xmlGetNoNsProp(rule, (xmlChar *) "context");
    if (context == ((void*)0)) {
 ...
 if (ruleptr == ((void*)0)) {
    ...
    cur = rule->children;
    while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    while (cur != ((void*)0)) {
 if (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "assert")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
     nbChecks++;
     test = xmlGetNoNsProp(cur, (xmlChar *) "test");
     if (test == ((void*)0)) {
 ...
 } else if (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "report")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
     nbChecks++;
     test = xmlGetNoNsProp(cur, (xmlChar *) "test");
     if (test == ((void*)0)) {
  xmlSchematronPErr(ctxt, cur,
 ...
 xmlSchematronPErr(ctxt, rule,
     XML_SCHEMAP_NOROOT,
     "rule has no assert nor report element", ((void*)0), ((void*)0));
    }
}
# 958 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
xmlSchematronParsePattern(xmlSchematronParserCtxtPtr ctxt, xmlNodePtr pat)
{
    ...
    if ((ctxt == ((void*)0)) || (pat == ((void*)0))) return;

    id = xmlGetNoNsProp(pat, (xmlChar *) "id");
    if (id == ((void*)0)) {
 id = xmlGetNoNsProp(pat, (xmlChar *) "name");
    }
 ...
 if (id != ((void*)0))
    ...
    while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    while (cur != ((void*)0)) {
 if (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "rule")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
     xmlSchematronParseRule(ctxt, pattern, cur);
     nbRules++;
 } else {
     xmlSchematronPErr(ctxt, cur,
  XML_SCHEMAP_NOROOT,
  "Expecting a rule element instead of %s", cur->name, ((void*)0));
 }
 cur = cur->next;
 while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    }
 ...
 xmlSchematronPErr(ctxt, pat,
     XML_SCHEMAP_NOROOT,
     "Pattern has no rule element", ((void*)0), ((void*)0));
    }
}
# 1076 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
xmlSchematronPtr
xmlSchematronParse(xmlSchematronParserCtxtPtr ctxt)
{
    xmlSchematronPtr ret = ((void*)0);
    xmlDocPtr doc;
    xmlNodePtr root, cur;
    int preserve = 0;
    ...
    if (ctxt->URL != ((void*)0)) {
        doc = xmlReadFile((const char *) ctxt->URL, ((void*)0),
                   XML_PARSE_NOENT);
        if (doc == ((void*)0)) {
     xmlSchematronPErr(ctxt, ((void*)0),
     XML_SCHEMAP_FAILED_LOAD,
 ...
 ctxt->preserve = 0;
        ...
        doc = xmlReadMemory(ctxt->buffer, ctxt->size, ((void*)0), ((void*)0),
                     XML_PARSE_NOENT);
        if (doc == ((void*)0)) {
     xmlSchematronPErr(ctxt, ((void*)0),
     XML_SCHEMAP_FAILED_PARSE,
        ...
        ctxt->URL = xmlDictLookup(ctxt->dict, (xmlChar *) "in_memory_buffer", -1);
 ctxt->preserve = 0;
    } else if (ctxt->doc != ((void*)0)) {
        doc = ctxt->doc;
 preserve = 1;
 ctxt->preserve = 1;
    } else {
 ...
 if (!preserve) {
    ...
    if (!((root != ((void*)0)) && (root->type == XML_ELEMENT_NODE ) && (root->ns != ((void*)0)) && (xmlStrEqual(root->name, (const xmlChar *) "schema")) && ((xmlStrEqual(root->ns->href, xmlSchematronNs)) || (xmlStrEqual(root->ns->href, xmlOldSchematronNs))))) {
 ...
 goto exit;
    ...
    cur = root->children;
    while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    if (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "title")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
 ...
 while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    ...
    while (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "ns")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
        xmlChar *prefix = xmlGetNoNsProp(cur, (xmlChar *) "prefix");
        xmlChar *uri = xmlGetNoNsProp(cur, (xmlChar *) "uri");
 if ((uri == ((void*)0)) || (uri[0] == 0)) {
     xmlSchematronPErr(ctxt, cur,
  XML_SCHEMAP_NOROOT,
  "ns element has no uri", ((void*)0), ((void*)0));
 }
 if ((prefix == ((void*)0)) || (prefix[0] == 0)) {
     xmlSchematronPErr(ctxt, cur,
  XML_SCHEMAP_NOROOT,
  "ns element has no prefix", ((void*)0), ((void*)0));
 }
 if ((prefix) && (uri)) {
 ...
 while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    ...
    while (cur != ((void*)0)) {
 if (((cur != ((void*)0)) && (cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && (xmlStrEqual(cur->name, (const xmlChar *) "pattern")) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs))))) {
     xmlSchematronParsePattern(ctxt, cur);
     ret->nbPattern++;
 } else {
     xmlSchematronPErr(ctxt, cur,
  XML_SCHEMAP_NOROOT,
  "Expecting a pattern element instead of %s", cur->name, ((void*)0));
 }
 cur = cur->next;
 while (cur != ((void*)0)) { if ((cur->type == XML_ELEMENT_NODE ) && (cur->ns != ((void*)0)) && ((xmlStrEqual(cur->ns->href, xmlSchematronNs)) || (xmlStrEqual(cur->ns->href, xmlOldSchematronNs)))) break; cur = cur->next; };
    }
...
xmlSchematronGetNode(xmlSchematronValidCtxtPtr ctxt,
    ...
    if ((ctxt == ((void*)0)) || (cur == ((void*)0)) || (xpath == ((void*)0)))
        return(((void*)0));
    ...
    if ((ret->type == XPATH_NODESET) &&
        (ret->nodesetval != ((void*)0)) && (ret->nodesetval->nodeNr > 0))
 node = ret->nodesetval->nodeTab[0];

    xmlXPathFreeObject(ret);
    return(node);
}
# 1273 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
xmlSchematronReportOutput(xmlSchematronValidCtxtPtr ctxt __attribute__((unused)),
                          xmlNodePtr cur __attribute__((unused)),
                          const char *msg) {

    fprintf(stderr, "%s", msg);
}
# 1292 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static xmlChar *
xmlSchematronFormatReport(xmlSchematronValidCtxtPtr ctxt,
 ...
 else if (((child != ((void*)0)) && (child->type == XML_ELEMENT_NODE ) && (child->ns != ((void*)0)) && (xmlStrEqual(child->name, (const xmlChar *) "name")) && ((xmlStrEqual(child->ns->href, xmlSchematronNs)) || (xmlStrEqual(child->ns->href, xmlOldSchematronNs))))) {
     xmlChar *path;

     path = xmlGetNoNsProp(child, (xmlChar *) "path");
...
# 1369 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
xmlSchematronReportSuccess(xmlSchematronValidCtxtPtr ctxt,
     xmlSchematronTestPtr test, xmlNodePtr cur, xmlSchematronPatternPtr pattern, int success) {
    if ((ctxt == ((void*)0)) || (cur == ((void*)0)) || (test == ((void*)0)))
        return;
 ...
 if (report == ((void*)0)) {
    ...
    if (ctxt->flags & XML_SCHEMATRON_OUT_ERROR) {
        ...
        __xmlRaiseError(schannel, channel, data,
                        ((void*)0), cur, XML_FROM_SCHEMATRONV,
                        (test->type == XML_SCHEMATRON_ASSERT)?XML_SCHEMATRONV_ASSERT:XML_SCHEMATRONV_REPORT,
                        XML_ERR_ERROR, ((void*)0), line,
                        (pattern == ((void*)0))?((void*)0):((const char *) pattern->name),
                        (const char *) path,
 ...
 if ((path != ((void*)0)) && (path != (xmlChar *) cur->name))
     xmlFree(path);
    }
}
# 1449 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static void
xmlSchematronReportPattern(xmlSchematronValidCtxtPtr ctxt,
      xmlSchematronPatternPtr pattern) {
    if ((ctxt == ((void*)0)) || (pattern == ((void*)0)))
        return;
    if ((ctxt->flags & XML_SCHEMATRON_OUT_QUIET) || (ctxt->flags & XML_SCHEMATRON_OUT_ERROR))
        return;
    if (ctxt->flags & XML_SCHEMATRON_OUT_XML) {
        (*(__xmlGenericError()))((*(__xmlGenericErrorContext())), "Unimplemented block at %s:%d\n", "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c", 1457);
    } else {
 char msg[1000];
 ...
 xmlSchematronReportOutput(ctxt, ((void*)0), &msg[0]);
    }
}
# 1483 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
void
...
# 1504 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
xmlSchematronValidCtxtPtr
xmlSchematronNewValidCtxt(xmlSchematronPtr schema, int options)
{
    ...
    if (ret == ((void*)0)) {
        xmlSchematronVErrMemory(((void*)0), "allocating validation context",
                                ((void*)0));
        return (((void*)0));
    }
 ...
 xmlSchematronFreeValidCtxt(ret);
    ...
    for (i = 0;i < schema->nbNamespaces;i++) {
        if ((schema->namespaces[2 * i] == ((void*)0)) ||
            (schema->namespaces[2 * i + 1] == ((void*)0)))
     break;
...
xmlSchematronNextNode(xmlNodePtr cur) {
 ...
 cur = cur->parent;
 if (cur == ((void*)0)) break;
 if (cur->type == XML_DOCUMENT_NODE) return(((void*)0));
 if (cur->next != ((void*)0)) {
     cur = cur->next;
     return(cur);
 }
...
# 1601 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
static int
...
# 1665 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
int
xmlSchematronValidateDoc(xmlSchematronValidCtxtPtr ctxt, xmlDocPtr instance)
{
    ...
    if ((ctxt == ((void*)0)) || (ctxt->schema == ((void*)0)) ||
        (ctxt->schema->rules == ((void*)0)) || (instance == ((void*)0)))
        return(-1);
    ctxt->nberrors = 0;
    root = xmlDocGetRootElement(instance);
    if (root == ((void*)0)) {
        (*(__xmlGenericError()))((*(__xmlGenericErrorContext())), "Unimplemented block at %s:%d\n", "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c", 1679);
 ctxt->nberrors++;
 return(1);
    }
    if ((ctxt->flags & XML_SCHEMATRON_OUT_QUIET) ||
...
# 1786 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c"
# 1 "./elfgcchack.h" 1
# 1787 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/schematron.c" 2
