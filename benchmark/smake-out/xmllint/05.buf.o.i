# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
# 16 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
# 1 "./libxml.h" 1
# 12 "./libxml.h"
...
int xmlNop(void);
# 17 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 19 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
# 20 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
# 22 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
# 25 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
# 28 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
...
typedef void (*xmlEntityReferenceFunc) (xmlEntityPtr ent,
 ...
 xmlErrMemory (xmlParserCtxtPtr ctxt,
     const char *extra);
# 31 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
# 1 "./buf.h" 1
# 22 "./buf.h"
...
# 32 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
# 43 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
struct _xmlBuf {
    xmlChar *content;
...
# 91 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
static void
...
# 106 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
static void
xmlBufOverflowError(xmlBufPtr buf, const char *extra)
{
    __xmlSimpleError(XML_FROM_BUFFER, XML_BUF_OVERFLOW, ((void*)0), ((void*)0), extra);
    if ((buf) && (buf->error == 0))
        buf->error = XML_BUF_OVERFLOW;
}
# 121 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlBufPtr
xmlBufCreate(void) {
    xmlBufPtr ret;
 ...
 xmlBufMemoryError(((void*)0), "creating buffer");
    ...
    ret->compat_size = (*(__xmlDefaultBufferSize()));
...
# 155 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlBufPtr
...
# 195 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlChar *
...
# 230 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlBufPtr
xmlBufCreateStatic(void *mem, size_t size) {
 ...
 xmlBufMemoryError(((void*)0), "creating buffer");
    ...
    if (size < 2147483647) {
        ...
        ret->compat_use = 2147483647;
        ret->compat_size = 2147483647;
    }
    ret->use = size;
    ret->size = size;
...
# 266 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 287 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 328 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
void
...
xmlBufEmpty(xmlBufPtr buf) {
    if ((buf == ((void*)0)) || (buf->error != 0)) return;
    if (buf->content == ((void*)0)) return;
    if (buf->size != (size_t) buf->compat_size) if (buf->compat_size < 2147483647) buf->size = buf->compat_size; if (buf->use != (size_t) buf->compat_use) if (buf->compat_use < 2147483647) buf->use = buf->compat_use;
    buf->use = 0;
    if (buf->alloc == XML_BUFFER_ALLOC_IMMUTABLE) {
        buf->content = (xmlChar *) "";
 ...
 buf->size += start_buf;
    ...
    if (buf->size < 2147483647) buf->compat_size = buf->size; else buf->compat_size = 2147483647; if (buf->use < 2147483647) buf->compat_use = buf->use; else buf->compat_use = 2147483647;
}
# 387 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
xmlBufShrink(xmlBufPtr buf, size_t len) {
    if ((buf == ((void*)0)) || (buf->error != 0)) return(0);
    if (buf->size != (size_t) buf->compat_size) if (buf->compat_size < 2147483647) buf->size = buf->compat_size; if (buf->use != (size_t) buf->compat_use) if (buf->compat_use < 2147483647) buf->use = buf->compat_use;
    if (len == 0) return(0);
...
# 436 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
static size_t
...
# 455 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
...
# 508 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 530 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 547 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
...
# 581 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlChar *
...
# 599 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlChar *
...
# 620 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
xmlBufAddLen(xmlBufPtr buf, size_t len) {
    if ((buf == ((void*)0)) || (buf->error))
        return(-1);
    if (buf->size != (size_t) buf->compat_size) if (buf->compat_size < 2147483647) buf->size = buf->compat_size; if (buf->use != (size_t) buf->compat_use) if (buf->compat_use < 2147483647) buf->use = buf->compat_use;
...
# 645 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 667 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
...
# 686 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
...
# 707 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
...
# 725 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 744 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 867 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
xmlBufAdd(xmlBufPtr buf, const xmlChar *str, int len) {
    unsigned int needSize;

    if ((str == ((void*)0)) || (buf == ((void*)0)) || (buf->error))
 return -1;
    if (buf->size != (size_t) buf->compat_size) if (buf->compat_size < 2147483647) buf->size = buf->compat_size; if (buf->use != (size_t) buf->compat_use) if (buf->compat_use < 2147483647) buf->use = buf->compat_use;
...
# 927 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1006 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1026 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1066 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1087 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1110 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1166 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlBufPtr
...
# 1203 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
xmlBufferPtr
...
# 1256 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1282 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
xmlBufResetInput(xmlBufPtr buf, xmlParserInputPtr input) {
    if ((input == ((void*)0)) || (buf == ((void*)0)) || (buf->error))
        return(-1);
    if (buf->size != (size_t) buf->compat_size) if (buf->compat_size < 2147483647) buf->size = buf->compat_size; if (buf->use != (size_t) buf->compat_use) if (buf->compat_use < 2147483647) buf->use = buf->compat_use;
...
# 1301 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
size_t
...
# 1332 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c"
int
...
# 1 "./elfgcchack.h" 1
# 1346 "/benchmark/RUNDIR-libxml2-2.9.4/libxml2-2.9.4/buf.c" 2
