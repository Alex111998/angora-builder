# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
# 1 "./../include/elf/dwarf.h" 1
# 36 "./../include/elf/dwarf.h"
enum dwarf_tag {
    TAG_padding = 0x0000,
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c" 2
...
# 180 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/dwarf1.c"
static bfd_boolean
parse_die (bfd * abfd,
    ...
    bfd_byte * aDiePtrEnd)
{
  ...
  if (xptr + 4 > aDiePtrEnd)
    return 0;
  aDieInfo->length = ((*((abfd)->xvec->bfd_getx32)) (xptr));
  xptr += 4;
  ...
  if (xptr + 2 > aDiePtrEnd)
    return 0;
  aDieInfo->tag = ((*((abfd)->xvec->bfd_getx16)) (xptr));
  xptr += 2;
  ...
  while (xptr + 2 <= aDiePtrEnd)
    {
      ...
      attr = ((*((abfd)->xvec->bfd_getx16)) (xptr));
      xptr += 2;
 ...
 case FORM_REF:
   if (xptr + 4 <= aDiePtrEnd)
     {
       if (attr == AT_sibling)
  aDieInfo->sibling = ((*((abfd)->xvec->bfd_getx32)) (xptr));
       else if (attr == AT_stmt_list)
  {
    aDieInfo->stmt_list_offset = ((*((abfd)->xvec->bfd_getx32)) (xptr));
 ...
 case FORM_ADDR:
   if (xptr + 4 <= aDiePtrEnd)
     {
       if (attr == AT_low_pc)
  aDieInfo->low_pc = ((*((abfd)->xvec->bfd_getx32)) (xptr));
       else if (attr == AT_high_pc)
  aDieInfo->high_pc = ((*((abfd)->xvec->bfd_getx32)) (xptr));
     }
   xptr += 4;
   break;
 case FORM_BLOCK2:
   if (xptr + 2 <= aDiePtrEnd)
     {
       block_len = ((*((abfd)->xvec->bfd_getx16)) (xptr));
 ...
 case FORM_BLOCK4:
   if (xptr + 4 <= aDiePtrEnd)
     {
       block_len = ((*((abfd)->xvec->bfd_getx32)) (xptr));
       if (xptr + block_len > aDiePtrEnd
    || xptr + block_len < xptr)
  return 0;
       xptr += block_len;
...
parse_line_table (struct dwarf1_debug* stash, struct dwarf1_unit* aUnit)
{
 ...
 (stash->abfd, msec, ((void*)0), stash->syms);
  ...
  if (xptr + 8 <= stash->line_section_end)
    {
      ...
      tblend = ((*((stash->abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr)) + xptr;
      xptr += 4;


      base = ((*((stash->abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
      xptr += 4;
      ...
      for (eachLine = 0; eachLine < aUnit->line_count; eachLine++)
 {
   ...
   aUnit->linenumber_table[eachLine].linenumber
     = ((*((stash->abfd)->xvec->bfd_getx32)) ((bfd_byte *) xptr));
   xptr += 4;
...
_bfd_dwarf1_find_nearest_line (bfd *abfd,
          ...
          unsigned int *linenumber_ptr)
{
  struct dwarf1_debug *stash = ((abfd) -> tdata.elf_obj_data)->dwarf1_find_line_info;
  ...
  if (! stash)
    {
      ...
      stash = ((abfd) -> tdata.elf_obj_data)->dwarf1_find_line_info
