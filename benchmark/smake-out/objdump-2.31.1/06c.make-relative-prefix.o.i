# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
# 51 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
# 1 "./config.h" 1
# 52 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
...
# 56 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
...
# 62 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
...
# 65 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2

# 1 "./../include/ansidecl.h" 1
# 67 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
...
# 68 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c" 2
# 101 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
...
split_directories (const char *name, int *ptr_num_dirs)
{
  ...
  p = name;
# 136 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
  while ((ch = *p++) != '\0')
    {
      if (((ch) == '/'))
 {
  ...
  num_dirs = 0;
  p = name;
# 166 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
  q = p;
  while ((ch = *p++) != '\0')
    {
      if (((ch) == '/'))
...
# 226 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-relative-prefix.c"
static char *
make_relative_prefix_1 (const char *progname, const char *bin_prefix,
   const char *prefix, const int resolve_links)
{
  char **prog_dirs = ((void*)0), **bin_dirs = ((void*)0), **prefix_dirs = ((void*)0);
  int prog_num, bin_num, prefix_num;
  int i, n, common;
  int needed_len;
  char *ret = ((void*)0), *ptr, *full_progname;
      ...
      if (temp)
 {
   ...
   if (len < 4032)
     nstore = (char *) __builtin_alloca(len);
   else
   ...
   nstore[endp - startp] = 0;
    ...
    if (! access (nstore, 1)
        ...
        )
      {
        ...
        struct stat st;
        if (stat (nstore, &st) >= 0 && ((((st.st_mode)) & 0170000) == (0100000)))
