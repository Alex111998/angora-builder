# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c" 2
...
extern int dwarf_debug_section_assert[(sizeof (dwarf_debug_sections) / sizeof ((dwarf_debug_sections)[0]))
          == debug_max + 1 ? 1 : -1];
# 397 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
...
lookup_info_hash_table (struct info_hash_table *hash_table, const char *key)
{
  ...
  entry = (struct info_hash_entry*) bfd_hash_lookup (&hash_table->base, key,
           0, 0);
  return entry ? entry->head : ((void*)0);
}
      ...
      if (! msec)
 {
   ...
   if (section_name != ((void*)0))
     msec = bfd_get_section_by_name (abfd, section_name);
      ...
      if (! msec)
 {
   _bfd_error_handler (dgettext ("bfd", "DWARF error: can't find %s section."),
  ...
  if (offset != 0 && offset >= *section_size)
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "DWARF error: offset (%" "ll" "u" ")" " greater than or equal to %s size (%" "ll" "u" ")"),
...
static unsigned int
read_1_byte (bfd *abfd __attribute__ ((__unused__)), bfd_byte *buf, bfd_byte *end)
{
  if (buf + 1 > end)
    return 0;
  return (*(const unsigned char *) (buf) & 0xff);
}

static int
read_1_signed_byte (bfd *abfd __attribute__ ((__unused__)), bfd_byte *buf, bfd_byte *end)
{
  if (buf + 1 > end)
    return 0;
  return (((*(const unsigned char *) (buf) & 0xff) ^ 0x80) - 0x80);
}
...
read_2_bytes (bfd *abfd, bfd_byte *buf, bfd_byte *end)
{
  if (buf + 2 > end)
    return 0;
  return ((*((abfd)->xvec->bfd_getx16)) (buf));
}
...
read_4_bytes (bfd *abfd, bfd_byte *buf, bfd_byte *end)
{
  if (buf + 4 > end)
    return 0;
  return ((*((abfd)->xvec->bfd_getx32)) (buf));
}
...
read_8_bytes (bfd *abfd, bfd_byte *buf, bfd_byte *end)
{
  if (buf + 8 > end)
    return 0;
  return ((*((abfd)->xvec->bfd_getx64)) (buf));
}
...
static char *
read_string (bfd * abfd __attribute__ ((__unused__)),
      bfd_byte * buf,
      bfd_byte * buf_end,
...
# 691 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static char *
     ...
     unsigned int * bytes_read_ptr)
{
  ...
  *bytes_read_ptr = unit->offset_size;
  ...
  if (stash->alt_bfd_ptr == ((void*)0))
    {
      bfd * debug_bfd;
      char * debug_filename = bfd_follow_gnu_debugaltlink (unit->abfd, "/usr/local/lib/debug");

      if (debug_filename == ((void*)0))
 return ((void*)0);

      if ((debug_bfd = bfd_openr (debug_filename, ((void*)0))) == ((void*)0)
...
read_address (struct comp_unit *unit, bfd_byte *buf, bfd_byte * buf_end)
{
  ...
  if (((unit->abfd)->xvec->flavour) == bfd_target_elf_flavour)
    signed_vma = ((const struct elf_backend_data *) ((unit->abfd)->xvec)->backend_data)->sign_extend_vma;
 ...
 {
 case 8:
   return ((*((unit->abfd)->xvec->bfd_getx_signed_64)) (buf));
 case 4:
   return ((*((unit->abfd)->xvec->bfd_getx_signed_32)) (buf));
 case 2:
   return ((*((unit->abfd)->xvec->bfd_getx_signed_16)) (buf));
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c", 897, __PRETTY_FUNCTION__);
 }
    }
  else
    {
 ...
 {
 case 8:
   return ((*((unit->abfd)->xvec->bfd_getx64)) (buf));
 case 4:
   return ((*((unit->abfd)->xvec->bfd_getx32)) (buf));
 case 2:
   return ((*((unit->abfd)->xvec->bfd_getx16)) (buf));
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c", 911, __PRETTY_FUNCTION__);
 }
    }
}
...
read_abbrevs (bfd *abfd, bfd_uint64_t offset, struct dwarf2_debug *stash)
{
  ...
  amt = sizeof (struct abbrev_info*) * 121;
      ...
      for (;;)
 {
   ...
   if ((cur_abbrev->num_attrs % 4) == 0)
     {
       struct attr_abbrev *tmp;

       amt = cur_abbrev->num_attrs + 4;
       ...
       if (tmp == ((void*)0))
  {
   ...
   ++cur_abbrev->num_attrs;
      ...
      hash_number = abbrev_number % 121;
      cur_abbrev->next = abbrevs[hash_number];
      abbrevs[hash_number] = cur_abbrev;
# 1059 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
      if ((unsigned int) (abbrev_ptr - stash->dwarf_abbrev_buffer)
   >= stash->dwarf_abbrev_size)
 break;
      abbrev_number = _bfd_safe_read_leb128 (abfd, abbrev_ptr,
          &bytes_read, 0, abbrev_end);
      abbrev_ptr += bytes_read;
      if (lookup_abbrev (abbrev_number, abbrevs) != ((void*)0))
 break;
    }
        ...
        bfd_byte * info_ptr_end)
{
  ...
  if (info_ptr >= info_ptr_end && form != DW_FORM_flag_present)
    {
      _bfd_error_handler (dgettext ("bfd", "DWARF error: info pointer extends beyond end of attributes"));
      bfd_set_error (bfd_error_bad_value);
      return info_ptr;
    }
      ...
      if (form == DW_FORM_implicit_const)
 {
   ...
   info_ptr += bytes_read;
    ...
    case DW_FORM_implicit_const:
      ...
      break;
    default:
      _bfd_error_handler (dgettext ("bfd", "DWARF error: invalid or unhandled FORM value: %#x"),
     form);
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
...
# 1490 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
  if (seq
...
concat_filename (struct line_info_table *table, unsigned int file)
{
  ...
  if (table == ((void*)0) || file - 1 >= table->num_files)
    {

      if (file)
 _bfd_error_handler
   (dgettext ("bfd", "DWARF error: mangled line number section (bad file number)"));
 ...
 subdir_name = table->dirs[table->files[file - 1].dir - 1];
      ...
      if (!subdir_name || !(((((subdir_name)[0]) == '/') || ((((subdir_name)[0]) == '\\') && (0))) || ((subdir_name)[0] && ((subdir_name)[1] == ':') && (0))))
         ...
         struct line_sequence * seq)
{
  ...
  if (seq->line_info_lookup != ((void*)0))
    return 1;
  ...
  do { if (!(line_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",1744); } while (0);
  ...
  for (n = 0; n < num_sequences; n++)
    {
      ...
      do { if (!(seq)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",1779); } while (0);
      sequences[n].low_pc = seq->low_pc;
      sequences[n].prev_sequence = ((void*)0);
      sequences[n].last_line = seq->last_line;
      sequences[n].line_info_lookup = ((void*)0);
      sequences[n].num_lines = 0;
      seq = seq->prev_sequence;
      free (last_seq);
    }
  do { if (!(seq == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",1788); } while (0);
...
{
  if ((table->num_dirs % 5) == 0)
    {
      char **tmp;
      bfd_size_type amt;

      amt = table->num_dirs + 5;
      amt *= sizeof (char *);
...
line_info_add_include_dir_stub (struct line_info_table *table, char *cur_dir,
    unsigned int dir __attribute__ ((__unused__)),
    unsigned int xtime __attribute__ ((__unused__)),
...
line_info_add_file_name (struct line_info_table *table, char *cur_file,
    ...
    unsigned int size)
{
  if ((table->num_files % 5) == 0)
    {
      struct fileinfo *tmp;
      bfd_size_type amt;

      amt = table->num_files + 5;
       ...
       unsigned int size))
{
  ...
  for (formati = 0; formati < format_count; formati++)
    {
      _bfd_safe_read_leb128 (abfd, buf, &bytes_read, 0, buf_end);
      buf += bytes_read;
      _bfd_safe_read_leb128 (abfd, buf, &bytes_read, 0, buf_end);
      buf += bytes_read;
    }

  data_count = _bfd_safe_read_leb128 (abfd, buf, &bytes_read, 0, buf_end);
  buf += bytes_read;
  if (format_count == 0 && data_count != 0)
    {
      _bfd_error_handler (dgettext ("bfd", "DWARF error: zero format count"));
      bfd_set_error (bfd_error_bad_value);
      return 0;
    }
  ...
  if (data_count > (bfd_vma) (buf_end - buf))
    {
      _bfd_error_handler
 (dgettext ("bfd", "DWARF error: data count (%" "ll" "x" ") larger than buffer size"),
  (uint64_t) data_count);
      bfd_set_error (bfd_error_bad_value);
      return 0;
    }
      ...
      for (formati = 0; formati < format_count; formati++)
 {
   ...
   switch (content_type)
     ...
     default:
       _bfd_error_handler
  (dgettext ("bfd", "DWARF error: unknown format content type %" "ll" "u"),
   (uint64_t) content_type);
       bfd_set_error (bfd_error_bad_value);
       return 0;
     }

   form = _bfd_safe_read_leb128 (abfd, format, &bytes_read, 0,
     buf_end);
   format += bytes_read;
...
decode_line_info (struct comp_unit *unit, struct dwarf2_debug *stash)
{
  ...
  table->sequences = ((void*)0);

  table->lcl_head = ((void*)0);

  if (stash->dwarf_line_size < 16)
    {
      _bfd_error_handler
 (dgettext ("bfd", "DWARF error: line info section is too small (%" "ll" "d" ")"),
 ...
 (dgettext ("bfd", "DWARF error: line info data is bigger (%#" "ll" "x" ")" " than the space remaining in the section (%#lx)"),
  ...
  if (lh.version < 2 || lh.version > 5)
    {
      _bfd_error_handler
 (dgettext ("bfd", "DWARF error: unhandled .debug_line version %d"), lh.version);
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
  line_ptr += 2;
  ...
  if (line_ptr + offset_size + (lh.version >= 5 ? 8 : (lh.version >= 4 ? 6 : 5))
    ...
    {
      _bfd_error_handler
 (dgettext ("bfd", "DWARF error: ran out of room reading prologue"));
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "DWARF error: line info unsupported segment selector size %u"),
  ...
  if (lh.maximum_ops_per_insn == 0)
    {
      _bfd_error_handler
 (dgettext ("bfd", "DWARF error: invalid maximum operations per instruction"));
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
  ...
  if (line_ptr + (lh.opcode_base - 1) >= line_end)
    {
      _bfd_error_handler (dgettext ("bfd", "DWARF error: ran out of room reading opcodes"));
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
 ...
 goto fail;
  ...
  else
    {
      ...
      while ((cur_dir = read_string (abfd, line_ptr, line_end, &bytes_read)) != ((void*)0))
 {
   line_ptr += bytes_read;
   ...
   if (!line_info_add_include_dir (table, cur_dir))
     goto fail;
      ...
      while ((cur_file = read_string (abfd, line_ptr, line_end, &bytes_read)) != ((void*)0))
 {
   unsigned int dir, xtime, size;

   line_ptr += bytes_read;

   dir = _bfd_safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
   line_ptr += bytes_read;
   xtime = _bfd_safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
   line_ptr += bytes_read;
   size = _bfd_safe_read_leb128 (abfd, line_ptr, &bytes_read, 0, line_end);
   line_ptr += bytes_read;
  ...
  while (line_ptr < line_end)
    {
      ...
      char * filename = table->num_files ? concat_filename (table, 1) : ((void*)0);
      unsigned int line = 1;
      ...
      while (!end_sequence && line_ptr < line_end)
 {
  ...
  default:
    _bfd_error_handler
      (dgettext ("bfd", "DWARF error: mangled line number section"));
    bfd_set_error (bfd_error_bad_value);
  line_fail:
    if (filename != ((void*)0))
      free (filename);
 ...
 fail:
  while (table->sequences != ((void*)0))
    {
      struct line_sequence* seq = table->sequences;
      table->sequences = table->sequences->prev_sequence;
      free (seq);
    }
  if (table->files != ((void*)0))
    free (table->files);
  if (table->dirs != ((void*)0))
    free (table->dirs);
  return ((void*)0);
}
...
{
  struct line_sequence *seq = ((void*)0);
...
build_lookup_funcinfo_table (struct comp_unit * unit)
{
  ...
  if (lookup_funcinfo_table == ((void*)0))
    return 0;
      ...
      for (range = entry->funcinfo->arange.next; range; range = range->next)
 {
  ...
  do { if (!(func_index == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",2606); } while (0);
...
{
  unsigned int number_of_functions = unit->number_of_functions;
  struct lookup_funcinfo* lookup_funcinfo = ((void*)0);
  struct funcinfo* funcinfo = ((void*)0);
   ...
   int * linenumber_ptr)
{
  ...
  if (attr_ptr->form == DW_FORM_ref_addr)
    {
# 2835 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
      size_t total;
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "DWARF error: invalid abstract instance DIE ref"));
   bfd_set_error (bfd_error_bad_value);
   return 0;
 }
      info_ptr += die_ref;
      ...
      else
 {
   ...
   for (u = unit->prev_unit; u != ((void*)0); u = u->prev_unit)
     if (info_ptr >= u->info_ptr_unit && info_ptr < u->end_ptr)
       break;

   if (u == ((void*)0))
     for (u = unit->next_unit; u != ((void*)0); u = u->next_unit)
       if (info_ptr >= u->info_ptr_unit && info_ptr < u->end_ptr)
  break;
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "DWARF error: unable to read alt ref %" "ll" "u"),
      (uint64_t) die_ref);
   bfd_set_error (bfd_error_bad_value);
   return 0;
 }
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "DWARF error: could not find abbrev number %u"), abbrev_number);
   bfd_set_error (bfd_error_bad_value);
   return 0;
 }
      else
 {
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "DWARF error: abstract instance recursion detected"));
    bfd_set_error (bfd_error_bad_value);
    return 0;
  }
       switch (attr.name)
  ...
  case DW_AT_name:
    ...
    if (name == ((void*)0) && is_str_attr (attr.form))
      {
        name = attr.u.str;
...
scan_unit_for_symbols (struct comp_unit *unit)
{
  ...
  while (nesting_level >= 0)
    {
      ...
      bfd_vma low_pc = 0;
      bfd_vma high_pc = 0;
      bfd_boolean high_pc_relative = 0;
      ...
      if (! abbrev)
 {
   ...
   if (abbrev_number != previous_failed_abbrev)
     {
       _bfd_error_handler
  (dgettext ("bfd", "DWARF error: could not find abbrev number %u"),
   abbrev_number);
   ...
   || abbrev->tag == DW_TAG_inlined_subroutine)
 {
   ...
   do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",3115); } while (0);
      ...
      for (i = 0; i < abbrev->num_attrs; ++i)
 {
  ...
  case DW_AT_name:
    ...
    if (func->name == ((void*)0) && is_str_attr (attr.form))
      {
  ...
  case DW_AT_location:
     ...
     && *attr.u.blk->data == DW_OP_addr)
   {
     ...
     if (attr.u.blk->size == unit->addr_size + 1U)
       var->addr = ((unit->addr_size * 8) == 8 ? (bfd_vma) (*(const unsigned char *) (attr.u.blk->data + 1) & 0xff) : (unit->addr_size * 8) == 16 ? ((*((unit->abfd)->xvec->bfd_getx16)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 32 ? ((*((unit->abfd)->xvec->bfd_getx32)) (attr.u.blk->data + 1)) : (unit->addr_size * 8) == 64 ? ((*((unit->abfd)->xvec->bfd_getx64)) (attr.u.blk->data + 1)) : (_bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c", 3271, __PRETTY_FUNCTION__), (bfd_vma) - 1));
...
# 3332 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
   ...
   unsigned int offset_size)
{
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "DWARF error: found dwarf version '%u', this reader" " only handles version 2, 3, 4 and 5 information"), version);
  ...
  do { if (!(offset_size == 4 || offset_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",3385); } while (0);
  if (offset_size == 4)
 ...
 (dgettext ("bfd", "DWARF error: found address size '%u', this reader" " can not handle sizes greater than '%u'"),
 ...
 ("DWARF error: found address size '%u', this reader"
  ...
  if (! abbrev)
    {
      _bfd_error_handler (dgettext ("bfd", "DWARF error: could not find abbrev number %u"),
     abbrev_number);
      bfd_set_error (bfd_error_bad_value);
      return ((void*)0);
    }
 ...
 case DW_AT_comp_dir:
   {
     ...
     if (! is_str_attr (attr.form))
       {
  _bfd_error_handler
    (dgettext ("bfd", "DWARF error: DW_AT_comp_dir attribute encountered with a non-string form"));
  comp_dir = ((void*)0);
       }
...
# 3585 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static bfd_vma
...
# 3680 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static bfd_boolean
...
reverse_funcinfo_list (struct funcinfo *head)
{
  ...
  for (rhead = ((void*)0); head; head = temp)
    {
      temp = head->prev_func;
       ...
       struct info_hash_table *varinfo_hash_table)
{
  ...
  do { if (!(stash->info_hash_status != 2)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",3745); } while (0);

  if (!comp_unit_maybe_decode_line_info (unit, stash))
    return 0;

  do { if (!(!unit->cached)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",3750); } while (0);
 ...
 okay = insert_info_hash_table (funcinfo_hash_table, each_func->name,
  ...
  for (each_var = unit->variable_table;
       ...
       each_var = each_var->prev_var)
    {
      ...
      if (each_var->stack == 0
   && each_var->file != ((void*)0)
   && each_var->name != ((void*)0))
...
# 3808 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static asection *
   ...
   asection *after_sec)
{
      ...
      if (look != ((void*)0))
 {
   ...
   if (msec != ((void*)0))
     return msec;
      ...
      for (msec = abfd->sections; msec != ((void*)0); msec = msec->next)
 if ((strncmp ((msec->name), (".gnu.linkonce.wi."), sizeof (".gnu.linkonce.wi.") - 1) == 0))
   return msec;

      return ((void*)0);
    }

  for (msec = after_sec->next; msec != ((void*)0); msec = msec->next)
    {
      look = debug_sections[debug_info].uncompressed_name;
 ...
 return msec;
      ...
      look = debug_sections[debug_info].compressed_name;
      if (look != ((void*)0) && strcmp (msec->name, look) == 0)
 return msec;
...
# 3902 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static bfd_boolean
place_sections (bfd *orig_bfd, struct dwarf2_debug *stash)
{
      ...
      for (sect = abfd->sections; sect != ((void*)0); sect = sect->next)
 {
   ...
   is_debug_info = (strcmp (sect->name, debug_info_name) == 0
      || (strncmp ((sect->name), (".gnu.linkonce.wi."), sizeof (".gnu.linkonce.wi.") - 1) == 0));

   if (!((sect->flags & 0x1) != 0 && abfd == orig_bfd)
       && !is_debug_info)
     continue;
      ...
      while (1)
 {
  ...
  continue;
       ...
       if (is_debug_info)
  {
    do { if (!(sect->alignment_power == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",3991); } while (0);
    sect->vma = last_dwarf;
    last_dwarf += sz;
  }
       else
...
stash_verify_info_hash_table (struct dwarf2_debug *stash)
{
    ...
    each_func = each_func->prev_func)
 {
   ...
   node = lookup_info_hash_table (stash->funcinfo_hash_table,
      each_func->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4167); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4174); } while (0);
 }
    ...
    each_var = each_var->prev_var)
 {
   ...
   node = lookup_info_hash_table (stash->varinfo_hash_table,
      each_var->name);
   do { if (!(node)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4185); } while (0);
   found = 0;
   while (node && !found)
     {
   ...
   do { if (!(found)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4192); } while (0);
 }
    }
}
...
{
  do { if (!(stash->info_hash_status == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4205); } while (0);

  if (stash->info_hash_count++ < 100)
    return;
...
stash_find_line_fast (struct dwarf2_debug *stash,
        ...
        unsigned int *linenumber_ptr)
{
  do { if (!(stash->info_hash_status == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4241); } while (0);
...
# 4280 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
static bfd_boolean
         ...
         bfd_boolean do_place)
{
  ...
  *pinfo = stash;
  ...
  msec = find_debug_info (debug_bfd, debug_sections, ((void*)0));
  if (msec == ((void*)0) && abfd == debug_bfd)
    {
      char * debug_filename;

      debug_filename = bfd_follow_build_id_debuglink (abfd, "/usr/local/lib/debug");
      if (debug_filename == ((void*)0))
 debug_filename = bfd_follow_gnu_debuglink (abfd, "/usr/local/lib/debug");
 ...
 return 0;
      ...
      if ((debug_bfd = bfd_openr (debug_filename, ((void*)0))) == ((void*)0)
   || !(debug_bfd->flags |= 0x8000,
        bfd_check_format (debug_bfd, bfd_object))
   || (msec = find_debug_info (debug_bfd,
          debug_sections, ((void*)0))) == ((void*)0)
   || !bfd_generic_link_read_symbols (debug_bfd))
 {
   ...
   return 0;
      ...
      symbols = ((debug_bfd)->outsymbols);
      stash->syms = symbols;
      stash->close_on_cleanup = 1;
    }
  ...
  if (do_place
    ...
    return 0;
# 4405 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
 ...
 total_size += msec->size;
      ...
      if (stash->info_ptr_memory == ((void*)0))
 return 0;

      total_size = 0;
      for (msec = find_debug_info (debug_bfd, debug_sections, ((void*)0));
    msec;
    msec = find_debug_info (debug_bfd, debug_sections, msec))
 {
   bfd_size_type size;
  ...
  stash->sec = find_debug_info (debug_bfd, debug_sections, ((void*)0));
  ...
  for (unit = stash->all_comp_units; unit; unit = unit->next_unit)
    {
      ...
      if (unit->function_table == ((void*)0))
 {
   if (unit->line_table == ((void*)0))
     unit->line_table = decode_line_info (unit, stash);
   if (unit->line_table != ((void*)0))
     scan_unit_for_symbols (unit);
 }

      for (func = unit->function_table; func != ((void*)0); func = func->prev_func)
 if (func->name && func->arange.low)
   {
     ...
     for (psym = symbols; * psym != ((void*)0); psym++)
       {
  asymbol * sym = * psym;
...
# 4516 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
bfd_boolean
_bfd_dwarf2_find_nearest_line (bfd *abfd,
          ...
          void **pinfo)
{
# 4538 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
  struct dwarf2_debug *stash;

  bfd_vma addr;
  struct comp_unit* each;
  struct funcinfo *function = ((void*)0);
  bfd_boolean found = 0;
  bfd_boolean do_line;

  *filename_ptr = ((void*)0);
  if (functionname_ptr != ((void*)0))
    *functionname_ptr = ((void*)0);
  *linenumber_ptr = 0;
  if (discriminator_ptr)
    *discriminator_ptr = 0;

  if (! _bfd_dwarf2_slurp_debug_info (abfd, ((void*)0), debug_sections,
          symbols, pinfo,
          (abfd->flags & (0x2 | 0x40)) == 0))
    return 0;

  stash = (struct dwarf2_debug *) *pinfo;

  do_line = symbol != ((void*)0);
  if (do_line)
    {
      do { if (!(section == ((void*)0) && offset == 0 && functionname_ptr == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4563); } while (0);
      section = ((symbol)->section);
      addr = symbol->value;
    }
  else
    {
      do { if (!(section != ((void*)0) && functionname_ptr != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4569); } while (0);
      addr = offset;
# 4585 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
      if (symbols != ((void*)0) && (section->flags & 0x10) == 0)
 {
   asymbol **tmp;

   for (tmp = symbols; (*tmp) != ((void*)0); ++tmp)
     if ((*tmp)->the_bfd == abfd
  && (*tmp)->section == section
  && (*tmp)->value == offset
  && ((*tmp)->flags & (1 << 8)) == 0)
  ...
  if (do_line)
    {
      ...
      if (stash->info_hash_status == 0)
 stash_maybe_enable_info_hash_tables (abfd, stash);



      if (stash->info_hash_status == 1)
 stash_maybe_update_info_hash_tables (stash);
      ...
      else
 {
  ...
  if (found)
  ...
  else
    {
      ...
      const char * local_filename = ((void*)0);
      struct funcinfo *local_function = ((void*)0);
      ...
      for (each = stash->all_comp_units; each; each = each->next_unit)
 {
   ...
   if (found)
     {
# 4686 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
       if (range <= min_range)
  {
      ...
      if (* linenumber_ptr)
 {
  ...
  if (addr_size == 0)
    addr_size = 4;
  do { if (!(addr_size == 4 || addr_size == 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c",4713); } while (0);
...
# 4749 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
      else if (addr_size == 8)
 {
   offset_size = 4;
   stash->info_ptr += 4;
...
bfd_boolean
_bfd_dwarf2_find_inliner_info (bfd *abfd __attribute__ ((__unused__)),
          const char **filename_ptr,
          const char **functionname_ptr,
          unsigned int *linenumber_ptr,
          void **pinfo)
...
_bfd_dwarf2_cleanup_debug_info (bfd *abfd, void **pinfo)
{
   ...
   if (function_table->file)
     {
       ...
       function_table->file = ((void*)0);
     }

   if (function_table->caller_file)
     {
       free (function_table->caller_file);
       function_table->caller_file = ((void*)0);
     }
      ...
      if (each->lookup_funcinfo_table)
 {
   ...
   each->lookup_funcinfo_table = ((void*)0);
 }
  ...
  if (cache == ((void*)0))
    {
      ...
      ((abfd) -> tdata.elf_obj_data)->elf_find_function_cache = cache;
      if (cache == ((void*)0))
 return ((void*)0);
    }
  if (cache->last_section != section
      ...
      || offset >= cache->func->value + cache->func_size)
    {
      ...
      bfd_vma low_func;
      asymbol **p;
# 5029 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./dwarf2.c"
      ...
      low_func = 0;
      state = nothing_seen;
      cache->filename = ((void*)0);
      cache->func = ((void*)0);
      cache->func_size = 0;
      cache->last_section = section;

      for (p = symbols; *p != ((void*)0); p++)
 {
   asymbol *sym = *p;
   bfd_vma code_off;
   bfd_size_type size;
  ...
  if (cache->func == ((void*)0))
    return ((void*)0);

  if (filename_ptr)
    *filename_ptr = cache->filename;
  if (functionname_ptr)
    *functionname_ptr = ((cache->func)->name);
