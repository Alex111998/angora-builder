# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
# 1 "./elfxx-x86.h" 1
# 21 "./elfxx-x86.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
# 1 "./elf-vxworks.h" 1
# 22 "./elf-vxworks.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
...
R_386_max };
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
...
R_X86_64_max };
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c" 2
...
_bfd_x86_elf_mkobject (bfd *abfd)
{
  return bfd_elf_allocate_object (abfd,
      ...
      ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->target_id);
}
...
_bfd_x86_elf_set_tls_module_base (struct bfd_link_info *info)
{
  ...
  htab = ((((struct bfd_link_hash_table *) ((info)->hash))->type == bfd_link_elf_hash_table) && (((struct elf_link_hash_table *) ((info)->hash)) -> hash_table_id) == (bed->target_id) ? ((struct elf_x86_link_hash_table *) ((info)->hash)) : ((void*)0));
  if (htab == ((void*)0))
    return;
...
elf_x86_allocate_dynrelocs (struct elf_link_hash_entry *h, void *inf)
{
  ...
  resolved_to_zero = ((eh)->elf.root.type == bfd_link_hash_undefweak && (_bfd_x86_elf_link_symbol_references_local (((info)), (&(eh)->elf)) || ((((info)->type == type_pde) || ((info)->type == type_pie)) && (eh)->zero_undefweak > 0)));
...
# 206 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
   if (h->def_regular)
     use_plt = 0;
   else if (htab->pcrel_plt)
     use_plt = ! ((info)->type == type_dll);
   else
     use_plt = ((info)->type == type_pde);
   if (use_plt)
     {
       if (use_plt_got)
  {
       ...
       if (!resolved_to_zero)
  {
   ...
   if (htab->target_os == is_vxworks && !(((info)->type == type_dll) || ((info)->type == type_pie)))
     {
# 273 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
      ...
      else
 {
  ...
  if (h->got.refcount > 0
      ...
      && h->dynindx == -1
      && (((struct elf_x86_link_hash_entry *)(h))->tls_type & 4))
    h->got.offset = (bfd_vma) -1;
  else if (h->got.refcount > 0)
    {
      asection *s;
      bfd_boolean dyn;
      int tls_type = ((struct elf_x86_link_hash_entry *)(h))->tls_type;
  ...
  for (p = eh->dyn_relocs; p != ((void*)0); p = p->next)
    {
      ...
      do { if (!(sreloc != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c",525); } while (0);
...
readonly_dynrelocs (struct elf_link_hash_entry *h)
{
  ...
  for (p = ((struct elf_x86_link_hash_entry *)(h))->dyn_relocs; p != ((void*)0); p = p->next)
    {
      asection *s = p->sec->output_section;

      if (s != ((void*)0) && (s->flags & 0x8) != 0)
 return p->sec;
    }
  return ((void*)0);
}
...
elf_x86_allocate_local_dynreloc (void **slot, void *inf)
{
  ...
  if (h->type != 10
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 602, __PRETTY_FUNCTION__);
     ...
     bfd_boolean create)
{
 ...
 __extension__ ({ struct objalloc *__o = ((struct objalloc *) htab->loc_hash_memory); unsigned long __len = (sizeof (struct elf_x86_link_hash_entry)); if (__len == 0) __len = 1; __len = (__len + __builtin_offsetof(struct objalloc_align, d) - 1) &~ (__builtin_offsetof(struct objalloc_align, d) - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
...
{
  return (strncmp ((secname), (".rel"), sizeof (".rel") - 1) == 0);
}

static bfd_boolean
elf_x86_64_is_reloc_section (const char *secname)
{
  return (strncmp ((secname), (".rela"), sizeof (".rela") - 1) == 0);
}
...
_bfd_x86_elf_link_hash_table_create (bfd *abfd)
{
      ...
      else
 {
   ...
   ret->dynamic_interpreter = "/usr/lib/libc.so.1";
   ret->dynamic_interpreter_size
     = sizeof "/usr/lib/libc.so.1";
   ret->tls_get_addr = "___tls_get_addr";
 }
    }
  ret->target_id = bed->target_id;
  ret->target_os = ((const struct elf_x86_backend_data *) ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->arch_data)->target_os;
...
elf_x86_linker_defined (struct bfd_link_info *info, const char *name)
{
  ...
  if (h->root.type == bfd_link_hash_new
    ...
    {
      ((struct elf_x86_link_hash_entry *)(h))->local_ref = 2;
      ((struct elf_x86_link_hash_entry *)(h))->linker_def = 1;
    }
}
        ...
        const char *name)
{
  ...
  if (((h->other) & 0x3) == 1
      || ((h->other) & 0x3) == 2)
    _bfd_elf_link_hash_hide_symbol (info, h, 1);
}
...
_bfd_x86_elf_link_check_relocs (bfd *abfd, struct bfd_link_info *info)
{
      ...
      if (htab)
 {
   ...
   h = ((struct elf_link_hash_entry *) bfd_link_hash_lookup (&(((struct elf_link_hash_table *) ((info)->hash)))->root, (htab->tls_get_addr), (0), (0), (0)));
        ...
        struct bfd_link_info *info)
{
  ...
  if (dynobj == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 974, __PRETTY_FUNCTION__);
  ...
  for (ibfd = info->input_bfds; ibfd != ((void*)0); ibfd = ibfd->link.next)
    {
      ...
      if (! (((ibfd)->xvec->flavour) == bfd_target_elf_flavour && ((ibfd) -> tdata.elf_obj_data) != ((void*)0) && (((ibfd) -> tdata.elf_obj_data) -> object_id) == (htab)->target_id))
 continue;
      ...
      for (s = ibfd->sections; s != ((void*)0); s = s->next)
 {
       ...
       else if (p->count != 0)
  {
    ...
    if ((p->sec->output_section->flags & 0x8) != 0
        && (info->flags & (1 << 2)) == 0)
      {
        info->flags |= (1 << 2);
        if ((info->warn_shared_textrel && (((info)->type == type_dll) || ((info)->type == type_pie)))
   ...
   info->callbacks->einfo
     (dgettext ("bfd", "%P: %pB: warning: relocation " "in read-only section `%pA'\n"),
 ...
 continue;
      ...
      local_tls_type = (((struct elf_x86_obj_tdata *) (ibfd)->tdata.any)->local_got_tls_type);
      local_tlsdesc_gotent = (((struct elf_x86_obj_tdata *) (ibfd)->tdata.any)->local_tlsdesc_gotent);
      s = htab->elf.sgot;
    ...
    ++local_got, ++local_tls_type, ++local_tlsdesc_gotent)
 {
  ...
  (bfd_link_hash_traverse (&(&htab->elf)->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (elf_x86_allocate_dynrelocs), (info)));



  htab_traverse (htab->loc_hash_table, elf_x86_allocate_local_dynreloc,
   info);
# 1118 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
  if (htab->elf.srelplt)
    {
       ...
       || htab->elf.igotplt->size == 0))
 {
   ...
   if (htab->elf.hgot != ((void*)0) && htab->target_os != is_solaris)
     {
        ...
        || s == htab->elf.sdynrelro)
 {
      ...
      else if (htab->is_reloc_section (((void) dynobj, (s)->name)))
 {
   if (s->size != 0
       && s != htab->elf.srelplt
       && s != htab->srelplt2)
      ...
      else
 {
   ...
   continue;
      ...
      if (s->size == 0)
 {
# 1270 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
   if (strip_section)
     s->flags |= 0x8000;
   continue;
 }
 ...
 return 0;
  ...
  if (htab->elf.dynamic_sections_created)
    {
# 1330 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
      if ((((info)->type == type_pde) || ((info)->type == type_pie)))
 {
      ...
      if (htab->elf.srelplt->size != 0)
 {
   if (!_bfd_elf_add_dynamic_entry (info, 2, 0)
       || !_bfd_elf_add_dynamic_entry (info, 20, htab->dt_reloc)
 ...
 return 0;
      ...
      if (relocs)
 {
   if (!_bfd_elf_add_dynamic_entry (info, htab->dt_reloc, 0)
       || !_bfd_elf_add_dynamic_entry (info, htab->dt_reloc_sz, 0)
       || !_bfd_elf_add_dynamic_entry (info, htab->dt_reloc_ent, htab->sizeof_reloc))
   ...
   if ((info->flags & (1 << 2)) == 0)
     (bfd_link_hash_traverse (&(&htab->elf)->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (maybe_set_textrel), (info)));
          ...
          struct bfd_link_info *info)
{
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "discarded output section: `%pA'"), htab->elf.sgotplt);
   return ((void*)0);
 }
 ...
 {
   ((*((output_bfd)->xvec->bfd_putx64)) ((dynamic_addr), (htab->elf.sgotplt->contents)));
 ...
 {
   ((*((output_bfd)->xvec->bfd_putx32)) ((dynamic_addr),(htab->elf.sgotplt->contents)));

   ((*((output_bfd)->xvec->bfd_putx32)) ((0),(htab->elf.sgotplt->contents + 4)));

   ((*((output_bfd)->xvec->bfd_putx32)) ((0),(htab->elf.sgotplt->contents + 4*2)));
  ...
  if (sdyn == ((void*)0) || htab->elf.sgot == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 1462, __PRETTY_FUNCTION__);
...
_bfd_x86_elf_merge_symbol_attribute (struct elf_link_hash_entry *h,
         ...
         bfd_boolean dynamic __attribute__ ((__unused__)))
{
  if (definition)
    {
      struct elf_x86_link_hash_entry *eh
 = (struct elf_x86_link_hash_entry *) h;
      eh->def_protected = (((isym->st_other) & 0x3)
      == 3);
    }
}
...
{
  if (h->dynindx != -1
      && ((((struct elf_x86_link_hash_entry *)(h)))->elf.root.type == bfd_link_hash_undefweak && (_bfd_x86_elf_link_symbol_references_local (((info)), (&(((struct elf_x86_link_hash_entry *)(h)))->elf)) || ((((info)->type == type_pde) || ((info)->type == type_pie)) && (((struct elf_x86_link_hash_entry *)(h)))->zero_undefweak > 0))))
    {
      h->dynindx = -1;
          ...
          Elf_Internal_Sym *sym)
{
      ...
      else
 {
   ...
   plt_offset = h->plt.offset;
      ...
      sym->st_size = 0;
      sym->st_info = ((((((unsigned int)(sym->st_info)) >> 4)) << 4) + ((2) & 0xF));
      sym->st_shndx
  ...
  if (h->is_weakalias)
    {
      ...
      do { if (!(def->root.type == bfd_link_hash_defined)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c",1924); } while (0);
      h->root.u.def.section = def->root.u.def.section;
      h->root.u.def.value = def->root.u.def.value;
      if (1
   || info->nocopyreloc
   || ((eh)->def_protected && ((eh)->elf.root.type == bfd_link_hash_defined || (eh)->elf.root.type == bfd_link_hash_defweak) && ((((eh)->elf.root.u.def.section->owner) -> tdata.elf_obj_data) -> has_no_copy_on_protected) && ((eh)->elf.root.u.def.section->owner->flags & 0x40) != 0 && ((eh)->elf.root.u.def.section->flags & 0x10) == 0))
 {
...
# 1945 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
  if (!(((info)->type == type_pde) || ((info)->type == type_pie)))
    return 1;
  ...
  if (info->nocopyreloc || ((eh)->def_protected && ((eh)->elf.root.type == bfd_link_hash_defined || (eh)->elf.root.type == bfd_link_hash_defweak) && ((((eh)->elf.root.u.def.section->owner) -> tdata.elf_obj_data) -> has_no_copy_on_protected) && ((eh)->elf.root.u.def.section->owner->flags & 0x40) != 0 && ((eh)->elf.root.u.def.section->flags & 0x10) == 0))
    {
      h->non_got_ref = 0;
      return 1;
    }
...
# 1998 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
  if ((h->root.u.def.section->flags & 0x8) != 0)
    {
      s = htab->elf.sdynrelro;
  ...
  if ((h->root.u.def.section->flags & 0x1) != 0 && h->size != 0)
    {
      srel->size += htab->sizeof_reloc;
      h->needs_copy = 1;
    }
        ...
        struct elf_link_hash_entry *h)
{
  ...
  if (eh->local_ref == 1)
    return 0;
# 2063 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c"
      ...
      Elf_Internal_Sym *sym)
{
  ...
  if (((unsigned int) R_X86_64_GNU_VTINHERIT
   ...
   != (unsigned int) R_386_GNU_VTENTRY))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 2096, __PRETTY_FUNCTION__);
...
static bfd_vma
elf_i386_get_plt_got_vma (struct elf_x86_plt *plt_p __attribute__ ((__unused__)),
     bfd_vma off,
     bfd_vma offset __attribute__ ((__unused__)),
     bfd_vma got_addr)
{
  return got_addr + off;
}
...
elf_x86_64_get_plt_got_vma (struct elf_x86_plt *plt_p,
       bfd_vma off,
       bfd_vma offset,
       bfd_vma got_addr __attribute__ ((__unused__)))
{
       ...
       bfd_byte *ptr, unsigned int datasz)
{
      ...
      if (datasz != 4)
 {
   _bfd_error_handler
     ((type == 0xc0000000
       ? dgettext ("bfd", "error: %pB: <corrupt x86 ISA used size: 0x%x>")
       : (type == 0xc0000001
   ? dgettext ("bfd", "error: %pB: <corrupt x86 ISA needed size: 0x%x>")
   : dgettext ("bfd", "error: %pB: <corrupt x86 feature size: 0x%x>"))),
      abfd, datasz);
      ...
      else
 {
       ...
       else
  {
    ...
    default:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 2501, __PRETTY_FUNCTION__);
    }
  ...
  (struct bfd_link_info *info, struct elf_x86_init_table *init_table)
{
  ...
  elf_property *prop;
  const struct elf_backend_data *bed;
  unsigned int class_align = (((const struct elf_backend_data *) ((info->output_bfd)->xvec)->backend_data)->s->elfclass == 2) ? 3 : 2;
      ...
      if (pbfd == ((void*)0))
 {
   sec = bfd_make_section_with_flags (ebfd,
          ...
          (0x1
           ...
           | 0x20));
   if (sec == ((void*)0))
     info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create GNU property section\n"));

   if (!bfd_set_section_alignment (ebfd, sec, class_align))
     {
error_alignment:
       info->callbacks->einfo (dgettext ("bfd", "%F%pA: failed to align section\n"),
          sec);
     }
 ...
 = htab->lazy_plt->eh_frame_plt_size;
  ...
  if (htab->target_os == is_vxworks
      && !elf_vxworks_create_dynamic_sections (dynobj, info,
            &htab->srelplt2))
    {
      info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create VxWorks dynamic sections\n"));
      return pbfd;
    }
  ...
  if (htab->elf.sgot == ((void*)0)
    ...
    info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create GOT sections\n"));
  ...
  if (!_bfd_elf_create_ifunc_sections (dynobj, info))
    info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create ifunc sections\n"));
      ...
      if ((((info)->type == type_pde) || ((info)->type == type_pie)) && !info->nointerp)
 {
   ...
   if (s == ((void*)0))
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elfxx-x86.c", 2765, __PRETTY_FUNCTION__);
      ...
      if (normal_target)
 {
   ...
   sec = bfd_make_section_anyway_with_flags (dynobj,
          ...
          pltflags);
   if (sec == ((void*)0))
     info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create GOT PLT section\n"));
       ...
       if (use_ibt_plt)
  {
    ...
    sec = bfd_make_section_anyway_with_flags (dynobj,
           ...
           pltflags);
    if (sec == ((void*)0))
      info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create IBT-enabled PLT section\n"));
       ...
       else if (info->bndplt && (((const struct elf_backend_data *) ((dynobj)->xvec)->backend_data)->s->elfclass == 2))
  {
    ...
    sec = bfd_make_section_anyway_with_flags (dynobj,
           ...
           pltflags);
    if (sec == ((void*)0))
      info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create BND PLT section\n"));
      ...
      if (!info->no_ld_generated_unwind_info)
 {
   ...
   sec = bfd_make_section_anyway_with_flags (dynobj,
          ...
          flags);
   if (sec == ((void*)0))
     info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create PLT .eh_frame section\n"));
   ...
   if (htab->plt_got != ((void*)0))
     {
       ...
       flags);
       if (sec == ((void*)0))
  info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create GOT PLT .eh_frame section\n"));
   ...
   if (htab->plt_second != ((void*)0))
     {
       ...
       flags);
       if (sec == ((void*)0))
  info->callbacks->einfo (dgettext ("bfd", "%F%P: failed to create the second PLT .eh_frame section\n"));
