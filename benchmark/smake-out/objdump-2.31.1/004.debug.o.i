# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 180 "./sysdep.h" 2
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
...
# 34 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c" 2
...
debug_add_to_namespace (struct debug_handle *info __attribute__ ((__unused__)),
    ...
    enum debug_object_linkage linkage)
{
  ...
  if (info->current_unit == ((void*)0)
    ...
    {
      debug_error (gettext ("debug_add_to_current_namespace: no current file"));
      return ((void*)0);
    }
...
debug_set_filename (void *handle, const char *name)
{
  ...
  if (info->current_unit != ((void*)0))
    ...
    {
      ((void) sizeof ((info->units == ((void*)0)) ? 1 : 0), __extension__ ({ if (info->units == ((void*)0)) ; else __assert_fail ("info->units == NULL", "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c", 699, __extension__ __PRETTY_FUNCTION__); }));
      info->units = nunit;
    }
...
debug_start_source (void *handle, const char *name)
{
  ...
  if (info->current_unit == ((void*)0))
    {
      debug_error (gettext ("debug_start_source: no debug_set_filename call"));
      return 0;
    }
...
# 763 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
bfd_boolean
         ...
         bfd_vma addr)
{
  ...
  if (info->current_unit == ((void*)0))
    {
      debug_error (gettext ("debug_record_function: no debug_set_filename call"));
      return 0;
    }
   ...
   enum debug_parm_kind kind, bfd_vma val)
{
  ...
  if (info->current_unit == ((void*)0)
      || info->current_function == ((void*)0))
    {
      debug_error (gettext ("debug_record_parameter: no current function"));
      return 0;
    }
...
debug_end_function (void *handle, bfd_vma addr)
{
  ...
  if (info->current_unit == ((void*)0)
      ...
      || info->current_function == ((void*)0))
    {
      debug_error (gettext ("debug_end_function: no current function"));
      return 0;
    }

  if (info->current_block->parent != ((void*)0))
    {
      debug_error (gettext ("debug_end_function: some blocks were not closed"));
      return 0;
    }
...
debug_start_block (void *handle, bfd_vma addr)
{
  ...
  if (info->current_unit == ((void*)0)
      || info->current_block == ((void*)0))
    {
      debug_error (gettext ("debug_start_block: no current block"));
      return 0;
    }
...
debug_end_block (void *handle, bfd_vma addr)
{
  ...
  if (info->current_unit == ((void*)0)
      || info->current_block == ((void*)0))
    {
      debug_error (gettext ("debug_end_block: no current block"));
      return 0;
    }
  ...
  if (parent == ((void*)0))
    {
      debug_error (gettext ("debug_end_block: attempt to close top level block"));
      return 0;
    }
...
debug_record_line (void *handle, unsigned long lineno, bfd_vma addr)
{
  ...
  if (info->current_unit == ((void*)0))
    {
      debug_error (gettext ("debug_record_line: no current unit"));
      return 0;
    }
...
# 990 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
...
bfd_boolean
debug_start_common_block (void *handle __attribute__ ((__unused__)),
     const char *name __attribute__ ((__unused__)))
{

  debug_error (gettext ("debug_start_common_block: not implemented"));
  return 0;
}
...
bfd_boolean
debug_end_common_block (void *handle __attribute__ ((__unused__)),
   const char *name __attribute__ ((__unused__)))
{

  debug_error (gettext ("debug_end_common_block: not implemented"));
  return 0;
}
...
bfd_boolean
debug_record_label (void *handle __attribute__ ((__unused__)),
      const char *name __attribute__ ((__unused__)),
      debug_type type __attribute__ ((__unused__)),
      bfd_vma addr __attribute__ ((__unused__)))
{

  debug_error (gettext ("debug_record_label: not implemented"));
  return 0;
}
         ...
         enum debug_var_kind kind, bfd_vma val)
{
  ...
  if (info->current_unit == ((void*)0)
      || info->current_file == ((void*)0))
    {
      debug_error (gettext ("debug_record_variable: no current file"));
      return 0;
    }
...
debug_make_type (struct debug_handle *info __attribute__ ((__unused__)),
...
# 1308 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
debug_type
...
debug_make_pointer_type (void *handle, debug_type type)
{
  ...
  if (type->pointer != ((debug_type) ((void*)0)))
    return type->pointer;
      ...
      enum debug_type_kind kind)
{
  ...
  switch (kind)
    ...
    default:
      debug_error (gettext ("debug_make_undefined_type: unsupported kind"));
      return ((debug_type) ((void*)0));
    }
...
debug_baseclass
debug_make_baseclass (void *handle __attribute__ ((__unused__)), debug_type type,
...
debug_field
debug_make_field (void *handle __attribute__ ((__unused__)), const char *name,
...
debug_field
debug_make_static_member (void *handle __attribute__ ((__unused__)), const char *name,
...
debug_method
debug_make_method (void *handle __attribute__ ((__unused__)), const char *name,
...
# 1775 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c"
debug_method_variant
debug_make_method_variant (void *handle __attribute__ ((__unused__)),
...
debug_method_variant
debug_make_static_method_variant (void *handle __attribute__ ((__unused__)),
      const char *physname, debug_type type,
      enum debug_visibility visibility,
      bfd_boolean constp, bfd_boolean volatilep)
{
...
debug_name_type (void *handle, const char *name, debug_type type)
{
  ...
  if (info->current_unit == ((void*)0)
      || info->current_file == ((void*)0))
    {
      debug_error (gettext ("debug_name_type: no current file"));
      return ((debug_type) ((void*)0));
    }
...
debug_tag_type (void *handle, const char *name, debug_type type)
{
  ...
  if (info->current_file == ((void*)0))
    {
      debug_error (gettext ("debug_tag_type: no current file"));
      return ((debug_type) ((void*)0));
    }
 ...
 return type;
      debug_error (gettext ("debug_tag_type: extra tag attempted"));
      return ((debug_type) ((void*)0));
    }
...
bfd_boolean
debug_record_type_size (void *handle __attribute__ ((__unused__)), debug_type type,
   unsigned int size)
{
  if (type->size != 0 && type->size != size)
    fprintf (stderr, gettext ("Warning: changing type size from %d to %d\n"),
      type->size, size);
...
debug_find_named_type (void *handle, const char *name)
{
  ...
  if (info->current_unit == ((void*)0))
    {
      debug_error (gettext ("debug_find_named_type: no current compilation unit"));
      return ((debug_type) ((void*)0));
    }
       ...
       struct debug_type_real_list *list)
{
 ...
 {
   fprintf (stderr,
     gettext ("debug_get_real_type: circular debug information for %s\n"),
...
debug_type
debug_get_field_type (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0))
    return ((void*)0);
  return field->type;
...
const char *
debug_get_field_name (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0))
    return ((void*)0);
  return field->name;
...
bfd_vma
debug_get_field_bitpos (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0) || field->static_member)
    return (bfd_vma) -1;
...
bfd_vma
debug_get_field_bitsize (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0) || field->static_member)
    return (bfd_vma) -1;
...
enum debug_visibility
debug_get_field_visibility (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0))
...
const char *
debug_get_field_physname (void *handle __attribute__ ((__unused__)), debug_field field)
{
  if (field == ((void*)0) || ! field->static_member)
    return ((void*)0);
    ...
    struct debug_type_s *type, struct debug_name *name)
{
      ...
      else
 {
  ...
  if (name != ((void*)0)
      ...
      && type->kind != DEBUG_KIND_TAGGED)
    {
      ((void) sizeof ((name->kind == DEBUG_OBJECT_TAG) ? 1 : 0), __extension__ ({ if (name->kind == DEBUG_OBJECT_TAG) ; else __assert_fail ("name->kind == DEBUG_OBJECT_TAG", "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c", 2474, __extension__ __PRETTY_FUNCTION__); }));
      tag = name->name;
    }
  ...
  switch (type->kind)
    ...
    case DEBUG_KIND_ILLEGAL:
      debug_error (gettext ("debug_write_type: illegal type encountered"));
      return 0;
    case DEBUG_KIND_INDIRECT:
      if (*type->u.kindirect->slot == ((debug_type) ((void*)0)))
 return (*fns->empty_type) (fhandle);
   ...
   if (info->mark == type->u.kclass->mark)
     {
       ...
       ((void) sizeof ((type->u.kclass->id > info->base_id) ? 1 : 0), __extension__ ({ if (type->u.kclass->id > info->base_id) ; else __assert_fail ("type->u.kclass->id > info->base_id", "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c", 2513, __extension__ __PRETTY_FUNCTION__); }));
   ...
   struct debug_type_s *type, const char *tag)
{
      ...
      if (info->mark == type->u.kclass->mark)
 {
   ...
   ((void) sizeof ((type->u.kclass->id > info->base_id) ? 1 : 0), __extension__ ({ if (type->u.kclass->id > info->base_id) ; else __assert_fail ("type->u.kclass->id > info->base_id", "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c", 2685, __extension__ __PRETTY_FUNCTION__); }));
   return (*fns->tag_type) (fhandle, tag, type->u.kclass->id,
       type->kind);
 }
      type->u.kclass->mark = info->mark;
  ...
  while (info->current_write_lineno != ((void*)0))
    {
      ...
      while (info->current_write_lineno_index < 10)
 {
      ...
      struct debug_type_s *type)
{
  ...
  ((void) sizeof ((type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS) ? 1 : 0), __extension__ ({ if (type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS) ; else __assert_fail ("type->kind == DEBUG_KIND_STRUCT || type->kind == DEBUG_KIND_UNION || type->kind == DEBUG_KIND_CLASS || type->kind == DEBUG_KIND_UNION_CLASS", "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/debug.c", 2944, __extension__ __PRETTY_FUNCTION__); }));
