# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c" 2
# 46 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 47 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 48 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 49 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c" 2


extern const size_t _bfd_target_vector_entries;
# 91 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
bfd_boolean
...
# 120 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
static bfd_boolean
...
bfd_reinit (bfd *abfd, unsigned int section_id)
{
  ...
  abfd->flags &= (0x800 | 0x4000 | 0x8000 | 0x1000 | 0x10000 | 0x20000 | 0x40000 | 0x80000);
...
static void
bfd_preserve_finish (bfd *abfd __attribute__ ((__unused__)), struct bfd_preserve *preserve)
{
...
# 209 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
bfd_boolean
bfd_check_format_matches (bfd *abfd, bfd_format format, char ***matching)
{
  ...
  if (matching != ((void*)0) || *bfd_associated_vector != ((void*)0))
    {
      bfd_size_type amt;
 ...
 goto err_ret;
      ...
      right_targ = (((abfd)->xvec->_bfd_check_format[(int) ((abfd)->format)]) (abfd));

      if (right_targ)
 goto ok_ret;
# 275 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
 ...
 goto err_ret;
      ...
      temp = (((abfd)->xvec->_bfd_check_format[(int) ((abfd)->format)]) (abfd));
      if (temp)
 {
      ...
      if (match_targ != right_targ)
 {
   ...
   if (bfd_seek (abfd, (file_ptr) 0, 0) != 0)
     goto err_ret;
   match_targ = (((abfd)->xvec->_bfd_check_format[(int) ((abfd)->format)]) (abfd));
   do { if (!(match_targ != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c",459); } while (0);
 }
...
# 526 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
bfd_boolean
bfd_set_format (bfd *abfd, bfd_format format)
{
  ...
  if (!(((abfd)->xvec->_bfd_set_format[(int) ((abfd)->format)]) (abfd)))
    {
      abfd->format = bfd_unknown;
      return 0;
    }
...
# 564 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/format.c"
const char *
