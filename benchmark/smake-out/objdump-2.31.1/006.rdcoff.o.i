# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 180 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c" 2
# 48 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/rdcoff.c"
struct coff_symbols
{
...
coff_get_slot (struct coff_types *types, long indx)
{
  ...
  if (indx / (16) > 1000)
    fatal (gettext ("Excessively large slot index: %lx"), indx);
   ...
   void *dhandle)
{
  ...
  if ((ntype & ~(((abfd)->tdata.coff_obj_data)->local_n_btmask)) != 0)
    {
      int newtype;

      newtype = ((((ntype) >> (((abfd)->tdata.coff_obj_data)->local_n_tshift)) & ~ (((abfd)->tdata.coff_obj_data)->local_n_btmask)) | ((ntype) & (((abfd)->tdata.coff_obj_data)->local_n_btmask)));

      if ((((unsigned long) (ntype) & (((abfd)->tdata.coff_obj_data)->local_n_tmask)) == ((unsigned long) (1) << (((abfd)->tdata.coff_obj_data)->local_n_btshft))))
 {
   ...
   type = debug_make_pointer_type (dhandle, type);
      ...
      else if ((((unsigned long) (ntype) & (((abfd)->tdata.coff_obj_data)->local_n_tmask)) == ((unsigned long) (2) << (((abfd)->tdata.coff_obj_data)->local_n_btshft))))
 {
   type = parse_coff_type (abfd, symbols, types, coff_symno, newtype,
      pauxent, useaux, dhandle);
   type = debug_make_function_type (dhandle, type, (debug_type *) ((void*)0),
      ...
      else if ((((unsigned long) (ntype) & (((abfd)->tdata.coff_obj_data)->local_n_tmask)) == ((unsigned long) (3) << (((abfd)->tdata.coff_obj_data)->local_n_btshft))))
 {
   int n;
 ...
 {
   non_fatal (gettext ("parse_coff_type: Bad type code 0x%x"), ntype);
        ...
        union internal_auxent *pauxent, void *dhandle)
{
  ...
  if (ntype >= 0
      && ntype <= (16)
      && types->basic[ntype] != ((debug_type) ((void*)0)))
  ...
  switch (ntype)
    ...
    case 8:
      if (pauxent == ((void*)0))
 ret = debug_make_struct_type (dhandle, 1, 0,
          (debug_field *) ((void*)0));
      else
 ret = parse_coff_struct_type (abfd, symbols, types, ntype, pauxent,
    ...
    case 9:
      if (pauxent == ((void*)0))
 ret = debug_make_struct_type (dhandle, 0, 0, (debug_field *) ((void*)0));
      else
 ret = parse_coff_struct_type (abfd, symbols, types, ntype, pauxent,
          dhandle);
   ...
   union internal_auxent *pauxent, void *dhandle)
{
 ...
 {
   non_fatal (gettext ("bfd_coff_get_syment failed: %s"),
      ...
      else
 {
   if (! bfd_coff_get_auxent (abfd, sym, 0, &auxent))
     {
       non_fatal (gettext ("bfd_coff_get_auxent failed: %s"),
    bfd_errmsg (bfd_get_error ()));
       return ((debug_type) ((void*)0));
     }
   psubaux = &auxent;
 ...
 case 8:
 case 11:
   bitpos = 8 * (((sym)->section->vma) + (sym)->value);
   bitsize = 0;
   break;

 case 18:
   bitpos = (((sym)->section->vma) + (sym)->value);
      ...
      if (! done)
 {
   ...
   ftype = parse_coff_type (abfd, symbols, types, this_coff_symno,
       syment.n_type, psubaux, 1, dhandle);
   f = debug_make_field (dhandle, ((sym)->name), ftype,
    bitpos, bitsize, DEBUG_VISIBILITY_PUBLIC);
   if (f == ((debug_field) ((void*)0)))
     return ((debug_type) ((void*)0));
  ...
  fields[count] = ((debug_field) ((void*)0));

  return debug_make_struct_type (dhandle, ntype == 8,
...
parse_coff_enum_type (bfd *abfd, struct coff_symbols *symbols,
        struct coff_types *types __attribute__ ((__unused__)),
        union internal_auxent *pauxent, void *dhandle)
{
  long symend;
  int alloc;
 ...
 case 16:
   ...
   vals[count] = (((sym)->section->vma) + (sym)->value);
   ++count;
   break;
...
static bfd_boolean
parse_coff_symbol (bfd *abfd __attribute__ ((__unused__)), struct coff_types *types,
     ...
     debug_type type, bfd_boolean within_function)
{
  switch (psyment->n_sclass)
    ...
    case 1:
      if (! debug_record_variable (dhandle, ((sym)->name), type,
       DEBUG_LOCAL, (((sym)->section->vma) + (sym)->value)))
 return 0;
      break;
    ...
    case 2:
      if (! debug_record_variable (dhandle, ((sym)->name), type,
       DEBUG_GLOBAL, (((sym)->section->vma) + (sym)->value)))
 return 0;
      break;
 ...
 return 0;
    ...
    case 4:
      ...
      if (! debug_record_variable (dhandle, ((sym)->name), type,
       DEBUG_REGISTER, (((sym)->section->vma) + (sym)->value)))
 return 0;
      break;
    ...
    case 9:
      if (! debug_record_parameter (dhandle, ((sym)->name), type,
        DEBUG_PARM_STACK, (((sym)->section->vma) + (sym)->value)))
 return 0;
      break;
    ...
    case 17:
      ...
      if (! debug_record_parameter (dhandle, ((sym)->name), type,
        DEBUG_PARM_REG, (((sym)->section->vma) + (sym)->value)))
 return 0;
      break;

    case 13:
      type = debug_name_type (dhandle, ((sym)->name), type);
 ...
 type = debug_tag_type (dhandle, ((sym)->name), type);
 if (type == ((debug_type) ((void*)0)))
   return 0;
...
parse_coff (bfd *abfd, asymbol **syms, long symcount, void *dhandle)
{
  ...
  types.slots = ((void*)0);
  for (i = 0; i <= (16); i++)
    types.basic[i] = ((debug_type) ((void*)0));
      ...
      else
 {
   ...
   paux = &auxent;
      ...
      if (this_coff_symno == next_c_file && syment.n_sclass != 103)
 {
 ...
 case 127:
 case 2:
   if ((((unsigned long) (syment.n_type) & (((abfd)->tdata.coff_obj_data)->local_n_tmask)) == ((unsigned long) (2) << (((abfd)->tdata.coff_obj_data)->local_n_btshft))))
     {
       fnname = name;
       fnclass = syment.n_sclass;
       fntype = syment.n_type;
       if (syment.n_numaux > 0)
  fnend = (((sym)->section->vma) + (sym)->value) + auxent.x_sym.x_misc.x_fsize;
       else
  fnend = 0;
       linenos = ((*((abfd)->xvec->_get_lineno)) (abfd, sym));
       break;
     }
   type = parse_coff_type (abfd, &symbols, &types, this_coff_symno,
      syment.n_type, paux, 1, dhandle);
   if (type == ((debug_type) ((void*)0)))
     return 0;
 ...
 case 101:
   if (strcmp (name, ".bf") == 0)
     {
       if (fnname == ((void*)0))
  {
    non_fatal (gettext ("%ld: .bf without preceding function"),
        this_coff_symno);
    return 0;
  }

       type = parse_coff_type (abfd, &symbols, &types, this_coff_symno,
          ((((fntype) >> (((abfd)->tdata.coff_obj_data)->local_n_tshift)) & ~ (((abfd)->tdata.coff_obj_data)->local_n_btmask)) | ((fntype) & (((abfd)->tdata.coff_obj_data)->local_n_btmask))), paux, 0, dhandle);
       if (type == ((debug_type) ((void*)0)))
  return 0;
       ...
       if (linenos != ((void*)0))
  {
    ...
    addr = ((void) abfd, (((sym)->section))->vma);
   ...
   return 0;
   ...
   else if (strcmp (name, ".ef") == 0)
     {
       if (! within_function)
  {
    non_fatal (gettext ("%ld: unexpected .ef\n"), this_coff_symno);
    return 0;
  }

       if ((((sym)->section->vma) + (sym)->value) > fnend)
  fnend = (((sym)->section->vma) + (sym)->value);
 ...
 case 100:
   if (strcmp (name, ".bb") == 0)
     {
       if (! debug_start_block (dhandle, (((sym)->section->vma) + (sym)->value)))
  return 0;
     }
   else if (strcmp (name, ".eb") == 0)
     {
       if (! debug_end_block (dhandle, (((sym)->section->vma) + (sym)->value)))
  return 0;
     }
   break;
