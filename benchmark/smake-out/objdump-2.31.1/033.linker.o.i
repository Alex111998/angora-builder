# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
# 1 "./genlink.h" 1
# 42 "./genlink.h"
...
struct bfd_hash_entry *_bfd_generic_link_hash_newfunc
  (struct bfd_hash_entry *, struct bfd_hash_table *, const char *);
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c" 2
# 405 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
   ...
   unsigned int entsize)
{
  ...
  do { if (!(!abfd->is_linker_output && !abfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",469); } while (0);
  table->undefs = ((void*)0);
  ...
  if (info->wrap_hash != ((void*)0))
    {
      ...
      l = string;
      if (*l == ((abfd)->xvec->symbol_leading_char) || *l == info->wrap_char)
 {
   prefix = *l;
   ++l;
 }
      ...
      if (bfd_hash_lookup (info->wrap_hash, l, 0, 0) != ((void*)0))
 {
   char *n;
   struct bfd_link_hash_entry *h;
   ...
   strcat (n, "__wrap_");
   strcat (n, l);
   h = bfd_link_hash_lookup (info->hash, n, create, 1, follow);
   free (n);
   return h;
 }
      ...
      if (*l == '_'
   && (strncmp ((l), ("__real_"), sizeof ("__real_") - 1) == 0)
      ...
      struct bfd_link_hash_entry *h)
{
  ...
  if (*l == ((input_bfd)->xvec->symbol_leading_char)
      || *l == info->wrap_char)
    ++l;

  if ((strncmp ((l), ("__wrap_"), sizeof ("__wrap_") - 1) == 0))
    {
      l += sizeof "__wrap_" - 1;
 ...
 {
   char save = 0;
   if (l - (sizeof "__wrap_" - 1) != h->root.string)
     {
       --l;
       save = *l;
       *(char *) l = *h->root.string;
     }
   h = bfd_link_hash_lookup (info->hash, l, 0, 0, 0);
   if (save)
     *(char *) l = save;
 }
    }
...
# 641 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
void
  ...
  for (i = 0; i < htab->table.size; i++)
    {
      ...
      for (; p != ((void*)0); p = (struct bfd_link_hash_entry *) p->root.next)
...
bfd_link_add_undef (struct bfd_link_hash_table *table,
      struct bfd_link_hash_entry *h)
{
  do { if (!(h->u.undef.next == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",669); } while (0);
...
# 684 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
void
...
_bfd_generic_link_hash_table_free (bfd *obfd)
{
  ...
  do { if (!(obfd->is_linker_output && obfd->link.hash)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",774); } while (0);
  ret = (struct generic_link_hash_table *) obfd->link.hash;
  bfd_hash_table_free (&ret->root.table);
  free (ret);
  obfd->link.hash = ((void*)0);
  obfd->is_linker_output = 0;
}
# 789 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
bfd_generic_link_read_symbols (bfd *abfd)
{
  if (((abfd)->outsymbols) == ((void*)0))
    {
      long symsize;
      long symcount;
      ...
      if (symsize < 0)
 return 0;
      ((abfd)->outsymbols) = (struct bfd_symbol **) bfd_alloc (abfd,
            symsize);
      if (((abfd)->outsymbols) == ((void*)0) && symsize != 0)
 return 0;
      symcount = ((*((abfd)->xvec->_bfd_canonicalize_symtab)) (abfd, ((abfd)->outsymbols)));
      if (symcount < 0)
 return 0;
...
void
_bfd_generic_copy_link_hash_symbol_type (bfd *abfd __attribute__ ((__unused__)),
    struct bfd_link_hash_entry *hdest __attribute__ ((__unused__)),
    struct bfd_link_hash_entry *hsrc __attribute__ ((__unused__)))
{
}
     ...
     struct bfd_link_info *info)
{
  ...
  outsyms = ((abfd)->outsymbols);
  return generic_link_add_symbol_list (abfd, info, symcount, outsyms);
}
# 892 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
      ...
      bfd_boolean *))
{
 ...
 return 1;
  ...
  amt = ((abfd)->tdata.aout_ar_data)->symdef_count;
  if (amt == 0)
    return 1;
  amt *= sizeof (*included);
  ...
  do
    {
      ...
      bfd_boolean needed = 0;
      bfd *element = ((void*)0);

      loop = 0;
      arsyms = ((abfd)->tdata.aout_ar_data)->symdefs;
      arsym_end = arsyms + ((abfd)->tdata.aout_ar_data)->symdef_count;
      for (arsym = arsyms, indx = 0; arsym < arsym_end; arsym++, indx++)
 {
   ...
   if (h == ((void*)0)
       ...
       && (strncmp ((arsym->name), ("__imp_"), sizeof ("__imp_") - 1) == 0))
        ...
        bfd_boolean *pneeded)
{
  ...
  for (; pp < ppend; pp++)
    {
      ...
      if (! (((p->section)->flags & 0x1000) != 0)
   && (p->flags & ((1 << 1) | (1 << 13) | (1 << 7))) == 0)
 continue;
      ...
      h = bfd_link_hash_lookup (info->hash, ((p)->name), 0,
    0, 1);
      if (h == ((void*)0)
       ...
       && h->u.undef.abfd == ((void*)0)))
 {
   ...
   *pneeded = 1;
   if (!(*info->callbacks
  ->add_archive_element) (info, abfd, ((p)->name),
     &abfd))
     return 0;


   return ((*((abfd)->xvec->_bfd_link_add_symbols)) (abfd, info));
 }
      ...
      if (h->type == bfd_link_hash_undefined)
 {
   ...
   bfd_vma size;
   unsigned int power;
# 1091 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
      ...
      else
 {
   ...
   if ((((p)->section->vma) + (p)->value) > h->u.c.size)
     h->u.c.size = (((p)->section->vma) + (p)->value);
 }
    }
  ...
  for (; pp < ppend; pp++)
    {
      ...
      if ((p->flags & ((1 << 13)
         ...
         | (1 << 11)
         | (1 << 7))) != 0
   || ((((p)->section)) == (&_bfd_std_section[1]))
   || (((((p)->section))->flags & 0x1000) != 0)
   || ((((p)->section)) == (&_bfd_std_section[3])))
 {
   const char *name;
   const char *string;
   ...
   (info, abfd, name, p->flags, ((p)->section),
    p->value, string, 0, 0, &bh)))
     return 0;
...
# 1206 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
   if (info->output_bfd->xvec == abfd->xvec)
     {
       if (h->sym == ((void*)0)
    || (! ((((p)->section)) == (&_bfd_std_section[1]))
        && (! (((((p)->section))->flags & 0x1000) != 0)
     || ((((h->sym)->section)) == (&_bfd_std_section[1])))))
  {
    h->sym = p;
...
# 1242 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
enum link_row
{
  UNDEF_ROW,
  UNDEFW_ROW,
...
static const enum link_action link_action[8][8] =
{
                 ...
                 {DEF, DEF, DEF, MDEF, DEF, CDEF, MDEF, CYCLE },
                  ...
                  {IND, IND, IND, MDEF, IND, CIND, MIND, CYCLE },
                    {MWARN, WARN, WARN, WARN, WARN, WARN, WARN, NOACT },
                 {SET, SET, SET, SET, SET, SET, CYCLE, CYCLE }
};
# 1325 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
static bfd *
...
# 1364 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry **hashp)
{
  enum link_row row;
  struct bfd_link_hash_entry *h;
  struct bfd_link_hash_entry *inh = ((void*)0);
  bfd_boolean cycle;

  do { if (!(section != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",1381); } while (0);

  if (((section) == (&_bfd_std_section[3]))
      || (flags & (1 << 13)) != 0)
    {
      row = INDR_ROW;
      ...
      inh = bfd_wrapped_link_hash_lookup (abfd, info, string, 1,
       copy, 0);
      if (inh == ((void*)0))
 return 0;
    }
    ...
    row = SET_ROW;
  else if (((section) == (&_bfd_std_section[1])))
    {
      if ((flags & (1 << 7)) != 0)
 row = UNDEFW_ROW;
      else
 row = UNDEF_ROW;
    ...
    row = DEFW_ROW;
  else if ((((section)->flags & 0x1000) != 0))
    {
      row = COMMON_ROW;
 ...
 _bfd_error_handler
  ...
  if (hashp != ((void*)0) && *hashp != ((void*)0))
    h = *hashp;
  else
    {
      if (row == UNDEF_ROW || row == UNDEFW_ROW)
 h = bfd_wrapped_link_hash_lookup (abfd, info, name, 1, copy, 0);
      else
 h = bfd_link_hash_lookup (info->hash, name, 1, copy, 0);
      if (h == ((void*)0))
 {
   if (hashp != ((void*)0))
     *hashp = ((void*)0);
  ...
  if (info->notice_all
   ...
   && bfd_hash_lookup (info->notice_hash, name, 0, 0) != ((void*)0)))
    {
 ...
 {
 case FAIL:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 1463, __PRETTY_FUNCTION__);
 ...
 case CDEF:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",1485); } while (0);
 ...
 case DEFW:
   {
     ...
     if (collect && name[0] == '_')
       {
  const char *s;
# 1524 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
  s = name + 1;
  while (*s == '_')
    ++s;
  if (s[0] == 'G' && (strncmp ((s), ("GLOBAL_"), sizeof ("GLOBAL_") - 1) == 0))
    {
      char c;

      c = s[(sizeof "GLOBAL_" - 1) + 1];
      if ((c == 'I' || c == 'D')
   && s[(sizeof "GLOBAL_" - 1)] == s[(sizeof "GLOBAL_" - 1) + 2])
        {
   ...
   if (oldtype == bfd_link_hash_defweak)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 1543, __PRETTY_FUNCTION__);
...
# 1589 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
 ...
 case REF:
   ...
   if (h->u.undef.next == ((void*)0) && info->hash->undefs_tail != h)
     h->u.undef.next = h;
   break;
 ...
 case BIG:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",1616); } while (0);
   (*info->callbacks->multiple_common) (info, h, abfd,
 ...
 case CIND:
   ...
   do { if (!(h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",1674); } while (0);
   (*info->callbacks->multiple_common) (info, h, abfd,
 ...
 case IND:
  ...
  (dgettext ("bfd", "%pB: indirect symbol `%s' to `%s' is a loop"),
   abfd, name, string);
 ...
 case WARNC:
   ...
   if (h->u.i.warning != ((void*)0)
       && (abfd->flags & 0x10000) == 0)
     {
       (*info->callbacks->warning) (info, h->u.i.warning,
        h->root.string, abfd, ((void*)0), 0);

       h->u.i.warning = ((void*)0);
     }
 ...
 case MWARN:

   {
     ...
     ((*info->hash->table.newfunc)
      (((void*)0), &info->hash->table, h->root.string)));
     if (sub == ((void*)0))
       return 0;
     *sub = *h;
...
_bfd_generic_final_link (bfd *abfd, struct bfd_link_info *info)
{
 ...
 p->u.indirect.section->linker_mark = 1;
  ...
  (bfd_link_hash_traverse (&(((struct generic_link_hash_table *) ((info)->hash)))->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (_bfd_generic_link_write_global_symbol), (&wginfo)));
  ...
  if (! generic_add_output_symbol (abfd, &outsymalloc, ((void*)0)))
    return 0;
      ...
      for (o = abfd->sections; o != ((void*)0); o = o->next)
 {
       ...
       else if (p->type == bfd_indirect_link_order)
  {
    ...
    if (reloc_count < 0)
      return 0;
    do { if (!((unsigned long) reloc_count == input_section->reloc_count)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",1881); } while (0);
      ...
      for (p = o->map_head.link_order; p != ((void*)0); p = p->next)
 {
  ...
  return 0;
     ...
     case bfd_indirect_link_order:
       if (! default_indirect_link_order (abfd, info, o, p, 1))
  return 0;
       break;
     default:
 ...
 *psymalloc *= 2;
      amt = *psymalloc;
      amt *= sizeof (asymbol *);
      newsyms = (asymbol **) bfd_realloc (((output_bfd)->outsymbols), amt);
      if (newsyms == ((void*)0))
 return 0;
      ...
      size_t *psymalloc)
{
      ...
      for (sec = input_bfd->sections; sec != ((void*)0); sec = sec->next)
 {
   if (sec->output_section == info->create_object_symbols_section)
     {
       ...
       newsym = ((*((input_bfd)->xvec->_bfd_make_empty_symbol)) (input_bfd));
       if (!newsym)
  return 0;
       newsym->name = input_bfd->filename;
       newsym->value = 0;
       newsym->flags = (1 << 0) | (1 << 14);
       newsym->section = sec;
  ...
  sym_ptr = ((input_bfd)->outsymbols);
  sym_end = sym_ptr + ((input_bfd)->symcount);
  for (; sym_ptr < sym_end; sym_ptr++)
   ...
   || ((((sym)->section)) == (&_bfd_std_section[3])))
 {
   if (sym->udata.p != ((void*)0))
     h = (struct generic_link_hash_entry *) sym->udata.p;
   else if ((sym->flags & (1 << 11)) != 0)
     {
# 2033 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
       h = ((void*)0);
     }
   else if (((((sym)->section)) == (&_bfd_std_section[1])))
     h = ((struct generic_link_hash_entry *)
   bfd_wrapped_link_hash_lookup (output_bfd, info,
            ((sym)->name),
            0, 0, 1));
   else
     h = ((struct generic_link_hash_entry *) bfd_link_hash_lookup (&(((struct generic_link_hash_table *) ((info)->hash)))->root, (((sym)->name)), (0), (0), (1)));
  ...
  case bfd_link_hash_new:
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2062, __PRETTY_FUNCTION__);
  case bfd_link_hash_undefined:
    break;
  case bfd_link_hash_undefweak:
    sym->flags |= (1 << 7);
  ...
  case bfd_link_hash_common:
    ...
    sym->flags |= (1 << 1);
    if (! (((sym->section)->flags & 0x1000) != 0))
      {
        do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2088); } while (0);
        sym->section = (&_bfd_std_section[0]);
      }
   ...
   || (info->strip == strip_some
       && bfd_hash_lookup (info->keep_hash, ((sym)->name),
      0, 0) == ((void*)0)))
 output = 0;
      else if ((sym->flags & ((1 << 1) | (1 << 7) | (1 << 23))) != 0)
 {




   if (((sym)->the_bfd) == input_bfd
       && (sym->flags & (1 << 10)) != 0)
     output = 1;
   else
     output = 0;
 }
      else if (((sym->section) == (&_bfd_std_section[3])))
 output = 0;
      else if ((sym->flags & (1 << 2)) != 0)
 {
      ...
      else if ((sym->flags & (1 << 11)))
 {
   if (info->strip != strip_all)
     ...
     output = 0;
        ...
        && (sym->section->owner->flags & 0x10000) != 0)



 output = 0;
      else
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2177, __PRETTY_FUNCTION__);




      if (!((sym->section) == (&_bfd_std_section[2]))
   && ((sym->section->output_section)->next == ((void*)0) ? (output_bfd)->section_last != (sym->section->output_section) : (sym->section->output_section)->next->prev != (sym->section->output_section)))
...
set_symbol_from_hash (asymbol *sym, struct bfd_link_hash_entry *h)
{
  switch (h->type)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2208, __PRETTY_FUNCTION__);
      break;
    case bfd_link_hash_new:
 ...
 {
   do { if (!((sym->flags & (1 << 11)) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2215); } while (0);
 }
      else
 {
   sym->flags |= (1 << 11);
   ...
   sym->value = 0;
    ...
    case bfd_link_hash_common:
      ...
      if (sym->section == ((void*)0))
 sym->section = (&_bfd_std_section[0]);
      else if (! (((sym->section)->flags & 0x1000) != 0))
 {
   do { if (!(((sym->section) == (&_bfd_std_section[1])))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2248); } while (0);
   sym->section = (&_bfd_std_section[0]);
 }
           ...
           void *data)
{
  ...
  if (h->sym != ((void*)0))
    ...
    {
      sym = ((*((wginfo->output_bfd)->xvec->_bfd_make_empty_symbol)) (wginfo->output_bfd));
      if (!sym)
 return 0;
  ...
  if (! generic_add_output_symbol (wginfo->output_bfd, wginfo->psymalloc,
       sym))
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2301, __PRETTY_FUNCTION__);
    }
          ...
          struct bfd_link_order *link_order)
{
  ...
  if (! ((info)->type == type_relocatable))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2318, __PRETTY_FUNCTION__);
  if (sec->orelocation == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2320, __PRETTY_FUNCTION__);
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2381, __PRETTY_FUNCTION__);
    ...
    struct bfd_link_order *link_order)
{
  switch (link_order->type)
    ...
    case bfd_symbol_reloc_link_order:
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2446, __PRETTY_FUNCTION__);
    case bfd_indirect_link_order:
    ...
    struct bfd_link_order *link_order)
{
  ...
  do { if (!((sec->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2469); } while (0);
  ...
  if (fill_size == 0)
    {
      fill = abfd->arch_info->fill (size, ((abfd)->xvec->byteorder == BFD_ENDIAN_BIG),
        (sec->flags & 0x10) != 0);
      if (fill == ((void*)0))
 return 0;
    }
        ...
        bfd_boolean generic_linker)
{
  ...
  do { if (!((output_section->flags & 0x100) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2532); } while (0);
  ...
  do { if (!(input_section->output_section == output_section)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2539); } while (0);
  do { if (!(input_section->output_offset == link_order->offset)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2540); } while (0);
  do { if (!(input_section->size == link_order->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2541); } while (0);
 ...
 (dgettext ("bfd", "attempt to do relocatable link with %s input and %s output"),
  ((input_bfd)->xvec->name), ((output_bfd)->xvec->name));
      bfd_set_error (bfd_error_wrong_format);
      return 0;
    }
 ...
 return 0;
      ...
      sympp = ((input_bfd)->outsymbols);
      symppend = sympp + ((input_bfd)->symcount);
      for (; sympp < symppend; sympp++)
 {
  ...
  if ((output_section->flags & (0x2000000 | 0x100000)) == 0x2000000
      ...
      if (!output_bfd->output_has_begun)
 {
   ...
   if (!bfd_set_section_contents (output_bfd, output_section, "", 0, 1))
     goto error_return;
      ...
      do { if (!(new_contents != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2624); } while (0);
      do { if (!(input_section->output_offset == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",2625); } while (0);
    }
  else
    {
...
# 2697 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
_bfd_generic_link_split_section (bfd *abfd __attribute__ ((__unused__)),
     asection *sec __attribute__ ((__unused__)))
{
  return 0;
}
# 2733 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
...
already_linked_newfunc (struct bfd_hash_entry *entry __attribute__ ((__unused__)),
   struct bfd_hash_table *table,
   const char *string __attribute__ ((__unused__)))
{
...
_bfd_handle_already_linked (asection *sec,
       ...
       struct bfd_link_info *info)
{
  switch (sec->flags & 0xc0000)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c", 2820, __PRETTY_FUNCTION__);
 ...
 (dgettext ("bfd", "%pB: ignoring duplicate section `%pA'\n"),
  sec->owner, sec);
      break;

    case 0x80000:
      if ((l->sec->owner->flags & 0x10000) != 0)
 ;
      else if (sec->size != l->sec->size)
 info->callbacks->einfo

   (dgettext ("bfd", "%pB: duplicate section `%pA' has different size\n"),
    sec->owner, sec);
      break;
      ...
      else if (sec->size != 0)
 {
   ...
   if (!bfd_malloc_and_get_section (sec->owner, sec, &sec_contents))
     info->callbacks->einfo
       ...
       (dgettext ("bfd", "%pB: could not read contents of section `%pA'\n"),
        sec->owner, sec);
     ...
     info->callbacks->einfo
       ...
       (dgettext ("bfd", "%pB: duplicate section `%pA' has different contents\n"),
        sec->owner, sec);
...
bfd_boolean
_bfd_generic_section_already_linked (bfd *abfd __attribute__ ((__unused__)),
         asection *sec,
         struct bfd_link_info *info)
{
  const char *name;
  ...
  if ((sec->flags & 0x20000) == 0)
    return 0;


  if ((sec->flags & 0x2000000) != 0)
    return 0;
# 2932 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
...
_bfd_nearby_section (bfd *obfd, asection *s, bfd_vma addr)
{
  ...
  for (prev = s->prev; prev != ((void*)0); prev = prev->prev)
    if ((prev->flags & 0x8000) == 0
 && !((prev)->next == ((void*)0) ? (obfd)->section_last != (prev) : (prev)->next->prev != (prev)))
      break;
  ...
  for (; next != ((void*)0); next = next->next)
    if ((next->flags & 0x8000) == 0
 && !((next)->next == ((void*)0) ? (obfd)->section_last != (next) : (next)->next->prev != (next)))
      break;
 ...
 best = prev;
  ...
  else if (((prev->flags ^ next->flags) & 0x8) != 0)
    {
      if (((next->flags ^ s->flags) & 0x8) != 0)
 best = prev;
    }
  else if (((prev->flags ^ next->flags) & 0x10) != 0)
    {
      if (((next->flags ^ s->flags) & 0x10) != 0)
 best = prev;
    }
  else
    {
...
fix_syms (struct bfd_link_hash_entry *h, void *data)
{
  ...
  if (h->type == bfd_link_hash_defined
   ...
   && (s->output_section->flags & 0x8000) != 0
   && ((s->output_section)->next == ((void*)0) ? (obfd)->section_last != (s->output_section) : (s->output_section)->next->prev != (s->output_section)))
 {
   asection *op;
...
# 3072 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
      ...
      struct bfd_link_hash_entry *h)
{
  ...
  do { if (!(h != ((void*)0) && h->type == bfd_link_hash_common)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",3081); } while (0);
  ...
  do { if (!(alignment != 0 && (alignment & -alignment) == alignment)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c",3090); } while (0);
  ...
  section->flags |= 0x1;
  section->flags &= ~0x1000;
  return 1;
}
# 3132 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
void
_bfd_generic_link_hide_symbol (bfd *output_bfd __attribute__ ((__unused__)),
          struct bfd_link_info *info __attribute__ ((__unused__)),
          struct bfd_link_hash_entry *h __attribute__ ((__unused__)))
{
}
# 3157 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
struct bfd_link_hash_entry *
          ...
          const char *symbol, asection *sec)
{
  ...
  h = bfd_link_hash_lookup (info->hash, symbol, 0, 0, 1);
  if (h != ((void*)0)
      && (h->type == bfd_link_hash_undefined
   || h->type == bfd_link_hash_undefweak))
    {
...
# 3193 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
struct bfd_elf_version_tree *
     ...
     bfd_boolean *hide)
{
  ...
  local_ver = ((void*)0);
  global_ver = ((void*)0);
  star_local_ver = ((void*)0);
  star_global_ver = ((void*)0);
  exist_ver = ((void*)0);
  for (t = verdefs; t != ((void*)0); t = t->next)
    {
      if (t->globals.list != ((void*)0))
 {
   struct bfd_elf_version_expr *d = ((void*)0);

   while ((d = (*t->match) (&t->globals, d, sym_name)) != ((void*)0))
     {
      ...
      if (t->locals.list != ((void*)0))
 {
   ...
   while ((d = (*t->match) (&t->locals, d, sym_name)) != ((void*)0))
     {
       if (d->literal || strcmp (d->pattern, "*") != 0)
  local_ver = t;
       else
  ...
  if (global_ver == ((void*)0) && local_ver == ((void*)0))
    global_ver = star_global_ver;

  if (global_ver != ((void*)0))
    {
...
# 3297 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
...
# 3321 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
bfd_link_check_relocs (bfd *abfd, struct bfd_link_info *info)
{
  return ((*((abfd)->xvec->_bfd_link_check_relocs)) (abfd, info));
}
# 3342 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
_bfd_generic_link_check_relocs (bfd *abfd __attribute__ ((__unused__)),
    struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 1;
}
# 3384 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/linker.c"
bfd_boolean
_bfd_generic_verify_endian_match (bfd *ibfd, struct bfd_link_info *info)
{
  ...
  if (ibfd->xvec->byteorder != obfd->xvec->byteorder
    ...
    {
      if (((ibfd)->xvec->byteorder == BFD_ENDIAN_BIG))
 _bfd_error_handler (dgettext ("bfd", "%pB: compiled for a big endian system " "and target is little endian"), ibfd);

      else
 _bfd_error_handler (dgettext ("bfd", "%pB: compiled for a little endian system " "and target is big endian"), ibfd);
...
int
_bfd_nolink_sizeof_headers (bfd *abfd __attribute__ ((__unused__)),
       struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 0;
}
...
_bfd_nolink_bfd_relax_section (bfd *abfd,
          asection *section __attribute__ ((__unused__)),
          struct bfd_link_info *link_info __attribute__ ((__unused__)),
          bfd_boolean *again __attribute__ ((__unused__)))
{
...
_bfd_nolink_bfd_get_relocated_section_contents
    (bfd *abfd,
     ...
     bfd_boolean relocatable __attribute__ ((__unused__)),
     asymbol **symbols __attribute__ ((__unused__)))
{
...
_bfd_nolink_bfd_lookup_section_flags
    (struct bfd_link_info *info __attribute__ ((__unused__)),
     struct flag_info *flaginfo __attribute__ ((__unused__)),
     asection *section)
{
...
_bfd_nolink_bfd_is_group_section (bfd *abfd,
      const asection *sec __attribute__ ((__unused__)))
{
  return _bfd_bool_bfd_false_error (abfd);
}

bfd_boolean
_bfd_nolink_bfd_discard_group (bfd *abfd, asection *sec __attribute__ ((__unused__)))
{
  return _bfd_bool_bfd_false_error (abfd);
}
...
void
_bfd_nolink_bfd_link_just_syms (asection *sec __attribute__ ((__unused__)),
    struct bfd_link_info *info __attribute__ ((__unused__)))
{
}
...
_bfd_nolink_bfd_copy_link_hash_symbol_type
    (bfd *abfd __attribute__ ((__unused__)),
     struct bfd_link_hash_entry *from __attribute__ ((__unused__)),
     struct bfd_link_hash_entry *to __attribute__ ((__unused__)))
{
}

bfd_boolean
_bfd_nolink_bfd_link_split_section (bfd *abfd, asection *sec __attribute__ ((__unused__)))
{
  return _bfd_bool_bfd_false_error (abfd);
}
...
struct bfd_link_hash_entry *
_bfd_nolink_bfd_define_start_stop (struct bfd_link_info *info __attribute__ ((__unused__)),
       const char *name __attribute__ ((__unused__)),
       asection *sec)
{
