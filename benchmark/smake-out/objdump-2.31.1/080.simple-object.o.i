# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c"
# 1 "./config.h" 1
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
simple_object_copy_lto_debug_sections (simple_object_read *src_object,
           const char *dest,
           int *err, int rename);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
# 48 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object.c" 2
...
simple_object_internal_read (int descriptor, off_t offset,
        ...
        const char **errmsg, int *err)
{
  if (lseek (descriptor, offset, 0) < 0)
    {
      *errmsg = "lseek";
     ...
     int *err)
{
      ...
      if (data != ((void*)0))
 {
   ...
   ret = ((simple_object_read *) xmalloc (sizeof (simple_object_read)));
...
{
  char *newname = rename ? ((char *) xcalloc ((strlen (name) + 1), sizeof (char)))
             : xstrdup (name);
           ...
           const char *dest, int *err, int rename)
{
  ...
  if (! attrs)
    return errmsg;
  dest_sobj = simple_object_start_write (attrs, ((void*)0), &errmsg, err);
    ...
    int *err)
{
  ...
  if (data == ((void*)0))
    return ((void*)0);
  ret = ((simple_object_attributes *) xmalloc (sizeof (simple_object_attributes)));
      ...
      int *err)
{
  ...
  if (data == ((void*)0))
    return ((void*)0);
  ret = ((simple_object_write *) xmalloc (sizeof (simple_object_write)));
  ret->functions = attrs->functions;
  ret->segment_name = segment_name ? xstrdup (segment_name) : ((void*)0);
  ret->sections = ((void*)0);
  ret->last_section = ((void*)0);
  ret->data = data;
  return ret;
}
        ...
        int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((simple_object_write_section *) xmalloc (sizeof (simple_object_write_section)));
  ret->next = ((void*)0);
  ret->name = xstrdup (name);
  ret->align = align;
  ret->buffers = ((void*)0);
  ret->last_buffer = ((void*)0);

  if (sobj->last_section == ((void*)0))
    {
      sobj->sections = ret;
...
const char *
simple_object_write_add_data (simple_object_write *sobj __attribute__ ((__unused__)),
         simple_object_write_section *section,
         const void *buffer,
         ...
         int *err __attribute__ ((__unused__)))
{
  ...
  wsb = ((struct simple_object_write_section_buffer *) xmalloc (sizeof (struct simple_object_write_section_buffer)));
  wsb->next = ((void*)0);
  wsb->size = size;
  ...
  if (!copy)
    ...
    {
      wsb->free_buffer = (void *) ((char *) xmalloc (sizeof (char) * (size)));
      memcpy (wsb->free_buffer, buffer, size);
      wsb->buffer = wsb->free_buffer;
    }

  if (section->last_buffer == ((void*)0))
    {
      section->buffers = wsb;
...
simple_object_release_write (simple_object_write *sobj)
{
      ...
      while (buffer != ((void*)0))
 {
   ...
   if (buffer->free_buffer != ((void*)0))
     free ((void*) (buffer->free_buffer));
