# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c" 2
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 39 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c" 2
...
static bfd_boolean
binary_mkobject (bfd *abfd __attribute__ ((__unused__)))
{
  return 1;
}
...
static long
binary_get_symtab_upper_bound (bfd *abfd __attribute__ ((__unused__)))
{
  return (3 + 1) * sizeof (asymbol *);
}
...
mangle_name (bfd *abfd, char *suffix)
{
  ...
  size = (strlen (((char *) (abfd)->filename))
   + strlen (suffix)
   + sizeof "_binary__");
  ...
  sprintf (buf, "_binary_%s_%s", ((char *) (abfd)->filename), suffix);
...
binary_canonicalize_symtab (bfd *abfd, asymbol **alocation)
{
  ...
  asymbol *syms;
  unsigned int i;
  bfd_size_type amt = 3 * sizeof (asymbol);
  ...
  syms[2].flags = (1 << 1);
  syms[2].section = (&_bfd_std_section[2]);
...
# 198 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c"
static void
binary_get_symbol_info (bfd *ignore_abfd __attribute__ ((__unused__)),
   asymbol *symbol,
   symbol_info *ret)
{
  bfd_symbol_info (symbol, ret);
}
# 221 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c"
static bfd_boolean
      ...
      for (s = abfd->sections; s != ((void*)0); s = s->next)
 {
   ...
   if (s->filepos < 0)
     _bfd_error_handler
       ...
       (dgettext ("bfd", "warning: writing section `%pA' at huge (ie negative) " "file offset"),
  ...
  if ((sec->flags & (0x2 | 0x1)) == 0)
    return 1;
  if ((sec->flags & 0x200) != 0)
    return 1;
...
static int
binary_sizeof_headers (bfd *abfd __attribute__ ((__unused__)),
         struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 0;
}
# 324 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/binary.c"
const bfd_target binary_vec =
{
  ...
  _bfd_archive_close_and_cleanup, _bfd_bool_bfd_true, _bfd_generic_new_section_hook, binary_get_section_contents, _bfd_generic_get_section_contents_in_window,
