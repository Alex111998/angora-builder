# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
# 1 "./config.h" 1
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
simple_object_copy_lto_debug_sections (simple_object_read *src_object,
           const char *dest,
           int *err, int rename);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c" 2
...
# 87 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
...
# 136 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
...
# 186 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
...
# 269 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-xcoff.c"
...
static void *
simple_object_xcoff_match (unsigned char header[(16)],
      ...
      const char **errmsg, int *err)
{
  ...
  ocr = ((struct simple_object_xcoff_read *) xmalloc (sizeof (struct simple_object_xcoff_read)));
  ocr->magic = magic;
  ocr->nscns = fetch_16 (hdrbuf + __builtin_offsetof(struct external_filehdr, f_nscns));
  if (u64)
    {
      ocr->symptr = fetch_64 (hdrbuf
         + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_symptr));

      ocr->nsyms = fetch_32 (hdrbuf + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_nsyms));

      ocr->scnhdr_offset = (sizeof (struct external_filehdr)
       + fetch_16 (hdrbuf + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_opthdr)));
  ...
  else
    {
      ocr->symptr = fetch_32 (hdrbuf
         + __builtin_offsetof(struct external_filehdr, u.xcoff32.f_symptr));

      ocr->nsyms = fetch_32 (hdrbuf + __builtin_offsetof(struct external_filehdr, u.xcoff32.f_nsyms));

      ocr->scnhdr_offset = (sizeof (struct external_filehdr) - 4
       + fetch_16 (hdrbuf + __builtin_offsetof(struct external_filehdr, u.xcoff32.f_opthdr)));
     ...
     const char **errmsg, int *err)
{
  ...
  strtab = ((char *) xmalloc (sizeof (char) * (strsize)));
  if (!simple_object_internal_read (sobj->descriptor, strtab_offset,
      ...
      int *err)
{
  ...
  char *strtab;
  size_t strtab_size;
  struct external_syment *symtab = ((void*)0);
  unsigned int i;

  scnhdr_size = u64 ? (68) : (40);
  scnbuf = ((unsigned char *) xmalloc (sizeof (unsigned char) * (scnhdr_size * ocr->nscns)));
  ...
  for (i = 0; i < nscns; ++i)
    {
      ...
      scnname = scnhdr + __builtin_offsetof(struct external_scnhdr, s_name);
      memcpy (namebuf, scnname, (8));
      namebuf[(8)] = '\0';
      name = &namebuf[0];
      if (namebuf[0] == '/')
 {
       ...
       if (strindex < 4 || strindex >= strtab_size)
  {
    ...
    *err = 0;
    return "section string index out of range";
      ...
      if (u64)
 {
   scnptr = fetch_64 (scnhdr + __builtin_offsetof(struct external_scnhdr, u.xcoff64.s_scnptr));

   size = fetch_64 (scnhdr + __builtin_offsetof(struct external_scnhdr, u.xcoff64.s_size));

 }
      else
 {
   scnptr = fetch_32 (scnhdr + __builtin_offsetof(struct external_scnhdr, u.xcoff32.s_scnptr));

   size = fetch_32 (scnhdr + __builtin_offsetof(struct external_scnhdr, u.xcoff32.s_size));
  ...
  if (ocr->nsyms > 0)
    {
      ...
      symtab = ((struct external_syment *) xmalloc (sizeof (struct external_syment) * (ocr->nsyms * (18))));
      if (!simple_object_internal_read (sobj->descriptor,
      ...
      for (i = 0; i < ocr->nsyms; i += n_numaux + 1)
 {
   ...
   if (symtab[i].n_sclass[0] != (2)
       && symtab[i].n_sclass[0] != (107))
     continue;
   ...
   n_scnum = fetch_16 (sym + __builtin_offsetof(struct external_syment, n_scnum));
   ...
   if (u64)
     {
       n_value = fetch_64 (sym + __builtin_offsetof(struct external_syment, u.xcoff64.n_value));

       n_offset = fetch_32 (sym + __builtin_offsetof(struct external_syment, u.xcoff64.n_offset));

     }
   else
     {

       n_zeroes = fetch_32 (sym + __builtin_offsetof(struct external_syment, u.xcoff32.n.n.n_zeroes));

       if (n_zeroes != 0)
  continue;

       n_value = fetch_32 (sym + __builtin_offsetof(struct external_syment, u.xcoff32.n_value));

       n_offset = fetch_32 (sym + __builtin_offsetof(struct external_syment, u.xcoff32.n.n.n_offset));
       ...
       if (u64)
  {
    ...
    if ((auxent->u.xcoff64.x_csect.x_smtyp & 0x7) != (1)
        || auxent->u.xcoff64.x_csect.x_smclas != (7))
      continue;

    x_scnlen64 =
      fetch_32 (aux + __builtin_offsetof(union external_auxent, u.xcoff64.x_csect.x_scnlen_hi));

    x_scnlen =
      ((x_scnlen64 << 32)
       | fetch_32 (aux
     + __builtin_offsetof(union external_auxent, u.xcoff64.x_csect.x_scnlen_lo)));

  }
       else
  {
    if ((auxent->u.xcoff32.x_csect.x_smtyp & 0x7) != (1)
        || auxent->u.xcoff32.x_csect.x_smclas != (7))
      continue;

    x_scnlen = fetch_32 (aux + __builtin_offsetof(union external_auxent, u.xcoff32.x_csect.x_scnlen));
         ...
         int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((struct simple_object_xcoff_attributes *) xmalloc (sizeof (struct simple_object_xcoff_attributes)));
  ret->magic = ocr->magic;
  ret->flags = ocr->flags;
  return ret;
}
      ...
      int *err)
{
  ...
  set_16 (hdr + __builtin_offsetof(struct external_filehdr, f_magic), attrs->magic);
  set_16 (hdr + __builtin_offsetof(struct external_filehdr, f_nscns), nscns);

  if (u64)
    {
      set_64 (hdr + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_symptr),
       symtab_offset);
      set_32 (hdr + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_nsyms),
       nsyms);

      set_16 (hdr + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_flags),
       attrs->flags);
    }
  else
    {
      set_32 (hdr + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_symptr),
       symtab_offset);
      set_32 (hdr + __builtin_offsetof(struct external_filehdr, u.xcoff64.f_nsyms),
       nsyms);
      ...
      const char **errmsg, int *err)
{
  ...
  namelen = strlen (name);
  if (namelen <= (8))
    strncpy ((char *) hdr + __builtin_offsetof(struct external_scnhdr, s_name),
      name, (8));
  else
    {
      snprintf ((char *) hdr + __builtin_offsetof(struct external_scnhdr, s_name),
  (8), "/%lu", (unsigned long) *name_offset);
  ...
  if (u64)
    {
      set_64 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff64.s_size),
       scnsize);
      set_64 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff64.s_scnptr),
       offset);
    }
  else
    {
      set_32 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff32.s_size),
       scnsize);
      set_32 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff32.s_scnptr),
       offset);
    }
  ...
  if (align > 13)
    align = 13;
  if (u64)
    set_32 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff64.s_flags), flags);
  else
    set_32 (hdr + __builtin_offsetof(struct external_scnhdr, u.xcoff32.s_flags), flags);
      ...
      int *err)
{
  ...
  offset = scnhdr_offset + nscns * (u64 ? (68) : (40));
  name_offset = 4;
  for (section = sobj->sections; section != ((void*)0); section = section->next)
    {
      size_t mask;
 ...
 return errmsg;
  ...
  set_16 (&syms[0].sym.n_scnum[0], (-2));
  set_16 (&syms[0].sym.n_type[0], (((0) << 4) | (0)));
  syms[0].sym.n_sclass[0] = (103);
