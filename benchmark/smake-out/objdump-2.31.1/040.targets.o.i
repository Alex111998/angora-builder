# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
# 1 "./../include/fnmatch.h" 1
# 63 "./../include/fnmatch.h"
extern int fnmatch (const char *__pattern, const char *__string, int __flags);
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
# 589 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
...
static const bfd_target * const _bfd_target_vector[] =
{
 ...
 &i386_elf32_vec,&iamcu_elf32_vec,&i386_pei_vec,&elf32_le_vec,&elf32_be_vec,&plugin_vec,
# 1284 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
 &srec_vec,
 &symbolsrec_vec,
 ...
 &ihex_vec,
# 1329 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
 &core_trad_vec,
...
# 1 "./targmatch.h" 1
# 591 "./targmatch.h"
{ "i[3-7]86-*-elf*", ((void*)0) },{ "i[3-7]86-*-rtems*",
&i386_elf32_vec },
# 620 "./targmatch.h"
{ "i[3-7]86-*-kaos*",
&i386_elf32_vec },
...
&i386_elf32_vec },
# 698 "./targmatch.h"
{ "i[3-7]86-*-netbsdelf*", ((void*)0) },{ "i[3-7]86-*-netbsd*-gnu*", ((void*)0) },{ "i[3-7]86-*-knetbsd*-gnu",
&i386_elf32_vec },
# 715 "./targmatch.h"
{ "i[3-7]86-*-openbsd*",
&i386_elf32_vec },
...
&i386_elf32_vec },
# 902 "./targmatch.h"
{ "i[3-7]86-*-beoself*", ((void*)0) },{ "i[3-7]86-*-beos*",
&i386_elf32_vec },
...
{ "ia16-*-elf",
&i386_elf32_vec },
# 1377 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c" 2
 { ((void*)0), ((void*)0) }
};
...
# 1422 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
bfd_boolean
...
# 1459 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
const bfd_target *
...
# 1552 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
const bfd_target *
       ...
       int *underscoring, const char **def_target_arch)
{
  ...
  if (! target_vec)
    return ((void*)0);
  if (is_bigendian)
    *is_bigendian = ((target_vec->byteorder == BFD_ENDIAN_BIG) ? 1
              : 0);
  if (underscoring)
      ...
      if (arches && tname)
 {
       ...
       if (!_bfd_find_arch_match (tname, arches, def_target_arch))
  {
    ...
    while ((hyp = strrchr (new_tname, '-')) != ((void*)0))
      {
        *hyp = 0;
...
# 1627 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
const char **
...
# 1669 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
const bfd_target *
...
# 1693 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c"
const char *
bfd_flavour_name (enum bfd_flavour flavour)
{
  ...
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/./targets.c", 1723, __PRETTY_FUNCTION__);
}
