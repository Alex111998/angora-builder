# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 180 "./sysdep.h" 2
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
cplus_demangle_print_callback (int options,
                               struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
# 1 "./debug.h" 1
# 33 "./debug.h"
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
# 1 "./budbg.h" 1
# 27 "./budbg.h"
...
# 34 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c" 2
...
parse_number (const char **pp, bfd_boolean *poverflow, const char *p_end)
{
      ...
      while (1)
 {
   ...
   d = *p++;
   if ((_sch_istable[(d) & 0xff] & (unsigned short)(_sch_isdigit)))
     d -= '0';
   else if ((_sch_istable[(d) & 0xff] & (unsigned short)(_sch_isupper)))
     d -= 'A';
   else if ((_sch_istable[(d) & 0xff] & (unsigned short)(_sch_islower)))
     d -= 'a';
   else
     break;
      ...
      if (! overflow)
 {
  ...
  if (poverflow != ((void*)0))
    *poverflow = 1;
    ...
    warn_stab (orig, gettext ("numeric overflow"));
...
{
  fprintf (stderr, gettext ("Bad stab: %s\n"), p);
}
...
void *
start_stab (void *dhandle __attribute__ ((__unused__)), bfd *abfd, bfd_boolean sections,
     ...
     const char *string)
{
 ...
 break;
      ...
      if (! info->within_function)
 {
   fprintf (stderr, gettext ("N_LBRAC not within function\n"));
   return 0;
 }
 ...
 {
   fprintf (stderr, gettext ("Too many N_RBRACs\n"));
   return 0;
 }
      break;
      ...
      else
 {
   ...
   if ((((((string)[0]) == '/') || ((((string)[0]) == '\\') && (0))) || ((string)[0] && ((string)[1] == ':') && (0))))
     info->so_string = xstrdup (string);
   else
...
parse_stab_string (void *dhandle, struct stab_handle *info, int stabtype,
     int desc __attribute__ ((__unused__)), bfd_vma value,
     const char *string, const char * string_end)
{
 ...
 case 'X':
   ...
   break;
 default:
   warn_stab (string, gettext ("unknown C++ encoded name"));
   break;
 }
    }
 ...
 name = savestring (string, p - string);
  ...
  ++p;
  if ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isdigit)) || *p == '(' || *p == '-')
    type = 'l';
  else if (*p == 0)
    {
      bad_stab (string);
 ...
 case 'e':
   ...
   dtype = parse_stab_type (dhandle, info, (const char *) ((void*)0),
       &p, (debug_type **) ((void*)0), string_end);
   if (dtype == ((debug_type) ((void*)0)))
     return 0;
   if (*p != ',')
     {
       bad_stab (string);
 ...
 if (name != ((void*)0))
   {
     ...
     leading = ((info->abfd)->xvec->symbol_leading_char);
...
# 1147 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
    default:
      bad_stab (string);
      return 0;
    }
   ...
   const char * p_end)
{
  ...
  info->self_crossref = 0;




  if (! (_sch_istable[(**pp) & 0xff] & (unsigned short)(_sch_isdigit)) && **pp != '(' && **pp != '-')
    {
...
# 1222 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
 ...
 *slotp = stab_find_slot (info, typenums);
 ...
 switch (**pp)
   ...
   default:
     ...
     warn_stab (orig, gettext ("unrecognized cross reference type"));
     code = DEBUG_KIND_STRUCT;
     break;
   }
 ++*pp;
...
parse_stab_type_number (const char **pp, int *typenums, const char *p_end)
{
  ...
  if (**pp != '(')
    {
      typenums[0] = 0;
      typenums[1] = (int) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
      return 1;
    }

  ++*pp;
  typenums[0] = (int) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ',')
    {
      bad_stab (orig);
      return 0;
         ...
         const char * p_end)
{
  ...
  if (**pp == '=')
    {
      *pp = orig;
      index_type = parse_stab_type (dhandle, info, (const char *) ((void*)0),
        pp, (debug_type **) ((void*)0), p_end);
      if (index_type == ((debug_type) ((void*)0)))
 return ((debug_type) ((void*)0));
    }
  ...
  if (ov2 || ov3)
    {
      ...
      if (index_type == ((debug_type) ((void*)0)))
 {
   if ((strncmp ((s2), ("01000000000000000000000;"), sizeof ("01000000000000000000000;") - 1) == 0)
       && (strncmp ((s3), ("0777777777777777777777;"), sizeof ("0777777777777777777777;") - 1) == 0))
     return debug_make_int_type (dhandle, 8, 0);
   if (! ov2
       && n2 == 0
       && (strncmp ((s3), ("01777777777777777777777;"), sizeof ("01777777777777777777777;") - 1) == 0))
     return debug_make_int_type (dhandle, 8, 1);
 }
      ...
      if (n2 == 0 && n3 == -1)
 {
  ...
  return debug_make_int_type (dhandle, 8, 1);
   ...
   return debug_make_int_type (dhandle, 4, 1);
 }


      if (self_subrange && n2 == 0 && n3 == 127)
 return debug_make_int_type (dhandle, 1, 0);
 ...
 {
   if (n3 < 0)
     return debug_make_int_type (dhandle, - n3, 1);
   else if (n3 == 0xff)
     return debug_make_int_type (dhandle, 1, 1);
   else if (n3 == 0xffff)
     return debug_make_int_type (dhandle, 2, 1);
     ...
     return debug_make_int_type (dhandle, 4, 1);
        ...
        && n2 < 0
        && (self_subrange || n2 == -8))
 return debug_make_int_type (dhandle, - n2, 1);
      else if (n2 == - n3 - 1 || n2 == n3 + 1)
 {
   if (n3 == 0x7f)
     return debug_make_int_type (dhandle, 1, 0);
   else if (n3 == 0x7fff)
     return debug_make_int_type (dhandle, 2, 0);
   else if (n3 == 0x7fffffff)
     return debug_make_int_type (dhandle, 4, 0);
  ...
  if (index_type == ((debug_type) ((void*)0)))
    {
      ...
      warn_stab (orig, gettext ("missing index type"));
      index_type = debug_make_int_type (dhandle, 4, 0);
    }

  return debug_make_range_type (dhandle, index_type, n2, n3);
}
# 1881 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static debug_type
parse_stab_sun_builtin_type (void *dhandle, const char **pp, const char * p_end)
{
  ...
  (void) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      return ((debug_type) ((void*)0));
  ...
  bits = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
...
parse_stab_sun_floating_type (void *dhandle, const char **pp, const char *p_end)
{
  ...
  details = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      return ((debug_type) ((void*)0));
  ...
  bytes = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      return ((debug_type) ((void*)0));
...
parse_stab_enum_type (void *dhandle, const char **pp, const char * p_end)
{
      ...
      if (*p == 0)
 {
   ...
   return ((debug_type) ((void*)0));
      ...
      *pp = p + 1;
      val = (bfd_signed_vma) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
      if (**pp != ',')
 {
   bad_stab (orig);
   free (name);
...
# 2093 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static debug_type
   ...
   const char * p_end)
{
  ...
  size = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
...
# 2160 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static bfd_boolean
   ...
   const char * p_end)
{
  ...
  *retp = ((void*)0);
  ...
  c = (unsigned int) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
 ...
 case 0:
   ...
   return 0;
 default:
   warn_stab (orig, gettext ("unknown virtual character for baseclass"));
   is_virtual = 0;
   break;
 }
      ++*pp;
 ...
 case 0:
   ...
   return 0;
 default:
   warn_stab (orig, gettext ("unknown visibility character for baseclass"));
   visibility = DEBUG_VISIBILITY_PUBLIC;
   break;
 }
      ++*pp;
      ...
      bitpos = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
      if (**pp != ',')
 {
   bad_stab (orig);
   return 0;
 ...
 return 0;
      ...
      visibility);
      if (classes[i] == ((debug_baseclass) ((void*)0)))
 return 0;
 ...
 return 0;
  ...
  classes[i] = ((debug_baseclass) ((void*)0));

  *retp = classes;

  return 1;
}
# 2294 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static bfd_boolean
...
# 2339 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
      if ((*p == '$' || *p == '.') && p[1] != '_')
 {
   ++*pp;
  ...
  *retp = ((debug_field) ((void*)0));
  ...
  switch (cpp_abbrev)
    ...
    case 'b':
      ...
      if (type_name == ((void*)0))
 {
   warn_stab (orig, gettext ("unnamed $vb type"));
   type_name = "FOO";
 }
      name = concat ("_vb$", type_name, (const char *) ((void*)0));
      break;
    default:
      warn_stab (orig, gettext ("unrecognized C++ abbreviation"));
        ...
        const char * p_end)
{
 ...
 case 0:
   ...
   return 0;
 default:
   warn_stab (orig, gettext ("unknown visibility character for field"));
   visibility = DEBUG_VISIBILITY_PUBLIC;
   break;
 }
      ++*pp;
      ...
      if (p == ((void*)0))
 {
  ...
  bitsize = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      free (name);
  ...
  if (bitpos == 0 && bitsize == 0)
    {
# 2612 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
...
# 2635 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static bfd_boolean
      ...
      const char * p_end)
{
  ...
  unsigned int alloc;
  char *name = ((void*)0);
  debug_method_variant *variants = ((void*)0);
  char *argtypes = ((void*)0);
      ...
      else
 {
   ...
   *pp = p + 1;
    ...
    xmalloc (allocvars * sizeof *variants));
      ...
      look_ahead_type = ((debug_type) ((void*)0));
      ...
      do
 {
   ...
   if (look_ahead_type != ((debug_type) ((void*)0)))
     {
   ...
   *pp = p + 1;
   ...
   switch (**pp)
     ...
     case '.':
       ...
       break;
     default:
       warn_stab (orig, gettext ("const/volatile indicator missing"));
       break;
     }
   ...
   switch (**pp)
     ...
     case '*':
       ...
       ++*pp;
       voffset = parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
       if (**pp != ';')
  {
    bad_stab (orig);
    goto fail;
   ...
   if (stub)
     {
       ...
       if (class_type == ((debug_type) ((void*)0)))
  goto fail;
  ...
  goto fail;
   ...
   if (! staticp)
     ...
     variants[cvars] = debug_make_static_method_variant (dhandle,
        ...
        constp,
        volatilep);
   if (variants[cvars] == ((debug_method_variant) ((void*)0)))
     goto fail;
   ...
   ++cvars;
      ...
      variants[cvars] = ((debug_method_variant) ((void*)0));
       ...
       bfd_boolean volatilep, const char **pphysname)
{
  ...
  is_full_physname_constructor = ((argtypes[0] == '_'
       && argtypes[1] == '_'
       && ((_sch_istable[(argtypes[2]) & 0xff] & (unsigned short)(_sch_isdigit))
           || argtypes[2] == 'Q'
           || argtypes[2] == 't'))
      || (strncmp ((argtypes), ("__ct"), sizeof ("__ct") - 1) == 0));
  ...
  is_destructor = ((argtypes[0] == '_'
      ...
      && argtypes[2] == '_')
     || (strncmp ((argtypes), ("__dt"), sizeof ("__dt") - 1) == 0));
  ...
  if (!(is_destructor || is_full_physname_constructor || is_v3))
    {
      ...
      len = tagname == ((void*)0) ? 0 : strlen (tagname);
      const_prefix = constp ? "C" : "";
      volatile_prefix = volatilep ? "V" : "";

      if (len == 0)
 sprintf (buf, "__%s%s", const_prefix, volatile_prefix);
      else if (tagname != ((void*)0) && strchr (tagname, '<') != ((void*)0))
 {
   ...
   && (fieldname[2] == '$' || fieldname[2] == '.'))
 {
   ...
   if (opname == ((void*)0))
     {
       fprintf (stderr, gettext ("No mangling for \"%s\"\n"), fieldname);
       return ((debug_type) ((void*)0));
     }
...
# 3093 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static bfd_boolean
...
# 3191 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
  orig = *pp;
  if (orig >= p_end)
    return ((debug_type) ((void*)0));
      ...
      if (index_type == ((debug_type) ((void*)0)))
 {
  ...
  if (! (_sch_istable[(**pp) & 0xff] & (unsigned short)(_sch_isdigit)) && **pp != '-' && **pp != 0)
    {
      ++*pp;
      adjustable = 1;
    }

  lower = (bfd_signed_vma) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      return ((debug_type) ((void*)0));
  ...
  upper = (bfd_signed_vma) parse_number (pp, (bfd_boolean *) ((void*)0), p_end);
  if (**pp != ';')
    {
      bad_stab (orig);
      return ((debug_type) ((void*)0));
  ...
  element_type = parse_stab_type (dhandle, info, (const char *) ((void*)0), pp,
      (debug_type **) ((void*)0), p_end);
  if (element_type == ((debug_type) ((void*)0)))
    return ((debug_type) ((void*)0));
...
find_excl (struct stab_handle *info, const char *name, bfd_vma hash)
{
  ...
  if (l == ((void*)0))
    {
      warn_stab (name, gettext ("Undefined N_EXCL"));
...
stab_find_slot (struct stab_handle *info, const int *typenums)
{
  ...
  if (filenum < 0 || (unsigned int) filenum >= info->files)
    {
      fprintf (stderr, gettext ("Type file number %d out of range\n"), filenum);
      return ((void*)0);
    }
  if (tindex < 0)
    {
      fprintf (stderr, gettext ("Type index number %d out of range\n"), tindex);
      return ((void*)0);
    }
...
static bfd_boolean
stab_record_type (void *dhandle __attribute__ ((__unused__)), struct stab_handle *info,
    ...
    int typenum)
{
  ...
  if (typenum >= 0 || typenum < -34)
    {
      fprintf (stderr, gettext ("Unrecognized XCOFF type %d\n"), typenum);
      return ((debug_type) ((void*)0));
    }
  ...
  switch (-typenum)
    ...
    case 1:
      ...
      name = "int";
      rettype = debug_make_int_type (dhandle, 4, 0);
      break;
    case 2:
      name = "char";
      rettype = debug_make_int_type (dhandle, 1, 0);
      break;
    case 3:
      name = "short";
      rettype = debug_make_int_type (dhandle, 2, 0);
      break;
    case 4:
      name = "long";
      rettype = debug_make_int_type (dhandle, 4, 0);
    ...
    case 5:
      name = "unsigned char";
      rettype = debug_make_int_type (dhandle, 1, 1);
      break;
    case 6:
      name = "signed char";
      rettype = debug_make_int_type (dhandle, 1, 0);
    ...
    case 7:
      name = "unsigned short";
      rettype = debug_make_int_type (dhandle, 2, 1);
      break;
    case 8:
      name = "unsigned int";
      rettype = debug_make_int_type (dhandle, 4, 1);
      break;
    case 9:
      name = "unsigned";
      rettype = debug_make_int_type (dhandle, 4, 1);
    ...
    case 31:
      name = "long long";
      rettype = debug_make_int_type (dhandle, 8, 0);
      break;
    case 32:
      name = "unsigned long long";
      rettype = debug_make_int_type (dhandle, 8, 1);
      break;
    case 33:
      name = "logical*8";
...
# 3752 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
...
{
  fprintf (stderr, gettext ("bad mangled name `%s'\n"), s);
}
...
stab_demangle_count (const char **pp)
{
  ...
  count = 0;
  while ((_sch_istable[(**pp) & 0xff] & (unsigned short)(_sch_isdigit)))
    {
      count *= 10;
      count += **pp - '0';
      ++*pp;
...
{
  if (! (_sch_istable[(**pp) & 0xff] & (unsigned short)(_sch_isdigit)))
    return 0;
   ...
   unsigned int physname_len)
{
 ...
 goto error_return;
  ...
  if (minfo.args == ((void*)0))
    fprintf (stderr, gettext ("no argument types in mangled string\n"));
        ...
        unsigned int physname_len)
{
 ...
 scan += i - 2;
  ...
  if (scan == *pp
      && ((_sch_istable[(scan[2]) & 0xff] & (unsigned short)(_sch_isdigit))
   || scan[2] == 'Q'
   || scan[2] == 't'))
    {
        ...
        const char **pp, const char *scan)
{
  ...
  *pp = scan + 2;
  ...
  if (*pp - name >= 5
    && (strncmp ((name), ("type"), sizeof ("type") - 1) == 0)
    && (name[4] == '$' || name[4] == '.'))
    {
      const char *tem;
    ...
    debug_type *ptype)
{
  ...
  switch ((*pp)[1])
    ...
    case '_':
      ...
      p = *pp + 2;
      if (! (_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isdigit)) || *p == '0')
 {
   stab_bad_demangle (orig);
   return 0;
 }
      ...
      else
 {
  ...
  {
    char *name;
# 4263 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
    name = savestring (*pp, len);

    for (; *fields != ((debug_field) ((void*)0)); fields++)
      {
        debug_type ft;
        const char *dn;
...
static bfd_boolean
stab_demangle_class (struct stab_demangle_info *minfo __attribute__ ((__unused__)),
 ...
 if (ptype != ((void*)0))
   {
     ...
     if (int_type == ((void*)0))
       int_type = debug_make_int_type (minfo->dhandle, 4, 0);
 ...
 if (ptype != ((void*)0))
   *ptype = debug_make_function_type (minfo->dhandle, *ptype, args,
    ...
    case 'O':
      {
 bfd_boolean memberp;
 debug_type class_type = ((debug_type) ((void*)0));
 debug_type *args;
 bfd_boolean varargs;
 unsigned int n;
 const char *name;
    ...
    debug_type *ptype)
{
      ...
      if (ptype != ((void*)0))
 {
   *ptype = debug_find_named_type (minfo->dhandle, "__wchar_t");
   if (*ptype == ((debug_type) ((void*)0)))
     *ptype = debug_make_int_type (minfo->dhandle, 2, 1);
 }
      ++*pp;
      break;
...
# 5238 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/stabs.c"
static debug_type *
      ...
      const char *physname, bfd_boolean *pvarargs)
{
  ...
  dc = cplus_demangle_v3_components (physname, (1 << 0) | (1 << 1), &mem);
  if (dc == ((void*)0))
    {
  ...
  if (dc->type != DEMANGLE_COMPONENT_TYPED_NAME
    ...
    {
      fprintf (stderr, gettext ("Demangled name is not a function\n"));
      free (mem);
      return ((void*)0);
    }
     ...
     bfd_boolean *pvarargs)
{
 ...
 {
   fprintf (stderr, gettext ("Unexpected type in v3 arglist demangling\n"));
   free (pargs);
   return ((void*)0);
 }
        ...
        bfd_boolean *pvarargs)
{
  ...
  switch (dc->type)
    ...
    default:
      fprintf (stderr, gettext ("Unrecognized demangle component %d\n"),
        (int) dc->type);
      return ((void*)0);
 ...
 p = cplus_demangle_print ((1 << 0) | (1 << 1), dc, 20, &alc);
 if (p == ((void*)0))
   {
     fprintf (stderr, gettext ("Failed to print demangled template\n"));
     return ((void*)0);
   }
 ...
 if (p == ((void*)0))
   {
     fprintf (stderr, gettext ("Couldn't get demangled builtin type\n"));
     return ((void*)0);
   }
 ...
 if (strcmp (p, "signed char") == 0)
   ret = debug_make_int_type (dhandle, 1, 0);
   ...
   ret = debug_make_int_type (dhandle, 1, 1);
 else if (strcmp (p, "int") == 0)
   ret = debug_make_int_type (dhandle, 4, 0);
 else if (strcmp (p, "unsigned int") == 0)
   ret = debug_make_int_type (dhandle, 4, 1);
 else if (strcmp (p, "long") == 0)
   ret = debug_make_int_type (dhandle, 4, 0);
 else if (strcmp (p, "unsigned long") == 0)
   ret = debug_make_int_type (dhandle, 4, 1);
 else if (strcmp (p, "__int128") == 0)
   ret = debug_make_int_type (dhandle, 16, 0);
 else if (strcmp (p, "unsigned __int128") == 0)
   ret = debug_make_int_type (dhandle, 16, 1);
 else if (strcmp (p, "short") == 0)
   ret = debug_make_int_type (dhandle, 2, 0);
 else if (strcmp (p, "unsigned short") == 0)
   ret = debug_make_int_type (dhandle, 2, 1);
 else if (strcmp (p, "void") == 0)
   ret = debug_make_void_type (dhandle);
 else if (strcmp (p, "wchar_t") == 0)
   ret = debug_make_int_type (dhandle, 4, 1);
 else if (strcmp (p, "long long") == 0)
   ret = debug_make_int_type (dhandle, 8, 0);
 else if (strcmp (p, "unsigned long long") == 0)
   ret = debug_make_int_type (dhandle, 8, 1);
 else if (strcmp (p, "...") == 0)
   {
     if (pvarargs == ((void*)0))
       fprintf (stderr, gettext ("Unexpected demangled varargs\n"));
     else
       *pvarargs = 1;
     ret = ((void*)0);
   }
   ...
   {
     fprintf (stderr, gettext ("Unrecognized demangled builtin type\n"));
     ret = ((void*)0);
   }
