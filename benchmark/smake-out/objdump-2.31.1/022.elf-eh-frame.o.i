# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c" 2
...
read_value (bfd *abfd, bfd_byte *buf, int width, int is_signed)
{
  ...
  switch (width)
    ...
    case 2:
      if (is_signed)
 value = ((*((abfd)->xvec->bfd_getx_signed_16)) (buf));
      else
 value = ((*((abfd)->xvec->bfd_getx16)) (buf));
      break;
    case 4:
      if (is_signed)
 value = ((*((abfd)->xvec->bfd_getx_signed_32)) (buf));
      else
 value = ((*((abfd)->xvec->bfd_getx32)) (buf));
      break;
    case 8:
      if (is_signed)
 value = ((*((abfd)->xvec->bfd_getx_signed_64)) (buf));
      else
 value = ((*((abfd)->xvec->bfd_getx64)) (buf));
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",193); } while (0);
      return 0;
    }
...
write_value (bfd *abfd, bfd_byte *buf, bfd_vma value, int width)
{
  switch (width)
    {
    case 2: ((*((abfd)->xvec->bfd_putx16)) ((value),(buf))); break;
    case 4: ((*((abfd)->xvec->bfd_putx32)) ((value),(buf))); break;
    case 8: ((*((abfd)->xvec->bfd_putx64)) ((value), (buf))); break;
    default: do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",210); } while (0);
    }
}
...
cie_compute_hash (struct cie *c)
{
  hashval_t h = 0;
  size_t len;
  h = iterative_hash (&c->length, sizeof (c->length), h);
  h = iterative_hash (&c->version, sizeof (c->version), h);
  h = iterative_hash (c->augmentation, strlen (c->augmentation) + 1, h);
  h = iterative_hash (&c->code_align, sizeof (c->code_align), h);
  h = iterative_hash (&c->data_align, sizeof (c->data_align), h);
  h = iterative_hash (&c->ra_column, sizeof (c->ra_column), h);
  h = iterative_hash (&c->augmentation_size, sizeof (c->augmentation_size), h);
  h = iterative_hash (&c->personality, sizeof (c->personality), h);
  h = iterative_hash (&c->cie_inf->u.cie.u.sec->output_section, sizeof (c->cie_inf->u.cie.u.sec->output_section), h);
  h = iterative_hash (&c->per_encoding, sizeof (c->per_encoding), h);
  h = iterative_hash (&c->lsda_encoding, sizeof (c->lsda_encoding), h);
  h = iterative_hash (&c->fde_encoding, sizeof (c->fde_encoding), h);
  h = iterative_hash (&c->initial_insn_length, sizeof (c->initial_insn_length), h);
...
bfd_elf_discard_eh_frame_entry (struct eh_frame_hdr_info *hdr_info)
{
  ...
  for (i = 0; i < hdr_info->array_count; i++)
    {
      if (hdr_info->u.compact.entries[i]->flags & 0x8000)
 {
   unsigned int j;
   ...
   hdr_info->u.compact.entries[hdr_info->array_count] = ((void*)0);
   i--;
 }
    }
}
     ...
     asection *sec)
{
 ...
 {
   hdr_info->frame_hdr_is_compact = 1;
   ...
   hdr_info->u.compact.entries =
    ...
    hdr_info->u.compact.allocated_entries
      * sizeof (hdr_info->u.compact.entries[0]));
      ...
      do { if (!(hdr_info->u.compact.entries)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",515); } while (0);
    }
          ...
          asection *sec, struct elf_reloc_cookie *cookie)
{
  ...
  if (sec->output_section && ((sec->output_section) == (&_bfd_std_section[2])))
    {
  ...
  text_sec = _bfd_elf_section_for_symbol (cookie, r_symndx, 0);

  if (text_sec == ((void*)0))
    return 0;

  (((struct bfd_elf_section_data*)(text_sec)->used_by_bfd)->eh_frame_entry) = sec;
  if (text_sec->output_section
      && ((text_sec->output_section) == (&_bfd_std_section[2])))
    sec->flags |= 0x8000;

  sec->sec_info_type = 6;
  ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info = text_sec;
    ...
    asection *sec, struct elf_reloc_cookie *cookie)
{
  ...
  bfd_byte *ehbuf = ((void*)0), *buf, *end;
  bfd_byte *last_fde;
  struct eh_cie_fde *this_inf;
  unsigned int hdr_length, hdr_id;
  unsigned int cie_count;
  struct cie *cie, *local_cies = ((void*)0);
  struct elf_link_hash_table *htab;
  struct eh_frame_hdr_info *hdr_info;
  struct eh_frame_sec_info *sec_info = ((void*)0);
  ...
  do if (!(bfd_malloc_and_get_section (abfd, sec, &ehbuf))) goto free_no_table; while (0);



  do if (!(sec->size == (unsigned int) sec->size)) goto free_no_table; while (0);

  ptr_size = (((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)
       ->elf_backend_eh_frame_address_size (abfd, sec));
  do if (!(ptr_size != 0)) goto free_no_table; while (0);
  ...
  while (buf != end)
    {
      ...
      do if (!(skip_bytes (&buf, end, 4))) goto free_no_table; while (0);
      hdr_length = ((*((abfd)->xvec->bfd_getx32)) (buf - 4));


      do if (!(hdr_length != 0xffffffff)) goto free_no_table; while (0);
      if (hdr_length == 0)
 break;

      do if (!(skip_bytes (&buf, end, 4))) goto free_no_table; while (0);
      hdr_id = ((*((abfd)->xvec->bfd_getx32)) (buf - 4));
      if (hdr_id == 0)
 num_cies++;

      do if (!(skip_bytes (&buf, end, hdr_length - 4))) goto free_no_table; while (0);
    }

  sec_info = (struct eh_frame_sec_info *)
      bfd_zmalloc (sizeof (struct eh_frame_sec_info)
     + (num_entries - 1) * sizeof (struct eh_cie_fde));
  do if (!(sec_info)) goto free_no_table; while (0);


  if (num_cies)
    {
      local_cies = (struct cie *) bfd_zmalloc (num_cies * sizeof (*local_cies));
      do if (!(local_cies)) goto free_no_table; while (0);
    }
# 693 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
  buf = ehbuf;
  cie_count = 0;
  gc_mark_hook = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->gc_mark_hook;
  while ((bfd_size_type) (buf - ehbuf) != sec->size)
    {
      ...
      do if (!(skip_bytes (&buf, ehbuf + sec->size, 4))) goto free_no_table; while (0);
      hdr_length = ((*((abfd)->xvec->bfd_getx32)) (buf - 4));


      do if (!((bfd_size_type) (buf - ehbuf) + hdr_length <= sec->size)) goto free_no_table; while (0);
      end = buf + hdr_length;
      ...
      if (hdr_length == 0)
 {
   ...
   while (skip_bytes (&buf, ehbuf + sec->size, 4))
     do if (!(((*((abfd)->xvec->bfd_getx32)) (buf - 4)) == 0)) goto free_no_table; while (0);
   do if (!((bfd_size_type) (buf - ehbuf) == sec->size)) goto free_no_table; while (0);
   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
   sec_info->count++;
   break;
 }
      ...
      if (hdr_id == 0)
 {
   ...
   start = buf;
   do if (!(read_byte (&buf, end, &cie->version))) goto free_no_table; while (0);


   do if (!(cie->version == 1 || cie->version == 3 || cie->version == 4)) goto free_no_table; while (0);


   do if (!(strlen ((char *) buf) < sizeof (cie->augmentation))) goto free_no_table; while (0);
   ...
   if (buf[0] == 'e' && buf[1] == 'h')
     {
       ...
       do if (!(skip_bytes (&buf, end, ptr_size))) goto free_no_table; while (0);
       while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) cookie->rel++;
     }
   if (cie->version >= 4)
     {
       do if (!(buf + 1 < end)) goto free_no_table; while (0);
       do if (!(buf[0] == ptr_size)) goto free_no_table; while (0);
       do if (!(buf[1] == 0)) goto free_no_table; while (0);
       buf += 2;
     }
   do if (!(read_uleb128 (&buf, end, &cie->code_align))) goto free_no_table; while (0);
   do if (!(read_sleb128 (&buf, end, &cie->data_align))) goto free_no_table; while (0);
   if (cie->version == 1)
     {
       do if (!(buf < end)) goto free_no_table; while (0);
       cie->ra_column = *buf++;
     }
   else
     do if (!(read_uleb128 (&buf, end, &cie->ra_column))) goto free_no_table; while (0);
   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
   cie->lsda_encoding = 0xff;
   cie->fde_encoding = 0xff;
   cie->per_encoding = 0xff;
  ...
  {
    aug++;
    do if (!(read_uleb128 (&buf, end, &cie->augmentation_size))) goto free_no_table; while (0);
    while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
  }
  ...
  switch (*aug++)
    {
    case 'L':
      do if (!(read_byte (&buf, end, &cie->lsda_encoding))) goto free_no_table; while (0);
      while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
      do if (!(get_DW_EH_PE_width (cie->lsda_encoding, ptr_size))) goto free_no_table; while (0);
      break;
    case 'R':
      do if (!(read_byte (&buf, end, &cie->fde_encoding))) goto free_no_table; while (0);
      while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
      do if (!(get_DW_EH_PE_width (cie->fde_encoding, ptr_size))) goto free_no_table; while (0);
      break;
    case 'S':
      break;
    case 'P':
      {
        ...
        do if (!(read_byte (&buf, end, &cie->per_encoding))) goto free_no_table; while (0);
        per_width = get_DW_EH_PE_width (cie->per_encoding,
            ptr_size);
        do if (!(per_width)) goto free_no_table; while (0);
        if ((cie->per_encoding & 0x70) == 0x50)
   {
     length = -(buf - ehbuf) & (per_width - 1);
     do if (!(skip_bytes (&buf, end, length))) goto free_no_table; while (0);
     if (per_width == 8)
       this_inf->u.cie.per_encoding_aligned8 = 1;
        ...
        do if (!(((cookie->rel < cookie->relend && (cookie->rel->r_offset == (bfd_size_type) ((buf) - ehbuf))) ? cookie->rel : ((void*)0)))) goto free_no_table; while (0);
        cie->personality.reloc_index
   = cookie->rel - cookie->rels;

        do
   cookie->rel++;
        while (((cookie->rel < cookie->relend && (cookie->rel->r_offset == (bfd_size_type) ((buf) - ehbuf))) ? cookie->rel : ((void*)0)) != ((void*)0));
        do if (!(skip_bytes (&buf, end, per_width))) goto free_no_table; while (0);
      }
      break;
    default:
   ...
   if ((((info)->type == type_dll) || ((info)->type == type_pie))
    ...
    (abfd, info, sec)))
     {
       if ((cie->fde_encoding & 0x70) == 0x00)
  this_inf->make_relative = 1;



       else if (cie->fde_encoding == 0xff
         && (cie->per_encoding & 0x70) != 0x50)
  {
    ...
    this_inf->make_relative = 1;
       ...
       if ((cie->lsda_encoding & 0x70) == 0x00)
  cie->can_make_lsda_relative = 1;
     }



   if (cie->fde_encoding == 0xff)
     cie->fde_encoding = 0x00;
      ...
      else
 {
   ...
   do if (!(cie != local_cies + cie_count)) goto free_no_table; while (0);
   ...
   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) { do if (!(cookie->rel->r_info == 0)) goto free_no_table; while (0); cookie->rel++; };
   if ((sec->flags & 0x100000) == 0 || cookie->rels != ((void*)0))
     {
       asection *rsec;
       ...
       if (rsec)
  {
    do if (!(rsec->owner == abfd)) goto free_no_table; while (0);
    this_inf->u.fde.next_for_section = (((struct bfd_elf_section_data*)(rsec)->used_by_bfd)->fde_list);
    (((struct bfd_elf_section_data*)(rsec)->used_by_bfd)->fde_list) = this_inf;
  }
     }
   ...
   do if (!(skip_bytes (&buf, end, 2 * length))) goto free_no_table; while (0);

   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf - length) - ehbuf))) cookie->rel++;
   if (!((cookie->rel < cookie->relend && (cookie->rel->r_offset == (bfd_size_type) ((buf - length) - ehbuf))) ? cookie->rel : ((void*)0))
       && read_value (abfd, buf - length, length, 0) == 0)
     {
       (*info->callbacks->minfo)

  (dgettext ("bfd", "discarding zero address range FDE in %pB(%pA).\n"),
   abfd, sec);
       this_inf->u.fde.cie_inf = ((void*)0);
     }


   if (cie->augmentation[0] == 'z')
     do if (!(read_uleb128 (&buf, end, &length))) goto free_no_table; while (0);
   else
     length = 0;
   ...
   if (cie->lsda_encoding != 0xff)
     {
       while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) cookie->rel++;
       if (cie->can_make_lsda_relative && ((cookie->rel < cookie->relend && (cookie->rel->r_offset == (bfd_size_type) ((buf) - ehbuf))) ? cookie->rel : ((void*)0)))
...
# 983 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
   while (cookie->rel < cookie->relend && (cookie->rel->r_offset < (bfd_size_type) ((buf) - ehbuf))) cookie->rel++;
 }
       ...
       || this_inf->make_relative))
 {
   ...
   do if (!(this_inf->set_loc)) goto free_no_table; while (0);
  ...
  this_inf->set_loc[++cnt] = p + 1 - start;
       do if (!(skip_cfa_op (&p, end, length))) goto free_no_table; while (0);
     }
 }
  ...
  do { if (!(sec_info->count == num_entries)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1031); } while (0);
  do { if (!(cie_count == num_cies)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1032); } while (0);

  ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info = sec_info;
  sec->sec_info_type = 3;
  if (!((info)->type == type_relocatable))
    {
 ...
 free_no_table:
  _bfd_error_handler
    ...
    (dgettext ("bfd", "error in %pB(%pA); no .eh_frame_hdr table will be created"),
     abfd, sec);
  hdr_info->u.dwarf.table = 0;
  if (sec_info)
    free (sec_info);
 success:
  if (ehbuf)
...
cmp_eh_frame_hdr (const void *a, const void *b)
{
  ...
  sec = (asection *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;
  ...
  if (next)
    {
      ...
      text_sec = (asection *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;
      end = text_sec->output_section->vma + text_sec->output_offset
     + text_sec->size;
      text_sec = (asection *) ((struct bfd_elf_section_data*)(next)->used_by_bfd)->sec_info;
...
_bfd_elf_end_eh_frame_parsing (struct bfd_link_info *info)
{
  ...
  hdr_info = &((struct elf_link_hash_table *) ((info)->hash))->eh_info;
  ...
  add_eh_frame_hdr_terminator (hdr_info->u.compact.entries[i], ((void*)0));
  return 1;
}
         ...
         struct elf_reloc_cookie *cookie)
{
  ...
  for (fde = (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->fde_list); fde; fde = fde->u.fde.next_for_section)
    {
 ...
 return 0;
      ...
      if (cie != ((void*)0) && !cie->u.cie.gc_mark)
 {
   cie->u.cie.gc_mark = 1;
...
# 1199 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
   ...
   struct eh_cie_fde *cie_inf)
{
   ...
   || (((unsigned int)(cookie->locsyms[r_symndx].st_info)) >> 4) != 0)
 {
   ...
   cie->personality.h = h;
   per_binds_local = _bfd_elf_symbol_refs_local_p (h, info, 0);
 }
      else
 {
   Elf_Internal_Sym *sym;
   ...
   if (sym_sec->kept_section != ((void*)0))
       ...
       ->elf_backend_can_make_relative_eh_frame (abfd, info, sec)))
 {
  ...
  if (hdr_info->u.dwarf.cies == ((void*)0))
    {
...
offset_adjust (bfd_vma offset, const asection *sec)
{
  struct eh_frame_sec_info *sec_info
    = (struct eh_frame_sec_info *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;
  unsigned int lo, hi, mid;
  struct eh_cie_fde *ent = ((void*)0);
 ...
 return delta;
      ptr_size = (((const struct elf_backend_data *) ((sec->owner)->xvec)->backend_data)
...
# 1415 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
bfd_boolean
     ...
     void *arg __attribute__ ((__unused__)))
{
  ...
  if (sym_sec->sec_info_type != 3
      || ((struct bfd_elf_section_data*)(sym_sec)->used_by_bfd)->sec_info == ((void*)0))
    return 1;
          ...
          struct elf_reloc_cookie *cookie)
{
  ...
  shndx = ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_idx;
  end_sym = cookie->locsyms + cookie->locsymcount;
  for (sym = cookie->locsyms + 1; sym < end_sym; ++sym)
    if (sym->st_info <= (((0) << 4) + ((1) & 0xF))
 && sym->st_shndx == shndx)
      {
    ...
    struct elf_reloc_cookie *cookie)
{
  ...
  if (sec->sec_info_type != 3)
    return 0;

  sec_info = (struct eh_frame_sec_info *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;
  if (sec_info == ((void*)0))
    return 0;
  ...
  for (ent = sec_info->entry; ent < sec_info->entry + sec_info->count; ++ent)
    if (ent->size == 4)
      ...
      ent->removed = sec->map_head.s != ((void*)0);
    else if (!ent->cie && ent->u.fde.cie_inf != ((void*)0))
      {
 bfd_boolean keep;
 if ((sec->flags & 0x100000) != 0 && cookie->rels == ((void*)0))
   {
 ...
 else
   {
     ...
     do { if (!(cookie->rel < cookie->relend && cookie->rel->r_offset == ent->offset + 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1516); } while (0);
 ...
 if (keep)
   {
     if ((((info)->type == type_dll) || ((info)->type == type_pie))
  && (((ent->fde_encoding & 0x70) == 0x00
       && ent->make_relative == 0)
      || (ent->fde_encoding & 0x70) == 0x50))
       {
  ...
  if (num_warnings_issued < 10)
    {
      _bfd_error_handler
        ...
        (dgettext ("bfd", "FDE encoding in %pB(%pA) prevents .eh_frame_hdr" " table being created"), abfd, sec);
    ...
    {
      _bfd_error_handler
        (dgettext ("bfd", "further warnings about FDE encoding preventing .eh_frame_hdr generation dropped"));
      num_warnings_issued ++;
    }
       }
     ent->removed = 0;
 ...
 offset += size_of_output_cie_fde (ent);
  ...
  if (changed && adjust_eh_frame_local_symbols (sec, cookie))
    {
      Elf_Internal_Shdr *symtab_hdr = &((abfd) -> tdata.elf_obj_data)->symtab_hdr;
...
_bfd_elf_discard_section_eh_frame_hdr (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (!hdr_info->frame_hdr_is_compact && hdr_info->u.dwarf.cies != ((void*)0))
    {
      htab_delete (hdr_info->u.dwarf.cies);
      hdr_info->u.dwarf.cies = ((void*)0);
    }
...
_bfd_elf_eh_frame_present (struct bfd_link_info *info)
{
  ...
  for (eh = eh->map_head.s; eh != ((void*)0); eh = eh->map_head.s)
    if (eh->size > 8)
      return 1;
...
_bfd_elf_eh_frame_entry_present (struct bfd_link_info *info)
{
 ...
 {
   const char *name = ((void) abfd, (o)->name);
...
_bfd_elf_maybe_strip_eh_frame_hdr (struct bfd_link_info *info)
{
  ...
  if (((hdr_info->hdr_sec->output_section) == (&_bfd_std_section[2]))
      || info->eh_frame_hdr_type == 0
      || (info->eh_frame_hdr_type == 1
   && !_bfd_elf_eh_frame_present (info))
      || (info->eh_frame_hdr_type == 2
   && !_bfd_elf_eh_frame_entry_present (info)))
    {
      hdr_info->hdr_sec->flags |= 0x8000;
  ...
  (info, info->output_bfd, "__GNU_EH_FRAME_HDR", (1 << 0),
   hdr_info->hdr_sec, 0, ((void*)0), 0, 0, &bh)))
    return 0;

  h = (struct elf_link_hash_entry *) bh;
  h->def_regular = 1;
  h->other = 2;
  ((const struct elf_backend_data *) ((info->output_bfd)->xvec)->backend_data)->elf_backend_hide_symbol (info, h, 1);


  if (!hdr_info->frame_hdr_is_compact)
    hdr_info->u.dwarf.table = 1;
  return 1;
}
...
bfd_vma
_bfd_elf_eh_frame_section_offset (bfd *output_bfd __attribute__ ((__unused__)),
      ...
      bfd_vma offset)
{
 ...
 break;
  ...
  do { if (!(lo < hi)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1777); } while (0);
           ...
           asection *sec, bfd_byte *contents)
{
  ...
  bfd_vma last_addr;
  bfd_vma offset;
  asection *text_sec = (asection *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;

  if (!sec->rawsize)
    sec->rawsize = sec->size;

  do { if (!(sec->sec_info_type == 6)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1845); } while (0);




  if (sec->flags & 0x8000
      || text_sec->flags & 0x8000)
    return 1;
  ...
  last_addr = ((*((abfd)->xvec->bfd_getx_signed_32)) (contents));

  for (offset = 8; offset < sec->rawsize; offset += 8)
    {
      addr = ((*((abfd)->xvec->bfd_getx_signed_32)) (contents + offset)) + offset;
      if (addr <= last_addr)
 {

   _bfd_error_handler (dgettext ("bfd", "%pB: %pA not in order"), sec->owner, sec);
   return 0;
 }
  ...
  if (addr & 1)
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "%pB: %pA invalid input section size"),
     sec->owner, sec);
  ...
  if (last_addr >= addr + sec->rawsize)
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "%pB: %pA points past end of text section"),
     sec->owner, sec);
      bfd_set_error (bfd_error_bad_value);
      return 0;
    }
  ...
  do { if (!(sec->size == sec->rawsize + 8)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1898); } while (0);
  do { if (!((addr & 1) == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1899); } while (0);
  do { if (!(bed->cant_unwind_opcode)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1900); } while (0);

  ((*((abfd)->xvec->bfd_putx32)) ((addr),(cantunwind)));
  ((*((abfd)->xvec->bfd_putx32)) (((*bed->cant_unwind_opcode) (info)),(cantunwind + 4)));
     ...
     bfd_byte *contents)
{
  ...
  ptr_size = (((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)
       ->elf_backend_eh_frame_address_size (abfd, sec));
  do { if (!(ptr_size != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1930); } while (0);

  sec_info = (struct eh_frame_sec_info *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;
  htab = ((struct elf_link_hash_table *) ((info)->hash));
  hdr_info = &htab->eh_info;

  if (hdr_info->u.dwarf.table && hdr_info->u.dwarf.array == ((void*)0))
    {
      hdr_info->frame_hdr_is_compact = 0;
      hdr_info->u.dwarf.array = (struct eh_frame_array_ent *)
 bfd_malloc (hdr_info->u.dwarf.fde_count
      * sizeof (*hdr_info->u.dwarf.array));
    }
  if (hdr_info->u.dwarf.array == ((void*)0))
    hdr_info = ((void*)0);
      ...
      if (ent->size == 4)
 {
   ...
   do { if (!(ent == last_ent - 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",1971); } while (0);
   continue;
 }
      ...
      ((*((abfd)->xvec->bfd_putx32)) ((new_size - 4),(buf)));
      ...
      if (ent->cie)
 {
  ...
  {
    do { if (!(action & 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2033); } while (0);
    *aug++ = 'R';
    *buf++ = make_pc_relative (0x00, ptr_size);
    action &= ~1;
  }
  ...
  switch (*aug++)
    ...
    case 'L':
      if (action & 2)
        {
   do { if (!(*buf == ent->lsda_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2045); } while (0);
   *buf = make_pc_relative (*buf, ptr_size);
   action &= ~2;
    ...
    case 'P':
      ...
      do { if (!(per_width != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2056); } while (0);
      do { if (!(((per_encoding & 0x70) == 0x10) == ent->u.cie.per_encoding_relative)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2058); } while (0);

      if ((per_encoding & 0x70) == 0x50)
        buf = (contents
   ...
   action &= ~4;
    ...
    case 'R':
      if (action & 1)
        {
   do { if (!(*buf == ent->fde_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2086); } while (0);
   *buf = make_pc_relative (*buf, ptr_size);
   action &= ~1;
        }
      buf++;
    ...
    case 'S':
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2095); } while (0);
    }
     }
 }
      else
 {
   ...
   ((*((abfd)->xvec->bfd_putx32)) ((value),(buf)));
   if (((info)->type == type_relocatable))
     continue;
   buf += 4;
   width = get_DW_EH_PE_width (ent->fde_encoding, ptr_size);
   value = read_value (abfd, buf, width,
         (((ent->fde_encoding) & 0x08) != 0));
   address = value;
   if (value)
     {
  ...
  {
  case 0x20:
    do { if (!(hdr_info == ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2125); } while (0);
    break;
  case 0x30:
    {
      switch (abfd->arch_info->arch)
        {
        case bfd_arch_ia64:
   do { if (!((((abfd) -> tdata.elf_obj_data) -> gp) != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2132); } while (0);
   address += (((abfd) -> tdata.elf_obj_data) -> gp);
   break;
        default:
   _bfd_error_handler
     (dgettext ("bfd", "DW_EH_PE_datarel unspecified" " for this architecture"));


        case bfd_arch_frv:
        case bfd_arch_i386:
   do { if (!(htab->hgot != ((void*)0) && ((htab->hgot->root.type == bfd_link_hash_defined) || (htab->hgot->root.type == bfd_link_hash_defweak)))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2146); } while (0);
  ...
  = read_value (abfd, buf + width, width, 0);
...
# 2281 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
bfd_boolean
_bfd_elf_fixup_eh_frame_hdr (struct bfd_link_info *info)
{
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "invalid output section for .eh_frame_entry: %pA"),
      sec->output_section);
   return 0;
 }
  ...
  for (p = sec->output_section->map_head.link_order; p != ((void*)0); p = p->next)
    {
      if (p->type != bfd_indirect_link_order)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c", 2320, __PRETTY_FUNCTION__);
 ...
 i--;
  ...
  if (i != 0)
    {
      _bfd_error_handler
 (dgettext ("bfd", "invalid contents in %pA section"), osec);
      return 0;
    }
...
write_compact_eh_frame_hdr (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (sec->size != 8)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c", 2359, __PRETTY_FUNCTION__);
  ...
  do { if (!(bed->compact_eh_encoding)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c",2367); } while (0);
  contents[1] = (*bed->compact_eh_encoding) (info);

  count = (sec->output_section->size - 8) / 8;
  ((*((abfd)->xvec->bfd_putx32)) ((count),(contents + 4)));
  return bfd_set_section_contents (abfd, sec->output_section, contents,
       (file_ptr) sec->output_offset, sec->size);
}
# 2396 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-eh-frame.c"
static bfd_boolean
write_dwarf_eh_frame_hdr (bfd *abfd, struct bfd_link_info *info)
{
  ...
  contents[1] = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->elf_backend_encode_eh_address
  ...
  ((*((abfd)->xvec->bfd_putx32)) ((encoded_eh_frame),(contents + 4)));
  ...
  if (contents[2] != 0xff)
    {
      ...
      ((*((abfd)->xvec->bfd_putx32)) ((hdr_info->u.dwarf.fde_count),(contents + 8)));
      ...
      for (i = 0; i < hdr_info->u.dwarf.fde_count; i++)
 {
   ...
   if ((((abfd) -> tdata.elf_obj_data) -> elf_header)->e_ident[4] == 2
    ...
    != sec->output_section->vma + val))
     overflow = 1;
   ((*((abfd)->xvec->bfd_putx32)) ((val),(contents + 8 + i * 8 + 4)));
   ...
   if ((((abfd) -> tdata.elf_obj_data) -> elf_header)->e_ident[4] == 2
    ...
    != sec->output_section->vma + val))
     overflow = 1;
   ((*((abfd)->xvec->bfd_putx32)) ((val),(contents + 8 + i * 8 + 8)));
   if (i != 0
       && (hdr_info->u.dwarf.array[i].initial_loc
    < (hdr_info->u.dwarf.array[i - 1].initial_loc
     ...
     overlap = 1;
      ...
      if (overflow)
 _bfd_error_handler (dgettext ("bfd", ".eh_frame_hdr entry overflow"));
      if (overlap)
 _bfd_error_handler (dgettext ("bfd", ".eh_frame_hdr refers to overlapping FDEs"));
      if (overflow || overlap)
 {
   bfd_set_error (bfd_error_bad_value);
   retval = 0;
...
_bfd_elf_write_section_eh_frame_hdr (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (info->eh_frame_hdr_type == 0 || sec == ((void*)0))
    return 1;
...
unsigned int
_bfd_elf_eh_frame_address_size (bfd *abfd, const asection *sec __attribute__ ((__unused__)))
{
  return (((abfd) -> tdata.elf_obj_data) -> elf_header)->e_ident[4] == 2 ? 8 : 4;
}
...
bfd_boolean
_bfd_elf_can_make_relative (bfd *input_bfd __attribute__ ((__unused__)),
       struct bfd_link_info *info __attribute__ ((__unused__)),
       asection *eh_frame_section __attribute__ ((__unused__)))
{
  return 1;
}
...
bfd_byte
_bfd_elf_encode_eh_address (bfd *abfd __attribute__ ((__unused__)),
       struct bfd_link_info *info __attribute__ ((__unused__)),
       asection *osec, bfd_vma offset,
       asection *loc_sec, bfd_vma loc_offset,
       bfd_vma *encoded)
