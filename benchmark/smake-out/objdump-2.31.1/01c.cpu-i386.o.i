# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cpu-i386.c" 2
      ...
      bfd_boolean long_nop)
{
  ...
  bfd_size_type nop_size = long_nop ? (sizeof (nops) / sizeof ((nops)[0])) : 2;
...
bfd_arch_i386_short_nop_fill (bfd_size_type count,
         ...
         bfd_boolean code)
{
  return bfd_arch_i386_fill (count, code, 0);
}
...
bfd_arch_i386_long_nop_fill (bfd_size_type count,
        ...
        bfd_boolean code)
{
  return bfd_arch_i386_fill (count, code, 1);
}
