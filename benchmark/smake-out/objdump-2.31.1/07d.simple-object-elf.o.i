# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
# 1 "./config.h" 1
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
# 1 "./../include/simple-object.h" 1
# 23 "./../include/simple-object.h"
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 24 "./../include/simple-object.h" 2
...
# 28 "./../include/simple-object.h" 2
# 42 "./../include/simple-object.h"
...
simple_object_copy_lto_debug_sections (simple_object_read *src_object,
           const char *dest,
           int *err, int rename);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2


# 1 "./simple-object-common.h" 1
# 21 "./simple-object-common.h"
...
struct simple_object_functions
{
  ...
  void *(*match) (unsigned char header[(16)],
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c" 2
...
# 134 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
typedef struct {
...
# 210 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
typedef struct
{
...
# 250 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
...
# 369 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
...
static void *
simple_object_elf_match (unsigned char header[(16)],
    int descriptor, off_t offset,
    const char *segment_name __attribute__ ((__unused__)),
    const char **errmsg, int *err)
{
  unsigned char ei_data;
  unsigned char ei_class;
  ...
  eor = ((struct simple_object_elf_read *) xmalloc (sizeof (struct simple_object_elf_read)));
  eor->type_functions = type_functions;
  eor->ei_data = ei_data;
  eor->ei_class = ei_class;
  eor->ei_osabi = header[7];
  eor->machine = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf32_External_Ehdr, e_machine))) : ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf64_External_Ehdr, e_machine))));

  eor->flags = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((ehdr) + __builtin_offsetof(Elf32_External_Ehdr, e_flags))) : ((type_functions)->fetch_Elf_Word ((ehdr) + __builtin_offsetof(Elf64_External_Ehdr, e_flags))));

  eor->shoff = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((ehdr) + __builtin_offsetof(Elf32_External_Ehdr, e_shoff))) : ((type_functions)->fetch_Elf_Addr ((ehdr) + __builtin_offsetof(Elf64_External_Ehdr, e_shoff))));

  eor->shnum = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf32_External_Ehdr, e_shnum))) : ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf64_External_Ehdr, e_shnum))));

  eor->shstrndx = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf32_External_Ehdr, e_shstrndx))) : ((type_functions)->fetch_Elf_Half ((ehdr) + __builtin_offsetof(Elf64_External_Ehdr, e_shstrndx))));


  if ((eor->shnum == 0 || eor->shstrndx == 0xFFFF)
      && eor->shoff != 0)
    {
     ...
     errmsg, err))
 {
   ...
   return ((void*)0);
      ...
      if (eor->shnum == 0)
 eor->shnum = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_size))) : ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_size))));


      if (eor->shstrndx == 0xFFFF)
 {
   eor->shstrndx = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_link))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_link))));
# 534 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
   if (eor->shstrndx >= eor->shnum
       && eor->shstrndx >= 0xFF00 + 0x100)
     eor->shstrndx -= 0x100;
 }
    }
     ...
     int *err)
{
  ...
  shnum = eor->shnum;
  shdrs = ((unsigned char *) xmalloc (sizeof (unsigned char) * (shdr_size * (shnum - 1))));
  ...
  name_size = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shstrhdr) + __builtin_offsetof(Elf32_External_Shdr, sh_size))) : ((type_functions)->fetch_Elf_Addr ((shstrhdr) + __builtin_offsetof(Elf64_External_Shdr, sh_size))));

  shstroff = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shstrhdr) + __builtin_offsetof(Elf32_External_Shdr, sh_offset))) : ((type_functions)->fetch_Elf_Addr ((shstrhdr) + __builtin_offsetof(Elf64_External_Shdr, sh_offset))));

  names = ((unsigned char *) xmalloc (sizeof (unsigned char) * (name_size)));
  if (!simple_object_internal_read (sobj->descriptor,
  ...
  for (i = 1; i < shnum; ++i)
    {
      ...
      sh_name = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_name))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_name))));
      ...
      if (sh_name >= name_size)
 {
   *err = 0;
   ...
   return "ELF section name out of range";
      ...
      offset = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_offset))) : ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_offset))));

      length = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_size))) : ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_size))));
        ...
        int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((struct simple_object_elf_attributes *) xmalloc (sizeof (struct simple_object_elf_attributes)));
          ...
          int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((struct simple_object_elf_write *) xmalloc (sizeof (struct simple_object_elf_write)));
  ret->attrs = *attrs;
  ret->shdrs = ((void*)0);
  return ret;
}
         ...
         const char **errmsg, int *err)
{
  ...
  shnum = 0;
  for (section = sobj->sections; section != ((void*)0); section = section->next)
    ++shnum;
  if (shnum > 0)
    {
  ...
  buf[5] = attrs->ei_data;
  buf[6] = 1;
  buf[7] = attrs->ei_osabi;

  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_type), (1)) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_type), (1)));
  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_machine), (attrs->machine)) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_machine), (attrs->machine)));
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_version), (1)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_version), (1)));


  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_shoff), (ehdr_size)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_shoff), (ehdr_size)));
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_flags), (attrs->flags)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_flags), (attrs->flags)));
  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_ehsize), (ehdr_size)) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_ehsize), (ehdr_size)));
  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_phentsize), ((cl == 1 ? sizeof (Elf32_External_Phdr) : sizeof (Elf64_External_Phdr)))) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_phentsize), ((cl == 1 ? sizeof (Elf32_External_Phdr) : sizeof (Elf64_External_Phdr)))));




  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_shentsize), ((cl == 1 ? sizeof (Elf32_External_Shdr) : sizeof (Elf64_External_Shdr)))) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_shentsize), ((cl == 1 ? sizeof (Elf32_External_Shdr) : sizeof (Elf64_External_Shdr)))));



  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_shnum), (shnum >= 0xFF00 ? 0 : shnum)) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_shnum), (shnum >= 0xFF00 ? 0 : shnum)));
 ...
 shstrndx = 0xFFFF;
  ...
  ((cl) == 1 ? (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf32_External_Ehdr, e_shstrndx), (shstrndx)) : (fns)->set_Elf_Half ((buf) + __builtin_offsetof(Elf64_External_Ehdr, e_shstrndx), (shstrndx)));
         ...
         const char **errmsg, int *err)
{
  ...
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_name), (sh_name)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_name), (sh_name)));
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_type), (sh_type)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_type), (sh_type)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_flags), (sh_flags)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_flags), (sh_flags)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_addr), (sh_addr)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_addr), (sh_addr)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_offset), (sh_offset)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_offset), (sh_offset)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_size), (sh_size)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_size), (sh_size)));
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_link), (sh_link)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_link), (sh_link)));
  ((cl) == 1 ? (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_info), (sh_info)) : (fns)->set_Elf_Word ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_info), (sh_info)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_addralign), (sh_addralign)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_addralign), (sh_addralign)));
  ((cl) == 1 ? (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf32_External_Shdr, sh_entsize), (sh_entsize)) : (fns)->set_Elf_Addr ((buf) + __builtin_offsetof(Elf64_External_Shdr, sh_entsize), (sh_entsize)));

  return simple_object_internal_write (descriptor, offset, buf, shdr_size,
           errmsg, err);
}
# 881 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-elf.c"
static const char *
     ...
     int *err)
{
  ...
  for (section = sobj->sections; section != ((void*)0); section = section->next)
    {
      ...
      if (eow->shdrs)
 {
   sh_type = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_type))) : ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_type))));


   sh_flags = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_flags))) : ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_flags))));


   sh_addr = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_addr))) : ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_addr))));


   sh_link = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_link))) : ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_link))));


   sh_info = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_info))) : ((attrs->type_functions)->fetch_Elf_Word ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_info))));


   sh_addralign = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_addralign))) : ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_addralign))));


   sh_entsize = ((attrs->ei_class) == 1 ? ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf32_External_Shdr, sh_entsize))) : ((attrs->type_functions)->fetch_Elf_Addr ((eow->shdrs + secnum * shdr_size) + __builtin_offsetof(Elf64_External_Shdr, sh_entsize))));
      ...
      while (new_sh_offset > sh_offset)
 {
   ...
   sh_offset += write;
      ...
      sh_size = 0;
      for (buffer = section->buffers; buffer != ((void*)0); buffer = buffer->next)
 {
        ...
        int *err)
{
  ...
  pfnret = ((int *) xmalloc (sizeof (int) * (shnum)));
  pfnname = ((const char * *) xmalloc (sizeof (const char *) * (shnum)));


  symtab_indices_shndx = ((unsigned int *) xcalloc ((shnum - 1), sizeof (unsigned int)));
      ...
      if (sh_name >= name_size)
 {
   *err = 0;
   ...
   return "ELF section name out of range";
      ...
      ret = (*pfn) (name);
      pfnret[i - 1] = ret == ((void*)0) ? -1 : 0;
      pfnname[i - 1] = ret == ((void*)0) ? name : ret;
      if (first_shndx == 0
   && pfnret[i - 1] == 0)
 first_shndx = i;


      sh_type = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_type))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_type))));

      if (sh_type == 18)
 {
   unsigned int sh_link;
   sh_link = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_link))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_link))));
      ...
      for (i = 1; i < shnum; ++i)
 {
   ...
   sh_info = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_info))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_info))));
   ...
   if (sh_type == 17)
     {
       ...
       unsigned entsize = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_entsize))) : ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_entsize))));
       ...
       buf = ((unsigned char *) xmalloc (sizeof (unsigned char) * (length)));
       if (!simple_object_internal_read (sobj->descriptor,
  ...
  sh_map = ((unsigned *) xmalloc (sizeof (unsigned) * (shnum)));
  sh_map[0] = 0;
  new_i = 1;
  for (i = 1; i < shnum; ++i)
    {
 ...
 sh_map[i] = new_i++;
  ...
  eow->shdrs = ((unsigned char *) xmalloc (sizeof (unsigned char) * (shdr_size * (new_i - 1))));
      ...
      if (sh_name >= name_size)
 {
   *err = 0;
   free ((void*) (names));
   free ((void*) (shdrs));
   free ((void*) (symtab_indices_shndx));
   return "ELF section name out of range";
 }
      ...
      if (sh_type == 2)
 {
   ...
   unsigned strtab = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_link))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_link))));

   unsigned char *strshdr = shdrs + (strtab - 1) * shdr_size;
   off_t stroff = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((strshdr) + __builtin_offsetof(Elf32_External_Shdr, sh_offset))) : ((type_functions)->fetch_Elf_Addr ((strshdr) + __builtin_offsetof(Elf64_External_Shdr, sh_offset))));

   size_t strsz = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((strshdr) + __builtin_offsetof(Elf32_External_Shdr, sh_size))) : ((type_functions)->fetch_Elf_Addr ((strshdr) + __builtin_offsetof(Elf64_External_Shdr, sh_size))));

   char *strings = ((char *) xmalloc (sizeof (char) * (strsz)));
   char *gnu_lto = strings;
   unsigned char *ent;
   unsigned *shndx_table = ((void*)0);
   ...
   if (symtab_indices_shndx[i - 1] != 0)
     {
       ...
       off_t sidxoff = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((sidxhdr) + __builtin_offsetof(Elf32_External_Shdr, sh_offset))) : ((type_functions)->fetch_Elf_Addr ((sidxhdr) + __builtin_offsetof(Elf64_External_Shdr, sh_offset))));

       size_t sidxsz = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((sidxhdr) + __builtin_offsetof(Elf32_External_Shdr, sh_size))) : ((type_functions)->fetch_Elf_Addr ((sidxhdr) + __builtin_offsetof(Elf64_External_Shdr, sh_size))));

       shndx_table = (unsigned *)((char *) xmalloc (sizeof (char) * (sidxsz)));
       simple_object_internal_read (sobj->descriptor,
        sobj->offset + sidxoff,
   ...
   for (ent = buf; ent < buf + length; ent += entsize)
     {
       unsigned st_shndx = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Half ((ent) + __builtin_offsetof(Elf32_External_Sym, st_shndx))) : ((type_functions)->fetch_Elf_Half ((ent) + __builtin_offsetof(Elf64_External_Sym, st_shndx))));
       ...
       if (discard)
  {
    ...
    int bind = (((unsigned char) (*st_info)) >> 4);
    int other = 0;
    if (bind == 0)
      {


        ((ei_class) == 1 ? (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf32_External_Sym, st_name), (0)) : (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf64_External_Sym, st_name), (0)));

        ((ei_class) == 1 ? (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf32_External_Sym, st_shndx), (sh_map[first_shndx])) : (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf64_External_Sym, st_shndx), (sh_map[first_shndx])));
    ...
    else
      {
        ...
        other = 2;
        if (gnu_lto)
   ((ei_class) == 1 ? (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf32_External_Sym, st_name), (gnu_lto - strings)) : (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf64_External_Sym, st_name), (gnu_lto - strings)));


        ((ei_class) == 1 ? (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf32_External_Sym, st_shndx), (0)) : (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf64_External_Sym, st_shndx), (0)));

      }
    *st_other = other;
    *st_info = (((bind) << 4) + ((0) & 0xf));
    ((ei_class) == 1 ? (type_functions)->set_Elf_Addr ((ent) + __builtin_offsetof(Elf32_External_Sym, st_value), (0)) : (type_functions)->set_Elf_Addr ((ent) + __builtin_offsetof(Elf64_External_Sym, st_value), (0)));

    ((ei_class) == 1 ? (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf32_External_Sym, st_size), (0)) : (type_functions)->set_Elf_Word ((ent) + __builtin_offsetof(Elf64_External_Sym, st_size), (0)));

  }
       else if (raw_st_shndx < 0xFF00
         || raw_st_shndx == 0xFFFF)

  ((ei_class) == 1 ? (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf32_External_Sym, st_shndx), (sh_map[st_shndx])) : (type_functions)->set_Elf_Half ((ent) + __builtin_offsetof(Elf64_External_Sym, st_shndx), (sh_map[st_shndx])));

     }
   free ((void*) (strings));
   free ((void*) (shndx_table));
 }
      else if (sh_type == 17)
 {
      ...
      if (errmsg)
 {
   ...
   return errmsg;
      ...
      flags = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_flags))) : ((type_functions)->fetch_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_flags))));


      {
 unsigned int sh_info, sh_link;
 if (flags & 0x00000040 || sh_type == 9 || sh_type == 4)
   {
     sh_info = ((ei_class) == 1 ? ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_info))) : ((type_functions)->fetch_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_info))));
  ...
  || sh_info > 0xffff)
     ...
     ((ei_class) == 1 ? (type_functions)->set_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_info), (sh_info)) : (type_functions)->set_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_info), (sh_info)));
 ...
 ((ei_class) == 1 ? (type_functions)->set_Elf_Word ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_link), (sh_link)) : (type_functions)->set_Elf_Word ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_link), (sh_link)));
 ...
 flags &= ~0x00000004;
      ...
      flags &= ~0x80000000;
      ((ei_class) == 1 ? (type_functions)->set_Elf_Addr ((shdr) + __builtin_offsetof(Elf32_External_Shdr, sh_flags), (flags)) : (type_functions)->set_Elf_Addr ((shdr) + __builtin_offsetof(Elf64_External_Shdr, sh_flags), (flags)));
