# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
# 1 "./libaout.h" 1
# 29 "./libaout.h"
...
extern bfd_boolean aout_32_bfd_free_cached_info
  (bfd *);
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
...
# 29 "/usr/include/bits/dirent_ext.h" 3 4
extern __ssize_t getdents64 (int __fd, void *__buffer, size_t __length)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
# 405 "/usr/include/dirent.h" 2 3 4
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2


# 1 "./hosts/i386linux.h" 1
# 47 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c" 2
...
# 74 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
...
trad_unix_core_file_p (bfd *abfd)
{
...

  {
    ...
    if ((ufile_ptr) (1UL << 12) * (1 + u.u_dsize
 ...
 return 0;
    ...
    if (((ufile_ptr) (1UL << 12) * (1 + u.u_dsize + u.u_ssize)
 ...
 return 0;
  ...
  flags = 0x1 + 0x2 + 0x100;
  ((abfd)->tdata.trad_core_data->stack_section) = bfd_make_section_anyway_with_flags (abfd, ".stack",
           flags);
  if (((abfd)->tdata.trad_core_data->stack_section) == ((void*)0))
    goto fail;
  ((abfd)->tdata.trad_core_data->data_section) = bfd_make_section_anyway_with_flags (abfd, ".data",
           flags);
  if (((abfd)->tdata.trad_core_data->data_section) == ((void*)0))
    goto fail;
  ((abfd)->tdata.trad_core_data->reg_section) = bfd_make_section_anyway_with_flags (abfd, ".reg",
          0x100);
  if (((abfd)->tdata.trad_core_data->reg_section) == ((void*)0))
    goto fail;

  ((abfd)->tdata.trad_core_data->data_section)->size = (1UL << 12) * u.u_dsize



      ;
  ((abfd)->tdata.trad_core_data->stack_section)->size = (1UL << 12) * u.u_ssize;
  ((abfd)->tdata.trad_core_data->reg_section)->size = (1UL << 12) * 1;
  ...
  ((abfd)->tdata.trad_core_data->data_section)->vma = (u.start_code) + ((1UL << 12) * u.u_tsize);





  ((abfd)->tdata.trad_core_data->stack_section)->vma = (u.start_stack + u.u_ssize * (1UL << 12)) - ((1UL << 12) * u.u_ssize);
# 208 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
  ((abfd)->tdata.trad_core_data->reg_section)->vma = - (bfd_vma) (unsigned long) u.u_ar0;

  ((abfd)->tdata.trad_core_data->data_section)->filepos = (1UL << 12) * 1;
  ((abfd)->tdata.trad_core_data->stack_section)->filepos = ((1UL << 12) * 1) + (1UL << 12) * u.u_dsize



      ;
  ((abfd)->tdata.trad_core_data->reg_section)->filepos = 0;


  ((abfd)->tdata.trad_core_data->stack_section)->alignment_power = 2;
  ((abfd)->tdata.trad_core_data->data_section)->alignment_power = 2;
  ((abfd)->tdata.trad_core_data->reg_section)->alignment_power = 2;
...
static int
trad_unix_core_file_failing_signal (bfd *ignore_abfd __attribute__ ((__unused__)))
{
...
swap_abort (void)
{
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c", 258, __PRETTY_FUNCTION__);
}
# 268 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/trad-core.c"
const bfd_target core_trad_vec =
  {
    ...
    (0x1 | 0x2 |
     0x4 | 0x08 |
     0x10 | 0x20 | 0x80 | 0x100),
    (0x100 | 0x1 | 0x2 | 0x4),
    0,
    ' ',
    16,
    0,
    ((bfd_uint64_t (*) (const void *)) swap_abort), ((bfd_int64_t (*) (const void *)) swap_abort), ((void (*) (bfd_uint64_t, void *)) swap_abort),
    ((bfd_vma (*) (const void *)) swap_abort), ((bfd_signed_vma (*) (const void *)) swap_abort), ((void (*) (bfd_vma, void *)) swap_abort),
    ((bfd_vma (*) (const void *)) swap_abort), ((bfd_signed_vma (*) (const void *)) swap_abort), ((void (*) (bfd_vma, void *)) swap_abort),
    ((bfd_uint64_t (*) (const void *)) swap_abort), ((bfd_int64_t (*) (const void *)) swap_abort), ((void (*) (bfd_uint64_t, void *)) swap_abort),
    ((bfd_vma (*) (const void *)) swap_abort), ((bfd_signed_vma (*) (const void *)) swap_abort), ((void (*) (bfd_vma, void *)) swap_abort),
    ((bfd_vma (*) (const void *)) swap_abort), ((bfd_signed_vma (*) (const void *)) swap_abort), ((void (*) (bfd_vma, void *)) swap_abort),
    ...
    _bfd_archive_close_and_cleanup, _bfd_bool_bfd_true, _bfd_generic_new_section_hook, _bfd_generic_get_section_contents, _bfd_generic_get_section_contents_in_window,
    _bfd_bool_bfd_bfd_true, _bfd_bool_bfd_link_true, _bfd_generic_init_private_section_data, _bfd_bool_bfd_asection_bfd_asection_true, _bfd_bool_bfd_asymbol_bfd_asymbol_true, _bfd_bool_bfd_bfd_true, _bfd_bool_bfd_uint_true, _bfd_bool_bfd_ptr_true,
    trad_unix_core_file_failing_command, trad_unix_core_file_failing_signal, generic_core_file_matches_executable_p, _bfd_nocore_core_file_pid,
    _bfd_bool_bfd_false_error, _bfd_bool_bfd_false_error, _bfd_noarchive_construct_extended_name_table, _bfd_noarchive_truncate_arname, _bfd_noarchive_write_armap, _bfd_ptr_bfd_null_error, _bfd_noarchive_write_ar_hdr, _bfd_noarchive_openr_next_archived_file, _bfd_noarchive_get_elt_at_index, bfd_generic_stat_arch_elt, _bfd_bool_bfd_false_error,
    _bfd_long_bfd_n1_error, _bfd_nosymbols_canonicalize_symtab, _bfd_generic_make_empty_symbol, _bfd_nosymbols_print_symbol, _bfd_nosymbols_get_symbol_info, _bfd_nosymbols_get_symbol_version_string, _bfd_nosymbols_bfd_is_local_label_name, _bfd_bool_bfd_asymbol_false, _bfd_nosymbols_get_lineno, _bfd_nosymbols_find_nearest_line, _bfd_nosymbols_find_line, _bfd_nosymbols_find_inliner_info, _bfd_nosymbols_bfd_make_debug_symbol, _bfd_nosymbols_read_minisymbols, _bfd_nosymbols_minisymbol_to_symbol,
    _bfd_norelocs_get_reloc_upper_bound, _bfd_norelocs_canonicalize_reloc, _bfd_norelocs_set_reloc, _bfd_norelocs_bfd_reloc_type_lookup, _bfd_norelocs_bfd_reloc_name_lookup,
    bfd_default_set_arch_mach, _bfd_generic_set_section_contents,
    _bfd_nolink_sizeof_headers, _bfd_nolink_bfd_get_relocated_section_contents, _bfd_nolink_bfd_relax_section, _bfd_nolink_bfd_link_hash_table_create, _bfd_bool_bfd_link_false_error, _bfd_nolink_bfd_link_just_syms, _bfd_nolink_bfd_copy_link_hash_symbol_type, _bfd_bool_bfd_link_false_error, _bfd_nolink_bfd_link_split_section, _bfd_generic_link_check_relocs, _bfd_bool_bfd_link_false_error, _bfd_nolink_bfd_lookup_section_flags, _bfd_bool_bfd_link_false_error, _bfd_nolink_bfd_is_group_section, _bfd_nolink_bfd_discard_group, _bfd_nolink_section_already_linked, _bfd_nolink_bfd_define_common_symbol, _bfd_generic_link_hide_symbol, _bfd_nolink_bfd_define_start_stop,
