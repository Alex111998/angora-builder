# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
bfd_boolean
_bfd_bool_bfd_false (bfd *abfd __attribute__ ((__unused__)))
{
  return 0;
}

bfd_boolean
_bfd_bool_bfd_asymbol_false (bfd *abfd __attribute__ ((__unused__)),
...
bfd_boolean
_bfd_bool_bfd_false_error (bfd *ignore __attribute__ ((__unused__)))
{
...
bfd_boolean
_bfd_bool_bfd_true (bfd *ignore __attribute__ ((__unused__)))
{
  return 1;
}

bfd_boolean
_bfd_bool_bfd_link_true (bfd *abfd __attribute__ ((__unused__)),
    struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 1;
}
...
bfd_boolean
_bfd_bool_bfd_bfd_true (bfd *ibfd __attribute__ ((__unused__)),
...
bfd_boolean
_bfd_bool_bfd_uint_true (bfd *abfd __attribute__ ((__unused__)),
...
bfd_boolean
_bfd_bool_bfd_asection_bfd_asection_true (bfd *ibfd __attribute__ ((__unused__)),
...
bfd_boolean
_bfd_bool_bfd_asymbol_bfd_asymbol_true (bfd *ibfd __attribute__ ((__unused__)),
     asymbol *isym __attribute__ ((__unused__)),
     bfd *obfd __attribute__ ((__unused__)),
     asymbol *osym __attribute__ ((__unused__)))
{
  return 1;
}

bfd_boolean
_bfd_bool_bfd_ptr_true (bfd *abfd __attribute__ ((__unused__)),
...
void *
_bfd_ptr_bfd_null_error (bfd *ignore __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return ((void*)0);
}
...
int
_bfd_int_bfd_0 (bfd *ignore __attribute__ ((__unused__)))
{
  return 0;
}

unsigned int
_bfd_uint_bfd_0 (bfd *ignore __attribute__ ((__unused__)))
{
   return 0;
}

long
_bfd_long_bfd_0 (bfd *ignore __attribute__ ((__unused__)))
{
  return 0;
}
...
long
_bfd_long_bfd_n1_error (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return -1;
}
...
void
_bfd_void_bfd (bfd *ignore __attribute__ ((__unused__)))
{
}

void
_bfd_void_bfd_link (bfd *abfd __attribute__ ((__unused__)),
      struct bfd_link_info *info __attribute__ ((__unused__)))
{
}

void
_bfd_void_bfd_asection (bfd *abfd __attribute__ ((__unused__)),
   asection *sec __attribute__ ((__unused__)))
{
}

long
_bfd_norelocs_get_reloc_upper_bound (bfd *abfd __attribute__ ((__unused__)),
         asection *sec __attribute__ ((__unused__)))
{
...
long
_bfd_norelocs_canonicalize_reloc (bfd *abfd __attribute__ ((__unused__)),
      asection *sec __attribute__ ((__unused__)),
      arelent **relptr,
...
void
_bfd_norelocs_set_reloc (bfd *abfd __attribute__ ((__unused__)),
    asection *sec __attribute__ ((__unused__)),
    arelent **relptr __attribute__ ((__unused__)),
    unsigned int count __attribute__ ((__unused__)))
{
...
_bfd_nocore_core_file_matches_executable_p
  (bfd *ignore_core_bfd __attribute__ ((__unused__)),
   bfd *ignore_exec_bfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 0;
}
...
char *
_bfd_nocore_core_file_failing_command (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return ((void*)0);
}
...
int
_bfd_nocore_core_file_failing_signal (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 0;
}
...
int
_bfd_nocore_core_file_pid (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 0;
}
...
const bfd_target *
_bfd_dummy_target (bfd *ignore_abfd __attribute__ ((__unused__)))
{
...
# 396 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
bfd_boolean
...
# 572 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
bfd_vma
...
{
  const bfd_byte *addr = (const bfd_byte *) p;
  return (((bfd_vma) ((addr[0] << 8) | addr[1]) ^ 0x8000) - 0x8000);
}
...
{
  const bfd_byte *addr = (const bfd_byte *) p;
  return (((bfd_vma) ((addr[1] << 8) | addr[0]) ^ 0x8000) - 0x8000);
}
...
bfd_getb_signed_32 (const void *p)
{
  ...
  v |= (unsigned long) addr[2] << 8;
  v |= (unsigned long) addr[3];
  return (((bfd_vma) (v) ^ 0x80000000) - 0x80000000);
}
...
bfd_uint64_t
bfd_getb64 (const void *p __attribute__ ((__unused__)))
{
...
bfd_uint64_t
bfd_getl64 (const void *p __attribute__ ((__unused__)))
{
...
bfd_int64_t
bfd_getb_signed_64 (const void *p __attribute__ ((__unused__)))
{
  ...
  return (((bfd_uint64_t) (v) ^ ((bfd_uint64_t) 1 << 63)) - ((bfd_uint64_t) 1 << 63));
...
bfd_int64_t
bfd_getl_signed_64 (const void *p __attribute__ ((__unused__)))
{
...
void
bfd_putb64 (bfd_uint64_t data __attribute__ ((__unused__)), void *p __attribute__ ((__unused__)))
{
...
void
bfd_putl64 (bfd_uint64_t data __attribute__ ((__unused__)), void *p __attribute__ ((__unused__)))
{
...
bfd_put_bits (bfd_uint64_t data, void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c", 846, __PRETTY_FUNCTION__);
...
bfd_get_bits (const void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c", 867, __PRETTY_FUNCTION__);
       ...
       bfd_size_type count)
{
  ...
  if (section->compress_status != 0)
    {
      _bfd_error_handler

 (dgettext ("bfd", "%pB: unable to get decompressed section %pA"),
  abfd, section);
      bfd_set_error (bfd_error_invalid_operation);
      return 0;
    }
...
_bfd_generic_get_section_contents_in_window
  (bfd *abfd __attribute__ ((__unused__)),
   ...
   bfd_window *w __attribute__ ((__unused__)),
   file_ptr offset __attribute__ ((__unused__)),
   bfd_size_type count __attribute__ ((__unused__)))
{
# 984 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c", 984, __PRETTY_FUNCTION__);
...
# 1021 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/libbfd.c"
unsigned int
bfd_log2 (bfd_vma x)
{
...
{
  char locals_prefix = (((abfd)->xvec->symbol_leading_char) == '_') ? 'L' : '.';
        ...
        const char *func)
{
 ...
 fprintf (stderr, dgettext ("bfd", "Deprecated %s called at %s line %d in %s\n"),
   what, file, line, func);
      else
 fprintf (stderr, dgettext ("bfd", "Deprecated %s called\n"), what);
      fflush (stderr);
      mask |= ~(size_t) func;
    }
}
...
bfd_vma
_bfd_read_unsigned_leb128 (bfd *abfd __attribute__ ((__unused__)),
      bfd_byte *buf,
      unsigned int *bytes_read_ptr)
{
  ...
  do
    {
      byte = (*(const unsigned char *) (buf) & 0xff);
      buf++;
      num_read++;
...
bfd_vma
_bfd_safe_read_leb128 (bfd *abfd __attribute__ ((__unused__)),
         bfd_byte *data,
         ...
         const bfd_byte * const end)
{
  ...
  while (data < end)
    {
      byte = (*(const unsigned char *) (data) & 0xff);
      data++;
      num_read++;
...
bfd_signed_vma
_bfd_read_signed_leb128 (bfd *abfd __attribute__ ((__unused__)),
    bfd_byte *buf,
    unsigned int *bytes_read_ptr)
{
  bfd_vma result;
...
bfd_boolean
_bfd_generic_init_private_section_data (bfd *ibfd __attribute__ ((__unused__)),
     asection *isec __attribute__ ((__unused__)),
     bfd *obfd __attribute__ ((__unused__)),
     asection *osec __attribute__ ((__unused__)),
