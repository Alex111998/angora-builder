# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
# 122 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 123 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 124 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 125 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
...
# 126 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
...
# 127 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c" 2
# 142 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c"
...
ihex_bad_byte (bfd *abfd, unsigned int lineno, int c, bfd_boolean error)
{
 ...
 (dgettext ("bfd", "%pB:%d: unexpected character `%s' in Intel Hex file"),
  abfd, lineno, buf);
...
ihex_scan (bfd *abfd)
{
  ...
  while ((c = ihex_get_byte (abfd, &error)) != (-1))
    {
      if (c == '\r')
 continue;
      else if (c == '\n')
      ...
      else
 {
   ...
   for (i = 0; i < 8; i++)
     {
       if (! ((((unsigned int) _hex_value[(unsigned char) (hdr[i])]) != 99)))
  {
   ...
   len = (((((unsigned int) _hex_value[(unsigned char) ((hdr)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((hdr)[1])])));
   addr = (((((((unsigned int) _hex_value[(unsigned char) ((hdr + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((hdr + 2)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((hdr + 2) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((hdr + 2) + 2)[1])]))));
   type = (((((unsigned int) _hex_value[(unsigned char) ((hdr + 6)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((hdr + 6)[1])])));
  ...
  goto error_return;
   ...
   for (i = 0; i < chars; i++)
     {
       if (! ((((unsigned int) _hex_value[(unsigned char) (buf[i])]) != 99)))
  {
   ...
   for (i = 0; i < len; i++)
     chksum += (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])])));
   if (((- chksum) & 0xff) != (unsigned int) (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])]))))
     {
       _bfd_error_handler

  (dgettext ("bfd", "%pB:%u: bad checksum in Intel Hex file (expected %u, found %u)"),
   abfd, lineno,
   (- chksum) & 0xff, (unsigned int) (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])]))));
       bfd_set_error (bfd_error_bad_value);
       goto error_return;
     }
       ...
       if (len != 2)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%pB:%u: bad extended address record length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }

       segbase = (((((((unsigned int) _hex_value[(unsigned char) ((buf)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[1])])))) << 4;
       ...
       if (len != 2)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%pB:%u: bad extended linear address record length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }

       extbase = (((((((unsigned int) _hex_value[(unsigned char) ((buf)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[1])])))) << 16;
       ...
       if (len != 2 && len != 4)
  {
    _bfd_error_handler
      ...
      (dgettext ("bfd", "%pB:%u: bad extended linear start address length in Intel Hex file"),
       abfd, lineno);
    bfd_set_error (bfd_error_bad_value);
    goto error_return;
  }
       ...
       if (len == 2)
  abfd->start_address += (((((((unsigned int) _hex_value[(unsigned char) ((buf)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[1])])))) << 16;
       else
  abfd->start_address = ((((((((unsigned int) _hex_value[(unsigned char) ((buf)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[1])])))) << 16) + (((((((unsigned int) _hex_value[(unsigned char) ((buf + 4)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 4)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf + 4) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf + 4) + 2)[1])]))));
  ...
  (dgettext ("bfd", "%pB:%u: unrecognized ihex type %u in Intel Hex file"),
   abfd, lineno, type);
       bfd_set_error (bfd_error_bad_value);
       goto error_return;
     }
...
ihex_object_p (bfd *abfd)
{
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  for (i = 1; i < 9; i++)
    {
      if (! ((((unsigned int) _hex_value[(unsigned char) (b[i])]) != 99)))
 {
   bfd_set_error (bfd_error_wrong_format);
   return ((void*)0);
 }
  ...
  type = (((((unsigned int) _hex_value[(unsigned char) ((b + 7)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((b + 7)[1])])));
  if (type > 5)
    {
      bfd_set_error (bfd_error_wrong_format);
      return ((void*)0);
...
ihex_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
 ...
 continue;
      ...
      do { if (!(c == ':')) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c",573); } while (0);
 ...
 {
   _bfd_error_handler
     (dgettext ("bfd", "%pB: internal error in ihex_read_section"), abfd);
   bfd_set_error (bfd_error_bad_value);
   goto error_return;
 }
 ...
 goto error_return;
      ...
      for (i = 0; i < len; i++)
 *p++ = (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])])));
 ...
 goto error_return;
  ...
  if ((bfd_size_type) (p - contents) < section->size)
    {
      _bfd_error_handler
 (dgettext ("bfd", "%pB: bad section length in ihex_read_section"), abfd);
      bfd_set_error (bfd_error_bad_value);
      goto error_return;
    }
...
ihex_write_object_contents (bfd *abfd)
{
      ...
      while (count > 0)
 {
       ...
       if (where <= 0xfffff)
  {
    ...
    do { if (!(extbase == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c",800); } while (0);
       ...
       else
  {
   ...
   (dgettext ("bfd", "%pB: address %#" "ll" "x" " out of range for Intel Hex file"),
...
static int
ihex_sizeof_headers (bfd *abfd __attribute__ ((__unused__)),
       struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 0;
}
# 958 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/ihex.c"
const bfd_target ihex_vec =
{
  ...
  _bfd_archive_close_and_cleanup, _bfd_bool_bfd_true, _bfd_generic_new_section_hook, ihex_get_section_contents, _bfd_generic_get_section_contents_in_window,
