# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 1 "./elf-vxworks.h" 1
# 22 "./elf-vxworks.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
# 1 "./../include/elf/vxworks.h" 1
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c" 2
...
elf_vxworks_gott_symbol_p (bfd *abfd, const char *name)
{
  ...
  leading = ((abfd)->xvec->symbol_leading_char);
  if (leading)
    {
      if (*name != leading)
 return 0;
...
{
# 65 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c"
  if (((((info)->type == type_dll) || ((info)->type == type_pie)) || abfd->flags & 0x40)
      && elf_vxworks_gott_symbol_p (abfd, *namep))
    {
      sym->st_info = (((2) << 4) + ((((sym->st_info) & 0xF)) & 0xF));
      *flagsp |= (1 << 7);
    }
...
elf_vxworks_link_output_symbol_hook (struct bfd_link_info *info
         ...
         const char *name,
         Elf_Internal_Sym *sym,
         asection *input_sec __attribute__ ((__unused__)),
         struct elf_link_hash_entry *h)
{
      ...
      hash_ptr++)
 {
   if (*hash_ptr
    ...
    || (*hash_ptr)->root.type == bfd_link_hash_defweak)
       && (*hash_ptr)->root.u.def.section->output_section != ((void*)0))
     {
# 192 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-vxworks.c"
       for (j = 0; j < bed->s->int_rels_per_ext_rel; j++)
  {
    ...
    irela[j].r_info
      = (((this_idx) << 8) + ((((irela[j].r_info) & 0xff)) & 0xff));
...
elf_vxworks_final_write_processing (bfd *abfd,
        bfd_boolean linker __attribute__ ((__unused__)))
{
  asection * sec;
  ...
  if (sec)
    d->this_hdr.sh_info = ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_idx;
}
...
elf_vxworks_add_dynamic_entries (bfd *output_bfd, struct bfd_link_info *info)
{
  if (bfd_get_section_by_name (output_bfd, ".tls_data"))
    {
      if (!_bfd_elf_add_dynamic_entry (info, 0x60000010, 0)
   || !_bfd_elf_add_dynamic_entry (info, 0x60000011, 0)
   || !_bfd_elf_add_dynamic_entry (info, 0x60000015, 0))
 return 0;
    }
  if (bfd_get_section_by_name (output_bfd, ".tls_vars"))
    {
      if (!_bfd_elf_add_dynamic_entry (info, 0x60000012, 0)
   || !_bfd_elf_add_dynamic_entry (info, 0x60000013, 0))
 return 0;
    }
  return 1;
}
...
elf_vxworks_finish_dynamic_entry (bfd *output_bfd, Elf_Internal_Dyn *dyn)
{
  ...
  switch (dyn->d_tag)
    ...
    case 0x60000015:
      sec = bfd_get_section_by_name (output_bfd, ".tls_data");
      dyn->d_un.d_val
 = (bfd_size_type)1 << ((void) output_bfd, (sec)->alignment_power);
