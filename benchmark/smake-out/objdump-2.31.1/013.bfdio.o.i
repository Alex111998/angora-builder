# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
file_ptr
...
{
# 120 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
...
# 176 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
bfd_size_type
bfd_bread (void *ptr, bfd_size_type size, bfd *abfd)
{
  ...
  if (element_bfd->arelt_data != ((void*)0))
    {
      bfd_size_type maxbytes = (((struct areltdata *)((element_bfd)->arelt_data))->parsed_size);
...
bfd_seek (bfd *abfd, file_ptr position, int direction)
{
  ...
  do { if (!(direction == 0 || direction == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c",328); } while (0);

  if (direction != 1)
    position += offset;

  if ((direction == 1 && position == 0)
      || (direction == 0 && (ufile_ptr) position == abfd->where))
    return 0;
...
# 372 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
long
bfd_get_mtime (bfd *abfd)
{
  ...
  abfd->mtime = buf.st_mtim.tv_sec;
  return buf.st_mtim.tv_sec;
}
# 420 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
ufile_ptr
...
# 445 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
ufile_ptr
bfd_get_file_size (bfd *abfd)
{
  if (abfd->my_archive != ((void*)0)
      && !((abfd->my_archive)->is_thin_archive))
    return (((struct areltdata *)((abfd)->arelt_data))->parsed_size);

  return bfd_get_size (abfd);
}
# 471 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/bfdio.c"
void *
...
static int
memory_bflush (bfd *abfd __attribute__ ((__unused__)))
{
  return 0;
}
...
static void *
memory_bmmap (bfd *abfd __attribute__ ((__unused__)), void *addr __attribute__ ((__unused__)),
       bfd_size_type len __attribute__ ((__unused__)), int prot __attribute__ ((__unused__)),
       int flags __attribute__ ((__unused__)), file_ptr offset __attribute__ ((__unused__)),
