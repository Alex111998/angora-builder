# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c"
# 1 "./config.h" 1
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
# 1 "./pex-common.h" 1
# 24 "./pex-common.h"
# 1 "./config.h" 1
# 25 "./pex-common.h" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-common.c" 2
   ...
   const struct pex_funcs *funcs)
{
  ...
  obj = ((struct pex_obj *) xmalloc (sizeof (struct pex_obj)));
  obj->flags = flags;
  obj->pname = pname;
  ...
  obj->time = ((void*)0);
  obj->number_waited = 0;
  obj->input_file = ((void*)0);
  obj->read_output = ((void*)0);
  obj->read_err = ((void*)0);
  obj->remove_count = 0;
  obj->remove = ((void*)0);
  obj->funcs = funcs;
...
pex_add_remove (struct pex_obj *obj, const char *name, int allocated)
{
  ...
  ++obj->remove_count;
  obj->remove = ((char * *) xrealloc ((void *) (obj->remove), sizeof (char *) * (obj->remove_count)));
  if (allocated)
    add = (char *) name;
  else
    add = xstrdup (name);
                   ...
                   int *err)
{
      ...
      if ((obj->flags & 0x4) == 0)
 {
   ...
   outname_allocated = 0;
    ...
    {
      if (obj->funcs->pipe (obj, p, (flags & 0x20) != 0) < 0)
 {
   *err = (*__errno_location ());
   errmsg = "pipe";
   goto error_exit;
      ...
      if (out < 0)
 {
  ...
  if (errname != ((void*)0) && (flags & 0x40) != 0)
    {
      *err = 0;
  ...
  if (errname == ((void*)0))
    {
      if (flags & 0x40)
 {
   if (obj->funcs->pipe (obj, p, (flags & 0x80) != 0) < 0)
     {
       *err = (*__errno_location ());
       errmsg = "pipe";
       goto error_exit;
      ...
      if (errdes < 0)
 {
  ...
  ++obj->count;
  obj->children = ((pid_t *) xrealloc ((void *) (obj->children), sizeof (pid_t) * (obj->count)));
...
pex_input_file (struct pex_obj *obj, int flags, const char *in_name)
{
  ...
  if (obj->count != 0
      || (obj->next_input >= 0 && obj->next_input != 0)
      || obj->next_input_name)
    {
      (*__errno_location ()) = 22;
      return ((void*)0);
...
pex_input_pipe (struct pex_obj *obj, int binary)
{
  ...
  if ((obj->next_input >= 0 && obj->next_input != 0)
      || obj->next_input_name)
    goto usage_error;
    ...
    int *err)
{
  ...
  obj->status = ((int *) xrealloc ((void *) (obj->status), sizeof (int) * (obj->count)));
  if ((obj->flags & 0x1) != 0)
    obj->time = ((struct pex_time *) xrealloc ((void *) (obj->time), sizeof (struct pex_time) * (obj->count)));

  ret = 1;
  for (i = obj->number_waited; i < obj->count; ++i)
    {
      if (obj->funcs->wait (obj, obj->children[i], &obj->status[i],
       obj->time == ((void*)0) ? ((void*)0) : &obj->time[i],
       done, errmsg, err) < 0)
 ret = 0;
    }
  obj->number_waited = i;
...
pex_free (struct pex_obj *obj)
{
  ...
  if (obj->stderr_pipe >= 0 && obj->stderr_pipe != 0)
    obj->funcs->close (obj, obj->stderr_pipe);
  if (obj->read_output != ((void*)0))
    fclose (obj->read_output);
  if (obj->read_err != ((void*)0))
    fclose (obj->read_err);
