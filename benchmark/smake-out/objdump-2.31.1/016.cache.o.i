# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 45 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 46 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
...
# 47 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
# 1 "./bfd_stdint.h" 1
# 48 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
...
# 113 "/usr/include/bits/mman-linux.h" 3 4
# 1 "/usr/include/bits/mman-shared.h" 1 3 4
# 50 "/usr/include/bits/mman-shared.h" 3 4
...
# 114 "/usr/include/bits/mman-linux.h" 2 3 4
...
# 51 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c" 2
# 61 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
enum cache_flag {
  CACHE_NORMAL = 0,
  CACHE_NO_OPEN = 1,
  CACHE_NO_SEEK = 2,
...
bfd_cache_max_open (void)
{
  if (max_open_files == 0)
    {
      int max;
# 97 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
      struct rlimit rlim;

      if (getrlimit (RLIMIT_NOFILE, &rlim) == 0
   && rlim.rlim_cur != (rlim_t) 0xffffffffffffffffuLL)
 max = rlim.rlim_cur / 8;
      else
...
static bfd *bfd_last_cache = ((void*)0);
...
# 237 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
static FILE *
bfd_cache_lookup_worker (bfd *abfd, enum cache_flag flag)
{
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c", 241, __PRETTY_FUNCTION__);

  if (abfd->my_archive != ((void*)0)
      && !((abfd->my_archive)->is_thin_archive))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c", 245, __PRETTY_FUNCTION__);
      ...
      if (abfd != bfd_last_cache)
 {
  ...
  _bfd_error_handler (dgettext ("bfd", "reopening %pB: %s\n"),
...
{
  FILE *f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NO_OPEN));
  if (f == ((void*)0))
    return abfd->where;
...
{
  FILE *f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, whence != 1 ? CACHE_NO_SEEK : CACHE_NORMAL));
  if (f == ((void*)0))
    return -1;
  return _bfd_real_fseek (f, offset, whence);
}
# 302 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
static file_ptr
cache_bread_1 (FILE *f, void *buf, file_ptr nbytes)
{
  file_ptr nread;
# 320 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
...
cache_bread (struct bfd *abfd, void *buf, file_ptr nbytes)
{
  ...
  f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NORMAL));
  if (f == ((void*)0))
    return -1;
...
# 369 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
...
{
  file_ptr nwrite;
  FILE *f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NORMAL));
...
{
  int sts;
  FILE *f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NO_SEEK_ERROR));
...
static void *
cache_bmmap (struct bfd *abfd __attribute__ ((__unused__)),
      ...
      bfd_size_type *map_len __attribute__ ((__unused__)))
{
  ...
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c", 443, __PRETTY_FUNCTION__);
  ...
  else
    {
      ...
      f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NO_SEEK_ERROR));
      if (f == ((void*)0))
 return ret;
...
# 495 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
bfd_boolean
bfd_cache_init (bfd *abfd)
{
  do { if (!(abfd->iostream != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c",498); } while (0);
...
# 526 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
bfd_boolean
...
# 555 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
bfd_boolean
...
# 581 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
FILE *
bfd_open_file (bfd *abfd)
{
 ...
 return ((void*)0);
  ...
  switch (abfd->direction)
    ...
    case read_direction:
    case no_direction:
      abfd->iostream = _bfd_real_fopen (abfd->filename, "r");
      break;
    case both_direction:
      ...
      if (abfd->opened_once)
 {
   abfd->iostream = _bfd_real_fopen (abfd->filename, "r+");
   if (abfd->iostream == ((void*)0))
     abfd->iostream = _bfd_real_fopen (abfd->filename, "w+");
 }
      else
 {
# 629 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cache.c"
   struct stat s;
