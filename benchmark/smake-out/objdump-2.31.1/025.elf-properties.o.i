# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c" 2
...
_bfd_elf_get_property (bfd *abfd, unsigned int type, unsigned int datasz)
{
  ...
  if (((abfd)->xvec->flavour) != bfd_target_elf_flavour)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c", 41, __PRETTY_FUNCTION__);
    }


  lastp = &(((abfd) -> tdata.elf_obj_data) -> properties);
 ...
 break;
  ...
  if (p == ((void*)0))
    {
      _bfd_error_handler (dgettext ("bfd", "%pB: out of memory in _bfd_elf_get_property"),
     abfd);
      _exit (1);
    }
  memset (p, 0, sizeof (*p));
...
_bfd_elf_parse_gnu_properties (bfd *abfd, Elf_Internal_Note *note)
{
  ...
  unsigned int align_size = bed->s->elfclass == 2 ? 8 : 4;
...
bad_size:
      _bfd_error_handler
 (dgettext ("bfd", "warning: %pB: corrupt GNU_PROPERTY_TYPE (%ld) size: %#lx"),
 ...
 goto bad_size;
      ...
      type = ((*((abfd)->xvec->bfd_h_getx32)) (ptr));
      datasz = ((*((abfd)->xvec->bfd_h_getx32)) (ptr + 4));
      ptr += 8;

      if (datasz > (size_t) (ptr_end - ptr))
 {
   _bfd_error_handler
     (dgettext ("bfd", "warning: %pB: corrupt GNU_PROPERTY_TYPE (%ld) type (0x%x) datasz: 0x%x"),
      abfd, note->type, type, datasz);

   (((abfd) -> tdata.elf_obj_data) -> properties) = ((void*)0);
   return 0;
 }

      if (type >= 0xc0000000)
 {
   if (bed->elf_machine_code == 0)
     {
      ...
      else
 {
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "warning: %pB: corrupt stack size: 0x%x"),
       abfd, datasz);
    ...
    return 0;
       ...
       if (datasz == 8)
  prop->u.number = ((*((abfd)->xvec->bfd_h_getx64)) (ptr));
       else
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "warning: %pB: corrupt no copy on protected size: 0x%x"),
       abfd, datasz);
    ...
    return 0;
       ...
       prop = _bfd_elf_get_property (abfd, type, datasz);
       (((abfd) -> tdata.elf_obj_data) -> has_no_copy_on_protected) = 1;
       prop->pr_kind = property_number;
       goto next;
     ...
     default:
      ...
      _bfd_error_handler
 (dgettext ("bfd", "warning: %pB: unsupported GNU_PROPERTY_TYPE (%ld) type: 0x%x"),
  abfd, note->type, type);
     ...
     elf_property *aprop, elf_property *bprop)
{
  ...
  if (bed->merge_gnu_properties != ((void*)0)
      && pr_type >= 0xc0000000
      && pr_type < 0xe0000000)
      ...
      if (aprop != ((void*)0) && bprop != ((void*)0))
 {
   ...
   break;
    ...
    default:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c", 233, __PRETTY_FUNCTION__);
    }
        ...
        elf_property_list **listp)
{
      ...
      if (p->property.pr_kind == property_remove)
 {
  ...
  for (p = *listp; p != ((void*)0); p = p->next)
    if (elf_merge_gnu_properties (info, abfd, ((void*)0), &p->property))
      {
 if (p->property.pr_type == 2)
   (((abfd) -> tdata.elf_obj_data) -> has_no_copy_on_protected) = 1;
 ...
 if (pr->pr_kind != property_unknown)
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c", 301, __PRETTY_FUNCTION__);
...
{
  bfd *abfd, *first_pbfd = ((void*)0);
  elf_property_list *list;
  asection *sec;
  bfd_boolean has_properties = 0;
 ...
 if ((elf_machine_code
      == ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->elf_machine_code)
     && (elfclass
  == ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->s->elfclass)
     && bfd_get_section_by_name (abfd,
     ".note.gnu.property") != ((void*)0)
     )
   {
  ...
  for (abfd = info->input_bfds; abfd != ((void*)0); abfd = abfd->link.next)
    if (abfd != first_pbfd && (abfd->flags & 0x40) == 0)
      {
 elf_property_list *null_ptr = ((void*)0);
 elf_property_list **listp = &null_ptr;


 if (((abfd)->xvec->flavour) == bfd_target_elf_flavour)
   {
     list = (((abfd) -> tdata.elf_obj_data) -> properties);
  ...
  && (elf_machine_code
      == ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->elf_machine_code))
       listp = &(((abfd) -> tdata.elf_obj_data) -> properties);
   }
 else
   list = ((void*)0);
  ...
  if (first_pbfd != ((void*)0))
    {
      ...
      sec = bfd_get_section_by_name (first_pbfd,
         ".note.gnu.property");
      do { if (!(sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c",401); } while (0);
      ...
      if (info->stacksize > 0)
 {
   ...
   p = _bfd_elf_get_property (first_pbfd, 1,
         align_size);
   if (p->pr_kind == property_unknown)
     ...
     p->u.number = stacksize;
      ...
      else if ((((first_pbfd) -> tdata.elf_obj_data) -> properties) == ((void*)0))
 {
   ...
   return ((void*)0);
      ...
      descsz = __builtin_offsetof(Elf_External_Note, name[sizeof "GNU"]);
      descsz = (descsz + 3) & -(unsigned int) 4;
      size = descsz;
      for (list = (((first_pbfd) -> tdata.elf_obj_data) -> properties);
    list != ((void*)0);
    list = list->next)
 {
   ...
   size = (size + (align_size - 1)) & ~(align_size - 1);
      ...
      ((*((first_pbfd)->xvec->bfd_h_putx32)) (sizeof "GNU", &e_note->namesz));
      ((*((first_pbfd)->xvec->bfd_h_putx32)) (size - descsz, &e_note->descsz));
      ((*((first_pbfd)->xvec->bfd_h_putx32)) (5, &e_note->type));
    ...
    list = list->next)
 {
   ...
   ((*((first_pbfd)->xvec->bfd_h_putx32)) (list->property.pr_type, contents + size));

   ((*((first_pbfd)->xvec->bfd_h_putx32)) (list->property.pr_datasz, contents + size + 4));
  ...
  default:
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c", 473, __PRETTY_FUNCTION__);

  case 0:
    break;

  case 4:
    ((*((first_pbfd)->xvec->bfd_h_putx32)) (list->property.u.number, contents + size));

    break;

  case 8:
    ((*((first_pbfd)->xvec->bfd_h_putx64)) (list->property.u.number, contents + size));
    ...
    break;
     ...
     default:
       ...
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-properties.c", 492, __PRETTY_FUNCTION__);
     }
   ...
   size = (size + (align_size - 1)) & ~ (align_size - 1);
      ...
      if ((((first_pbfd) -> tdata.elf_obj_data) -> has_no_copy_on_protected))
