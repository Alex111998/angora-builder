# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c" 2
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c"
# 1 "./config.h" 1
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pexecute.c" 2
      ...
      if (pex != ((void*)0))
 {
   ...
   *errmsg_arg = ((void*)0);
   return -1;
      ...
      pex = pex_init (0x2, pname, temp_base);
      idx = 0;
    }
  else
    {
...
int
pwait (int pid, int *status, int flags __attribute__ ((__unused__)))
{

  --pid;

  if (pex == ((void*)0) || pid < 0 || pid >= idx)
    return -1;
 ...
 return -1;
  ...
  else
    {
      ...
      vector = ((int *) xmalloc (sizeof (int) * (idx)));
