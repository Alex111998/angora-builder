# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
# 1 "./libcoff.h" 1
# 30 "./libcoff.h"
# 1 "./coff-bfd.h" 1
# 27 "./coff-bfd.h"
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
struct bfd_hash_entry *
...
coff_link_add_symbols (bfd *abfd,
         struct bfd_link_info *info)
{
  unsigned int n_tmask = ((abfd)->tdata.coff_obj_data)->local_n_tmask;
  unsigned int n_btshft = ((abfd)->tdata.coff_obj_data)->local_n_btshft;
  unsigned int n_btmask = ((abfd)->tdata.coff_obj_data)->local_n_btmask;
  bfd_boolean keep_syms;
  ...
  symcount = (((abfd)->tdata.coff_obj_data)->raw_syment_count);
  ...
  keep_syms = (((abfd)->tdata.coff_obj_data)->keep_syms);
  ...
  if (sym_hash == ((void*)0))
    goto error_return;
  (((abfd)->tdata.coff_obj_data)->sym_hashes) = sym_hash;

  symesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_symesz);
  do { if (!(symesz == (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_auxesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",269); } while (0);
  esym = (bfd_byte *) (((abfd)->tdata.coff_obj_data)->external_syms);
  ...
  while (esym < esym_end)
    {
      ...
      ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_sym_in) (abfd,esym,&sym));

      classification = ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_classify_symbol) (abfd, &sym));
      if (classification != COFF_SYMBOL_LOCAL)
 {
   ...
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 308, __PRETTY_FUNCTION__);
  ...
  value -= section->vma;
   ...
   if (((sym).n_sclass == 127 || ((((abfd)->tdata.coff_obj_data)->pe) && (sym).n_sclass == 105)))
     flags = (1 << 7);
   ...
   if ((((abfd)->tdata.coff_obj_data)->pe) && (flags & (1 << 8)) != 0)
     {
       *sym_hash = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (name), (0), (copy), (0)));
       ...
       if (*sym_hash != ((void*)0))
  {
    if (((*sym_hash)->coff_link_hash_flags
      ...
      _bfd_error_handler
        (dgettext ("bfd", "warning: symbol `%s' is both section and non-section"),
         name);

    addit = 0;
  }
     }
# 381 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
   if ((((abfd)->tdata.coff_obj_data)->pe)
       && (classification == COFF_SYMBOL_GLOBAL
    || classification == COFF_SYMBOL_PE_SECTION)
       && ((struct coff_section_tdata *) (section)->used_by_bfd) != ((void*)0)
       && ((struct coff_section_tdata *) (section)->used_by_bfd)->comdat != ((void*)0)
       && (strncmp ((name), ("??_"), sizeof ("??_") - 1) == 0)
       && strcmp (name, ((struct coff_section_tdata *) (section)->used_by_bfd)->comdat->name) == 0)
     {
       if (*sym_hash == ((void*)0))
  *sym_hash = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (name), (0), (copy), (0)));
    ...
    && ((struct coff_section_tdata *) ((*sym_hash)->root.u.def.section)->used_by_bfd)->comdat != ((void*)0)
    && strcmp (((struct coff_section_tdata *) ((*sym_hash)->root.u.def.section)->used_by_bfd)->comdat->name,
        ((struct coff_section_tdata *) (section)->used_by_bfd)->comdat->name) == 0)
  addit = 0;
     }

   if (addit)
     {
       if (! (((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_link_add_one_symbol) (info, abfd, name, flags, section, value, (const char *) ((void*)0), copy, 0, (struct bfd_link_hash_entry **) sym_hash))))
  ...
  goto error_return;
   ...
   if (section == (&_bfd_std_section[0])
       && (*sym_hash)->root.type == bfd_link_hash_common
       && ((*sym_hash)->root.u.c.p->alignment_power
    > (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_default_section_alignment_power)))
     (*sym_hash)->root.u.c.p->alignment_power
       = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_default_section_alignment_power);

   if (((info->output_bfd)->xvec->flavour) == ((abfd)->xvec->flavour))
     {




       if (((*sym_hash)->symbol_class == 0
     && (*sym_hash)->type == 0)
    || sym.n_scnum != 0
    || (sym.n_value != 0
        && (*sym_hash)->root.type != bfd_link_hash_defined
        && (*sym_hash)->root.type != bfd_link_hash_defweak))
  {
    ...
    if (sym.n_type != 0)
     ...
     && !(((((*sym_hash)->type) & n_tmask) >> n_btshft) == (((sym.n_type) & n_tmask) >> n_btshft)
          && ((((*sym_hash)->type) & n_btmask) == 0
       || ((sym.n_type) & n_btmask) == 0)))
   _bfd_error_handler
   ...
   goto error_return;
      ...
      i < sym.n_numaux;
      i++, eaux += symesz, iaux++)
   ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (abfd,eaux,sym.n_type,sym.n_sclass,(int) i,sym.n_numaux,iaux));
   ...
   if (classification == COFF_SYMBOL_PE_SECTION
       && (*sym_hash)->numaux != 0)
     {
       ...
       do { if (!((*sym_hash)->numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",501); } while (0);
       if (section->size == 0)
  ...
  if (! ((info)->type == type_relocatable)
      ...
      && ((info->output_bfd)->xvec->flavour) == ((abfd)->xvec->flavour)
      ...
      if (stabstr != ((void*)0))
 {
  ...
  = ((struct coff_section_tdata *) (stab)->used_by_bfd);

       if (secdata == ((void*)0))
  {
    amt = sizeof (struct coff_section_tdata);
    stab->used_by_bfd = bfd_zalloc (abfd, amt);
    if (stab->used_by_bfd == ((void*)0))
      goto error_return;
    secdata = ((struct coff_section_tdata *) (stab)->used_by_bfd);
  }

       table = ((struct coff_link_hash_table *) ((info)->hash));
  ...
  (((abfd)->tdata.coff_obj_data)->keep_syms) = keep_syms;
        ...
        struct bfd_link_info *info)
{
  ...
  unsigned int linesz;
  bfd *sub;
  bfd_byte *external_relocs = ((void*)0);
  char strbuf[4];
  bfd_size_type amt;
  ...
  flaginfo.strtab = ((void*)0);
  flaginfo.section_info = ((void*)0);
  flaginfo.last_file_index = -1;
  flaginfo.last_bf_index = -1;
  flaginfo.internal_syms = ((void*)0);
  flaginfo.sec_ptrs = ((void*)0);
  flaginfo.sym_indices = ((void*)0);
  flaginfo.outsyms = ((void*)0);
  flaginfo.linenos = ((void*)0);
  flaginfo.contents = ((void*)0);
  flaginfo.external_relocs = ((void*)0);
  flaginfo.internal_relocs = ((void*)0);
  flaginfo.global_to_static = 0;
  debug_merge_allocated = 0;

  ((abfd)->tdata.coff_obj_data)->link_info = info;

  flaginfo.strtab = _bfd_stringtab_init ();
  if (flaginfo.strtab == ((void*)0))
    goto error_return;

  if (! (bfd_hash_table_init (&(&flaginfo.debug_merge)->root, _bfd_coff_debug_merge_hash_newfunc, sizeof (struct coff_debug_merge_hash_entry))))
    goto error_return;
  ...
  if (! abfd->output_has_begun)
    {
      if (! ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_compute_section_file_positions) (abfd)))
 goto error_return;
    }



  rel_filepos = (((abfd)->tdata.coff_obj_data)->relocbase);
      ...
      else
 {
   ...
   if ((((abfd)->tdata.coff_obj_data)->pe) && o->reloc_count >= 0xffff)
     rel_filepos += relsz;
 }
   ...
   && strlen (o->name) > (8))
 {
   ...
   if (_bfd_stringtab_add (flaginfo.strtab, o->name, 0, 0)
       == (bfd_size_type) -1)
     goto error_return;
  ...
  if (((info)->type == type_relocatable))
    {
      ...
      if (flaginfo.section_info == ((void*)0))
 goto error_return;
      for (i = 0; i <= abfd->section_count; i++)
 {
   flaginfo.section_info[i].relocs = ((void*)0);
   flaginfo.section_info[i].rel_hashes = ((void*)0);
 }
    }
      ...
      else
 {
   ...
   line_filepos += o->lineno_count * linesz;
      ...
      if (o->reloc_count != 0)
 {
# 757 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
   do { if (!(((info)->type == type_relocatable))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",757); } while (0);
   amt = o->reloc_count;
   ...
   if (flaginfo.section_info[o->target_index].relocs == ((void*)0)
       || flaginfo.section_info[o->target_index].rel_hashes == ((void*)0))
     goto error_return;
  ...
  (((abfd)->tdata.coff_obj_data)->sym_filepos) = line_filepos;
  ...
  for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
    {
      ...
      sz = (((sub)->xvec->flavour) == bfd_target_coff_flavour || ((sub)->xvec->flavour) == bfd_target_xcoff_flavour) ? (((sub)->tdata.coff_obj_data)->raw_syment_count) : 2;
      if (sz > max_sym_count)
 max_sym_count = sz;
    }
  ...
  amt = max_lineno_count * (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_linesz);
  ...
  if ((flaginfo.internal_syms == ((void*)0) && max_sym_count > 0)
      || (flaginfo.sec_ptrs == ((void*)0) && max_sym_count > 0)
      || (flaginfo.sym_indices == ((void*)0) && max_sym_count > 0)
      || flaginfo.outsyms == ((void*)0)
      || (flaginfo.linenos == ((void*)0) && max_lineno_count > 0)
      || (flaginfo.contents == ((void*)0) && max_contents_size > 0)
      || (flaginfo.external_relocs == ((void*)0) && max_reloc_count > 0)
  ...
  (((abfd)->tdata.coff_obj_data)->raw_syment_count) = 0;

  if (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_start_final_link)
    {
      if (! ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_start_final_link) (abfd, info)))
 goto error_return;
    }
 ...
 {
   if (p->type == bfd_indirect_link_order
       && (((p->u.indirect.section->owner)->xvec->flavour) == bfd_target_coff_flavour || ((p->u.indirect.section->owner)->xvec->flavour) == bfd_target_xcoff_flavour))
     {
       sub = p->u.indirect.section->owner;
       if (! ((((bfd_coff_backend_data *) (sub)->xvec->backend_data)->_bfd_coff_link_output_has_begun) (sub, & flaginfo)))
  {
      ...
      for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
 {
   ...
   if ((((sub)->xvec->flavour) == bfd_target_coff_flavour || ((sub)->xvec->flavour) == bfd_target_xcoff_flavour) || ! ((sub)->outsymbols))
     continue;
   for (i = 0; i < ((sub)->symcount); ++i)
     {
       asymbol *sym = ((sub)->outsymbols) [i];
       file_ptr pos;
       struct internal_syment isym;
       union internal_auxent iaux;
       bfd_size_type string_size = 0, indx;
       bfd_vma written = 0;
       bfd_boolean rewrite = 0, hash;
  ...
  continue;
   ...
   && (((sym)->section)->flags & 0x800000)
   && ! ((flaginfo.info)->type == type_relocatable))
         || flaginfo.info->discard == discard_l)
        && ((*((sub)->xvec->_bfd_is_local_label_name)) (sub, ((sym)->name)))))
  continue;

       pos = (((abfd)->tdata.coff_obj_data)->sym_filepos) + (((abfd)->tdata.coff_obj_data)->raw_syment_count)
          * symesz;
       if (bfd_seek (abfd, pos, 0) != 0)
  goto error_return;
       if (! coff_write_alien_symbol(abfd, sym, &isym, &iaux, &written,
         &string_size, ((void*)0), ((void*)0)))
  goto error_return;

       hash = !flaginfo.info->traditional_format;

       if (string_size >= 6 && isym.n_sclass == 103
    && ! isym._n._n_n._n_zeroes && isym.n_numaux)
  {
    ...
    if (indx == (bfd_size_type) -1)
      goto error_return;
    isym._n._n_n._n_offset = 4 + indx;
    ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (abfd, &isym, flaginfo.outsyms));
    if (bfd_seek (abfd, pos, 0) != 0
       ...
       if (string_size)
  {
    ...
    if (isym.n_sclass != 103)
      ...
      {
        do { if (!(isym.n_numaux == 1)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",948); } while (0);
        iaux.x_file.x_n.x_offset = 4 + indx;
        ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (abfd,&iaux,isym.n_type,103,0,1,flaginfo.outsyms + symesz));

        if (bfd_seek (abfd, pos + symesz, 0) != 0
       ...
       if (isym.n_sclass == 103)
  {
    if (flaginfo.last_file_index != -1)
      {
        flaginfo.last_file.n_value = (((abfd)->tdata.coff_obj_data)->raw_syment_count);
        ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (abfd, &flaginfo.last_file, flaginfo.outsyms));

        pos = (((abfd)->tdata.coff_obj_data)->sym_filepos) + flaginfo.last_file_index
           * symesz;
        rewrite = 1;
      }
    flaginfo.last_file_index = (((abfd)->tdata.coff_obj_data)->raw_syment_count);
    flaginfo.last_file = isym;
  }

       if (rewrite
    && (bfd_seek (abfd, pos, 0) != 0
  ...
  if (! ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_final_link_postscript) (abfd, & flaginfo)))
    goto error_return;



  (bfd_hash_table_free (&(&flaginfo.debug_merge)->root));
  debug_merge_allocated = 0;

  if (flaginfo.internal_syms != ((void*)0))
    {
      free (flaginfo.internal_syms);
      flaginfo.internal_syms = ((void*)0);
    }
  if (flaginfo.sec_ptrs != ((void*)0))
    {
      free (flaginfo.sec_ptrs);
      flaginfo.sec_ptrs = ((void*)0);
    }
  if (flaginfo.sym_indices != ((void*)0))
    {
      free (flaginfo.sym_indices);
      flaginfo.sym_indices = ((void*)0);
    }
  if (flaginfo.linenos != ((void*)0))
    {
      free (flaginfo.linenos);
      flaginfo.linenos = ((void*)0);
    }
  if (flaginfo.contents != ((void*)0))
    {
      free (flaginfo.contents);
      flaginfo.contents = ((void*)0);
    }
  if (flaginfo.external_relocs != ((void*)0))
    {
      free (flaginfo.external_relocs);
      flaginfo.external_relocs = ((void*)0);
    }
  if (flaginfo.internal_relocs != ((void*)0))
    {
  ...
  if (flaginfo.last_file_index != -1
      && (unsigned int) flaginfo.last_file.n_value != (((abfd)->tdata.coff_obj_data)->raw_syment_count))
    {
      file_ptr pos;
      ...
      pos = (((abfd)->tdata.coff_obj_data)->sym_filepos) + flaginfo.last_file_index * symesz;
      if (bfd_seek (abfd, pos, 0) != 0
   || bfd_bwrite (flaginfo.outsyms, symesz, abfd) != symesz)
 return 0;
    }
  ...
  if (info->task_link)
    {
      flaginfo.failed = 0;
      (bfd_link_hash_traverse (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (_bfd_coff_write_task_globals), (&flaginfo)));
 ...
 goto error_return;
  ...
  if (flaginfo.outsyms != ((void*)0))
    {
      free (flaginfo.outsyms);
      flaginfo.outsyms = ((void*)0);
    }

  if (((info)->type == type_relocatable) && max_output_reloc_count > 0)
    {
   ...
   for (; irel < irelend; irel++, rel_hash++, erel += relsz)
     {
       if (*rel_hash != ((void*)0))
  {
    do { if (!((*rel_hash)->indx >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",1099); } while (0);
    irel->r_symndx = (*rel_hash)->indx;
  }
       ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_reloc_out) (abfd, irel, erel));
     }

   if (bfd_seek (abfd, o->rel_filepos, 0) != 0)
     goto error_return;
   if ((((abfd)->tdata.coff_obj_data)->pe) && o->reloc_count >= 0xffff)
     {
       ...
       ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_reloc_out) (abfd, &incount, excount));
  ...
  if (flaginfo.section_info != ((void*)0))
    {
      ...
      for (i = 0; i < abfd->section_count; i++)
 {
   if (flaginfo.section_info[i].relocs != ((void*)0))
     free (flaginfo.section_info[i].relocs);
   if (flaginfo.section_info[i].rel_hashes != ((void*)0))
  ...
  if (((struct coff_link_hash_table *) ((info)->hash))->stab_info.stabstr != ((void*)0))
    {
      if (! _bfd_write_stab_strings (abfd, &((struct coff_link_hash_table *) ((info)->hash))->stab_info))
 return 0;
    }


  if ((((abfd)->tdata.coff_obj_data)->raw_syment_count) != 0 || long_section_names)
    {
      file_ptr pos;

      pos = (((abfd)->tdata.coff_obj_data)->sym_filepos) + (((abfd)->tdata.coff_obj_data)->raw_syment_count) * symesz;
      if (bfd_seek (abfd, pos, 0) != 0)
 return 0;


      ((*((abfd)->xvec->bfd_h_putx32)) (_bfd_stringtab_size (flaginfo.strtab) + 4, strbuf));
      ...
      if (bfd_bwrite (strbuf, (bfd_size_type) 4, abfd)
   != 4)
 return 0;
 ...
 return 0;
      ...
      (((abfd)->tdata.coff_obj_data)->strings_written) = 1;
    }
...
{
  if (((output_bfd)->tdata.coff_obj_data)->pe)
    {
      int val = strtoul (ptr, &ptr, 0);

      if (heap)
 ((output_bfd)->tdata.pe_obj_data)->pe_opthdr.SizeOfHeapReserve = val;
      else
 ((output_bfd)->tdata.pe_obj_data)->pe_opthdr.SizeOfStackReserve = val;

      if (ptr[0] == ',')
 {
   val = strtoul (ptr+1, &ptr, 0);
   if (heap)
     ((output_bfd)->tdata.pe_obj_data)->pe_opthdr.SizeOfHeapCommit = val;
   else
     ((output_bfd)->tdata.pe_obj_data)->pe_opthdr.SizeOfStackCommit = val;
 }
    }
  return ptr;
}
      ...
      bfd *abfd)
{
      ...
      if (s[0] != '-')
 {
   ...
   continue;
      ...
      if ((strncmp ((s), ("-attr"), sizeof ("-attr") - 1) == 0))
 {
   char *name;
   char *attribs;
   asection *asec;
  ...
  asec->flags |= 0x8;
      ...
      else if ((strncmp ((s), ("-heap"), sizeof ("-heap") - 1) == 0))
 s = dores_com (s + 5, output_bfd, 1);

      else if ((strncmp ((s), ("-stack"), sizeof ("-stack") - 1) == 0))
 s = dores_com (s + 6, output_bfd, 0);


      else if ((strncmp ((s), ("-aligncomm:"), sizeof ("-aligncomm:") - 1) == 0))
 {
...
mark_relocs (struct coff_final_link_info *flaginfo, bfd *input_bfd)
{
  ...
  for (a = input_bfd->sections; a != (asection *) ((void*)0); a = a->next)
    {
      ...
      if ((a->flags & 0x4) == 0 || a->reloc_count < 1
   || a->linker_mark == 0)
 continue;

      if (a->output_section == (&_bfd_std_section[2]))
 continue;
 ...
 if ((unsigned long) irel->r_symndx < (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
...
{
  unsigned int n_tmask = ((input_bfd)->tdata.coff_obj_data)->local_n_tmask;
  unsigned int n_btshft = ((input_bfd)->tdata.coff_obj_data)->local_n_btshft;
  ...
  strings = ((void*)0);
  syment_base = (((output_bfd)->tdata.coff_obj_data)->raw_syment_count);
  isymesz = (((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_symesz);
  osymesz = (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_symesz);
  linesz = (((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_linesz);
  do { if (!(linesz == (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_linesz))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",1448); } while (0);
  ...
  esym = (bfd_byte *) (((input_bfd)->tdata.coff_obj_data)->external_syms);
  esym_end = esym + (((input_bfd)->tdata.coff_obj_data)->raw_syment_count) * isymesz;
  ...
  if (( flaginfo->info->strip != strip_none
      ...
      && ((flaginfo->info)->type == type_relocatable))
    {
      ...
      memset (indexp, 0, (((input_bfd)->tdata.coff_obj_data)->raw_syment_count) * sizeof * indexp);
  ...
  while (esym < esym_end)
    {
      ...
      ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_in) (input_bfd,esym,isymp));
      ...
      classification = ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_classify_symbol) (input_bfd, &isym));
      switch (classification)
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 1506, __PRETTY_FUNCTION__);
 case COFF_SYMBOL_GLOBAL:
 case COFF_SYMBOL_PE_SECTION:
 case COFF_SYMBOL_LOCAL:
   *secpp = coff_section_from_bfd_index (input_bfd, isym.n_scnum);
   break;
 case COFF_SYMBOL_COMMON:
   *secpp = (&_bfd_std_section[0]);
   break;
 case COFF_SYMBOL_UNDEFINED:
   *secpp = (&_bfd_std_section[1]);
   break;
 }
      ...
      if (! skip)
 {
   switch (classification)
     {
     default:
       _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 1544, __PRETTY_FUNCTION__);
     case COFF_SYMBOL_GLOBAL:
     case COFF_SYMBOL_COMMON:
     case COFF_SYMBOL_PE_SECTION:
       ...
       global = 1;
       if (! (((unsigned long) (isym.n_type) & n_tmask) == ((unsigned long) (2) << n_btshft)))
  skip = 1;
       break;
  ...
  skip = 1;
   ...
   && isym.n_type == 0
   && isym.n_numaux > 0
   && ((*secpp)->output_section == (&_bfd_std_section[2])
       || (((*secpp)->output_section)->next == ((void*)0) ? (output_bfd)->section_last != ((*secpp)->output_section) : ((*secpp)->output_section)->next->prev != ((*secpp)->output_section))))
       ...
       || flaginfo->info->discard == discard_l))
 {
   ...
   if (! dont_skip_symbol
       && ((flaginfo->info->strip == strip_some
     && (bfd_hash_lookup (flaginfo->info->keep_hash, name, 0,
        0) == ((void*)0)))
     || (! global
         && flaginfo->info->discard == discard_l
   ...
   && isym.n_numaux == 1)
 {
   ...
   if (*name == '~' || *name == '.' || *name == '$'
       || (*name == ((input_bfd)->xvec->symbol_leading_char)
    && (name[1] == '~' || name[1] == '.' || name[1] == '$')))
     name = "";

   mh = ((struct coff_debug_merge_hash_entry *) bfd_hash_lookup (&(&flaginfo->debug_merge)->root, (name), (1), (1)));
   ...
   ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (input_bfd,(esym + isymesz),isym.n_type,isym.n_sclass,0,isym.n_numaux,&aux));
   ...
   islp = isymp + 2;
   esl = esym + 2 * isymesz;
   eslend = ((bfd_byte *) (((input_bfd)->tdata.coff_obj_data)->external_syms)
   ...
   while (esl < eslend)
     {
       ...
       ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_in) (input_bfd,esl,islp));
    ...
    && islp->n_sclass != 102)
  {
    ...
    ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (input_bfd,(esl + isymesz),islp->n_type,islp->n_sclass,0,islp->n_numaux,&eleaux));
    ...
    if (indx > 0
        && (indx
     < ((esym -
         (bfd_byte *) (((input_bfd)->tdata.coff_obj_data)->external_syms))
        / (long) isymesz)))
      {
   ...
   if (mt->elements == ((void*)0))
     bfd_release (input_bfd, mt);
   else
     {
       struct coff_debug_merge_type *mtl;

       for (mtl = mh->types; mtl != ((void*)0); mtl = mtl->next)
  {
   ...
   break;
    ...
    if (me == ((void*)0) && mel == ((void*)0))
      break;
  }

       if (mtl == ((void*)0) || (bfd_size_type) mtl->indx >= syment_base)
  {
      ...
      if (! skip)
 {
   ...
   if (isym._n._n_n._n_zeroes == 0
       && isym._n._n_n._n_offset != 0)
     {
       ...
       name = _bfd_coff_internal_syment_name (input_bfd, &isym, ((void*)0));
       if (name == ((void*)0))
  return 0;
  ...
  return 0;
   ...
   switch (isym.n_sclass)
     ...
     case 101:
       if ((((input_bfd)->tdata.coff_obj_data)->pe)
    && memcmp (isym._n._n_name, ".bf", sizeof ".bf") != 0
    && isym.n_scnum > 0)
  {
  ...
  if (! (((flaginfo->output_bfd)->tdata.coff_obj_data)->pe))
    isym.n_value += (*secpp)->output_section->vma;
       }
     break;

     case 103:
# 1885 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
       if (flaginfo->last_file_index != -1
    && flaginfo->last_file.n_value != (bfd_vma) output_index)
  {
    ...
    if ((bfd_size_type) flaginfo->last_file_index >= syment_base)
      {
        ...
        ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (output_bfd, &flaginfo->last_file, (flaginfo->outsyms + ((flaginfo->last_file_index - syment_base) * osymesz))));
    ...
    else
      {
        ...
        ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (output_bfd, &flaginfo->last_file, outsym));

        pos = (((output_bfd)->tdata.coff_obj_data)->sym_filepos);
        pos += flaginfo->last_file_index * osymesz;
        if (bfd_seek (output_bfd, pos, 0) != 0
   ...
   if (flaginfo->info->task_link && ((isym).n_sclass == 2 || ((isym).n_sclass == 127 || ((((input_bfd)->tdata.coff_obj_data)->pe) && (isym).n_sclass == 105))))
     isym.n_sclass = 3;


   ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (output_bfd, &isym, outsym));
   ...
   if (global)
     {
       ...
       indx = ((esym - (bfd_byte *) (((input_bfd)->tdata.coff_obj_data)->external_syms))
        / isymesz);
       h = (((input_bfd)->tdata.coff_obj_data)->sym_hashes)[indx];
       if (h == ((void*)0))
  {
      ...
      for (--add; add > 0; --add)
 {
  ...
  isymp = flaginfo->internal_syms;
  indexp = flaginfo->sym_indices;
  sym_hash = (((input_bfd)->tdata.coff_obj_data)->sym_hashes);
  outsym = flaginfo->outsyms;
   ...
   if (*indexp < 0)
     {
       ...
       do { if (!(isymp->n_numaux == 0 || h->numaux == 0 || h->numaux == isymp->n_numaux)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",2002); } while (0);
   ...
   for (i = 0; i < isymp->n_numaux && esym < esym_end; i++)
     {
       ...
       if (h != ((void*)0) && h->aux != ((void*)0) && (h->numaux > i))
  auxp = h->aux + i;
       else
  {
    ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (input_bfd,esym,isymp->n_type,isymp->n_sclass,i,isymp->n_numaux,&aux));

    auxp = &aux;
  }

       if (isymp->n_sclass == 103)
  {
    ...
    if (auxp->x_file.x_n.x_zeroes == 0
        && auxp->x_file.x_n.x_offset != 0)
      {
        ...
        do { if (!(auxp->x_file.x_n.x_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",2037); } while (0);
        ...
        if (strings == ((void*)0))
   {
     ...
     if (strings == ((void*)0))
       return 0;
        ...
        if ((bfd_size_type) auxp->x_file.x_n.x_offset >= (((input_bfd)->tdata.coff_obj_data)->strings_len))
   filename = dgettext ("bfd", "<corrupt>");
        else
   filename = strings + auxp->x_file.x_n.x_offset;
       ...
       hash, copy);
        if (indx == (bfd_size_type) -1)
   return 0;
        auxp->x_file.x_n.x_offset = 4 + indx;
      }
  }
       else if ((isymp->n_sclass != 3 || isymp->n_type != 0)
         && isymp->n_sclass != 105)
  {
    unsigned long indx;

    if ((((unsigned long) (isymp->n_type) & n_tmask) == ((unsigned long) (2) << n_btshft))
        || ((isymp->n_sclass) == 10 || (isymp->n_sclass) == 12 || (isymp->n_sclass) == 15)
        || isymp->n_sclass == 100
        || isymp->n_sclass == 101)
      {
        indx = auxp->x_sym.x_fcnary.x_fcn.x_endndx.l;
        if (indx > 0
     && indx < (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
   {
     ...
     && indx < (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
       ++indx;
     if (indx >= (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
       indx = output_index;
     else
    ...
    if (indx > 0 && indx < (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
      {
        long symindx;
        ...
        if (flaginfo->last_bf_index != -1)
   {
     ...
     + ((flaginfo->last_bf_index
        ...
        * osymesz));
         ...
         ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (output_bfd,&flaginfo->last_bf,isymp->n_type,isymp->n_sclass,0,isymp->n_numaux,auxout));
     ...
     else
       {
         ...
         ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (output_bfd,&flaginfo->last_bf,isymp->n_type,isymp->n_sclass,0,isymp->n_numaux,outsym));
        ...
        else
   {
     ...
     flaginfo->last_bf_index = (((outsym - flaginfo->outsyms)
       ...
       if (h == ((void*)0))
  {
    ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (output_bfd,auxp,isymp->n_type,isymp->n_sclass,i,isymp->n_numaux,outsym));
      ...
      for (o = input_bfd->sections; o != ((void*)0); o = o->next)
 {
   ...
   file_ptr pos;
   bfd_size_type amt;
# 2216 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
   if (o->lineno_count == 0
       || (o->output_section->flags & 0x100) == 0)
     continue;

   if (bfd_seek (input_bfd, o->line_filepos, 0) != 0
   ...
   for (; eline < elineend; eline += linesz)
     {
       ...
       ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_swap_lineno_in) (input_bfd,eline,&iline));

       if (iline.l_lnno != 0)
  iline.l_addr.l_paddr += offset;
       else if (iline.l_addr.l_symndx >= 0
         && ((unsigned long) iline.l_addr.l_symndx
      < (((input_bfd)->tdata.coff_obj_data)->raw_syment_count)))
  {
    long indx;
...
# 2269 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
        ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_in) (output_bfd,(flaginfo->outsyms + ((indx - syment_base) * osymesz)),&is));



        if (((((unsigned long) (is.n_type) & n_tmask) == ((unsigned long) (2) << n_btshft))
      || is.n_sclass == 100)
     && is.n_numaux >= 1)
   {
     void *auxptr;
     ...
     auxptr = (flaginfo->outsyms
        + ((indx - syment_base + 1)
           * osymesz));
     ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (output_bfd,auxptr,is.n_type,is.n_sclass,0,is.n_numaux,&ia));
     ...
     ia.x_sym.x_fcnary.x_fcn.x_lnnoptr =
       (o->output_section->line_filepos
        ...
        + eline - flaginfo->linenos);
     ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (output_bfd,&ia,is.n_type,is.n_sclass,0,is.n_numaux,auxptr));
    ...
    iline.l_addr.l_symndx = indx;
       ...
       if (!skipping)
  {
    ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_lineno_out) (output_bfd, &iline, oeline));
    oeline += linesz;
  }
     }
  ...
  if (outsym > flaginfo->outsyms)
    {
      ...
      pos = (((output_bfd)->tdata.coff_obj_data)->sym_filepos) + syment_base * osymesz;
      amt = outsym - flaginfo->outsyms;
      if (bfd_seek (output_bfd, pos, 0) != 0
   || bfd_bwrite (flaginfo->outsyms, amt, output_bfd) != amt)
 return 0;

      do { if (!(((((output_bfd)->tdata.coff_obj_data)->raw_syment_count) + (outsym - flaginfo->outsyms) / osymesz) == output_index)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c",2346); } while (0);



      (((output_bfd)->tdata.coff_obj_data)->raw_syment_count) = output_index;
    }


  adjust_symndx = ((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_adjust_symndx;
  for (o = input_bfd->sections; o != ((void*)0); o = o->next)
    {
      bfd_byte *contents;
      struct coff_section_tdata *secdata;
   ...
   || (o->size == 0 && (o->flags & 0x4) == 0))
 {
  ...
  (dgettext ("bfd", "%pB: relocs in section `%pA', but it has no contents"),
   input_bfd, o);
   ...
   continue;
      ...
      secdata = ((struct coff_section_tdata *) (o)->used_by_bfd);
      if (secdata != ((void*)0) && secdata->contents != ((void*)0))
      ...
      if ((o->flags & 0x4) != 0)
 {
   ...
   internal_relocs = (_bfd_coff_read_internal_relocs
        (input_bfd, o, 0, flaginfo->external_relocs,
         ((flaginfo->info)->type == type_relocatable),
         (((flaginfo->info)->type == type_relocatable)
   ...
   for (; irel < &internal_relocs[o->reloc_count]; irel++)
     {
       ...
       if (symndx < 0)
  continue;
       h = (((input_bfd)->tdata.coff_obj_data)->sym_hashes)[symndx];
       if (h == ((void*)0))
  continue;
  ...
  (*flaginfo->info->callbacks->einfo)
   ...
   if (! ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_relocate_section) (output_bfd, flaginfo->info, input_bfd, o, contents, internal_relocs, flaginfo->internal_syms, flaginfo->sec_ptrs)))
   ...
   if (((flaginfo->info)->type == type_relocatable))
     {
       bfd_vma offset;
       struct internal_reloc *irelend;
       struct coff_link_hash_entry **rel_hash;
       ...
       for (; irel < irelend; irel++, rel_hash++)
  {
   ...
   continue;
    ...
    h = (((input_bfd)->tdata.coff_obj_data)->sym_hashes)[irel->r_symndx];
    if (h != ((void*)0))
      {
        ...
        else
   {
     ...
     (*flaginfo->info->callbacks->unattached_reloc)
      ...
      if (secdata == ((void*)0) || secdata->stab_info == ((void*)0))
 {
      ...
      else
 {
   ...
   (output_bfd, &((struct coff_link_hash_table *) ((flaginfo->info)->hash))->stab_info,
...
_bfd_coff_write_global_sym (struct bfd_hash_entry *bh, void *data)
{
 ...
 return 1;
  ...
  switch (h->root.type)
    ...
    case bfd_link_hash_warning:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 2599, __PRETTY_FUNCTION__);
      return 0;
 ...
 if (! (((flaginfo->output_bfd)->tdata.coff_obj_data)->pe))
  ...
  if (strlen (h->root.root.string) <= 8)
    strncpy (isym._n._n_name, h->root.root.string, 8);
  else
    {
      bfd_boolean hash;
      bfd_size_type indx;
      ...
      if (indx == (bfd_size_type) -1)
 {
  ...
  if (flaginfo->global_to_static)
    {
      if (! ((isym).n_sclass == 2 || ((isym).n_sclass == 127 || ((((output_bfd)->tdata.coff_obj_data)->pe) && (isym).n_sclass == 105))))
 return 1;
  ...
  if (! (((flaginfo->info)->type == type_dll) || ((flaginfo->info)->type == type_pie))
      && ! ((flaginfo->info)->type == type_relocatable)
      && ((isym).n_sclass == 127 || ((((flaginfo->output_bfd)->tdata.coff_obj_data)->pe) && (isym).n_sclass == 105)))
    isym.n_sclass = 2;

  isym.n_numaux = h->numaux;

  ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (output_bfd, &isym, flaginfo->outsyms));

  symesz = (((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_symesz);

  pos = (((output_bfd)->tdata.coff_obj_data)->sym_filepos);
  pos += (((output_bfd)->tdata.coff_obj_data)->raw_syment_count) * symesz;
  if (bfd_seek (output_bfd, pos, 0) != 0
  ...
  h->indx = (((output_bfd)->tdata.coff_obj_data)->raw_syment_count);

  ++(((output_bfd)->tdata.coff_obj_data)->raw_syment_count);
       ...
       || h->root.type == bfd_link_hash_defweak))
 {
   ...
   if (sec != ((void*)0))
    ...
    && (! (((output_bfd)->tdata.coff_obj_data)->pe)
        || ((flaginfo->info)->type == type_relocatable)))
  _bfd_error_handler

    (dgettext ("bfd", "%pB: %pA: reloc overflow: %#x > 0xffff"),
  ...
  _bfd_error_handler
    ...
    (dgettext ("bfd", "%pB: warning: %pA: line number overflow: %#x > 0xffff"),
     output_bfd, sec, sec->lineno_count);
      ...
      ((((bfd_coff_backend_data *) (output_bfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (output_bfd,auxp,isym.n_type,isym.n_sclass,(int) i,isym.n_numaux,flaginfo->outsyms));
       ...
       struct bfd_link_order *link_order)
{
 ...
 case bfd_reloc_outofrange:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 2840, __PRETTY_FUNCTION__);
 case bfd_reloc_overflow:
   (*flaginfo->info->callbacks->reloc_overflow)
     (flaginfo->info, ((void*)0),
      (link_order->type == bfd_section_reloc_link_order
       ? ((link_order->u.reloc.p->u.section)->name)
  ...
  if (link_order->type == bfd_section_reloc_link_order)
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 2878, __PRETTY_FUNCTION__);
      *rel_hash_ptr = ((void*)0);
      irel->r_symndx = 0;
    }
  else
        ...
        asection **sections)
{
      ...
      if (symndx == -1)
 {
   ...
   sym = ((void*)0);
        ...
        || (unsigned long) symndx >= (((input_bfd)->tdata.coff_obj_data)->raw_syment_count))
 {
   _bfd_error_handler

     (dgettext ("bfd", "%pB: illegal symbol index %ld in relocs"), input_bfd, symndx);
   return 0;
 }
      else
 {
   ...
   sym = syms + symndx;
      ...
      if (sym != ((void*)0) && sym->n_scnum != 0)
 addend = - sym->n_value;
      else
 addend = 0;

      howto = ((((bfd_coff_backend_data *) (input_bfd)->xvec->backend_data)->_bfd_coff_rtype_to_howto) (input_bfd, input_section, rel, h, sym, &addend));
      ...
      else
 {
  ...
  {
# 3051 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c"
  ...
  val = 0;
     ...
     (*info->callbacks->undefined_symbol)
       (info, h->root.root.string, input_bfd, input_section,
        rel->r_vaddr - input_section->vma, 1);
 }
      ...
      if (info->base_file)
 {
   ...
   if (sym && ((output_bfd)->tdata.pe_obj_data)->in_reloc_p (output_bfd, howto))
     {
      ...
      + input_section->output_section->vma);
       if (((output_bfd)->tdata.coff_obj_data)->pe)
  addr -= ((output_bfd)->tdata.pe_obj_data)->pe_opthdr.ImageBase;
 ...
 {
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/cofflink.c", 3121, __PRETTY_FUNCTION__);
 case bfd_reloc_ok:
   break;
 case bfd_reloc_outofrange:
   _bfd_error_handler

     (dgettext ("bfd", "%pB: bad reloc address %#" "ll" "x" " in section `%pA'"),
