# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32.c" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32.c"
# 1 "./elfcode.h" 1
# 68 "./elfcode.h"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
...
# 173 "./elfcode.h"
bfd_boolean
bfd_elf32_swap_symbol_in (bfd *abfd,
      const void *psrc,
      const void *pshn,
      Elf_Internal_Sym *dst)
{
  const Elf32_External_Sym *src = (const Elf32_External_Sym *) psrc;
  const Elf_External_Sym_Shndx *shndx = (const Elf_External_Sym_Shndx *) pshn;
  int signed_vma = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->sign_extend_vma;

  dst->st_name = ((*((abfd)->xvec->bfd_h_getx32)) (src->st_name));
  if (signed_vma)
    dst->st_value = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->st_value));
  else
    dst->st_value = ((*((abfd)->xvec->bfd_h_getx32)) (src->st_value));
  dst->st_size = ((*((abfd)->xvec->bfd_h_getx32)) (src->st_size));
  dst->st_info = (*(const unsigned char *) (src->st_info) & 0xff);
  dst->st_other = (*(const unsigned char *) (src->st_other) & 0xff);
  dst->st_shndx = ((*((abfd)->xvec->bfd_h_getx16)) (src->st_shndx));
  if (dst->st_shndx == ((-0x1u) & 0xffff))
    {
      if (shndx == ((void*)0))
 return 0;
      dst->st_shndx = ((*((abfd)->xvec->bfd_h_getx32)) (shndx->est_shndx));
    }
  else if (dst->st_shndx >= ((-0x100u) & 0xffff))
    dst->st_shndx += (-0x100u) - ((-0x100u) & 0xffff);
...
void
bfd_elf32_swap_symbol_out (bfd *abfd,
       const Elf_Internal_Sym *src,
       void *cdst,
       void *shndx)
{
  unsigned int tmp;
  Elf32_External_Sym *dst = (Elf32_External_Sym *) cdst;
  ((*((abfd)->xvec->bfd_h_putx32)) (src->st_name, dst->st_name));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->st_value, dst->st_value));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->st_size, dst->st_size));
  ((void) (*((unsigned char *) (dst->st_info)) = (src->st_info) & 0xff));
  ((void) (*((unsigned char *) (dst->st_other)) = (src->st_other) & 0xff));
  tmp = src->st_shndx;
  if (tmp >= ((-0x100u) & 0xffff) && tmp < (-0x100u))
    {
      if (shndx == ((void*)0))
 _bfd_abort ("./elfcode.h", 224, __PRETTY_FUNCTION__);
      ((*((abfd)->xvec->bfd_h_putx32)) (tmp, shndx));
      tmp = (-0x1u) & 0xffff;
    }
  ((*((abfd)->xvec->bfd_h_putx16)) (tmp, dst->st_shndx));
}
...
elf_swap_ehdr_in (bfd *abfd,
    const Elf32_External_Ehdr *src,
    Elf_Internal_Ehdr *dst)
{
  int signed_vma = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->sign_extend_vma;
  memcpy (dst->e_ident, src->e_ident, 16);
  dst->e_type = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_type));
  dst->e_machine = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_machine));
  dst->e_version = ((*((abfd)->xvec->bfd_h_getx32)) (src->e_version));
  if (signed_vma)
    dst->e_entry = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->e_entry));
  else
    dst->e_entry = ((*((abfd)->xvec->bfd_h_getx32)) (src->e_entry));
  dst->e_phoff = ((*((abfd)->xvec->bfd_h_getx32)) (src->e_phoff));
  dst->e_shoff = ((*((abfd)->xvec->bfd_h_getx32)) (src->e_shoff));
  dst->e_flags = ((*((abfd)->xvec->bfd_h_getx32)) (src->e_flags));
  dst->e_ehsize = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_ehsize));
  dst->e_phentsize = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_phentsize));
  dst->e_phnum = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_phnum));
  dst->e_shentsize = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_shentsize));
  dst->e_shnum = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_shnum));
  dst->e_shstrndx = ((*((abfd)->xvec->bfd_h_getx16)) (src->e_shstrndx));
}
...
elf_swap_ehdr_out (bfd *abfd,
     ...
     Elf32_External_Ehdr *dst)
{
  unsigned int tmp;
  int signed_vma = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->sign_extend_vma;
  memcpy (dst->e_ident, src->e_ident, 16);

  ((*((abfd)->xvec->bfd_h_putx16)) (src->e_type, dst->e_type));
  ((*((abfd)->xvec->bfd_h_putx16)) (src->e_machine, dst->e_machine));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->e_version, dst->e_version));
  if (signed_vma)
    ((*((abfd)->xvec->bfd_h_putx32)) (src->e_entry, dst->e_entry));
  else
    ((*((abfd)->xvec->bfd_h_putx32)) (src->e_entry, dst->e_entry));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->e_phoff, dst->e_phoff));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->e_shoff, dst->e_shoff));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->e_flags, dst->e_flags));
  ((*((abfd)->xvec->bfd_h_putx16)) (src->e_ehsize, dst->e_ehsize));
  ((*((abfd)->xvec->bfd_h_putx16)) (src->e_phentsize, dst->e_phentsize));
  tmp = src->e_phnum;
  if (tmp > 0xffff)
    tmp = 0xffff;
  ((*((abfd)->xvec->bfd_h_putx16)) (tmp, dst->e_phnum));
  ((*((abfd)->xvec->bfd_h_putx16)) (src->e_shentsize, dst->e_shentsize));
  tmp = src->e_shnum;
  if (tmp >= ((-0x100u) & 0xffff))
    tmp = 0;
  ((*((abfd)->xvec->bfd_h_putx16)) (tmp, dst->e_shnum));
  tmp = src->e_shstrndx;
  if (tmp >= ((-0x100u) & 0xffff))
    tmp = (-0x1u) & 0xffff;
  ((*((abfd)->xvec->bfd_h_putx16)) (tmp, dst->e_shstrndx));
}
...
elf_swap_shdr_in (bfd *abfd,
    const Elf32_External_Shdr *src,
    Elf_Internal_Shdr *dst)
{
  int signed_vma = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->sign_extend_vma;

  dst->sh_name = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_name));
  dst->sh_type = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_type));
  dst->sh_flags = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_flags));
  if (signed_vma)
    dst->sh_addr = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->sh_addr));
  else
    dst->sh_addr = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_addr));
  dst->sh_offset = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_offset));
  dst->sh_size = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_size));
  dst->sh_link = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_link));
  dst->sh_info = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_info));
  dst->sh_addralign = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_addralign));
  dst->sh_entsize = ((*((abfd)->xvec->bfd_h_getx32)) (src->sh_entsize));
...
elf_swap_shdr_out (bfd *abfd,
     ...
     Elf32_External_Shdr *dst)
{

  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_name, dst->sh_name));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_type, dst->sh_type));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_flags, dst->sh_flags));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_addr, dst->sh_addr));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_offset, dst->sh_offset));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_size, dst->sh_size));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_link, dst->sh_link));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_info, dst->sh_info));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_addralign, dst->sh_addralign));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->sh_entsize, dst->sh_entsize));
}
...
void
bfd_elf32_swap_phdr_in (bfd *abfd,
    const Elf32_External_Phdr *src,
    Elf_Internal_Phdr *dst)
{
  int signed_vma = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->sign_extend_vma;

  dst->p_type = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_type));
  dst->p_flags = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_flags));
  dst->p_offset = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_offset));
  if (signed_vma)
    {
      dst->p_vaddr = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->p_vaddr));
      dst->p_paddr = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->p_paddr));
    }
  else
    {
      dst->p_vaddr = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_vaddr));
      dst->p_paddr = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_paddr));
    }
  dst->p_filesz = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_filesz));
  dst->p_memsz = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_memsz));
  dst->p_align = ((*((abfd)->xvec->bfd_h_getx32)) (src->p_align));
}

void
bfd_elf32_swap_phdr_out (bfd *abfd,
     const Elf_Internal_Phdr *src,
     Elf32_External_Phdr *dst)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_type, dst->p_type));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_offset, dst->p_offset));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_vaddr, dst->p_vaddr));
  ((*((abfd)->xvec->bfd_h_putx32)) (p_paddr, dst->p_paddr));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_filesz, dst->p_filesz));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_memsz, dst->p_memsz));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_flags, dst->p_flags));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->p_align, dst->p_align));
}


void
bfd_elf32_swap_reloc_in (bfd *abfd,
     const bfd_byte *s,
     Elf_Internal_Rela *dst)
{
  const Elf32_External_Rel *src = (const Elf32_External_Rel *) s;
  dst->r_offset = ((*((abfd)->xvec->bfd_h_getx32)) (src->r_offset));
  dst->r_info = ((*((abfd)->xvec->bfd_h_getx32)) (src->r_info));
  dst->r_addend = 0;
}

void
bfd_elf32_swap_reloca_in (bfd *abfd,
      const bfd_byte *s,
      Elf_Internal_Rela *dst)
{
  const Elf32_External_Rela *src = (const Elf32_External_Rela *) s;
  dst->r_offset = ((*((abfd)->xvec->bfd_h_getx32)) (src->r_offset));
  dst->r_info = ((*((abfd)->xvec->bfd_h_getx32)) (src->r_info));
  dst->r_addend = ((*((abfd)->xvec->bfd_h_getx_signed_32)) (src->r_addend));
}


void
bfd_elf32_swap_reloc_out (bfd *abfd,
      const Elf_Internal_Rela *src,
      bfd_byte *d)
{
  Elf32_External_Rel *dst = (Elf32_External_Rel *) d;
  ((*((abfd)->xvec->bfd_h_putx32)) (src->r_offset, dst->r_offset));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->r_info, dst->r_info));
}

void
bfd_elf32_swap_reloca_out (bfd *abfd,
       const Elf_Internal_Rela *src,
       bfd_byte *d)
{
  Elf32_External_Rela *dst = (Elf32_External_Rela *) d;
  ((*((abfd)->xvec->bfd_h_putx32)) (src->r_offset, dst->r_offset));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->r_info, dst->r_info));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->r_addend, dst->r_addend));
}

void
bfd_elf32_swap_dyn_in (bfd *abfd,
   const void *p,
   Elf_Internal_Dyn *dst)
{
  const Elf32_External_Dyn *src = (const Elf32_External_Dyn *) p;

  dst->d_tag = ((*((abfd)->xvec->bfd_h_getx32)) (src->d_tag));
  dst->d_un.d_val = ((*((abfd)->xvec->bfd_h_getx32)) (src->d_un.d_val));
}

void
bfd_elf32_swap_dyn_out (bfd *abfd,
    const Elf_Internal_Dyn *src,
    void *p)
{
  Elf32_External_Dyn *dst = (Elf32_External_Dyn *) p;

  ((*((abfd)->xvec->bfd_h_putx32)) (src->d_tag, dst->d_tag));
  ((*((abfd)->xvec->bfd_h_putx32)) (src->d_un.d_val, dst->d_un.d_val));
}
# 470 "./elfcode.h"
static inline bfd_boolean
elf_file_p (Elf32_External_Ehdr *x_ehdrp)
{
...
# 487 "./elfcode.h"
const bfd_target *
bfd_elf32_object_p (bfd *abfd)
{
  Elf32_External_Ehdr x_ehdr;
  Elf_Internal_Ehdr *i_ehdrp;
  Elf32_External_Shdr x_shdr;
 ...
 goto got_wrong_format_error;
  ...
  ebd = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data);
  if (ebd->s->arch_size != 32)
    goto got_wrong_format_error;
 ...
 goto got_no_match;
  ...
  if (ebd->elf_machine_code != 0
      && i_ehdrp->e_ident[7] != ebd->elf_osabi
      && ebd->elf_osabi != 0)
    goto got_wrong_format_error;
      ...
      if (i_ehdrp->e_shnum == 0)
 {
   ...
   if (i_ehdrp->e_shnum >= (-0x100u)
     ...
     goto got_wrong_format_error;
      ...
      if (i_ehdrp->e_shstrndx == ((-0x1u) & 0xffff))
 {
   ...
   if (i_ehdrp->e_shstrndx != i_shdr.sh_link)
     goto got_wrong_format_error;
      ...
      if (i_ehdrp->e_phnum == 0xffff && i_shdr.sh_info != 0)
 {
 ...
 (((abfd) -> tdata.elf_obj_data) -> elf_sect_ptr)[shindex] = shdrp++;
      ...
      for (shindex = 1; shindex < i_ehdrp->e_shnum; shindex++)
 {
  ...
  case 43:
  case 2:
    if (i_shdrp[shindex].sh_link == ((-0x100u) & 0xffff)
        || i_shdrp[shindex].sh_link == (((-0x100u) + 1) & 0xffff) )
      break;
  ...
  default:
   ...
   if (((i_shdrp[shindex].sh_flags & (1 << 6))
        || i_shdrp[shindex].sh_type == 4
        || i_shdrp[shindex].sh_type == 9)
  ...
  if (i_ehdrp->e_shnum != 0)
    {
      if (i_ehdrp->e_shstrndx >= (((abfd) -> tdata.elf_obj_data) -> num_elf_sections))
 {
   ...
   _bfd_error_handler
     (dgettext ("bfd", "warning: %pB has a corrupt string table index - ignoring"),
      abfd);
 }
    }
 ...
 {
   Elf32_External_Phdr x_phdr;

   if (bfd_bread (&x_phdr, sizeof x_phdr, abfd) != sizeof x_phdr)
     goto got_no_match;
   bfd_elf32_swap_phdr_in (abfd, &x_phdr, i_phdr);
 }
    }
...
void
bfd_elf32_write_relocs (bfd *abfd, asection *sec, void *data)
{
  ...
  rela_hdr = ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->rela.hdr;
  if (rela_hdr == ((void*)0))
    rela_hdr = ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->rel.hdr;
  ...
  if (rela_hdr->sh_type == 4)
    {
      swap_out = bfd_elf32_swap_reloca_out;
      extsize = sizeof (Elf32_External_Rela);
    }
  else if (rela_hdr->sh_type == 9)
    {
      swap_out = bfd_elf32_swap_reloc_out;
      extsize = sizeof (Elf32_External_Rel);
    }
  else


    _bfd_abort ("./elfcode.h", 914, __PRETTY_FUNCTION__);
  ...
  for (idx = 0; idx < sec->reloc_count; idx++, dst_rela += extsize)
    {
      ...
      if (sym == last_sym)
 n = last_sym_idx;
      else if (((sym->section) == (&_bfd_std_section[2])) && sym->value == 0)
 n = 0;
      else
 {
   last_sym = sym;
      ...
      if (ptr->howto == ((void*)0))
 {
   *failedp = 1;
   return;
      ...
      src_rela.r_info = (((n) << 8) + ((ptr->howto->type) & 0xff));
...
int
bfd_elf32_write_out_phdrs (bfd *abfd,
...
bfd_boolean
bfd_elf32_write_shdrs_and_ehdr (bfd *abfd)
{
  Elf32_External_Ehdr x_ehdr;
  Elf_Internal_Ehdr *i_ehdrp;
  Elf32_External_Shdr *x_shdrp;
  Elf_Internal_Shdr **i_shdrp;
  unsigned int count;
  bfd_size_type amt;
  ...
  if (i_ehdrp->e_phnum >= 0xffff)
    i_shdrp[0]->sh_info = i_ehdrp->e_phnum;
  if (i_ehdrp->e_shnum >= ((-0x100u) & 0xffff))
    i_shdrp[0]->sh_size = i_ehdrp->e_shnum;
  if (i_ehdrp->e_shstrndx >= ((-0x100u) & 0xffff))
...
bfd_boolean
bfd_elf32_checksum_contents (bfd *abfd,
         void (*process) (const void *, size_t, void *),
         void *arg)
{
  Elf_Internal_Ehdr *i_ehdrp = (((abfd) -> tdata.elf_obj_data) -> elf_header);
  Elf_Internal_Shdr **i_shdrp = (((abfd) -> tdata.elf_obj_data) -> elf_sect_ptr);
  Elf_Internal_Phdr *i_phdrp = ((abfd) -> tdata.elf_obj_data)->phdr;
  ...
  for (count = 0; count < num; count++)
    {
      Elf32_External_Phdr x_phdr;
      bfd_elf32_swap_phdr_out (abfd, &i_phdrp[count], &x_phdr);
...
long
bfd_elf32_slurp_symbol_table (bfd *abfd, asymbol **symptrs, bfd_boolean dynamic)
{
  Elf_Internal_Shdr *hdr;
...
# 1154 "./elfcode.h"
       ...
       && ((abfd) -> tdata.elf_obj_data)->verref == ((void*)0)))
 {
  ...
  ebd = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data);
  symcount = hdr->sh_size / sizeof (Elf32_External_Sym);
  if (symcount == 0)
    sym = symbase = ((void*)0);
  else
    {
   ...
   && verhdr->sh_size / sizeof (Elf_External_Versym) != symcount)
 {
   _bfd_error_handler
     ...
     (dgettext ("bfd", "%pB: version count (%" "ll" "d" ")" " does not match symbol count (%ld)"),
      ...
      for (isym = isymbuf + 1, sym = symbase; isym < isymend; isym++, sym++)
 {
   ...
   if (isym->st_shndx == 0)
     {
       sym->symbol.section = (&_bfd_std_section[1]);
     }
   else if (isym->st_shndx == (-0xFu))
     {
       sym->symbol.section = (&_bfd_std_section[2]);
     }
   else if (isym->st_shndx == (-0xEu))
     {
       sym->symbol.section = (&_bfd_std_section[0]);
       if ((abfd->flags & 0x10000) != 0)
  {
    ...
    if (xc == ((void*)0))
      {
        flagword flags = (0x1 | 0x1000 | 0x200000
     | 0x8000);
       ...
       if (sym->symbol.section == ((void*)0))
  {
   ...
   switch ((((unsigned int)(isym->st_info)) >> 4))
     {
     case 0:
       sym->symbol.flags |= (1 << 0);
       break;
     case 1:
       if (isym->st_shndx != 0 && isym->st_shndx != (-0xEu))
  sym->symbol.flags |= (1 << 1);
       break;
     case 2:
       sym->symbol.flags |= (1 << 7);
       break;
     case 10:
       sym->symbol.flags |= (1 << 23);
       break;
     }

   switch (((isym->st_info) & 0xF))
     {
     case 3:
       sym->symbol.flags |= (1 << 8) | (1 << 2);
       break;
     case 4:
       sym->symbol.flags |= (1 << 14) | (1 << 2);
       break;
     case 2:
       sym->symbol.flags |= (1 << 3);
       break;
     case 5:


       sym->symbol.flags |= (1 << 6);

     case 1:
       sym->symbol.flags |= (1 << 16);
       break;
     case 6:
       sym->symbol.flags |= (1 << 18);
       break;
     case 8:
       sym->symbol.flags |= (1 << 19);
       break;
     case 9:
       sym->symbol.flags |= (1 << 20);
       break;
     case 10:
       sym->symbol.flags |= (1 << 22);
       break;
     }

   if (dynamic)
     sym->symbol.flags |= (1 << 15);
...
elf_slurp_reloc_table_from_section (bfd *abfd,
        ...
        bfd_boolean dynamic)
{
  const struct elf_backend_data * const ebd = ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data);
  ...
  do { if (!(entsize == sizeof (Elf32_External_Rel) || entsize == sizeof (Elf32_External_Rela))) bfd_assert("./elfcode.h",1422); } while (0);


  if (dynamic)
    symcount = ((abfd)->dynsymcount);
  else
  ...
  for (i = 0, relent = relents;
       ...
       i++, relent++, native_relocs += entsize)
    {
      ...
      if (entsize == sizeof (Elf32_External_Rela))
 bfd_elf32_swap_reloca_in (abfd, native_relocs, &rela);
      else
 bfd_elf32_swap_reloc_in (abfd, native_relocs, &rela);





      if ((abfd->flags & (0x2 | 0x40)) == 0 || dynamic)
 ...
 relent->sym_ptr_ptr = (&_bfd_std_section[2])->symbol_ptr_ptr;
      else if (((rela.r_info) >> 8) > symcount)
 {
   _bfd_error_handler

     (dgettext ("bfd", "%pB(%pA): relocation %d has invalid symbol index %ld"),
      abfd, asect, i, (long) ((rela.r_info) >> 8));
...
bfd_boolean
bfd_elf32_slurp_reloc_table (bfd *abfd,
         asection *asect,
         asymbol **symbols,
         bfd_boolean dynamic)
{
 ...
 return 1;
      ...
      rel_hdr = d->rel.hdr;
      reloc_count = rel_hdr ? ((rel_hdr)->sh_entsize > 0 ? (rel_hdr)->sh_size / (rel_hdr)->sh_entsize : 0) : 0;
      rel_hdr2 = d->rela.hdr;
      reloc_count2 = rel_hdr2 ? ((rel_hdr2)->sh_entsize > 0 ? (rel_hdr2)->sh_size / (rel_hdr2)->sh_entsize : 0) : 0;


      if (asect->reloc_count != reloc_count + reloc_count2)
 return 0;
      do { if (!((rel_hdr && asect->rel_filepos == rel_hdr->sh_offset) || (rel_hdr2 && asect->rel_filepos == rel_hdr2->sh_offset))) bfd_assert("./elfcode.h",1529); } while (0);
 ...
 return 1;
      ...
      rel_hdr = &d->this_hdr;
      reloc_count = ((rel_hdr)->sh_entsize > 0 ? (rel_hdr)->sh_size / (rel_hdr)->sh_entsize : 0);
      rel_hdr2 = ((void*)0);
      reloc_count2 = 0;
    }
   ...
   int (*target_read_memory) (bfd_vma, bfd_byte *, bfd_size_type))
{
  ...
  switch (x_ehdr.e_ident[5])
    {
    case 2:
      if (! ((templ)->xvec->header_byteorder == BFD_ENDIAN_BIG))
 {
   bfd_set_error (bfd_error_wrong_format);
   return ((void*)0);
 }
      break;
    case 1:
      if (! ((templ)->xvec->header_byteorder == BFD_ENDIAN_LITTLE))
 {
   bfd_set_error (bfd_error_wrong_format);
   return ((void*)0);
 }
  ...
  if (i_ehdr.e_phentsize != sizeof (Elf32_External_Phdr) || i_ehdr.e_phnum == 0)
    {
      bfd_set_error (bfd_error_wrong_format);
      return ((void*)0);
    }

  x_phdrs = (Elf32_External_Phdr *)
  ...
  for (i = 0; i < i_ehdr.e_phnum; ++i)
    {
      bfd_elf32_swap_phdr_in (templ, &x_phdrs[i], &i_phdrs[i]);
      if (i_phdrs[i].p_type == 1)
 {
 ...
 {
   bfd_vma page_size = ((const struct elf_backend_data *) ((templ)->xvec)->backend_data)->minpagesize;
...
# 21 "./elfcore.h"
char*
bfd_elf32_core_file_failing_command (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->command;
}

int
bfd_elf32_core_file_failing_signal (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->signal;
}

int
bfd_elf32_core_file_pid (bfd *abfd)
{
  return ((abfd) -> tdata.elf_obj_data)->core->pid;
}

bfd_boolean
bfd_elf32_core_file_matches_executable_p (bfd *core_bfd, bfd *exec_bfd)
{
  char* corename;
...
# 78 "./elfcore.h"
const bfd_target *
bfd_elf32_core_file_p (bfd *abfd)
{
  Elf32_External_Ehdr x_ehdr;
  Elf_Internal_Ehdr *i_ehdrp;
      ...
      for (target_ptr = bfd_target_vector; *target_ptr != ((void*)0); target_ptr++)
 {
  ...
  if (i_ehdrp->e_phentsize != sizeof (Elf32_External_Phdr))
    goto wrong;



  if (i_ehdrp->e_shoff != 0 && i_ehdrp->e_phnum == 0xffff)
    {
      Elf32_External_Shdr x_shdr;
      Elf_Internal_Shdr i_shdr;
      file_ptr where = (file_ptr) i_ehdrp->e_shoff;
 ...
 goto fail;
      ...
      bfd_elf32_swap_phdr_in (abfd, &x_phdr, i_phdrp + phindex);
    }
  ...
  if (ebd->elf_backend_object_p != ((void*)0)
 ...
 if ((bfd_size_type) statbuf.st_size < high)
   {
     _bfd_error_handler
       ...
       (dgettext ("bfd", "warning: %pB is truncated: expected core file " "size >= %" "ll" "u" ", found: %" "ll" "u"),
...
const struct elf_size_info _bfd_elf32_size_info = {
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32.c" 2
