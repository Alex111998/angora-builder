# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c" 2
...
_bfd_elf_create_ifunc_sections (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (htab->irelifunc != ((void*)0) || htab->iplt != ((void*)0))
    return 1;
        ...
        bfd_boolean avoid_plt)
{
  ...
  bfd_boolean need_dynreloc = !use_plt || (((info)->type == type_dll) || ((info)->type == type_pie));
# 141 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c"
  if (!need_dynreloc
      && !(((info)->type == type_pde) && h->def_regular)
      && (h->dynindx != -1
   || info->export_dynamic)
 ...
 (dgettext ("bfd", "%F%P: dynamic STT_GNU_IFUNC symbol `%s' with pointer " "equality in `%pB' can not be used when making an " "executable; recompile with -fPIE and relink with -pie\n"),
 ...
 if (p->count)
  ...
  use_plt = 1;
  need_dynreloc = (((info)->type == type_dll) || ((info)->type == type_pie));
  break;
       }
   }
      if (keep)
  ...
  if (!h->ref_regular)
    {
      if (h->plt.refcount > 0
   || h->got.refcount > 0)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c", 200, __PRETTY_FUNCTION__);
      h->got = htab->init_got_offset;
      h->plt = htab->init_plt_offset;
      *head = ((void*)0);
      return 1;
...
keep:
 ...
 plt->size += plt_header_size;
  ...
  readonly_dynrelocs_against_ifunc = 0;
      ...
      do
 {
  ...
  readonly_dynrelocs_against_ifunc = 1;
     }
   count += p->count;
   p = p->next;
 }
...
# 314 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf-ifunc.c"
  if (use_plt
      && (h->got.refcount <= 0
