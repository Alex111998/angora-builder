# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
# 1 "./sysdep.h" 1
# 34 "./sysdep.h"
# 1 "./config.h" 1
# 35 "./sysdep.h" 2
...
# 44 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c" 2
# 1 "./disassemble.h" 1
# 22 "./disassemble.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c" 2
# 107 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
disassembler_ftype
disassembler (enum bfd_architecture a,
       bfd_boolean big __attribute__ ((__unused__)),
       ...
       bfd *abfd __attribute__ ((__unused__)))
{
  ...
  switch (a)
    {
# 202 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
    case bfd_arch_i386:
    case bfd_arch_iamcu:
    case bfd_arch_l1om:
    case bfd_arch_k1om:
      ...
      break;
# 530 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
    default:
      return 0;
    }
  return disassemble;
...
void
disassembler_usage (FILE *stream __attribute__ ((__unused__)))
{
# 561 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
  print_i386_disassembler_options (stream);
# 570 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
  return;
}
...
disassemble_init_for_target (struct disassemble_info * info)
{
  ...
  switch (info->arch)
    {
# 654 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/./disassemble.c"
    default:
      break;
    }
}
...
remove_whitespace_and_extra_commas (char *options)
{
  ...
  for (len = strlen (options); len > 0; len--)
    {
      if (!(_sch_istable[(options[len - 1]) & 0xff] & (unsigned short)(_sch_isspace)) && options[len - 1] != ',')
 break;
      options[len - 1] = '\0';
    }
  ...
  for (i = 0; options[i] != '\0'; i++)
    if ((_sch_istable[(options[i]) & 0xff] & (unsigned short)(_sch_isspace)))
      options[i] = ',';
 ...
 next[len - (size_t)(next - str)] = '\0';
  ...
  return (strlen (options) != 0) ? options : ((void*)0);
}
