# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c" 2
        ...
        unsigned int alignment, struct sec_merge_sec_info *secinfo)
{
  ...
  entry = sec_merge_hash_lookup (tab, str, alignment, 1);
  if (entry == ((void*)0))
    return ((void*)0);
  ...
  unsigned char *contents, file_ptr offset)
{
  ...
  for (; entry != ((void*)0) && entry->secinfo == secinfo; entry = entry->next)
    {
      ...
      if (len != 0)
 {
   do { if (!(len <= pad_len)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c",313); } while (0);
   if (contents)
     {
 ...
 goto err;
  ...
  if (off != 0)
    {
      do { if (!(off <= pad_len)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c",342); } while (0);
      if (contents)
   ...
   void **psecinfo)
{
  ...
  if ((abfd->flags & 0x40) != 0
    ...
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c", 372, __PRETTY_FUNCTION__);
 ...
 && ! ((secinfo->sec->flags ^ sec->flags) & (0x800000 | 0x1000000))
 ...
 goto error_return;
      ...
      sinfo->chain = ((void*)0);
      *psinfo = sinfo;
      sinfo->htab = sec_merge_init (sec->entsize, (sec->flags & 0x1000000));
       ...
       void (*remove_hook) (bfd *, asection *))
{
 ...
 for (secinfo = sinfo->chain; secinfo; secinfo = secinfo->next)
   if (secinfo->first_str == ((void*)0))
     secinfo->sec->flags |= 0x8000 | 0x200000;
    }
...
_bfd_write_merged_section (bfd *output_bfd, asection *sec, void *psecinfo)
{
  ...
  hdr = &((struct bfd_elf_section_data*)(sec->output_section)->used_by_bfd)->this_hdr;
  if (hdr->sh_offset == (file_ptr) -1)
    {


      contents = hdr->contents;
      if ((sec->output_section->flags & 0x8000000) == 0
   || contents == ((void*)0))
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c", 828, __PRETTY_FUNCTION__);
    }
  else
    {
      contents = ((void*)0);
...
bfd_vma
_bfd_merged_section_offset (bfd *output_bfd __attribute__ ((__unused__)), asection **psec,
       void *psecinfo, bfd_vma offset)
{
 ...
 _bfd_error_handler
   ...
   (dgettext ("bfd", "%pB: access beyond end of merged section (%" "ll" "d" ")"),
      ...
      else
 {
  ...
  entry = sec_merge_hash_lookup (secinfo->htab, (char *) p, 0, 0);
  if (!entry)
    {
      if (! secinfo->htab->strings)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c", 908, __PRETTY_FUNCTION__);


      if (*p)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c", 912, __PRETTY_FUNCTION__);
      if (! secinfo->htab->first)
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/merge.c", 914, __PRETTY_FUNCTION__);
