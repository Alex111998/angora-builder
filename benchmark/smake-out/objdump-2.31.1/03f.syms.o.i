# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
# 329 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 330 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 331 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 332 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
...
# 333 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
...
# 334 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
...
# 335 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c" 2
# 371 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
bfd_boolean
bfd_is_local_label (bfd *abfd, asymbol *sym)
{
  ...
  if ((sym->flags & ((1 << 1) | (1 << 7) | (1 << 14) | (1 << 8))) != 0)
    return 0;
  if (sym->name == ((void*)0))
    return 0;
  return ((*((abfd)->xvec->_bfd_is_local_label_name)) (abfd, sym->name));
}
# 449 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
bfd_boolean
bfd_set_symtab (bfd *abfd, asymbol **location, unsigned int symcount)
{
  if (abfd->format != bfd_object || ((abfd)->direction == read_direction || (abfd)->direction == both_direction))
    {
...
# 474 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
void
bfd_print_symbol_vandf (bfd *abfd, void *arg, asymbol *symbol)
{
  ...
  fprintf (file, " %c%c%c%c%c%c%c",
    ...
    (type & (1 << 11)) ? 'C' : ' ',
    (type & (1 << 12)) ? 'W' : ' ',
    (type & (1 << 13)) ? 'I' : (type & (1 << 22)) ? 'i' : ' ',
    (type & (1 << 2)) ? 'd' : (type & (1 << 15)) ? 'D' : ' ',
    ((type & (1 << 3))
     ? 'F'
     : ((type & (1 << 14))
        ? 'f'
...
# 538 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
asymbol *
...
# 562 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
...
# 620 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
static char
decode_section_type (const struct bfd_section *section)
{
  ...
  if (section->flags & 0x20)
    {
      if (section->flags & 0x8)
 return 'r';
      else if (section->flags & 0x400000)
 return 'g';
      else
 return 'd';
    }
 ...
 return 'b';
  ...
  if (section->flags & 0x2000)
    return 'N';
  if ((section->flags & 0x100) && (section->flags & 0x8))
    return 'n';

  return '?';
}
# 660 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
int
bfd_decode_symclass (asymbol *symbol)
{
 ...
 return 'U';
  ...
  if (((symbol->section) == (&_bfd_std_section[3])))
    return 'I';
  if (symbol->flags & (1 << 22))
    return 'i';
  if (symbol->flags & (1 << 7))
    {
 ...
 return 'W';
  ...
  if (symbol->flags & (1 << 23))
    return 'u';
  if (!(symbol->flags & ((1 << 1) | (1 << 0))))
    return '?';
 ...
 c = decode_section_type (symbol->section);
  ...
  return c;
# 721 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
}
# 736 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
bfd_boolean
bfd_is_undefined_symclass (int symclass)
{
  return symclass == 'U' || symclass == 'w' || symclass == 'v';
}
# 755 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
void
...
# 795 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
long
          ...
          unsigned int *sizep)
{
  ...
  if (dynamic)
    symcount = ((*((abfd)->xvec->_bfd_canonicalize_dynamic_symtab)) (abfd, syms));
  else
...
asymbol *
_bfd_generic_minisymbol_to_symbol (bfd *abfd __attribute__ ((__unused__)),
       bfd_boolean dynamic __attribute__ ((__unused__)),
       const void *minisym,
       asymbol *sym __attribute__ ((__unused__)))
{
  return *(asymbol **) minisym;
}
# 867 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
struct indexentry
{
  bfd_vma val;
  bfd_byte *stab;
         ...
         void **pinfo)
{
  ...
  *pfound = 0;
  *pfilename = ((char *) (abfd)->filename);
  *pfnname = ((void*)0);
  *pline = 0;
# 969 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/syms.c"
  info = (struct stab_find_info *) *pinfo;
  if (info != ((void*)0))
    {
      if (info->stabsec == ((void*)0) || info->strsec == ((void*)0))
 {
      ...
      if (info->stabsec == ((void*)0) || info->strsec == ((void*)0))
 {
   ...
   : info->strsec->size);
      ...
      if (info->stabs == ((void*)0) || info->strs == ((void*)0))
 return 0;
      ...
      if (reloc_count > 0)
 {
   ...
   for (pr = reloc_vector; *pr != ((void*)0); pr++)
     {
       arelent *r;
       unsigned long val;
       asymbol *sym;
  ...
  {
    _bfd_error_handler
      (dgettext ("bfd", "unsupported .stab relocation"));
    bfd_set_error (bfd_error_invalid_operation);
    if (reloc_vector != ((void*)0))
      free (reloc_vector);
    return 0;
       ...
       val = ((*((abfd)->xvec->bfd_getx32)) (info->stabs + r->address * bfd_octets_per_byte (abfd)));

       val &= r->howto->src_mask;
       sym = *r->sym_ptr_ptr;
       val += sym->value + sym->section->vma + r->addend;
       ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) val),(info->stabs + r->address * bfd_octets_per_byte (abfd))));
 ...
 free (reloc_vector);
      ...
      nul_fun = ((void*)0);
      for (stab = info->stabs; stab < info->stabs + stabsize; stab += (12))
 {
   if (stab[(4)] == (bfd_byte) N_SO)
     {
  ...
  ++info->indextablesize;
       ...
       if (((*((abfd)->xvec->bfd_getx32)) (stab + (0))) == 0)
  nul_fun = ((void*)0);
       else
  {
    nul_fun = stab;
    ...
    if (stab + (12) + (4) < info->stabs + stabsize
        && *(stab + (12) + (4)) == (bfd_byte) N_SO)
      stab += (12);
  }
     }
   else if (stab[(4)] == (bfd_byte) N_FUN
     && ((*((abfd)->xvec->bfd_getx32)) (stab + (0))) != 0)
     {
       nul_fun = ((void*)0);
       ++info->indextablesize;
     }
    ...
    stab += (12))
 {
  ...
  break;
       str += stroff;
       stroff = ((*((abfd)->xvec->bfd_getx32)) (stab + (8)));
       break;
     ...
     case N_SO:
       ...
       if (nul_fun != ((void*)0))
  {
    info->indextable[i].val = ((*((abfd)->xvec->bfd_getx32)) (nul_fun + (8)));
    info->indextable[i].stab = nul_fun;
    info->indextable[i].str = nul_str;
    info->indextable[i].directory_name = directory_name;
    info->indextable[i].file_name = file_name;
    info->indextable[i].function_name = ((void*)0);
    ++i;
  }

       directory_name = ((void*)0);
       file_name = (char *) str + ((*((abfd)->xvec->bfd_getx32)) (stab + (0)));
  ...
  file_name = ((void*)0);
     ...
     case N_FUN:
       ...
       function_name = (char *) str + ((*((abfd)->xvec->bfd_getx32)) (stab + (0)));
  ...
  function_name = ((void*)0);
       ...
       nul_fun = ((void*)0);
       info->indextable[i].val = ((*((abfd)->xvec->bfd_getx32)) (stab + (8)));
      ...
      if (nul_fun != ((void*)0))
 {
   ...
   ++i;
      ...
      info->indextable[i].str = str;
      info->indextable[i].directory_name = ((void*)0);
      info->indextable[i].file_name = ((void*)0);
      info->indextable[i].function_name = ((void*)0);
      ++i;
  ...
  offset += ((void) abfd, (section)->vma);


  if (info->cached_indexentry != ((void*)0)
 ...
 return 1;
  ...
  saw_line = 0;
  saw_func = 0;
  for (; stab < (indexentry+1)->stab; stab += (12))
    {
      bfd_boolean done;
      bfd_vma val;
 ...
 case N_SOL:
   ...
   val = ((*((abfd)->xvec->bfd_getx32)) (stab + (8)));
   if (val <= offset)
     {
       file_name = (char *) str + ((*((abfd)->xvec->bfd_getx32)) (stab + (0)));
       if (file_name >= (char *) info->strs + strsize || file_name < (char *) str)
 ...
 case N_BSLINE:
   ...
   if (!saw_line || val <= offset)
     {
       *pline = ((*((abfd)->xvec->bfd_getx16)) (stab + (6)));
  ...
  *pfound = 1;
  ...
  if (file_name == ((void*)0) || (((((file_name)[0]) == '/') || ((((file_name)[0]) == '\\') && (0))) || ((file_name)[0] && ((file_name)[1] == ':') && (0)))
      || directory_name == ((void*)0))
    *pfilename = file_name;
  else
    {
   ...
   || filename_cmp (info->filename + dirlen, file_name) != 0)
 {
  ...
  if (indexentry->function_name != ((void*)0))
    {
      char *s;
...
long
_bfd_nosymbols_canonicalize_symtab (bfd *abfd __attribute__ ((__unused__)),
        asymbol **location __attribute__ ((__unused__)))
{
  return 0;
}

void
_bfd_nosymbols_print_symbol (bfd *abfd __attribute__ ((__unused__)),
...
void
_bfd_nosymbols_get_symbol_info (bfd *abfd __attribute__ ((__unused__)),
    asymbol *sym __attribute__ ((__unused__)),
    symbol_info *ret __attribute__ ((__unused__)))
{
}
...
_bfd_nosymbols_get_symbol_version_string (bfd *abfd,
       asymbol *symbol __attribute__ ((__unused__)),
       bfd_boolean *hidden __attribute__ ((__unused__)))
{
  return (const char *) _bfd_ptr_bfd_null_error (abfd);
}

bfd_boolean
_bfd_nosymbols_bfd_is_local_label_name (bfd *abfd __attribute__ ((__unused__)),
...
alent *
_bfd_nosymbols_get_lineno (bfd *abfd, asymbol *sym __attribute__ ((__unused__)))
{
...
_bfd_nosymbols_find_nearest_line
    (bfd *abfd,
     ...
     const char **filename_ptr __attribute__ ((__unused__)),
     const char **functionname_ptr __attribute__ ((__unused__)),
     unsigned int *line_ptr __attribute__ ((__unused__)),
     unsigned int *discriminator_ptr __attribute__ ((__unused__)))
{
...
_bfd_nosymbols_read_minisymbols (bfd *abfd,
     bfd_boolean dynamic __attribute__ ((__unused__)),
     void **minisymsp __attribute__ ((__unused__)),
     unsigned int *sizep __attribute__ ((__unused__)))
{
...
_bfd_nosymbols_minisymbol_to_symbol (bfd *abfd,
         bfd_boolean dynamic __attribute__ ((__unused__)),
         const void *minisym __attribute__ ((__unused__)),
         asymbol *sym __attribute__ ((__unused__)))
{
  return (asymbol *) _bfd_ptr_bfd_null_error (abfd);
}
...
_bfd_nodynamic_get_synthetic_symtab (bfd *abfd,
         ...
         long dynsymcount __attribute__ ((__unused__)),
         asymbol **dynsyms __attribute__ ((__unused__)),
         asymbol **ret __attribute__ ((__unused__)))
{
  return _bfd_long_bfd_n1_error (abfd);
}
