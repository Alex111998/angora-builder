# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
# 1 "./plugin.h" 1
# 24 "./plugin.h"
...
plugin_data_struct;
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
...
# 39 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c" 2
# 113 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c"
static enum ld_plugin_status
message (int level __attribute__ ((__unused__)),
  const char * format, ...)
{
  va_list args;
...
bfd_plugin_open_input (bfd *ibfd, struct ld_plugin_input_file *file)
{
  ...
  && !((iobfd->my_archive)->is_thin_archive))
 ...
 return 0;
  ...
  else
    {
      ...
      file->filesize = (((struct areltdata *)((ibfd)->arelt_data))->parsed_size);
    }
  return 1;
}
...
try_load_plugin (const char *pname, bfd *abfd, int *has_plugin_p)
{
  ...
  *has_plugin_p = 0;
  ...
  plugin_handle = dlopen (pname, 0x00002);
  if (!plugin_handle)
    {
...
bfd_link_plugin_object_p (bfd *abfd)
{
  if (ld_plugin_object_p)
    return ld_plugin_object_p (abfd) != ((void*)0);
  return 0;
}
...
load_plugin (bfd *abfd)
{
  ...
  if (plugin_program_name == ((void*)0))
    return found;

  plugin_dir = concat ("/usr/local/bin", "/../lib/bfd-plugins", ((void*)0));
  ...
  while ((ent = readdir (d)))
    {
      ...
      full_name = concat (p, "/", ent->d_name, ((void*)0));
      if (stat(full_name, &s) == 0 && ((((s.st_mode)) & 0170000) == (0100000)))
...
bfd_plugin_object_p (bfd *abfd)
{
  ...
  return abfd->plugin_format == bfd_plugin_yes ? abfd->xvec : ((void*)0);
}
...
static bfd_boolean
bfd_plugin_bfd_copy_private_bfd_data (bfd *ibfd __attribute__ ((__unused__)),
          bfd *obfd __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",402); } while (0);
  return 1;
}
...
static bfd_boolean
bfd_plugin_bfd_copy_private_section_data (bfd *ibfd __attribute__ ((__unused__)),
       asection *isection __attribute__ ((__unused__)),
       bfd *obfd __attribute__ ((__unused__)),
       asection *osection __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",415); } while (0);
  return 1;
}
...
static bfd_boolean
bfd_plugin_bfd_copy_private_symbol_data (bfd *ibfd __attribute__ ((__unused__)),
      asymbol *isymbol __attribute__ ((__unused__)),
      bfd *obfd __attribute__ ((__unused__)),
      asymbol *osymbol __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",428); } while (0);
  return 1;
}

static bfd_boolean
bfd_plugin_bfd_print_private_bfd_data (bfd *abfd __attribute__ ((__unused__)), void * ptr __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",435); } while (0);
  return 1;
}

static char *
bfd_plugin_core_file_failing_command (bfd *abfd __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",442); } while (0);
  return ((void*)0);
}

static int
bfd_plugin_core_file_failing_signal (bfd *abfd __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",449); } while (0);
  return 0;
}

static int
bfd_plugin_core_file_pid (bfd *abfd __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",456); } while (0);
  return 0;
}
...
bfd_plugin_get_symtab_upper_bound (bfd *abfd)
{
  ...
  do { if (!(nsyms >= 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",466); } while (0);
...
convert_flags (const struct ld_plugin_symbol *sym)
{
 switch (sym->def)
   ...
   default:
     do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",486); } while (0);
     return 0;
   }
}
    ...
    asymbol **alocation)
{
  ...
  fake_common_section.flags = 0x1000;

  for (i = 0; i < nsyms; i++)
    {
      asymbol *s = bfd_alloc (abfd, sizeof (asymbol));

      do { if (!(s)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",509); } while (0);
      alocation[i] = s;
 ...
 case LDPK_WEAKDEF:
   ...
   break;
 default:
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",530); } while (0);
 }
...
static void
bfd_plugin_print_symbol (bfd *abfd __attribute__ ((__unused__)),
    void * afile __attribute__ ((__unused__)),
    asymbol *symbol __attribute__ ((__unused__)),
    bfd_print_symbol_type how __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",545); } while (0);
}

static void
bfd_plugin_get_symbol_info (bfd *abfd __attribute__ ((__unused__)),
       asymbol *symbol,
       symbol_info *ret)
{
...
static int
bfd_plugin_sizeof_headers (bfd *a __attribute__ ((__unused__)),
      struct bfd_link_info *info __attribute__ ((__unused__)))
{
  do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/plugin.c",572); } while (0);
  return 0;
}
...
const bfd_target plugin_vec =
{
  ...
  bfd_plugin_bfd_copy_private_bfd_data, _bfd_bool_bfd_link_true, _bfd_generic_init_private_section_data, bfd_plugin_bfd_copy_private_section_data, bfd_plugin_bfd_copy_private_symbol_data, _bfd_bool_bfd_bfd_true, _bfd_bool_bfd_uint_true, bfd_plugin_bfd_print_private_bfd_data,
  bfd_plugin_core_file_failing_command, bfd_plugin_core_file_failing_signal, generic_core_file_matches_executable_p, bfd_plugin_core_file_pid,
