# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2
# 55 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 56 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 57 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 58 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2
...
# 59 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2
...
# 60 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c" 2



static const char digs[] = "0123456789ABCDEF";
# 75 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c"
...
verilog_write_address (bfd *abfd, bfd_vma address)
{
  ...
  *dst++ = '@';
  dst[1] = digs[((address >> 24)) & 0xf]; dst[0] = digs[(((address >> 24)) >> 4) & 0xf];;
  dst += 2;
  dst[1] = digs[((address >> 16)) & 0xf]; dst[0] = digs[(((address >> 16)) >> 4) & 0xf];;
  dst += 2;
  dst[1] = digs[((address >> 8)) & 0xf]; dst[0] = digs[(((address >> 8)) >> 4) & 0xf];;
  dst += 2;
  dst[1] = digs[((address)) & 0xf]; dst[0] = digs[(((address)) >> 4) & 0xf];;
  dst += 2;
  *dst++ = '\r';
  *dst++ = '\n';
  wrlen = dst - buffer;
        ...
        const bfd_byte *end)
{
  ...
  for (src = data; src < end; src++)
    {
      dst[1] = digs[(*src) & 0xf]; dst[0] = digs[((*src) >> 4) & 0xf];;
      dst += 2;
      *dst++ = ' ';
    }
  *dst++ = '\r';
...
verilog_write_section (bfd *abfd,
         tdata_type *tdata __attribute__ ((__unused__)),
...
verilog_write_object_contents (bfd *abfd)
{
  ...
  while (list != (verilog_data_list_type *) ((void*)0))
    {
...
# 319 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/verilog.c"
const bfd_target verilog_vec =
{
  ...
  verilog_set_arch_mach, verilog_set_section_contents,
