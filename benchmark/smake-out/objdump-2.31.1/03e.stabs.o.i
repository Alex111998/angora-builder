# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c" 2
# 60 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c"
...
# 107 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c"
    ...
    bfd_size_type *pstring_offset)
{
  ...
  if (stabsec->size % 12 != 0)


    return 1;

  if ((stabstrsec->flags & 0x4) != 0)


    return 1;

  if (((stabsec->output_section) == (&_bfd_std_section[2]))
      || ((stabstrsec->output_section) == (&_bfd_std_section[2])))
 ...
 goto error_return;
      ...
      (void) _bfd_stringtab_add (sinfo->strings, "", 1, 1);
      ...
      if (type == 0)
 {
   ...
   stroff = next_stroff;
   next_stroff += ((*((abfd)->xvec->bfd_getx32)) (sym + 8));
   if (pstring_offset)
   ...
   first = 0;
      ...
      symstroff = stroff + ((*((abfd)->xvec->bfd_getx32)) (sym + 0));
      if (symstroff >= stabstrsec->size)
 {
   _bfd_error_handler

     (dgettext ("bfd", "%pB(%pA+%#lx): stabs entry has invalid string index"),
      abfd, stabsec, (long) (sym - stabbuf));
   bfd_set_error (bfd_error_bad_value);
   goto error_return;
 }
      string = (char *) stabstrbuf + symstroff;
      *pstridx = _bfd_stringtab_add (sinfo->strings, string, 1, 1);
      ...
      if (type == (int) N_BINCL)
 {
       ...
       else if (nest == 0)
  {
    ...
    str = ((char *) stabstrbuf
    + stroff
    + ((*((abfd)->xvec->bfd_getx32)) (incl_sym + 0)));
    for (; *str != '\0'; str++)
      {
   ...
   do { if (!(num_chars == (bfd_vma) (symb_rover - symb))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",360); } while (0);



   incl_entry = (struct stab_link_includes_entry * )
     bfd_hash_lookup (&sinfo->includes, string, 1, 1);
  ...
  goto error_return;
   ...
   else
     {
       ...
       nest = 0;
       for (incl_sym = sym + 12, incl_pstridx = pstridx + 1;
     incl_sym < symend;
     incl_sym += 12, ++incl_pstridx)
  {
    int incl_type;
  ...
  free (stabstrbuf);
  stabstrbuf = ((void*)0);
# 461 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c"
  stabsec->size = (count - skip) * 12;
  if (stabsec->size == 0)
    stabsec->flags |= 0x8000 | 0x200000;
  stabstrsec->flags |= 0x8000 | 0x200000;
   ...
   *pskips = offset;
   if (*pstridx == (bfd_size_type) -1)
     offset += 12;
      ...
      do { if (!(offset != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",491); } while (0);
    }
       ...
       void * cookie)
{
  ...
  if ((stabsec->output_section != ((void*)0)
       && ((stabsec->output_section) == (&_bfd_std_section[2]))))
 ...
 continue;
      ...
      if (type == (int) N_FUN)
 {
   int strx = ((*((abfd)->xvec->bfd_getx32)) (sym + 0));
       ...
       if (deleting)
  {
   ...
   deleting = 0;
   if ((*reloc_symbol_deleted_p) (sym + 8 - stabbuf, cookie))
     deleting = 1;
 }
   ...
   *pskips = offset;
   if (*pstridx == (bfd_size_type) -1)
     offset += 12;
      ...
      do { if (!(offset != 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",645); } while (0);
    }
     ...
     bfd_byte *contents)
{
  ...
  for (e = secinfo->excls; e != ((void*)0); e = e->next)
    {
      ...
      do { if (!(e->offset < stabsec->rawsize)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",683); } while (0);
      excl_sym = contents + e->offset;
      ((*((output_bfd)->xvec->bfd_putx32)) ((e->val),(excl_sym + 8)));
      excl_sym[4] = e->type;
    }
      ...
      if (*pstridx != (bfd_size_type) -1)
 {
   if (tosym != sym)
     memcpy (tosym, sym, 12);
   ((*((output_bfd)->xvec->bfd_putx32)) ((*pstridx),(tosym + 0)));
   ...
   if (sym[4] == 0)
     {
       ...
       do { if (!(sym == contents)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",709); } while (0);
       ((*((output_bfd)->xvec->bfd_putx32)) ((_bfd_stringtab_size (sinfo->strings)),(tosym + 8)));

       ((*((output_bfd)->xvec->bfd_putx16)) ((stabsec->output_section->size / 12 - 1),(tosym + 6)));
  ...
  do { if (!((bfd_size_type) (tosym - contents) == stabsec->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",721); } while (0);
...
{
  if (((sinfo->stabstr->output_section) == (&_bfd_std_section[2])))

    return 1;

  do { if (!((sinfo->stabstr->output_offset + _bfd_stringtab_size (sinfo->strings)) <= sinfo->stabstr->output_section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/stabs.c",739); } while (0);
