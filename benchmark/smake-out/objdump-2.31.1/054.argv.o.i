# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
# 1 "./config.h" 1
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2

# 1 "./../include/ansidecl.h" 1
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 31 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2



# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c" 2
# 71 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
char **
...
# 104 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
...
{
  while ((_sch_istable[(**input) & 0xff] & (unsigned short)(_sch_isspace)))
    {
      (*input)++;
    }
}
...
{
  while (*input != '\0' && (_sch_istable[(*input) & 0xff] & (unsigned short)(_sch_isspace)))
    input++;

  return (*input == '\0');
}
# 176 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
char **buildargv (const char *input)
{
      ...
      do
 {
       ...
       else
  {
   ...
   while (*input != '\0')
     {
       if ((_sch_istable[(*input) & 0xff] & (unsigned short)(_sch_isspace)) && !squote && !dquote && !bsquote)
  {
    break;
  }
       else
...
# 299 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
int
      ...
      while (*arg != '\0')
        {
          ...
          if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isspace)) || c == '\\' || c == '\'' || c == '"')
            if ((-1) == fputc ('\\', f))
              {
                status = 1;
                goto done;
...
# 365 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
void
...
# 496 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./argv.c"
int
