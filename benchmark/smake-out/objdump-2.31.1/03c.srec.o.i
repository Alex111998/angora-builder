# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2
# 104 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 105 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 106 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 107 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2
...
# 108 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2
...
# 109 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c" 2




static const char digs[] = "0123456789ABCDEF";
# 132 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c"
unsigned int _bfd_srec_len = 16;




bfd_boolean _bfd_srec_forceS3 = 0;
        ...
        bfd_boolean error)
{
 ...
 (dgettext ("bfd", "%pB:%d: unexpected character `%s' in S-record file"),
  abfd, lineno, buf);
...
srec_scan (bfd *abfd)
{
  ...
  while ((c = srec_get_byte (abfd, &error)) != (-1))
    {
 ...
 case ' ':
  ...
  goto error_return;
       ...
       *p++ = c;
       while ((c = srec_get_byte (abfd, &error)) != (-1)
       && ! (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isspace)))
  {
    ...
    if (c == (-1))
      {
       ...
       symval = 0;
       while ((((unsigned int) _hex_value[(unsigned char) (c)]) != 99))
  {
    symval <<= 4;
    symval += ((unsigned int) _hex_value[(unsigned char) (c)]);
    c = srec_get_byte (abfd, &error);
    if (c == (-1))
      {
        srec_bad_byte (abfd, lineno, c, error);
 ...
 case 'S':
   {
     ...
     if (! (((unsigned int) _hex_value[(unsigned char) (hdr[1])]) != 99) || ! (((unsigned int) _hex_value[(unsigned char) (hdr[2])]) != 99))
       {
  if (! (((unsigned int) _hex_value[(unsigned char) (hdr[1])]) != 99))
    c = hdr[1];
  else
    c = hdr[2];
  srec_bad_byte (abfd, lineno, c, error);
  goto error_return;
     ...
     check_sum = bytes = ((((unsigned int) _hex_value[(unsigned char) ((hdr + 1)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((hdr + 1)[1])]));
     min_bytes = 3;
     if (hdr[0] == '2' || hdr[0] == '8')
       min_bytes = 4;
  ...
  _bfd_error_handler (dgettext ("bfd", "%pB:%d: byte count %d too small"),
        abfd, lineno, bytes);
  bfd_set_error (bfd_error_bad_value);
  goto error_return;
       }
  ...
  break;
       ...
       case '3':
  check_sum += ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])]));
  address = ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])]));
  data += 2;
  --bytes;

       case '2':
  check_sum += ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])]));
  address = (address << 8) | ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])]));
  data += 2;
  --bytes;
  ...
  if (sec != ((void*)0)
  ...
  else
    {
      ...
      sprintf (secbuf, ".sec%d", ((abfd)->section_count) + 1);
      amt = strlen (secbuf) + 1;
  ...
  if (check_sum != ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])])))
    {
      _bfd_error_handler

        (dgettext ("bfd", "%pB:%d: bad checksum in S-record file"),
         abfd, lineno);
      bfd_set_error (bfd_error_bad_value);
      goto error_return;
    }
...
srec_object_p (bfd *abfd)
{
  ...
  if (b[0] != 'S' || !(((unsigned int) _hex_value[(unsigned char) (b[1])]) != 99) || !(((unsigned int) _hex_value[(unsigned char) (b[2])]) != 99) || !(((unsigned int) _hex_value[(unsigned char) (b[3])]) != 99))
    {
...
srec_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
  ...
  if (bfd_seek (abfd, section->filepos, 0) != 0)
    goto error_return;
 ...
 continue;
      ...
      do { if (!(c == 'S')) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c",743); } while (0);

      if (bfd_bread (hdr, (bfd_size_type) 3, abfd) != 3)
 goto error_return;

      do { if (!((((unsigned int) _hex_value[(unsigned char) (hdr[1])]) != 99) && (((unsigned int) _hex_value[(unsigned char) (hdr[2])]) != 99))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c",748); } while (0);

      bytes = ((((unsigned int) _hex_value[(unsigned char) ((hdr + 1)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((hdr + 1)[1])]));
 ...
 {
 default:
   do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c",770); } while (0);
   if (buf != ((void*)0))
     free (buf);
   return 1;
 ...
 case '1':
   ...
   if (address != section->vma + sofar)
     {
       ...
       do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c",795); } while (0);
       if (buf != ((void*)0))
  free (buf);
       return 1;
     }
   ...
   while (bytes-- != 0)
     {
       contents[sofar] = ((((unsigned int) _hex_value[(unsigned char) ((data)[0])])<<4) + ((unsigned int) _hex_value[(unsigned char) ((data)[1])]));
       data += 2;
       ++sofar;
     }
  ...
  do { if (!(sofar == section->size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c",818); } while (0);
     ...
     const bfd_byte *end)
{
  ...
  *dst++ = '0' + type;
  ...
  switch (type)
    ...
    case 3:
    case 7:
      dst[1] = digs[((address >> 24)) & 0xf]; dst[0] = digs[(((address >> 24))>>4)&0xf]; check_sum += (((address >> 24)) & 0xff);;
      dst += 2;

    case 8:
    case 2:
      dst[1] = digs[((address >> 16)) & 0xf]; dst[0] = digs[(((address >> 16))>>4)&0xf]; check_sum += (((address >> 16)) & 0xff);;
      dst += 2;

    case 9:
    case 1:
    case 0:
      dst[1] = digs[((address >> 8)) & 0xf]; dst[0] = digs[(((address >> 8))>>4)&0xf]; check_sum += (((address >> 8)) & 0xff);;
      dst += 2;
      dst[1] = digs[((address)) & 0xf]; dst[0] = digs[(((address))>>4)&0xf]; check_sum += (((address)) & 0xff);;
      dst += 2;
      break;
  ...
  for (src = data; src < end; src++)
    {
      dst[1] = digs[(*src) & 0xf]; dst[0] = digs[((*src)>>4)&0xf]; check_sum += ((*src) & 0xff);;
      dst += 2;
    }


  length[1] = digs[((dst - length) / 2) & 0xf]; length[0] = digs[(((dst - length) / 2)>>4)&0xf]; check_sum += (((dst - length) / 2) & 0xff);;
  check_sum &= 0xff;
  check_sum = 255 - check_sum;
  dst[1] = digs[(check_sum) & 0xf]; dst[0] = digs[((check_sum)>>4)&0xf]; check_sum += ((check_sum) & 0xff);;
  dst += 2;
      ...
      srec_data_list_type *list)
{
  ...
  if (_bfd_srec_len == 0)
    _bfd_srec_len = 1;
  else if (_bfd_srec_len > 0xff - tdata->type - 2)
    _bfd_srec_len = 0xff - tdata->type - 2;
...
srec_write_symbols (bfd *abfd)
{
  ...
  int i;
  int count = ((abfd)->symcount);

  if (count)
    {
      bfd_size_type len;
      asymbol **table = ((abfd)->outsymbols);
      ...
      for (i = 0; i < count; i++)
 {
  ...
  return 0;
       ...
       sprintf (buf + 2, "%08" "l" "x", (s->value + s->section->output_section->lma + s->section->output_offset));
...
static int
srec_sizeof_headers (bfd *abfd __attribute__ ((__unused__)),
...
{
  bfd_size_type symcount = ((abfd)->symcount);
  asymbol *csymbols;
  unsigned int i;
...
static void
srec_get_symbol_info (bfd *ignore_abfd __attribute__ ((__unused__)),
        asymbol *symbol,
        symbol_info *ret)
{
...
# 1291 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/srec.c"
const bfd_target srec_vec =
{
  ...
  _bfd_archive_close_and_cleanup, _bfd_bool_bfd_true, _bfd_generic_new_section_hook, srec_get_section_contents, _bfd_generic_get_section_contents_in_window,
  ...
  srec_get_symtab_upper_bound, srec_canonicalize_symtab, _bfd_generic_make_empty_symbol, srec_print_symbol, srec_get_symbol_info, _bfd_nosymbols_get_symbol_version_string, bfd_generic_is_local_label_name, _bfd_bool_bfd_asymbol_false, _bfd_nosymbols_get_lineno, _bfd_nosymbols_find_nearest_line, _bfd_nosymbols_find_line, _bfd_nosymbols_find_inliner_info, _bfd_nosymbols_bfd_make_debug_symbol, _bfd_generic_read_minisymbols, _bfd_generic_minisymbol_to_symbol,
  ...
  srec_sizeof_headers, bfd_generic_get_relocated_section_contents, bfd_generic_relax_section, _bfd_generic_link_hash_table_create, _bfd_generic_link_add_symbols, _bfd_generic_link_just_syms, _bfd_generic_copy_link_hash_symbol_type, _bfd_generic_final_link, _bfd_generic_link_split_section, _bfd_generic_link_check_relocs, bfd_generic_gc_sections, bfd_generic_lookup_section_flags, bfd_generic_merge_sections, bfd_generic_is_group_section, bfd_generic_discard_group, _bfd_generic_section_already_linked, bfd_generic_define_common_symbol, _bfd_generic_link_hide_symbol, bfd_generic_define_start_stop,
