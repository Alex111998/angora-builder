# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c" 2
# 307 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c"
...
static unsigned long bfd_default_hash_table_size = 4051;
         ...
         unsigned int size)
{
  ...
  table->table = (struct bfd_hash_entry **)
      __extension__ ({ struct objalloc *__o = ((struct objalloc *) table->memory); unsigned long __len = (alloc); if (__len == 0) __len = 1; __len = (__len + __builtin_offsetof(struct objalloc_align, d) - 1) &~ (__builtin_offsetof(struct objalloc_align, d) - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
...
bfd_hash_hash (const char *string, unsigned int *lenp)
{
  ...
  do { if (!(string != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c",438); } while (0);
  hash = 0;
  len = 0;
  ...
  if (copy)
    {
      ...
      new_string = (char *) __extension__ ({ struct objalloc *__o = ((struct objalloc *) table->memory); unsigned long __len = (len + 1); if (__len == 0) __len = 1; __len = (__len + __builtin_offsetof(struct objalloc_align, d) - 1) &~ (__builtin_offsetof(struct objalloc_align, d) - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
   ...
   struct bfd_hash_entry *ent)
{
  ...
  for (pph = &table->table[_index]; *pph != ((void*)0); pph = &(*pph)->next)
    if (*pph == ent)
      break;
  if (*pph == ((void*)0))
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c", 580, __PRETTY_FUNCTION__);

  *pph = ent->next;
  ent->string = string;
  ent->hash = bfd_hash_hash (string, ((void*)0));
  _index = ent->hash % table->size;
    ...
    struct bfd_hash_entry *nw)
{
      ...
      if (*pph == old)
 {
  ...
  _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c", 612, __PRETTY_FUNCTION__);
}
     ...
     unsigned int size)
{
  ...
  ret = __extension__ ({ struct objalloc *__o = ((struct objalloc *) table->memory); unsigned long __len = (size); if (__len == 0) __len = 1; __len = (__len + __builtin_offsetof(struct objalloc_align, d) - 1) &~ (__builtin_offsetof(struct objalloc_align, d) - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
  ...
  for (i = 0; i < table->size; i++)
    {
      ...
      for (p = table->table[i]; p != ((void*)0); p = p->next)
 if (! (*func) (p, info))
   goto out;
    }
 out:
...
bfd_hash_set_default_size (unsigned long hash_size)
{
  ...
  for (_index = 0; _index < (sizeof (hash_size_primes) / sizeof ((hash_size_primes)[0])) - 1; ++_index)
...
# 697 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c"
...
# 761 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/hash.c"
struct bfd_strtab_hash *
      ...
      bfd_boolean copy)
{
  ...
  if (hash)
    {
      entry = ((struct strtab_hash_entry *) bfd_hash_lookup (&(tab)->table, (str), (1), (copy)));
      if (entry == ((void*)0))
...
_bfd_stringtab_emit (bfd *abfd, struct bfd_strtab_hash *tab)
{
      ...
      if (xcoff)
 {
   ...
   ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) len),(buf)));
