# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c" 2
# 19 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c"
# 1 "./sysdep.h" 1
# 23 "./sysdep.h"
...
# 180 "./sysdep.h" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c" 2
# 1 "./bucomm.h" 1
# 27 "./bucomm.h"
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c" 2

static char ftypelet (unsigned long);
static void setst (unsigned long, char *);
# 106 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c"
void
mode_string (unsigned long mode, char *str)
{
  ...
  str[2] = (mode & 0200) != 0 ? 'w' : '-';
  str[3] = (mode & 0100) != 0 ? 'x' : '-';
  str[4] = (mode & (0400 >> 3)) != 0 ? 'r' : '-';
  str[5] = (mode & (0200 >> 3)) != 0 ? 'w' : '-';
  str[6] = (mode & (0100 >> 3)) != 0 ? 'x' : '-';
  str[7] = (mode & ((0400 >> 3) >> 3)) != 0 ? 'r' : '-';
  str[8] = (mode & ((0200 >> 3) >> 3)) != 0 ? 'w' : '-';
  str[9] = (mode & ((0100 >> 3) >> 3)) != 0 ? 'x' : '-';
  setst ((unsigned long) mode, str);
}
# 181 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c"
static char
ftypelet (unsigned long bits)
{
  ...
  if (((((bits)) & 0170000) == (0010000)))
    return 'p';
# 209 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/binutils/filemode.c"
  return '-';
}
...
static void
setst (unsigned long bits __attribute__ ((__unused__)), char *chars __attribute__ ((__unused__)))
{
