# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
# 1 "./../zlib/zlib.h" 1
# 34 "./../zlib/zlib.h"
# 1 "./../zlib/zconf.h" 1
# 247 "./../zlib/zconf.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c" 2
       ...
       bfd_size_type uncompressed_size)
{
  z_stream strm;
  int rc;
# 45 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
  memset (& strm, 0, sizeof strm);
  strm.avail_in = compressed_size;
  strm.next_in = (Bytef*) compressed_buffer;
  strm.avail_out = uncompressed_size;

  do { if (!(0 == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c",50); } while (0);
 ...
 break;
  ...
  rc |= inflateEnd (&strm);
  return rc == 0 && strm.avail_out == 0;
}
# 75 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
          ...
          bfd_size_type uncompressed_size)
{
  ...
  int header_size = bfd_get_compression_header_size (abfd, ((void*)0));
 ...
 _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c", 102, __PRETTY_FUNCTION__);
...
# 222 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
bfd_get_full_section_contents (bfd *abfd, sec_ptr sec, bfd_byte **ptr)
{
      ...
      if (p == ((void*)0))
 {
  ...
  _bfd_error_handler
    ...
    (dgettext ("bfd", "error: %pB(%pA) is too large (%#" "ll" "x" " bytes)"),
 ...
 memcpy (p, sec->contents, sz);
    ...
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c", 333, __PRETTY_FUNCTION__);
    }
}
# 350 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
void
bfd_cache_section_contents (asection *sec, void *contents)
{
  if (sec->compress_status == 2)
    sec->compress_status = 1;
  sec->contents = contents;
  sec->flags |= 0x4000;
}
# 377 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
           ...
           bfd_size_type *uncompressed_size_p)
{
  ...
  compression_header_size = bfd_get_compression_header_size (abfd, sec);
  if (compression_header_size > 24)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c", 390, __PRETTY_FUNCTION__);
 ...
 compressed = (strncmp (((char*) header), ("ZLIB"), sizeof ("ZLIB") - 1) == 0);
      else
 compressed = 1;
    }
  else
      ...
      if (compression_header_size != 0)
 {
   if (!bfd_check_compression_header (abfd, header, sec,
     ...
     compression_header_size = -1;
        ...
        && (_sch_istable[(header[4]) & 0xff] & (unsigned short)(_sch_isprint)))
 compressed = 0;
      else
...
# 447 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
...
# 476 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
bfd_init_section_decompress_status (bfd *abfd, sec_ptr sec)
{
  ...
  compression_header_size = bfd_get_compression_header_size (abfd, sec);
  if (compression_header_size > 24)
    _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c", 486, __PRETTY_FUNCTION__);
  header_size = compression_header_size ? compression_header_size : 12;
  ...
  if (compression_header_size == 0)
    {
      ...
      if (! (strncmp (((char*) header), ("ZLIB"), sizeof ("ZLIB") - 1) == 0))
 {
...
# 540 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
...
# 590 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/compress.c"
bfd_boolean
