# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
# 1 "./config.h" 1
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
simple_object_copy_lto_debug_sections (simple_object_read *src_object,
           const char *dest,
           int *err, int rename);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2

# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 28 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 36 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 40 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c" 2
...
# 85 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
struct mach_o_load_command
{
  unsigned char cmd[4];
  unsigned char cmdsize[4];
};
# 98 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
...
# 188 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
...
# 239 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
static void *
...
# 284 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
  if (segment_name == ((void*)0))
    {
  ...
  filetype = (*fetch_32) (b + __builtin_offsetof(struct mach_o_header_32, filetype));
  if (filetype != 0x01)
    {
  ...
  omr = ((struct simple_object_mach_o_read *) xmalloc (sizeof (struct simple_object_mach_o_read)));
  omr->segment_name = xstrdup (segment_name);
  omr->magic = magic;
  omr->is_big_endian = is_big_endian;
  omr->cputype = (*fetch_32) (b + __builtin_offsetof(struct mach_o_header_32, cputype));
  omr->cpusubtype = (*fetch_32) (b
     + __builtin_offsetof(struct mach_o_header_32, cpusubtype));

  omr->ncmds = (*fetch_32) (b + __builtin_offsetof(struct mach_o_header_32, ncmds));
  omr->flags = (*fetch_32) (b + __builtin_offsetof(struct mach_o_header_32, flags));
  if (magic == 0xfeedface)
    omr->reserved = 0;
  else
    omr->reserved = (*fetch_32) (b
     + __builtin_offsetof(struct mach_o_header_64, reserved));
  ...
  if (is_32)
    {
     ...
     + __builtin_offsetof(struct mach_o_section_32, offset));
      *size = fetch_32 (sechdr
   + __builtin_offsetof(struct mach_o_section_32, size));
    }
  else
    {
      *offset = fetch_32 (sechdr
     + __builtin_offsetof(struct mach_o_section_64, offset));
      *size = fetch_64 (sechdr
   + __builtin_offsetof(struct mach_o_section_64, size));
    }
}
# 403 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
static int
         ...
         const char **errmsg, int *err)
{
  ...
  is_32 = omr->magic == 0xfeedface;

  if (is_32)
    {
      seghdrsize = sizeof (struct mach_o_segment_command_32);
      sechdrsize = sizeof (struct mach_o_section_32);
      segname_offset = __builtin_offsetof(struct mach_o_section_32, segname);
      sectname_offset = __builtin_offsetof(struct mach_o_section_32, sectname);
      nsects = (*fetch_32) (segbuf
       + __builtin_offsetof(struct mach_o_segment_command_32, nsects));
  ...
  else
    {
      ...
      segname_offset = __builtin_offsetof(struct mach_o_section_64, segname);
      sectname_offset = __builtin_offsetof(struct mach_o_section_64, sectname);
      nsects = (*fetch_32) (segbuf
       + __builtin_offsetof(struct mach_o_segment_command_64, nsects));

    }



  secdata = ((unsigned char *) xmalloc (sizeof (unsigned char) * (nsects * sechdrsize)));
 ...
 continue;
      ...
      if (strcmp ((char *) secdata + nameoff, "__wrapper_names") == 0)
 {
   nametab_index = i;
   gnu_sections_found |= 0x04;
 }
      else if (strcmp ((char *) secdata + nameoff, "__wrapper_index") == 0)
 {
   index_index = i;
   gnu_sections_found |= 0x02;
 }
      else if (strcmp ((char *) secdata + nameoff, "__wrapper_sects") == 0)
 {
   sections_index = i;
   gnu_sections_found |= 0x01;
 }
      else if (strcmp ((char *) secdata + nameoff, "__section_names") == 0)
 {
   strtab_index = i;
   gnu_sections_found |= 0x08;
 }
    }
  ...
  if ((gnu_sections_found & (0x01 | 0x02 | 0x04)) != 0)
    {
      off_t nametab_offset;
      off_t index_offset;

      if ((gnu_sections_found & (0x01 | 0x02 | 0x04)) != (0x01 | 0x02 | 0x04))
 {
   ...
   *err = 0;
   ...
   return 0;
      ...
      nametab = ((char *) xmalloc (sizeof (char) * (nametab_size)));
     ...
     errmsg, err))
 {
   ...
   return 0;
      ...
      index = ((unsigned char *) xmalloc (sizeof (unsigned char) * (index_size)));
      if (!simple_object_internal_read (sobj->descriptor,
  ...
  if ((gnu_sections_found & 0x08) != 0)
    {
      ...
      strtab = ((char *) xmalloc (sizeof (char) * (strtab_size)));
      if (!simple_object_internal_read (sobj->descriptor,
      ...
      if ((gnu_sections_found & (0x01 | 0x02 | 0x04)) != 0)
 {
       ...
       for (j = 0; j < n_wrapped_sects; ++j)
  {
    ...
    if (!(*pfn) (data, name, secoffset, secsize))
      ...
      if ((gnu_sections_found & 0x08) != 0)
 {
   memcpy (namebuf, sechdr + sectname_offset, (16));
   namebuf[(16)] = '\0';

   name = &namebuf[0];
   if (strtab != ((void*)0) && name[0] == '_' && name[1] == '_')
     {
      ...
      else
 {
   ...
   name = &namebuf[0];
   memcpy (namebuf, (char *) sechdr + segname_offset, (16));
   namebuf[(16)] = '\0';
   l = strlen (namebuf);
   namebuf[l] = ',';
        ...
        int *err)
{
 ...
 return errmsg;
      ...
      cmd = (*fetch_32) (loadbuf + __builtin_offsetof(struct mach_o_load_command, cmd));
      cmdsize = (*fetch_32) (loadbuf
        + __builtin_offsetof(struct mach_o_load_command, cmdsize));
           ...
           int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((struct simple_object_mach_o_attributes *) xmalloc (sizeof (struct simple_object_mach_o_attributes)));
  ret->magic = omr->magic;
       ...
       int *err)
{
  ...
  hdr = &hdrbuf[0];
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, magic), attrs->magic);
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, cputype), attrs->cputype);
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, cpusubtype),
   attrs->cpusubtype);
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, filetype), 0x01);
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, ncmds), 1);
  set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, flags), attrs->flags);
  if (attrs->magic == 0xfeedface)
    {
      wrsize = sizeof (struct mach_o_header_32);
      set_32 (hdr + __builtin_offsetof(struct mach_o_header_32, sizeofcmds),
       (sizeof (struct mach_o_segment_command_32)
        + nsects * sizeof (struct mach_o_section_32)));
    }
  else
    {
      set_32 (hdr + __builtin_offsetof(struct mach_o_header_64, sizeofcmds),
       (sizeof (struct mach_o_segment_command_64)
        + nsects * sizeof (struct mach_o_section_64)));
      set_32 (hdr + __builtin_offsetof(struct mach_o_header_64, reserved),
       attrs->reserved);
        ...
        const char **errmsg, int *err)
{
  ...
  if (attrs->magic == 0xfeedface)
    {
      strncpy ((char *) hdr + __builtin_offsetof(struct mach_o_section_32, sectname),
        name, (16));
      strncpy ((char *) hdr + __builtin_offsetof(struct mach_o_section_32, segname),
        segn, (16));
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_32, addr), secaddr);
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_32, size), secsize);
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_32, offset), offset);
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_32, align), align);


      set_32 (hdr + __builtin_offsetof(struct mach_o_section_32, flags),
       0x02000000);
  ...
  : simple_object_set_little_64);
      ...
      strncpy ((char *) hdr + __builtin_offsetof(struct mach_o_section_64, sectname),
        name, (16));
      strncpy ((char *) hdr + __builtin_offsetof(struct mach_o_section_64, segname),
        segn, (16));
      set_64 (hdr + __builtin_offsetof(struct mach_o_section_64, addr), secaddr);
      set_64 (hdr + __builtin_offsetof(struct mach_o_section_64, size), secsize);
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_64, offset), offset);
      set_32 (hdr + __builtin_offsetof(struct mach_o_section_64, align), align);


      set_32 (hdr + __builtin_offsetof(struct mach_o_section_64, flags),
       0x02000000);
...
# 1028 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
static int
        ...
        int *err)
{
  ...
  *nsects = nsects_in = 0;
  ...
  if (sobj->segment_name != ((void*)0))
    {


      *nsects = 3;
# 1093 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-mach-o.c"
      index = ((unsigned int *) xmalloc (sizeof (unsigned int) * (nsects_in * 4)));





      for (section = sobj->sections, sect = 0; section != ((void*)0);
    section = section->next, sect++)
 {
   ...
   name_offset += strlen (section->name) + 1;
      ...
      snames = ((char *) xmalloc (sizeof (char) * (name_offset)));
    }
  else
    {
      *nsects = nsects_in;
  ...
  for (section = sobj->sections, sect = 0;
       section != ((void*)0); section = section->next, sect++)
    {
      size_t mask;
      size_t new_offset;
      size_t secsize;
   ...
   if (comma != ((void*)0))
     {
       ...
       strncpy (segnbuf, comma + 1, (16));
     }
   else
     strncpy (namebuf, section->name, (16));
 ...
 return 0;
  ...
  if (attrs->magic == 0xfeedface)
    {
      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_32, cmd),
       0x01);
      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_32, cmdsize),
       cmdsize);




      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_32, fileoff),
       hdrsize + cmdsize);
      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_32, filesize),
       offset - (hdrsize + cmdsize));


      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_32, nsects),
       *nsects);
  ...
  : simple_object_set_little_64);
      ...
      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_64, cmd),
       0x01);
      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_64, cmdsize),
       cmdsize);




      set_64 (hdr + __builtin_offsetof(struct mach_o_segment_command_64, fileoff),
       hdrsize + cmdsize);
      set_64 (hdr + __builtin_offsetof(struct mach_o_segment_command_64, filesize),
       offset - (hdrsize + cmdsize));


      set_32 (hdr + __builtin_offsetof(struct mach_o_segment_command_64, nsects),
       *nsects);
