# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
# 1 "./config.h" 1
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 27 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 32 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
# 49 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
...
# 50 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c" 2
extern int mkstemps (char *, int);
# 70 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
...
# 104 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
const char *
choose_tmpdir (void)
{
  if (!memoized_tmpdir)
 ...
 base = ".";
      ...
      len = strlen (base);
      tmpdir = ((char *) xmalloc (sizeof (char) * (len + 2)));
      strcpy (tmpdir, base);
      tmpdir[len] = '/';
      tmpdir[len+1] = '\0';
      memoized_tmpdir = tmpdir;
# 166 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
    }

  return memoized_tmpdir;
}
# 183 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./make-temp-file.c"
char *
make_temp_file (const char *suffix)
{
  ...
  temp_filename = ((char *) xmalloc (sizeof (char) * (base_len + (sizeof("ccXXXXXX") - 1) + suffix_len + 1)));
  ...
  if (fd == -1)
    {
      fprintf (stderr, "Cannot create temporary file in %s: %s\n",
        base, strerror ((*__errno_location ())));
      abort ();
    }
