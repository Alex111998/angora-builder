# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
# 49 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 50 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 51 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
...
# 52 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 53 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
# 1 "./bfdver.h" 1
# 54 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c" 2
# 429 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
unsigned int
bfd_get_reloc_size (reloc_howto_type *howto)
{
  switch (howto->size)
    ...
    case -1: return 2;
    case -2: return 4;
    default: _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 443, __PRETTY_FUNCTION__);
    }
}
# 488 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_reloc_status_type
      ...
      bfd_vma relocation)
{
  ...
  fieldmask = (((((bfd_vma) 1 << ((bitsize) - 1)) - 1) << 1) | 1);
  signmask = ~fieldmask;
  addrmask = (((((bfd_vma) 1 << ((addrsize) - 1)) - 1) << 1) | 1) | (fieldmask << rightshift);
 ...
 flag = bfd_reloc_overflow;
    ...
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 536, __PRETTY_FUNCTION__);
    }

  return flag;
}
# 562 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
bfd_reloc_offset_in_range (reloc_howto_type *howto,
      ...
      bfd_size_type octet)
{
  bfd_size_type octet_end = ((abfd)->direction != write_direction && (section)->rawsize != 0 ? (section)->rawsize : (section)->size);
...
# 608 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (((symbol->section) == (&_bfd_std_section[2]))
      && output_bfd != ((void*)0))
    {
  ...
  if ((output_bfd && ! howto->partial_inplace)
      || reloc_target_output_section == ((void*)0))
    output_base = 0;
  else
  ...
  if (howto->pc_relative)
    {
# 724 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
      relocation -=
      ...
      else
 {
   ...
   if (abfd->xvec->flavour == bfd_target_coff_flavour
     ...
     {
# 826 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
       relocation -= reloc_entry->addend;
...
# 843 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont
    ...
    flag = bfd_check_overflow (howto->complain_on_overflow,
          ...
          relocation);
# 878 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 919 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  switch (howto->size)
    {
    case 5:
      {
 long x = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) data + octets));
 x >>= 8;
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) (x >> 8)),((bfd_byte *) data + octets)));
 ((void) (*((unsigned char *) ((unsigned char *) data + 2 + octets)) = ((x & 0xFF)) & 0xff));
      }
      break;

    case 0:
      {
 char x = (*(const unsigned char *) ((char *) data + octets) & 0xff);
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((void) (*((unsigned char *) ((unsigned char *) data + octets)) = (x) & 0xff));
      }
      break;

    case 1:
      {
 short x = ((*((abfd)->xvec->bfd_getx16)) ((bfd_byte *) data + octets));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) x),((unsigned char *) data + octets)));
      }
      break;
    case 2:
      {
 long x = ((*((abfd)->xvec->bfd_getx32)) ((bfd_byte *) data + octets));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) x),((bfd_byte *) data + octets)));
      }
      break;
    case -2:
      {
 ...
 ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) x),((bfd_byte *) data + octets)));
    ...
    case -1:
      {
 long x = ((*((abfd)->xvec->bfd_getx16)) ((bfd_byte *) data + octets));
 relocation = -relocation;
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) x),((bfd_byte *) data + octets)));
      }
      break;
    ...
    case 4:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 983, __PRETTY_FUNCTION__);
...
# 1015 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_reloc_status_type
   ...
   char **error_message)
{
 ...
 return cont;
  ...
  if (howto->pc_relative)
    {
# 1125 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
      relocation -=
 input_section->output_section->vma + input_section->output_offset;
 ...
 relocation -= reloc_entry->address;
  ...
  if (! howto->partial_inplace)
   ...
   && strcmp (abfd->xvec->name, "coff-Intel-big") != 0)
 {
# 1224 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
   relocation -= reloc_entry->addend;
...
# 1242 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  if (howto->complain_on_overflow != complain_overflow_dont)
    flag = bfd_check_overflow (howto->complain_on_overflow,
          howto->bitsize,
          howto->rightshift,
          bfd_arch_bits_per_address (abfd),
          relocation);
# 1276 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  relocation >>= (bfd_vma) howto->rightshift;


  relocation <<= (bfd_vma) howto->bitpos;
# 1317 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  ...
  switch (howto->size)
    ...
    case 0:
      {
 char x = (*(const unsigned char *) (data) & 0xff);
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((void) (*((unsigned char *) (data)) = (x) & 0xff));
      }
      break;

    case 1:
      {
 short x = ((*((abfd)->xvec->bfd_getx16)) (data));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) x),(data)));
      }
      break;
    case 2:
      {
 long x = ((*((abfd)->xvec->bfd_getx32)) (data));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) x),(data)));
      }
      break;
    case -2:
      {
 ...
 ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) x),(data)));
    ...
    case 4:
      {
 bfd_vma x = ((*((abfd)->xvec->bfd_getx64)) (data));
 x = ( (x & ~howto->dst_mask) | (((x & howto->src_mask) + relocation) & howto->dst_mask));
 ((*((abfd)->xvec->bfd_putx64)) ((x), (data)));
      }
      break;
    default:
      return bfd_reloc_other;
...
# 1392 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_reloc_status_type
...
# 1424 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
  if (howto->pc_relative)
    {
   ...
   bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1461, __PRETTY_FUNCTION__);
    case 0:
      return bfd_reloc_ok;
    case 1:
      x = (*(const unsigned char *) (location) & 0xff);
      break;
    case 2:
      x = ((*((input_bfd)->xvec->bfd_getx16)) (location));
      break;
    case 4:
      x = ((*((input_bfd)->xvec->bfd_getx32)) (location));
      break;
    case 8:



      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1477, __PRETTY_FUNCTION__);
  ...
  if (howto->complain_on_overflow != complain_overflow_dont)
    {
      ...
      fieldmask = (((((bfd_vma) 1 << ((howto->bitsize) - 1)) - 1) << 1) | 1);
      signmask = ~fieldmask;
      addrmask = ((((((bfd_vma) 1 << ((bfd_arch_bits_per_address (input_bfd)) - 1)) - 1) << 1) | 1)
 ...
 case complain_overflow_bitfield:
   ...
   sum = a + b;
# 1551 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
   if (((~(a ^ b)) & (a ^ sum)) & signmask & addrmask)
     flag = bfd_reloc_overflow;
   break;

 case complain_overflow_unsigned:
# 1567 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
   sum = (a + b) & addrmask;
   if ((a | b | sum) & signmask)
     flag = bfd_reloc_overflow;
   break;
 ...
 default:
   _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1573, __PRETTY_FUNCTION__);
 }
    }
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1589, __PRETTY_FUNCTION__);
    case 1:
    ...
    case 8:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1603, __PRETTY_FUNCTION__);
       ...
       bfd_byte *location)
{
  ...
  switch (size)
    {
    default:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1630, __PRETTY_FUNCTION__);
    case 0:
      return;
    case 1:
      x = (*(const unsigned char *) (location) & 0xff);
    ...
    case 8:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1646, __PRETTY_FUNCTION__);
  ...
  if (strcmp (((void) input_bfd, (input_section)->name),
       ".debug_ranges") == 0
      && (howto->dst_mask & 1) != 0)
    x |= 1;
  ...
  switch (size)
    ...
    default:
    case 0:
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1666, __PRETTY_FUNCTION__);
    case 1:
      ((void) (*((unsigned char *) (location)) = (x) & 0xff));
      break;
    case 2:
    ...
    case 8:
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c", 1680, __PRETTY_FUNCTION__);

      break;
    }
}
# 8016 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
reloc_howto_type *
bfd_reloc_type_lookup (bfd *abfd, bfd_reloc_code_real_type code)
{
  return ((*((abfd)->xvec->reloc_type_lookup)) (abfd, code));
}

reloc_howto_type *
bfd_reloc_name_lookup (bfd *abfd, const char *reloc_name)
{
  return ((*((abfd)->xvec->reloc_name_lookup)) (abfd, reloc_name));
}

static reloc_howto_type bfd_howto_32 =
{ (unsigned) 0, 00, 2, 32, 0, 0, complain_overflow_dont, 0, "VRT32", 0, 0xffffffff, 0xffffffff, 1 };
# 8044 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
reloc_howto_type *
bfd_default_reloc_type_lookup (bfd *abfd, bfd_reloc_code_real_type code)
{
 ...
 {
 case 64:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c",8055); } while (0);
   break;
 case 32:
   return &bfd_howto_32;
 case 16:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c",8060); } while (0);
   break;
 default:
   do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c",8063); } while (0);
 }
      break;
    default:
      do { bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c",8067); } while (0);
    }
  return ((void*)0);
}
# 8084 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
const char *
...
# 8108 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
bfd_generic_relax_section (bfd *abfd __attribute__ ((__unused__)),
      ...
      bfd_boolean *again)
{
  if (((link_info)->type == type_relocatable))
    (*link_info->callbacks->einfo)
      (dgettext ("bfd", "%P%F: --relax and -r may not be used together\n"));

  *again = 0;
  return 1;
}
# 8135 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
bfd_generic_gc_sections (bfd *abfd __attribute__ ((__unused__)),
    struct bfd_link_info *info __attribute__ ((__unused__)))
{
  return 1;
}
# 8156 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
bfd_generic_lookup_section_flags (struct bfd_link_info *info __attribute__ ((__unused__)),
      struct flag_info *flaginfo,
      asection *section __attribute__ ((__unused__)))
{
  if (flaginfo != ((void*)0))
    {
      _bfd_error_handler (dgettext ("bfd", "INPUT_SECTION_FLAGS are not supported"));
      return 0;
    }
  return 1;
}
# 8182 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
bfd_generic_merge_sections (bfd *abfd __attribute__ ((__unused__)),
       struct bfd_link_info *link_info __attribute__ ((__unused__)))
{
  return 1;
}
# 8208 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_byte *
         ...
         asymbol **symbols)
{
      ...
      for (parent = reloc_vector; *parent != ((void*)0); parent++)
 {
  ...
  (dgettext ("bfd", "%X%P: %pB(%pA): error: relocation for offset %V has no value\n"),
   abfd, input_section, (* parent)->address);
       goto error_return;
     }

   if (symbol->section && (!((symbol->section) == (&_bfd_std_section[2])) && (((symbol->section)->output_section) == (&_bfd_std_section[2])) && (symbol->section)->sec_info_type != 2 && (symbol->section)->sec_info_type != 4))
     {
       bfd_byte *p;
       static reloc_howto_type none_howto
  = { (unsigned) 0, 0, 0, 0, 0, 0, complain_overflow_dont, ((void*)0), "unused", 0, 0, 0, 0 };


       p = data + (*parent)->address * bfd_octets_per_byte (input_bfd);
       _bfd_clear_contents ((*parent)->howto, input_bfd, input_section,
       p);
       (*parent)->sym_ptr_ptr = (&_bfd_std_section[2])->symbol_ptr_ptr;
       (*parent)->addend = 0;
  ...
  case bfd_reloc_undefined:
    (*link_info->callbacks->undefined_symbol)
      (link_info, ((*(*parent)->sym_ptr_ptr)->name),
       input_bfd, input_section, (*parent)->address, 1);
    break;
  case bfd_reloc_dangerous:
    do { if (!(error_message != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c",8311); } while (0);
  ...
  case bfd_reloc_outofrange:
    ...
    link_info->callbacks->einfo
      ...
      (dgettext ("bfd", "%X%P: %pB(%pA): relocation \"%pR\" goes out of range\n"),
  ...
  case bfd_reloc_notsupported:
    ...
    link_info->callbacks->einfo
      ...
      (dgettext ("bfd", "%X%P: %pB(%pA): relocation \"%pR\" is not supported\n"),
       abfd, input_section, * parent);
    goto error_return;
  ...
  default:
    ...
    link_info->callbacks->einfo
      ...
      (dgettext ("bfd", "%X%P: %pB(%pA): relocation \"%pR\" returns an unrecognized value %x\n"),
...
# 8381 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
void
_bfd_generic_set_reloc (bfd *abfd __attribute__ ((__unused__)),
   sec_ptr section,
   arelent **relptr,
   unsigned int count)
{
...
# 8407 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/reloc.c"
bfd_boolean
_bfd_unrecognized_reloc (bfd * abfd, sec_ptr section, unsigned int r_type)
{

  _bfd_error_handler (dgettext ("bfd", "%pB: unrecognized relocation type %#x in section `%pA'"),
        abfd, r_type, section);


  _bfd_error_handler (dgettext ("bfd", "is this version of the linker - %s - out of date ?"),
        "(GNU Binutils) " "2.31.1");
...
_bfd_norelocs_bfd_reloc_type_lookup
    (bfd *abfd,
     bfd_reloc_code_real_type code __attribute__ ((__unused__)))
{
...
_bfd_norelocs_bfd_reloc_name_lookup (bfd *abfd,
         const char *reloc_name __attribute__ ((__unused__)))
{
  return (reloc_howto_type *) _bfd_ptr_bfd_null_error (abfd);
}
...
_bfd_nodynamic_canonicalize_dynamic_reloc (bfd *abfd,
        arelent **relp __attribute__ ((__unused__)),
        asymbol **symp __attribute__ ((__unused__)))
{
