# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
# 20 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c"
# 1 "./config.h" 1
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
simple_object_copy_lto_debug_sections (simple_object_read *src_object,
           const char *dest,
           int *err, int rename);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 33 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 37 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c" 2
...
# 68 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c"
...
# 102 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c"
...
# 165 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./simple-object-coff.c"
...
static const struct coff_magic_struct coff_magic[] =
{
  ...
  { 0x14c, 0, (0x0002) | (0x1000) | (0x2000) },

  { 0x8664, 0, (0x0002) | (0x1000) | (0x2000) }
};



static void *
simple_object_coff_match (unsigned char header[(16)],
     ...
     const char **errmsg, int *err)
{
 ...
 break;
  ...
  flags = fetch_16 (hdrbuf + __builtin_offsetof(struct external_filehdr, f_flags));
  ...
  ocr = ((struct simple_object_coff_read *) xmalloc (sizeof (struct simple_object_coff_read)));
  ocr->magic = magic;
  ...
  ocr->symptr = fetch_32 (hdrbuf
     + __builtin_offsetof(struct external_filehdr, f_symptr));
  ocr->nsyms = fetch_32 (hdrbuf + __builtin_offsetof(struct external_filehdr, f_nsyms));
  ocr->flags = flags;
  ocr->scnhdr_offset = (sizeof (struct external_filehdr)
   + fetch_16 (hdrbuf + __builtin_offsetof(struct external_filehdr, f_opthdr)));
       ...
       if (strindex < 4 || strindex >= strtab_size)
  {
    ...
    *err = 0;
    return "section string index out of range";
      ...
      scnptr = fetch_32 (scnhdr + __builtin_offsetof(struct external_scnhdr, s_scnptr));
      size = fetch_32 (scnhdr + __builtin_offsetof(struct external_scnhdr, s_size));
         ...
         int *err __attribute__ ((__unused__)))
{
  ...
  ret = ((struct simple_object_coff_attributes *) xmalloc (sizeof (struct simple_object_coff_attributes)));
  ret->magic = ocr->magic;
      ...
      int *err)
{
  ...
  set_32 (hdr + __builtin_offsetof(struct external_filehdr, f_symptr), symtab_offset);
  set_32 (hdr + __builtin_offsetof(struct external_filehdr, f_nsyms), nsyms);

  set_16 (hdr + __builtin_offsetof(struct external_filehdr, f_flags), attrs->flags);
     ...
     const char **errmsg, int *err)
{
  ...
  namelen = strlen (name);
  if (namelen <= (8))
    strncpy ((char *) hdr + __builtin_offsetof(struct external_scnhdr, s_name), name,
      (8));
  else
    {
  ...
  set_32 (hdr + __builtin_offsetof(struct external_scnhdr, s_size), scnsize);
  set_32 (hdr + __builtin_offsetof(struct external_scnhdr, s_scnptr), offset);
  ...
  if (align > 13)
    align = 13;
  flags |= (((align) + 1) << 20);
  set_32 (hdr + __builtin_offsetof(struct external_scnhdr, s_flags), flags);
      ...
      int *err)
{
 ...
 return errmsg;
  ...
  set_16 (&syms[0].sym.e_scnum[0], (-2));
  set_16 (&syms[0].sym.e_type[0], (((0) << 4) | (0)));
  syms[0].sym.e_sclass[0] = (103);
