# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2
# 1 "./elf-bfd.h" 1
# 25 "./elf-bfd.h"
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2




static reloc_howto_type dummy =
  { (unsigned) 0, 0, 0, 0, 0, 0, complain_overflow_dont, ((void*)0), "UNKNOWN", 0, 0, 0, 0 };
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c"
static bfd_boolean
elf_generic_info_to_howto (bfd *abfd __attribute__ ((__unused__)),
      arelent *bfd_reloc,
      Elf_Internal_Rela *elf_reloc __attribute__ ((__unused__)))
{
...
static bfd_boolean
elf_generic_info_to_howto_rel (bfd *abfd __attribute__ ((__unused__)),
          arelent *bfd_reloc,
          Elf_Internal_Rela *elf_reloc __attribute__ ((__unused__)))
{
  bfd_reloc->howto = &dummy;
  ...
  if ((o->flags & 0x4) != 0)
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "%pB: relocations in generic ELF (EM: %d)"),
     abfd, ehdrp->e_machine);

      bfd_set_error (bfd_error_wrong_format);
      * (bfd_boolean *) failed = 1;
    }
}
...
# 105 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c"
# 1 "./elf32-target.h" 1
# 763 "./elf32-target.h"
...
const bfd_target elf32_be_vec =
{
  ...
  (bfd_arch_unknown == bfd_arch_unknown ? 2 : 0 == 0 ? 1 : 0),
  ...
  _bfd_elf_get_symtab_upper_bound, _bfd_elf_canonicalize_symtab, _bfd_elf_make_empty_symbol, bfd_elf_print_symbol, _bfd_elf_get_symbol_info, _bfd_elf_get_symbol_version_string, _bfd_elf_is_local_label_name, _bfd_bool_bfd_asymbol_false, _bfd_elf_get_lineno, _bfd_elf_find_nearest_line, _bfd_elf_find_line, _bfd_elf_find_inliner_info, _bfd_nosymbols_bfd_make_debug_symbol, _bfd_generic_read_minisymbols, _bfd_generic_minisymbol_to_symbol,
  _bfd_elf_get_reloc_upper_bound, _bfd_elf_canonicalize_reloc, _bfd_generic_set_reloc, bfd_default_reloc_type_lookup, _bfd_norelocs_bfd_reloc_name_lookup,
  _bfd_elf_set_arch_mach, _bfd_elf_set_section_contents,
  _bfd_elf_sizeof_headers, bfd_generic_get_relocated_section_contents, bfd_generic_relax_section, _bfd_generic_link_hash_table_create, elf32_generic_link_add_symbols, _bfd_generic_link_just_syms, _bfd_generic_copy_link_hash_symbol_type, _bfd_generic_final_link, _bfd_generic_link_split_section, _bfd_elf_link_check_relocs, bfd_elf_gc_sections, bfd_elf_lookup_section_flags, _bfd_elf_merge_sections, bfd_elf_is_group_section, bfd_generic_discard_group, _bfd_elf_section_already_linked, bfd_generic_define_common_symbol, _bfd_elf_link_hide_symbol, bfd_generic_define_start_stop,
  _bfd_elf_get_dynamic_symtab_upper_bound, _bfd_elf_canonicalize_dynamic_symtab, _bfd_elf_get_synthetic_symtab, _bfd_elf_get_dynamic_reloc_upper_bound, _bfd_elf_canonicalize_dynamic_reloc,
...
# 106 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/elf32-gen.c" 2
