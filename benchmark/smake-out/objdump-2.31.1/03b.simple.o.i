# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c" 2
...
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c" 2

static void
simple_dummy_warning (struct bfd_link_info *link_info __attribute__ ((__unused__)),
        const char *warning __attribute__ ((__unused__)),
        const char *symbol __attribute__ ((__unused__)),
        bfd *abfd __attribute__ ((__unused__)),
        asection *section __attribute__ ((__unused__)),
        bfd_vma address __attribute__ ((__unused__)))
{
}

static void
simple_dummy_undefined_symbol (struct bfd_link_info *link_info __attribute__ ((__unused__)),
          const char *name __attribute__ ((__unused__)),
          bfd *abfd __attribute__ ((__unused__)),
          asection *section __attribute__ ((__unused__)),
          bfd_vma address __attribute__ ((__unused__)),
          bfd_boolean fatal __attribute__ ((__unused__)))
{
}

static void
simple_dummy_reloc_overflow (struct bfd_link_info *link_info __attribute__ ((__unused__)),
        struct bfd_link_hash_entry *entry __attribute__ ((__unused__)),
        const char *name __attribute__ ((__unused__)),
        const char *reloc_name __attribute__ ((__unused__)),
        bfd_vma addend __attribute__ ((__unused__)),
        bfd *abfd __attribute__ ((__unused__)),
        asection *section __attribute__ ((__unused__)),
        bfd_vma address __attribute__ ((__unused__)))
{
...
static void
simple_dummy_reloc_dangerous (struct bfd_link_info *link_info __attribute__ ((__unused__)),
...
static void
simple_dummy_unattached_reloc (struct bfd_link_info *link_info __attribute__ ((__unused__)),
          const char *name __attribute__ ((__unused__)),
          bfd *abfd __attribute__ ((__unused__)),
          asection *section __attribute__ ((__unused__)),
          bfd_vma address __attribute__ ((__unused__)))
...
static void
simple_dummy_multiple_definition (struct bfd_link_info *link_info __attribute__ ((__unused__)),
      struct bfd_link_hash_entry *h __attribute__ ((__unused__)),
      bfd *nbfd __attribute__ ((__unused__)),
      asection *nsec __attribute__ ((__unused__)),
      bfd_vma nval __attribute__ ((__unused__)))
{
}

static void
simple_dummy_einfo (const char *fmt __attribute__ ((__unused__)), ...)
{
}
...
# 119 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c"
static void
simple_save_output_info (bfd *abfd __attribute__ ((__unused__)),
    asection *section,
    void *ptr)
{
...
static void
simple_restore_output_info (bfd *abfd __attribute__ ((__unused__)),
       asection *section,
       void *ptr)
{
  struct saved_offsets *saved_offsets = (struct saved_offsets *) ptr;
...
# 173 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/simple.c"
bfd_byte *
        ...
        asymbol **symbol_table)
{
  ...
  if ((abfd->flags & (0x1 | 0x2 | 0x40)) != 0x1
      || ! (sec->flags & 0x4))
    {
      contents = outbuf;
      ...
      if (data == ((void*)0))
 {
  ...
  if (saved_offsets.sections == ((void*)0))
    {
      if (data)
 free (data);
      _bfd_generic_link_hash_table_free (abfd);
  ...
  if (symbol_table == ((void*)0))
    {
      ...
      storage_needed = ((*((abfd)->xvec->_bfd_get_symtab_upper_bound)) (abfd));
      symbol_table = (asymbol **) bfd_malloc (storage_needed);
      ((*((abfd)->xvec->_bfd_canonicalize_symtab)) (abfd, symbol_table));
    }
  else
    storage_needed = 0;
