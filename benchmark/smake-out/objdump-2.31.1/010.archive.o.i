# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
# 134 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 135 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 136 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
...
# 137 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 138 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
...
# 139 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
# 1 "./../include/aout/ranlib.h" 1
# 44 "./../include/aout/ranlib.h"
struct symdef
  {
    union
      {
...
# 140 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
...
# 141 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
...
# 144 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c" 2
# 155 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
struct ar_cache
{
  file_ptr ptr;
  bfd *arbfd;
};
# 172 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
void
...
_bfd_ar_sizepad (char *p, size_t n, bfd_size_type size)
{
  ...
  snprintf (buf, sizeof (buf), "%-10" "l" "u", size);
  len = strlen (buf);
  if (len > n)
    {
...
_bfd_generic_mkarchive (bfd *abfd)
{
  ...
  if (((abfd)->tdata.aout_ar_data) == ((void*)0))
    return 0;
# 229 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
  return 1;
}
# 254 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
symindex
...
# 294 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
bfd_boolean
...
{
  htab_t hash_table = ((arch_bfd)->tdata.aout_ar_data)->cache;
  struct ar_cache m;
...
_bfd_add_bfd_to_archive_cache (bfd *arch_bfd, file_ptr filepos, bfd *new_elt)
{
  ...
  if (hash_table == ((void*)0))
    {
      hash_table = htab_create_alloc (16, hash_file_ptr, eq_file_ptr,
          ((void*)0), _bfd_calloc_wrapper, free);
      if (hash_table == ((void*)0))
 return 0;
  ...
  *htab_find_slot (hash_table, (const void *) cache, INSERT) = cache;
  ...
  ((struct areltdata *) ((new_elt)->arelt_data))->parent_cache = hash_table;
  ((struct areltdata *) ((new_elt)->arelt_data))->key = filepos;
...
get_extended_arelt_filename (bfd *arch, const char *name, file_ptr *originp)
{
  ...
  if ((*__errno_location ()) != 0 || table_index >= ((arch)->tdata.aout_ar_data)->extended_names_size)
    {
      bfd_set_error (bfd_error_malformed_archive);
      return ((void*)0);
    }
  ...
  if (((arch)->is_thin_archive) && endp != ((void*)0) && *endp == ':')
    {
      file_ptr origin = strtol (endp + 1, ((void*)0), 10);
      ...
      if ((*__errno_location ()) != 0)
 {
  ...
  return ((arch)->tdata.aout_ar_data)->extended_names + table_index;
}
# 474 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
void *
...
_bfd_generic_read_ar_hdr_mag (bfd *abfd, const char *mag)
{
 ...
 bfd_set_error (bfd_error_no_more_archived_files);
  ...
  hdr.ar_fmag[0] = 0;
  scan = sscanf (hdr.ar_size, "%" "l" "u", &parsed_size);
 ...
 return ((void*)0);
  ...
  else if ((hdr.ar_name[0] == '#' && hdr.ar_name[1] == '1' && hdr.ar_name[2] == '/' && (_sch_istable[(hdr.ar_name[3]) & 0xff] & (unsigned short)(_sch_isdigit))))
    {
      ...
      if (bfd_bread (filename, namelen, abfd) != namelen)
 {
   ...
   return ((void*)0);
  ...
  else
    {
      ...
      char *e;
      e = (char *) memchr (hdr.ar_name, '\0', ((abfd)->xvec->ar_max_namelen));
      if (e == ((void*)0))
 {
   e = (char *) memchr (hdr.ar_name, '/', ((abfd)->xvec->ar_max_namelen));
   if (e == ((void*)0))
     e = (char *) memchr (hdr.ar_name, ' ', ((abfd)->xvec->ar_max_namelen));
 }
...
_bfd_get_elt_at_filepos (bfd *archive, file_ptr filepos)
{
 ...
 bfd_set_error (bfd_error_malformed_archive);
  ...
  n_bfd->flags |= archive->flags & (0x4000
        | 0x8000
        | 0x20000);
...
_bfd_generic_get_elt_at_index (bfd *abfd, symindex sym_index)
{
  ...
  entry = ((abfd)->tdata.aout_ar_data)->symdefs + sym_index;
  return _bfd_get_elt_at_filepos (abfd, entry->file_offset);
}

bfd *
_bfd_noarchive_get_elt_at_index (bfd *abfd,
     symindex sym_index __attribute__ ((__unused__)))
{
  return (bfd *) _bfd_ptr_bfd_null_error (abfd);
}
# 781 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
bfd *
...
bfd_generic_openr_next_archived_file (bfd *archive, bfd *last_file)
{
  ...
  if (!last_file)
  ...
  else
    {
      ...
      if (! ((archive)->is_thin_archive))
 {
   bfd_size_type size = (((struct areltdata *)((last_file)->arelt_data))->parsed_size);
...
_bfd_noarchive_openr_next_archived_file (bfd *archive,
      bfd *last_file __attribute__ ((__unused__)))
{
...
bfd_generic_archive_p (bfd *abfd)
{
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  ((abfd)->is_thin_archive) = (strncmp (armag, "!<thin>\012", 8) == 0);

  if (strncmp (armag, "!<arch>\012", 8) != 0
      && ! ((abfd)->is_thin_archive))
    {
      bfd_set_error (bfd_error_wrong_format);
...
# 877 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
  if (!((*((abfd)->xvec->_bfd_slurp_armap)) (abfd))
      || !((*((abfd)->xvec->_bfd_slurp_extended_name_table)) (abfd)))
    {
      if (bfd_get_error () != bfd_error_system_call)
 bfd_set_error (bfd_error_wrong_format);
  ...
  if (abfd->target_defaulted && ((abfd)->has_armap))
    {
      bfd *first;
# 902 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
      first = bfd_openr_next_archived_file (abfd, ((void*)0));
      if (first != ((void*)0))
 {
   first->target_defaulted = 0;
...
# 936 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
static bfd_boolean
do_slurp_bsd_armap (bfd *abfd)
{
 ...
 bfd_set_error (bfd_error_malformed_archive);
  ...
  ardata->symdef_count = ((*((abfd)->xvec->bfd_h_getx32)) (raw_armap)) / 8;
  ...
  for (counter = 0, set = ardata->symdefs;
       ...
       counter++, set++, rbase += 8)
    {
      set->name = ((*((abfd)->xvec->bfd_h_getx32)) (rbase)) + stringbase;
      set->file_offset = ((*((abfd)->xvec->bfd_h_getx32)) (rbase + 4));
    }
...
bfd_slurp_armap (bfd *abfd)
{
  ...
  if ((strncmp ((nextname), ("__.SYMDEF       "), sizeof ("__.SYMDEF       ") - 1) == 0)
      || (strncmp ((nextname), ("__.SYMDEF/      "), sizeof ("__.SYMDEF/      ") - 1) == 0))
    return do_slurp_bsd_armap (abfd);
  else if ((strncmp ((nextname), ("/               "), sizeof ("/               ") - 1) == 0))
    return do_slurp_coff_armap (abfd);
  else if ((strncmp ((nextname), ("/SYM64/         "), sizeof ("/SYM64/         ") - 1) == 0))
    {
  ...
  else if ((strncmp ((nextname), ("#1/20           "), sizeof ("#1/20           ") - 1) == 0))
    {
 ...
 return 0;
      if (bfd_seek (abfd, -(file_ptr) (sizeof (hdr) + 20), 1) != 0)
 return 0;
      extname[20] = 0;
      if ((strncmp ((extname), ("__.SYMDEF SORTED"), sizeof ("__.SYMDEF SORTED") - 1) == 0)
   || (strncmp ((extname), ("__.SYMDEF"), sizeof ("__.SYMDEF") - 1) == 0))
 return do_slurp_bsd_armap (abfd);
    }
...
# 1197 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
bfd_boolean
_bfd_slurp_extended_name_table (bfd *abfd)
{
  ...
  if (bfd_seek (abfd, ((abfd)->tdata.aout_ar_data)->first_file_filepos, 0) != 0)
    return 0;
 ...
 return 0;
      ...
      if (! (strncmp ((nextname), ("ARFILENAMES/    "), sizeof ("ARFILENAMES/    ") - 1) == 0)
   && ! (strncmp ((nextname), ("//              "), sizeof ("//              ") - 1) == 0))
 {
   ((abfd)->tdata.aout_ar_data)->extended_names = ((void*)0);
   ((abfd)->tdata.aout_ar_data)->extended_names_size = 0;
   return 1;
 }
 ...
 goto byebye;
      ...
      ((abfd)->tdata.aout_ar_data)->extended_names = (char *) bfd_zalloc (abfd, amt + 1);
 ...
 byebye:
   ...
   return 0;
      ...
      if (bfd_bread (((abfd)->tdata.aout_ar_data)->extended_names, amt, abfd) != amt)
 {
   if (bfd_get_error () != bfd_error_system_call)
     bfd_set_error (bfd_error_malformed_archive);
   bfd_release (abfd, (((abfd)->tdata.aout_ar_data)->extended_names));
   ((abfd)->tdata.aout_ar_data)->extended_names = ((void*)0);
   goto byebye;
 }
      ...
      {
 char *ext_names = ((abfd)->tdata.aout_ar_data)->extended_names;
 char *temp = ext_names;
...
# 1318 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
static const char *
normalize (bfd *abfd __attribute__ ((__unused__)), const char *file)
{
  return lbasename (file);
}
# 1347 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
static const char *
adjust_relative_path (const char * path, const char * ref_path)
{
  static char *pathbuf = ((void*)0);
  ...
  pathp = lpath == ((void*)0) ? path : lpath;

  rpath = lrealpath (ref_path);
  refp = rpath == ((void*)0) ? ref_path : rpath;
      ...
      while (dir_down && down > pwd)
 {
   if ((((*down) == '/') || (((*down) == '\\') && (0))))
     --dir_down;
      ...
      do { if (!(dir_down == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c",1418); } while (0);
      len += strlen (down) + 1;
    }
  else
    down = ((void*)0);
...
{
  *name = "ARFILENAMES/";
  return _bfd_construct_extended_name_table (abfd, 0, tabloc, tablen);
}
...
{
  *name = "//";
  return _bfd_construct_extended_name_table (abfd, 1, tabloc, tablen);
}

bfd_boolean
_bfd_noarchive_construct_extended_name_table (bfd *abfd __attribute__ ((__unused__)),
           char **tabloc __attribute__ ((__unused__)),
           bfd_size_type *len __attribute__ ((__unused__)),
           const char **name __attribute__ ((__unused__)))
{
  return 1;
}
# 1495 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
bfd_boolean
        ...
        bfd_size_type *tablen)
{
      ...
      if (((abfd)->is_thin_archive))
 {
   ...
   if (current->my_archive
       && ! ((current->my_archive)->is_thin_archive))
   ...
   if (! (((((filename)[0]) == '/') || ((((filename)[0]) == '\\') && (0))) || ((filename)[0] && ((filename)[1] == ':') && (0)))
       && ! (((((abfd->filename)[0]) == '/') || ((((abfd->filename)[0]) == '\\') && (0))) || ((abfd->filename)[0] && ((abfd->filename)[1] == ':') && (0))))
      ...
      if (((abfd)->is_thin_archive))
 {
   ...
   else if (! (((((filename)[0]) == '/') || ((((filename)[0]) == '\\') && (0))) || ((filename)[0] && ((filename)[1] == ':') && (0)))
     && ! (((((abfd->filename)[0]) == '/') || ((((abfd->filename)[0]) == '\\') && (0))) || ((abfd->filename)[0] && ((abfd->filename)[1] == ':') && (0))))
     normal = adjust_relative_path (filename, abfd->filename);
   else
     normal = filename;
      ...
      else
 {
   ...
   if (normal == ((void*)0))
     return 0;
      ...
      thislen = strlen (normal);
      if (thislen > maxname || ((abfd)->is_thin_archive))
 {
   ...
   if (normal == last_filename)
   ...
   else
     {
       ...
       if (! trailing_slash)
  strptr[thislen] = "`\012"[1];
       else
  {
    strptr[thislen] = '/';
    strptr[thislen + 1] = "`\012"[1];
  }
       stroff = strptr - *tabloc;
       last_stroff = stroff;
     }
   hdr->ar_name[0] = ((current)->xvec->ar_pad_char);
   if (((abfd)->is_thin_archive) && current->origin > 0)
     {
        ...
        const char **name)
{
      ...
      if (len > maxname || has_space)
 {
   ...
   len = (len + 3) & ~3;
   ((struct areltdata *) ((current)->arelt_data))->extra_size = len;
...
{
  struct ar_hdr *hdr = ((struct ar_hdr *) ((struct areltdata *) ((abfd)->arelt_data))->arch_header);
...
_bfd_bsd44_write_ar_hdr (bfd *archive, bfd *abfd)
{
  ...
  if ((hdr->ar_name[0] == '#' && hdr->ar_name[1] == '1' && hdr->ar_name[2] == '/' && (_sch_istable[(hdr->ar_name[3]) & 0xff] & (unsigned short)(_sch_isdigit))))
    {
      ...
      do { if (!(padded_len == ((struct areltdata *) ((abfd)->arelt_data))->extra_size)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c",1757); } while (0);

      if (!_bfd_ar_sizepad (hdr->ar_size, sizeof (hdr->ar_size),
       ((struct areltdata *) ((abfd)->arelt_data))->parsed_size + padded_len))
 return 0;
...
bfd_boolean
_bfd_noarchive_write_ar_hdr (bfd *archive, bfd *abfd __attribute__ ((__unused__)))
{
  return _bfd_bool_bfd_false_error (archive);
}
# 1823 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
...
bfd_ar_hdr_from_filesystem (bfd *abfd, const char *filename, bfd *member)
{
  ...
  if ((abfd->flags & 0x2000) != 0)
    {
      status.st_mtim.tv_sec = 0;
      status.st_uid = 0;
      status.st_gid = 0;
      status.st_mode = 0644;
    }
...
bfd_generic_stat_arch_elt (bfd *abfd, struct stat *buf)
{
  ...
  if (hdr == ((void*)0))
    return -1;
# 1955 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
  buf->st_mtim.tv_sec = strtol (hdr->ar_date, &aloser, 10); if (aloser == hdr->ar_date) return -1;;
  ...
  if (filename == ((void*)0))
    {
      ...
      _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c", 1988, __PRETTY_FUNCTION__);
    }
...
# 2034 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
void
...
void
_bfd_noarchive_truncate_arname (bfd *abfd __attribute__ ((__unused__)),
    const char *pathname __attribute__ ((__unused__)),
    char *arhdr __attribute__ ((__unused__)))
{
}
...
_bfd_write_archive_contents (bfd *arch)
{
  ...
  bfd_boolean makemap = ((arch)->has_armap);

  bfd_boolean hasobjects = 0;
  bfd_size_type wrote;
  int tries;
  char *armag;
      ...
      if ((elength % 2) == 1)
 {
  ...
  for (current = arch->archive_head;
    ...
    {
      char buffer[8192];
      bfd_size_type remaining = (((struct areltdata *)((current)->arelt_data))->parsed_size);


      if (!((*((current)->xvec->_bfd_write_ar_hdr_fn)) (arch, current)))
 return 0;
      if (((arch)->is_thin_archive))
 continue;
      ...
      do
 {
   if (((*((arch)->xvec->_bfd_update_armap_timestamp)) (arch)))
     break;
   _bfd_error_handler
     (dgettext ("bfd", "warning: writing archive was slow: rewriting timestamp"));
 }
      while (++tries < 6);
    }
       ...
       for (src_count = 0; src_count < symcount; src_count++)
  {
        ...
        if (orl_count == orl_max)
   {
     ...
     && strcmp (syms[src_count]->name
         ...
         "__gnu_lto_slim") == 0)
   _bfd_error_handler
     (dgettext ("bfd", "%pB: plugin needed to handle lto object"),
      current);
        ...
        int stridx)
{
  ...
  first = mapsize + elength + sizeof (struct ar_hdr) + 8;
# 2445 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
  ((arch)->tdata.aout_ar_data)->armap_timestamp = 0;
  uid = 0;
  gid = 0;
  if ((arch->flags & 0x2000) == 0)
    {
      struct stat statbuf;

      if (stat (arch->filename, &statbuf) == 0)
 ((arch)->tdata.aout_ar_data)->armap_timestamp = (statbuf.st_mtim.tv_sec
           + 60);
      uid = getuid();
      gid = getgid();
    }
  ...
  memset (&hdr, ' ', sizeof (struct ar_hdr));
  memcpy (hdr.ar_name, "__.SYMDEF", strlen ("__.SYMDEF"));
  ((arch)->tdata.aout_ar_data)->armap_datepos = (8
          + __builtin_offsetof(struct ar_hdr, ar_date[0]));
  ...
  if (bfd_bwrite (&hdr, sizeof (struct ar_hdr), arch)
      != sizeof (struct ar_hdr))
    return 0;
  ((*((arch)->xvec->bfd_h_putx32)) (ranlibsize, temp));
      ...
      if (map[count].u.abfd != last_elt)
 {
   do
     {
       struct areltdata *ared = ((struct areltdata *) ((current)->arelt_data));
      ...
      if (firstreal != (file_ptr) offset)
 {
   ...
   return 0;
      ...
      last_elt = current;
      ((*((arch)->xvec->bfd_h_putx32)) (map[count].namidx, buf));
      ((*((arch)->xvec->bfd_h_putx32)) (firstreal, buf + 4));
      if (bfd_bwrite (buf, 8, arch)
   != 8)
 return 0;
    }


  ((*((arch)->xvec->bfd_h_putx32)) (stringsize, temp));
  if (bfd_bwrite (temp, sizeof (temp), arch) != sizeof (temp))
    return 0;
  for (count = 0; count < orl_count; count++)
    {
...
_bfd_archive_bsd_update_armap_timestamp (bfd *arch)
{
  ...
  if (bfd_stat (arch, &archstat) == -1)
    {
      bfd_perror (dgettext ("bfd", "Reading archive file mod timestamp"));


      return 1;
    }
  if (((long) archstat.st_mtim.tv_sec) <= ((arch)->tdata.aout_ar_data)->armap_timestamp)

    return 1;


  ((arch)->tdata.aout_ar_data)->armap_timestamp = archstat.st_mtim.tv_sec + 60;
  ...
  if (bfd_seek (arch, ((arch)->tdata.aout_ar_data)->armap_datepos, 0) != 0
   ...
   != sizeof (hdr.ar_date)))
    {
      bfd_perror (dgettext ("bfd", "Writing updated armap timestamp"));
...
# 2608 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
bfd_boolean
         ...
         int stridx)
{
  ...
  first_archive_member_file_ptr = (mapsize
       ...
       + sizeof (struct ar_hdr)
       + 8);
# 2668 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c"
  memset (&hdr, ' ', sizeof (struct ar_hdr));
  hdr.ar_name[0] = '/';
  if (!_bfd_ar_sizepad (hdr.ar_size, sizeof (hdr.ar_size), mapsize))
    return 0;
  ...
  while (current != ((void*)0) && count < symbol_count)
    {
...
_bfd_noarchive_write_armap
    (bfd *arch __attribute__ ((__unused__)),
     unsigned int elength __attribute__ ((__unused__)),
     struct orl *map __attribute__ ((__unused__)),
     unsigned int orl_count __attribute__ ((__unused__)),
     int stridx __attribute__ ((__unused__)))
{
  return 1;
}

static int
archive_close_worker (void **slot, void *inf __attribute__ ((__unused__)))
{
...
{
  if (((abfd)->direction == read_direction || (abfd)->direction == both_direction) && abfd->format == bfd_archive)
    {
      bfd *nbfd;
      bfd *next;
      htab_t htab;
      ...
      for (nbfd = abfd->nested_archives; nbfd; nbfd = next)
 {
   ...
   bfd_close (nbfd);
      ...
      if (htab)
 {
   htab_traverse_noresize (htab, archive_close_worker, ((void*)0));
   htab_delete (htab);
   ((abfd)->tdata.aout_ar_data)->cache = ((void*)0);
 }
    }
  if (((struct areltdata *) ((abfd)->arelt_data)) != ((void*)0))
    {
      struct areltdata *ared = ((struct areltdata *) ((abfd)->arelt_data));
      ...
      if (htab)
 {
   ...
   if (slot != ((void*)0))
     {
       do { if (!(((struct ar_cache *) *slot)->arbfd == abfd)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/archive.c",2806); } while (0);
