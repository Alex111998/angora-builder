# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c" 2
# 21 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c"
# 1 "./sysdep.h" 1
# 34 "./sysdep.h"
# 1 "./config.h" 1
# 35 "./sysdep.h" 2
...
# 44 "./sysdep.h" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c" 2
...
extern void init_disassemble_info (struct disassemble_info *dinfo, void *stream,
       fprintf_ftype fprintf_func);
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c" 2
# 1 "./opintl.h" 1
# 24 "./opintl.h"
...
# 25 "./opintl.h" 2
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c" 2
        ...
        struct disassemble_info *info)
{
  if (status != 5)
    ...
    info->fprintf_func (info->stream, dgettext ("opcodes", "Unknown error %d\n"), status);
  else
    {
      char buf[30];
      ...
      sprintf (buf, "%08" "l" "x", memaddr);
      info->fprintf_func (info->stream,
     dgettext ("opcodes", "Address 0x%s is out of bounds.\n"), buf);
    }
}
# 81 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/opcodes/dis-buf.c"
void
generic_print_address (bfd_vma addr, struct disassemble_info *info)
{
  char buf[30];

  sprintf (buf, "%08" "l" "x", addr);
...
int
generic_symbol_at_address (bfd_vma addr __attribute__ ((__unused__)),
...
bfd_boolean
generic_symbol_is_valid (asymbol * sym __attribute__ ((__unused__)),
    struct disassemble_info *info __attribute__ ((__unused__)))
{
  return 1;
}
