# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
# 39 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
# 1 "./sysdep.h" 1
# 29 "./sysdep.h"
# 1 "./config.h" 1
# 30 "./sysdep.h" 2
...
# 189 "./sysdep.h" 2
# 40 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
# 1 "./bfd.h" 1
# 43 "./bfd.h"
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
# 1 "./libbfd.h" 1
# 58 "./libbfd.h"
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 42 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
...
# 43 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
# 1 "./libcoff.h" 1
# 29 "./libcoff.h"
...
# 44 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c" 2
     ...
     unsigned int target_index)
{
  ...
  if (((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_set_long_section_names) (abfd, (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_long_section_names)))
      && hdr->s_name[0] == '/')
    {
      char buf[(8)];
      long strindex;
      ...
      ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_set_long_section_names) (abfd, 1));
      memcpy (buf, hdr->s_name + 1, (8) - 1);
      buf[(8) - 1] = '\0';
      ...
      if (*p == '\0' && strindex >= 0)
 {
   ...
   if (strings == ((void*)0))
     return 0;
   if ((bfd_size_type)(strindex + 2) >= (((abfd)->tdata.coff_obj_data)->strings_len))
     return 0;
   strings += strindex;
 ...
 return 0;
  ...
  ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_set_alignment_hook) (abfd, return_section, hdr));
  ...
  if (! ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_styp_to_sec_flags_hook) (abfd, hdr, name, return_section, & flags)))
  ...
  if ((return_section->flags & 0x4000000) != 0)
    return_section->lineno_count = 0;

  if (hdr->s_nreloc != 0)
    return_section->flags |= 0x4;

  if (hdr->s_scnptr != 0)
    return_section->flags |= 0x100;
      ...
      else if (!bfd_is_section_compressed (abfd, return_section))
 {
   ...
   if ((abfd->flags & 0x4000) && return_section->size != 0)
     action = compress;
 }
 ...
 case compress:
  ...
  (dgettext ("bfd", "%pB: unable to initialize compress status for section %s"),
   ...
   if (return_section->compress_status == 1)
     {
       if (name[1] != 'z')
  {
      ...
      struct internal_aouthdr *internal_a)
{
  ...
  bfd_vma ostart = ((abfd)->start_address);
  void * tdata;
  void * tdata_save;
  ...
  if (!(internal_f->f_flags & (0x0001)))
    abfd->flags |= 0x1;
  if ((internal_f->f_flags & (0x0002)))
    abfd->flags |= 0x2;
  if (!(internal_f->f_flags & (0x0004)))
    abfd->flags |= 0x4;
  if (!(internal_f->f_flags & (0x0008)))
    abfd->flags |= 0x20;


  if ((internal_f->f_flags & (0x0002)) != 0)
    abfd->flags |= 0x100;
  ...
  if (internal_a != (struct internal_aouthdr *) ((void*)0))
  ...
  tdata = ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_mkobject_hook) (abfd, (void *) internal_f, (void *) internal_a));
  if (tdata == ((void*)0))
    goto fail2;

  scnhsz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_scnhsz);
  ...
  if (! ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_set_arch_mach_hook) (abfd, (void *) internal_f)))
    goto fail;
      ...
      for (i = 0; i < nscns; i++)
 {
   ...
   ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_scnhdr_in) (abfd, (void *) (external_sections + i * scnhsz), (void *) & tmp));
...
coff_object_p (bfd *abfd)
{
  ...
  filhsz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filhsz);
  aoutsz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_aoutsz);
 ...
 bfd_set_error (bfd_error_wrong_format);
  ...
  ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_filehdr_in) (abfd, filehdr, &internal_f));
  bfd_release (abfd, filehdr);
# 353 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
 ...
 memset (((char *) opthdr) + internal_f.f_opthdr, 0, aoutsz - internal_f.f_opthdr);
      ...
      ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_aouthdr_in) (abfd, opthdr, (void *) &internal_a));
      bfd_release (abfd, opthdr);
    }
...
coff_section_from_bfd_index (bfd *abfd, int section_index)
{
  ...
  if (section_index == ((int)-1))
    return (&_bfd_std_section[2]);
  if (section_index == ((int)0))
    return (&_bfd_std_section[1]);
  if (section_index == ((int)-2))
    return (&_bfd_std_section[2]);
...
coff_get_symtab_upper_bound (bfd *abfd)
{
  ...
  return (((abfd)->symcount) + 1) * (sizeof (coff_symbol_type *));
}
...
coff_canonicalize_symtab (bfd *abfd, asymbol **alocation)
{
  ...
  symbase = (((abfd)->tdata.coff_obj_data)->symbols);
    ...
    char *buf)
{
  ...
  if (sym->_n._n_n._n_zeroes != 0
  ...
  else
    {
      ...
      do { if (!(sym->_n._n_n._n_offset >= 4)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",468); } while (0);
      strings = (((abfd)->tdata.coff_obj_data)->strings);
      if (strings == ((void*)0))
 {
   strings = _bfd_coff_read_string_table (abfd);
   if (strings == ((void*)0))
     return ((void*)0);
      ...
      if ((((abfd)->tdata.coff_obj_data)->strings_len) > 0
   && sym->_n._n_n._n_offset >= (((abfd)->tdata.coff_obj_data)->strings_len))
 return ((void*)0);
      return strings + sym->_n._n_n._n_offset;
    }
}
# 494 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
struct internal_reloc *
    ...
    struct internal_reloc *internal_relocs)
{
  ...
  if (((struct coff_section_tdata *) (sec)->used_by_bfd) != ((void*)0)
      && ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs != ((void*)0))
    {
      if (! require_internal)
 return ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs;
      memcpy (internal_relocs, ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs,
       sec->reloc_count * sizeof (struct internal_reloc));
      return internal_relocs;
    }

  relsz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_relsz);
 ...
 goto error_return;
  ...
  if (bfd_seek (abfd, sec->rel_filepos, 0) != 0
 ...
 goto error_return;
  ...
  for (; erel < erel_end; erel += relsz, irel++)
    ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_reloc_in) (abfd, (void *) erel, (void *) irel));
      ...
      if (((struct coff_section_tdata *) (sec)->used_by_bfd) == ((void*)0))
 {
   ...
   if (sec->used_by_bfd == ((void*)0))
     goto error_return;
   ((struct coff_section_tdata *) (sec)->used_by_bfd)->contents = ((void*)0);
 }
      ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs = free_internal;
    }
...
{
  unsigned int limit = ((abfd)->symcount);
  unsigned int i;
  int total = 0;
  asymbol **p;
  asection *s;
 ...
 total += s->lineno_count;
  ...
  for (s = abfd->sections; s != ((void*)0); s = s->next)
    do { if (!(s->lineno_count == 0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",605); } while (0);

  for (p = abfd->outsymbols, i = 0; i < limit; i++, p++)
    {
      asymbol *q_maybe = *p;

      if ((((((q_maybe)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((q_maybe)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour))
 {
   coff_symbol_type *q = ((coff_symbol_type *)(&((q_maybe)->the_bfd)));
       ...
       do
  {
    ...
    if (! ( ((sec) == (&_bfd_std_section[2])) || ((sec) == (&_bfd_std_section[1])) || ((sec) == (&_bfd_std_section[0])) || ((sec) == (&_bfd_std_section[3]))))
      sec->lineno_count ++;
      ...
      struct internal_syment *syment)
{
  ...
  if (coff_symbol_ptr->symbol.section
      && (((coff_symbol_ptr->symbol.section)->flags & 0x1000) != 0))
    {

      syment->n_scnum = ((int)0);
      syment->n_value = coff_symbol_ptr->symbol.value;
    }
  else if ((coff_symbol_ptr->symbol.flags & (1 << 2)) != 0
    && (coff_symbol_ptr->symbol.flags & (1 << 17)) == 0)
    {
      syment->n_value = coff_symbol_ptr->symbol.value;
    }
  else if (((coff_symbol_ptr->symbol.section) == (&_bfd_std_section[1])))
    {
      syment->n_scnum = ((int)0);
      syment->n_value = 0;
    }
      ...
      if (coff_symbol_ptr->symbol.section)
 {
   ...
   if (! (((abfd)->tdata.coff_obj_data)->pe))
     {
       syment->n_value += (syment->n_sclass == 20)
 ...
 {
   do { if (!(0)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",686); } while (0);

   syment->n_scnum = ((int)-1);
   syment->n_value = coff_symbol_ptr->symbol.value;
 }
    }
}
# 701 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
bfd_boolean
coff_renumber_symbols (bfd *bfd_ptr, int *first_undef)
{
  unsigned int symbol_count = ((bfd_ptr)->symcount);
  asymbol **symbol_ptr_ptr = bfd_ptr->outsymbols;
  unsigned int native_index = 0;
  struct internal_syment *last_file = ((void*)0);
  unsigned int symbol_index;
# 720 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
  {
    asymbol **newsyms;
    unsigned int i;
    bfd_size_type amt;
    ...
    for (i = 0; i < symbol_count; i++)
      if ((symbol_ptr_ptr[i]->flags & (1 << 10)) != 0
   || (!((symbol_ptr_ptr[i]->section) == (&_bfd_std_section[1]))
       && !(((symbol_ptr_ptr[i]->section)->flags & 0x1000) != 0)
       && ((symbol_ptr_ptr[i]->flags & (1 << 3)) != 0
    || ((symbol_ptr_ptr[i]->flags & ((1 << 1) | (1 << 7)))
        == 0))))
 ...
 *newsyms++ = symbol_ptr_ptr[i];
  ...
  for (symbol_index = 0; symbol_index < symbol_count; symbol_index++)
    {
      ...
      coff_symbol_ptr = (((((((symbol_ptr_ptr[symbol_index])->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((symbol_ptr_ptr[symbol_index])->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((symbol_ptr_ptr[symbol_index])->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (symbol_ptr_ptr[symbol_index]) : ((void*)0));
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",769); } while (0);
   if (s->u.syment.n_sclass == 103)
     {
       if (last_file != ((void*)0))
 ...
 native_index++;
  ...
  (((bfd_ptr)->tdata.coff_obj_data)->conv_table_size) = native_index;
...
coff_mangle_symbols (bfd *bfd_ptr)
{
      ...
      if (coff_symbol_ptr && coff_symbol_ptr->native)
 {
   ...
   do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",814); } while (0);
   if (s->fix_value)
     {
  ...
  (coff_symbol_ptr->symbol.section->output_section->line_filepos
   + s->u.syment.n_value * (((bfd_coff_backend_data *) (bfd_ptr)->xvec->backend_data)->_bfd_linesz));
       coff_symbol_ptr->symbol.section =
  coff_section_from_bfd_index (bfd_ptr, ((int)-2));
       do { if (!(coff_symbol_ptr->symbol.flags & (1 << 2))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",833); } while (0);
     }
   for (i = 0; i < s->u.syment.n_numaux; i++)
     {
       combined_entry_type *a = s + i + 1;

       do { if (!(! a->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",839); } while (0);
       if (a->fix_tag)
  {
        ...
        bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",883); } while (0);
  if (native->u.syment.n_sclass == 103
      && native->u.syment.n_numaux > 0)
    {
      unsigned int filnmlen;

      if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings))
 {
 ...
 strncpy (native->u.syment._n._n_name, ".file", 8);

      do { if (!(! (native + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",899); } while (0);
      auxent = &(native + 1)->u.auxent;

      filnmlen = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filnmlen);

      if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_long_filenames))
 {
   if (name_length <= filnmlen)
     strncpy (auxent->x_file.x_fname, name, filnmlen);
   else
     {
       auxent->x_file.x_n.x_offset = *string_size_p + 4;
      ...
      else
 {
   ...
   if (name_length > filnmlen)
    ...
    {
      if (name_length <= 8 && !(((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings))

 strncpy (native->u.syment._n._n_name, symbol->name, 8);

      else if (!((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_symname_in_debug) (abfd, &native->u.syment)))
 {
      ...
      else
 {
   file_ptr filepos;
   bfd_byte buf[4];
   int prefix_len = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_debug_string_prefix_length);
   ...
   if (*debug_string_section_p == (asection *) ((void*)0))
     *debug_string_section_p = bfd_get_section_by_name (abfd, ".debug");
   filepos = bfd_tell (abfd);
   if (prefix_len == 4)
     ((*((abfd)->xvec->bfd_putx32)) (((bfd_vma) (name_length + 1)),(buf)));
   else
     ((*((abfd)->xvec->bfd_putx16)) (((bfd_vma) (name_length + 1)),(buf)));
   ...
   if (!bfd_set_section_contents (abfd,
     ...
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c", 965, __PRETTY_FUNCTION__);
   if (bfd_seek (abfd, filepos, 0) != 0)
     _bfd_abort ("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c", 967, __PRETTY_FUNCTION__);
   native->u.syment._n._n_n._n_offset =
...
# 984 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
static bfd_boolean
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1002); } while (0);

  if (native->u.syment.n_sclass == 103)
    symbol->flags |= (1 << 2);

  if (symbol->flags & (1 << 2)
      && ((symbol->section) == (&_bfd_std_section[2])))
    native->u.syment.n_scnum = ((int)-2);

  else if (((symbol->section) == (&_bfd_std_section[2])))
    native->u.syment.n_scnum = ((int)-1);

  else if (((symbol->section) == (&_bfd_std_section[1])))
    native->u.syment.n_scnum = ((int)0);
  ...
  symesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_symesz);
  buf = bfd_alloc (abfd, symesz);
  if (!buf)
    return 0;
  ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_sym_out) (abfd, &native->u.syment, buf));
  ...
  if (native->u.syment.n_numaux > 0)
    {
      ...
      auxesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_auxesz);
      buf = bfd_alloc (abfd, auxesz);
      if (!buf)
 return 0;
      for (j = 0; j < native->u.syment.n_numaux; j++)
 {
   do { if (!(! (native + j + 1)->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1044); } while (0);
   ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_aux_out) (abfd,&((native + j + 1)->u.auxent),type,n_sclass,(int) j,native->u.syment.n_numaux,buf));
    ...
    bfd_size_type *debug_string_size_p)
{
  ...
  asection *output_section = symbol->section->output_section
          ? symbol->section->output_section
          : symbol->section;
  struct bfd_link_info *link_info = ((abfd)->tdata.coff_obj_data)->link_info;
  bfd_boolean ret;

  if ((!link_info || link_info->strip_discarded)
      && !((symbol->section) == (&_bfd_std_section[2]))
      && symbol->section->output_section == (&_bfd_std_section[2]))
    {
      symbol->name = "";
      if (isym != ((void*)0))
 memset (isym, 0, sizeof (*isym));
  ...
  native->u.syment.n_numaux = 0;
  if (((symbol->section) == (&_bfd_std_section[1])))
    {
      native->u.syment.n_scnum = ((int)0);
      native->u.syment.n_value = symbol->value;
    }
  else if ((((symbol->section)->flags & 0x1000) != 0))
    {
      native->u.syment.n_scnum = ((int)0);
      native->u.syment.n_value = symbol->value;
    }
  else if (symbol->flags & (1 << 14))
    {
      native->u.syment.n_scnum = ((int)-2);
      native->u.syment.n_numaux = 1;
    }
  else if (symbol->flags & (1 << 2))
    {
 ...
 native->u.syment.n_value += output_section->vma;
      ...
      {
 coff_symbol_type *c = (((((((symbol)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((symbol)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((symbol)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (symbol) : ((void*)0));
 if (c != (coff_symbol_type *) ((void*)0))
  ...
  native->u.syment.n_type = 0;
  if (symbol->flags & (1 << 14))
    native->u.syment.n_sclass = 103;
  else if (symbol->flags & (1 << 0))
    native->u.syment.n_sclass = 3;
  else if (symbol->flags & (1 << 7))
    native->u.syment.n_sclass = (((abfd)->tdata.coff_obj_data)->pe) ? 105 : 127;
  else
    native->u.syment.n_sclass = 2;

  ret = coff_write_symbol (abfd, symbol, native, written, string_size_p,
      debug_string_section_p, debug_string_size_p);
  if (isym != ((void*)0))
    *isym = native->u.syment;
  if (iaux != ((void*)0) && native->u.syment.n_numaux)
     ...
     bfd_size_type *debug_string_size_p)
{
  ...
  if ((!link_info || link_info->strip_discarded)
      && !((symbol->symbol.section) == (&_bfd_std_section[2]))
      && symbol->symbol.section->output_section == (&_bfd_std_section[2]))
    {
      symbol->symbol.name = "";
      return 1;
    }

  do { if (!(native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1184); } while (0);
      ...
      while (lineno[count].line_number != 0)
 {
   ...
   count++;
      ...
      symbol->done_lineno = 1;

      if (! ( ((symbol->symbol.section->output_section) == (&_bfd_std_section[2])) || ((symbol->symbol.section->output_section) == (&_bfd_std_section[1])) || ((symbol->symbol.section->output_section) == (&_bfd_std_section[0])) || ((symbol->symbol.section->output_section) == (&_bfd_std_section[3]))))
 symbol->symbol.section->output_section->moving_line_filepos +=
   count * (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_linesz);
    }
...
static void
null_error_handler (const char *fmt __attribute__ ((__unused__)),
...
coff_write_symbols (bfd *abfd)
{
      ...
      for (o = abfd->sections; o != ((void*)0); o = o->next)
 {
  ...
  if (bfd_seek (abfd, (((abfd)->tdata.coff_obj_data)->sym_filepos), 0) != 0)
    return 0;
  ...
  for (p = abfd->outsymbols, i = 0; i < limit; i++, p++)
    {
      asymbol *symbol = *p;
      coff_symbol_type *c_symbol = (((((((symbol)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((symbol)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((symbol)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (symbol) : ((void*)0));

      if (c_symbol == (coff_symbol_type *) ((void*)0)
   || c_symbol->native == (combined_entry_type *) ((void*)0))
 {
   if (!coff_write_alien_symbol (abfd, symbol, ((void*)0), ((void*)0), &written,
 ...
 {
   if (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_classify_symbol != ((void*)0))
     {
       ...
       do { if (!(c_symbol->native->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1295); } while (0);
       sym_class = ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_classify_symbol) (abfd, &c_symbol->native->u.syment));

       (void) bfd_set_error_handler (current_error_handler);

       n_sclass = &c_symbol->native->u.syment.n_sclass;
# 1309 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
       if (symbol->flags & (1 << 7))
  *n_sclass = (((abfd)->tdata.coff_obj_data)->pe) ? 105 : 127;
       else if (symbol->flags & (1 << 0) && sym_class != COFF_SYMBOL_LOCAL)
  *n_sclass = 3;
       else if (symbol->flags & (1 << 1)
         && (sym_class != COFF_SYMBOL_GLOBAL



      || *n_sclass == 127))
  c_symbol->native->u.syment.n_sclass = 2;
     }
  ...
  (((abfd)->tdata.coff_obj_data)->raw_syment_count) = written;
  ...
  if (string_size != 0)
    {
      ...
      ((*((abfd)->xvec->bfd_h_putx32)) (size, buffer));
    ...
    i++, p++)
 {
   ...
   coff_symbol_type *c_symbol = (((((((q)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((q)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((q)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (q) : ((void*)0));
   size_t maxlen;
# 1382 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
   if (c_symbol == ((void*)0)
       || c_symbol->native == ((void*)0))


     maxlen = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings) ? 0 : 8;

   else if (! c_symbol->native->is_sym)
     maxlen = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings) ? 0 : 8;

   else if (((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_symname_in_debug) (abfd, &c_symbol->native->u.syment)))



     maxlen = name_length;

   else if (c_symbol->native->u.syment.n_sclass == 103
       ...
       if ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings))
  {
    if (bfd_bwrite (".file", (bfd_size_type) 6, abfd) != 6)
      return 0;
       ...
       maxlen = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filnmlen);
     }
   else
     maxlen = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_force_symnames_in_strings) ? 0 : 8;
  ...
  return 0;
  ...
  else
    {
      ...
      if (bfd_bwrite ((void *) buffer, (bfd_size_type) 4, abfd)
   != 4)
 return 0;
    }
  ...
  do { if (!(debug_string_size == 0 || (debug_string_section != (asection *) ((void*)0) && (((((bfd_vma) (debug_string_size) + (1 << debug_string_section->alignment_power) - 1) >= (bfd_vma) (debug_string_size)) ? (((bfd_vma) (debug_string_size) + ((1 << debug_string_section->alignment_power) - 1)) & ~ (bfd_vma) ((1 << debug_string_section->alignment_power)-1)) : ~ (bfd_vma) 0) == debug_string_section->size)))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1445); } while (0);
...
coff_write_linenumbers (bfd *abfd)
{
  ...
  linesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_linesz);
      ...
      if (s->lineno_count)
 {
   ...
   if (bfd_seek (abfd, s->line_filepos, 0) != 0)
     return 0;
  ...
  {
    alent *l =
    ((*((((p)->the_bfd))->xvec->_get_lineno)) (((p)->the_bfd), p));
    ...
    if (l)
      {
        ...
        ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_lineno_out) (abfd, &out, buff));
...
alent *
coff_get_lineno (bfd *ignore_abfd __attribute__ ((__unused__)), asymbol *symbol)
{
  return ((coff_symbol_type *)(&((symbol)->the_bfd)))->lineno;
}
       ...
       combined_entry_type *auxent)
{
  ...
  do { if (!(symbol->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1529); } while (0);
  if (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_pointerize_aux_hook)
    {
      if ((*((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_pointerize_aux_hook)
 ...
 return;
  ...
  if (n_sclass == 3 && type == 0)
    return;
  if (n_sclass == 103)
    return;

  do { if (!(! auxent->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1543); } while (0);




  if (((((unsigned long) (type) & ((abfd)->tdata.coff_obj_data)->local_n_tmask) == ((unsigned long) (2) << ((abfd)->tdata.coff_obj_data)->local_n_btshft)) || ((n_sclass) == 10 || (n_sclass) == 12 || (n_sclass) == 15) || n_sclass == 100
       || n_sclass == 101)
      && auxent->u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l > 0
      && auxent->u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l
      < (long) (((abfd)->tdata.coff_obj_data)->raw_syment_count))
    {
...
build_debug_section (bfd *abfd, asection ** sect_return)
{
  ...
  if (bfd_seek (abfd, sect->filepos, 0) != 0
      || bfd_bread (debug_section, sec_size, abfd) != sec_size
      || bfd_seek (abfd, position, 0) != 0)
    return ((void*)0);
...
copy_name (bfd *abfd, char *name, size_t maxlen)
{
  ...
  if ((newname = (char *) bfd_alloc (abfd, (bfd_size_type) len + 1)) == ((void*)0))
    return ((void*)0);
...
_bfd_coff_get_external_symbols (bfd *abfd)
{
  ...
  if ((((abfd)->tdata.coff_obj_data)->external_syms) != ((void*)0))
    return 1;

  symesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_symesz);

  size = (((abfd)->tdata.coff_obj_data)->raw_syment_count) * symesz;
  if (size == 0)
    return 1;

  if (size < (((abfd)->tdata.coff_obj_data)->raw_syment_count)
      || (bfd_get_file_size (abfd) > 0
   && size > bfd_get_file_size (abfd)))

    {
      _bfd_error_handler (dgettext ("bfd", "%pB: corrupt symbol count: %#" "ll" "x" ""),
     abfd, (uint64_t) (((abfd)->tdata.coff_obj_data)->raw_syment_count));
      return 0;
    }
  ...
  if (syms == ((void*)0))
    {
      ...
      _bfd_error_handler (dgettext ("bfd", "%pB: not enough memory to allocate space " "for %#" "ll" "x" " symbols of size %#" "ll" "x"),
 ...
 free (syms);
  ...
  (((abfd)->tdata.coff_obj_data)->external_syms) = syms;
  return 1;
}
...
_bfd_coff_read_string_table (bfd *abfd)
{
  ...
  if ((((abfd)->tdata.coff_obj_data)->strings) != ((void*)0))
    return (((abfd)->tdata.coff_obj_data)->strings);

  if ((((abfd)->tdata.coff_obj_data)->sym_filepos) == 0)
    {
      bfd_set_error (bfd_error_no_symbols);
      return ((void*)0);
    }

  pos = (((abfd)->tdata.coff_obj_data)->sym_filepos);
  pos += (((abfd)->tdata.coff_obj_data)->raw_syment_count) * (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_symesz);
 ...
 return ((void*)0);
  ...
  else
    {
      ...
      strsize = ((*((abfd)->xvec->bfd_h_getx32)) (extstrsize));



    }

  if (strsize < 4 || strsize > bfd_get_file_size (abfd))
    {
      _bfd_error_handler

 (dgettext ("bfd", "%pB: bad string table size %" "ll" "u"), abfd, (uint64_t) strsize);
  ...
  if (bfd_bread (strings + 4, strsize - 4, abfd)
      != strsize - 4)
    {
      free (strings);
      return ((void*)0);
  ...
  (((abfd)->tdata.coff_obj_data)->strings) = strings;
  (((abfd)->tdata.coff_obj_data)->strings_len) = strsize;
...
{
  if (! (((abfd)->xvec->flavour) == bfd_target_coff_flavour || ((abfd)->xvec->flavour) == bfd_target_xcoff_flavour))
    return 0;

  if ((((abfd)->tdata.coff_obj_data)->external_syms) != ((void*)0)
      && ! (((abfd)->tdata.coff_obj_data)->keep_syms))
    {
      free ((((abfd)->tdata.coff_obj_data)->external_syms));
      (((abfd)->tdata.coff_obj_data)->external_syms) = ((void*)0);
    }

  if ((((abfd)->tdata.coff_obj_data)->strings) != ((void*)0)
      && ! (((abfd)->tdata.coff_obj_data)->keep_strings))
    {
      free ((((abfd)->tdata.coff_obj_data)->strings));
      (((abfd)->tdata.coff_obj_data)->strings) = ((void*)0);
      (((abfd)->tdata.coff_obj_data)->strings_len) = 0;
    }
...
coff_get_normalized_symtab (bfd *abfd)
{
  ...
  char *raw_src;
  char *raw_end;
  const char *string_table = ((void*)0);
  asection * debug_sec = ((void*)0);
  char *debug_sec_data = ((void*)0);
  bfd_size_type size;

  if ((((abfd)->tdata.coff_obj_data)->raw_syments) != ((void*)0))
    return (((abfd)->tdata.coff_obj_data)->raw_syments);

  if (! _bfd_coff_get_external_symbols (abfd))
    return ((void*)0);

  size = (((abfd)->tdata.coff_obj_data)->raw_syment_count) * sizeof (combined_entry_type);

  if (size < (((abfd)->tdata.coff_obj_data)->raw_syment_count))
    return ((void*)0);
  internal = (combined_entry_type *) bfd_zalloc (abfd, size);
  if (internal == ((void*)0) && size != 0)
    return ((void*)0);
  internal_end = internal + (((abfd)->tdata.coff_obj_data)->raw_syment_count);

  raw_src = (char *) (((abfd)->tdata.coff_obj_data)->external_syms);


  symesz = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_symesz);
  raw_end = (char *) raw_src + (((abfd)->tdata.coff_obj_data)->raw_syment_count) * symesz;
  ...
  for (internal_ptr = internal;
       ...
       raw_src += symesz, internal_ptr++)
    {
      ...
      internal_ptr->is_sym = 1;


      if (symbol_ptr->u.syment.n_sclass == 103
    ...
    i++)
 {
   ...
   raw_src += symesz;
   ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_swap_aux_in) (abfd,(void *) raw_src,symbol_ptr->u.syment.n_type,symbol_ptr->u.syment.n_sclass,(int) i,symbol_ptr->u.syment.n_numaux,&(internal_ptr->u.auxent)));





   internal_ptr->is_sym = 0;
  ...
  for (internal_ptr = internal; internal_ptr < internal_end;
       internal_ptr++)
    {
      do { if (!(internal_ptr->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1884); } while (0);

      if (internal_ptr->u.syment.n_sclass == 103
   && internal_ptr->u.syment.n_numaux > 0)
 {
   ...
   do { if (!(! aux->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1893); } while (0);
       ...
       if (string_table == ((void*)0))
  {
    ...
    >= (((abfd)->tdata.coff_obj_data)->strings_len))
  internal_ptr->u.syment._n._n_n._n_offset = (bfd_hostptr_t) dgettext ("bfd", "<corrupt>");
       else
  ...
  internal_ptr->u.syment._n._n_n._n_offset =
    ((bfd_hostptr_t)
     copy_name (abfd,
         aux->u.auxent.x_file.x_fname,
         (size_t) (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filnmlen)));
     }
 }
      else
 {
  ...
  return ((void*)0);
   ...
   else if (!((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_symname_in_debug) (abfd, &internal_ptr->u.syment)))
     {
       ...
       if (string_table == ((void*)0))
  {
    ...
    if (string_table == ((void*)0))
      return ((void*)0);
       ...
       if (internal_ptr->u.syment._n._n_n._n_offset >= (((abfd)->tdata.coff_obj_data)->strings_len)
  ...
  internal_ptr->u.syment._n._n_n._n_offset =
    ((bfd_hostptr_t)
   ...
   else
     {
       ...
       if (debug_sec_data == ((void*)0))
  debug_sec_data = build_debug_section (abfd, & debug_sec);
       if (debug_sec_data != ((void*)0))
  {
    do { if (!(debug_sec != ((void*)0))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1981); } while (0);
  ...
  (((abfd)->tdata.coff_obj_data)->raw_syments) = internal;
  do { if (!((((abfd)->tdata.coff_obj_data)->raw_syment_count) == (unsigned int) (internal_ptr - internal))) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",1999); } while (0);
...
coff_make_empty_symbol (bfd *abfd)
{
  ...
  new_symbol->native = ((void*)0);
  new_symbol->lineno = ((void*)0);
  new_symbol->done_lineno = 0;
...
coff_bfd_make_debug_symbol (bfd *abfd,
       ...
       unsigned long sz __attribute__ ((__unused__)))
{
  bfd_size_type amt = sizeof (coff_symbol_type);
  ...
  if (!new_symbol->native)
    return ((void*)0);
  new_symbol->native->is_sym = 1;
  new_symbol->symbol.section = (&_bfd_std_section[2]);
  new_symbol->symbol.flags = (1 << 2);
  new_symbol->lineno = ((void*)0);
  new_symbol->done_lineno = 0;
  new_symbol->symbol.the_bfd = abfd;
...
coff_get_symbol_info (bfd *abfd, asymbol *symbol, symbol_info *ret)
{
  ...
  if (((coff_symbol_type *)(&((symbol)->the_bfd)))->native != ((void*)0)
      && ((coff_symbol_type *)(&((symbol)->the_bfd)))->native->fix_value
      && ((coff_symbol_type *)(&((symbol)->the_bfd)))->native->is_sym)
    ret->value = ((coff_symbol_type *)(&((symbol)->the_bfd)))->native->u.syment.n_value -
      (bfd_hostptr_t) (((abfd)->tdata.coff_obj_data)->raw_syments);
}
  ...
  switch (how)
    ...
    case bfd_print_symbol_more:
      fprintf (file, "coff %s %s",
        ((coff_symbol_type *)(&((symbol)->the_bfd)))->native ? "n" : "g",
        ((coff_symbol_type *)(&((symbol)->the_bfd)))->lineno ? "l" : " ");
      break;

    case bfd_print_symbol_all:
      if (((coff_symbol_type *)(&((symbol)->the_bfd)))->native)
 {
   bfd_vma val;
   unsigned int aux;
   combined_entry_type *combined = ((coff_symbol_type *)(&((symbol)->the_bfd)))->native;
   combined_entry_type *root = (((abfd)->tdata.coff_obj_data)->raw_syments);
   struct lineno_cache_entry *l = ((coff_symbol_type *)(&((symbol)->the_bfd)))->lineno;

   fprintf (file, "[%3ld]", (long) (combined - root));


   if (combined < (((abfd)->tdata.coff_obj_data)->raw_syments)
       || combined >= (((abfd)->tdata.coff_obj_data)->raw_syments) + (((abfd)->tdata.coff_obj_data)->raw_syment_count))
     {
       fprintf (file, dgettext ("bfd", "<corrupt info> %s"), symbol->name);
       break;
     }

   do { if (!(combined->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",2113); } while (0);
   ...
   for (aux = 0; aux < combined->u.syment.n_numaux; aux++)
     {
       ...
       do { if (!(! auxp->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",2133); } while (0);
       if (auxp->fix_tag)
  ...
  tagndx = auxp->u.auxent.x_sym.x_tagndx.l;
       ...
       if (((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_print_aux) (abfd, file, root, combined, auxp, aux)))
  continue;
  ...
  case 2:
  case 111:
    if ((((unsigned long) (combined->u.syment.n_type) & ((abfd)->tdata.coff_obj_data)->local_n_tmask) == ((unsigned long) (2) << ((abfd)->tdata.coff_obj_data)->local_n_btshft)))
      {
        long next, llnos;
...
bfd_boolean
_bfd_coff_is_local_label_name (bfd *abfd __attribute__ ((__unused__)),
          const char *name)
{
       ...
       const struct dwarf_debug_section *debug_sections)
{
  ...
  coff_data_type *cof = ((abfd)->tdata.coff_obj_data);
  ...
  if (! _bfd_stab_section_find_nearest_line (abfd, symbols, section, offset,
          ...
          &((abfd)->tdata.coff_obj_data)->line_info))
    return 0;
  ...
  if (_bfd_dwarf2_find_nearest_line (abfd, symbols, ((void*)0), section, offset,
         ...
         line_ptr, ((void*)0), debug_sections, 0,
         &((abfd)->tdata.coff_obj_data)->dwarf2_find_line_info))
    return 1;
  ...
  if (((abfd)->tdata.coff_obj_data)->dwarf2_find_line_info != ((void*)0))
    {
      bfd_signed_vma bias;
      ...
      if (sec_data == ((void*)0) && section->owner == abfd)
 {
   ...
   sec_data = (struct coff_section_tdata *) section->used_by_bfd;
      ...
      if (sec_data != ((void*)0) && sec_data->saved_bias)
      ...
      else
 {
   ...
   if (sec_data)
     {
       sec_data->saved_bias = 1;
       sec_data->bias = bias;
     }
 }

      if (bias
   && _bfd_dwarf2_find_nearest_line (abfd, symbols, ((void*)0), section,
         offset + bias,
         filename_ptr, functionname_ptr,
         line_ptr, ((void*)0), debug_sections, 0,
         &((abfd)->tdata.coff_obj_data)->dwarf2_find_line_info))
  ...
  *line_ptr = 0;
  ...
  while (p < pend)
    {
      do { if (!(p->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",2343); } while (0);
      if (p->u.syment.n_sclass == 103)
 break;
      ...
      while (1)
 {
   ...
   for (p2 = p + 1 + p->u.syment.n_numaux;
     ...
     {
       do { if (!(p2->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",2367); } while (0);
       if (p2->u.syment.n_scnum > 0
    && (section
        == coff_section_from_bfd_index (abfd,
            p2->u.syment.n_scnum)))
  break;
       if (p2->u.syment.n_sclass == 103)
  {
    p2 = pend;
    break;
  }
   ...
   if (p > pend || p->u.syment.n_sclass != 103)
     break;
 }
    }
      ...
      for (; i < section->lineno_count; i++)
 {
       ...
       if (coff->native)
  {
    ...
    do { if (!(s->is_sym)) bfd_assert("/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c",2453); } while (0);
    s = s + 1 + s->u.syment.n_numaux;



    if (s->u.syment.n_scnum == ((int)-2))
      s = s + 1 + s->u.syment.n_numaux;
...
coff_sizeof_headers (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (!((info)->type == type_relocatable))
    size = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filhsz) + (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_aoutsz);
  else
    size = (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filhsz);

  size += abfd->section_count * (((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_scnhsz);
  return size;
}
      ...
      unsigned int symbol_class)
{
  ...
  csym = (((((((symbol)->the_bfd))->xvec->flavour) == bfd_target_coff_flavour || ((((symbol)->the_bfd))->xvec->flavour) == bfd_target_xcoff_flavour) && ((symbol)->the_bfd)->tdata.coff_obj_data) ? (coff_symbol_type *) (symbol) : ((void*)0));
  if (csym == ((void*)0))
    {
      bfd_set_error (bfd_error_invalid_operation);
      return 0;
      ...
      else
 {
   ...
   native->u.syment.n_flags = ((& csym->symbol)->the_bfd)->flags;
 }
      ...
      struct bfd_link_info *info)
{
  ...
  s_comdat = ((((abfd)->xvec->flavour) == bfd_target_coff_flavour && ((struct coff_section_tdata *) (sec)->used_by_bfd) != ((void*)0)) ? ((struct coff_section_tdata *) (sec)->used_by_bfd)->comdat : ((void*)0));
  ...
  for (l = already_linked_list->entry; l != ((void*)0); l = l->next)
    {
      ...
      l_comdat = ((((l->sec->owner)->xvec->flavour) == bfd_target_coff_flavour && ((struct coff_section_tdata *) (l->sec)->used_by_bfd) != ((void*)0)) ? ((struct coff_section_tdata *) (l->sec)->used_by_bfd)->comdat : ((void*)0));
# 2676 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
      if (((s_comdat != ((void*)0)) == (l_comdat != ((void*)0))
     ...
     bfd *abfd)
{
  ...
  ((((bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_slurp_symbol_table) (abfd));

  cookie->abfd = abfd;
  cookie->sym_hashes = (((abfd)->tdata.coff_obj_data)->sym_hashes);

  cookie->symbols = (((abfd)->tdata.coff_obj_data)->symbols);
...
static void
fini_reloc_cookie (struct coff_reloc_cookie *cookie __attribute__ ((__unused__)),
   ...
   asection *sec)
{
  ...
  cookie->rels = _bfd_coff_read_internal_relocs (abfd, sec, 0, ((void*)0), 0, ((void*)0));
   ...
   asection *sec)
{
  if (cookie->rels
      ...
      && ((struct coff_section_tdata *) (sec)->used_by_bfd)->relocs != cookie->rels)
    free (cookie->rels);
}
...
_bfd_coff_gc_mark_hook (asection *sec,
   struct bfd_link_info *info __attribute__ ((__unused__)),
   struct internal_reloc *rel __attribute__ ((__unused__)),
   ...
   struct internal_syment *sym)
{
 ...
 case bfd_link_hash_undefweak:
   if (h->symbol_class == 105 && h->numaux == 1)
     {
   ...
   struct coff_reloc_cookie *cookie)
{
 ...
 h = (struct coff_link_hash_entry *) h->root.u.i.link;
  ...
  return (*gc_mark_hook) (sec, info, cookie->rel, ((void*)0),
     &(cookie->symbols
       + (((sec->owner)->tdata.coff_obj_data)->conversion_table)[cookie->rel->r_symndx])->native->u.syment);
}
    ...
    struct coff_reloc_cookie *cookie)
{
  ...
  if (rsec && !rsec->gc_mark)
    {
      if (((rsec->owner)->xvec->flavour) != bfd_target_coff_flavour)
 rsec->gc_mark = 1;
...
_bfd_coff_gc_mark_extra_sections (struct bfd_link_info *info,
      coff_gc_mark_hook_fn mark_hook __attribute__ ((__unused__)))
{
  bfd *ibfd;
        ...
        void *data __attribute__ ((__unused__)))
{
  ...
  if ((h->root.type == bfd_link_hash_defined
      ...
      && !(h->root.u.def.section->owner->flags & 0x40))
    {
...
static bfd_boolean
coff_gc_sweep (bfd *abfd __attribute__ ((__unused__)), struct bfd_link_info *info)
{
  bfd *sub;
  ...
  for (sub = info->input_bfds; sub != ((void*)0); sub = sub->link.next)
    {
      ...
      if (((sub)->xvec->flavour) != bfd_target_coff_flavour)
 continue;

      for (o = sub->sections; o != ((void*)0); o = o->next)
 {

   if ((o->flags & (0x2000 | 0x100000)) != 0
       || (o->flags & (0x1 | 0x2 | 0x4)) == 0)
     o->gc_mark = 1;
   else if ((strncmp ((o->name), (".idata"), sizeof (".idata") - 1) == 0)
     || (strncmp ((o->name), (".pdata"), sizeof (".pdata") - 1) == 0)
     || (strncmp ((o->name), (".xdata"), sizeof (".xdata") - 1) == 0)
     || (strncmp ((o->name), (".rsrc"), sizeof (".rsrc") - 1) == 0))
     o->gc_mark = 1;
   ...
   if (info->print_gc_sections && o->size != 0)
    ...
    o, sub);
# 3058 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
 }
    }



  (bfd_link_hash_traverse (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (bfd_boolean (*) (struct bfd_link_hash_entry *, void *)) (coff_gc_sweep_symbol), (((void*)0))));
  ...
  for (sym = info->gc_sym_list; sym != ((void*)0); sym = sym->next)
    {
      ...
      h = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (sym->name), (0), (0), (0)));
...
bfd_boolean
bfd_coff_gc_sections (bfd *abfd __attribute__ ((__unused__)), struct bfd_link_info *info)
{
  bfd *sub;
# 3111 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/bfd/coffgen.c"
 ...
 continue;
      ...
      for (o = sub->sections; o != ((void*)0); o = o->next)
 {
   if (((o->flags & (0x8000 | 0x200000)) == 0x200000
        || (strncmp ((o->name), (".vectors"), sizeof (".vectors") - 1) == 0)
        || (strncmp ((o->name), (".ctors"), sizeof (".ctors") - 1) == 0)
        || (strncmp ((o->name), (".dtors"), sizeof (".dtors") - 1) == 0))
       && !o->gc_mark)
     {
