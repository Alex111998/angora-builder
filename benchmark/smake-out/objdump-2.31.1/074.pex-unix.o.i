# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
# 22 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
# 1 "./config.h" 1
# 23 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 24 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
# 1 "./pex-common.h" 1
# 24 "./pex-common.h"
# 1 "./config.h" 1
# 25 "./pex-common.h" 2
...
# 25 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
# 1 "./../include/environ.h" 1
# 31 "./../include/environ.h"
extern char **environ;
# 26 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 29 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 30 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 35 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 38 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 47 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
extern __pid_t wait4 (__pid_t __pid, int *__stat_loc, int __options,
        struct rusage *__usage) __attribute__ ((__nothrow__));
# 50 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 53 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 54 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
...
# 57 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c" 2
# 120 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
static pid_t pex_wait (struct pex_obj *, pid_t, int *, struct pex_time *);



static pid_t
pex_wait (struct pex_obj *obj __attribute__ ((__unused__)), pid_t pid, int *status,
   struct pex_time *time)
{
  pid_t ret;
  struct rusage r;
...
# 301 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
...
static int
pex_unix_open_read (struct pex_obj *obj __attribute__ ((__unused__)), const char *name,
...
static int
pex_unix_open_write (struct pex_obj *obj __attribute__ ((__unused__)), const char *name,
       int binary __attribute__ ((__unused__)), int append)
{


  return open (name, 01 | 0100
       | (append ? 02000 : 01000), (0400 | 0200 | (0400 >> 3) | (0200 >> 3) | ((0400 >> 3) >> 3) | ((0200 >> 3) >> 3)));
}



static int
pex_unix_close (struct pex_obj *obj __attribute__ ((__unused__)), int fd)
{
  return close (fd);
}
   ...
   const char *errmsg, int err)
{
  ...
  retval |= (write (2, obj->pname, strlen (obj->pname)) < 0);
  retval |= (write (2, ": error trying to exec '", strlen (": error trying to exec '")) < 0);
  retval |= (write (2, executable, strlen (executable)) < 0);
  retval |= (write (2, "': ", strlen ("': ")) < 0);
  retval |= (write (2, errmsg, strlen (errmsg)) < 0);
  retval |= (write (2, ": ", strlen (": ")) < 0);
  retval |= (write (2, xstrerror (err), strlen (xstrerror (err))) < 0);
  retval |= (write (2, "\n", strlen ("\n")) < 0);


  _exit (retval == 0 ? -1 : -2);
}
# 589 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
static pid_t
       ...
       int toclose, const char **errmsg, int *err)
{
 ...
 {
   if (dup2 (in, 0) < 0)
     pex_child_error (obj, executable, "dup2", (*__errno_location ()));
   if (close (in) < 0)
     pex_child_error (obj, executable, "close", (*__errno_location ()));
 }
      if (out != 1)
 {
   if (dup2 (out, 1) < 0)
      ...
      if ((flags & 0x2) != 0)
 {
   ...
   pex_child_error (obj, executable, "execvp", (*__errno_location ()));
 }
      else
 {
   execv (executable, argv);
   pex_child_error (obj, executable, "execv", (*__errno_location ()));
 }
...
static int
pex_unix_pipe (struct pex_obj *obj __attribute__ ((__unused__)), int *p,
        int binary __attribute__ ((__unused__)))
{
  return pipe (p);
}
...
static FILE *
pex_unix_fdopenr (struct pex_obj *obj __attribute__ ((__unused__)), int fd,
    int binary __attribute__ ((__unused__)))
{
  return fdopen (fd, "r");
}
...
static FILE *
pex_unix_fdopenw (struct pex_obj *obj __attribute__ ((__unused__)), int fd,
    int binary __attribute__ ((__unused__)))
{
  if (fcntl (fd, 2, 1) < 0)
    return ((void*)0);
...
static void
pex_unix_cleanup (struct pex_obj *obj __attribute__ ((__unused__)))
{
# 789 "/benchmark/RUNDIR-binutils-2.31.1/binutils-2.31.1/libiberty/./pex-unix.c"
}
