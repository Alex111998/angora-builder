# 1 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c" 2
# 26 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c"
# 1 "./ming.h" 1
# 45 "./ming.h"
...
# 27 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c" 2
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 29 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c" 2
void SWFShape_setLineStyle(SWFShape shape, unsigned short width,
                           byte r, byte g, byte b, byte a)
{
...
# 55 "/benchmark/RUNDIR-libming-4.8/BUILD/src/compat.c" 2
