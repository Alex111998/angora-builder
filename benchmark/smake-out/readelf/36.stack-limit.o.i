# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 340 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c" 2
# 36 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c"
# 1 "./config.h" 1
# 37 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c" 2
# 1 "./../include/ansidecl.h" 1
# 38 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c" 2
...
# 41 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c" 2
...
# 44 "/benchmark/RUNDIR-binutils-2.29/binutils-2.29/libiberty/./stack-limit.c" 2


void
stack_limit_increase (unsigned long pref __attribute__ ((__unused__)))
{
  ...
  if (getrlimit (RLIMIT_STACK, &rlim) == 0
      ...
      && rlim.rlim_cur < pref
      && (rlim.rlim_max == 0xffffffffffffffffuLL || rlim.rlim_cur < rlim.rlim_max))
    {
      rlim.rlim_cur = pref;
      if (rlim.rlim_max != 0xffffffffffffffffuLL && rlim.rlim_cur > rlim.rlim_max)
