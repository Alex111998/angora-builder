# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 32 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c"
...
# 33 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 34 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 35 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 36 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 38 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jerror.h" 1
# 39 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
extern void siglongjmp (sigjmp_buf __env, int __val)
     __attribute__ ((__nothrow__)) __attribute__ ((__noreturn__));
# 40 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 41 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h" 1
# 92 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
enum TJSAMP {
  ...
  TJSAMP_440,
# 131 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
  TJSAMP_411
};
# 143 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
static const int tjMCUWidth[6] = { 8, 16, 16, 8, 8, 32 };
# 154 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
static const int tjMCUHeight[6] = { 8, 8, 16, 8, 16, 8 };
# 165 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
enum TJPF {
  ...
  TJPF_ARGB,
# 250 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
  TJPF_CMYK,
...
# 264 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
static const int tjRedOffset[12] = {
  0, 2, 0, 2, 3, 1, -1, 0, 2, 3, 1, -1
};
# 275 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
...
# 296 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
...
# 315 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
enum TJCS {
  ...
  TJCS_RGB = 0,
# 339 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
  TJCS_YCbCr,
  ...
  TJCS_CMYK,
# 364 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
  TJCS_YCCK
};
# 431 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
enum TJERR {
...
# 452 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
enum TJXOP {
...
# 552 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
typedef struct {
...
typedef struct tjtransform {
  ...
  void *data;
# 643 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
...
# 680 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          tjhandle tjInitCompress(void);
# 743 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjCompress2(tjhandle handle, const unsigned char *srcBuf,
                          int width, int pitch, int height, int pixelFormat,
                          unsigned char **jpegBuf, unsigned long *jpegSize,
                          int jpegSubsamp, int jpegQual, int flags);
# 809 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjCompressFromYUV(tjhandle handle, const unsigned char *srcBuf,
                                int width, int pad, int height, int subsamp,
                                unsigned char **jpegBuf,
                                unsigned long *jpegSize, int jpegQual,
                                int flags);
# 882 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjCompressFromYUVPlanes(tjhandle handle,
                                      ...
                                      unsigned long *jpegSize, int jpegQual,
                                      int flags);
# 913 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          unsigned long tjBufSize(int width, int height, int jpegSubsamp);
# 933 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          unsigned long tjBufSizeYUV2(int width, int pad, int height,
                                      int subsamp);
# 958 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          unsigned long tjPlaneSizeYUV(int componentID, int width, int stride,
                                       int height, int subsamp);
# 976 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjPlaneWidth(int componentID, int width, int subsamp);
# 993 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjPlaneHeight(int componentID, int height, int subsamp);
# 1045 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjEncodeYUV3(tjhandle handle, const unsigned char *srcBuf,
                           int width, int pitch, int height, int pixelFormat,
                           unsigned char *dstBuf, int pad, int subsamp,
                           int flags);
# 1105 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjEncodeYUVPlanes(tjhandle handle, const unsigned char *srcBuf,
                                int width, int pitch, int height,
                                int pixelFormat, unsigned char **dstPlanes,
                                int *strides, int subsamp, int flags);
# 1117 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          tjhandle tjInitDecompress(void);
# 1146 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecompressHeader3(tjhandle handle,
                                  const unsigned char *jpegBuf,
                                  unsigned long jpegSize, int *width,
                                  int *height, int *jpegSubsamp,
                                  int *jpegColorspace);
# 1163 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          tjscalingfactor *tjGetScalingFactors(int *numscalingfactors);
# 1216 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecompress2(tjhandle handle, const unsigned char *jpegBuf,
                            unsigned long jpegSize, unsigned char *dstBuf,
                            int width, int pitch, int height, int pixelFormat,
                            int flags);
# 1268 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecompressToYUV2(tjhandle handle, const unsigned char *jpegBuf,
                                 unsigned long jpegSize, unsigned char *dstBuf,
                                 int width, int pad, int height, int flags);
# 1325 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecompressToYUVPlanes(tjhandle handle,
                                      const unsigned char *jpegBuf,
                                      unsigned long jpegSize,
                                      unsigned char **dstPlanes, int width,
                                      int *strides, int height, int flags);
# 1380 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecodeYUV(tjhandle handle, const unsigned char *srcBuf,
                          int pad, int subsamp, unsigned char *dstBuf,
                          int width, int pitch, int height, int pixelFormat,
                          int flags);
# 1439 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDecodeYUVPlanes(tjhandle handle,
                                const unsigned char **srcPlanes,
                                const int *strides, int subsamp,
                                unsigned char *dstBuf, int width, int pitch,
                                int height, int pixelFormat, int flags);
# 1452 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          tjhandle tjInitTransform(void);
# 1515 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjTransform(tjhandle handle, const unsigned char *jpegBuf,
                          unsigned long jpegSize, int n,
                          unsigned char **dstBufs, unsigned long *dstSizes,
                          tjtransform *transforms, int flags);
# 1529 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjDestroy(tjhandle handle);
# 1545 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          unsigned char *tjAlloc(int bytes);
# 1591 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          unsigned char *tjLoadImage(const char *filename, int *width,
                                     int align, int *height, int *pixelFormat,
                                     int flags);
# 1628 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjSaveImage(const char *filename, unsigned char *buffer,
                          int width, int pitch, int height, int pixelFormat,
                          int flags);
# 1643 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          void tjFree(unsigned char *buffer);
# 1656 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          char *tjGetErrorStr2(tjhandle handle);
# 1669 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
          int tjGetErrorCode(tjhandle handle);
# 1697 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./turbojpeg.h"
...
# 42 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./tjutil.h" 1
# 47 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./tjutil.h"
extern double getTime(void);
# 43 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/transupp.h" 1
# 87 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/transupp.h"
typedef enum {
  JXFORM_NONE,
  JXFORM_FLIP_H,
  JXFORM_FLIP_V,
...
typedef struct {
  ...
  boolean crop;
  boolean slow_hflip;
# 135 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/transupp.h"
...
extern boolean jtransform_perfect_transform(JDIMENSION image_width,
                                             ...
                                             JXFORM_CODE transform);
# 195 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/transupp.h"
typedef enum {
  JCOPYOPT_NONE,
  JCOPYOPT_COMMENTS,
  JCOPYOPT_ALL,
...
extern void jcopy_markers_execute(j_decompress_ptr srcinfo,
                                   j_compress_ptr dstinfo,
                                   JCOPY_OPTION option);
# 44 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./jpegcomp.h" 1
# 45 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h" 1
# 17 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h"
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jinclude.h" 1
# 23 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jinclude.h"
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jconfig.h" 1
# 24 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jinclude.h" 2
...
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 39 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jinclude.h" 2
# 18 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h" 2

# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/jerror.h" 1
# 20 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h" 2
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h" 1
# 35 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h"
typedef enum {
...
JTRC_BMP_OS2,
JTRC_BMP_OS2_MAPPED,
# 77 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h"
JERR_PPM_COLORSPACE,
JERR_PPM_NONNUMERIC,
JERR_PPM_NOT,
JERR_PPM_OUTOFRANGE,
...
JTRC_PPM,
JTRC_PPM_TEXT,
# 112 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h"
JERR_TGA_NOTCOMP,
...
# 21 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h" 2
...
# 86 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/./cdjpeg.h"
...
# 46 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
...
# 1 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h" 1
# 41 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/cderror.h"
((void*)0),
...
# 71 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c" 2
 ((void*)0)
};
...
static int cs2pf[17] = {
  ...
  TJPF_RGB,
# 162 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c"
  TJPF_UNKNOWN, TJPF_CMYK, TJPF_UNKNOWN, TJPF_RGB, TJPF_RGBX, TJPF_BGR,
  TJPF_BGRX, TJPF_XBGR, TJPF_XRGB, TJPF_RGBA, TJPF_BGRA, TJPF_ABGR, TJPF_ARGB,
  TJPF_UNKNOWN
};
# 217 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c"
                           ...
                           int subsamp, int jpegQual, int flags)
{
  ...
  if ((env = getenv("TJ_RESTART")) != ((void*)0) && strlen(env) > 0) {
    ...
    if (sscanf(env, "%d%c", &temp, &tempc) >= 1 && temp >= 0 &&
        temp <= 65535) {
      if ((__extension__ ({ int __res; if (sizeof (tempc) > 1) { if (__builtin_constant_p (tempc)) { int __c = (tempc); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (tempc); } else __res = (*__ctype_toupper_loc ())[(int) (tempc)]; __res; })) == 'B') {
          ...
          unsigned long tjBufSize(int width, int height, int jpegSubsamp)
{
  ...
  retval = ((width + (mcuw) - 1) & (~((mcuw) - 1))) * ((height + (mcuh) - 1) & (~((mcuh) - 1))) * (2ULL + chromasf) + 2048ULL;
  if (retval > (unsigned long long)((unsigned long)-1))
    { snprintf(errStr, 200, "%s", "tjBufSize(): Image is too large"); retval = -1; goto bailout; };
          ...
          unsigned long TJBUFSIZE(int width, int height)
{
  ...
  retval = ((width + (16) - 1) & (~((16) - 1))) * ((height + (16) - 1) & (~((16) - 1))) * 6ULL + 2048ULL;
  if (retval > (unsigned long long)((unsigned long)-1))
    { snprintf(errStr, 200, "%s", "TJBUFSIZE(): Image is too large"); retval = -1; goto bailout; };
                                      ...
                                      int subsamp)
{
  ...
  if (retval > (unsigned long long)((unsigned long)-1))
    { snprintf(errStr, 200, "%s", "tjBufSizeYUV2(): Image is too large"); retval = -1; goto bailout; };
                                       ...
                                       int height, int subsamp)
{
  ...
  if (retval > (unsigned long long)((unsigned long)-1))
    { snprintf(errStr, 200, "%s", "tjPlaneSizeYUV(): Image is too large"); retval = -1; goto bailout; };
                           ...
                           int flags)
{
  ...
  if (width <= 0 || height <= 0 || dstBuf == ((void*)0) || pad < 0 ||
      !(((pad) & (pad - 1)) == 0) || subsamp < 0 || subsamp >= 6)
                                ...
                                int height, int pixelFormat, int flags)
{
  ...
  dinfo->progressive_mode = dinfo->inputctl->has_multiple_scans = 0;
...
# 1707 "/benchmark/RUNDIR-libjpeg-2.0.4/libjpeg-turbo-2.0.4/turbojpeg.c"
  ...
  for (i = 0; i < n; i++) {
    ...
    if (xinfo[i].crop) {
      if ((t[i].r.x % xinfo[i].iMCU_sample_width) != 0 ||
        ...
        snprintf(this->errStr, 200,
                 "To crop this JPEG image, x must be a multiple of %d\n"
                 "and y must be a multiple of %d.\n",
                 xinfo[i].iMCU_sample_width, xinfo[i].iMCU_sample_height);
        this->isInstanceError = 1;
        retval = -1; goto bailout;
      }
    }
  }
