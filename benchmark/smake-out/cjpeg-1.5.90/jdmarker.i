# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c" 2
# 19 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
...
# 20 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c" 2
...
# 21 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c" 2
...
# 199 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static boolean
...

{
  ...
  while (length > 0) {
    ...
    do { if (bytes_in_buffer == 0) { if (!(*datasrc->fill_input_buffer) (cinfo)) { return 0; } ( next_input_byte = datasrc->next_input_byte, bytes_in_buffer = datasrc->bytes_in_buffer ); }; bytes_in_buffer--; val = (*next_input_byte++); } while (0);
...
# 432 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static boolean
...

{
  ...
  while (length > 16) {
    ...
    memset((void *)(&huffval[count]), 0, (size_t)((256 - count) * sizeof(UINT8)));
    ...
    memcpy((void *)((*htblptr)->huffval), (const void *)(huffval), (size_t)(sizeof((*htblptr)->huffval)));
  }
...
# 600 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static void
...

{
  ...
  if (datalen >= 14 &&
    ...
    totallen -= 14;
    if (totallen !=
        ((JLONG)(data[12]) * (JLONG)(data[13]) * (JLONG)3))
...
# 890 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static boolean
...
# 968 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static int
...
# 1129 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
static boolean
...
# 1208 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
boolean
...
# 1316 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
void
...
# 1365 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdmarker.c"
void
