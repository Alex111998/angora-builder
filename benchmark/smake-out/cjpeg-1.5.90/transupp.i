# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
# 23 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
...
# 24 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
...
# 25 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
...
extern void jcopy_markers_execute(j_decompress_ptr srcinfo,
                                   j_compress_ptr dstinfo,
                                   JCOPY_OPTION option);
# 26 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jpegcomp.h" 1
# 27 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
...
# 28 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c" 2
# 91 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
static void
...

{
  ...
  JCOEFPTR src_ptr, dst_ptr;
  jpeg_component_info *compptr;
# 278 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
  MCU_rows = srcinfo->output_height /
             (dstinfo->max_v_samp_factor * 8);
        ...
        for (dst_blk_x = 0; dst_blk_x < compptr->width_in_blocks;
          ...
          src_buffer = (*srcinfo->mem->access_virt_barray)
            ((j_common_ptr)srcinfo, src_coef_arrays[ci],
             ...
             (JDIMENSION)compptr->h_samp_factor, 0);
...
do_transverse(j_decompress_ptr srcinfo, j_compress_ptr dstinfo,
              ...
              jvirt_barray_ptr *src_coef_arrays,
              jvirt_barray_ptr *dst_coef_arrays)
# 662 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
{
  JDIMENSION MCU_cols, MCU_rows, comp_width, comp_height, dst_blk_x, dst_blk_y;
  JDIMENSION x_crop_blocks, y_crop_blocks;
  int ci, i, j, offset_x, offset_y;
...
# 798 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
boolean
...
# 892 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
boolean
    ...
    if (qtblptr != ((void*)0)) {
      for (i = 0; i < 8; i++) {
        for (j = 0; j < i; j++) {
          ...
          qtblptr->quantval[i * 8 + j] =
            qtblptr->quantval[j * 8 + i];
...
# 1343 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
jvirt_barray_ptr *
...
# 1391 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
  switch (info->transform) {
  case JXFORM_TRANSPOSE:
  case JXFORM_TRANSVERSE:
  case JXFORM_ROT_90:
...
# 1431 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
...
# 1456 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
void
...
# 1528 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
boolean
...
# 1567 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
void
...
# 1595 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/transupp.c"
void
