# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c" 2
# 54 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
...
# 55 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c" 2
...
# 56 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c" 2
# 1 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdct.h" 1
# 39 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdct.h"
typedef short DCTELEM;
typedef unsigned short UDCTELEM;
typedef unsigned int UDCTELEM2;
# 66 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdct.h"
...
# 93 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jdct.h"
...
extern void jpeg_idct_16x16(j_decompress_ptr cinfo,
                             jpeg_component_info *compptr, JCOEFPTR coef_block,
                             JSAMPARRAY output_buf, JDIMENSION output_col);
# 57 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c" 2
# 172 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  wsptr = workspace;
  for (ctr = 8; ctr > 0; ctr--) {
# 206 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
    if (inptr[8 * 1] == 0 && inptr[8 * 2] == 0 &&
        inptr[8 * 3] == 0 && inptr[8 * 4] == 0 &&
        inptr[8 * 5] == 0 && inptr[8 * 6] == 0 &&
        inptr[8 * 7] == 0) {

      int dcval = ((JLONG)((unsigned long)((((ISLOW_MULT_TYPE)(inptr[8 * 0])) * (quantptr[8 * 0]))) << (2)));
    ...
    wsptr[8 * 0] = (int)(((tmp10 + tmp3) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 7] = (int)(((tmp10 - tmp3) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 1] = (int)(((tmp11 + tmp2) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 6] = (int)(((tmp11 - tmp2) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 2] = (int)(((tmp12 + tmp1) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 5] = (int)(((tmp12 - tmp1) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 3] = (int)(((tmp13 + tmp0) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
    wsptr[8 * 4] = (int)(((tmp13 - tmp0) + (((JLONG)1) << ((13 - 2) - 1))) >> (13 - 2));
...
# 314 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
    if (wsptr[1] == 0 && wsptr[2] == 0 && wsptr[3] == 0 && wsptr[4] == 0 &&
        wsptr[5] == 0 && wsptr[6] == 0 && wsptr[7] == 0) {

      JSAMPLE dcval = range_limit[(int)((((JLONG)wsptr[0]) + (((JLONG)1) << ((2 + 3) - 1))) >> (2 + 3)) & (255 * 4 + 3)];
    ...
    outptr[0] = range_limit[(int)(((tmp10 + tmp3) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[7] = range_limit[(int)(((tmp10 - tmp3) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[1] = range_limit[(int)(((tmp11 + tmp2) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[6] = range_limit[(int)(((tmp11 - tmp2) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[2] = range_limit[(int)(((tmp12 + tmp1) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[5] = range_limit[(int)(((tmp12 - tmp1) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[3] = range_limit[(int)(((tmp13 + tmp0) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &

                            (255 * 4 + 3)];
    outptr[4] = range_limit[(int)(((tmp13 - tmp0) + (((JLONG)1) << ((13 + 2 + 3) - 1))) >> (13 + 2 + 3)) &
...
# 426 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
              ...
              JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 7; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp13 += ((JLONG)1) << (13 - 2 - 1);

    z1 = (((ISLOW_MULT_TYPE)(inptr[8 * 2])) * (quantptr[8 * 2]));
    z2 = (((ISLOW_MULT_TYPE)(inptr[8 * 4])) * (quantptr[8 * 4]));
    z3 = (((ISLOW_MULT_TYPE)(inptr[8 * 6])) * (quantptr[8 * 6]));

    tmp10 = ((z2 - z3) * (((JLONG)((0.881747734) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = ((z1 - z2) * (((JLONG)((0.314692123) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = tmp10 + tmp12 + tmp13 - ((z2) * (((JLONG)((1.841218003) * (((JLONG)1) << 13) + 0.5))));
    tmp0 = z1 + z3;
    z2 -= tmp0;
    tmp0 = ((tmp0) * (((JLONG)((1.274162392) * (((JLONG)1) << 13) + 0.5)))) + tmp13;
    tmp10 += tmp0 - ((z3) * (((JLONG)((0.077722536) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += tmp0 - ((z1) * (((JLONG)((2.470602249) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp1 = ((z1 + z2) * (((JLONG)((0.935414347) * (((JLONG)1) << 13) + 0.5))));
    tmp2 = ((z1 - z2) * (((JLONG)((0.170262339) * (((JLONG)1) << 13) + 0.5))));
    tmp0 = tmp1 - tmp2;
    tmp1 += tmp2;
    tmp2 = ((z2 + z3) * (-((JLONG)((1.378756276) * (((JLONG)1) << 13) + 0.5))));
    tmp1 += tmp2;
    z2 = ((z1 + z3) * (((JLONG)((0.613604268) * (((JLONG)1) << 13) + 0.5))));
    tmp0 += z2;
  ...
  for (ctr = 0; ctr < 7; ctr++) {
    ...
    tmp13 = (JLONG)wsptr[0] + (((JLONG)1) << (2 + 2));
    tmp13 = ((JLONG)((unsigned long)(tmp13) << (13)));
...
# 575 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
              ...
              JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 6; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp10 = ((tmp2) * (((JLONG)((0.707106781) * (((JLONG)1) << 13) + 0.5))));
    tmp1 = tmp0 + tmp10;
    ...
    tmp1 = ((JLONG)((unsigned long)(z1 - z2 - z3) << (2)));
...
# 696 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
              ...
              JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 5; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    z2 = ((tmp0 - tmp1) * (((JLONG)((0.353553391) * (((JLONG)1) << 13) + 0.5))));
    z3 = tmp12 + z2;
    tmp10 = z3 + z1;
    tmp11 = z3 - z1;
    ...
    tmp0 = z1 + ((z2) * (((JLONG)((0.513743148) * (((JLONG)1) << 13) + 0.5))));
    tmp1 = z1 - ((z3) * (((JLONG)((2.176250899) * (((JLONG)1) << 13) + 0.5))));
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    tmp12 = (JLONG)wsptr[0] + (((JLONG)1) << (2 + 2));
    tmp12 = ((JLONG)((unsigned long)(tmp12) << (13)));
    tmp0 = (JLONG)wsptr[2];
    tmp1 = (JLONG)wsptr[4];
    z1 = ((tmp0 + tmp1) * (((JLONG)((0.790569415) * (((JLONG)1) << 13) + 0.5))));
...
# 811 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
              ...
              JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 3; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp12 = ((tmp2) * (((JLONG)((0.707106781) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp0 + tmp12;
...
# 901 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
              ...
              JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp3 = ((z3) * (((JLONG)((0.707106781) * (((JLONG)1) << 13) + 0.5))));
    tmp1 = tmp0 + tmp3;
    tmp2 = tmp0 - tmp3 - tmp3;

    tmp0 = ((z1 - z2) * (((JLONG)((0.707106781) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = tmp2 + tmp0;
    tmp14 = tmp2 - tmp0 - tmp0;

    tmp0 = ((z1 + z2) * (((JLONG)((1.328926049) * (((JLONG)1) << 13) + 0.5))));
    tmp2 = ((z1) * (((JLONG)((1.083350441) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp2 = ((z1 + z3) * (((JLONG)((0.909038955) * (((JLONG)1) << 13) + 0.5))));
    tmp3 = ((z1 + z4) * (((JLONG)((0.483689525) * (((JLONG)1) << 13) + 0.5))));
    tmp0 = tmp2 + tmp3 - z2;
...
# 1072 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    z1 = ((z4) * (((JLONG)((1.144122806) * (((JLONG)1) << 13) + 0.5))));
    z2 = ((z4) * (((JLONG)((0.437016024) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = z3 + z1;
    tmp11 = z3 - z2;

    tmp22 = ((z3 - ((JLONG)((unsigned long)(z1 - z2) << (1)))) >> (13 - 2));
    ...
    z1 = ((z2 + z3) * (((JLONG)((0.831253876) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = z1 + ((z2) * (((JLONG)((0.513743148) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = z1 - ((z3) * (((JLONG)((2.176250899) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp12 = ((tmp13) * (((JLONG)((0.309016994) * (((JLONG)1) << 13) + 0.5))));
    z5 = ((JLONG)((unsigned long)(z3) << (13)));

    z2 = ((tmp11) * (((JLONG)((0.951056516) * (((JLONG)1) << 13) + 0.5))));
    z4 = z5 + tmp12;

    tmp10 = ((z1) * (((JLONG)((1.396802247) * (((JLONG)1) << 13) + 0.5)))) + z2 + z4;
    tmp14 = ((z1) * (((JLONG)((0.221231742) * (((JLONG)1) << 13) + 0.5)))) - z2 + z4;

    z2 = ((tmp11) * (((JLONG)((0.587785252) * (((JLONG)1) << 13) + 0.5))));
    z4 = z5 - tmp12 - ((JLONG)((unsigned long)(tmp13) << (13 - 1)));

    tmp12 = ((JLONG)((unsigned long)(z1 - tmp13 - z3) << (2)));

    tmp11 = ((z1) * (((JLONG)((1.260073511) * (((JLONG)1) << 13) + 0.5)))) - z2 - z4;
    tmp13 = ((z1) * (((JLONG)((0.642039522) * (((JLONG)1) << 13) + 0.5)))) - z2 + z4;
...
# 1267 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp10 += ((JLONG)1) << (13 - 2 - 1);

    z1 = (((ISLOW_MULT_TYPE)(inptr[8 * 2])) * (quantptr[8 * 2]));
    z2 = (((ISLOW_MULT_TYPE)(inptr[8 * 4])) * (quantptr[8 * 4]));
    z3 = (((ISLOW_MULT_TYPE)(inptr[8 * 6])) * (quantptr[8 * 6]));

    tmp20 = ((z2 - z3) * (((JLONG)((2.546640132) * (((JLONG)1) << 13) + 0.5))));
    tmp23 = ((z2 - z1) * (((JLONG)((0.430815045) * (((JLONG)1) << 13) + 0.5))));
    z4 = z1 + z3;
    tmp24 = ((z4) * (-((JLONG)((1.155664402) * (((JLONG)1) << 13) + 0.5))));
    z4 -= z2;
    tmp25 = tmp10 + ((z4) * (((JLONG)((1.356927976) * (((JLONG)1) << 13) + 0.5))));
    tmp21 = tmp20 + tmp23 + tmp25 -
            ((z2) * (((JLONG)((1.821790775) * (((JLONG)1) << 13) + 0.5))));
    tmp20 += tmp25 + ((z3) * (((JLONG)((2.115825087) * (((JLONG)1) << 13) + 0.5))));
    tmp23 += tmp25 - ((z1) * (((JLONG)((1.513598477) * (((JLONG)1) << 13) + 0.5))));
    tmp24 += tmp25;
    tmp22 = tmp24 - ((z3) * (((JLONG)((0.788749120) * (((JLONG)1) << 13) + 0.5))));
    tmp24 += ((z2) * (((JLONG)((1.944413522) * (((JLONG)1) << 13) + 0.5)))) -
             ((z1) * (((JLONG)((1.390975730) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp11 = z1 + z2;
    tmp14 = ((tmp11 + z3 + z4) * (((JLONG)((0.398430003) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = ((tmp11) * (((JLONG)((0.887983902) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = ((z1 + z3) * (((JLONG)((0.670361295) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = tmp14 + ((z1 + z4) * (((JLONG)((0.366151574) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp11 + tmp12 + tmp13 -
            ((z1) * (((JLONG)((0.923107866) * (((JLONG)1) << 13) + 0.5))));
    z1 = tmp14 - ((z2 + z3) * (((JLONG)((1.163011579) * (((JLONG)1) << 13) + 0.5))));
    tmp11 += z1 + ((z2) * (((JLONG)((2.073276588) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += z1 - ((z3) * (((JLONG)((1.192193623) * (((JLONG)1) << 13) + 0.5))));
    z1 = ((z2 + z4) * (-((JLONG)((1.798248910) * (((JLONG)1) << 13) + 0.5))));
    tmp11 += z1;
    tmp13 += z1 + ((z4) * (((JLONG)((2.102458632) * (((JLONG)1) << 13) + 0.5))));
    tmp14 += ((z2) * (-((JLONG)((1.467221301) * (((JLONG)1) << 13) + 0.5)))) +
             ((z3) * (((JLONG)((1.001388905) * (((JLONG)1) << 13) + 0.5)))) -
             ((z4) * (((JLONG)((1.684843907) * (((JLONG)1) << 13) + 0.5))));
  ...
  for (ctr = 0; ctr < 11; ctr++) {
    ...
    tmp10 = (JLONG)wsptr[0] + (((JLONG)1) << (2 + 2));
    tmp10 = ((JLONG)((unsigned long)(tmp10) << (13)));
...
# 1461 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    z1 = (((ISLOW_MULT_TYPE)(inptr[8 * 2])) * (quantptr[8 * 2]));
    z4 = ((z1) * (((JLONG)((1.366025404) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp11 = ((z2) * (((JLONG)((1.306562965) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((z2) * (-((JLONG)4433)));

    tmp10 = z1 + z3;
    tmp15 = ((tmp10 + z4) * (((JLONG)((0.860918669) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = tmp15 + ((tmp10) * (((JLONG)((0.261052384) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp12 + tmp11 + ((z1) * (((JLONG)((0.280143716) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = ((z3 + z4) * (-((JLONG)((1.045510580) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += tmp13 + tmp14 - ((z3) * (((JLONG)((1.478575242) * (((JLONG)1) << 13) + 0.5))));
    tmp13 += tmp15 - tmp11 + ((z4) * (((JLONG)((1.586706681) * (((JLONG)1) << 13) + 0.5))));
    tmp15 += tmp14 - ((z1) * (((JLONG)((0.676326758) * (((JLONG)1) << 13) + 0.5)))) -
             ((z4) * (((JLONG)((1.982889723) * (((JLONG)1) << 13) + 0.5))));
...
# 1677 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp13 = ((tmp11) * (((JLONG)((0.096834934) * (((JLONG)1) << 13) + 0.5)))) + z1;

    tmp20 = ((z2) * (((JLONG)((1.373119086) * (((JLONG)1) << 13) + 0.5)))) + tmp12 + tmp13;
    tmp22 = ((z2) * (((JLONG)((0.501487041) * (((JLONG)1) << 13) + 0.5)))) - tmp12 + tmp13;

    tmp12 = ((tmp10) * (((JLONG)((0.316450131) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = ((tmp11) * (((JLONG)((0.486914739) * (((JLONG)1) << 13) + 0.5)))) + z1;

    tmp21 = ((z2) * (((JLONG)((1.058554052) * (((JLONG)1) << 13) + 0.5)))) - tmp12 + tmp13;
    tmp25 = ((z2) * (-((JLONG)((1.252223920) * (((JLONG)1) << 13) + 0.5)))) + tmp12 + tmp13;

    tmp12 = ((tmp10) * (((JLONG)((0.435816023) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = ((tmp11) * (((JLONG)((0.937303064) * (((JLONG)1) << 13) + 0.5)))) - z1;

    tmp23 = ((z2) * (-((JLONG)((0.170464608) * (((JLONG)1) << 13) + 0.5)))) - tmp12 - tmp13;
    tmp24 = ((z2) * (-((JLONG)((0.803364869) * (((JLONG)1) << 13) + 0.5)))) + tmp12 - tmp13;
    ...
    tmp11 = ((z1 + z2) * (((JLONG)((1.322312651) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = ((z1 + z3) * (((JLONG)((1.163874945) * (((JLONG)1) << 13) + 0.5))));
    tmp15 = z1 + z4;
    tmp13 = ((tmp15) * (((JLONG)((0.937797057) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp11 + tmp12 + tmp13 -
            ((z1) * (((JLONG)((2.020082300) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((z2 + z3) * (-((JLONG)((0.338443458) * (((JLONG)1) << 13) + 0.5))));
    tmp11 += tmp14 + ((z2) * (((JLONG)((0.837223564) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += tmp14 - ((z3) * (((JLONG)((1.572116027) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((z2 + z4) * (-((JLONG)((1.163874945) * (((JLONG)1) << 13) + 0.5))));
    tmp11 += tmp14;
    tmp13 += tmp14 + ((z4) * (((JLONG)((2.205608352) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((z3 + z4) * (-((JLONG)((0.657217813) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += tmp14;
    tmp13 += tmp14;
    tmp15 = ((tmp15) * (((JLONG)((0.338443458) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = tmp15 + ((z1) * (((JLONG)((0.318774355) * (((JLONG)1) << 13) + 0.5)))) -
            ((z2) * (((JLONG)((0.466105296) * (((JLONG)1) << 13) + 0.5))));
    z1 = ((z3 - z2) * (((JLONG)((0.937797057) * (((JLONG)1) << 13) + 0.5))));
    tmp14 += z1;
    tmp15 += z1 + ((z3) * (((JLONG)((0.384515595) * (((JLONG)1) << 13) + 0.5)))) -
             ((z4) * (((JLONG)((1.742345811) * (((JLONG)1) << 13) + 0.5))));
...
# 1905 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    z3 = ((z4) * (((JLONG)((0.314692123) * (((JLONG)1) << 13) + 0.5))));
    z4 = ((z4) * (((JLONG)((0.881747734) * (((JLONG)1) << 13) + 0.5))));

    tmp10 = z1 + z2;
    tmp11 = z1 + z3;
    tmp12 = z1 - z4;

    tmp23 = ((z1 - ((JLONG)((unsigned long)(z2 + z3 - z4) << (1)))) >> (13 - 2));
    ...
    tmp13 = z3 + ((z1) * (((JLONG)((0.273079590) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = z3 - ((z2) * (((JLONG)((1.719280954) * (((JLONG)1) << 13) + 0.5))));
    tmp15 = ((z1) * (((JLONG)((0.613604268) * (((JLONG)1) << 13) + 0.5)))) -
            ((z2) * (((JLONG)((1.378756276) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp12 = ((tmp14) * (((JLONG)((1.197448846) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp11 + tmp12 + tmp13 - ((z1) * (((JLONG)((1.126980169) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((tmp14) * (((JLONG)((0.752406978) * (((JLONG)1) << 13) + 0.5))));
    tmp16 = tmp14 - ((z1) * (((JLONG)((1.061150426) * (((JLONG)1) << 13) + 0.5))));
    z1 -= z2;
    tmp15 = ((z1) * (((JLONG)((0.467085129) * (((JLONG)1) << 13) + 0.5)))) - tmp13;
    tmp16 += tmp15;
    z1 += z4;
    z4 = ((z2 + z3) * (-((JLONG)((0.158341681) * (((JLONG)1) << 13) + 0.5)))) - tmp13;
    tmp11 += z4 - ((z2) * (((JLONG)((0.424103948) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += z4 - ((z3) * (((JLONG)((2.373959773) * (((JLONG)1) << 13) + 0.5))));
    z4 = ((z3 - z2) * (((JLONG)((1.405321284) * (((JLONG)1) << 13) + 0.5))));
    tmp14 += z4 + tmp13 - ((z3) * (((JLONG)((1.6906431334) * (((JLONG)1) << 13) + 0.5))));
    tmp15 += z4 + ((z2) * (((JLONG)((0.674957567) * (((JLONG)1) << 13) + 0.5))));

    tmp13 = ((JLONG)((unsigned long)(z1 - z3) << (2)));
  ...
  for (ctr = 0; ctr < 14; ctr++) {
    ...
    tmp11 = ((z1 + z2) * (((JLONG)((1.334852607) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = ((tmp14) * (((JLONG)((1.197448846) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = tmp11 + tmp12 + z4 - ((z1) * (((JLONG)((1.126980169) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = ((tmp14) * (((JLONG)((0.752406978) * (((JLONG)1) << 13) + 0.5))));
    tmp16 = tmp14 - ((z1) * (((JLONG)((1.061150426) * (((JLONG)1) << 13) + 0.5))));
    z1 -= z2;
    tmp15 = ((z1) * (((JLONG)((0.467085129) * (((JLONG)1) << 13) + 0.5)))) - z4;
    tmp16 += tmp15;
    tmp13 = ((z2 + z3) * (-((JLONG)((0.158341681) * (((JLONG)1) << 13) + 0.5)))) - z4;
    tmp11 += tmp13 - ((z2) * (((JLONG)((0.424103948) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += tmp13 - ((z3) * (((JLONG)((2.373959773) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = ((z3 - z2) * (((JLONG)((1.405321284) * (((JLONG)1) << 13) + 0.5))));
    tmp14 += tmp13 + z4 - ((z3) * (((JLONG)((1.6906431334) * (((JLONG)1) << 13) + 0.5))));
    tmp15 += tmp13 + ((z2) * (((JLONG)((0.674957567) * (((JLONG)1) << 13) + 0.5))));
...
# 2131 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp11 = ((z4) * (((JLONG)((1.144122806) * (((JLONG)1) << 13) + 0.5))));
    ...
    z4 = z2 - z3;
    z3 += z2;
    tmp10 = ((z3) * (((JLONG)((1.337628990) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = ((z4) * (((JLONG)((0.045680613) * (((JLONG)1) << 13) + 0.5))));
    z2 = ((z2) * (((JLONG)((1.439773946) * (((JLONG)1) << 13) + 0.5))));

    tmp20 = tmp13 + tmp10 + tmp11;
    tmp23 = tmp12 - tmp10 + tmp11 + z2;

    tmp10 = ((z3) * (((JLONG)((0.547059574) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = ((z4) * (((JLONG)((0.399234004) * (((JLONG)1) << 13) + 0.5))));

    tmp25 = tmp13 - tmp10 - tmp11;
    tmp26 = tmp12 + tmp10 - tmp11 - z2;

    tmp10 = ((z3) * (((JLONG)((0.790569415) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = ((z4) * (((JLONG)((0.353553391) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp11 = tmp15 + ((z1) * (((JLONG)((0.513743148) * (((JLONG)1) << 13) + 0.5))));
    tmp14 = tmp15 - ((tmp13) * (((JLONG)((2.176250899) * (((JLONG)1) << 13) + 0.5))));

    tmp13 = ((z2) * (-((JLONG)((0.831253876) * (((JLONG)1) << 13) + 0.5))));
    tmp15 = ((z2) * (-((JLONG)((1.344997024) * (((JLONG)1) << 13) + 0.5))));
    z2 = z1 - z4;
    tmp12 = z3 + ((z2) * (((JLONG)((1.406466353) * (((JLONG)1) << 13) + 0.5))));

    tmp10 = tmp12 + ((z4) * (((JLONG)((2.457431844) * (((JLONG)1) << 13) + 0.5)))) - tmp15;
    tmp16 = tmp12 - ((z1) * (((JLONG)((1.112434820) * (((JLONG)1) << 13) + 0.5)))) + tmp13;
    tmp12 = ((z2) * (((JLONG)((1.224744871) * (((JLONG)1) << 13) + 0.5)))) - z3;
    z2 = ((z1 + z4) * (((JLONG)((0.575212477) * (((JLONG)1) << 13) + 0.5))));
    tmp13 += z2 + ((z1) * (((JLONG)((0.475753014) * (((JLONG)1) << 13) + 0.5)))) - z3;
    tmp15 += z2 - ((z4) * (((JLONG)((0.869244010) * (((JLONG)1) << 13) + 0.5)))) + z3;
...
# 2373 "/benchmark/RUNDIR-libjpeg-1.5.90/libjpeg-turbo-1.5.90/jidctint.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 8; ctr++, inptr++, quantptr++, wsptr++) {
    ...
    tmp1 = ((z1) * (((JLONG)((1.306562965) * (((JLONG)1) << 13) + 0.5))));
    tmp2 = ((z1) * (((JLONG)4433)));
    ...
    z3 = ((z3) * (((JLONG)((1.387039845) * (((JLONG)1) << 13) + 0.5))));

    tmp0 = z3 + ((z2) * (((JLONG)20995)));
    tmp1 = z4 + ((z1) * (((JLONG)7373)));
    tmp2 = z3 - ((z1) * (((JLONG)((0.601344887) * (((JLONG)1) << 13) + 0.5))));
    tmp3 = z4 - ((z2) * (((JLONG)((0.509795579) * (((JLONG)1) << 13) + 0.5))));
    ...
    tmp1 = ((z1 + z2) * (((JLONG)((1.353318001) * (((JLONG)1) << 13) + 0.5))));
    tmp2 = ((tmp11) * (((JLONG)((1.247225013) * (((JLONG)1) << 13) + 0.5))));
    tmp3 = ((z1 + z4) * (((JLONG)((1.093201867) * (((JLONG)1) << 13) + 0.5))));
    tmp10 = ((z1 - z4) * (((JLONG)((0.897167586) * (((JLONG)1) << 13) + 0.5))));
    tmp11 = ((tmp11) * (((JLONG)((0.666655658) * (((JLONG)1) << 13) + 0.5))));
    tmp12 = ((z1 - z2) * (((JLONG)((0.410524528) * (((JLONG)1) << 13) + 0.5))));
    tmp0 = tmp1 + tmp2 + tmp3 -
            ((z1) * (((JLONG)((2.286341144) * (((JLONG)1) << 13) + 0.5))));
    tmp13 = tmp10 + tmp11 + tmp12 -
            ((z1) * (((JLONG)((1.835730603) * (((JLONG)1) << 13) + 0.5))));
    z1 = ((z2 + z3) * (((JLONG)((0.138617169) * (((JLONG)1) << 13) + 0.5))));
    tmp1 += z1 + ((z2) * (((JLONG)((0.071888074) * (((JLONG)1) << 13) + 0.5))));
    tmp2 += z1 - ((z3) * (((JLONG)((1.125726048) * (((JLONG)1) << 13) + 0.5))));
    z1 = ((z3 - z2) * (((JLONG)((1.407403738) * (((JLONG)1) << 13) + 0.5))));
    tmp11 += z1 - ((z3) * (((JLONG)((0.766367282) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += z1 + ((z2) * (((JLONG)((1.971951411) * (((JLONG)1) << 13) + 0.5))));
    z2 += z4;
    z1 = ((z2) * (-((JLONG)((0.666655658) * (((JLONG)1) << 13) + 0.5))));
    tmp1 += z1;
    tmp3 += z1 + ((z4) * (((JLONG)((1.065388962) * (((JLONG)1) << 13) + 0.5))));
    z2 = ((z2) * (-((JLONG)((1.247225013) * (((JLONG)1) << 13) + 0.5))));
    tmp10 += z2 + ((z4) * (((JLONG)((3.141271809) * (((JLONG)1) << 13) + 0.5))));
    tmp12 += z2;
    z2 = ((z3 + z4) * (-((JLONG)((1.353318001) * (((JLONG)1) << 13) + 0.5))));
    tmp2 += z2;
    tmp3 += z2;
