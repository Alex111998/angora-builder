# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c" 2
# 33 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
# 1 "./aes.h" 1
# 38 "./aes.h"
typedef struct
{
...
# 34 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 36 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c" 2
# 63 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
...
# 90 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
...
# 379 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
int aes_crypt_ecb( aes_context *ctx,
                    int mode,
                    const unsigned char input[16],
                    unsigned char output[16] )
...
# 399 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
    RK = ctx->rk;
                    ...
                    unsigned char *output )
{
    ...
    if( length % 16 )
        return( -0x0810 );
# 511 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/aes.c"
    if( mode == 0 )
    {
        while( length > 0 )
        {
