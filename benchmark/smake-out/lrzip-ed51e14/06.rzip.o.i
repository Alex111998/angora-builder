# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
# 24 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c"
# 1 "./config.h" 1
# 25 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 29 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
extern int fstatvfs64 (int __fildes, struct statvfs64 *__buf)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
# 31 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 33 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 36 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 39 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2

# 1 "/usr/include/lzo/lzoconf.h" 1 3 4
# 40 "/usr/include/lzo/lzoconf.h" 3 4
...
# 41 "/usr/include/lzo/lzoconf.h" 2 3 4
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3 4
...
# 41 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
lzo1x_optimize ( unsigned char * src, lzo_uint src_len,
                                unsigned char * dst, lzo_uint * dst_len,
                                void * wrkmem );
# 42 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 44 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 47 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 52 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 54 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 56 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
# 1 "./stream.h" 1
# 26 "./stream.h"
...
# 57 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
# 1 "./util.h" 1
# 27 "./util.h"
...
# 58 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
# 1 "./lrzip_core.h" 1
# 24 "./lrzip_core.h"
...
extern void zpaq_decompress(unsigned char *s_buf, i64 *d_len, unsigned char *c_buf, i64 c_len,
       FILE *msgout, _Bool progress, long thread);
# 59 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
...
# 61 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c" 2
# 79 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c"
struct hash_entry {
 i64 offset;
 tag t;
};
...
static void remap_low_sb(rzip_control *control, struct sliding_buffer *sb)
{
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 108, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Sliding main buffer to offset %lld\n", new_offset); } while (0); } while (0);
 if (__builtin_expect(!!(munmap(sb->buf_low, sb->size_low)), 0))
  failure(control, 110, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to munmap in remap_low_sb\n");
 if (new_offset + sb->size_low > sb->orig_size)
  sb->size_low = sb->orig_size - new_offset;
 sb->offset_low = new_offset;
 sb->buf_low = (unsigned char *)mmap(sb->buf_low, sb->size_low, 0x1, 0x01, sb->fd, sb->orig_offset + sb->offset_low);
 if (__builtin_expect(!!(sb->buf_low == ((void *) -1)), 0))
  failure(control, 116, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to re mmap in remap_low_sb\n");
}

static inline void remap_high_sb(rzip_control *control, struct sliding_buffer *sb, i64 p)
{
 if (__builtin_expect(!!(munmap(sb->buf_high, sb->size_high)), 0))
  failure(control, 122, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to munmap in remap_high_sb\n");
 sb->size_high = sb->high_length;
 sb->offset_high = p;

 sb->offset_high -= (sb->offset_high + sb->orig_offset) % control->page_size;
 if (__builtin_expect(!!(sb->offset_high + sb->size_high > sb->orig_size), 0))
  sb->size_high = sb->orig_size - sb->offset_high;
 sb->buf_high = (unsigned char *)mmap(sb->buf_high, sb->size_high, 0x1, 0x01, sb->fd, sb->orig_offset + sb->offset_high);
 if (__builtin_expect(!!(sb->buf_high == ((void *) -1)), 0))
  failure(control, 131, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to re mmap in remap_high_sb\n");
}
# 143 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c"
static unsigned char *sliding_get_sb(rzip_control *control, i64 p)
{
...
static inline i64 sliding_get_sb_range(rzip_control *control, i64 p)
{
 ...
 sbo = sb->offset_high;
 sbs = sb->size_high;
 if (__builtin_expect(!!(p >= sbo && p < (sbo + sbs)), 1))
  return (sbs - (p - sbo));

 do { fatal(control, 177, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "sliding_get_sb_range: the pointer is out of range\n"); return 0; } while (0);
}
...
static void sliding_mcpy(rzip_control *control, unsigned char *buf, i64 offset, i64 len)
{
 ...
 while (n < len) {
  unsigned char *srcbuf = sliding_get_sb(control, offset + n);
  i64 m = ((sliding_get_sb_range(control, offset + n)) < (len - n)? (sliding_get_sb_range(control, offset + n)): (len - n));
...
static inline void put_u8(rzip_control *control, void *ss, unsigned char b)
{
...
{
 s = __uint32_identity (s);
 write_stream(control, ss, 0, (unsigned char *)&s, 4);
}


static void put_vchars(rzip_control *control, void *ss, i64 s, i64 length)
{
 s = __uint64_identity (s);
 write_stream(control, ss, 0, (unsigned char *)&s, length);
}

static void put_header(rzip_control *control, void *ss, unsigned char head, i64 len)
{
     ...
     i64 p, i64 len)
{
 ...
 while (len) {
  i64 n = ((sinfo->bufsize - sinfo->s[stream].buflen) < (len)? (sinfo->bufsize - sinfo->s[stream].buflen): (len));
...
static inline _Bool empty_hash(struct hash_entry *he)
{
...
static inline _Bool minimum_bitness(struct rzip_state *st, tag t)
{
...
static inline _Bool lesser_bitness(tag a, tag b)
{
...
again:
 ...
 if (!st->tag_clean_ptr)
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 383, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Starting sweep for mask %u\n", (unsigned int)st->minimum_tag_mask); } while (0); } while (0);
 ...
 *t ^= st->hash_index[*u];
 u = sliding_get_sb(control, p + 31 - 1);
 *t ^= st->hash_index[*u];
}
   ...
   i64 end, i64 *rev)
{
 ...
 end = ((0) > (st->last_match)? (0): (st->last_match));
...
static void show_distrib(rzip_control *control, struct rzip_state *st)
{
 ...
 if (total != st->hash_count)
  do { print_err(control, 571, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "WARNING: hash_count says total %lld\n", st->hash_count); } while (0);

 if (!total)
  do { do { print_stuff(control, 1, 574, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "0 total hashes\n"); } while (0); } while (0);
 else {
  do { do { print_stuff(control, 1, 577, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "%lld total hashes -- %lld in primary bucket (%-2.3f%%)\n", total, primary, primary * 100.0 / total); } while (0); } while (0);
 ...
 *control->checksum.cksum = CrcUpdate(*control->checksum.cksum, control->checksum.buf, control->checksum.len);
 ...
 do { do { free((control->checksum.buf)); (control->checksum.buf) = ((void*)0); } while (0); control->checksum.buf = ((void*)0); } while (0);
...
static inline void cksum_update(rzip_control *control)
{
 ...
 create_pthread(control, &thread, ((void*)0), cksumthread, control);
}
          ...
          double pct_base, double pct_multiple)
{
 ...
 if (st->hash_table)
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 624, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "hashsize = %lld.  bits = %lld. %luMB\n", hashsize, st->hash_bits, st->level->mb_used); } while (0); } while (0);



  st->hash_limit = (1 << st->hash_bits) / 3 * 2;
  st->hash_table = calloc(sizeof(st->hash_table[0]), (1 << st->hash_bits));
  if (__builtin_expect(!!(!st->hash_table), 0))
   failure(control, 630, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to allocate hash table in hash_search\n");
 }
 ...
 p = 0;
 end = st->chunk_size - 31;
 st->last_match = p;
 current.len = 0;
 current.p = p;
 current.ofs = 0;

 if (__builtin_expect(!!(end > 0), 1))
 ...
 while (p < end) {
  ...
  sb->offset_search = ++p;
  if (__builtin_expect(!!(sb->offset_search > sb->offset_low + sb->size_low), 0))
   remap_low_sb(control, &control->sb);

  if (__builtin_expect(!!(p % 128 == 0 && st->chunk_size), 0)) {
   i64 chunk_pct;
   int pct;
   ...
   if (pct != lastpct || chunk_pct != last_chunkpct) {
    if (!(control->flags & (1 << 12)) || st->stdin_eof)
     do { if ((control->flags & (1 << 0))) do { print_stuff(control, 2, 663, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Total: %2d%%  ", pct); } while (0); } while (0);
    do { if ((control->flags & (1 << 0))) do { print_stuff(control, 2, 664, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Chunk: %2d%%\r", chunk_pct); } while (0); } while (0);
    if (control->info_cb)
     control->info_cb(control->info_data,
      (!(control->flags & (1 << 12)) || st->stdin_eof) ? pct : -1, chunk_pct);
    lastpct = pct;
  ...
  if ((current.len >= 1024 || p >= current.p + 31)
      && current.len >= 31) {
  ...
  if (p > cksum_limit) {
   ...
   control->checksum.len = ((st->chunk_size - p) < (control->page_size)? (st->chunk_size - p): (control->page_size));
   control->checksum.buf = malloc(control->checksum.len);
   if (__builtin_expect(!!(!control->checksum.buf), 0))
    failure(control, 718, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to malloc ckbuf in hash_search\n");
 ...
 if (st->chunk_size > cksum_limit) {
  ...
  while (42) {
   ...
   if (buf) {
    do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 740, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Malloced %""l" "d"" for checksum ckbuf\n", cksum_len); } while (0); } while (0);
    break;
   }
   cksum_len = cksum_len / 3 * 2;
   if (cksum_len < control->page_size)
    failure(control, 745, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to malloc any ram for checksum ckbuf\n");
  }
...
# 815 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c"
static inline void mmap_stdin(rzip_control *control, unsigned char *buf,
         struct rzip_state *st)
{
 ...
 while (len > 0) {
  ...
  if (__builtin_expect(!!(ret < 0), 0))
   failure(control, 828, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to read in mmap_stdin\n");
  total += ret;
  if (ret == 0) {

   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 832, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Shrinking chunk to %lld\n", total); } while (0); } while (0);
   if (__builtin_expect(!!(total), 1)) {
    buf = (unsigned char *)mremap(buf, st->chunk_size, total, 0);
    st->mmap_size = st->chunk_size = total;
   } else {

    buf = (unsigned char *)mremap(buf, st->chunk_size, control->page_size, 0);
    st->mmap_size = control->page_size;
    st->chunk_size = 0;
   }
   if (__builtin_expect(!!(buf == ((void *) -1)), 0))
    failure(control, 843, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to remap to smaller buf in mmap_stdin\n");
    ...
    i64 offset)
{
 ...
 if (!(control->flags & (1 << 12))) {
  ...
  sb->buf_high = (unsigned char *)mmap(((void*)0), sb->high_length, 0x1, 0x01, fd_in, offset);
  if (__builtin_expect(!!(sb->buf_high == ((void *) -1)), 0))
   failure(control, 864, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Unable to mmap buf_high in init_sliding_mmap\n");
  sb->size_high = sb->high_length;
  sb->offset_high = 0;
 }
 sb->offset_low = 0;
    ...
    i64 offset, double pct_base, double pct_multiple)
{
 ...
 st->ss = open_stream_out(control, fd_out, 2, st->chunk_size, st->chunk_bytes);
 if (__builtin_expect(!!(!st->ss), 0))
  failure(control, 887, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to open streams in rzip_chunk\n");

 do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 889, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Beginning rzip pre-processing phase\n"); } while (0); } while (0);
 hash_search(control, st, pct_base, pct_multiple);


 if (__builtin_expect(!!(munmap(sb->buf_low, sb->size_low)), 0)) {
  close_stream_out(control, st->ss);
  failure(control, 895, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to munmap in rzip_chunk\n");
 }
 if (!(control->flags & (1 << 12))) {
  if (__builtin_expect(!!(munmap(sb->buf_high, sb->size_high)), 0)) {
   close_stream_out(control, st->ss);
   failure(control, 900, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to munmap in rzip_chunk\n");
  }
 }

 if (__builtin_expect(!!(close_stream_out(control, st->ss)), 0))
  failure(control, 905, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to flush/close streams in rzip_chunk\n");
}
...
void rzip_fd(rzip_control *control, int fd_in, int fd_out)
{
 ...
 if (__builtin_expect(!!(!st), 0))
  failure(control, 936, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to allocate control state in rzip_fd\n");

 if ((control->flags & (1 << 6))) {
  if (__builtin_expect(!!(__lzo_init_v2(0x20a0,(int)sizeof(short),(int)sizeof(int), (int)sizeof(long),(int)sizeof(unsigned int),(int)sizeof(lzo_uint), (int)((unsigned)sizeof(unsigned char *)),(int)sizeof(char *),(int)sizeof(void *), (int)sizeof(lzo_callback_t)) != 0), 0)) {
   do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
   failure(control, 941, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "lzo_init() failed\n");
  }
 }

 if (__builtin_expect(!!(fstat(fd_in, &s)), 0)) {
  do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
  failure(control, 947, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to stat fd_in in rzip_fd\n");
 }

 if (!(control->flags & (1 << 12))) {
  len = control->st_size = s.st_size;
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 952, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "File size: %lld\n", len); } while (0); } while (0);
 } else
  control->st_size = 0;
 ...
 if (!(control->flags & (1 << 13))) {
  ...
  if (__builtin_expect(!!(fstatvfs(fd_out, &fbuf)), 0)) {
   do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
   failure(control, 962, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to fstatvfs in compress_file\n");
  }
  free_space = (i64)fbuf.f_bsize * (i64)fbuf.f_bavail;
  if (free_space < control->st_size) {
   if ((control->flags & (1 << 3)))
    do { do { print_stuff(control, 1, 967, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Warning, possibly inadequate free space detected, but attempting to compress due to -f option being used.\n"); } while (0); } while (0);
   else {
    do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
    failure(control, 970, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Possibly inadequate free space to compress file, use -f to override.\n");
   }
  }
 }
 ...
 if ((control->flags & (1 << 15)))
  ...
  control->max_chunk = control->window * (100 * 1024 * 1024);
 else
  control->max_chunk = control->ramsize / 3 * 2;
 control->max_mmap = ((control->max_mmap) < (control->max_chunk)? (control->max_mmap): (control->max_chunk));
 if (control->max_chunk < control->st_size)
  round_to_page(&control->max_chunk);

 if (!(control->flags & (1 << 12)))
  st->chunk_size = ((control->max_chunk) < (len)? (control->max_chunk): (len));
 else
 ...
 while (!pass || len > 0 || ((control->flags & (1 << 12)) && !st->stdin_eof)) {
  ...
  if (!(control->flags & (1 << 12))) {
   st->chunk_size = ((st->chunk_size) < (len)? (st->chunk_size): (len));
   if (__builtin_expect(!!(st->chunk_size), 1))
    st->mmap_size = ((st->mmap_size) < (len)? (st->mmap_size): (len));
   else
    st->mmap_size = control->page_size;
  }
...
retry:
  if ((control->flags & (1 << 12))) {
   ...
   sb->buf_low = mmap(((void*)0), st->mmap_size, 0x1 | 0x2, 0x20 | 0x02, -1, 0);

   if (sb->buf_low == ((void *) -1)) {
    if (__builtin_expect(!!((*__errno_location ()) != 12), 0)) {
     close_streamout_threads(control);
     do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
     do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
     failure(control, 1046, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to mmap %s\n", control->infile);
    }
    st->mmap_size = st->mmap_size / 10 * 9;
    round_to_page(&st->mmap_size);
    if (__builtin_expect(!!(!st->mmap_size), 0)) {
     close_streamout_threads(control);
     do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
     do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
     failure(control, 1054, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Unable to mmap any ram\n");
    }
    goto retry;
   }
   ...
   sb->buf_low = (unsigned char *)mmap(sb->buf_low, st->mmap_size, 0x1, 0x01, fd_in, offset);
   if (sb->buf_low == ((void *) -1)) {
    if (__builtin_expect(!!((*__errno_location ()) != 12), 0)) {
     close_streamout_threads(control);
     do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
     do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
     failure(control, 1068, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to mmap %s\n", control->infile);
    }
    st->mmap_size = st->mmap_size / 10 * 9;
    round_to_page(&st->mmap_size);
    if (__builtin_expect(!!(!st->mmap_size), 0)) {
     ...
     do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
     do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
     failure(control, 1076, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Unable to mmap any ram\n");
    }
    goto retry;
   }
   if (st->mmap_size < st->chunk_size) {
    do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1081, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Enabling sliding mmap mode and using mmap of %lld bytes with window of %lld bytes\n", st->mmap_size, st->chunk_size); } while (0); } while (0);
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1088, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Succeeded in testing %lld sized mmap for rzip pre-processing\n", st->mmap_size); } while (0); } while (0);

  if (st->chunk_size > control->ramsize)
   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 1091, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Compression window is larger than ram, will proceed with unlimited mode possibly much slower\n"); } while (0); } while (0);

  if (!passes && !(control->flags & (1 << 12)) && st->chunk_size) {
   passes = s.st_size / st->chunk_size + !!(s.st_size % st->chunk_size);
   if (passes == 1)
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 1096, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Will take 1 pass\n"); } while (0); } while (0);
   else
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 1098, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Will take %d passes\n", passes); } while (0); } while (0);
  }

  sb->orig_offset = offset;
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1102, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Chunk size: %lld\n", st->chunk_size); } while (0); } while (0);
  ...
  if (bits % 8)
   st->chunk_bytes++;
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1114, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Byte width: %d\n", st->chunk_bytes); } while (0); } while (0);
  ...
  if (last.tv_sec > 0 && pct_base > 100) {
   ...
   if (!(control->flags & (1 << 12)) || st->stdin_eof)
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 1145, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "\nPass %d / %d -- Elapsed Time: %02d:%02d:%02d. ETA: %02d:%02d:%02d. Compress Speed: %3.3fMB/s.\n", pass, passes, elapsed_hours, elapsed_minutes, elapsed_seconds, eta_hours, eta_minutes, eta_seconds, chunkmbs); } while (0); } while (0);


   else
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 1148, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "\nPass %d -- Elapsed Time: %02d:%02d:%02d. Compress Speed: %3.3fMB/s.\n", pass, elapsed_hours, elapsed_minutes, elapsed_seconds, chunkmbs); } while (0); } while (0);
  ...
  len -= st->chunk_size;
  if (__builtin_expect(!!(len > 0 && control->eof), 0)) {
   close_streamout_threads(control);
   do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
   do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
   failure(control, 1164, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Wrote EOF to file yet chunk_size was shrunk, corrupting archive.\n");
  }
 }

 if (__builtin_expect(!!(st->hash_table), 1))
  do { do { free((st->hash_table)); (st->hash_table) = ((void*)0); } while (0); st->hash_table = ((void*)0); } while (0);
 if (__builtin_expect(!!(!close_streamout_threads(control)), 0)) {
  do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
  failure(control, 1172, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to close_streamout_threads in rzip_fd\n");
 }

 if (!(!((control->flags & (1 << 16))) && !((control->flags & (1 << 17))))) {

  md5_finish_ctx(&control->ctx, control->md5_resblock);
  if ((control->flags & (1 << 16)) || (control->flags & (1 << 11))) {
   do { do { print_stuff(control, 1, 1179, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "MD5: "); } while (0); } while (0);
   for (j = 0; j < 16; j++)
    do { do { print_stuff(control, 1, 1181, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "%02x", control->md5_resblock[j] & 0xFF); } while (0); } while (0);
   do { do { print_stuff(control, 1, 1182, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "\n"); } while (0); } while (0);
  }

  if ((control->flags & (1 << 23)))
   if (__builtin_expect(!!(!lrz_encrypt(control, control->md5_resblock, 16, control->salt_pass)), 0)) {
    do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
    failure(control, 1188, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to lrz_encrypt in rzip_fd\n");
   }
  if (__builtin_expect(!!(write_1g(control, control->md5_resblock, 16) != 16), 0)) {
   do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
   failure(control, 1192, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to write md5 in rzip_fd\n");
  }
 }
 ...
 if ((control->flags & (1 << 21))) {
  if (__builtin_expect(!!(!flush_tmpoutbuf(control)), 0)) {
   do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
   failure(control, 1199, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Failed to flush_tmpoutbuf in rzip_fd\n");
  }
 }
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1214, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "matches=%u match_bytes=%u\n", (unsigned int)st->stats.matches, (unsigned int)st->stats.match_bytes); } while (0); } while (0);

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1216, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "literals=%u literal_bytes=%u\n", (unsigned int)st->stats.literals, (unsigned int)st->stats.literal_bytes); } while (0); } while (0);

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1218, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "true_tag_positives=%u false_tag_positives=%u\n", (unsigned int)st->stats.tag_hits, (unsigned int)st->stats.tag_misses); } while (0); } while (0);

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1221, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "inserts=%u match %.3f\n", (unsigned int)st->stats.inserts, (1.0 + st->stats.match_bytes) / st->stats.literal_bytes); } while (0); } while (0);



 if (!(control->flags & (1 << 12)))
  do { if ((control->flags & (1 << 0))) do { print_stuff(control, 2, 1224, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "%s - ", control->infile); } while (0); } while (0);
 do { if ((control->flags & (1 << 0))) do { print_stuff(control, 2, 1226, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/rzip.c", __func__, "Compression Ratio: %.3f. Average Compression Speed: %6.3fMB/s.\n", 1.0 * s.st_size / s2.st_size, chunkmbs); } while (0); } while (0);
...
void rzip_control_free(rzip_control *control)
{
 ...
 do { do { free((control->tmpdir)); (control->tmpdir) = ((void*)0); } while (0); control->tmpdir = ((void*)0); } while (0);
 do { do { free((control->outname)); (control->outname) = ((void*)0); } while (0); control->outname = ((void*)0); } while (0);
 do { do { free((control->outdir)); (control->outdir) = ((void*)0); } while (0); control->outdir = ((void*)0); } while (0);
 if (control->suffix && control->suffix[0])
  do { do { free((control->suffix)); (control->suffix) = ((void*)0); } while (0); control->suffix = ((void*)0); } while (0);

 for (x = 0; x < control->sinfo_idx; x++) {
  do { do { free((control->sinfo_queue[x]->s)); (control->sinfo_queue[x]->s) = ((void*)0); } while (0); control->sinfo_queue[x]->s = ((void*)0); } while (0);
  do { do { free((control->sinfo_queue[x])); (control->sinfo_queue[x]) = ((void*)0); } while (0); control->sinfo_queue[x] = ((void*)0); } while (0);
 }
 do { do { free((control->sinfo_queue)); (control->sinfo_queue) = ((void*)0); } while (0); control->sinfo_queue = ((void*)0); } while (0);
 do { do { free((control)); (control) = ((void*)0); } while (0); control = ((void*)0); } while (0);
}
