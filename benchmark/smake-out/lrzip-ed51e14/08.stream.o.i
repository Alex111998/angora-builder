# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
# 24 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
# 1 "./config.h" 1
# 25 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 29 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 32 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 35 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 38 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
extern int fstatvfs64 (int __fildes, struct statvfs64 *__buf)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2)));
# 40 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 41 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 42 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 43 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 44 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
lzo1x_optimize ( unsigned char * src, lzo_uint src_len,
                                unsigned char * dst, lzo_uint * dst_len,
                                void * wrkmem );
# 45 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 47 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 55 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 59 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
# 61 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
# 1 "./lrzip_core.h" 1
# 24 "./lrzip_core.h"
...
extern void zpaq_decompress(unsigned char *s_buf, i64 *d_len, unsigned char *c_buf, i64 c_len,
       FILE *msgout, _Bool progress, long thread);
# 62 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c" 2
...
_Bool init_mutex(rzip_control *control, pthread_mutex_t *mutex)
{
 if (__builtin_expect(!!(pthread_mutex_init(mutex, ((void*)0))), 0))
  do { fatal(control, 98, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_mutex_init\n"); return 0; } while (0);
 return 1;
}
...
_Bool unlock_mutex(rzip_control *control, pthread_mutex_t *mutex)
{
 if (__builtin_expect(!!(pthread_mutex_unlock(mutex)), 0))
  do { fatal(control, 105, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_mutex_unlock\n"); return 0; } while (0);
 return 1;
}
...
_Bool lock_mutex(rzip_control *control, pthread_mutex_t *mutex)
{
 if (__builtin_expect(!!(pthread_mutex_lock(mutex)), 0))
  do { fatal(control, 112, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_mutex_lock\n"); return 0; } while (0);
 return 1;
}
...
static _Bool cond_wait(rzip_control *control, pthread_cond_t *cond, pthread_mutex_t *mutex)
{
 if (__builtin_expect(!!(pthread_cond_wait(cond, mutex)), 0))
  do { fatal(control, 119, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_cond_wait\n"); return 0; } while (0);
 return 1;
}
...
static _Bool cond_broadcast(rzip_control *control, pthread_cond_t *cond)
{
 if (__builtin_expect(!!(pthread_cond_broadcast(cond)), 0))
  do { fatal(control, 126, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_cond_broadcast\n"); return 0; } while (0);
 return 1;
}
 ...
 void * (*start_routine)(void *), void *arg)
{
 if (__builtin_expect(!!(pthread_create(thread, attr, start_routine, arg)), 0))
  do { fatal(control, 134, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_create\n"); return 0; } while (0);
 return 1;
}
...
_Bool detach_pthread(rzip_control *control, pthread_t *thread)
{
 if (__builtin_expect(!!(pthread_detach(*thread)), 0))
  do { fatal(control, 141, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_detach\n"); return 0; } while (0);
 return 1;
}
...
_Bool join_pthread(rzip_control *control, pthread_t th, void **thread_return)
{
 if (pthread_join(th, thread_return))
  do { fatal(control, 148, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to pthread_join\n"); return 0; } while (0);
 return 1;
}
...
# 167 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
static int zpaq_compress_buf(rzip_control *control, struct compress_thread *cthread, long thread)
{
 ...
 c_buf = malloc(c_size);
 if (!c_buf) {
  do { print_err(control, 178, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in zpaq_compress_buf\n"); } while (0);
  return -1;
 }
 ...
 if (__builtin_expect(!!(c_len >= cthread->c_len), 0)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 188, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);

  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
  return 0;
 }

 cthread->c_len = c_len;
 do { do { free((cthread->s_buf)); (cthread->s_buf) = ((void*)0); } while (0); cthread->s_buf = ((void*)0); } while (0);
 cthread->s_buf = c_buf;
 cthread->c_type = 8;
 return 0;
}
...
static int bzip2_compress_buf(rzip_control *control, struct compress_thread *cthread)
{
 ...
 c_buf = malloc(dlen);
 if (!c_buf) {
  do { print_err(control, 212, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in bzip2_compress_buf\n"); } while (0);
  return -1;
 }
 ...
 if (bzip2_ret == (-8)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 224, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
 ...
 if (__builtin_expect(!!(bzip2_ret != 0), 0)) {
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 232, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "BZ2 compress failed\n"); } while (0); } while (0);
  return -1;
 }

 if (__builtin_expect(!!(dlen >= cthread->c_len), 0)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 237, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
...
static int gzip_compress_buf(rzip_control *control, struct compress_thread *cthread)
{
 ...
 c_buf = malloc(dlen);
 if (!c_buf) {
  do { print_err(control, 258, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in gzip_compress_buf\n"); } while (0);
  return -1;
 }
 ...
 if (gzip_ret == (-5)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 269, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
 ...
 if (__builtin_expect(!!(gzip_ret != 0), 0)) {
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 277, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "compress2 failed\n"); } while (0); } while (0);
  return -1;
 }

 if (__builtin_expect(!!((i64)dlen >= cthread->c_len), 0)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 282, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
...
static int lzma_compress_buf(rzip_control *control, struct compress_thread *cthread)
{
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 311, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Starting lzma back end compression thread...\n"); } while (0); } while (0);
retry:
 dlen = round_up_page(control, cthread->s_len);
 c_buf = malloc(dlen);
 if (!c_buf) {
  do { print_err(control, 316, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in lzma_compress_buf\n"); } while (0);
  return -1;
 }
 ...
 if (lzma_ret != 0) {
  switch (lzma_ret) {
   case 2:
    break;
   case 5:
    do { print_err(control, 334, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "LZMA Parameter ERROR: %d. This should not happen.\n", 5); } while (0);
    break;
   case 7:
    do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 337, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Harmless LZMA Output Buffer Overflow error: %d. Incompressible block.\n", 7); } while (0); } while (0);
    break;
   case 12:
    do { print_err(control, 340, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "LZMA Multi Thread ERROR: %d. This should not happen.\n", 12); } while (0);
    break;
   default:
    do { print_err(control, 343, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unidentified LZMA ERROR: %d. This should not happen.\n", lzma_ret); } while (0);
    break;
  }
  ...
  if (lzma_ret == 2) {
   if (lzma_level > 1) {
    lzma_level--;
    do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 351, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "LZMA Warning: %d. Can't allocate enough RAM for compression window, trying smaller.\n", 2); } while (0); } while (0);
    goto retry;
   }



   do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 357, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate enough RAM for any sized compression window, falling back to bzip2 compression.\n"); } while (0); } while (0);
 ...
 if (__builtin_expect(!!((i64)dlen >= cthread->c_len), 0)) {
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 366, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
  return 0;
 }
...
static int lzo_compress_buf(rzip_control *control, struct compress_thread *cthread)
{
 ...
 if (__builtin_expect(!!(wrkmem == ((void*)0)), 0)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 400, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to malloc wkmem\n"); } while (0); } while (0);
  return ret;
 }

 c_buf = malloc(dlen);
 if (!c_buf) {
  do { print_err(control, 406, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in lzo_compress_buf"); } while (0);
  goto out_free;
 }
 ...
 if (dlen >= in_len){
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 417, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Incompressible block\n"); } while (0); } while (0);
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
  goto out_free;
 }
 ...
 cthread->c_type = 5;
out_free:
 do { do { free((wrkmem)); (wrkmem) = ((void*)0); } while (0); wrkmem = ((void*)0); } while (0);
 return ret;
}
# 438 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
static int zpaq_decompress_buf(rzip_control *control __attribute__((unused)), struct uncomp_thread *ucthread, long thread)
{
 ...
 if (__builtin_expect(!!(!ucthread->s_buf), 0)) {
  do { print_err(control, 447, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to allocate %ld bytes for decompression\n", dlen); } while (0);
  ret = -1;
  goto out;
 }
 ...
 if (__builtin_expect(!!(dlen != ucthread->u_len), 0)) {
  do { print_err(control, 457, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inconsistent length after decompression. Got %ld bytes, expected %lld\n", dlen, ucthread->u_len); } while (0);
  ret = -1;
 } else
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
out:
 if (ret == -1) {
  do { do { free((ucthread->s_buf)); (ucthread->s_buf) = ((void*)0); } while (0); ucthread->s_buf = ((void*)0); } while (0);
...
static int bzip2_decompress_buf(rzip_control *control __attribute__((unused)), struct uncomp_thread *ucthread)
{
 ...
 ucthread->s_buf = malloc(round_up_page(control, dlen));
 if (__builtin_expect(!!(!ucthread->s_buf), 0)) {
  do { print_err(control, 478, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to allocate %d bytes for decompression\n", dlen); } while (0);
  ret = -1;
  goto out;
 }
 ...
 if (__builtin_expect(!!(bzerr != 0), 0)) {
  do { print_err(control, 485, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to decompress buffer - bzerr=%d\n", bzerr); } while (0);
  ret = -1;
  goto out;
 }

 if (__builtin_expect(!!(dlen != ucthread->u_len), 0)) {
  do { print_err(control, 491, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inconsistent length after decompression. Got %d bytes, expected %lld\n", dlen, ucthread->u_len); } while (0);
  ret = -1;
 } else
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
out:
...
static int gzip_decompress_buf(rzip_control *control __attribute__((unused)), struct uncomp_thread *ucthread)
{
 ...
 ucthread->s_buf = malloc(round_up_page(control, dlen));
 if (__builtin_expect(!!(!ucthread->s_buf), 0)) {
  do { print_err(control, 512, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to allocate %ld bytes for decompression\n", dlen); } while (0);
  ret = -1;
  goto out;
 }
 ...
 if (__builtin_expect(!!(gzerr != 0), 0)) {
  do { print_err(control, 519, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to decompress buffer - gzerr=%d\n", gzerr); } while (0);
  ret = -1;
  goto out;
 }

 if (__builtin_expect(!!((i64)dlen != ucthread->u_len), 0)) {
  do { print_err(control, 525, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inconsistent length after decompression. Got %ld bytes, expected %lld\n", dlen, ucthread->u_len); } while (0);
  ret = -1;
 } else
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
out:
...
static int lzma_decompress_buf(rzip_control *control, struct uncomp_thread *ucthread)
{
 ...
 ucthread->s_buf = malloc(round_up_page(control, dlen));
 if (__builtin_expect(!!(!ucthread->s_buf), 0)) {
  do { print_err(control, 547, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to allocate %lld bytes for decompression\n", (i64)dlen); } while (0);
  ret = -1;
  goto out;
 }
 ...
 if (__builtin_expect(!!(lzmaerr), 0)) {
  do { print_err(control, 556, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to decompress buffer - lzmaerr=%d\n", lzmaerr); } while (0);
  ret = -1;
  goto out;
 }

 if (__builtin_expect(!!((i64)dlen != ucthread->u_len), 0)) {
  do { print_err(control, 562, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inconsistent length after decompression. Got %lld bytes, expected %lld\n", (i64)dlen, ucthread->u_len); } while (0);
  ret = -1;
 } else
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
out:
...
static int lzo_decompress_buf(rzip_control *control __attribute__((unused)), struct uncomp_thread *ucthread)
{
 ...
 ucthread->s_buf = malloc(round_up_page(control, dlen));
 if (__builtin_expect(!!(!ucthread->s_buf), 0)) {
  do { print_err(control, 583, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to allocate %lu bytes for decompression\n", (unsigned long)dlen); } while (0);
  ret = -1;
  goto out;
 }
 ...
 if (__builtin_expect(!!(lzerr != 0), 0)) {
  do { print_err(control, 590, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to decompress buffer - lzerr=%d\n", lzerr); } while (0);
  ret = -1;
  goto out;
 }

 if (__builtin_expect(!!((i64)dlen != ucthread->u_len), 0)) {
  do { print_err(control, 596, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inconsistent length after decompression. Got %lu bytes, expected %lld\n", (unsigned long)dlen, ucthread->u_len); } while (0);
  ret = -1;
 } else
  do { do { free((c_buf)); (c_buf) = ((void*)0); } while (0); c_buf = ((void*)0); } while (0);
out:
...
ssize_t put_fdout(rzip_control *control, void *offset_buf, ssize_t ret)
{
 ...
 if (__builtin_expect(!!(control->out_ofs + ret > control->out_maxlen), 0)) {
  ...
  do { if ((control->flags & ((1 << 10) | (1 << 11)))) do { print_stuff(control, 3, 620, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to decompress entirely in ram, will use physical files\n"); } while (0); } while (0);
  if (__builtin_expect(!!(control->fd_out == -1), 0))
   failure(control, 622, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Was unable to decompress entirely in ram and no temporary file creation was possible\n");
  if (__builtin_expect(!!(!write_fdout(control, control->tmp_outbuf, control->out_len)), 0)) {
   do { print_err(control, 624, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to write_fdout tmpoutbuf in put_fdout\n"); } while (0);
   return -1;
  }
  close_tmpoutbuf(control);
  if (__builtin_expect(!!(!write_fdout(control, offset_buf, ret)), 0)) {
   do { print_err(control, 629, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to write_fdout offset_buf in put_fdout\n"); } while (0);
   return -1;
  }
  return ret;
 }
...
static _Bool read_fdin(struct rzip_control *control, i64 len)
{
 ...
 for (i = 0; i < len; i++) {
  ...
  if (__builtin_expect(!!(tmpchar == (-1)), 0))
   do { failure(control, 674, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Reached end of file on STDIN prematurely on read_fdin, asked for %lld got %lld\n", len, i); return 0; } while (0);
...
ssize_t read_1g(rzip_control *control, int fd, void *buf, i64 len)
{
 ...
 if ((control->flags & (1 << 22)) && fd == control->fd_in) {
  ...
  if (__builtin_expect(!!(control->in_ofs + len > control->in_maxlen), 0)) {
   ...
   if (dump_stdin(control))
    do { failure(control, 704, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Inadequate ram to %compress from STDIN and unable to create in tmpfile"); return -1; } while (0);
   goto read_fd;
  }
 ...
 if ((control->flags & (1 << 21)) && fd == control->fd_out) {
  if (__builtin_expect(!!(control->out_ofs + len > control->out_maxlen), 0))
   do { failure(control, 718, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Trying to read beyond out_ofs in tmpoutbuf\n"); return -1; } while (0);
...
static int write_buf(rzip_control *control, unsigned char *p, i64 len)
{
 ...
 if (__builtin_expect(!!(ret == -1), 0)) {
  do { print_err(control, 745, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Write of length %lld failed - %s\n", len, strerror((*__errno_location ()))); } while (0);
  return -1;
 }
 if (__builtin_expect(!!(ret != (ssize_t)len), 0)) {
  do { print_err(control, 749, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Partial write!? asked for %lld bytes but got %lld\n", len, (i64)ret); } while (0);
  return -1;
 }
 return 0;
}
...
static int read_buf(rzip_control *control, int f, unsigned char *p, i64 len)
{
 ...
 if (__builtin_expect(!!(ret == -1), 0)) {
  do { print_err(control, 773, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Read of length %lld failed - %s\n", len, strerror((*__errno_location ()))); } while (0);
  return -1;
 }
 if (__builtin_expect(!!(ret != (ssize_t)len), 0)) {
  do { print_err(control, 777, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Partial read!? asked for %lld bytes but got %lld\n", len, (i64)ret); } while (0);
  return -1;
 }
 return 0;
}
...
static int fd_seekto(rzip_control *control, struct stream_info *sinfo, i64 spos, i64 pos)
{
 if (__builtin_expect(!!(lseek(sinfo->fd, spos, 0) != spos), 0)) {
  do { print_err(control, 809, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to seek to %lld in stream\n", pos); } while (0);
  return -1;
 }
 return 0;
}
...
static int seekto(rzip_control *control, struct stream_info *sinfo, i64 pos)
{
 ...
 if ((control->flags & (1 << 21))) {
  ...
  if (__builtin_expect(!!(spos > control->out_len || spos < 0), 0)) {
   do { print_err(control, 824, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Trying to seek to %lld outside tmp outbuf in seekto\n", spos); } while (0);
   return -1;
  }
  return 0;
 }
...
static int read_seekto(rzip_control *control, struct stream_info *sinfo, i64 pos)
{
 ...
 if ((control->flags & (1 << 22))) {
  ...
  if (__builtin_expect(!!(spos < 0), 0)) {
   do { print_err(control, 852, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Trying to seek to %lld outside tmp inbuf in read_seekto\n", spos); } while (0);
   return -1;
  }
  return 0;
 }
...
static i64 get_seek(rzip_control *control, int fd)
{
 ...
 ret = lseek(fd, 0, 1);
 if (__builtin_expect(!!(ret == -1), 0))
  do { fatal(control, 869, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to lseek in get_seek\n"); return -1; } while (0);
 return ret;
}
...
i64 get_readseek(rzip_control *control, int fd)
{
 ...
 ret = lseek(fd, 0, 1);
 if (__builtin_expect(!!(ret == -1), 0))
  do { fatal(control, 881, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to lseek in get_seek\n"); return -1; } while (0);
 return ret;
}
...
_Bool prepare_streamout_threads(rzip_control *control)
{
 ...
 if (__builtin_expect(!!(!threads), 0))
  do { fatal(control, 899, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to calloc threads in prepare_streamout_threads\n"); return 0; } while (0);

 cthread = calloc(sizeof(struct compress_thread), control->threads);
 if (__builtin_expect(!!(!cthread), 0)) {
  do { do { free((threads)); (threads) = ((void*)0); } while (0); threads = ((void*)0); } while (0);
  do { fatal(control, 904, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to calloc cthread in prepare_streamout_threads\n"); return 0; } while (0);
 }
...
_Bool close_streamout_threads(rzip_control *control)
{
 ...
 do { do { free((cthread)); (cthread) = ((void*)0); } while (0); cthread = ((void*)0); } while (0);
 do { do { free((threads)); (threads) = ((void*)0); } while (0); threads = ((void*)0); } while (0);
 return 1;
}
...
void *open_stream_out(rzip_control *control, int f, unsigned int n, i64 chunk_limit, char cbytes)
{
 ...
 if (__builtin_expect(!!(!sinfo->s), 0)) {
  do { do { free((sinfo)); (sinfo) = ((void*)0); } while (0); sinfo = ((void*)0); } while (0);
  return ((void*)0);
 }
...
retest_malloc:
 ...
 if (!(control->flags & (1 << 5))) {
  ...
  if (!testmalloc2) {
   do { do { free((testmalloc)); (testmalloc) = ((void*)0); } while (0); testmalloc = ((void*)0); } while (0);
   limit = limit / 10 * 9;
   goto retest_malloc;
  }
  do { do { free((testmalloc2)); (testmalloc2) = ((void*)0); } while (0); testmalloc2 = ((void*)0); } while (0);
 }
 do { do { free((testmalloc)); (testmalloc) = ((void*)0); } while (0); testmalloc = ((void*)0); } while (0);
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1008, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Succeeded in testing %lld sized malloc for back end compression\n", testsize); } while (0); } while (0);
 ...
 if (control->threads > 1)
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1017, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Using up to %d threads to compress up to %lld bytes each.\n", control->threads, sinfo->bufsize); } while (0); } while (0);

 else
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1020, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Using only 1 thread to compress up to %lld bytes\n", sinfo->bufsize); } while (0); } while (0);


 for (i = 0; i < n; i++) {
  sinfo->s[i].buf = calloc(sinfo->bufsize , 1);
  if (__builtin_expect(!!(!sinfo->s[i].buf), 0)) {
   fatal(control, 1025, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc buffer of size %lld in open_stream_out\n", sinfo->bufsize);
   do { do { free((sinfo->s)); (sinfo->s) = ((void*)0); } while (0); sinfo->s = ((void*)0); } while (0);
   do { do { free((sinfo)); (sinfo) = ((void*)0); } while (0); sinfo = ((void*)0); } while (0);
   return ((void*)0);
  }
 }
...
void *open_stream_in(rzip_control *control, int f, int n, char chunk_bytes)
{
 ...
 if (__builtin_expect(!!(!ucthread), 0)) {
  do { do { free((sinfo)); (sinfo) = ((void*)0); } while (0); sinfo = ((void*)0); } while (0);
  do { do { free((threads)); (threads) = ((void*)0); } while (0); threads = ((void*)0); } while (0);
  do { fatal(control, 1083, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to calloc cthread in open_stream_in\n"); return ((void*)0); } while (0);
 }
 ...
 if (control->major_version == 0 && control->minor_version > 5) {
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1102, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Reading eof flag at %lld\n", get_readseek(control, f)); } while (0); } while (0);
  if (__builtin_expect(!!(read_u8(control, f, &control->eof)), 0)) {
   do { print_err(control, 1104, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to read eof flag in open_stream_in\n"); } while (0);
   goto failed;
  }
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1107, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "EOF: %d\n", control->eof); } while (0); } while (0);


  if (!(control->flags & (1 << 23))) {
   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1111, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Reading expected chunksize at %lld\n", get_readseek(control, f)); } while (0); } while (0);
   if (__builtin_expect(!!(read_val(control, f, &sinfo->size, sinfo->chunk_bytes)), 0)) {
    do { print_err(control, 1113, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to read in chunk size in open_stream_in\n"); } while (0);
    goto failed;
   }
   sinfo->size = __uint64_identity (sinfo->size);
   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1117, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Chunk size: %lld\n", sinfo->size); } while (0); } while (0);
   control->st_size += sinfo->size;
   if (__builtin_expect(!!(sinfo->chunk_bytes < 1 || sinfo->chunk_bytes > 8 || sinfo->size < 0), 0)) {
    do { print_err(control, 1120, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Invalid chunk data size %d bytes %lld\n", sinfo->size, sinfo->chunk_bytes); } while (0);
    goto failed;
   }
  }
 }
...
again:
  ...
  if (control->major_version == 0 && control->minor_version < 4) {
   ...
   do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1161, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Reading stream %d header at %lld\n", i, get_readseek(control, f)); } while (0); } while (0);
  ...
  if (__builtin_expect(!!(c == 3 && v1 == 0 && v2 == 0 && sinfo->s[i].last_head == 0 && i == 0), 0)) {
   do { print_err(control, 1188, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Enabling stream close workaround\n"); } while (0);
   sinfo->initial_pos += header_length;
   goto again;
  }

  if (__builtin_expect(!!(c != 3), 0)) {
   do { print_err(control, 1194, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unexpected initial tag %d in streams\n", c); } while (0);
   if ((control->flags & (1 << 23)))
    do { print_err(control, 1196, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Wrong password?\n"); } while (0);
   goto failed;
  }
  if (__builtin_expect(!!(v1), 0)) {
   do { print_err(control, 1200, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unexpected initial c_len %lld in streams %lld\n", v1, v2); } while (0);
   goto failed;
  }
  if (__builtin_expect(!!(v2), 0)) {
   do { print_err(control, 1204, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unexpected initial u_len %lld in streams\n", v2); } while (0);
   goto failed;
  }
 }
...
# 1224 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
static _Bool rewrite_encrypted(rzip_control *control, struct stream_info *sinfo, i64 ofs)
{
 ...
 if (__builtin_expect(!!(!head), 0))
  do { fatal(control, 1234, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to malloc head in rewrite_encrypted\n"); return 0; } while (0);
 buf = head + 8;
 if (__builtin_expect(!!(!get_rand(control, head, 8)), 0))
  goto error;
 if (__builtin_expect(!!(seekto(control, sinfo, ofs - 8)), 0))
  do { failure(control, 1239, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to seekto buf ofs in rewrite_encrypted\n"); goto error; } while (0);
 if (__builtin_expect(!!(write_buf(control, head, 8)), 0))
  do { failure(control, 1241, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf head in rewrite_encrypted\n"); goto error; } while (0);
 if (__builtin_expect(!!(read_buf(control, sinfo->fd, buf, 25)), 0))
  do { failure(control, 1243, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to read_buf buf in rewrite_encrypted\n"); goto error; } while (0);

 if (__builtin_expect(!!(!lrz_encrypt(control, buf, 25, head)), 0))
  goto error;

 if (__builtin_expect(!!(seekto(control, sinfo, ofs)), 0))
  do { failure(control, 1249, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to seek back to ofs in rewrite_encrypted\n"); goto error; } while (0);
 if (__builtin_expect(!!(write_buf(control, buf, 25)), 0))
  do { failure(control, 1251, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf encrypted buf in rewrite_encrypted\n"); goto error; } while (0);
 do { do { free((head)); (head) = ((void*)0); } while (0); head = ((void*)0); } while (0);
...
static void *compthread(void *data)
{
 ...
 do { do { free((data)); (data) = ((void*)0); } while (0); data = ((void*)0); } while (0);
 cti = &cthread[i];
 ctis = cti->sinfo;

 if (__builtin_expect(!!(setpriority(PRIO_PROCESS, 0, control->nice_val) == -1), 0))
  do { print_err(control, 1280, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Warning, unable to set nice value on thread\n"); } while (0);
...
retry:
 ...
 if (!(control->flags & (1 << 5)) && cti->c_len >= 64) {
  ...
  else do { failure(control, 1304, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Dunno wtf compression to use!\n"); goto error; } while (0);
 }
 ...
 if (!ret && padded_len < ((control->flags & (1 << 23)) ? 16 : 0)) {
  ...
  if (__builtin_expect(!!(!cti->s_buf), 0))
   do { fatal(control, 1315, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to realloc s_buf in compthread\n"); goto error; } while (0);
 ...
 if (__builtin_expect(!!(ret && waited), 0))
  do { failure(control, 1324, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to compress in compthread\n"); goto error; } while (0);
 ...
 if (__builtin_expect(!!(ret), 0)) {
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1334, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to compress in parallel, waiting for previous thread to complete before trying again\n"); } while (0); } while (0);
  goto retry;
 }
 ...
 if (!ctis->chunks++) {
  ...
  if ((control->flags & (1 << 21))) {
   ...
   if (__builtin_expect(!!(!flush_tmpoutbuf(control)), 0)) {
    do { print_err(control, 1354, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to flush_tmpoutbuf in compthread\n"); } while (0);
    goto error;
   }
  }

  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1360, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Writing initial chunk bytes value %d at %lld\n", ctis->chunk_bytes, get_seek(control, ctis->fd)); } while (0); } while (0);
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1366, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Writing EOF flag as %d\n", control->eof); } while (0); } while (0);
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1376, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Writing initial header at %lld\n", ctis->initial_pos); } while (0); } while (0);
  for (j = 0; j < ctis->num_streams; j++) {


   if ((control->flags & (1 << 23))) {
    if (__builtin_expect(!!(write_val(control, 0, 8)), 0))
     do { fatal(control, 1382, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf blank salt in compthread %d\n", i); goto error; } while (0);
    ctis->cur_pos += 8;
   }
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1394, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Compthread %ld seeking to %lld to store length %d\n", i, ctis->s[cti->streamno].last_head, write_len); } while (0); } while (0);

 if (__builtin_expect(!!(seekto(control, ctis, ctis->s[cti->streamno].last_head)), 0))
  do { fatal(control, 1397, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to seekto in compthread %d\n", i); goto error; } while (0);

 if (__builtin_expect(!!(write_val(control, ctis->cur_pos, write_len)), 0))
  do { fatal(control, 1400, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_val cur_pos in compthread %d\n", i); goto error; } while (0);
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1407, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Compthread %ld seeking to %lld to write header\n", i, ctis->cur_pos); } while (0); } while (0);

 if (__builtin_expect(!!(seekto(control, ctis, ctis->cur_pos)), 0))
  do { fatal(control, 1410, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to seekto cur_pos in compthread %d\n", i); goto error; } while (0);

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1412, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Thread %ld writing %lld compressed bytes from stream %d\n", i, padded_len, cti->streamno); } while (0); } while (0);

 if ((control->flags & (1 << 23))) {
  if (__builtin_expect(!!(write_val(control, 0, 8)), 0))
   do { fatal(control, 1416, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf header salt in compthread %d\n", i); goto error; } while (0);
  ctis->cur_pos += 8;
 ...
 if (__builtin_expect(!!(write_u8(control, cti->c_type) || write_val(control, cti->c_len, write_len) || write_val(control, cti->s_len, write_len) || write_val(control, 0, write_len)), 0)) {
   ...
   do { fatal(control, 1425, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed write in compthread %d\n", i); goto error; } while (0);
 }
 ctis->cur_pos += 1 + (write_len * 3);
 ...
 if ((control->flags & (1 << 23))) {
  ...
  if (__builtin_expect(!!(write_buf(control, cti->salt, 8)), 0))
   do { fatal(control, 1433, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf block salt in compthread %d\n", i); goto error; } while (0);
  if (__builtin_expect(!!(!lrz_encrypt(control, cti->s_buf, padded_len, cti->salt)), 0))
   goto error;
  ctis->cur_pos += 8;
 }

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1439, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Compthread %ld writing data at %lld\n", i, ctis->cur_pos); } while (0); } while (0);

 if (__builtin_expect(!!(write_buf(control, cti->s_buf, padded_len)), 0))
  do { fatal(control, 1442, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to write_buf s_buf in compthread %d\n", i); goto error; } while (0);

 ctis->cur_pos += padded_len;
 do { do { free((cti->s_buf)); (cti->s_buf) = ((void*)0); } while (0); cti->s_buf = ((void*)0); } while (0);
...
static void clear_buffer(rzip_control *control, struct stream_info *sinfo, int streamno, int newbuf)
{
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1473, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Starting thread %ld to compress %lld bytes from stream %d\n", i, cthread[i].s_len, streamno); } while (0); } while (0);


 s = malloc(sizeof(stream_thread_struct));
 if (__builtin_expect(!!(!s), 0)) {
  cksem_post(control, &cthread[i].cksem);
  failure(control, 1478, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc in clear_buffer");
 }
 s->i = i;
 s->control = control;
 if (__builtin_expect(!!((!create_pthread(control, &threads[i], ((void*)0), compthread, s)) || (!detach_pthread(control, &threads[i]))), 0))

  failure(control, 1484, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to create compthread in clear_buffer");
 ...
 if (newbuf) {
  ...
  if (__builtin_expect(!!(!sinfo->s[streamno].buf), 0))
   failure(control, 1491, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc buffer of size %lld in flush_buffer\n", sinfo->bufsize);
...
static void *ucompthread(void *data)
{
 ...
 if (__builtin_expect(!!(setpriority(PRIO_PROCESS, 0, control->nice_val) == -1), 0))
  do { print_err(control, 1516, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Warning, unable to set nice value on thread\n"); } while (0);
...
retry:
 if (uci->c_type != 3) {
  switch (uci->c_type) {
   ...
   case 8:
    ...
    break;
   default:
    do { failure(control, 1537, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Dunno wtf decompression type to use!\n"); return ((void*)0); } while (0);
    break;
  }
 }
 ...
 if (__builtin_expect(!!(ret), 0)) {
  if (__builtin_expect(!!(waited), 0))
   do { failure(control, 1546, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to decompress in ucompthread\n"); return ((void*)0); } while (0);
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1547, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to decompress in parallel, waiting for previous thread to complete before trying again\n"); } while (0); } while (0);
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1559, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Thread %ld decompressed %lld bytes from stream %d\n", i, uci->u_len, uci->streamno); } while (0); } while (0);
...
static int fill_buffer(rzip_control *control, struct stream_info *sinfo, struct stream *s, int streamno)
{
 ...
 do { do { free((s->buf)); (s->buf) = ((void*)0); } while (0); s->buf = ((void*)0); } while (0);
 if (s->eos)
  goto out;
fill_another:
 new_thread = 1;
 if (__builtin_expect(!!(ucthread[s->uthread_no].busy), 0))
  do { failure(control, 1579, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Trying to start a busy thread, this shouldn't happen!\n"); return -1; } while (0);
 ...
 if (control->major_version == 0 && control->minor_version < 4) {
  ...
  do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1610, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Reading ucomp header at %lld\n", get_readseek(control, sinfo->fd)); } while (0); } while (0);
 ...
 if (__builtin_expect(!!(c_len < 1 || u_len < 1 || last_head < 0 || (last_head && last_head <= s->last_head)), 0)) {
  do { fatal(control, 1639, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Invalid data compressed len %lld uncompressed %lld last_head %lld\n", c_len, u_len, last_head); return -1; } while (0);

 }
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1641, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Fill_buffer stream %d c_len %lld u_len %lld last_head %lld\n", streamno, c_len, u_len, last_head); } while (0); } while (0);
 ...
 if (__builtin_expect(!!(u_len > control->maxram), 0))
  do { fatal(control, 1648, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc buffer of size %lld in this environment\n", u_len); return -1; } while (0);
 max_len = ((u_len) > (((control->flags & (1 << 23)) ? 16 : 0))? (u_len): (((control->flags & (1 << 23)) ? 16 : 0)));
 max_len = ((max_len) > (c_len)? (max_len): (c_len));
 s_buf = malloc(max_len);
 if (__builtin_expect(!!(u_len && !s_buf), 0))
  do { fatal(control, 1653, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc buffer of size %lld in fill_buffer\n", u_len); return -1; } while (0);
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1674, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Starting thread %ld to decompress %lld bytes from stream %d\n", s->uthread_no, padded_len, streamno); } while (0); } while (0);


 st = malloc(sizeof(stream_thread_struct));
 if (__builtin_expect(!!(!st), 0))
  do { fatal(control, 1678, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to malloc in fill_buffer"); return -1; } while (0);
 st->i = s->uthread_no;
 st->control = control;
 if (__builtin_expect(!!(!create_pthread(control, &threads[s->uthread_no], ((void*)0), ucompthread, st)), 0)) {
  do { do { free((st)); (st) = ((void*)0); } while (0); st = ((void*)0); } while (0);
  return -1;
 }
...
out:
 ...
 if (__builtin_expect(!!(new_thread && !join_pthread(control, threads[s->unext_thread], ((void*)0))), 0))
  return -1;
 ucthread[s->unext_thread].busy = 0;

 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1709, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Taking decompressed data from thread %ld\n", s->unext_thread); } while (0); } while (0);
...
i64 read_stream(rzip_control *control, void *ss, int streamno, unsigned char *p, i64 len)
{
 ...
 while (len) {
  ...
  n = ((s->buflen - s->bufp) < (len)? (s->buflen - s->bufp): (len));
  ...
  if (len && s->bufp == s->buflen) {
   if (__builtin_expect(!!(fill_buffer(control, sinfo, s, streamno)), 0))
    return -1;
   if (s->bufp == s->buflen)
    break;
  }
 ...
 if (control->library_mode) {
  if (!control->sinfo_buckets) {
   ...
   if (!control->sinfo_queue) {
    do { print_err(control, 1803, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to calloc sinfo_queue in close_stream_out\n"); } while (0);
    return -1;
   }
   ...
   if (!tmp) {
    do { print_err(control, 1813, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Failed to realloc sinfo_queue in close_stream_out\n"); } while (0);
    return -1;
   }
...
# 1829 "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c"
 return 0;
}
...
int close_stream_in(rzip_control *control, void *ss)
{
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1840, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Closing stream at %lld, want to seek to %lld\n", get_readseek(control, control->fd_in), sinfo->initial_pos + sinfo->total_read); } while (0); } while (0);
 ...
 for (i = 0; i < sinfo->num_streams; i++)
  do { do { free((sinfo->s[i].buf)); (sinfo->s[i].buf) = ((void*)0); } while (0); sinfo->s[i].buf = ((void*)0); } while (0);

 output_thread = 0;
 do { do { free((ucthread)); (ucthread) = ((void*)0); } while (0); ucthread = ((void*)0); } while (0);
 do { do { free((threads)); (threads) = ((void*)0); } while (0); threads = ((void*)0); } while (0);
 do { do { free((sinfo->s)); (sinfo->s) = ((void*)0); } while (0); sinfo->s = ((void*)0); } while (0);
 do { do { free((sinfo)); (sinfo) = ((void*)0); } while (0); sinfo = ((void*)0); } while (0);
...
static int lzo_compresses(rzip_control *control, unsigned char *s_buf, i64 s_len)
{
 ...
 if (__builtin_expect(!!(wrkmem == ((void*)0)), 0))
  do { fatal(control, 1876, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate wrkmem in lzo_compresses\n"); return 0; } while (0);
 ...
 if (__builtin_expect(!!(!c_buf), 0)) {
  do { do { free((wrkmem)); (wrkmem) = ((void*)0); } while (0); wrkmem = ((void*)0); } while (0);
  do { fatal(control, 1884, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "Unable to allocate c_buf in lzo_compresses\n"); return 0; } while (0);
 }
 ...
 do { if ((control->flags & (1 << 11))) do { print_stuff(control, 4, 1911, "/benchmark/RUNDIR-lrzip-ed51e14/BUILD/stream.c", __func__, "lzo testing %s for chunk %ld. Compressed size = %5.2F%% of chunk, %d Passes\n", (ret == 0? "FAILED" : "OK"), save_len, 100 * ((double) best_dlen / (double) in_len), workcounter); } while (0); } while (0);
