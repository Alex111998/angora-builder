# 1 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c" 2
# 21 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c"
...
# 22 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c" 2
# 1 "./parser.h" 1
# 22 "./parser.h"
...
# 76 "./parser.h" 2
# 23 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c" 2
# 1 "./read.h" 1
...
void dumpBuffer(unsigned char *buf, int length);
# 24 "/benchmark/RUNDIR-libming-4.7.1/BUILD/util/blocktypes.c" 2
...
static struct SWFBlock blocks[] = {
  { SWF_CHARACTERSET, "SWF_CHARACTERSET", parseSWF_CHARACTERSET, },
  { SWF_DEFINEBITS, "SWF_DEFINEBITS", parseSWF_DEFINEBITS, },
  { SWF_DEFINEBITSJPEG2, "SWF_DEFINEBITSJPEG2", parseSWF_DEFINEBITSJPEG2, },
  { SWF_DEFINEBITSJPEG3, "SWF_DEFINEBITSJPEG3", parseSWF_DEFINEBITSJPEG3, },
  { SWF_DEFINEBITSPTR, "SWF_DEFINEBITSPTR", parseSWF_DEFINEBITSPTR, },
  { SWF_DEFINEBUTTON, "SWF_DEFINEBUTTON", parseSWF_DEFINEBUTTON, },
  { SWF_DEFINEBUTTON2, "SWF_DEFINEBUTTON2", parseSWF_DEFINEBUTTON2, },
  { SWF_DEFINEBUTTONCXFORM, "SWF_DEFINEBUTTONCXFORM", parseSWF_DEFINEBUTTONCXFORM, },
  { SWF_DEFINEBUTTONSOUND, "SWF_DEFINEBUTTONSOUND", parseSWF_DEFINEBUTTONSOUND, },
  { SWF_DEFINECOMMANDOBJ, "SWF_DEFINECOMMANDOBJ", parseSWF_DEFINECOMMANDOBJ, },
  { SWF_DEFINEEDITTEXT, "SWF_DEFINEEDITTEXT", parseSWF_DEFINEEDITTEXT, },
  { SWF_DEFINEFONT, "SWF_DEFINEFONT", parseSWF_DEFINEFONT, },
  { SWF_DEFINEFONT2, "SWF_DEFINEFONT2", parseSWF_DEFINEFONT2, },
  { SWF_DEFINEFONT3, "SWF_DEFINEFONT3", parseSWF_DEFINEFONT3, },
  { SWF_DEFINEFONTINFO, "SWF_DEFINEFONTINFO", parseSWF_DEFINEFONTINFO, },
  { SWF_DEFINEFONTINFO2, "SWF_DEFINEFONTINFO2", parseSWF_DEFINEFONTINFO2, },
  { SWF_CSMTEXTSETTINGS, "SWF_CSMTEXTSETTINGS", parseSWF_CSMTEXTSETTINGS, },
  { SWF_DEFINEFONTNAME, "SWF_DEFINEFONTNAME", parseSWF_DEFINEFONTNAME, },
  { SWF_DEFINEFONTALIGNZONES, "SWF_DEFINEFONTALIGNZONES", parseSWF_DEFINEFONTALIGNZONES, },
  { SWF_DEFINELOSSLESS, "SWF_DEFINELOSSLESS", parseSWF_DEFINELOSSLESS, },
  { SWF_DEFINELOSSLESS2, "SWF_DEFINELOSSLESS2", parseSWF_DEFINELOSSLESS2, },
  { SWF_DEFINEMORPHSHAPE, "SWF_DEFINEMORPHSHAPE", parseSWF_DEFINEMORPHSHAPE, },
  { SWF_DEFINEMORPHSHAPE2, "SWF_DEFINEMORPHSHAPE2", parseSWF_DEFINEMORPHSHAPE2, },
  { SWF_DEFINESHAPE, "SWF_DEFINESHAPE", parseSWF_DEFINESHAPE, },
  { SWF_DEFINESHAPE2, "SWF_DEFINESHAPE2", parseSWF_DEFINESHAPE2, },
  { SWF_DEFINESHAPE3, "SWF_DEFINESHAPE3", parseSWF_DEFINESHAPE3, },
  { SWF_DEFINESHAPE4, "SWF_DEFINESHAPE4", parseSWF_DEFINESHAPE4, },
  { SWF_DEFINESOUND, "SWF_DEFINESOUND", parseSWF_DEFINESOUND, },
  { SWF_DEFINESPRITE, "SWF_DEFINESPRITE", parseSWF_DEFINESPRITE, },
  { SWF_DEFINETEXT, "SWF_DEFINETEXT", parseSWF_DEFINETEXT, },
  { SWF_DEFINETEXT2, "SWF_DEFINETEXT2", parseSWF_DEFINETEXT2, },
  { SWF_DEFINETEXTFORMAT, "SWF_DEFINETEXTFORMAT", parseSWF_DEFINETEXTFORMAT, },
  { SWF_DEFINEVIDEO, "SWF_DEFINEVIDEO", parseSWF_DEFINEVIDEO, },
  { SWF_DEFINEVIDEOSTREAM, "SWF_DEFINEVIDEOSTREAM", parseSWF_DEFINEVIDEOSTREAM, },
  { SWF_DOACTION, "SWF_DOACTION", parseSWF_DOACTION, },
  { SWF_ENABLEDEBUGGER, "SWF_ENABLEDEBUGGER", parseSWF_ENABLEDEBUGGER, },
  { SWF_ENABLEDEBUGGER2, "SWF_ENABLEDEBUGGER2", parseSWF_ENABLEDEBUGGER2, },
  { SWF_END, "SWF_END", parseSWF_END, },
  { SWF_EXPORTASSETS, "SWF_EXPORTASSETS", parseSWF_EXPORTASSETS, },
  { SWF_FONTREF, "SWF_FONTREF", parseSWF_FONTREF, },
  { SWF_FRAMELABEL, "SWF_FRAMELABEL", parseSWF_FRAMELABEL, },
  { SWF_FRAMETAG, "SWF_FRAMETAG", parseSWF_FRAMETAG, },
  { SWF_FREEALL, "SWF_FREEALL", parseSWF_FREEALL, },
  { SWF_FREECHARACTER, "SWF_FREECHARACTER", parseSWF_FREECHARACTER, },
  { SWF_GENCOMMAND, "SWF_GENCOMMAND", parseSWF_GENCOMMAND, },
  { SWF_IMPORTASSETS, "SWF_IMPORTASSETS", parseSWF_IMPORTASSETS, },
  { SWF_IMPORTASSETS2, "SWF_IMPORTASSETS2", parseSWF_IMPORTASSETS2, },
  { SWF_INITACTION, "SWF_INITACTION", parseSWF_INITACTION, },
  { SWF_JPEGTABLES, "SWF_JPEGTABLES", parseSWF_JPEGTABLES, },
  { SWF_NAMECHARACTER, "SWF_NAMECHARACTER", parseSWF_NAMECHARACTER, },
  { SWF_PATHSAREPOSTSCRIPT, "SWF_PATHSAREPOSTSCRIPT", parseSWF_PATHSAREPOSTSCRIPT, },
  { SWF_PLACEOBJECT, "SWF_PLACEOBJECT", parseSWF_PLACEOBJECT, },
  { SWF_PLACEOBJECT2, "SWF_PLACEOBJECT2", parseSWF_PLACEOBJECT2, },
  { SWF_PLACEOBJECT3, "SWF_PLACEOBJECT3", parseSWF_PLACEOBJECT3, },
  { SWF_PREBUILT, "SWF_PREBUILT", parseSWF_PREBUILT, },
  { SWF_PREBUILTCLIP, "SWF_PREBUILTCLIP", parseSWF_PREBUILTCLIP, },
  { SWF_PROTECT, "SWF_PROTECT", parseSWF_PROTECT, },
  { SWF_REMOVEOBJECT, "SWF_REMOVEOBJECT", parseSWF_REMOVEOBJECT, },
  { SWF_REMOVEOBJECT2, "SWF_REMOVEOBJECT2", parseSWF_REMOVEOBJECT2, },
  { SWF_SERIALNUMBER, "SWF_SERIALNUMBER", parseSWF_SERIALNUMBER, },
  { SWF_SETBACKGROUNDCOLOR, "SWF_SETBACKGROUNDCOLOR", parseSWF_SETBACKGROUNDCOLOR, },
  { SWF_SHOWFRAME, "SWF_SHOWFRAME", parseSWF_SHOWFRAME, },
  { SWF_SOUNDSTREAMBLOCK, "SWF_SOUNDSTREAMBLOCK", parseSWF_SOUNDSTREAMBLOCK, },
  { SWF_SOUNDSTREAMHEAD, "SWF_SOUNDSTREAMHEAD", parseSWF_SOUNDSTREAMHEAD, },
  { SWF_SOUNDSTREAMHEAD2, "SWF_SOUNDSTREAMHEAD2", parseSWF_SOUNDSTREAMHEAD2, },
  { SWF_STARTSOUND, "SWF_STARTSOUND", parseSWF_STARTSOUND, },
  { SWF_STARTSOUND2, "SWF_STARTSOUND2", parseSWF_STARTSOUND2, },
  { SWF_SYNCFRAME, "SWF_SYNCFRAME", parseSWF_SYNCFRAME, },
  { SWF_VIDEOFRAME, "SWF_VIDEOFRAME", parseSWF_VIDEOFRAME, },
  { SWF_REFLEX, "SWF_REFLEX", parseSWF_REFLEX, },
  { SWF_FILEATTRIBUTES, "SWF_FILEATTRIBUTES", parseSWF_FILEATTRIBUTES, },
  { SWF_METADATA, "SWF_METADATA", parseSWF_METADATA, },
  { SWF_SCRIPTLIMITS, "SWF_SCRIPTLIMITS", parseSWF_SCRIPTLIMITS, },
  { SWF_DEFINESCALINGGRID, "SWF_DEFINESCALINGGRID", parseSWF_DEFINESCALINGGRID, },
  { SWF_SETTABINDEX, "SWF_SETTABINDEX", parseSWF_SETTABINDEX, },
  { SWF_DOABC, "SWF_DOABC", parseSWF_DOABC, },
  { SWF_SYMBOLCLASS, "SWF_SYMBOLCLASS", parseSWF_SYMBOLCLASS, },
  { SWF_DEFINESCENEANDFRAMEDATA, "SWF_DEFINESCENEANDFRAMEDATA", parseSWF_DEFINESCENEANDFRAMEDATA, },
  { SWF_DEFINEBINARYDATA, "SWF_DEFINEBINARYDATA", parseSWF_DEFINEBINARYDATA, },
  { SWF_DEBUGID, "SWF_DEBUGID", parseSWF_DEBUGID, },
};
