# 1 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
# 21 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c"
...
# 22 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 23 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
# 1 "./libming.h" 1
# 36 "./libming.h"
# 1 "./ming_config.h" 1
# 37 "./libming.h" 2
...
# 76 "./libming.h" 2
# 27 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
# 1 "./shape_util.h" 1
# 28 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
# 1 "./blocks/error.h" 1
# 15 "./blocks/error.h"
...
# 29 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
# 1 "./blocks/shape.h" 1
# 33 "./blocks/shape.h"
# 1 "./blocks/output.h" 1
# 34 "./blocks/output.h"
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 30 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c" 2
...
{
 return ((ax-bx)>0?(ax-bx):-(ax-bx)) + ((ay-by)>0?(ay-by):-(ay-by));
}

static void subdivideCubicLeft(cubic *New, cubic *old, double t)
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c",74); } while(0);;
...
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c",97); } while(0);;
...
static int SWFShape_approxCubic(SWFShape shape, cubic *c)
{
 ...
 else
 {
  ...
  if(denom == 0)
  {
   ...
   SWFShape_drawScaledLineTo(shape, (int)(floor((c->d.x)+0.5)), (int)(floor((c->d.y)+0.5)));
   return 1;
  }
 ...
 else
 {
  ...
  SWFShape_drawScaledCurveTo(shape, (int)(floor((q.b.x)+0.5)), (int)(floor((q.b.y)+0.5)),
       (int)(floor((q.c.x)+0.5)), (int)(floor((q.c.y)+0.5)));
  return 1;
 }
}
       ...
       int cx, int cy, int dx, int dy)
{
 ...
 if ( t1 > 0.0 && t1 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 263 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c"
 ...
 if ( t2 > 0.0 && t2 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 280 "/benchmark/RUNDIR-libming-4.7.1/BUILD/src/shape_cubic.c"
    ...
    double cx, double cy, double dx, double dy)
{
 ...
 int sbx = (int)(floor((bx*Ming_scale)+0.5)) + sax;
 int sby = (int)(floor((by*Ming_scale)+0.5)) + say;
 int scx = (int)(floor((cx*Ming_scale)+0.5)) + sbx;
 int scy = (int)(floor((cy*Ming_scale)+0.5)) + sby;
 int sdx = (int)(floor((dx*Ming_scale)+0.5)) + scx;
 int sdy = (int)(floor((dy*Ming_scale)+0.5)) + scy;
    ...
    double cx, double cy, double dx, double dy)
{
 return SWFShape_drawScaledCubicTo(shape,
      (int)(floor((bx*Ming_scale)+0.5)),
      (int)(floor((by*Ming_scale)+0.5)),
      (int)(floor((cx*Ming_scale)+0.5)),
      (int)(floor((cy*Ming_scale)+0.5)),
      (int)(floor((dx*Ming_scale)+0.5)),
