# 1 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
# 21 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c"
...
# 22 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 23 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
...
# 26 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
# 1 "./libming.h" 1
# 36 "./libming.h"
# 1 "./ming_config.h" 1
# 37 "./libming.h" 2
...
# 76 "./libming.h" 2
# 27 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
# 1 "./shape_util.h" 1
# 28 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
# 1 "./blocks/error.h" 1
# 15 "./blocks/error.h"
...
# 29 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
# 1 "./blocks/shape.h" 1
# 33 "./blocks/shape.h"
# 1 "./blocks/output.h" 1
# 34 "./blocks/output.h"
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 30 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c" 2
...
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c",74); } while(0);;
...
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c",97); } while(0);;
       ...
       int cx, int cy, int dx, int dy)
{
 ...
 if ( t1 > 0.0 && t1 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 263 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c"
 ...
 if ( t2 > 0.0 && t2 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 280 "/benchmark/RUNDIR-libming-4.7/BUILD/src/shape_cubic.c"
